...
var _toArrayMjs = /*#__PURE__*/ _interopRequireDefault(
    require("./_to_array.js")
);
var _toPropertyKeyMjs = /*#__PURE__*/ _interopRequireDefault(
    require("./_to_property_key.js")
);
...
function _createElementDescriptor(def) {
    ...
    if (def.kind === "method") {
        ...
        Object.defineProperty(def.value, "name", {
            value: (0, _typeOfMjs.default)(key) === "symbol" ? "" : key,
            configurable: true,
        });
...
function _toElementDescriptors(elementObjects) {
    ...
    return (0, _toArrayMjs.default)(elementObjects).map(function (
        elementObject
    ) {
