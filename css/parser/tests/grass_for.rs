...
grass_error!(missing_dollar_sign, "@for", "Error: expected \"$\".");
grass_error!(
...
grass_error!(
    through_i32_max,
    "@for $i from 0 through 2147483647 {}",
    "Error: 2147483647 is not an int."
);
grass_error!(
    from_i32_max,
    "@for $i from 2147483647 through 0 {}",
    "Error: 2147483647 is not an int."
);
grass_error!(
    from_nan,
    "@for $i from (0/0) through 0 {}",
    "Error: NaN is not an int."
);
grass_error!(
    to_nan,
    "@for $i from 0 through (0/0) {}",
    "Error: NaN is not an int."
);
grass_error!(
    to_and_from_i32_min,
    "@for $i from -2147483648 through -2147483648 {}",
    "Error: -2147483648 is not an int."
);
