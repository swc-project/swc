...
grass_test!(selector_attribute_in, "[attr~=val] {\n  color: red;\n}\n");
grass_test!(
...
grass_error!(nothing_after_period, ". {}", "Error: Expected identifier.");
grass_error!(nothing_after_hash, "# {}", "Error: Expected identifier.");
grass_error!(nothing_after_percent, "% {}", "Error: Expected identifier.");
grass_error!(no_ident_after_colon, ": {}", "Error: Expected identifier.");
grass_error!(double_colon_no_space, "::{}", "Error: Expected identifier.");
grass_error!(
    non_ident_char_after_colon,
    ":#ab {}",
    "Error: Expected identifier."
);
grass_error!(nothing_after_colon, "a:{}", "Error: Expected identifier.");
grass_error!(
