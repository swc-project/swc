...
cargo set-version $version -p binding_core_wasm -p binding_minifier_wasm -p binding_typescript_wasm -p binding_nodejs_support_wasm -p binding_html_wasm -p binding_es_ast_viewer
