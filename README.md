...
- Giving developer time on the project. (Message us on [Github discussions](https://github.com/swc-project/swc/discussionsg) (preferred) or [Slack](https://swc-org.slack.com/) for guidance!)
