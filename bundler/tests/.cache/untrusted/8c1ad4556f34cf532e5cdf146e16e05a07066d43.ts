// Loaded from https://raw.githubusercontent.com/denjucks/dex/master/lib/deps/lodash@4.17.15/lodash.dew.js
    ...
    var runInContext = function runInContext(context) {
      ...
      function memoize(func, resolver) {
        ...
        var memoized = function () {
          var args = arguments,
              key = resolver ? resolver.apply(this || _global, args) : args[0],
      ...
      baseForOwn(LazyWrapper.prototype, function (func, methodName) {
        ...
        lodash.prototype[methodName] = function () {
          ...
          var chainAll = (this || _global).__chain__,
              isHybrid = !!(this || _global).__actions__.length,
