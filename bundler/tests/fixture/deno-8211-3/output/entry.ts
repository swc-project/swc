...
const mod = function() {
    ...
    class Duration {
        ...
        toISO() {
            ...
            if (this.seconds !== 0 || this.milliseconds !== 0) s += roundTo3(this.seconds + this.milliseconds / 1000, 3) + "S";
            if (s === "P") s += "T0S";
            return s;
        }
        toJSON() {
    ...
    class Interval {
        ...
        static fromISO(text, opts) {
            ...
            if (s && e) {
                ...
                try {
                    start = DateTime4.fromISO(s, opts);
                ...
                if (startIsValid) {
                    ...
                    const dur = Duration3.fromISO(s, opts);
                    if (dur.isValid) {
