...
///
/// The `scope_stack` parameter provides the current scope context during
/// traversal. The active scope is `scope_stack.last()`.
...
/// Walk a single statement mutably, calling visitor hooks and recursing into
/// children.
...
/// Walk an expression mutably, calling visitor hooks and recursing into
/// children.
