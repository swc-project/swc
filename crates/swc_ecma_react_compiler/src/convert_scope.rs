...
impl ScopeCollector {
    ...
    /// Visit a function's internals (params + body), creating the function
    /// scope. Used for method definitions and other Function nodes not
    /// covered by FnDecl/FnExpr.
...
impl<'a> ReferenceResolver<'a> {
    ...
    /// Visit function internals for the resolver (params + body), mirroring the
    /// collector.
    fn visit_function_inner(&mut self, function: &Function) {
        let func_start = function.span.lo.0;
