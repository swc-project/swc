...
use swc_common::{chain, pass::Repeat, SyntaxContext};
...
/// changes.
pub fn simplifier(top_level_ctxt: SyntaxContext, c: Config) -> impl RepeatedJsPass {
    Repeat::new(chain!(
        expr_simplifier(top_level_ctxt, c.expr),
