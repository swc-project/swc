...
//! and function call signatures for built-in objects, hooks, and user-defined
//! types.

use std::collections::HashMap;

use crate::{
    type_config::{AliasingEffectConfig, AliasingSignatureConfig, ValueKind, ValueReason},
    Effect, Type,
};
...
pub struct FunctionSignature {
    ...
    /// with Place values is deferred until the aliasing effects system is
    /// ported.
...
///   `build_builtin_shapes` / `build_default_globals` to construct the static
///   base.
