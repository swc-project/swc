...
pub struct TypeScriptOptions {
    ...
    /// ## Deprecated
    ///
    /// Allowing `declare` fields is built-in support in Oxc without any option.
    ...
    /// [`crate::CompilerAssumptions::set_public_class_fields`] to `true`.
    /// The `set_public_class_fields: true` +
