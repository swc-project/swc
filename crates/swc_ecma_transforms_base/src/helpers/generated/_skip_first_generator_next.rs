...
pub const DEF: HelperDef = HelperDef {
    name: HelperName::skip_first_generator_next,
    local: "_skip_first_generator_next",
    import_path: "@swc/helpers/_/_skip_first_generator_next",
    #[cfg(feature = "inline-helpers")]
    source: r#"function _skip_first_generator_next(fn) {
    return function() {
...
"#,
    #[cfg(feature = "inline-helpers")]
    deps: super::HelperBitmap::from_bits(0x00000000000040000000000000000000),
};
