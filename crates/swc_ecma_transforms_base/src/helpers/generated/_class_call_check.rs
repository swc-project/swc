...
pub const DEF: HelperDef = HelperDef {
    name: HelperName::class_call_check,
    local: "_class_call_check",
    import_path: "@swc/helpers/_/_class_call_check",
    #[cfg(feature = "inline-helpers")]
    source: r#"function _class_call_check(instance, Constructor) {
    if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
}
"#,
    #[cfg(feature = "inline-helpers")]
    deps: super::HelperBitmap::from_bits(0x00000000000000000000000000080000),
};
