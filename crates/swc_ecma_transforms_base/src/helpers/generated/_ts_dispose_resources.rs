...
pub const DEF: HelperDef = HelperDef {
    name: HelperName::ts_dispose_resources,
    local: "_ts_dispose_resources",
    import_path: "@swc/helpers/_/_ts_dispose_resources",
    #[cfg(feature = "inline-helpers")]
    source: r#"var _SuppressedError = typeof SuppressedError === "function" ? SuppressedError : function(error, suppressed, message) {
