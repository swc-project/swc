...
pub const DEF: HelperDef = HelperDef {
    name: HelperName::class_private_field_destructure,
    local: "_class_private_field_destructure",
    import_path: "@swc/helpers/_/_class_private_field_destructure",
    #[cfg(feature = "inline-helpers")]
    source: r#"function _class_private_field_destructure(receiver, privateMap) {
    var descriptor = _class_extract_field_descriptor(receiver, privateMap, "set");
    return _class_apply_descriptor_destructure(receiver, descriptor);
}
"#,
    #[cfg(feature = "inline-helpers")]
    deps: super::HelperBitmap::from_bits(0x00000000000000000000000001408000),
};
