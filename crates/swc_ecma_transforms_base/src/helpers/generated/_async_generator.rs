...
pub const DEF: HelperDef = HelperDef {
    name: HelperName::async_generator,
    local: "_async_generator",
    import_path: "@swc/helpers/_/_async_generator",
    #[cfg(feature = "inline-helpers")]
    source: r#"function _async_generator(gen) {
    var front, back;
...
"#,
    #[cfg(feature = "inline-helpers")]
    deps: super::HelperBitmap::from_bits(0x00000000000002000000000000000080),
};
