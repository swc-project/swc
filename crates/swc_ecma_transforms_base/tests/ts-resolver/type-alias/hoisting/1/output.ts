namespace Foo__2 {
    ...
    type NextFunction__4 = (err?: any) => void;
    export type SimpleHandleFunction__3 = (req: IncomingMessage__3, res: http.ServerResponse) => void;
    export type NextHandleFunction__3 = (req: IncomingMessage__3, res: http.ServerResponse, next: NextFunction__4) => void;
    export type ErrorHandleFunction__3 = (err: any, req: IncomingMessage__3, res: http.ServerResponse, next: NextFunction__4) => void;
