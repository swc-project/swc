...
use react_compiler_hir::{
    environment::Environment, DeclarationId, IdentifierId, IdentifierName, InstructionKind,
    InstructionValue, JsxTag, ParamPattern, Place, ReactiveBlock, ReactiveFunction,
...
/// Promotes temporary (unnamed) identifiers used in scopes to named
/// identifiers. TS: `promoteUsedTemporaries`
        ...
        ReactiveValue::Instruction(instr_value) => {
            ...
            match instr_value {
                ...
                | InstructionValue::ObjectMethod { lowered_func, .. } => {
                    ...
                    // Collect param IDs first to avoid borrow conflict
