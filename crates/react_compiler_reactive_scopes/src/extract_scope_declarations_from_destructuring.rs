...
use react_compiler_hir::{
    environment::Environment, visitors, DeclarationId, IdentifierId, IdentifierName,
    InstructionKind, InstructionValue, LValue, ParamPattern, Place, ReactiveFunction,
    ...
    fn transform_instruction(
        ...
        }) = &mut instruction.value
        {
            ...
            if !has_declaration {
                ...
                // Mixed: replace reassigned items with temporaries and emit separate
                // assignments
