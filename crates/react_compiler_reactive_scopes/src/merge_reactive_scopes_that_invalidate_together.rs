...
//! that share dependencies (and thus invalidate together) to reduce memoization
//! overhead.
//!
//! Corresponds to
...
/// Merges adjacent reactive scopes that share dependencies (invalidate
/// together). TS: `mergeReactiveScopesThatInvalidateTogether`
...
/// TS: `class Transform extends
/// ReactiveFunctionTransform<ReactiveScopeDependencies | null>`
...
/// Check if a type is always invalidating (guaranteed to change when inputs
/// change).
