...
use react_compiler_hir::{
    ...
    visitors as hir_visitors, EvaluationOrder, IdentifierId, InstructionValue, Place,
    PrunedReactiveScopeBlock, ReactiveFunction, ReactiveInstruction, ReactiveScopeBlock,
    ReactiveValue,
};
...
impl<'a> ReactiveFunctionVisitor for CollectVisitor<'a> {
    ...
    fn visit_lvalue(&self, id: EvaluationOrder, lvalue: &Place, state: &mut Self::State) {
        // Visitors don't visit lvalues as places by default, but we want to visit all
        // places
