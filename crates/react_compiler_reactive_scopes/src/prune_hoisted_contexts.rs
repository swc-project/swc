...
use react_compiler_hir::{
    environment::Environment, EvaluationOrder, IdentifierId, InstructionKind, InstructionValue,
    Place, ReactiveFunction, ReactiveInstruction, ReactiveScopeBlock, ReactiveStatement,
    ReactiveValue,
};
...
/// Corresponds to TS `convertHoistedLValueKind` — returns None for non-hoisted
/// kinds.
