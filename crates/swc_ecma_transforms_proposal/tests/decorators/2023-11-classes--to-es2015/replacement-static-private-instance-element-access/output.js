let _ref;
var _x, ___a_1, _a, _m, ____private_a_2, _Foo, _class;
let _initClass, _staticBlock;
const dec = ()=>{};
let hasX, hasA, hasM;
let _Foo1, _Foo_member;
new (_ref = (_x = /*#__PURE__*/ new WeakMap(), ___a_1 = /*#__PURE__*/ new WeakMap(), _a = /*#__PURE__*/ new WeakMap(), _m = /*#__PURE__*/ new WeakSet(), ____private_a_2 = /*#__PURE__*/ new WeakMap(), _Foo = class Foo {
    get a() {
    ...
    constructor(){
        super(_Foo1), _staticBlock.call(this), _initClass(), _Foo_member = _Foo1;
    }
