var ____private_accessor_1, _class;
...
new (____private_accessor_1 = /*#__PURE__*/ new WeakMap(), _class = class extends _identity {
    constructor(){
        super(_Foo), _class_private_field_init(this, ____private_accessor_1, {
            writable: true,
            value: (()=>{
    ...
    class Foo {
        static get accessor() {
            return _class_private_field_get(this, ____private_accessor_1);
        }
        static set accessor(_v) {
            _class_private_field_set(this, ____private_accessor_1, _v);
        }
        static get getter() {}
        static set setter(_) {}
        static method() {}
    ...
    (()=>{
        ({ e: [_init_accessor, _init_extra__init_accessor, _init_property, _init_extra__init_property, _initStatic], c: [_Foo, _initClass] } = _apply_decs_2311(Foo, [
            dec
        ], [
            [
                _dec,
