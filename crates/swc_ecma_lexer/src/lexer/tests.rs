...
trait WithSpan: Sized {
    ...
    fn into_token(self) -> TokenType;
}
impl WithSpan for TokenType {
    fn into_token(self) -> TokenType {
        self
    }
}
...
fn simple_regex() {
    ...
    assert_eq!(
        ...
        vec![
            TokenAndSpan {
                token: TokenType::BinOp(BinOpToken::Div),
                had_line_break: true,
                span: Span {
                    lo: BytePos(1),
                    hi: BytePos(2),
...
fn jsx_03() {
    assert_eq!(
        ...
        vec![
            ...
            //
            TokenType::JSXTagStart,
            TokenType::JSXName { name: "br".into() },
            tok!('/'),
            TokenType::JSXTagEnd,
            //
            TokenType::JSXTagStart,
...
fn jsx_04() {
    assert_eq!(
        ...
        vec![
            TokenType::Word(Word::Keyword(Yield)),
            TokenType::JSXTagStart,
            TokenType::JSXName { name: "a".into() },
            TokenType::JSXTagEnd,
            //
...
fn shebang() {
    assert_eq!(
        ...
        vec![TokenType::Shebang("/usr/bin/env node".into())]
    );
}
...
fn issue_191() {
    assert_eq!(
        ...
        vec![
            ...
            tok!("${"),
            TokenType::Word(Word::Ident("foo".into())),
            tok!('}'),
            TokenType::Template {
                raw: "<bar>".into(),
                cooked: Ok("<bar>".into()),
...
fn issue_299_01() {
    assert_eq!(
        ...
        vec![
            ...
            TokenType::JSXName { name: "num".into() },
            tok!('='),
            TokenType::Str {
                value: "\\ ".into(),
                raw: "'\\ '".into(),
