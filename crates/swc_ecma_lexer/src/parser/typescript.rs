...
use crate::{
    common::parser::{
        ...
        typescript::{
            ...
            parse_ts_this_type_node, parse_ts_this_type_predicate, parse_ts_tuple_type,
            parse_ts_type, parse_ts_type_alias_decl, parse_ts_type_args,
            parse_ts_type_member_semicolon, parse_ts_type_or_type_predicate_ann,
            parse_ts_type_params, parse_ts_type_ref, try_parse_ts, try_parse_ts_index_signature,
