...
bar
ↂωↂ`;const template_literal48=`This is ${undefined}`;const template_literal49=`This is ${NaN}`;const template_literal50=`This is ${null}`;const template_literal51=`This is ${Infinity}`;const template_literal60=`${4**11}`;const template_literal61=`Hello ${guest()}, welcome to ${location()}${"."}`;const template_literal62=`${1}${2}${3}${4}${5}${6}${7}${8}${9}${0}`;const template_literal63=`${foobar()}${foobar()}${foobar()}${foobar()}`;const template_literal64=`${1}${foobar()}${2}${foobar()}${3}${foobar()}`;const template_literal65="Decimals "+`${1}${2}${3}${4}${5}${6}${7}${8}${9}${0}`;const template_literal66=`${`${`${`foo`}`}`}`;const template_literal67=`before ${`innerBefore ${any} innerAfter`} after`;const template_literal68=`1 ${2+`3 ${any} 4`+5} 6`;const template_literal69=`</script>${content}`;const template_literal70=`<!--`;const template_literal71=`-->`;const template_literal72=`\u0020\u{20}\u{00020}\x20 `;console.log(`\\n\\r\\u2028\\u2029\n\r\u2028\u2029`);function a(){return`\
foo`}function b(){return`
bar`}function c(){return`\
baz`}function d(){return`qux`}function e(){return`\nfin`}function x(s){return s.raw[0]}console.log(String.raw`\u`);console.log(x`\u`);console.log(String.raw`\unicode \xerces \1234567890`);let z=()=>String.raw;console.log(z()`\4321\u\x`);var str=`foo ${"`;\n`${any}"} bar`;var concat=`foo ${any} bar`+"`;\n`${any}";var template=`foo ${"`;\n`${any}"} ${any} bar`;const template_weird=`\xb43`;const template_literal73=`'`;const template_literal74=`"`;const template_literal75="\u2028";const template_literal76="\u2029";const template_literal77="\uFEFF";const template_literal78=`\uD800`;const template_literal79=`\uDBFF`;const template_literal80=`\uDC00`;const template_literal81=`\uDFFF`
