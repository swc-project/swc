...
pub trait VisitMutHook {
    ...
    #[doc = "Called when entering a node of type `DocumentFragment` before visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn enter_document_fragment(&mut self, node: &mut DocumentFragment) {}
    #[doc = "Called when exiting a node of type `DocumentFragment` after visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn exit_document_fragment(&mut self, node: &mut DocumentFragment) {}
    ...
    #[doc = "Called when entering a node of type `Option < DocumentFragment >` before visiting its \
             children."]
    #[inline]
    #[allow(unused_variables)]
    fn enter_opt_document_fragment(&mut self, node: &mut Option<DocumentFragment>) {}
    #[doc = "Called when exiting a node of type `Option < DocumentFragment >` after visiting its \
             children."]
    #[inline]
    #[allow(unused_variables)]
    fn exit_opt_document_fragment(&mut self, node: &mut Option<DocumentFragment>) {}
    ...
    #[doc = "Called when entering a node of type `Option < Raw >` before visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn enter_opt_raw(&mut self, node: &mut Option<Raw>) {}
    #[doc = "Called when exiting a node of type `Option < Raw >` after visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn exit_opt_raw(&mut self, node: &mut Option<Raw>) {}
    #[doc = "Called when entering a node of type `Raw` before visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn enter_raw(&mut self, node: &mut Raw) {}
    #[doc = "Called when exiting a node of type `Raw` after visiting its children."]
    #[inline]
    #[allow(unused_variables)]
    fn exit_raw(&mut self, node: &mut Raw) {}
    ...
    B: VisitMutHook,
{
    ...
    #[inline]
    fn enter_document_fragment(&mut self, node: &mut DocumentFragment) {
        self.first.enter_document_fragment(node);
        self.second.enter_document_fragment(node);
    }

    #[inline]
    fn exit_document_fragment(&mut self, node: &mut DocumentFragment) {
        self.second.exit_document_fragment(node);
        self.first.exit_document_fragment(node);
    }
    ...
    #[inline]
    fn enter_opt_document_fragment(&mut self, node: &mut Option<DocumentFragment>) {
        self.first.enter_opt_document_fragment(node);
        self.second.enter_opt_document_fragment(node);
    }

    #[inline]
    fn exit_opt_document_fragment(&mut self, node: &mut Option<DocumentFragment>) {
        self.second.exit_opt_document_fragment(node);
        self.first.exit_opt_document_fragment(node);
    }
    ...
    #[inline]
    fn enter_opt_raw(&mut self, node: &mut Option<Raw>) {
        self.first.enter_opt_raw(node);
        self.second.enter_opt_raw(node);
    }

    #[inline]
    fn exit_opt_raw(&mut self, node: &mut Option<Raw>) {
        self.second.exit_opt_raw(node);
        self.first.exit_opt_raw(node);
    }

    #[inline]
    fn enter_raw(&mut self, node: &mut Raw) {
        self.first.enter_raw(node);
        self.second.enter_raw(node);
    }

    #[inline]
    fn exit_raw(&mut self, node: &mut Raw) {
        self.second.exit_raw(node);
        self.first.exit_raw(node);
    }
...
impl<H: VisitMutHook> VisitMut for VisitMutWithHook<H> {
    ...
    #[doc = "Visits a node of type `DocumentFragment` using the hook's enter and exit methods."]
    #[inline]
    fn visit_mut_document_fragment(&mut self, node: &mut DocumentFragment) {
        self.hook.enter_document_fragment(node);
        node.visit_mut_children_with(self);
        self.hook.exit_document_fragment(node);
    }
    ...
    #[doc = "Visits a node of type `Option < DocumentFragment >` using the hook's enter and exit \
             methods."]
    #[inline]
    fn visit_mut_opt_document_fragment(&mut self, node: &mut Option<DocumentFragment>) {
        self.hook.enter_opt_document_fragment(node);
        node.visit_mut_children_with(self);
        self.hook.exit_opt_document_fragment(node);
    }
    ...
    #[doc = "Visits a node of type `Option < Raw >` using the hook's enter and exit methods."]
    #[inline]
    fn visit_mut_opt_raw(&mut self, node: &mut Option<Raw>) {
        self.hook.enter_opt_raw(node);
        node.visit_mut_children_with(self);
        self.hook.exit_opt_raw(node);
    }

    #[doc = "Visits a node of type `Raw` using the hook's enter and exit methods."]
    #[inline]
    fn visit_mut_raw(&mut self, node: &mut Raw) {
        self.hook.enter_raw(node);
        node.visit_mut_children_with(self);
        self.hook.exit_raw(node);
    }
