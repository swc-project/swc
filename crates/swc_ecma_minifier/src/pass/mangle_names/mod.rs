...
use swc_common::Mark;
use swc_ecma_ast::*;
use swc_ecma_transforms_base::rename::{renamer, RenameIdMap, Renamer};
...
impl<'a> Renamer for ManglingRenamer<'a> {
    ...
    fn store_cache(&mut self, update: &RenameIdMap) {
