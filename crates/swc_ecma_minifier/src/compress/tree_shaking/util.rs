...
use swc_ecma_ast::{
    ...
    ExportDefaultDecl, ExportNamedSpecifier, ExportSpecifier, Expr, FnDecl, FnExpr, Function, Id,
    Ident, ImportSpecifier, MemberExpr, MemberProp, NamedExport, Param, Pat, PropName,
    VarDeclarator,
};
