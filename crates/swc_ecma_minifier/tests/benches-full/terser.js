                        ...
                        case "for":
                            return next(), function() {
                                ...
                                if (is("punc", ";")) await_tok && token_error(await_tok, for_await_error);
                                    ...
                                    var obj, init1, lhs, obj1, is_in = is("operator", "in"), is_of = is("name", "of");
                                    if (await_tok && !is_of && token_error(await_tok, for_await_error), is_in || is_of) {
                                        ...
                                        })) : (init1 = init, lhs = init1 instanceof AST_Definitions ? init1.definitions[0].name : null, obj1 = expression(!0), expect(")"), new AST_ForOf({
                                            await: !!await_tok,
                                            init: init1,
                                            name: lhs,
                                            object: obj1,
