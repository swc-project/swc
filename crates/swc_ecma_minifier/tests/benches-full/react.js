...
"production" !== process.env.NODE_ENV && function() {
    ...
    function Component(props1, context, updater) {
        this.props = props1, this.context = context, this.refs = emptyObject, this.updater = updater || ReactNoopUpdateQueue;
    }
    ...
    function PureComponent(props1, context, updater) {
        this.props = props1, this.context = context, this.refs = emptyObject, this.updater = updater || ReactNoopUpdateQueue;
    }
    ...
    function getComponentName(type) {
        ...
        if ('object' == typeof type) switch(type.$$typeof){
            ...
            case REACT_FORWARD_REF_TYPE:
                ...
                return innerType = type.render, wrapperName = 'ForwardRef', functionName = innerType.displayName || innerType.name || '', outerType.displayName || ('' !== functionName ? wrapperName + "(" + functionName + ")" : wrapperName);
    ...
    var ReactElement = function(type, key1, ref, self, source, owner, props1) {
        var element = {
    ...
    function createElement(type, config, children) {
        var propName, props1 = {}, key1 = null, ref = null, self = null, source = null;
        ...
        }(config)), hasValidKey(config) && (key1 = '' + config.key), self = void 0 === config.__self ? null : config.__self, source = void 0 === config.__source ? null : config.__source, config)hasOwnProperty.call(config, propName) && !RESERVED_PROPS.hasOwnProperty(propName) && (props1[propName] = config[propName]);
        var childrenLength = arguments.length - 2;
        if (1 === childrenLength) props1.children = children;
        else if (childrenLength > 1) {
            for(var childArray = Array(childrenLength), i = 0; i < childrenLength; i++)childArray[i] = arguments[i + 2];
            Object.freeze && Object.freeze(childArray), props1.children = childArray;
        }
        if (type && type.defaultProps) {
            var defaultProps = type.defaultProps;
            for(propName in defaultProps)void 0 === props1[propName] && (props1[propName] = defaultProps[propName]);
        }
        if (key1 || ref) {
            var warnAboutAccessingKey, warnAboutAccessingRef, displayName = 'function' == typeof type ? type.displayName || type.name || 'Unknown' : type;
            key1 && ((warnAboutAccessingKey = function() {
        ...
        return ReactElement(type, key1, ref, self, source, ReactCurrentOwner.current, props1);
    }
    function cloneElement(element, config, children) {
        if (!(null != element)) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + element + ".");
        var propName, defaultProps, props1 = _assign({}, element.props), key1 = element.key, ref = element.ref, self = element._self, source = element._source, owner = element._owner;
        if (null != config) for(propName in hasValidRef(config) && (ref = config.ref, owner = ReactCurrentOwner.current), hasValidKey(config) && (key1 = '' + config.key), element.type && element.type.defaultProps && (defaultProps = element.type.defaultProps), config)hasOwnProperty.call(config, propName) && !RESERVED_PROPS.hasOwnProperty(propName) && (props1[propName] = void 0 === config[propName] && void 0 !== defaultProps ? defaultProps[propName] : config[propName]);
        var childrenLength = arguments.length - 2;
        if (1 === childrenLength) props1.children = children;
        else if (childrenLength > 1) {
            for(var childArray = Array(childrenLength), i = 0; i < childrenLength; i++)childArray[i] = arguments[i + 2];
            props1.children = childArray;
        }
        return ReactElement(element.type, key1, ref, self, source, owner, props1);
    }
    ...
    function createElementWithValidation(type, props1, children) {
        ...
        return type === exports.Fragment ? function(fragment) {
            for(var keys = Object.keys(fragment.props), i = 0; i < keys.length; i++){
                var key1 = keys[i];
                if ('children' !== key1 && 'key' !== key1) {
                    setCurrentlyValidatingElement$1(fragment), error("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", key1), setCurrentlyValidatingElement$1(null);
                    break;
                }
            }
    ...
    }, exports.Component = Component, exports.PureComponent = PureComponent, exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ReactSharedInternals, exports.cloneElement = function(element, props1, children) {
