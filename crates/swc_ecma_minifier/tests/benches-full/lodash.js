(function() {
    ...
    var unescapeHtmlChar = basePropertyOf({
        ...
        function baseClone(value, bitmask, customizer, key, object, stack) {
            ...
            var keysFunc = 4 & bitmask ? isFlat ? getAllKeysIn : getAllKeys : isFlat ? keysIn : keys, props = isArr ? undefined : keysFunc(value);
