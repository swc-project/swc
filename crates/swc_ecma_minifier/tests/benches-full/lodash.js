(function() {
    ...
    var unescapeHtmlChar = basePropertyOf({
        ...
        function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
            ...
            if (data && function(data, source) {
            ...
            }(newData, data), func = newData[0], bitmask = newData[1], thisArg = newData[2], partials = newData[3], holders = newData[4], (arity = newData[9] = undefined === newData[9] ? isBindKey ? 0 : func.length : nativeMax(newData[9] - length, 0)) || !(24 & bitmask) || (bitmask &= -25), bitmask && 1 != bitmask) 8 == bitmask || 16 == bitmask ? (func1 = func, arity1 = arity, Ctor = createCtor(func1), result = function wrapper() {
                ...
                if ((length -= holders.length) < arity1) return createRecurry(func1, bitmask, createHybrid, wrapper.placeholder, undefined, args, holders, undefined, undefined, arity1 - length);
                var fn = this && this !== root && this instanceof wrapper ? Ctor : func1;
                return apply(fn, this, args);
            }) : 32 != bitmask && 33 != bitmask || holders.length ? result = createHybrid.apply(undefined, newData) : (func2 = func, partials1 = partials, isBind = 1 & bitmask, Ctor1 = createCtor(func2), result = function wrapper() {
            ...
            else var func1, arity1, Ctor, func2, partials1, isBind, Ctor1, func3, isBind1, Ctor2, result = (func3 = func, isBind1 = 1 & bitmask, Ctor2 = createCtor(func3), function wrapper() {
                return (this && this !== root && this instanceof wrapper ? Ctor2 : func3).apply(isBind1 ? thisArg : this, arguments);
            });
        ...
        var result, cache, stringToPath = (cache = (result = memoize(function(string) {
            var result = [];
