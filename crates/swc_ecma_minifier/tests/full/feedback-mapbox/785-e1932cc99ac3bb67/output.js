(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[785],{/***/840:/***/function(t,e,n){var r;!/*! Hammer.JS - v2.0.7 - 2016-04-22
             ...
             * Licensed under the MIT license */function(i,o,a,s){"use strict";var c,u=["","webkit","Moz","MS","ms","o"],l=o.createElement("div"),h=Math.round,p=Math.abs,f=Date.now;/**
                 ...
                 */function R(t){var e=t.ownerDocument||t;return e.defaultView||e.parentWindow||i}var A="ontouchstart"in i,I=D(i,"PointerEvent")!==s,L=A&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),N="touch",z="mouse",F=2|4,V=8|16,Z=2|4|(8|16),B=["x","y"],U=["clientX","clientY"];/**
                 * create new input type manager
                 * @param {Manager} manager
                 * @param {Function} callback
                 * @returns {Input}
                 * @constructor
                 */function q(t,e){var n=this;this.manager=t,this.callback=e,this.element=t.element,this.target=t.options.inputTarget,// smaller wrapper around the handler, for the scope and the enabled state of the manager,
...
this.domHandler=function(e){E(t.options.enable,[t])&&n.handler(e)},this.init()}/**
                 ...
                 * @param {Object} input
                 */function W(t,e,n){var r,i,o,a,c,u,l,h,d,v,g,m,b,y,w,O=n.pointers.length,E=n.changedPointers.length,_=1&e&&O-E==0,P=e&(4|8)&&O-E==0;n.isFirst=!!_,n.isFinal=!!P,_&&(t.session={}),// source event is the normalized value of the domEvents
// like 'touchstart, mouseup, pointerdown'
n.eventType=e,r=t.session,o=(i=n.pointers).length,r.firstInput||(r.firstInput=H(n)),o>1&&!r.firstMultiple?r.firstMultiple=H(n):1===o&&(r.firstMultiple=!1),a=r.firstInput,u=(c=r.firstMultiple)?c.center:a.center,l=n.center=X(i),n.timeStamp=f(),n.deltaTime=n.timeStamp-a.timeStamp,n.angle=$(u,l),n.distance=G(u,l),h=n.center,d=r.offsetDelta||{},v=r.prevDelta||{},g=r.prevInput||{},(1===n.eventType||4===g.eventType)&&(v=r.prevDelta={x:g.deltaX||0,y:g.deltaY||0},d=r.offsetDelta={x:h.x,y:h.y}),n.deltaX=v.x+(h.x-d.x),n.deltaY=v.y+(h.y-d.y),n.offsetDirection=K(n.deltaX,n.deltaY),m=Y(n.deltaTime,n.deltaX,n.deltaY),n.overallVelocityX=m.x,n.overallVelocityY=m.y,n.overallVelocity=p(m.x)>p(m.y)?m.x:m.y,n.scale=c?(b=c.pointers,G(i[0],i[1],U)/G(b[0],b[1],U)):1,n.rotation=c?(y=c.pointers,$(i[1],i[0],U)+$(y[1],y[0],U)):0,n.maxPointers=r.prevInput?n.pointers.length>r.prevInput.maxPointers?n.pointers.length:r.prevInput.maxPointers:n.pointers.length,/**
                 * velocity is calculated every x ms
                 * @param {Object} session
                 * @param {Object} input
                 */function(t,e){var n,r,i,o,a=t.lastInterval||e,c=e.timeStamp-a.timeStamp;if(8!=e.eventType&&(c>25||a.velocity===s)){var u=e.deltaX-a.deltaX,l=e.deltaY-a.deltaY,h=Y(c,u,l);r=h.x,i=h.y,n=p(h.x)>p(h.y)?h.x:h.y,o=K(u,l),t.lastInterval=e}else // use latest velocity info if it doesn't overtake a minimum period
...
var e=[],n=0;n<t.pointers.length;)e[n]={clientX:h(t.pointers[n].clientX),clientY:h(t.pointers[n].clientY)},n++;return{timeStamp:f(),pointers:e,center:X(e),deltaX:t.deltaX,deltaY:t.deltaY}}/**
                 * get the center of all the pointers
                 * @param {Array} pointers
                 * @return {Object} center contains `x` and `y` properties
                 */function X(t){var e=t.length;// no need to loop when only one touch
if(1===e)return{x:h(t[0].clientX),y:h(t[0].clientY)};for(var n=0,r=0,i=0;i<e;)n+=t[i].clientX,r+=t[i].clientY,i++;return{x:h(n/e),y:h(r/e)}}/**
                 ...
                 */function Y(t,e,n){return{x:e/t||0,y:n/t||0}}/**
                 * get the direction between two points
                 * @param {Number} x
                 * @param {Number} y
                 * @return {Number} direction
                 */function K(t,e){return t===e?1:p(t)>=p(e)?t<0?2:4:e<0?8:16}/**
                 * calculate the absolute distance between two points
                 * @param {Object} p1 {x, y}
                 * @param {Object} p2 {x, y}
                 * @param {Array} [props] containing x and y keys
                 * @return {Number} distance
                 */function G(t,e,n){n||(n=B);var r=e[n[0]]-t[n[0]],i=e[n[1]]-t[n[1]];return Math.sqrt(r*r+i*i)}/**
                 * calculate the angle between two coordinates
                 * @param {Object} p1
                 * @param {Object} p2
                 * @param {Array} [props] containing x and y keys
                 * @return {Number} angle
                 */function $(t,e,n){n||(n=B);var r=e[n[0]]-t[n[0]];return 180*Math.atan2(e[n[1]]-t[n[1]],r)/Math.PI}q.prototype={/**
                     ...
                     * unbind the events
                     */destroy:function(){this.evEl&&P(this.element,this.evEl,this.domHandler),this.evTarget&&P(this.target,this.evTarget,this.domHandler),this.evWin&&P(R(this.element),this.evWin,this.domHandler)}};var J={mousedown:1,mousemove:2,mouseup:4};/**
                 * Mouse events input
                 * @constructor
                 * @extends Input
                 */function Q(){this.evEl="mousedown",this.evWin="mousemove mouseup",this.pressed=!1,q.apply(this,arguments)}w(Q,q,{/**
                     * handle mouse events
                     * @param {Object} ev
                     */handler:function(t){var e=J[t.type];// mouse must be down
1&e&&0===t.button&&(this.pressed=!0),2&e&&1!==t.which&&(e=4),this.pressed&&(4&e&&(this.pressed=!1),this.callback(this.manager,e,{pointers:[t],changedPointers:[t],pointerType:z,srcEvent:t}))}});var tt={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},te={2:N,3:"pen",4:z,5:"kinect"},tn="pointerdown",tr="pointermove pointerup pointercancel";/**
                 * Pointer events input
                 * @constructor
                 * @extends Input
                 */function ti(){this.evEl=tn,this.evWin=tr,q.apply(this,arguments),this.store=this.manager.session.pointerEvents=[]}i.MSPointerEvent&&!i.PointerEvent&&(tn="MSPointerDown",tr="MSPointerMove MSPointerUp MSPointerCancel"),w(ti,q,{/**
                     * handle mouse events
                     * @param {Object} ev
                     */handler:function(t){var e=this.store,n=!1,r=tt[t.type.toLowerCase().replace("ms","")],i=te[t.pointerType]||t.pointerType,o=i==N,a=T(e,t.pointerId,"pointerId");// it not found, so the pointer hasn't been down (so it's probably a hover)
1&r&&(0===t.button||o)?a<0&&(e.push(t),a=e.length-1):r&(4|8)&&(n=!0),!(a<0)&&(// update the event in the store
e[a]=t,this.callback(this.manager,r,{pointers:e,changedPointers:[t],pointerType:i,srcEvent:t}),n&&// remove from the store
e.splice(a,1))}});var to={touchstart:1,touchmove:2,touchend:4,touchcancel:8};/**
                 * Touch events input
                 * @constructor
                 * @extends Input
                 */function ta(){this.evTarget="touchstart",this.evWin="touchstart touchmove touchend touchcancel",this.started=!1,q.apply(this,arguments)}/**
                 * @this {TouchInput}
                 * @param {Object} ev
                 * @param {Number} type flag
                 * @returns {undefined|Array} [all, changed]
                 */function ts(t,e){var n=k(t.touches),r=k(t.changedTouches);return e&(4|8)&&(n=x(n.concat(r),"identifier",!0)),[n,r]}w(ta,q,{handler:function(t){var e=to[t.type];if(1===e&&(this.started=!0),this.started){var n=ts.call(this,t,e);e&(4|8)&&n[0].length-n[1].length==0&&(this.started=!1),this.callback(this.manager,e,{pointers:n[0],changedPointers:n[1],pointerType:N,srcEvent:t})}}});var tc={touchstart:1,touchmove:2,touchend:4,touchcancel:8};/**
                 * Multi-user touch events input
                 * @constructor
                 * @extends Input
                 */function tu(){this.evTarget="touchstart touchmove touchend touchcancel",this.targetIds={},q.apply(this,arguments)}/**
                 * @this {TouchInput}
                 * @param {Object} ev
                 * @param {Number} type flag
                 * @returns {undefined|Array} [all, changed]
                 */function tl(t,e){var n=k(t.touches),r=this.targetIds;// when there is only one touch, the process can be simplified
if(e&(1|2)&&1===n.length)return r[n[0].identifier]=!0,[n,n];var i,o,a=k(t.changedTouches),s=[],c=this.target;// collect touches
...
i=0;i<a.length;)r[a[i].identifier]&&s.push(a[i]),e&(4|8)&&delete r[a[i].identifier],i++;if(s.length)return[// merge targetTouches with changedTargetTouches so it contains ALL touches, including 'end' and 'cancel'
x(o.concat(s),"identifier",!0),s]}function th(){q.apply(this,arguments);var t=O(this.handler,this);this.touch=new tu(this.manager,t),this.mouse=new Q(this.manager,t),this.primaryTouch=null,this.lastTouches=[]}function tp(t,e){1&t?(this.primaryTouch=e.changedPointers[0].identifier,tf.call(this,e)):t&(4|8)&&tf.call(this,e)}function tf(t){var e=t.changedPointers[0];if(e.identifier===this.primaryTouch){var n={x:e.clientX,y:e.clientY};this.lastTouches.push(n);var r=this.lastTouches;setTimeout(function(){var t=r.indexOf(n);t>-1&&r.splice(t,1)},2500)}}function td(t){for(var e=t.srcEvent.clientX,n=t.srcEvent.clientY,r=0;r<this.lastTouches.length;r++){var i=this.lastTouches[r],o=Math.abs(e-i.x),a=Math.abs(n-i.y);if(o<=25&&a<=25)return!0}return!1}w(tu,q,{handler:function(t){var e=tc[t.type],n=tl.call(this,t,e);n&&this.callback(this.manager,e,{pointers:n[0],changedPointers:n[1],pointerType:N,srcEvent:t})}}),w(th,q,{/**
...
if(r)tp.call(this,e,n);else if(i&&td.call(this,n))return;this.callback(t,e,n)}},/**
                     * remove the event listeners
                     */destroy:function(){this.touch.destroy(),this.mouse.destroy()}});var tv=D(l.style,"touchAction"),tg=s!==tv,tm="compute",tb="auto",ty="manipulation",tw="none",tO="pan-x",tE="pan-y",t_=function(){if(!tg)return!1;var t={},e=i.CSS&&i.CSS.supports;return["auto","manipulation","pan-y","pan-x","pan-x pan-y","none"].forEach(function(n){// If css.supports is not supported but there is native touch-action assume it supports
...
t[n]=!e||i.CSS.supports("touch-action",n)}),t}();/**
                 ...
                 * @param {String} value
                 * @constructor
                 */function tP(t,e){this.manager=t,this.set(e)}/**
                 * Recognizer
                 * Every recognizer needs to extend from this class.
                 * @constructor
                 * @param {Object} options
                 */function tM(t){var e;this.options=c({},this.defaults,t||{}),this.id=C++,this.manager=null,// default is enable true
this.options.enable=s===(e=this.options.enable)||e,this.state=1,this.simultaneous={},this.requireFail=[]}/**
                 * get a usable string, used as event postfix
                 * @param {Const} state
                 * @returns {String} state
                 */function tj(t){return 16&t?"cancel":8&t?"end":4&t?"move":2&t?"start":""}/**
                 * direction cons to string
                 * @param {Const} direction
                 * @returns {String}
                 */function tS(t){return 16==t?"down":8==t?"up":2==t?"left":4==t?"right":""}/**
                 * get a recognizer by name if it is bound to a manager
                 * @param {Recognizer|String} otherRecognizer
                 * @param {Recognizer} recognizer
                 * @returns {Recognizer}
                 */function tT(t,e){var n=e.manager;return n?n.get(t):t}/**
                 * This recognizer is just used as a base for the simple attribute recognizers.
                 * @constructor
                 * @extends Recognizer
                 */function tk(){tM.apply(this,arguments)}/**
                 * Pan
                 * Recognized when the pointer is down and moved in the allowed direction.
                 * @constructor
                 * @extends AttrRecognizer
                 */function tx(){tk.apply(this,arguments),this.pX=null,this.pY=null}/**
                 * Pinch
                 ...
                 * @constructor
                 * @extends Recognizer
                 */function tC(){tM.apply(this,arguments),this._timer=null,this._input=null}/**
                 * Rotate
                 * Recognized when two or more pointer are moving in a circular motion.
                 * @constructor
                 * @extends AttrRecognizer
                 */function tR(){tk.apply(this,arguments)}/**
                 * Swipe
                 * Recognized when the pointer is moving fast (velocity), with enough distance in the allowed direction.
                 * @constructor
                 * @extends AttrRecognizer
                 */function tA(){tk.apply(this,arguments)}/**
                 ...
                 * @constructor
                 * @extends Recognizer
                 */function tI(){tM.apply(this,arguments),// previous time and center,
...
this.pTime=!1,this.pCenter=!1,this._timer=null,this._input=null,this.count=0}/**
                 ...
                 * @param {Object} [options]
                 * @constructor
                 */function tL(t,e){var n,r;return(e=e||{}).recognizers=(n=e.recognizers,r=tL.defaults.preset,s===n?r:n),new tN(t,e)}/**
                 * Manager
                 * @param {HTMLElement} element
                 * @param {Object} [options]
                 * @constructor
                 */function tN(t,e){var n;this.options=c({},tL.defaults,e||{}),this.options.inputTarget=this.options.inputTarget||t,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=t,this.input=new((n=this.options.inputClass)?n:I?ti:L?tu:A?th:Q)(this,W),this.touchAction=new tP(this,this.options.touchAction),tz(this,!0),g(this.options.recognizers,function(t){var e=this.add(new t[0](t[1]));t[2]&&e.recognizeWith(t[2]),t[3]&&e.requireFailure(t[3])},this)}/**
                 * add/remove the css properties as defined in manager.options.cssProps
                 * @param {Manager} manager
                 * @param {Boolean} add
                 */function tz(t,e){var n,r=t.element;r.style&&(g(t.options.cssProps,function(i,o){n=D(r.style,o),e?(t.oldCssProps[n]=r.style[n],r.style[n]=i):r.style[n]=t.oldCssProps[n]||""}),e||(t.oldCssProps={}))}tP.prototype={/**
                     * set the touchAction value on the element or enable the polyfill
                     * @param {String} value
                     */set:function(t){t==tm&&(t=this.compute()),tg&&this.manager.element.style&&t_[t]&&(this.manager.element.style[tv]=t),this.actions=t.toLowerCase().trim()},/**
                 ...
                 * @returns {*}
                 */function(t){// none
if(j(t,tw))return tw;var e=j(t,tO),n=j(t,tE);return(// if both pan-x and pan-y are set (different recognizers
// for different directions, e.g. horizontal pan but vertical swipe?)
// we need none (as otherwise with pan-x pan-y combined none of these
// recognizers will work, since the browser would handle all panning
e&&n?tw:e||n?e?tO:tE:j(t,ty)?ty:tb)}(t.join(" "))},/**
...
if(this.manager.session.prevented){e.preventDefault();return}var r=this.actions,i=j(r,tw)&&!t_[tw],o=j(r,tE)&&!t_[tE],a=j(r,tO)&&!t_[tO];if(i){//do not prevent defaults if this is a tap gesture
var s=1===t.pointers.length,c=t.distance<2,u=t.deltaTime<250;if(s&&c&&u)return}if((!a||!o)&&(i||o&&n&F||a&&n&V))return this.preventSrc(e)},/**
                     * call preventDefault to prevent the browser's default behavior (scrolling in most cases)
                     * @param {Object} srcEvent
                     */preventSrc:function(t){this.manager.session.prevented=!0,t.preventDefault()}},tM.prototype={/**
                     * @virtual
                     * @type {Object}
                     */defaults:{},/**
                     * set options
...
this.manager&&this.manager.touchAction.update(),this},/**
                     ...
                     */recognizeWith:function(t){if(v(t,"recognizeWith",this))return this;var e=this.simultaneous;return e[(t=tT(t,this)).id]||(e[t.id]=t,t.recognizeWith(this)),this},/**
                     * drop the simultaneous link. it doesnt remove the link on the other recognizer.
                     * @param {Recognizer} otherRecognizer
                     * @returns {Recognizer} this
                     */dropRecognizeWith:function(t){return v(t,"dropRecognizeWith",this)||(t=tT(t,this),delete this.simultaneous[t.id]),this},/**
                     * recognizer can only run when an other is failing
                     * @param {Recognizer} otherRecognizer
                     * @returns {Recognizer} this
                     */requireFailure:function(t){if(v(t,"requireFailure",this))return this;var e=this.requireFail;return T(e,t=tT(t,this))===-1&&(e.push(t),t.requireFailure(this)),this},/**
                     * drop the requireFailure link. it does not remove the link on the other recognizer.
                     * @param {Recognizer} otherRecognizer
                     * @returns {Recognizer} this
                     */dropRequireFailure:function(t){if(v(t,"dropRequireFailure",this))return this;t=tT(t,this);var e=T(this.requireFail,t);return e>-1&&this.requireFail.splice(e,1),this},/**
                     ...
                     * @param {Object} input
                     */emit:function(t){var e=this,n=this.state;function r(n){e.manager.emit(n,t)}n<8&&r(e.options.event+tj(n)),r(e.options.event),t.additionalEvent&&// additional event(panleft, panright, pinchin, pinchout...)
r(t.additionalEvent),n>=8&&r(e.options.event+tj(n))},/**
...
this.state=32},/**
                     * can we emit?
                     * @returns {boolean}
                     */canEmit:function(){for(var t=0;t<this.requireFail.length;){if(!(this.requireFail[t].state&(32|1)))return!1;t++}return!0},/**
                     * update the recognizer
                     * @param {Object} inputData
                     */recognize:function(t){// make a new copy of the inputData
// so we can change the inputData without messing up the other recognizers
var e=c({},t);// is is enabled and allow recognizing?
if(!E(this.options.enable,[this,e])){this.reset(),this.state=32;return}this.state&(8|16|32)&&(this.state=1),this.state=this.process(e),this.state&(2|4|8|16)&&this.tryEmit(e)},/**
                     ...
                     * @param {Object} input
                     * @returns {*} State
                     */process:function(t){var e=this.state,n=t.eventType,r=e&(2|4),i=this.attrTest(t);return(// on cancel input and we've recognized before, return STATE_CANCELLED
r&&(8&n||!i)?16|e:r||i?4&n?8|e:2&e?4|e:2:32)}}),w(tx,tk,{/**
                     * @namespace
                     * @memberof PanRecognizer
                     */defaults:{event:"pan",threshold:10,pointers:1,direction:Z},getTouchAction:function(){var t=this.options.direction,e=[];return t&F&&e.push(tE),t&V&&e.push(tO),e},directionTest:function(t){var e=this.options,n=!0,r=t.distance,i=t.direction,o=t.deltaX,a=t.deltaY;return i&e.direction||(e.direction&F?(i=0===o?1:o<0?2:4,n=o!=this.pX,r=Math.abs(t.deltaX)):(i=0===a?1:a<0?8:16,n=a!=this.pY,r=Math.abs(t.deltaY))),t.direction=i,n&&r>e.threshold&&i&e.direction},attrTest:function(t){return tk.prototype.attrTest.call(this,t)&&(2&this.state||!(2&this.state)&&this.directionTest(t))},emit:function(t){this.pX=t.deltaX,this.pY=t.deltaY;var e=tS(t.direction);e&&(t.additionalEvent=this.options.event+e),this._super.emit.call(this,t)}}),w(tD,tk,{/**
                     * @namespace
                     * @memberof PinchRecognizer
                     */defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return[tw]},attrTest:function(t){return this._super.attrTest.call(this,t)&&(Math.abs(t.scale-1)>this.options.threshold||2&this.state)},emit:function(t){if(1!==t.scale){var e=t.scale<1?"in":"out";t.additionalEvent=this.options.event+e}this._super.emit.call(this,t)}}),w(tC,tM,{/**
                     * @namespace
                     * @memberof PressRecognizer
                     */defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return[tb]},process:function(t){var e=this.options,n=t.pointers.length===e.pointers,r=t.distance<e.threshold,i=t.deltaTime>e.time;// we only allow little movement
// and we've reached an end event, so a tap is possible
if(this._input=t,r&&n&&(!(t.eventType&(4|8))||i)){if(1&t.eventType)this.reset(),this._timer=d(function(){this.state=8,this.tryEmit()},e.time,this);else if(4&t.eventType)return 8}else this.reset();return 32},reset:function(){clearTimeout(this._timer)},emit:function(t){8===this.state&&(t&&4&t.eventType?this.manager.emit(this.options.event+"up",t):(this._input.timeStamp=f(),this.manager.emit(this.options.event,this._input)))}}),w(tR,tk,{/**
                     * @namespace
                     * @memberof RotateRecognizer
                     */defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return[tw]},attrTest:function(t){return this._super.attrTest.call(this,t)&&(Math.abs(t.rotation)>this.options.threshold||2&this.state)}}),w(tA,tk,{/**
                     * @namespace
                     * @memberof SwipeRecognizer
                     */defaults:{event:"swipe",threshold:10,velocity:.3,direction:F|V,pointers:1},getTouchAction:function(){return tx.prototype.getTouchAction.call(this)},attrTest:function(t){var e,n=this.options.direction;return n&(F|V)?e=t.overallVelocity:n&F?e=t.overallVelocityX:n&V&&(e=t.overallVelocityY),this._super.attrTest.call(this,t)&&n&t.offsetDirection&&t.distance>this.options.threshold&&t.maxPointers==this.options.pointers&&p(e)>this.options.velocity&&4&t.eventType},emit:function(t){var e=tS(t.offsetDirection);e&&this.manager.emit(this.options.event+e,t),this.manager.emit(this.options.event,t)}}),w(tI,tM,{/**
                     * @namespace
                     * @memberof PinchRecognizer
                     */defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return[ty]},process:function(t){var e=this.options,n=t.pointers.length===e.pointers,r=t.distance<e.threshold,i=t.deltaTime<e.time;if(this.reset(),1&t.eventType&&0===this.count)return this.failTimeout();// we only allow little movement
// and we've reached an end event, so a tap is possible
...
[tR,{enable:!1}],[tD,{enable:!1},["rotate"]],[tA,{direction:F}],[tx,{direction:F},["swipe"]],[tI],[tI,{event:"doubletap",taps:2},["tap"]],[tC]],/**
                     ...
                     */cssProps:{/**
                         ...
                         */tapHighlightColor:"rgba(0,0,0,0)"}},tN.prototype={/**
                     * set options
                     * @param {Object} options
                     * @returns {Manager}
...
e.recognize(t):e.reset(),!i&&e.state&(2|4|8)&&(i=n.curRecognizer=e),o++}},/**
                     * get a recognizer by its event name.
                     * @param {Recognizer|String} recognizer
                     * @returns {Recognizer|Null}
                     */get:function(t){if(t instanceof tM)return t;for(var e=this.recognizers,n=0;n<e.length;n++)if(e[n].options.event==t)return e[n];return null},/**
...
if(t=this.get(t)){var e=this.recognizers,n=T(e,t);n!==-1&&(e.splice(n,1),this.touchAction.update())}return this},/**
                     * bind event
                     * @param {String} events
                     * @param {Function} handler
...
var n,r=this.handlers[t]&&this.handlers[t].slice();if(r&&r.length){e.type=t,e.preventDefault=function(){e.srcEvent.preventDefault()};for(var i=0;i<r.length;)r[i](e),i++}},/**
                     ...
                     */destroy:function(){this.element&&tz(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null}},c(tL,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:F,DIRECTION_VERTICAL:V,DIRECTION_ALL:Z,Manager:tN,Input:q,TouchAction:tP,TouchInput:tu,MouseInput:Q,PointerEventInput:ti,TouchMouseInput:th,SingleTouchInput:ta,Recognizer:tM,AttrRecognizer:tk,Tap:tI,Pan:tx,Swipe:tA,Pinch:tD,Rotate:tR,Press:tC,on:_,off:P,each:g,merge:y,extend:b,assign:c,inherit:w,bindFn:O,prefixed:D}),(void 0!==i?i:"undefined"!=typeof self?self:{}).Hammer=tL,s!==(r=(function(){return tL}).call(e,n,e,t))&&(t.exports=r)}(window,document,0);/***/},/***/3454:/***/function(t,e,n){"use strict";var r,i;t.exports=(null===(r=n.g.process)||void 0===r?void 0:r.env)&&"object"==typeof(null===(i=n.g.process)||void 0===i?void 0:i.env)?n.g.process:n(7663);//# sourceMappingURL=process.js.map
...
function({width:t,height:e,bounds:n,minExtent:r=0,maxZoom:i=24,padding:o=0,offset:a=[0,0]}){var s,c;const[[u,l],[h,p]]=n;if(Number.isFinite(o)){const t=o;o={top:t,bottom:t,left:t,right:t}}else M(Number.isFinite(o.top)&&Number.isFinite(o.bottom)&&Number.isFinite(o.left)&&Number.isFinite(o.right));const f=D([u,p<(s=-85.051129)?s:p>85.051129?85.051129:p]),d=D([h,l<(c=-85.051129)?c:l>85.051129?85.051129:l]),v=[Math.max(Math.abs(d[0]-f[0]),r),Math.max(Math.abs(d[1]-f[1]),r)],g=[t-o.left-o.right-2*Math.abs(a[0]),e-o.top-o.bottom-2*Math.abs(a[1])];M(g[0]>0&&g[1]>0);const m=g[0]/v[0],y=g[1]/v[1],w=(o.right-o.left)/2/m,O=(o.bottom-o.top)/2/y,E=C([(d[0]+f[0])/2+w,(d[1]+f[1])/2+O]),_=Math.min(i,b(Math.abs(Math.min(m,y))));return M(Number.isFinite(_)),{longitude:E[0],latitude:E[1],zoom:_}}// CONCATENATED MODULE: ./node_modules/@math.gl/web-mercator/dist/esm/get-bounds.js
...
var t4={longitude:1,bearing:1};function t5(t){return Number.isFinite(t)||Array.isArray(t)}function t3(t,e,n){return t in t4&&Math.abs(n-e)>180&&(n=n<0?n+360:n-360),n}// CONCATENATED MODULE: ./node_modules/react-map-gl/dist/esm/utils/transition/viewport-fly-to-interpolator.js
...
())}a&&m(a)}),b();var y=t.width,w=t.height,O=t.style,E=t.getCursor,_=h.useMemo(function(){return e3(e3({position:"relative"},O),{},{width:y,height:w,cursor:E(f.state)})},[O,y,w,E,f.state]);return n&&f._child||(f._child=h.createElement(tN,{value:g},h.createElement("div",{key:"event-canvas",ref:l,style:_},h.createElement(tY,r({},t,{width:"100%",height:"100%",style:null,onResize:function(t){var e=t.width,n=t.height;f.width=e,f.height=n,b(),f.props.onResize({width:e,height:n})},ref:p}))))),d=!1,f._child});no.supported=tY.supported,no.propTypes=e8,no.defaultProps=e6;/* harmony default export */var na=no;// CONCATENATED MODULE: ./node_modules/react-map-gl/dist/esm/utils/deep-equal.js
...
var ns={captureScroll:!1,captureDrag:!0,captureClick:!0,captureDoubleClick:!0,capturePointerMove:!1},nc={captureScroll:p.bool,captureDrag:p.bool,captureClick:p.bool,captureDoubleClick:p.bool,capturePointerMove:p.bool};function nu(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=h.useContext(tL),n=h.useRef(null),r=h.useRef({props:t,state:{},context:e,containerRef:n}).current;return r.props=t,r.context=e,h.useEffect(function(){return function(t){var e=t.containerRef.current,n=t.context.eventManager;if(e&&n){var r={wheel:function(e){var n=t.props;n.captureScroll&&e.stopPropagation(),n.onScroll&&n.onScroll(e,t)},panstart:function(e){var n=t.props;n.captureDrag&&e.stopPropagation(),n.onDragStart&&n.onDragStart(e,t)},anyclick:function(e){var n=t.props;n.captureClick&&e.stopPropagation(),n.onNativeClick&&n.onNativeClick(e,t)},click:function(e){var n=t.props;n.captureClick&&e.stopPropagation(),n.onClick&&n.onClick(e,t)},dblclick:function(e){var n=t.props;n.captureDoubleClick&&e.stopPropagation(),n.onDoubleClick&&n.onDoubleClick(e,t)},pointermove:function(e){var n=t.props;n.capturePointerMove&&e.stopPropagation(),n.onPointerMove&&n.onPointerMove(e,t)}};return n.watch(r,e),function(){n.off(r)}}}(r)},[e.eventManager]),r}// CONCATENATED MODULE: ./node_modules/react-map-gl/dist/esm/components/base-control.js
function nl(t){var e=t.instance,n=nu(t),r=n.context,i=n.containerRef;return e._context=r,e._containerRef=i,e._render()}var nh=function(t){tQ(i,t);var e,n=(e=function(){if("undefined"==typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(t){return!1}}(),function(){var t,n=t2(i);return t=e?Reflect.construct(n,arguments,t2(this).constructor):n.apply(this,arguments),t1(this,t)});function i(){var t;tc(this,i);for(var e=arguments.length,r=Array(e),o=0;o<e;o++)r[o]=arguments[o];return a(t$(t=n.call.apply(n,[this].concat(r))),"_context",{}),a(t$(t),"_containerRef",h.createRef()),a(t$(t),"_onScroll",function(t){}),a(t$(t),"_onDragStart",function(t){}),a(t$(t),"_onDblClick",function(t){}),a(t$(t),"_onClick",function(t){}),a(t$(t),"_onPointerMove",function(t){}),t}return tl(i,[{key:"_render",value:function(){throw Error("_render() not implemented")}},{key:"render",value:function(){return h.createElement(nl,r({instance:this},this.props,{onScroll:this._onScroll,onDragStart:this._onDragStart,onDblClick:this._onDblClick,onClick:this._onClick,onPointerMove:this._onPointerMove}))}}]),i}(h.PureComponent);//# sourceMappingURL=base-control.js.map
