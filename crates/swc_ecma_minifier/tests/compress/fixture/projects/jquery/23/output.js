export const obj = {
    style: function(elem, name, value, extra) {
        ...
        if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
            ...
            if ("number" !== type || jQuery.cssNumber[origName] || (value += "px"), jQuery.support.clearCloneStyle || "" !== value || 0 !== name.indexOf("background") || (style[name] = "inherit"), !hooks || !("set" in hooks) || void 0 !== (value = hooks.set(elem, value, extra))) try {
                style[name] = value;
            } catch (e) {}
        }
    }
