"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[717],{
...
// EXTERNAL MODULE: ./node_modules/.pnpm/next@12.0.8-canary.20_react-dom@17.0.2+react@17.0.2/node_modules/next/dist/compiled/regenerator-runtime/runtime.js
var runtime = __webpack_require__(7991);
...
function transform(param) {
    ...
    try {
        return (0,ts_results_esm.Ok)(swc.transformSync(code, _objectSpread({}, config, {
            filename: fileName
        })));
    } catch (error) {
...
function CompressOptionsModal() {
    ...
    var handleApply = function() {
        setSwcConfig(function(config) {
            return CompressOptionsModal_objectSpread({}, config, {
                jsc: CompressOptionsModal_objectSpread({}, config.jsc, {
                    minify: CompressOptionsModal_objectSpread({}, config.jsc.minify, {
                        compress: options1
                    })
                })
            });
    ...
    var handleOptionChange = function(key, event) {
        setOptions(function(options) {
            return options && typeof options === 'object' ? CompressOptionsModal_objectSpread({}, options, CompressOptionsModal_defineProperty({}, key, event.target.checked)) : options;
        });
    };
...
function MangleOptionsModal() {
    ...
    var handleApply = function() {
        setSwcConfig(function(config) {
            return MangleOptionsModal_objectSpread({}, config, {
                jsc: MangleOptionsModal_objectSpread({}, config.jsc, {
                    minify: MangleOptionsModal_objectSpread({}, config.jsc.minify, {
                        mangle: options1
                    })
                })
            });
    ...
    var handleOptionChange = function(key, event) {
        setOptions(function(options) {
            return options && typeof options === 'object' ? MangleOptionsModal_objectSpread({}, options, MangleOptionsModal_defineProperty({}, key, event.target.checked)) : options;
        });
    };
    return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
...
var ConfigEditorModal_editorOptions = ConfigEditorModal_objectSpread({}, editorOptions, {
...
function Configuration() {
    ...
    var handleLanguageChange = function(event) {
        setSwcConfig(function(config) {
            ...
            return Configuration_objectSpread({}, config, {
                jsc: Configuration_objectSpread({}, config.jsc, {
    ...
    var handleModuleChange = function(event) {
        setSwcConfig(function(config) {
            return Configuration_objectSpread({}, config, {
                module: Configuration_objectSpread({}, config.module, {
    ...
    var handleToggleJSX = function(event) {
        setSwcConfig(function(config) {
            return Configuration_objectSpread({}, config, {
                jsc: Configuration_objectSpread({}, config.jsc, {
                    parser: Configuration_objectSpread({}, config.jsc.parser, {
    ...
    var handleToggleCompress = function(event) {
        ...
        setSwcConfig(function(config) {
            return Configuration_objectSpread({}, config, {
                jsc: Configuration_objectSpread({}, config.jsc, {
                    minify: Configuration_objectSpread({}, config.jsc.minify, {
                        compress: options
                    })
                })
            });
    ...
    var handleEnvTargetsChange = function(event) {
        setSwcConfig(function(config) {
            return Configuration_objectSpread({}, config, {
                env: Configuration_objectSpread({}, config.env, {
...
function InputEditor(param1) {
    ...
    var handleShare = function() {
        var _ref = InputEditor_asyncToGenerator(runtime_default().mark(function _callee() {
            return runtime_default().wrap(function _callee$(_ctx) {
                while(1)switch(_ctx.prev = _ctx.next){
                    case 0:
...
var OutputEditor_editorOptions = OutputEditor_objectSpread({}, editorOptions, {
    readOnly: true,
    wordWrap: 'on',
    tabSize: 4
});
