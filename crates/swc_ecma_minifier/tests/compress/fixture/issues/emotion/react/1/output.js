            ...
            var cursor, react = __webpack_require__(7294), StyleSheet1 = function() {
                ...
                return _proto.hydrate = function(nodes) {
                    ...
                    if (this.ctr % (this.isSpeedy ? 65000 : 1) == 0) {
                        var options, tag2;
                        this._insertTag((options = this, (tag2 = document.createElement("style")).setAttribute("data-emotion", options.key), void 0 !== options.nonce && tag2.setAttribute("nonce", options.nonce), tag2.appendChild(document.createTextNode("")), tag2.setAttribute("data-s", ""), tag2));
                    }
