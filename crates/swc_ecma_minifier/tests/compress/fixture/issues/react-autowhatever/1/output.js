...
var ItemsList = function(Component1) {
    ...
    function ItemsList1() {
        ...
        var obj, self1, call, _this = (self1 = this, call = _getPrototypeOf(ItemsList1).apply(this, arguments), call && ("object" == ((obj = call) && "undefined" != typeof Symbol && obj.constructor === Symbol ? "symbol" : typeof obj) || "function" == typeof call) ? call : function(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }(self1));
        return _this.storeHighlightedItemReference = function(highlightedItem) {
