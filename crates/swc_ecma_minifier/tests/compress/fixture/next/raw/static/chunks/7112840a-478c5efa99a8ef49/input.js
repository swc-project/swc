...
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3333);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4444);
...
/** A mutation that deletes the document at the given key. */ class cn extends (/* unused pure expression or super */ null && (He)) {
    constructor(t, e) {
        super(), this.key = t, this.precondition = e, this.type = 2 /* Delete */ , this.fieldTransforms = [];
    }
}

class an extends (/* unused pure expression or super */ null && (He)) {
    constructor(t, e) {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class zs extends (/* unused pure expression or super */ null && (j)) {
    constructor(t, e) {
...
let Xs = (/* unused pure expression or super */ null && (!1));
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class ti extends (/* unused pure expression or super */ null && (Ks)) {
    constructor(t, e) {
 ...
 */
class Gi extends (/* unused pure expression or super */ null && (Qi)) {
    /**
 ...
 */ class cr {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Mn(e, i);
            return (_e(e) || me(e)) && this.Ln(e.limitType, r, s, n) ? this.Fn(t, e) : (x() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_2__/* .LogLevel.DEBUG */ ["in"].DEBUG && $("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), be(e)), 
    ...
    Fn(t, e) {
        return x() <= _firebase_logger__WEBPACK_IMPORTED_MODULE_2__/* .LogLevel.DEBUG */ ["in"].DEBUG && $("QueryEngine", "Using full collection scan to execute query:", be(e)), 
...
class {
    ...
    ji(t, e) {
        const n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = (0,_firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_4__/* .createWebChannelTransport */ .UE)(), i = (0,_firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_4__/* .getStatEventTarget */ .FJ)(), r = {
        ...
        this.useFetchStreams && (r.xmlHttpFactory = new _firebase_webchannel_wrapper__WEBPACK_IMPORTED_MODULE_4__/* .FetchXmlHttpFactory */ .zI({})), this.Ui(r.initMessageHeaders, e), 
 ...
 */ class eo extends (/* unused pure expression or super */ null && (Zr)) {
    constructor(t, e, n, s, i) {
 ...
 */ class $c extends (/* unused pure expression or super */ null && (kc)) {
    constructor(t, e, n) {
 ...
 */ class Oc extends (/* unused pure expression or super */ null && ($c)) {
    constructor(t, e) {
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ const xa = (/* unused pure expression or super */ null && (-1));
 ...
 */ function Oa(e = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .getApp */ .Mq)()) {
    return (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._getProvider */ .qX)(e, "firestore").getImmediate();
}
...
class uu extends (/* unused pure expression or super */ null && (Za)) {
    _toFieldTransform(t) {
...
class lu extends (/* unused pure expression or super */ null && (Za)) {
    _toFieldTransform(t) {
...
class fu extends (/* unused pure expression or super */ null && (Za)) {
    constructor(t, e) {
        super(t), this.Qc = e;
    }
    _toFieldTransform(t) {
...
class du extends (/* unused pure expression or super */ null && (Za)) {
    constructor(t, e) {
        super(t), this.Qc = e;
    }
    _toFieldTransform(t) {
...
class wu extends (/* unused pure expression or super */ null && (Za)) {
    constructor(t, e) {
        super(t), this.Wc = e;
    }
    _toFieldTransform(t) {
...
class Lu extends (/* unused pure expression or super */ null && (Fu)) {
    constructor(t, e, n) {
...
class Uu extends (/* unused pure expression or super */ null && (Fu)) {
    constructor(t, e) {
...
class Ku extends (/* unused pure expression or super */ null && (Fu)) {
    constructor(t, e, n) {
...
class Wu extends (/* unused pure expression or super */ null && (Fu)) {
    constructor(t, e, n) {
...
class Hu extends (/* unused pure expression or super */ null && (Fu)) {
    constructor(t, e, n) {
        super(), this.type = t, this.Zc = e, this.ta = n;
    }
    _apply(t) {
...
class ih extends (/* unused pure expression or super */ null && (nh)) {
    constructor(t) {
 ...
 * the methods to read and write data within the transaction context. See
 * {@link runTransaction}.
 */ class Ih extends (/* unused pure expression or super */ null && (class {
    /** @hideconstructor */
    constructor(t, e) {
 ...
 */ !function(t, e = !0) {
    !function(t) {
        C = t;
    }(_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .SDK_VERSION */ .Jn), (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._registerComponent */ .Xd)(new _firebase_component__WEBPACK_IMPORTED_MODULE_1__/* .Component */ .wA("firestore", ((t, {options: n}) => {
        const s = t.getProvider("app").getImmediate(), i = new ka(s, new H(t.getProvider("auth-internal")));
        return n = Object.assign({
            useFetchStreams: e
        }, n), i._setSettings(n), i;
    }), "PUBLIC" /* PUBLIC */)), (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .registerVersion */ .KN)(S, "3.3.0", t), 
