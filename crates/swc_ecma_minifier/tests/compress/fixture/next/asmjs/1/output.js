export function foo(global, env, buffer) {
    ...
    function uc(b) {
        ...
        var d = ib;
        d = T1(g1[b + 48 >> 2]);
        if (Sb(d) | 0) d = a1[(c1[b + 976 >> 2] | 0) + 2 >> 0] | 0 ? T1(1) : T1(0);
        return T1(d);
    }
    function vc(a, b) {
        a = a | 0;
    ...
    function Pd(a, b, c, d, e, f, h, i, j, k, l, m, n) {
        ...
        if (j < T1(0) | k < T1(0)) n = 0;
        else {
            if ((n | 0) != 0 ? (p = T1(g1[n + 4 >> 2]), p != T1(0)) : 0) {
                r = T1(Od(b, p, 0, 0));
                s = T1(Od(d, p, 0, 0));
                q = T1(Od(f, p, 0, 0));
                p = T1(Od(i, p, 0, 0));
    ...
    function Td(b, d, e, f, i, j, k, m, n, o, p) {
        ...
        o = o | 0;
        p = p | 0;
        var q = 0, r = 0, s = 0, t = 0, u = ib, v = ib, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0, C = 0, D = 0, E = 0, F = 0, G = 0, H = ib, I = ib, J = ib, K = 0, L = 0;
        G = l1;
        l1 = l1 + 160 | 0;
        D = G + 152 | 0;
        C = G + 120 | 0;
        ...
        do if (!(c1[b + 964 >> 2] | 0)) {
            ...
            a: do if ((D | 0) == 1) {
                ...
                while(1){
                    q = ac(b, r) | 0;
                    if (!h) {
                        if (T1(Ee(q)) > T1(0) ? T1(Fe(q)) > T1(0) : 0) h = q;
                        else h = 0;
                    } else if (De(q) | 0) {
                        t = 0;
                        break a;
            ...
            while(1){
                ...
                if (!M ? (ia = (r | 0) == 0, !ia) : 0) {
                    ...
                    do {
                        ...
                        } else if ((B ? (ka = T1(Ee(q)), ka != T1(0)) : 0) ? (Ma = T1(v + T1(z * ka)), la = T1(Ie(q, Ja, Ma, H, Ea)), Ma != la) : 0) {
                            w = T1(w - T1(la - v));
                            x = T1(x - ka);
                        }
                        q = c1[q + 960 >> 2] | 0;
                    ...
                    if (!ia) {
                        ...
                        do {
                            ...
                            } else if (s ? (ma = T1(Ee(r)), ma != T1(0)) : 0) v = T1(Ie(r, Ja, T1(w + T1(y * ma)), H, Ea));
                            else v = w;
                            e = T1(e - T1(v - w));
                            x = T1(Ud(r, Ja, Ea));
                            f = T1(Ud(r, Ka, Ea));
                ...
                if (O & e > T1(0)) {
                    q = c1[P >> 2] | 0;
                    if ((c1[b + 364 + (q << 3) + 4 >> 2] | 0) != 0 ? (na = T1(be(b + 364 + (q << 3) | 0, ua)), na >= T1(0)) : 0) v = T1(cC(T1(0), T1(na - T1(H - e))));
                    else v = T1(0);
                } else v = e;
                B = G >>> 0 < D >>> 0;
                if (B) {
                        ...
                        while(1){
                            ...
                            if (r >>> 0 < s >>> 0) {
                                ...
                                do {
                                    ...
                                    i: do if ((c1[r + 36 >> 2] | 0) != 1 ? (c1[r + 24 >> 2] | 0) == 0 : 0) switch(Je(b, r) | 0){
                                        case 1:
                                            {
    ...
    function _d(b, d, e, f) {
        ...
        j = b + 976 | 0;
        if (Td(b, h, i, f, l, k, d, e, 1, 3189, c1[j >> 2] | 0) | 0 ? (ce(b, c1[b + 496 >> 2] | 0, d, e, d), de(b, T1(g1[(c1[j >> 2] | 0) + 4 >> 2]), T1(0), T1(0)), a1[11696] | 0) : 0) Md(b, 7);
        return;
    }
    function $d(a) {
        a = a | 0;
    ...
    function ce(a, b, d, e, f) {
        ...
        d = T1(d + T1(ne(a, h, f)));
        g1[a + 400 + (c1[1000 + (h << 2) >> 2] << 2) >> 2] = d;
        d = T1(e + T1(me(a, b, f)));
        g1[a + 400 + (c1[1040 + (b << 2) >> 2] << 2) >> 2] = d;
        f = T1(e + T1(ne(a, b, f)));
        g1[a + 400 + (c1[1000 + (b << 2) >> 2] << 2) >> 2] = f;
        return;
    }
    function de(a, b, d, e) {
        a = a | 0;
        ...
        if (!(b == T1(0))) {
            ...
            d = T1(gC(T1(p * b), T1(1)));
            if (Ld(d, T1(0)) | 0) h = 0;
            else h = (Ld(d, T1(1)) | 0) ^ 1;
            d = T1(gC(T1(i * b), T1(1)));
            if (Ld(d, T1(0)) | 0) f = 0;
            else f = (Ld(d, T1(1)) | 0) ^ 1;
    ...
    function ne(a, b, d) {
        ...
        else a = Tb(a + 60 | 0, c1[1000 + (b << 2) >> 2] | 0, 992) | 0;
        return T1(pe(a, d));
    }
    function oe(a) {
        a = a | 0;
    ...
    function se(a, b) {
        ...
        b = b | 0;
        var d = ib;
        if (!((oe(b) | 0 ? (c1[a + 312 >> 2] | 0) != 0 : 0) ? (d = T1(g1[a + 308 >> 2]), d >= T1(0)) : 0)) d = T1(cC(T1(g1[(Tb(a + 276 | 0, c1[1040 + (b << 2) >> 2] | 0, 992) | 0) >> 2]), T1(0)));
        return T1(d);
    }
    function te(a, b) {
        a = a | 0;
        b = b | 0;
        var d = ib;
        if (!((oe(b) | 0 ? (c1[a + 320 >> 2] | 0) != 0 : 0) ? (d = T1(g1[a + 316 >> 2]), d >= T1(0)) : 0)) d = T1(cC(T1(g1[(Tb(a + 276 | 0, c1[1000 + (b << 2) >> 2] | 0, 992) | 0) >> 2]), T1(0)));
        return T1(d);
    }
    function ue(a, b, d) {
        a = a | 0;
        ...
        d = T1(d);
        var e = ib;
        if (!((oe(b) | 0 ? (c1[a + 240 >> 2] | 0) != 0 : 0) ? (e = T1(be(a + 236 | 0, d)), e >= T1(0)) : 0)) e = T1(cC(T1(be(Tb(a + 204 | 0, c1[1040 + (b << 2) >> 2] | 0, 992) | 0, d)), T1(0)));
        return T1(e);
    }
    function ve(a, b, d) {
        a = a | 0;
        ...
        d = T1(d);
        var e = ib;
        if (!((oe(b) | 0 ? (c1[a + 248 >> 2] | 0) != 0 : 0) ? (e = T1(be(a + 244 | 0, d)), e >= T1(0)) : 0)) e = T1(cC(T1(be(Tb(a + 204 | 0, c1[1000 + (b << 2) >> 2] | 0, 992) | 0, d)), T1(0)));
        return T1(e);
    }
    function we(a, b, d, e, f, h, i) {
        ...
        n = T1(Ud(a, 0, b));
        if (Sb(b) | 0) o = b;
        else o = T1(cC(T1(0), T1(T1(b - m) - j)));
        if (Sb(d) | 0) p = d;
        else p = T1(cC(T1(0), T1(T1(d - n) - k)));
        if ((e | 0) == 1 & (f | 0) == 1) {
    ...
    function ye(a, b, c, d, e, f, h) {
        ...
        var i = 0, j = ib, k = ib;
        i = (d | 0) == 2;
        if ((!(b <= T1(0) & i) ? !(c <= T1(0) & (e | 0) == 2) : 0) ? !((d | 0) == 1 & (e | 0) == 1) : 0) a = 0;
        else {
            j = T1(Ud(a, 0, f));
            k = T1(Ud(a, 2, f));
            i = b < T1(0) & i | (Sb(b) | 0);
            b = T1(b - k);
            g1[a + 908 >> 2] = T1(Ie(a, 2, i ? T1(0) : b, f, f));
            b = T1(c - j);
            i = c < T1(0) & (e | 0) == 2 | (Sb(c) | 0);
            g1[a + 912 >> 2] = T1(Ie(a, 0, i ? T1(0) : b, h, f));
            a = 1;
        }
        return a | 0;
    }
    ...
    function Fe(b) {
        ...
        do if (c1[b + 944 >> 2] | 0) {
            ...
            if (Sb(d) | 0) {
                ...
                if (e << 24 >> 24 == 0 ? (f = T1(g1[b + 40 >> 2]), f < T1(0) & ((Sb(f) | 0) ^ 1)) : 0) {
                    d = T1(-f);
                    break;
                }
                d = e << 24 >> 24 ? T1(1) : T1(0);
    ...
    function He(a, b, d, e, f, h, i, j, k, m) {
        ...
        do if ((p | 0) == 7) {
            ...
            d = T1(g1[A >> 2]);
            f = T1(g1[B >> 2]);
            Td(b, d, f, k, c1[C >> 2] | 0, c1[D >> 2] | 0, h, i, 0, 3565, m) | 0;
    ...
    function Te(a, b, c, d) {
        ...
        f = d < c & (d >= T1(0) & ((Sb(d) | 0) ^ 1));
        c = f ? d : c;
        f = e >= T1(0) & ((Sb(e) | 0) ^ 1) & c < e;
        return T1(f ? e : c);
    }
    function Ue(a, b, d, e, f, h, i) {
        ...
        l = Sb(j) | 0;
        m = Sb(k) | 0;
        do if (l ^ m ? (p = T1(g1[b + 396 >> 2]), !(Sb(p) | 0)) : 0) if (l) {
            j = T1(n + T1(T1(k - o) * p));
            break;
        } else {
            v = T1(o + T1(T1(j - n) / p));
    ...
    function Xe(b) {
        ...
        switch(c1[b + 56 >> 2] | 0){
            ...
            case 3:
                {
                    d = T1(g1[b + 40 >> 2]);
                    if (d > T1(0) & ((Sb(d) | 0) ^ 1)) b = a1[(c1[b + 976 >> 2] | 0) + 2 >> 0] | 0 ? 1056 : 992;
                    else b = 1056;
                    break;
                }
            default:
    ...
    function Ze(a, b) {
        ...
        else a = (c1[(Tb(a, c1[1000 + (b << 2) >> 2] | 0, 948) | 0) + 4 >> 2] | 0) != 0;
        return a | 0;
    }
    function _e(a, b, d) {
        a = a | 0;
    ...
    function ow(a, b, d, e, f, g) {
        ...
        c1[m >> 2] = 0;
        c1[g >> 2] = 0;
        Ba1(0, k | 0, a | 0, b | 0, d | 0, e | 0, f | 0, uw(j) | 0) | 0;
        jw(j);
        kw(i);
        l1 = h;
        return;
    ...
    function QB(b, e, f, g, h, i) {
        ...
        do if (D >>> 0 < 2146435072 | (D | 0) == 2146435072 & false) {
                ...
                while(1){
                    ...
                    if (j >>> 0 >= n >>> 0) {
                        ...
                        do {
                            ...
                            y = A1;
                            v = HC(x | 0, y | 0, 1000000000, 0) | 0;
                            c1[j >> 2] = v;
                            m = EC(x | 0, y | 0, 1000000000, 0) | 0;
                            j = j + -4 | 0;
                        }while (j >>> 0 >= n >>> 0)
                        if (m) {
                            n = n + -4 | 0;
            ...
            if ((n | 0) < (((g - y >> 2) * 9 | 0) + -9 | 0)) {
                ...
                n = (s + 4 | 0) == (g | 0);
                if (!(n & (q | 0) == 0)) {
                    r = (((p >>> 0) / (o >>> 0) | 0) & 1 | 0) == 0 ? 9007199254740992 : 9007199254740994;
                    x = (o | 0) / 2 | 0;
                    e = q >>> 0 < x >>> 0 ? 0.5 : n & (q | 0) == (x | 0) ? 1 : 1.5;
                    if (C) {
                        x = (a1[B >> 0] | 0) == 45;
                        e = x ? -e : e;
                        r = x ? -r : r;
    ...
    function UB(b, d, e) {
        ...
        do if (b) {
            ...
            if (!(c1[c1[(VB() | 0) + 188 >> 2] >> 2] | 0)) if ((d & -128 | 0) == 57216) {
                a1[b >> 0] = d;
                b = 1;
                break;
            } else {
