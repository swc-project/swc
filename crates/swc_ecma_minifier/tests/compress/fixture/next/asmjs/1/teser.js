export function foo(global, env, buffer) {
    ...
    function Ld(a, b) {
        ...
        var c = 0;
        if (Sb(a) | 0) c = Sb(b) | 0;
        else c = T(C(T(a - b))) < T(.0000999999974);
        return c | 0
    }
        ...
        do {
            if (!(c[b + 964 >> 2] | 0)) {
                ...
                while (1) {
                    ...
                    } while (0); X = w > T(0.0) & w < T(1.0); E = X ? T(1.0) : w; X = v > T(0.0) & v < T(1.0); A = X ? T(1.0) : v; do {
                        if (!N) {
                            if (!(x < ba & ((Sb(ba) | 0) ^ 1))) {
                                if (!(x > ca & ((Sb(ca) | 0) ^ 1))) {
                                    if (!(a[(c[J >> 2] | 0) + 3 >> 0] | 0)) {
                    ...
                    } else e = T(0.0); e = T(F + e); Oa = e < T(0.0) & 1; a[Y >> 0] = Oa | d[Y >> 0];
                    if (O & e > T(0.0)) {
                        q = c[P >> 2] | 0;
                    ...
                    } else v = T(0.0); f = T(aa + e);
                    if (Q) x = T(T(Ie(b, Ka, T(za + v), ya, m)) - za);
                    else x = qa; w = T(T(Ie(b, Ka, T(za + (W ? qa : v)), ya, m)) - za);
                    if (B & o) {
                        r = G;
                        do {
                    ...
                    oa = T(oa + w); da = T(cC(da, f)); k = L + 1 | 0;
                    if (D >>> 0 >= Ia >>> 0) break;
                    else {
                        e = H;
                        G = D;
