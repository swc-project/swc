        ...
        8780: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var nothing = [], WidgetViewDesc1 = function(ViewDesc) {
                ...
                return ViewDesc && (MarkViewDesc.__proto__ = ViewDesc), MarkViewDesc.prototype = Object.create(ViewDesc && ViewDesc.prototype), MarkViewDesc.prototype.constructor = MarkViewDesc, MarkViewDesc.create = function(parent, mark, inline, view) {
                    ...
                    return spec && spec.dom, new MarkViewDesc(parent, mark, spec.dom, spec.contentDOM || spec.dom);
                ...
                return NodeViewDesc.create = function(parent, node, outerDeco, innerDeco, view, pos) {
                    var descObj, custom = view.nodeViews[node.type.name], spec = custom && custom(node, view, function() {
                    ...
                    else dom || (dom = prosemirror_model__WEBPACK_IMPORTED_MODULE_1__.DOMSerializer.renderSpec(document, node.type.spec.toDOM(node)).dom);
                    contentDOM || node.isText || "BR" == dom.nodeName || (dom.hasAttribute("contenteditable"), node.type.spec.draggable);
                    var nodeDOM = dom;
            ...
            ViewTreeUpdater.prototype.destroyBetween = function(start, end) {
                ...
                !(!lastChild || !(lastChild instanceof TextViewDesc1) || /\n$/.test(lastChild.node.text)) || (result1.safari || result1.chrome) && lastChild && "false" == lastChild.dom.contentEditable && this.addHackNode("IMG");
            ...
            function parseFromClipboard(view, text, html, plainText, $context) {
                ...
                if (sliceData) slice = addContext(closeSlice(slice, +sliceData[1], +sliceData[2]), sliceData[3]);
            ...
            DOMObserver.prototype.flushSoon = function() {
                ...
                if (this.view.docView && !(this.flushingSoon > -1)) {
                    ...
                    (from > -1 || newSel) && (from > -1 && (this.view.docView.markDirty(from, to), checkCSS(this.view)), this.handleDOMChange(from, to, typeOver, added), this.view.docView.dirty ? this.view.updateState(this.view.state) : this.currentSelection.eq(sel), this.currentSelection.set(sel));
                }
            ...
            function ensureListeners(view) {
                view.someProp("handleDOMEvents", function(currentHandlers) {
                    for(var type in currentHandlers)view.eventHandlers[type];
                });
            }
            ...
            editHandlers.keydown = function(view2, event) {
                ...
                if (view2.shiftKey = 16 == event.keyCode || event.shiftKey, !inOrNearComposition(view2, event)) if (229 != event.keyCode && view2.domObserver.forceFlush(), view2.lastKeyCode = event.keyCode, view2.lastKeyCodeTime = Date.now(), !result1.ios || 13 != event.keyCode || event.ctrlKey || event.altKey || event.metaKey) view2.someProp("handleKeyDown", function(f) {
            ...
            handlers1.mousedown = function(view, event) {
                ...
                pos && ("singleClick" == type ? (view.mouseDown && view.mouseDown.done(), view.mouseDown = new MouseDown(view, pos, event, flushed)) : ("doubleClick" == type ? handleDoubleClick : handleTripleClick)(view, pos.pos, pos.inside, event) && event.preventDefault());
            };
            ...
            handlers1.copy = editHandlers.cut = function(view5, e) {
                ...
                data && doPaste(view6, data.getData("text/plain"), data.getData("text/html"), e1) ? e1.preventDefault() : (function(view, e) {
                    if (view.dom.parentNode) {
                        ...
                        target.style.cssText = "position: fixed; left: -10000px; top: 10px", target.focus(), setTimeout(function() {
            ...
            for(var prop1 in handlers1.dragstart = function(view, e) {
                ...
                if (mouseDown && mouseDown.done(), e.dataTransfer) {
                    ...
                    var slice = view.state.selection.content(), ref = serializeForClipboard(view, slice), dom = ref.dom;
                    ref.text, e.dataTransfer.clearData(), e.dataTransfer.setData(brokenClipboardAPI ? "Text" : "text/html", dom.innerHTML), e.dataTransfer.effectAllowed = "copyMove", view.dragging = new Dragging(slice, !e[dragCopyModifier]);
                }
                ...
                view.focused || (view.domObserver.stop(), view.dom.classList.add("ProseMirror-focused"), view.domObserver.start(), view.focused = !0);
            ...
            DecorationSet.create = function(doc, decorations) {
                ...
                for(var local = moveSpans(childIndex ? withoutNulls(decorations) : decorations, -offset), i = 0; i < local.length; i++)local[i].type.valid(doc, local[i]);
                ...
                for(var result = [], i = 0; i < this.local.length; i++)this.local[i].type instanceof InlineType;
                return result;
            };
            ...
            var EditorView = function(place, props) {
                this._props = props, this.state = props.state, this.directPlugins = props.plugins || [], this.directPlugins.forEach(checkStateComponent), this.dispatch = this.dispatch.bind(this), this._root = null, this.focused = !1, this.trackWrites = null, this.dom = place && place.mount || document.createElement("div"), place && (place.appendChild ? place.appendChild(this.dom) : place.apply ? place(this.dom) : place.mount && (this.mounted = !0)), this.editable = getEditable(this), this.markCursor = null, this.cursorWrapper = null, updateCursorWrapper(this), this.nodeViews = buildNodeViews(this), this.docView = docViewDesc(this.state.doc, computeDocDeco(this), viewDecorations(this), this.dom, this), this.lastSelectedViewDesc = null, this.dragging = null, (function(view7) {
                    ...
                    for(var event5 in view7.shiftKey = !1, view7.mouseDown = null, view7.lastKeyCode = null, view7.lastKeyCodeTime = 0, view7.lastClick = {
                        ...
                        return (function(view8, from2, to2, typeOver, addedNodes) {
                            ...
                            var sel2 = view8.state.selection, parse = function(view, from_, to_) {
                                ...
                                ], selectionCollapsed(domSel)), result1.chrome && 8 === view.lastKeyCode) for(var off = toOffset; off > fromOffset; off--){
                    ...
                    }), view7.domObserver.start(), view7.domChangeCount = 0, view7.eventHandlers = Object.create(null), handlers1)handlers1[event6 = event5], view7.dom.addEventListener(event6, view7.eventHandlers[event6] = function(event) {
                        !eventBelongsToView(view7, event) || runCustomHandler(view7, event) || !view7.editable && event.type in editHandlers;
                    });
            ...
            function computeDocDeco(view) {
                ...
                return attrs.class = "ProseMirror", attrs.contenteditable = String(view.editable), attrs.translate = "no", view.someProp("attributes", function(value) {
                    if ("function" == typeof value && (value = value(view.state)), value) for(var attr in value)"class" == attr && (attrs.class += " " + value[attr]), "style" == attr ? attrs.style = (attrs.style ? attrs.style + ";" : "") + value[attr] : attrs[attr] || "contenteditable" == attr || "nodeName" == attr;
                }), [
            ...
            function buildNodeViews(view) {
                ...
                return view.someProp("nodeViews", function(obj) {
                    for(var prop in obj)Object.prototype.hasOwnProperty.call(result, prop);
                }), result;
            }
            ...
            prototypeAccessors$21.props.get = function() {
                ...
                var ref1, refDOM1, refTop1, stack1, newRefTop, this$1 = this, prev = this.state, redraw = !1, updateSel = !1;
                ...
                } else oldScrollPos && (refDOM1 = (ref1 = oldScrollPos).refDOM, refTop1 = ref1.refTop, stack1 = ref1.stack, newRefTop = refDOM1 ? refDOM1.getBoundingClientRect().top : 0, (function(stack, dTop) {
                ...
                })(stack1, 0 == newRefTop ? 0 : newRefTop - refTop1));
                ...
                var dom;
                this.domObserver.stop(), this.editable && ((dom = this.dom).setActive ? dom.setActive() : preventScrollSupported ? dom.focus(preventScrollSupported) : (scrollStack(dom), dom.focus(null == preventScrollSupported ? {
                    get preventScroll () {
                        return preventScrollSupported = {
                            preventScroll: !0
                        }, !0;
                    }
                } : void 0), preventScrollSupported || (preventScrollSupported = !1))), selectionToDOM(this), this.domObserver.start();
            }, prototypeAccessors$21.root.get = function() {
                var cached = this._root;
                if (null == cached) {
                    for(var search = this.dom.parentNode; search; search = search.parentNode)if (9 == search.nodeType || 11 == search.nodeType && search.host) return search.getSelection, this._root = search;
                }
                ...
                })(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], viewDecorations(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom));
            }, EditorView.prototype.dispatchEvent = function(event) {
                var view, event7;
                return view = this, void (runCustomHandler(view, event7 = event) || !handlers1[event7.type] || !view.editable && event7.type in editHandlers);
