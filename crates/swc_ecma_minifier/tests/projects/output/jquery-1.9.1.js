!function(window1, undefined) {
    var readyList, rootjQuery, core_strundefined = "undefined", document = window1.document, location = window1.location, _jQuery = window1.jQuery, _$ = window1.$, class2type = {}, core_deletedIds = [], core_version = "1.9.1", core_concat = core_deletedIds.concat, core_push = core_deletedIds.push, core_slice = core_deletedIds.slice, core_indexOf = core_deletedIds.indexOf, core_toString = class2type.toString, core_hasOwn = class2type.hasOwnProperty, core_trim = core_version.trim, jQuery = function(selector, context) {
        ...
        if (document.addEventListener) {
            ...
            window1.removeEventListener("load", completed, !1);
        } else {
    ...
    jQuery.extend = jQuery.fn.extend = function() {
        ...
        for(; i < length; i++)if (null != (options = arguments[i])) for(name1 in options){
            src = target[name1];
            if (target !== (copy = options[name1])) {
                if (deep && copy && (jQuery.isPlainObject(copy) || (copyIsArray = jQuery.isArray(copy)))) {
                    if (copyIsArray) {
                        copyIsArray = !1;
                        clone = src && jQuery.isArray(src) ? src : [];
                    } else clone = src && jQuery.isPlainObject(src) ? src : {};
                    target[name1] = jQuery.extend(deep, clone, copy);
                } else copy !== undefined && (target[name1] = copy);
            }
        }
        return target;
    };
    jQuery.extend({
        ...
        parseXML: function(data) {
            ...
            if (!data || "string" != typeof data) return null;
            try {
                if (window1.DOMParser) xml = new DOMParser().parseFromString(data, "text/xml");
                else {
        ...
        grep: function(elems, callback, inv) {
            ...
            inv = !!inv;
            for(; i < length; i++)!!callback(elems[i], i) !== inv && ret.push(elems[i]);
            return ret;
        },
    ...
    jQuery.support = function() {
        ...
        for(i in {
            ...
            support[i + "Bubbles"] = eventName in window1 || !1 === div.attributes[eventName].expando;
        }
        return div.style.backgroundClip = "content-box", div.cloneNode(!0).style.backgroundClip = "", support.clearCloneStyle = "content-box" === div.style.backgroundClip, jQuery(function() {
            ...
            if (body) {
                (container = document.createElement("div")).style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px";
                ...
                if (window1.getComputedStyle) {
                    support.pixelPosition = "1%" !== (window1.getComputedStyle(div, null) || {}).top;
                    support.boxSizingReliable = "4px" === (window1.getComputedStyle(div, null) || {
                        width: "4px"
                    }).width;
                    (marginDiv = div.appendChild(document.createElement("div"))).style.cssText = div.style.cssText = divReset;
                    marginDiv.style.marginRight = marginDiv.style.width = "0";
                    div.style.width = "1px";
                    support.reliableMarginRight = !parseFloat((window1.getComputedStyle(marginDiv, null) || {}).marginRight);
                }
    ...
    function internalData(elem, name1, data, pvt) {
        if (jQuery.acceptData(elem)) {
            ...
            if (id && cache[id] && (pvt || cache[id].data) || !getByName || data !== undefined) {
                ...
                ("object" == typeof name1 || "function" == typeof name1) && (pvt ? cache[id] = jQuery.extend(cache[id], name1) : cache[id].data = jQuery.extend(cache[id].data, name1));
                thisCache = cache[id];
                if (!pvt) {
                    thisCache.data || (thisCache.data = {});
                    thisCache = thisCache.data;
                }
                return data !== undefined && (thisCache[jQuery.camelCase(name1)] = data), getByName ? null == (ret = thisCache[name1]) && (ret = thisCache[jQuery.camelCase(name1)]) : ret = thisCache, ret;
            }
        }
    }
        ...
        if (jQuery.acceptData(elem)) {
            ...
            if (cache[id]) {
                if (name1 && (thisCache = pvt ? cache[id] : cache[id].data)) {
                    ...
                    for(i = 0, l = name1.length; i < l; i++)delete thisCache[name1[i]];
            ...
            if (key === undefined) {
                if (this.length) {
                    ...
                    if (1 === elem.nodeType && !jQuery._data(elem, "parsedAttrs")) {
                        ...
                        for(; i < attrs.length; i++)(name1 = attrs[i].name).indexOf("data-") || dataAttr(elem, name1 = jQuery.camelCase(name1.slice(5)), data[name1]);
    ...
    jQuery.fn.extend({
        ...
        addClass: function(value) {
            ...
            if ("string" == typeof value && value) {
                ...
                for(; i < len; i++)if (cur = 1 === (elem = this[i]).nodeType && (elem.className ? (" " + elem.className + " ").replace(rclass, " ") : " ")) {
                    j = 0;
                    for(; clazz = classes[j++];)0 > cur.indexOf(" " + clazz + " ") && (cur += clazz + " ");
        ...
        val: function(value) {
            ...
            return arguments.length ? (isFunction = jQuery.isFunction(value), this.each(function(i) {
                ...
                if (1 === this.nodeType) {
                    null == (val = isFunction ? value.call(this, i, self.val()) : value) ? val = "" : "number" == typeof val ? val += "" : jQuery.isArray(val) && (val = jQuery.map(val, function(value) {
    ...
    jQuery.extend({
        ...
        attr: function(elem, name1, value) {
            ...
            if (elem && 3 !== nType && 8 !== nType && 2 !== nType) {
                ...
                if (notxml = 1 !== nType || !jQuery.isXMLDoc(elem)) {
                    ...
                    hooks = jQuery.attrHooks[name1] || (rboolean.test(name1) ? boolHook : nodeHook);
                }
                if (value !== undefined) {
        ...
        removeAttr: function(elem, value) {
            ...
            if (attrNames && 1 === elem.nodeType) for(; name1 = attrNames[i++];){
                propName = jQuery.propFix[name1] || name1;
                rboolean.test(name1) ? !getSetAttribute && ruseDefault.test(name1) ? elem[jQuery.camelCase("default-" + name1)] = elem[propName] = !1 : elem[propName] = !1 : jQuery.attr(elem, name1, "");
                elem.removeAttribute(getSetAttribute ? name1 : propName);
            }
        },
        attrHooks: {
            type: {
        ...
        prop: function(elem, name1, value) {
            ...
            if (elem && 3 !== nType && 8 !== nType && 2 !== nType) {
                if (1 !== nType || !jQuery.isXMLDoc(elem)) {
                    name1 = jQuery.propFix[name1] || name1;
                    hooks = jQuery.propHooks[name1];
                }
                return value !== undefined ? hooks && "set" in hooks && undefined !== (ret = hooks.set(elem, value, name1)) ? ret : elem[name1] = value : hooks && "get" in hooks && null !== (ret = hooks.get(elem, name1)) ? ret : elem[name1];
            }
        },
        propHooks: {
            tabIndex: {
    ...
    jQuery.event = {
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (!(3 === elem.nodeType || 8 === elem.nodeType || rfocusMorph.test(type + jQuery.event.triggered))) {
                ...
                (event = event[jQuery.expando] ? event : new jQuery.Event(type, "object" == typeof event && event)).isTrigger = !0;
                ...
                if (onlyHandlers || !special.trigger || !1 !== special.trigger.apply(elem, data)) {
                    ...
                    event.type = type;
                    if (!onlyHandlers && !event.isDefaultPrevented() && (!special._default || !1 === special._default.apply(elem.ownerDocument, data)) && !("click" === type && jQuery.nodeName(elem, "a")) && jQuery.acceptData(elem) && ontype && elem[type] && !jQuery.isWindow(elem)) {
            ...
            if (!special.preDispatch || !1 !== special.preDispatch.call(this, event)) {
                ...
                for(; (matched = handlerQueue[i++]) && !event.isPropagationStopped();){
                    ...
                    for(; (handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped();)if (!event.namespace_re || event.namespace_re.test(handleObj.namespace)) {
                        ...
                        if (undefined !== (ret = ((jQuery.event.special[handleObj.origType] || {}).handle || handleObj.handler).apply(matched.elem, args)) && !1 === (event.result = ret)) {
            ...
            if (delegateCount && cur.nodeType && (!event.button || "click" !== event.type)) {
                for(; cur != this; cur = cur.parentNode || this)if (1 === cur.nodeType && (!0 !== cur.disabled || "click" !== event.type)) {
                    ...
                    for(i = 0; i < delegateCount; i++){
                        undefined === matches[sel = (handleObj = handlers[i]).selector + " "] && (matches[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) >= 0 : jQuery.find(sel, this, null, [
                            cur
                        ]).length);
        ...
        mouseHooks: {
            ...
            filter: function(event, original) {
                ...
                return !event.relatedTarget && fromElement && (event.relatedTarget = fromElement === event.target ? original.toElement : fromElement), event.which || button === undefined || (event.which = 1 & button ? 1 : 2 & button ? 3 : 4 & button ? 2 : 0), event;
            }
        },
        special: {
            load: {
    ...
    jQuery.removeEvent = document.removeEventListener ? function(elem, type, handle) {
        ...
        var name1 = "on" + type;
        if (elem.detachEvent) {
            typeof elem[name1] === core_strundefined && (elem[name1] = null);
            elem.detachEvent(name1, handle);
        }
    };
    jQuery.Event = function(src, props) {
        ...
        if (src && src.type) {
            ...
            this.type = src.type;
            this.isDefaultPrevented = src.defaultPrevented || !1 === src.returnValue || src.getPreventDefault && src.getPreventDefault() ? returnTrue : returnFalse;
        } else this.type = src;
    ...
    jQuery.fn.extend({
        ...
        off: function(types, selector, fn) {
            ...
            return !1 === fn && (fn = returnFalse), this.each(function() {
    ...
    !function(window1, undefined) {
                ...
                if (!seed && 1 === match.length) {
                    ...
                    for(; i--;){
                        ...
                        if ((find = Expr.find[type]) && (seed = find(token.matches[0].replace(runescape, funescape), rsibling.test(tokens[0].type) && context.parentNode || context))) {
                            tokens.splice(i, 1);
                            if (!(selector = seed.length && toSelector(tokens))) {
        ...
        setDocument = Sizzle.setDocument = function(node) {
            ...
            return (support.matchesSelector = isNative(matches = docElem.matchesSelector || docElem.mozMatchesSelector || docElem.webkitMatchesSelector || docElem.oMatchesSelector || docElem.msMatchesSelector)) && assert(function(div) {
                    ...
                    return 1 === first && 0 === last ? function(elem) {
                        ...
                        if (parent) {
                            if (simple) {
                                for(; dir;){
                                    node = elem;
                                    for(; node = node[dir];)if (ofType ? node.nodeName.toLowerCase() === name1 : 1 === node.nodeType) return !1;
                            ...
                            else for(; node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop();)if ((ofType ? node.nodeName.toLowerCase() === name1 : 1 === node.nodeType) && ++diff) {
                ...
                if (xml) {
                    ...
                    if ((cache = (outerCache = elem[expando] || (elem[expando] = {}))[dir]) && cache[0] === dirkey) {
                        ...
                        (cache = outerCache[dir] = [
                            dirkey
                        ])[1] = matcher(elem, context, xml) || cachedruns;
                        if (!0 === cache[1]) return !0;
                    }
                }
            };
        }
            ...
            return postFilter && !postFilter[expando] && (postFilter = setMatcher(postFilter)), postFinder && !postFinder[expando] && (postFinder = setMatcher(postFinder, postSelector)), markFunction(function(seed, results, context, xml) {
                ...
                if (seed) {
                    if (postFinder || preFilter) {
                        ...
                        i = matcherOut.length;
                        for(; i--;)(elem = matcherOut[i]) && (temp = postFinder ? indexOf.call(seed, elem) : preMap[i]) > -1 && (seed[temp] = !(results[temp] = elem));
                    }
                } else {
        ...
        compile = Sizzle.compile = function(selector, group) {
            ...
            if (!cached) {
                ...
                i = group.length;
                for(; i--;)(cached = matcherFromTokens(group[i]))[expando] ? setMatchers1.push(cached) : elementMatchers1.push(cached);
    ...
    jQuery.fn.extend({
        ...
        closest: function(selectors, context) {
            for(var cur, i = 0, l = this.length, ret = [], pos = rneedsContext.test(selectors) || "string" != typeof selectors ? jQuery(selectors, context || this.context) : 0; i < l; i++){
                cur = this[i];
                for(; cur && cur.ownerDocument && cur !== context && 11 !== cur.nodeType;){
    ...
    jQuery.fn.extend({
        ...
        remove: function(selector, keepData) {
            for(var elem, i = 0; null != (elem = this[i]); i++)if (!selector || jQuery.filter(selector, [
                elem
            ]).length > 0) {
        ...
        buildFragment: function(elems, context, scripts, selection) {
            for(var j, elem, contains, tmp, tag, tbody, wrap, l = elems.length, safe = createSafeFragment(context), nodes = [], i = 0; i < l; i++)if ((elem = elems[i]) || 0 === elem) {
                if ("object" === jQuery.type(elem)) jQuery.merge(nodes, elem.nodeType ? [
                    ...
                    wrap = wrapMap[tag = (rtagName.exec(elem) || [
                        "",
                        ""
                    ])[1].toLowerCase()] || wrapMap._default;
        ...
        css: function(name1, value) {
            return jQuery.access(this, function(elem, name1, value) {
                ...
                if (jQuery.isArray(name1)) {
                    ...
                    len = name1.length;
                    for(; i < len; i++)map[name1[i]] = jQuery.css(elem, name1[i], !1, styles);
                    return map;
                }
    ...
    jQuery.extend({
        ...
        style: function(elem, name1, value, extra) {
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                name1 = jQuery.cssProps[origName] || (jQuery.cssProps[origName] = vendorPropName(style, origName));
                hooks = jQuery.cssHooks[name1] || jQuery.cssHooks[origName];
                if (value === undefined) return hooks && "get" in hooks && undefined !== (ret = hooks.get(elem, !1, extra)) ? ret : style[name1];
                if ("string" == (type = typeof value) && (ret = rrelNum.exec(value))) {
                    value = (ret[1] + 1) * ret[2] + parseFloat(jQuery.css(elem, name1));
                    type = "number";
                }
                if (!(null == value || "number" === type && isNaN(value))) {
                    "number" !== type || jQuery.cssNumber[origName] || (value += "px");
                    jQuery.support.clearCloneStyle || "" !== value || 0 !== name1.indexOf("background") || (style[name1] = "inherit");
                    if (!hooks || !("set" in hooks) || undefined !== (value = hooks.set(elem, value, extra))) try {
                        style[name1] = value;
                    } catch (e) {}
                }
            }
        ...
        swap: function(elem, options, callback, args) {
            var ret, name1, old = {};
            for(name1 in options){
                old[name1] = elem.style[name1];
                elem.style[name1] = options[name1];
            }
            ret = callback.apply(elem, args || []);
            for(name1 in options)elem.style[name1] = old[name1];
            return ret;
        }
    });
    if (window1.getComputedStyle) {
        ...
        curCSS = function(elem, name1, _computed) {
            ...
            if (computed) {
                "" !== ret || jQuery.contains(elem.ownerDocument, elem) || (ret = jQuery.style(elem, name1));
                if (rnumnonpx.test(ret) && rmargin.test(name1)) {
                    width = style.width;
        ...
        curCSS = function(elem, name1, _computed) {
            ...
            null == ret && style && style[name1] && (ret = style[name1]);
            if (rnumnonpx.test(ret) && !rposition.test(name1)) {
                left = style.left;
                (rsLeft = (rs = elem.runtimeStyle) && rs.left) && (rs.left = elem.currentStyle.left);
                style.left = "fontSize" === name1 ? "1em" : ret;
    ...
    function augmentWidthOrHeight(elem, name1, extra, isBorderBox, styles) {
        for(var i = extra === (isBorderBox ? "border" : "content") ? 4 : "width" === name1 ? 1 : 0, val = 0; i < 4; i += 2){
    ...
    function getWidthOrHeight(elem, name1, extra) {
        ...
        if (val <= 0 || null == val) {
            ((val = curCSS(elem, name1, styles)) < 0 || null == val) && (val = elem.style[name1]);
            if (rnumnonpx.test(val)) return val;
            valueIsBorderBox = isBorderBox && (jQuery.support.boxSizingReliable || val === elem.style[name1]);
    ...
    function css_defaultDisplay(nodeName) {
        ...
        if (!display) {
            if ("none" === (display = actualDisplay(nodeName, doc)) || !display) {
                (doc = ((iframe = (iframe || jQuery("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(doc.documentElement))[0].contentWindow || iframe[0].contentDocument).document).write("<!doctype html><html><body>");
                doc.close();
    ...
    jQuery.extend({
        ...
        ajax: function(url, options) {
            ...
            if (!s.hasContent) {
                ...
                !1 === s.cache && (s.url = rts.test(cacheURL) ? cacheURL.replace(rts, "$1_=" + ajax_nonce++) : cacheURL + (ajax_rquery.test(cacheURL) ? "&" : "?") + "_=" + ajax_nonce++);
            }
            if (s.ifModified) {
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                if (2 !== state) {
                    ...
                    isSuccess ? deferred.resolveWith(callbackContext, [
                        success,
                        statusText,
                        jqXHR
        ...
        if (!s.crossDomain || jQuery.support.cors) {
            ...
            return {
                send: function(headers, complete) {
                    ...
                    callback = function(_, isAbort) {
                        ...
                        try {
                            if (callback && (isAbort || 4 === xhr.readyState)) {
                                ...
                                if (isAbort) 4 !== xhr.readyState && xhr.abort();
                                else {
                                    responses = {};
                                    status = xhr.status;
                    ...
                    if (s.async) {
                        if (4 === xhr.readyState) setTimeout(callback);
                        else {
                            handle = ++xhrId;
                            if (xhrOnUnloadAbort) {
                                if (!xhrCallbacks) {
                                    xhrCallbacks = {};
                                    jQuery(window1).unload(xhrOnUnloadAbort);
                                }
        ...
        "*": [
            function(prop, value) {
                ...
                if (parts) {
                    ...
                    if ("px" !== (unit = parts[3] || (jQuery.cssNumber[prop] ? "" : "px")) && start) {
    ...
    function Animation(elem, properties, options) {
        ...
        !function(props, specialEasing) {
            ...
            for(index in props){
                easing = specialEasing[name1 = jQuery.camelCase(index)];
                value = props[index];
                ...
                if ((hooks = jQuery.cssHooks[name1]) && "expand" in hooks) {
    ...
    jQuery.fn.extend({
        ...
        stop: function(type, clearQueue, gotoEnd) {
            ...
            return clearQueue && !1 !== type && this.queue(type || "fx", []), this.each(function() {
