!function(root, doc, factory) {
    ...
    jQuery.mobile = {}, function($, window, undefined) {
    ...
    }, $.extend($.find, oldFind), function($, undefined) {
        ...
        keyCode: $1.ui.keyCode,
        behaviors: {},
        silentScroll: function(ypos) {
            "number" !== $1.type(ypos) && (ypos = $1.mobile.defaultHomeScroll), $1.event.special.scrollstart.enabled = !1, setTimeout(function() {
                window1.scrollTo(0, ypos), $1.mobile.document.trigger("silentscroll", {
                    x: 0,
                    y: ypos
                });
            }, 20), setTimeout(function() {
                $1.event.special.scrollstart.enabled = !0;
            }, 150);
        },
        getClosestBaseUrl: function(ele) {
            var url = $1(ele).closest(".ui-page").jqmData("url"), base = $1.mobile.path.documentBase.hrefNoHash;
            return $1.mobile.dynamicBaseEnabled && url && $1.mobile.path.isPath(url) || (url = base), $1.mobile.path.makeUrlAbsolute(url, base);
        },
        ...
        getScreenHeight: function() {
            return window1.innerHeight || $1.mobile.window.height();
        },
        resetActivePageHeight: function(height) {
            var page = $1("." + $1.mobile.activePageClass), pageHeight = page.height(), pageOuterHeight = page.outerHeight(!0);
            height = compensateToolbars(page, "number" == typeof height ? height : $1.mobile.getScreenHeight()), page.css("min-height", height - (pageOuterHeight - pageHeight));
        },
        loading: function() {
            var loader = this.loading._widget || $1($1.mobile.loader.prototype.defaultHtml).loader(), returnValue = loader.loader.apply(loader, arguments);
            return this.loading._widget = loader, returnValue;
        }
    }), $1.addDependents = function(elem, newDependents) {
        var $elem = $1(elem), dependents = $elem.jqmData("dependents") || $1();
        $elem.jqmData("dependents", $1(dependents).add(newDependents));
    }, $1.fn.extend({
        removeWithDependents: function() {
            $1.removeWithDependents(this);
        },
        enhanceWithin: function() {
            var index, widgetElements = {}, keepNative = $1.mobile.page.prototype.keepNativeSelector(), that = this;
            for(index in $1.mobile.nojs && $1.mobile.nojs(this), $1.mobile.links && $1.mobile.links(this), $1.mobile.degradeInputsWithin && $1.mobile.degradeInputsWithin(this), $1.fn.buttonMarkup && this.find($1.fn.buttonMarkup.initSelector).not(keepNative).jqmEnhanceable().buttonMarkup(), $1.fn.fieldcontain && this.find(":jqmData(role='fieldcontain')").not(keepNative).jqmEnhanceable().fieldcontain(), $1.each($1.mobile.widgets, function(name, constructor) {
                if (constructor.initSelector) {
                    var elements = $1.mobile.enhanceable(that.find(constructor.initSelector));
        ...
        addDependents: function(newDependents) {
            $1.addDependents(this, newDependents);
        },
        getEncodedText: function() {
            return $1("<a>").text(this.text()).html();
        },
        jqmEnhanceable: function() {
            return $1.mobile.enhanceable(this);
        },
        jqmHijackable: function() {
            return $1.mobile.hijackable(this);
        }
    }), $1.removeWithDependents = function(nativeElement) {
        var element = $1(nativeElement);
        (element.jqmData("dependents") || $1()).remove(), element.remove();
    }, $1.addDependents = function(nativeElement, newDependents) {
        var element = $1(nativeElement), dependents = element.jqmData("dependents") || $1();
        element.jqmData("dependents", $1(dependents).add(newDependents));
    }, $1.find.matches = function(expr, set) {
        return $1.find(expr, null, null, set);
    }, $1.find.matchesSelector = function(node, expr) {
        return $1.find(expr, null, null, [
            node
        ]).length > 0;
    }, $2 = jQuery, uuid = 0, slice = Array.prototype.slice, _cleanData = $2.cleanData, $2.cleanData = function(elems) {
        ...
        return fullName = namespace + "-" + (name = name.split(".")[1]), prototype || (prototype = base, base = $2.Widget), $2.expr[":"][fullName.toLowerCase()] = function(elem) {
            ...
            _childConstructors: []
        }), (basePrototype = new base()).options = $2.widget.extend({}, basePrototype.options), $2.each(prototype, function(prop, value) {
        ...
        $2.fn[name] = function(options) {
            ...
            return options = !isMethodCall && args.length ? $2.widget.extend.apply(null, [
                options
    ...
    }, $2.Widget = function() {}, $2.Widget._childConstructors = [], $2.Widget.prototype = {
        widgetName: "widget",
        widgetEventPrefix: "",
        defaultElement: "<div>",
        options: {
        ...
        _createWidget: function(options, element) {
            element = $2(element || this.defaultElement || this)[0], this.element = $2(element), this.uuid = uuid++, this.eventNamespace = "." + this.widgetName + this.uuid, this.options = $2.widget.extend({}, this.options, this._getCreateOptions(), options), this.bindings = $2(), this.hoverable = $2(), this.focusable = $2(), element !== this && ($2.data(element, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(event1) {
                    event1.target === element && this.destroy();
                }
            }), this.document = $2(element.style ? element.ownerDocument : element.document || element), this.window = $2(this.document[0].defaultView || this.document[0].parentWindow)), this._create(), this._trigger("create", null, this._getCreateEventData()), this._init();
        },
        ...
        _init: $2.noop,
        destroy: function() {
            this._destroy(), this.element.unbind(this.eventNamespace).removeData(this.widgetFullName).removeData($2.camelCase(this.widgetFullName)), this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName + "-disabled ui-state-disabled"), this.bindings.unbind(this.eventNamespace), this.hoverable.removeClass("ui-state-hover"), this.focusable.removeClass("ui-state-focus");
        },
        _destroy: $2.noop,
        widget: function() {
            return this.element;
        ...
        _on: function(suppressDisabledCheck, element, handlers) {
            ...
            "boolean" != typeof suppressDisabledCheck && (handlers = element, element = suppressDisabledCheck, suppressDisabledCheck = !1), handlers ? (element = delegateElement = $2(element), this.bindings = this.bindings.add(element)) : (handlers = element, element = this.element, delegateElement = this.widget()), $2.each(handlers, function(event1, handler) {
                function handlerProxy() {
                    if (!(!suppressDisabledCheck && (!0 === instance.options.disabled || $2(this).hasClass("ui-state-disabled")))) return ("string" == typeof handler ? instance[handler] : handler).apply(instance, arguments);
                }
                "string" != typeof handler && (handlerProxy.guid = handler.guid = handler.guid || handlerProxy.guid || $2.guid++);
        ...
        _hoverable: function(element) {
            this.hoverable = this.hoverable.add(element), this._on(element, {
                mouseenter: function(event1) {
                    $2(event1.currentTarget).addClass("ui-state-hover");
                },
                mouseleave: function(event1) {
                    $2(event1.currentTarget).removeClass("ui-state-hover");
                }
            });
        },
        _focusable: function(element) {
            this.focusable = this.focusable.add(element), this._on(element, {
                focusin: function(event1) {
                    $2(event1.currentTarget).addClass("ui-state-focus");
                },
                focusout: function(event1) {
                    $2(event1.currentTarget).removeClass("ui-state-focus");
                }
            });
        },
        _trigger: function(type, event1, data) {
            var prop, orig, callback = this.options[type];
            if (data = data || {}, (event1 = $2.Event(event1)).type = (type === this.widgetEventPrefix ? type : this.widgetEventPrefix + type).toLowerCase(), event1.target = this.element[0], orig = event1.originalEvent) for(prop in orig)prop in event1 || (event1[prop] = orig[prop]);
            return this.element.trigger(event1, data), !($2.isFunction(callback) && !1 === callback.apply(this.element[0], [
                event1
        ...
        $2.Widget.prototype["_" + method] = function(element, options, callback) {
            ...
            "number" == typeof (options = options || {}) && (options = {
                duration: options
            }), hasOptions = !$2.isEmptyObject(options), options.complete = callback, options.delay && element.delay(options.delay), hasOptions && $2.effects && $2.effects.effect[effectName] ? element[method](options) : effectName !== method && element[effectName] ? element[effectName](options.duration, options.easing, callback) : element.queue(function(next) {
    ...
    }), $4.mobile.media = function(q) {
        return window.matchMedia(q).matches;
    }, $5 = jQuery, support = {
        touch: "ontouchend" in document1
    }, $5.mobile.support = $5.mobile.support || {}, $5.extend($5.support, support), $5.extend($5.mobile.support, support), function($, undefined) {
        $.extend($.support, {
    ...
    }(jQuery), $win = ($6 = jQuery).mobile.window, dummyFnToInitNavigate = function() {}, $6.event.special.beforenavigate = {
        setup: function() {
    ...
    }, $6.event.special.navigate = self = {
        bound: !1,
        pushStateEnabled: !0,
        originalEventName: void 0,
        isPushStateEnabled: function() {
            return $6.support.pushState && !0 === $6.mobile.pushStateEnabled && this.isHashChangeEnabled();
        },
        isHashChangeEnabled: function() {
            return !0 === $6.mobile.hashListeningEnabled;
        },
        popstate: function(event1) {
            var newEvent = new $6.Event("navigate"), beforeNavigate = new $6.Event("beforenavigate"), state = event1.originalEvent.state || {};
            beforeNavigate.originalEvent = event1, $win.trigger(beforeNavigate), !beforeNavigate.isDefaultPrevented() && (event1.historyState && $6.extend(state, event1.historyState), newEvent.originalEvent = event1, setTimeout(function() {
        ...
        hashchange: function(event1) {
            var newEvent = new $6.Event("navigate"), beforeNavigate = new $6.Event("beforenavigate");
        ...
        this.history = history1, this.ignoreInitialHashChange = !0, $7.mobile.window.bind({
            "popstate.history": $7.proxy(this.popstate, this),
            "hashchange.history": $7.proxy(this.hashchange, this)
        });
    }, $7.extend($7.mobile.Navigator.prototype, {
        squash: function(url, data) {
            var state, href, hash = path1.isPath(url) ? path1.stripHash(url) : url;
            return href = path1.squash(url), state = $7.extend({
                hash: hash,
                url: href
        ...
        go: function(url, data, noEvents) {
            var state, href, hash, popstateEvent, isPopStateEvent = $7.event.special.navigate.isPushStateEnabled();
            href = path1.squash(url), hash = this.hash(url, href), noEvents && hash !== path1.stripHash(path1.parseLocation().hash) && (this.preventNextHashChange = noEvents), this.preventHashAssignPopState = !0, window.location.hash = hash, this.preventHashAssignPopState = !1, state = $7.extend({
                url: href,
                hash: hash,
                title: document1.title
            }, data), isPopStateEvent && ((popstateEvent = new $7.Event("popstate")).originalEvent = {
                type: "popstate",
                state: null
            }, this.squash(url, state), noEvents || (this.ignorePopState = !0, $7.mobile.window.trigger(popstateEvent))), this.history.add(state.url, state);
        },
        popstate: function(event1) {
            var hash, state;
            if ($7.event.special.navigate.isPushStateEnabled()) {
                ...
                this.history.direct({
                    ...
                    present: function(historyEntry, direction) {
                        event1.historyState = $7.extend({}, historyEntry), event1.historyState.direction = direction;
                    }
                });
            }
        },
        hashchange: function(event1) {
            var history1, hash;
            if (!(!$7.event.special.navigate.isHashChangeEnabled() || $7.event.special.navigate.isPushStateEnabled())) {
                ...
                history1 = this.history, hash = path1.parseLocation().hash, this.history.direct({
                    url: hash,
                    present: function(historyEntry, direction) {
                        event1.hashchangeState = $7.extend({}, historyEntry), event1.hashchangeState.direction = direction;
                    },
                    missing: function() {
                        history1.add(hash, {
                            hash: hash,
        ...
        $8.each(vendorPrefixes, function(j, prefix) {
            if (undefined4 !== testElement.style[$8.camelCase(prefix + testName)]) return props[test].prefix = prefix, !1;
        }), props[test].duration = $8.camelCase(props[test].prefix + test + "-duration"), props[test].event = $8.camelCase(props[test].prefix + test + "-end"), "" === props[test].prefix && (props[test].event = props[test].event.toLowerCase());
    }), $8.support.cssTransitions = undefined4 !== props.transition.prefix, $8.support.cssAnimations = undefined4 !== props.animation.prefix, $8(testElement).remove(), $8.fn.animationComplete = function(callback, type, fallbackTime) {
        var timer, duration, that = this, animationType = type && "animation" !== type ? "transition" : "animation";
        return $8.support.cssTransitions && "transition" === animationType || $8.support.cssAnimations && "animation" === animationType ? (undefined4 === fallbackTime && ($8(this).context !== document1 && (duration = 3000 * parseFloat($8(this).css(props[animationType].duration))), (0 === duration || undefined4 === duration || isNaN(duration)) && (duration = $8.fn.animationComplete.defaultDuration)), timer = setTimeout(function() {
            $8(that).off(props[animationType].event), callback.apply(that);
        }, duration), $8(this).one(props[animationType].event, function() {
            clearTimeout(timer), callback.call(this, arguments);
        })) : (setTimeout($8.proxy(callback, this), 0), $8(this));
    }, $8.fn.animationComplete.defaultDuration = 1000, function($, window, document1, undefined) {
        ...
        element: (baseElement = ($9 = jQuery)("head").children("base")).length ? baseElement : $9("<base>", {
            href: $9.mobile.path.documentBase.hrefNoHash
        }).prependTo($9("head")),
        linkSelector: "[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]",
        set: function(href) {
            $9.mobile.dynamicBaseEnabled && $9.support.dynamicBaseTag && base.element.attr("href", $9.mobile.path.makeUrlAbsolute(href, $9.mobile.path.documentBase));
        },
        rewrite: function(href, page) {
            var newPath = $9.mobile.path.get(href);
            page.find(base.linkSelector).each(function(i, link) {
                var thisAttr = $9(link).is("[href]") ? "href" : $9(link).is("[src]") ? "src" : "action", thisUrl = $9(link).attr(thisAttr);
                thisUrl = thisUrl.replace(location.protocol + "//" + location.host + location.pathname, ""), /^(\w+:|#|\/)/.test(thisUrl) || $9(link).attr(thisAttr, newPath + thisUrl);
            });
        },
        reset: function() {
            base.element.attr("href", $9.mobile.path.documentBase.hrefNoSearch);
        }
    }, $9.mobile.base = base, ($10 = jQuery).mobile.widgets = {}, originalWidget = $10.widget, keepNativeFactoryDefault = $10.mobile.keepNative, $10.widget = (orig = $10.widget, function() {
        var constructor = orig.apply(this, arguments), name = constructor.prototype.widgetName;
        return constructor.initSelector = undefined5 !== constructor.prototype.initSelector ? constructor.prototype.initSelector : ":jqmData(role='" + name + "')", $10.mobile.widgets[name] = constructor, constructor;
    }), $10.extend($10.widget, originalWidget), $10.mobile.document.on("create", function(event1) {
        $10(event1.target).enhanceWithin();
    }), $10.widget("mobile.page", {
        options: {
            theme: "a",
            domCache: !1,
            keepNativeDefault: $10.mobile.keepNative,
            contentTheme: null,
            enhanced: !1
        },
        _createWidget: function() {
            $10.Widget.prototype._createWidget.apply(this, arguments), this._trigger("init");
        },
        _create: function() {
            ...
            }), this.element.enhanceWithin(), "dialog" === $10.mobile.getAttribute(this.element[0], "role") && $10.mobile.dialog && this.element.dialog();
        },
        _enhance: function() {
            var attrPrefix = "data-" + $10.mobile.ns, self = this;
            this.options.role && this.element.attr("data-" + $10.mobile.ns + "role", this.options.role), this.element.attr("tabindex", "0").addClass("ui-page ui-page-theme-" + this.options.theme), this.element.find("[" + attrPrefix + "role='content']").each(function() {
                var $this = $10(this), theme = this.getAttribute(attrPrefix + "theme") || undefined5;
        ...
        bindRemove: function(callback) {
            ...
            !page.data("mobile-page").options.domCache && page.is(":jqmData(external-page='true')") && page.bind("pagehide.remove", callback || function(e, data) {
                if (!data.samePage) {
                    var $this = $10(this), prEvent = new $10.Event("pageremove");
                    $this.trigger(prEvent), prEvent.isDefaultPrevented() || $this.removeWithDependents();
                }
            });
        },
        _setOptions: function(o) {
            undefined5 !== o.theme && this.element.removeClass("ui-page-theme-" + this.options.theme).addClass("ui-page-theme-" + o.theme), undefined5 !== o.contentTheme && this.element.find("[data-" + $10.mobile.ns + "='content']").removeClass("ui-body-" + this.options.contentTheme).addClass("ui-body-" + o.contentTheme);
        },
        ...
        keepNativeSelector: function() {
            var options = this.options, keepNative = $10.trim(options.keepNative || ""), globalValue = $10.trim($10.mobile.keepNative), optionValue = $10.trim(options.keepNativeDefault), newDefault = keepNativeFactoryDefault === globalValue ? "" : globalValue, oldDefault = "" === newDefault ? optionValue : "";
            return (keepNative ? [
                keepNative
            ] : []).concat(newDefault ? [
                newDefault
    ...
    }), ($11 = jQuery).widget("mobile.pagecontainer", {
        options: {
            theme: "a"
        },
        initSelector: !1,
        _create: function() {
            ...
            }), this.window.one("navigate", $11.proxy(function() {
        ...
        _delayedRecordScroll: function() {
            setTimeout($11.proxy(this, "_recordScroll"), 100);
        },
        _getScroll: function() {
            return this.window.scrollTop();
        },
        _getMinScroll: function() {
            return $11.mobile.minScrollBack;
        },
        _getDefaultScroll: function() {
            return $11.mobile.defaultHomeScroll;
        },
        _filterNavigateEvents: function(e, data) {
            var url;
            !(e.originalEvent && e.originalEvent.isDefaultPrevented()) && ((url = e.originalEvent.type.indexOf("hashchange") > -1 ? data.state.hash : data.state.url) || (url = this._getHash()), url && "#" !== url && 0 !== url.indexOf("#" + $11.mobile.path.uiStateKey) || (url = location.href), this._handleNavigate(url, data.state));
        },
        _getHash: function() {
            return $11.mobile.path.parseLocation().hash;
        },
        getActivePage: function() {
            return this.activePage;
        },
        _getInitialContent: function() {
            return $11.mobile.firstPage;
        },
        _getHistory: function() {
            return $11.mobile.navigate.history;
        },
        _getActiveHistory: function() {
            return $11.mobile.navigate.history.getActive();
        },
        _getDocumentBase: function() {
            return $11.mobile.path.documentBase;
        },
        back: function() {
            this.go(-1);
        },
        ...
        go: function(steps) {
            if ($11.mobile.hashListeningEnabled) window.history.go(steps);
            else {
                var activeIndex = $11.mobile.navigate.history.activeIndex, index = activeIndex + parseInt(steps, 10), url = $11.mobile.navigate.history.stack[index].url;
                $11.mobile.navigate.history.activeIndex = index, $11.mobile.navigate.history.previousIndex = activeIndex, this.change(url, {
        ...
        _handleDestination: function(to) {
            var history1;
            return "string" === $11.type(to) && (to = $11.mobile.path.stripHash(to)), to && (history1 = this._getHistory(), (to = $11.mobile.path.isPath(to) ? to : $11.mobile.path.makeUrlAbsolute("#" + to, this._getDocumentBase())) === $11.mobile.path.makeUrlAbsolute("#" + history1.initialDst, this._getDocumentBase()) && history1.stack.length && history1.stack[0].url !== history1.initialDst.replace($11.mobile.dialogHashKey, "") && (to = this._getInitialContent())), to || this._getInitialContent();
        },
        _handleDialog: function(changePageOptions, data) {
            var to, active, activeContent = this.getActivePage();
            return activeContent && !activeContent.hasClass("ui-dialog") ? ("back" === data.direction ? this.back() : this.forward(), !1) : (to = data.pageUrl, active = this._getActiveHistory(), $11.extend(changePageOptions, {
                role: active.role,
        ...
        _handleNavigate: function(url, data) {
            var to = $11.mobile.path.stripHash(url), history1 = this._getHistory(), transition = 0 === history1.stack.length ? "none" : undefined6, changePageOptions = {
                changeHash: !1,
                fromHashChange: !0,
                reverse: "back" === data.direction
            };
            $11.extend(changePageOptions, data, {
                transition: (history1.getLast() || {}).transition || transition
            }), (!(history1.activeIndex > 0 && to.indexOf($11.mobile.dialogHashKey) > -1) || history1.initialDst === to || !1 !== (to = this._handleDialog(changePageOptions, data))) && this._changeContent(this._handleDestination(to), changePageOptions);
        },
        _changeContent: function(to, opts) {
            $11.mobile.changePage(to, opts);
        },
        _getBase: function() {
            return $11.mobile.base;
        },
        _getNs: function() {
            return $11.mobile.ns;
        },
        ...
        _find: function(absUrl) {
            ...
            return 0 === (page = this.element.children("[data-" + this._getNs() + "url='" + dataUrl + "']")).length && dataUrl && !$11.mobile.path.isPath(dataUrl) && (page = this.element.children($11.mobile.path.hashToSelector("#" + dataUrl)).attr("data-" + this._getNs() + "url", dataUrl).jqmData("url", dataUrl)), 0 === page.length && $11.mobile.path.isFirstPageUrl(fileUrl) && initialContent && initialContent.parent().length && (page = $11(initialContent)), page;
        },
        _getLoader: function() {
            return $11.mobile.loading();
        },
        _showLoading: function(delay, theme, msg, textonly) {
            !this._loadMsg && (this._loadMsg = setTimeout($11.proxy(function() {
        ...
        _showError: function() {
            this._hideLoading(), this._showLoading(0, $11.mobile.pageLoadErrorMessageTheme, $11.mobile.pageLoadErrorMessage, !0), setTimeout($11.proxy(this, "_hideLoading"), 1500);
        },
        _parse: function(html, fileUrl) {
            var page, all = $11("<div></div>");
            return all.get(0).innerHTML = html, (page = all.find(":jqmData(role='page'), :jqmData(role='dialog')").first()).length || (page = $11("<div data-" + this._getNs() + "role='page'>" + (html.split(/<\/?body[^>]*>/gim)[1] || "") + "</div>")), page.attr("data-" + this._getNs() + "url", $11.mobile.path.convertUrlToDataUrl(fileUrl)).attr("data-" + this._getNs() + "external-page", !0), page;
        },
        _setLoadedTitle: function(page, html) {
            var newPageTitle = html.match(/<title[^>]*>([^<]*)/) && RegExp.$1;
            newPageTitle && !page.jqmData("title") && (newPageTitle = $11("<div>" + newPageTitle + "</div>").text(), page.jqmData("title", newPageTitle));
        },
        _isRewritableBaseTag: function() {
            return $11.mobile.dynamicBaseEnabled && !$11.support.dynamicBaseTag;
        },
        _createDataUrl: function(absoluteUrl) {
            return $11.mobile.path.convertUrlToDataUrl(absoluteUrl);
        },
        _createFileUrl: function(absoluteUrl) {
            return $11.mobile.path.getFilePath(absoluteUrl);
        },
        _triggerWithDeprecated: function(name, data, page) {
            var deprecatedEvent = $11.Event("page" + name), newEvent = $11.Event(this.widgetName + name);
        ...
        load: function(url, options) {
            var fileUrl, dataUrl, pblEvent, triggerData, deferred = options && options.deferred || $11.Deferred(), settings = $11.extend({}, this._loadDefaults, options), content = null, absUrl = $11.mobile.path.makeUrlAbsolute(url, this._findBaseWithDefault());
            if (settings.reload = settings.reloadPage, settings.data && "get" === settings.type && (absUrl = $11.mobile.path.addSearchParams(absUrl, settings.data), settings.data = undefined6), settings.data && "post" === settings.type && (settings.reload = !0), fileUrl = this._createFileUrl(absUrl), dataUrl = this._createDataUrl(absUrl), 0 === (content = this._find(absUrl)).length && $11.mobile.path.isEmbeddedPage(fileUrl) && !$11.mobile.path.isFirstPageUrl(fileUrl)) {
            ...
            if (triggerData = {
                ...
                if (settings.showLoadMsg && this._showLoading(settings.loadMsgDelay), undefined6 === settings.prefetch && this._getBase().reset(), !($11.mobile.allowCrossDomainPages || $11.mobile.path.isSameDomain($11.mobile.path.documentUrl, absUrl))) {
                    deferred.reject(absUrl, settings);
                    return;
                }
                $11.ajax({
        ...
        _loadError: function(absUrl, triggerData, settings, deferred) {
            return $11.proxy(function(xhr, textStatus, errorThrown) {
                this._getBase().set($11.mobile.path.get()), triggerData.xhr = xhr, triggerData.textStatus = textStatus, triggerData.errorThrown = errorThrown;
        ...
        _getTransitionHandler: function(transition) {
            return transition = $11.mobile._maybeDegradeTransition(transition), $11.mobile.transitionHandlers[transition] || $11.mobile.defaultTransitionHandler;
        },
        ...
        _cssTransition: function(to, from, options) {
            ...
            }), promise.done($11.proxy(function() {
                this._triggerCssTransitionEvents(to, from);
            }, this));
        },
        _releaseTransitionLock: function() {
            isPageTransitioning = !1, pageTransitionQueue.length > 0 && $11.mobile.changePage.apply(null, pageTransitionQueue.pop());
        },
        _removeActiveLinkClass: function(force) {
            $11.mobile.removeActiveLinkClass(force);
        },
        _loadUrl: function(to, triggerData, settings) {
            settings.target = to, settings.deferred = $11.Deferred(), this.load(to, settings), settings.deferred.done($11.proxy(function(url, options, content) {
                isPageTransitioning = !1, options.absUrl = triggerData.absUrl, this.transition(content, triggerData, options);
            }, this)), settings.deferred.fail($11.proxy(function() {
        ...
        _triggerPageBeforeChange: function(to, triggerData, settings) {
            var pbcEvent = new $11.Event("pagebeforechange");
            return $11.extend(triggerData, {
                toPage: to,
                options: settings
            }), "string" === $11.type(to) ? triggerData.absUrl = $11.mobile.path.makeUrlAbsolute(to, this._findBaseWithDefault()) : triggerData.absUrl = settings.absUrl, this.element.trigger(pbcEvent, triggerData), !pbcEvent.isDefaultPrevented();
        },
        change: function(to, options) {
            ...
            var settings = $11.extend({}, $11.mobile.changePage.defaults, options), triggerData = {};
            settings.fromPage = settings.fromPage || this.activePage, this._triggerPageBeforeChange(to, triggerData, settings) && (to = triggerData.toPage, "string" === $11.type(to) ? (isPageTransitioning = !0, this._loadUrl(to, triggerData, settings)) : this.transition(to, triggerData, settings));
        },
        transition: function(toPage, triggerData, settings) {
            ...
            if (!(!this._triggerPageBeforeChange(toPage, triggerData, settings) || (beforeTransition = this._triggerWithDeprecated("beforetransition", triggerData)).deprecatedEvent.isDefaultPrevented() || beforeTransition.event.isDefaultPrevented())) {
                if (isPageTransitioning = !0, toPage[0] !== $11.mobile.firstPage[0] || settings.dataUrl || (settings.dataUrl = $11.mobile.path.documentUrl.hrefNoHash), fromPage = settings.fromPage, pageUrl = url = settings.dataUrl && $11.mobile.path.convertUrlToDataUrl(settings.dataUrl) || toPage.jqmData("url"), $11.mobile.path.getFilePath(url), active = $11.mobile.navigate.history.getActive(), activeIsInitialPage = 0 === $11.mobile.navigate.history.activeIndex, historyDir = 0, pageTitle = document1.title, isDialog = ("dialog" === settings.role || "dialog" === toPage.jqmData("role")) && !0 !== toPage.jqmData("dialog"), fromPage && fromPage[0] === toPage[0] && !settings.allowSamePageTransition) {
                    isPageTransitioning = !1, this._triggerWithDeprecated("transition", triggerData), this.element.trigger("pagechange", triggerData), settings.fromHashChange && $11.mobile.navigate.history.direct({
                        url: url
                    });
                    return;
                }
                ...
                try {
                    document1.activeElement && "body" !== document1.activeElement.nodeName.toLowerCase() ? $11(document1.activeElement).blur() : $11("input:focus, textarea:focus, select:focus").blur();
                } catch (e) {}
                alreadyThere = !1, isDialog && active && (active.url && active.url.indexOf($11.mobile.dialogHashKey) > -1 && this.activePage && !this.activePage.hasClass("ui-dialog") && $11.mobile.navigate.history.activeIndex > 0 && (settings.changeHash = !1, alreadyThere = !0), url = active.url || "", !alreadyThere && url.indexOf("#") > -1 ? url += $11.mobile.dialogHashKey : url += "#" + $11.mobile.dialogHashKey, 0 === $11.mobile.navigate.history.activeIndex && url === $11.mobile.navigate.history.initialDst && (url += $11.mobile.dialogHashKey)), (newPageTitle = active ? toPage.jqmData("title") || toPage.children(":jqmData(role='header')").find(".ui-title").text() : pageTitle) && pageTitle === document1.title && (pageTitle = newPageTitle), toPage.jqmData("title") || toPage.jqmData("title", pageTitle), settings.transition = settings.transition || (historyDir && !activeIsInitialPage ? active.transition : undefined6) || (isDialog ? $11.mobile.defaultDialogTransition : $11.mobile.defaultPageTransition), !historyDir && alreadyThere && ($11.mobile.navigate.history.getActive().pageUrl = pageUrl), url && !settings.fromHashChange && (!$11.mobile.path.isPath(url) && 0 > url.indexOf("#") && (url = "#" + url), params = {
                    transition: settings.transition,
                    title: pageTitle,
                    pageUrl: pageUrl,
                    role: settings.role
                }, !1 !== settings.changeHash && $11.mobile.hashListeningEnabled ? $11.mobile.navigate(url, params, !0) : toPage[0] !== $11.mobile.firstPage[0] && $11.mobile.navigate.history.add(url, params)), document1.title = pageTitle, $11.mobile.activePage = toPage, this.activePage = toPage, settings.reverse = settings.reverse || historyDir < 0, cssTransitionDeferred = $11.Deferred(), this._cssTransition(toPage, fromPage, {
                    transition: settings.transition,
                    reverse: settings.reverse,
                    deferred: cssTransitionDeferred
                }), cssTransitionDeferred.done($11.proxy(function(name, reverse, $to, $from, alreadyFocused) {
                    $11.mobile.removeActiveLinkClass(), settings.duplicateCachedPage && settings.duplicateCachedPage.remove(), alreadyFocused || $11.mobile.focusPage(toPage), this._releaseTransitionLock(), this.element.trigger("pagechange", triggerData), this._triggerWithDeprecated("transition", triggerData);
                }, this));
            }
        },
        _findBaseWithDefault: function() {
            return this.activePage && $11.mobile.getClosestBaseUrl(this.activePage) || $11.mobile.path.documentBase.hrefNoHash;
        }
    }), $11.mobile.navreadyDeferred = $11.Deferred(), pageTransitionQueue = [], isPageTransitioning = !1, function($, undefined) {
    ...
    }(jQuery), $12 = jQuery, window2 = this, $12.mobile.Transition = function() {
        this.init.apply(this, arguments);
    }, $12.extend($12.mobile.Transition.prototype, {
        ...
        init: function(name, reverse, $to, $from) {
            $12.extend(this, {
                ...
                $to: $to,
                $from: $from,
                deferred: new $12.Deferred()
            });
        },
        cleanFrom: function() {
            this.$from.removeClass($12.mobile.activePageClass + " out in reverse " + this.name).height("");
        },
        beforeDoneIn: function() {},
        beforeDoneOut: function() {},
        beforeStartOut: function() {},
        doneIn: function() {
            this.beforeDoneIn(), this.$to.removeClass("out in reverse " + this.name).height(""), this.toggleViewportClass(), $12.mobile.window.scrollTop() !== this.toScroll && this.scrollPage(), this.sequential || this.$to.addClass($12.mobile.activePageClass), this.deferred.resolve(this.name, this.reverse, this.$to, this.$from, !0);
        },
        ...
        scrollPage: function() {
            $12.event.special.scrollstart.enabled = !1, ($12.mobile.hideUrlBar || this.toScroll !== $12.mobile.defaultHomeScroll) && window2.scrollTo(0, this.toScroll), setTimeout(function() {
                $12.event.special.scrollstart.enabled = !0;
            }, 150);
        },
        startIn: function(screenHeight, reverseClass, none, preventFocus) {
            this.hideIn(function() {
                this.$to.addClass($12.mobile.activePageClass + this.toPreClass), preventFocus || $12.mobile.focusPage(this.$to), this.$to.height(screenHeight + this.toScroll), none || this.scrollPage();
            }), this.$to.removeClass(this.toPreClass).addClass(this.name + " in " + reverseClass), none ? this.doneIn() : this.$to.animationComplete($12.proxy(function() {
                this.doneIn();
            }, this));
        },
        startOut: function(screenHeight, reverseClass, none) {
            this.beforeStartOut(screenHeight, reverseClass, none), this.$from.height(screenHeight + $12.mobile.window.scrollTop()).addClass(this.name + " out" + reverseClass);
        },
        toggleViewportClass: function() {
            $12.mobile.pageContainer.toggleClass("ui-mobile-viewport-transitioning viewport-" + this.name);
        },
        transition: function() {
            var none, reverseClass = this.reverse ? " reverse" : "", screenHeight = $12.mobile.getScreenHeight(), maxTransitionOverride = !1 !== $12.mobile.maxTransitionWidth && $12.mobile.window.width() > $12.mobile.maxTransitionWidth;
            return this.toScroll = $12.mobile.navigate.history.getActive().lastScroll || $12.mobile.defaultHomeScroll, none = !$12.support.cssTransitions || !$12.support.cssAnimations || maxTransitionOverride || !this.name || "none" === this.name || Math.max($12.mobile.window.scrollTop(), this.toScroll) > $12.mobile.getMaxScrollForTransition(), this.toggleViewportClass(), this.$from && !none ? this.startOut(screenHeight, reverseClass, none) : this.doneOut(screenHeight, reverseClass, none, !0), this.deferred.promise();
        }
    ...
    }), ($13 = jQuery).mobile.transitionHandlers = {
        sequential: $13.mobile.SerialTransition,
        simultaneous: $13.mobile.ConcurrentTransition
    }, $13.mobile.defaultTransitionHandler = $13.mobile.transitionHandlers.sequential, $13.mobile.transitionFallbacks = {}, $13.mobile._maybeDegradeTransition = function(transition) {
        return transition && !$13.support.cssTransform3d && $13.mobile.transitionFallbacks[transition] && (transition = $13.mobile.transitionFallbacks[transition]), transition;
    }, $13.mobile.getMaxScrollForTransition = $13.mobile.getMaxScrollForTransition || function() {
        return 3 * $13.mobile.getScreenHeight();
    }, jQuery.mobile.transitionFallbacks.flip = "fade", jQuery.mobile.transitionFallbacks.flow = "fade", jQuery.mobile.transitionFallbacks.pop = "fade", ($14 = jQuery).mobile.transitionHandlers.slide = $14.mobile.transitionHandlers.simultaneous, $14.mobile.transitionFallbacks.slide = "fade", jQuery.mobile.transitionFallbacks.slidedown = "fade", jQuery.mobile.transitionFallbacks.slidefade = "fade", jQuery.mobile.transitionFallbacks.slideup = "fade", jQuery.mobile.transitionFallbacks.turn = "fade", ($15 = jQuery).mobile.degradeInputs = {
        color: !1,
        date: !1,
        datetime: !1,
        "datetime-local": !1,
        ...
        url: !1,
        week: !1
    }, $15.mobile.page.prototype.options.degradeInputs = $15.mobile.degradeInputs, $15.mobile.degradeInputsWithin = function(target) {
        (target = $15(target)).find("input").not($15.mobile.page.prototype.keepNativeSelector()).each(function() {
            var html, hasType, repstr, element = $15(this), type = this.getAttribute("type"), optType = $15.mobile.degradeInputs[type] || "text";
            $15.mobile.degradeInputs[type] && (hasType = (html = $15("<div>").html(element.clone()).html()).indexOf(" type=") > -1, repstr = ' type="' + optType + '" data-' + $15.mobile.ns + 'type="' + type + '"' + (hasType ? "" : ">"), element.replaceWith(html.replace(hasType ? /\s+type=["']?\w+['"]?/ : /\/?>/, repstr)));
        });
    ...
    }(jQuery, 0), $16 = jQuery, rInitialLetter = /([A-Z])/g, iconposClass = function(iconpos) {
        return "ui-btn-icon-" + (null === iconpos ? "left" : iconpos);
    }, $16.widget("mobile.collapsible", {
        options: {
            enhanced: !1,
            expandCueText: null,
        ...
        _create: function() {
            var elem = this.element, ui = {
                accordion: elem.closest(":jqmData(role='collapsible-set'),:jqmData(role='collapsibleset')" + ($16.mobile.collapsibleset ? ", :mobile-collapsibleset" : "")).addClass("ui-collapsible-set")
            };
            this._ui = ui, this._renderedOptions = this._getOptions(this.options), this.options.enhanced ? (ui.heading = $16(".ui-collapsible-heading", this.element[0]), ui.content = ui.heading.next(), ui.anchor = $16("a", ui.heading[0]).first(), ui.status = ui.anchor.children(".ui-collapsible-heading-status")) : this._enhance(elem, ui), this._on(ui.heading, {
                tap: function() {
                    ui.heading.find("a").first().addClass($16.mobile.activeBtnClass);
                },
        ...
        _getOptions: function(options) {
            ...
            for(key in options = $16.extend({}, options), accordion.length && !accordionWidget && (this._ui.accordionWidget = accordionWidget = accordion.data("mobile-collapsibleset")), options)options[key] = null != options[key] ? options[key] : accordionWidget ? accordionWidget.options[key] : accordion.length ? $16.mobile.getAttribute(accordion[0], key.replace(rInitialLetter, "-$1").toLowerCase()) : null, null == options[key] && (options[key] = $16.mobile.collapsible.defaults[key]);
            return options;
        },
        ...
        _enhance: function(elem, ui) {
            ...
            return elem.addClass("ui-collapsible " + (opts.inset ? "ui-collapsible-inset " : "") + (opts.inset && opts.corners ? "ui-corner-all " : "") + (contentThemeClass ? "ui-collapsible-themed-content " : "")), ui.originalHeading = elem.children(this.options.heading).first(), ui.content = elem.wrapInner("<div class='ui-collapsible-content " + contentThemeClass + "'></div>").children(".ui-collapsible-content"), ui.heading = ui.originalHeading, ui.heading.is("legend") && (ui.heading = $16("<div role='heading'>" + ui.heading.html() + "</div>"), ui.placeholder = $16("<div><!-- placeholder for legend --></div>").insertBefore(ui.originalHeading), ui.originalHeading.remove()), iconclass = opts.collapsed ? opts.collapsedIcon ? "ui-icon-" + opts.collapsedIcon : "" : opts.expandedIcon ? "ui-icon-" + opts.expandedIcon : "", ui.status = $16("<span class='ui-collapsible-heading-status'></span>"), ui.anchor = ui.heading.detach().addClass("ui-collapsible-heading").append(ui.status).wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().addClass("ui-btn " + (iconclass ? iconclass + " " : "") + (iconclass ? iconposClass(opts.iconpos) + " " : "") + this._themeClassFromOption("ui-btn-", opts.theme) + " " + (opts.mini ? "ui-mini " : "")), ui.heading.insertBefore(ui.content), this._handleExpandCollapse(this.options.collapsed), ui;
        },
        refresh: function() {
        ...
        _handleExpandCollapse: function(isCollapse) {
            ...
            ui.status.text(isCollapse ? opts.expandCueText : opts.collapseCueText), ui.heading.toggleClass("ui-collapsible-heading-collapsed", isCollapse).find("a").first().toggleClass("ui-icon-" + opts.expandedIcon, !isCollapse).toggleClass("ui-icon-" + opts.collapsedIcon, isCollapse || opts.expandedIcon === opts.collapsedIcon).removeClass($16.mobile.activeBtnClass), this.element.toggleClass("ui-collapsible-collapsed", isCollapse), ui.content.toggleClass("ui-collapsible-content-collapsed", isCollapse).attr("aria-hidden", isCollapse).trigger("updatelayout"), this.options.collapsed = isCollapse, this._trigger(isCollapse ? "collapse" : "expand");
        },
        expand: function() {
    ...
    }), $16.mobile.collapsible.defaults = {
    ...
    }(jQuery), disabledZoom = (initialContent = (meta = ($17 = jQuery)("meta[name=viewport]")).attr("content")) + ",maximum-scale=1, user-scalable=no", enabledZoom = initialContent + ",maximum-scale=10, user-scalable=yes", disabledInitially = /(user-scalable[\s]*=[\s]*no)|(maximum-scale[\s]*=[\s]*1)[$,\s]/.test(initialContent), $17.mobile.zoom = $17.extend({}, {
        enabled: !disabledInitially,
        locked: !1,
        disable: function(lock) {
            disabledInitially || $17.mobile.zoom.locked || (meta.attr("content", disabledZoom), $17.mobile.zoom.enabled = !1, $17.mobile.zoom.locked = lock || !1);
        },
        enable: function(unlock) {
            disabledInitially || $17.mobile.zoom.locked && !0 !== unlock || (meta.attr("content", enabledZoom), $17.mobile.zoom.enabled = !0, $17.mobile.zoom.locked = !1);
        },
        restore: function() {
            disabledInitially || (meta.attr("content", initialContent), $17.mobile.zoom.enabled = !0);
        }
    }), function($, undefined) {
        ...
        $.widget("mobile.slider", $.extend({
            ...
            refresh: function(val, isfromControl, preventInputUpdate) {
                var bg, left, width, data, pxStep, percent, control, isInput, optionElements, min, max, step, newval, valModStep, alignValue, handlePercent, aPercent, bPercent, valueChanged, self = this, parentTheme = $.mobile.getAttribute(this.element[0], "theme"), theme = this.options.theme || parentTheme, trackTheme = this.options.trackTheme || parentTheme, cornerClass = this.options.corners ? " ui-corner-all" : "", miniClass = this.options.mini ? " ui-mini" : "";
    ...
    }(jQuery), rDividerListItem = /(^|\s)ui-li-divider(\s|$)/, origDefaultFilterCallback = ($18 = jQuery).mobile.filterable.prototype.options.filterCallback, $18.mobile.filterable.prototype.options.filterCallback = function(index, searchValue) {
        return !this.className.match(rDividerListItem) && origDefaultFilterCallback.call(this, index, searchValue);
    }, $18.widget("mobile.filterable", $18.mobile.filterable, {
        options: {
        ...
        _create: function() {
            ...
            for(this._super(), $18.extend(this, {
                _widget: null
            }), idx = recognizedWidgets.length - 1; idx > -1; idx--)if (widgetName = recognizedWidgets[idx], $18.mobile[widgetName]) {
        ...
        _setInput: function(selector) {
            ...
            if (!selector) {
                ...
                updatePlaceholder = !1, selector = $18("<input data-" + $18.mobile.ns + "type='search' placeholder='" + opts.filterPlaceholder + "'></input>").jqmData("ui-filterable-" + this.uuid + "-internal", !0), $18("<form class='ui-filterable'></form>").append(selector).submit(function(evt) {
                    evt.preventDefault(), selector.blur();
                }).insertBefore(this.element), $18.mobile.textinput && (null != this.options.filterTheme && (textinputOpts.theme = opts.filterTheme), selector.textinput(textinputOpts));
            }
        ...
        _setOptions: function(options) {
            ...
            return undefined8 !== options.filterPlaceholder && this._isSearchInternal() && this._search.attr("placeholder", options.filterPlaceholder), undefined8 !== options.filterTheme && this._search && $18.mobile.textinput && this._search.textinput("option", "theme", options.filterTheme), ret;
        },
        _destroy: function() {
        ...
        _syncTextInputOptions: function(options) {
            ...
            if (this._isSearchInternal() && $18.mobile.textinput) {
                for(idx in $18.mobile.textinput.prototype.options)undefined8 !== options[idx] && ("theme" === idx && null != this.options.filterTheme ? textinputOptions[idx] = this.options.filterTheme : textinputOptions[idx] = options[idx]);
