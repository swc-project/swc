!function(root, doc, factory) {
    ...
    var $, bool, docElem, refNode, fakeBody, div, $1, self, $win, dummyFnToInitNavigate, $2, heldCall, curr, diff, handler, lastCall, $3, baseElement, base, $4, defaultGetMaxScrollForTransition, $5, $6, $7, $8, $9, meta, initialContent, disabledZoom, enabledZoom, disabledInitially, $10;
    jQuery.mobile = {};
    ...
    !function($, window, undefined) {
        ...
        $.fn.jqmData = function(prop, value) {
            var result;
            if (void 0 !== prop) {
                prop && (prop = $.mobile.nsNormalize(prop));
                result = arguments.length < 2 || void 0 === value ? this.data(prop) : this.data(prop, value);
            }
            return result;
        };
    ...
    !function($, undefined) {
        ...
        $.support.selectstart = "onselectstart" in document1.createElement("div");
        $.fn.extend({
    ...
    !function($, window, undefined) {
        ...
        $.extend($.mobile, {
            ...
            silentScroll: function(ypos) {
                "number" !== $.type(ypos) && (ypos = $.mobile.defaultHomeScroll);
            ...
            removeActiveLinkClass: function(forceRemoval) {
                $.mobile.activeClickedLink && (!$.mobile.activeClickedLink.closest("." + $.mobile.activePageClass).length || forceRemoval) && $.mobile.activeClickedLink.removeClass($.mobile.activeBtnClass);
            ...
            resetActivePageHeight: function(height) {
                ...
                height = compensateToolbars(page, "number" == typeof height ? height : $.mobile.getScreenHeight());
        ...
        $.fn.extend({
            ...
            enhanceWithin: function() {
                ...
                $.mobile.nojs && $.mobile.nojs(this);
                $.mobile.links && $.mobile.links(this);
                $.mobile.degradeInputsWithin && $.mobile.degradeInputsWithin(this);
                $.fn.buttonMarkup && this.find($.fn.buttonMarkup.initSelector).not(keepNative).jqmEnhanceable().buttonMarkup();
                $.fn.fieldcontain && this.find(":jqmData(role='fieldcontain')").not(keepNative).jqmEnhanceable().fieldcontain();
    ...
    !function($, undefined) {
        ...
        $.widget = function(name, base, prototype) {
            ...
            return $.widget.bridge(name, constructor), constructor;
        };
        ...
        $.Widget.prototype = {
            ...
            option: function(key, value) {
                ...
                if ("string" == typeof key) {
                    ...
                    if (parts.length) {
                        ...
                        key = parts.pop();
                        if (value === undefined) return undefined === curOption[key] ? null : curOption[key];
                        curOption[key] = value;
                    } else {
            ...
            _on: function(suppressDisabledCheck, element, handlers) {
                ...
                $.each(handlers, function(event1, handler) {
            ...
            _hoverable: function(element) {
                ...
                this._on(element, {
                    mouseenter: function(event1) {
                        $(event1.currentTarget).addClass("ui-state-hover");
                    },
                    mouseleave: function(event1) {
                        $(event1.currentTarget).removeClass("ui-state-hover");
                    }
                });
            },
            _focusable: function(element) {
                ...
                this._on(element, {
                    focusin: function(event1) {
                        $(event1.currentTarget).addClass("ui-state-focus");
                    },
                    focusout: function(event1) {
                        $(event1.currentTarget).removeClass("ui-state-focus");
                    }
                });
            },
            _trigger: function(type, event1, data) {
                ...
                data = data || {};
                (event1 = $.Event(event1)).type = (type === this.widgetEventPrefix ? type : this.widgetEventPrefix + type).toLowerCase();
                event1.target = this.element[0];
                if (orig = event1.originalEvent) for(prop in orig)prop in event1 || (event1[prop] = orig[prop]);
                return this.element.trigger(event1, data), !($.isFunction(callback) && !1 === callback.apply(this.element[0], [
                    event1
    ...
    !function($) {
        ...
        $.widget("mobile.loader", {
            ...
            show: function(theme, msgText, textonly) {
                ...
                this.resetHtml();
                if ("object" === $.type(theme)) theme = (loadSettings = $.extend({}, this.options, theme)).theme;
                else {
                    loadSettings = this.options;
                    theme = theme || loadSettings.theme;
                }
                message = msgText || (!1 === loadSettings.text ? "" : loadSettings.text);
                ...
                loadSettings.html ? this.element.html(loadSettings.html) : this.element.find("h1").text(message);
    ...
    !function($, window, undefined) {
        ...
        fake_onhashchange = function() {
            ...
            return !window.attachEvent || window.addEventListener || supports_onhashchange || (self.start = function() {
                if (!iframe) {
                    iframe_src = (iframe_src = $.fn[str_hashchange].src) && iframe_src + get_fragment();
    ...
    $ = jQuery, window.matchMedia = window.matchMedia || (refNode = (docElem = document1.documentElement).firstElementChild || docElem.firstChild, fakeBody = document1.createElement("body"), (div = document1.createElement("div")).id = "mq-test-1", div.style.cssText = "position:absolute;top:-100em", fakeBody.style.background = "none", fakeBody.appendChild(div), function(q) {
    ...
    !function($, undefined) {
        ...
        $.extend($.support, {
            ...
            cssTransform3d: function() {
                ...
                if (ret) return !!ret;
                el = document1.createElement("div");
                transforms = {
                    MozTransform: "-moz-transform",
                    transform: "transform"
                };
                fakeBody.append(el);
                for(t in transforms)if (undefined !== el.style[t]) {
        ...
        fakeBody.remove();
        nokiaLTE7_3 = (ua1 = window.navigator.userAgent).indexOf("Nokia") > -1 && (ua1.indexOf("Symbian/3") > -1 || ua1.indexOf("Series60/5") > -1) && ua1.indexOf("AppleWebKit") > -1 && ua1.match(/(BrowserNG|NokiaBrowser)\/7\.[0-3]/);
    ...
    $win = ($1 = jQuery).mobile.window, dummyFnToInitNavigate = function() {}, $1.event.special.beforenavigate = {
        setup: function() {
    ...
    }, $1.event.special.navigate = self = {
        bound: !1,
        pushStateEnabled: !0,
        originalEventName: void 0,
        isPushStateEnabled: function() {
            return $1.support.pushState && !0 === $1.mobile.pushStateEnabled && this.isHashChangeEnabled();
        },
        isHashChangeEnabled: function() {
            return !0 === $1.mobile.hashListeningEnabled;
        },
        popstate: function(event1) {
            var newEvent = new $1.Event("navigate"), beforeNavigate = new $1.Event("beforenavigate"), state = event1.originalEvent.state || {};
            beforeNavigate.originalEvent = event1;
            $win.trigger(beforeNavigate);
            if (!beforeNavigate.isDefaultPrevented()) {
                event1.historyState && $1.extend(state, event1.historyState);
                newEvent.originalEvent = event1;
                setTimeout(function() {
        ...
        hashchange: function(event1) {
            var newEvent = new $1.Event("navigate"), beforeNavigate = new $1.Event("beforenavigate");
            beforeNavigate.originalEvent = event1;
            $win.trigger(beforeNavigate);
            if (!beforeNavigate.isDefaultPrevented()) {
                newEvent.originalEvent = event1;
    ...
    !function($, undefined) {
        ...
        $.mobile.path = path = {
            ...
            makePathAbsolute: function(relPath, absPath) {
                ...
                relPath = relPath || "";
                absStack = (absPath = absPath ? absPath.replace(/^\/|(\/[^\/]*|[^\/]+)$/g, "") : "") ? absPath.split("/") : [];
            ...
            squash: function(url, resolutionUrl) {
                ...
                if ((stateIndex = (cleanedUrl = path.isPath(uri.hash) ? path.stripHash(uri.hash) : cleanedUrl).indexOf(this.uiStateKey)) > -1) {
                ...
                if (isPath) {
                    (path.isPath(preservedHash) || 0 === preservedHash.replace("#", "").indexOf(this.uiStateKey)) && (preservedHash = "");
                    uiState && -1 === preservedHash.indexOf(this.uiStateKey) && (preservedHash += uiState);
                    -1 === preservedHash.indexOf("#") && "" !== preservedHash && (preservedHash = "#" + preservedHash);
                    href = (href = path.parseUrl(href)).protocol + "//" + href.host + href.pathname + search + preservedHash;
    ...
    !function($, undefined) {
        ...
        $.extend($.mobile.History.prototype, {
            ...
            add: function(url, data) {
                ...
                data.hash && -1 === data.hash.indexOf("#") && (data.hash = "#" + data.hash);
                data.url = url;
            ...
            direct: function(opts) {
                ...
                newActiveIndex < a ? (opts.present || opts.back || $.noop)(this.getActive(), "back") : newActiveIndex > a ? (opts.present || opts.forward || $.noop)(this.getActive(), "forward") : newActiveIndex === undefined && opts.missing && opts.missing(this.getActive());
            }
        });
    }(jQuery);
    !function($, undefined) {
        var path = $.mobile.path, initialHref = location.href;
        $.mobile.Navigator = function(history1) {
        ...
        $.extend($.mobile.Navigator.prototype, {
            ...
            go: function(url, data, noEvents) {
                ...
                noEvents && hash !== path.stripHash(path.parseLocation().hash) && (this.preventNextHashChange = noEvents);
                ...
                if (isPopStateEvent) {
                    (popstateEvent = new $.Event("popstate")).originalEvent = {
                        type: "popstate",
                        state: null
                    };
            ...
            popstate: function(event1) {
                ...
                if ($.event.special.navigate.isPushStateEnabled()) {
                    ...
                    if (!event1.originalEvent.state && 1 === this.history.stack.length && this.ignoreInitialHashChange) {
                    ...
                    if (!event1.originalEvent.state && hash) {
                    ...
                    this.history.direct({
                        ...
                        present: function(historyEntry, direction) {
                            event1.historyState = $.extend({}, historyEntry);
                            event1.historyState.direction = direction;
                        }
                    });
                }
            },
            hashchange: function(event1) {
                ...
                if (!(!$.event.special.navigate.isHashChangeEnabled() || $.event.special.navigate.isPushStateEnabled())) {
                    ...
                    this.history.direct({
                        url: hash,
                        present: function(historyEntry, direction) {
                            event1.hashchangeState = $.extend({}, historyEntry);
                            event1.hashchangeState.direction = direction;
                        },
                        missing: function() {
                            history1.add(hash, {
                                hash: hash,
    ...
    !function($, undefined) {
        ...
        $.each([
            ...
            "" === props[test].prefix && (props[test].event = props[test].event.toLowerCase());
        });
        ...
        $.fn.animationComplete = function(callback, type, fallbackTime) {
            ...
            if ($.support.cssTransitions && "transition" === animationType || $.support.cssAnimations && "animation" === animationType) {
                if (fallbackTime === undefined) {
                    $(this).context !== document1 && (duration = 3000 * parseFloat($(this).css(props[animationType].duration)));
                    (0 === duration || duration === undefined || isNaN(duration)) && (duration = $.fn.animationComplete.defaultDuration);
                }
            ...
            return setTimeout($.proxy(callback, this), 0), $(this);
        };
    ...
    !function($, window, document1, undefined) {
        ...
        function triggerVirtualEvent(eventType, event1, flags) {
            var ve;
            if (flags && flags[eventType] || !flags && function(element, eventType) {
                for(var b; element;){
                    if ((b = $.data(element, dataPropertyName)) && (!eventType || b[eventType])) return element;
                    element = element.parentNode;
                }
                return null;
            }(event1.target, eventType)) {
                ve = function(event1, eventType) {
                    var oe, props, ne, prop, ct, touch, i, j, len, t = event1.type;
                    (event1 = $.Event(event1)).type = eventType;
                    oe = event1.originalEvent;
                    props = $.event.props;
                    t.search(/^(mouse|click)/) > -1 && (props = mouseEventProps);
                    if (oe) for(i = props.length; i;)event1[prop = props[--i]] = oe[prop];
                    t.search(/mouse(down|up)|click/) > -1 && !event1.which && (event1.which = 1);
                    if (-1 !== t.search(/^touch/)) {
                        t = (ne = getNativeEvent(oe)).touches;
                        ct = ne.changedTouches;
                        if (touch = t && t.length ? t[0] : ct && ct.length ? ct[0] : void 0) for(j = 0, len = touchEventProps.length; j < len; j++)event1[prop = touchEventProps[j]] = touch[prop];
                    }
                    return event1;
                }(event1, eventType);
                $(event1.target).trigger(ve);
            }
            return ve;
        }
        function mouseEventCallback(event1) {
            var ve, touchID = $.data(event1.target, touchTargetPropertyName);
            if (!blockMouseTriggers && (!lastTouchID || lastTouchID !== touchID) && (ve = triggerVirtualEvent("v" + event1.type, event1))) {
                ve.isDefaultPrevented() && event1.preventDefault();
                ve.isPropagationStopped() && event1.stopPropagation();
                ve.isImmediatePropagationStopped() && event1.stopImmediatePropagation();
            }
        }
        function handleTouchStart(event1) {
            var target, flags, t, touches = getNativeEvent(event1).touches;
            if (touches && 1 === touches.length && (flags = getVirtualBindingFlags(target = event1.target)).hasVirtualBinding) {
                lastTouchID = nextTouchID++;
                $.data(target, touchTargetPropertyName, lastTouchID);
                clearResetTimer();
                blockTouchTriggers = !1;
                didScroll = !1;
                startX = (t = getNativeEvent(event1).touches[0]).pageX;
                startY = t.pageY;
                triggerVirtualEvent("vmouseover", event1, flags);
                triggerVirtualEvent("vmousedown", event1, flags);
            }
        }
        function handleScroll(event1) {
            if (!blockTouchTriggers) {
                didScroll || triggerVirtualEvent("vmousecancel", event1, getVirtualBindingFlags(event1.target));
                didScroll = !0;
                startResetTimer();
            }
        }
        function handleTouchMove(event1) {
            if (!blockTouchTriggers) {
                ...
                (didScroll = didScroll || Math.abs(t.pageX - startX) > moveThreshold || Math.abs(t.pageY - startY) > moveThreshold) && !didCancel && triggerVirtualEvent("vmousecancel", event1, flags);
                triggerVirtualEvent("vmousemove", event1, flags);
                startResetTimer();
            }
        }
        function handleTouchEnd(event1) {
            if (!blockTouchTriggers) {
                ...
                triggerVirtualEvent("vmouseup", event1, flags);
                if (!didScroll && (ve = triggerVirtualEvent("vclick", event1, flags)) && ve.isDefaultPrevented()) {
                    t = getNativeEvent(event1).changedTouches[0];
                    clickBlockList.push({
                        touchID: lastTouchID,
                        x: t.clientX,
                        y: t.clientY
                ...
                triggerVirtualEvent("vmouseout", event1, flags);
                didScroll = !1;
                startResetTimer();
            }
        }
    ...
    !function($, window, undefined) {
        ...
        function triggerCustomEvent(obj, eventType, event1, bubble) {
            ...
            bubble ? $.event.trigger(event1, void 0, obj) : $.event.dispatch.call(obj, event1);
        ...
        $.event.special.tap = {
            ...
            setup: function() {
                ...
                $this.bind("vmousedown", function(event1) {
                    isTaphold = !1;
                    if (event1.which && 1 !== event1.which) return !1;
                    ...
                    function clickHandler(event1) {
                        clearTapHandlers();
                        isTaphold || origTarget !== event1.target ? isTaphold && event1.stopPropagation() : triggerCustomEvent(thisObject, "tap", event1);
                    }
        ...
        $.event.special.swipe = {
            ...
            getLocation: function(event1) {
                ...
                if (0 === event1.pageY && Math.floor(y) > Math.floor(event1.pageY) || 0 === event1.pageX && Math.floor(x) > Math.floor(event1.pageX)) {
                    x -= winPageX;
                    y -= winPageY;
                } else if (y < event1.pageY - winPageY || x < event1.pageX - winPageX) {
                    x = event1.pageX - winPageX;
                    y = event1.pageY - winPageY;
                }
                return {
                    x: x,
                    y: y
            ...
            setup: function() {
                ...
                if (!(events = $.data(this, "mobile-events"))) {
                    events = {
                        length: 0
                    };
                ...
                context.start = function(event1) {
                    if (!$.event.special.swipe.eventInProgress) {
                        ...
                        context.move = function(event1) {
                            if (start) {
                                stop = $.event.special.swipe.stop(event1);
                                !emitted && (emitted = $.event.special.swipe.handleSwipe(start, stop, thisObject, origTarget)) && ($.event.special.swipe.eventInProgress = !1);
                                Math.abs(start.coords[0] - stop.coords[0]) > $.event.special.swipe.scrollSupressionThreshold && event1.preventDefault();
                            }
                        };
    ...
    jQuery.event.special.throttledresize = {
        ...
        if ((diff = (curr = new Date().getTime()) - lastCall) >= 250) {
            lastCall = curr;
    ...
    !function($, window) {
        ...
        if ($.support.orientation) {
            ...
            (initial_orientation_is_landscape && initial_orientation_is_default || !initial_orientation_is_landscape && !initial_orientation_is_default) && (portrait_map = {
                "-90": !0,
                90: !0
            });
        }
    ...
    base = {
        element: (baseElement = ($3 = jQuery)("head").children("base")).length ? baseElement : $3("<base>", {
            href: $3.mobile.path.documentBase.hrefNoHash
        }).prependTo($3("head")),
        linkSelector: "[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]",
        set: function(href) {
            $3.mobile.dynamicBaseEnabled && $3.support.dynamicBaseTag && base.element.attr("href", $3.mobile.path.makeUrlAbsolute(href, $3.mobile.path.documentBase));
        },
        rewrite: function(href, page) {
            var newPath = $3.mobile.path.get(href);
            page.find(base.linkSelector).each(function(i, link) {
                var thisAttr = $3(link).is("[href]") ? "href" : $3(link).is("[src]") ? "src" : "action", thisUrl = $3(link).attr(thisAttr);
                thisUrl = thisUrl.replace(location.protocol + "//" + location.host + location.pathname, "");
                /^(\w+:|#|\/)/.test(thisUrl) || $3(link).attr(thisAttr, newPath + thisUrl);
            });
        },
        reset: function() {
            base.element.attr("href", $3.mobile.path.documentBase.hrefNoSearch);
        }
    }, $3.mobile.base = base;
    !function($, undefined) {
        $.mobile.widgets = {};
        var orig, originalWidget = $.widget, keepNativeFactoryDefault = $.mobile.keepNative;
        $.widget = (orig = $.widget, function() {
        ...
        $.mobile.document.on("create", function(event1) {
            $(event1.target).enhanceWithin();
        });
        $.widget("mobile.page", {
            options: {
                theme: "a",
            ...
            _create: function() {
                ...
                "dialog" === $.mobile.getAttribute(this.element[0], "role") && $.mobile.dialog && this.element.dialog();
            },
            _enhance: function() {
                var attrPrefix = "data-" + $.mobile.ns, self = this;
                this.options.role && this.element.attr("data-" + $.mobile.ns + "role", this.options.role);
                ...
                this.element.find("[" + attrPrefix + "role='content']").each(function() {
                    ...
                    self.options.contentTheme = theme || self.options.contentTheme || self.options.dialog && self.options.theme || "dialog" === self.element.jqmData("role") && self.options.theme;
                    $this.addClass("ui-content");
                    self.options.contentTheme && $this.addClass("ui-body-" + self.options.contentTheme);
            ...
            bindRemove: function(callback) {
                ...
                !page.data("mobile-page").options.domCache && page.is(":jqmData(external-page='true')") && page.bind("pagehide.remove", callback || function(e, data) {
                    if (!data.samePage) {
                        ...
                        prEvent.isDefaultPrevented() || $this.removeWithDependents();
                    }
                });
            },
            _setOptions: function(o) {
                undefined !== o.theme && this.element.removeClass("ui-page-theme-" + this.options.theme).addClass("ui-page-theme-" + o.theme);
                undefined !== o.contentTheme && this.element.find("[data-" + $.mobile.ns + "='content']").removeClass("ui-body-" + this.options.contentTheme).addClass("ui-body-" + o.contentTheme);
            },
    ...
    !function($, undefined) {
        $.widget("mobile.pagecontainer", {
            ...
            _setOptions: function(options) {
                undefined !== options.theme && "none" !== options.theme ? this.element.removeClass("ui-overlay-" + this.options.theme).addClass("ui-overlay-" + options.theme) : undefined !== options.theme && this.element.removeClass("ui-overlay-" + this.options.theme);
                this._super(options);
            },
            ...
            _filterNavigateEvents: function(e, data) {
                ...
                if (!(e.originalEvent && e.originalEvent.isDefaultPrevented())) {
                    (url = e.originalEvent.type.indexOf("hashchange") > -1 ? data.state.hash : data.state.url) || (url = this._getHash());
                    url && "#" !== url && 0 !== url.indexOf("#" + $.mobile.path.uiStateKey) || (url = location.href);
            ...
            go: function(steps) {
                if ($.mobile.hashListeningEnabled) window.history.go(steps);
                    ...
                    var activeIndex = $.mobile.navigate.history.activeIndex, index = activeIndex + parseInt(steps, 10), url = $.mobile.navigate.history.stack[index].url;
            ...
            _handleDestination: function(to) {
                var history1;
                "string" === $.type(to) && (to = $.mobile.path.stripHash(to));
                if (to) {
                    history1 = this._getHistory();
                    (to = $.mobile.path.isPath(to) ? to : $.mobile.path.makeUrlAbsolute("#" + to, this._getDocumentBase())) === $.mobile.path.makeUrlAbsolute("#" + history1.initialDst, this._getDocumentBase()) && history1.stack.length && history1.stack[0].url !== history1.initialDst.replace($.mobile.dialogHashKey, "") && (to = this._getInitialContent());
                }
            ...
            _handleNavigate: function(url, data) {
                var to = $.mobile.path.stripHash(url), history1 = this._getHistory(), transition = 0 === history1.stack.length ? "none" : undefined, changePageOptions = {
                    changeHash: !1,
                    fromHashChange: !0,
                    reverse: "back" === data.direction
                };
                ...
                history1.activeIndex > 0 && to.indexOf($.mobile.dialogHashKey) > -1 && history1.initialDst !== to && !1 === (to = this._handleDialog(changePageOptions, data)) || this._changeContent(this._handleDestination(to), changePageOptions);
            },
            ...
            _showError: function() {
                this._hideLoading();
                this._showLoading(0, $.mobile.pageLoadErrorMessageTheme, $.mobile.pageLoadErrorMessage, !0);
                setTimeout($.proxy(this, "_hideLoading"), 1500);
            },
            _parse: function(html, fileUrl) {
                var page, all = $("<div></div>");
                return all.get(0).innerHTML = html, (page = all.find(":jqmData(role='page'), :jqmData(role='dialog')").first()).length || (page = $("<div data-" + this._getNs() + "role='page'>" + (html.split(/<\/?body[^>]*>/gim)[1] || "") + "</div>")), page.attr("data-" + this._getNs() + "url", $.mobile.path.convertUrlToDataUrl(fileUrl)).attr("data-" + this._getNs() + "external-page", !0), page;
            },
            ...
            _loadSuccess: function(absUrl, triggerData, settings, deferred) {
                ...
                return $.proxy(function(html, textStatus, xhr) {
                    ...
                    pageElemRegex.test(html) && RegExp.$1 && dataUrlRegex.test(RegExp.$1) && RegExp.$1 && (fileUrl = $.mobile.path.getFilePath($("<div>" + RegExp.$1 + "</div>").text()));
                    undefined === settings.prefetch && this._getBase().set(fileUrl);
                    ...
                    if (this._trigger("load", undefined, triggerData)) {
                        this._isRewritableBaseTag() && content && this._getBase().rewrite(fileUrl, content);
                        this._include(content, settings);
                        absUrl.indexOf("&" + $.mobile.subPageUrlKey) > -1 && (content = this.element.children("[data-" + this._getNs() + "url='" + dataUrl + "']"));
            ...
            load: function(url, options) {
                ...
                if (settings.data && "get" === settings.type) {
                ...
                if (0 === (content = this._find(absUrl)).length && $.mobile.path.isEmbeddedPage(fileUrl) && !$.mobile.path.isFirstPageUrl(fileUrl)) {
                ...
                if (!((pblEvent = this._triggerWithDeprecated("beforeload", triggerData)).deprecatedEvent.isDefaultPrevented() || pblEvent.event.isDefaultPrevented())) {
                    settings.showLoadMsg && this._showLoading(settings.loadMsgDelay);
                    undefined === settings.prefetch && this._getBase().reset();
            ...
            _releaseTransitionLock: function() {
                ...
                pageTransitionQueue.length > 0 && $.mobile.changePage.apply(null, pageTransitionQueue.pop());
            },
            ...
            change: function(to, options) {
                ...
                if (this._triggerPageBeforeChange(to, triggerData, settings)) {
                    ...
                    } else this.transition(to, triggerData, settings);
                }
            },
            transition: function(toPage, triggerData, settings) {
                ...
                if (!(!this._triggerPageBeforeChange(toPage, triggerData, settings) || (beforeTransition = this._triggerWithDeprecated("beforetransition", triggerData)).deprecatedEvent.isDefaultPrevented() || beforeTransition.event.isDefaultPrevented())) {
                    isPageTransitioning = !0;
                    toPage[0] !== $.mobile.firstPage[0] || settings.dataUrl || (settings.dataUrl = $.mobile.path.documentUrl.hrefNoHash);
                    fromPage = settings.fromPage;
                    pageUrl = url = settings.dataUrl && $.mobile.path.convertUrlToDataUrl(settings.dataUrl) || toPage.jqmData("url");
                    $.mobile.path.getFilePath(url);
                    active = $.mobile.navigate.history.getActive();
                    activeIsInitialPage = 0 === $.mobile.navigate.history.activeIndex;
                    historyDir = 0;
                    pageTitle = document1.title;
                    isDialog = ("dialog" === settings.role || "dialog" === toPage.jqmData("role")) && !0 !== toPage.jqmData("dialog");
                    ...
                    if (isDialog && active) {
                        if (active.url && active.url.indexOf($.mobile.dialogHashKey) > -1 && this.activePage && !this.activePage.hasClass("ui-dialog") && $.mobile.navigate.history.activeIndex > 0) {
                            settings.changeHash = !1;
                            alreadyThere = !0;
                        }
                        url = active.url || "";
                        !alreadyThere && url.indexOf("#") > -1 ? url += $.mobile.dialogHashKey : url += "#" + $.mobile.dialogHashKey;
                        0 === $.mobile.navigate.history.activeIndex && url === $.mobile.navigate.history.initialDst && (url += $.mobile.dialogHashKey);
                    }
                    (newPageTitle = active ? toPage.jqmData("title") || toPage.children(":jqmData(role='header')").find(".ui-title").text() : pageTitle) && pageTitle === document1.title && (pageTitle = newPageTitle);
                    ...
                    !historyDir && alreadyThere && ($.mobile.navigate.history.getActive().pageUrl = pageUrl);
                    if (url && !settings.fromHashChange) {
                        !$.mobile.path.isPath(url) && 0 > url.indexOf("#") && (url = "#" + url);
                        params = {
                        ...
                        !1 !== settings.changeHash && $.mobile.hashListeningEnabled ? $.mobile.navigate(url, params, !0) : toPage[0] !== $.mobile.firstPage[0] && $.mobile.navigate.history.add(url, params);
                    }
                    document1.title = pageTitle;
                    ...
                    cssTransitionDeferred.done($.proxy(function(name, reverse, $to, $from, alreadyFocused) {
                        ...
                        settings.duplicateCachedPage && settings.duplicateCachedPage.remove();
                        alreadyFocused || $.mobile.focusPage(toPage);
                        this._releaseTransitionLock();
                        this.element.trigger("pagechange", triggerData);
                        this._triggerWithDeprecated("transition", triggerData);
                    }, this));
    ...
    !function($, undefined) {
        ...
        $.mobile._registerInternalEvents = function() {
            var getAjaxFormData = function($form, calculateOnly) {
                ...
                if (!$.mobile.ajaxEnabled || $form.is(":jqmData(ajax='false')") || !$form.jqmHijackable().length || $form.attr("target")) return !1;
                url = $lastVClicked && $lastVClicked.attr("formaction") || $form.attr("action");
                method = ($form.attr("method") || "get").toLowerCase();
                if (!url) {
                    url = $.mobile.getClosestBaseUrl($form);
                    "get" === method && (url = $.mobile.path.parseUrl(url).hrefNoSearch);
                    url === $.mobile.path.documentBase.hrefNoHash && (url = documentUrl.hrefNoSearch);
                }
                url = $.mobile.path.makeUrlAbsolute(url, $.mobile.getClosestBaseUrl($form));
                if ($.mobile.path.isExternal(url) && !$.mobile.path.isPermittedCrossDomainRequest(documentUrl, url)) return !1;
                if (!calculateOnly) {
                    formData = $form.serializeArray();
                    if ($lastVClicked && $lastVClicked[0].form === $form[0] && (vclickedName = $lastVClicked.attr("name"))) {
            ...
            $.mobile.document.delegate("form", "submit", function(event1) {
                var formData;
                if (!event1.isDefaultPrevented() && (formData = getAjaxFormData($(this)))) {
            ...
            $.mobile.document.bind("vclick", function(event1) {
                ...
                if (!(event1.which > 1) && $.mobile.linkBindingEnabled) {
                    ...
                    ~target.className.indexOf("ui-link-inherit") ? target.parentNode && (btnEls = $.data(target.parentNode, "buttonElements")) : btnEls = $.data(target, "buttonElements");
            ...
            $.mobile.document.bind("click", function(event1) {
                if (!(!$.mobile.linkBindingEnabled || event1.isDefaultPrevented())) {
                    ...
                    $.mobile.activeClickedLink && $.mobile.activeClickedLink[0] === event1.target.parentNode && httpCleanup();
                    if (link && !(event1.which > 1) && $link.jqmHijackable().length) {
                        ...
                        reverse = "reverse" === $link.jqmData("direction") || $link.jqmData("back");
    ...
    !function($, window, undefined) {
        ...
        $.extend($.mobile.Transition.prototype, {
            ...
            doneIn: function() {
                ...
                $.mobile.window.scrollTop() !== this.toScroll && this.scrollPage();
                this.sequential || this.$to.addClass($.mobile.activePageClass);
            ...
            scrollPage: function() {
                $.event.special.scrollstart.enabled = !1;
                ($.mobile.hideUrlBar || this.toScroll !== $.mobile.defaultHomeScroll) && window.scrollTo(0, this.toScroll);
                setTimeout(function() {
                    $.event.special.scrollstart.enabled = !0;
                }, 150);
            },
    ...
    $4 = jQuery, defaultGetMaxScrollForTransition = function() {
        return 3 * $4.mobile.getScreenHeight();
    }, $4.mobile.transitionHandlers = {
        sequential: $4.mobile.SerialTransition,
        simultaneous: $4.mobile.ConcurrentTransition
    }, $4.mobile.defaultTransitionHandler = $4.mobile.transitionHandlers.sequential, $4.mobile.transitionFallbacks = {}, $4.mobile._maybeDegradeTransition = function(transition) {
        return transition && !$4.support.cssTransform3d && $4.mobile.transitionFallbacks[transition] && (transition = $4.mobile.transitionFallbacks[transition]), transition;
    }, $4.mobile.getMaxScrollForTransition = $4.mobile.getMaxScrollForTransition || defaultGetMaxScrollForTransition;
    ...
    ($5 = jQuery).mobile.transitionHandlers.slide = $5.mobile.transitionHandlers.simultaneous, $5.mobile.transitionFallbacks.slide = "fade";
    ...
    ($6 = jQuery).mobile.degradeInputs = {
        ...
        url: !1,
        week: !1
    }, $6.mobile.page.prototype.options.degradeInputs = $6.mobile.degradeInputs, $6.mobile.degradeInputsWithin = function(target) {
        (target = $6(target)).find("input").not($6.mobile.page.prototype.keepNativeSelector()).each(function() {
            var html, hasType, findstr, repstr, element = $6(this), type = this.getAttribute("type"), optType = $6.mobile.degradeInputs[type] || "text";
            if ($6.mobile.degradeInputs[type]) {
                findstr = (hasType = (html = $6("<div>").html(element.clone()).html()).indexOf(" type=") > -1) ? /\s+type=["']?\w+['"]?/ : /\/?>/;
                repstr = ' type="' + optType + '" data-' + $6.mobile.ns + 'type="' + type + '"' + (hasType ? "" : ">");
    ...
    !function($, window, undefined) {
        $.widget("mobile.page", $.mobile.page, {
            ...
            _enhance: function() {
                this._super();
                this.options.dialog && this.element.addClass("ui-dialog").wrapInner($("<div/>", {
                    role: "dialog",
            ...
            _setOptions: function(options) {
                ...
                undefined !== options.corners && this._inner.toggleClass("ui-corner-all", !!options.corners);
                if (undefined !== options.overlayTheme && $.mobile.activePage[0] === this.element[0]) {
                    currentOpts.overlayTheme = options.overlayTheme;
                    this._handlePageBeforeShow();
                }
                if (undefined !== options.closeBtnText) {
                    closeButtonLocation = currentOpts.closeBtn;
                    closeButtonText = options.closeBtnText;
                }
                undefined !== options.closeBtn && (closeButtonLocation = options.closeBtn);
                closeButtonLocation && this._setCloseBtn(closeButtonLocation, closeButtonText);
                this._super(options);
            },
            _handlePageBeforeShow: function() {
            ...
            _setCloseBtn: function(location1, text) {
                ...
                if ("none" == (location1 = "left" === location1 ? "left" : "right" === location1 ? "right" : "none")) {
                    if (btn) {
                        btn.remove();
                        btn = null;
                    }
                } else if (btn) {
                    btn.removeClass("ui-btn-left ui-btn-right").addClass("ui-btn-" + location1);
                    text && btn.text(text);
                } else {
        ...
        $.widget("mobile.dialog", {
            ...
            close: function() {
                ...
                if (this._isCloseable) {
                    this._isCloseable = !1;
                    $.mobile.hashListeningEnabled && hist.activeIndex > 0 ? $.mobile.back() : $.mobile.pageContainer.pagecontainer("back");
                }
            }
        });
    }(jQuery, this);
    !function($, undefined) {
        ...
        $.widget("mobile.collapsible", {
            ...
            _getOptions: function(options) {
                ...
                accordion.length && !accordionWidget && (this._ui.accordionWidget = accordionWidget = accordion.data("mobile-collapsibleset"));
                for(key in options){
                    options[key] = null != options[key] ? options[key] : accordionWidget ? accordionWidget.options[key] : accordion.length ? $.mobile.getAttribute(accordion[0], key.replace(rInitialLetter, "-$1").toLowerCase()) : null;
                    null == options[key] && (options[key] = $.mobile.collapsible.defaults[key]);
                }
                return options;
            },
            ...
            _enhance: function(elem, ui) {
                ...
                return iconclass = opts.collapsed ? opts.collapsedIcon ? "ui-icon-" + opts.collapsedIcon : "" : opts.expandedIcon ? "ui-icon-" + opts.expandedIcon : "", ui.status = $("<span class='ui-collapsible-heading-status'></span>"), ui.anchor = ui.heading.detach().addClass("ui-collapsible-heading").append(ui.status).wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().addClass("ui-btn " + (iconclass ? iconclass + " " : "") + (iconclass ? iconposClass(opts.iconpos) + " " : "") + this._themeClassFromOption("ui-btn-", opts.theme) + " " + (opts.mini ? "ui-mini " : "")), ui.heading.insertBefore(ui.content), this._handleExpandCollapse(this.options.collapsed), ui;
            },
            refresh: function() {
            ...
            _applyOptions: function(options) {
                ...
                undefined !== options.collapsed && this._handleExpandCollapse(options.collapsed);
                (isCollapsed = elem.hasClass("ui-collapsible-collapsed")) ? undefined !== opts.expandCueText && status.text(opts.expandCueText) : undefined !== opts.collapseCueText && status.text(opts.collapseCueText);
                hasIcon = undefined !== opts.collapsedIcon ? !1 !== opts.collapsedIcon : !1 !== currentOpts.collapsedIcon;
                if (!(undefined === opts.iconpos && undefined === opts.collapsedIcon && undefined === opts.expandedIcon)) {
                    anchor.removeClass([
                ...
                if (undefined !== opts.theme) {
                    oldTheme = this._themeClassFromOption("ui-btn-", currentOpts.theme);
                    newTheme = this._themeClassFromOption("ui-btn-", opts.theme);
                    anchor.removeClass(oldTheme).addClass(newTheme);
                }
                if (undefined !== opts.contentTheme) {
                ...
                if (undefined !== opts.inset) {
                    elem.toggleClass("ui-collapsible-inset", opts.inset);
                    hasCorners = !!(opts.inset && (opts.corners || currentOpts.corners));
                }
                undefined !== opts.corners && (hasCorners = !!(opts.corners && (opts.inset || currentOpts.inset)));
                hasCorners !== undefined && elem.toggleClass("ui-corner-all", hasCorners);
                undefined !== opts.mini && anchor.toggleClass("ui-mini", opts.mini);
            },
            _setOptions: function(options) {
    ...
    jQuery.fn.grid = function(options) {
        return this.each(function() {
            ...
            iterator > 1 && $kids.filter(":nth-child(" + iterator + "n+2)").addClass("ui-block-b");
            iterator > 2 && $kids.filter(":nth-child(" + iterator + "n+3)").addClass("ui-block-c");
            iterator > 3 && $kids.filter(":nth-child(" + iterator + "n+4)").addClass("ui-block-d");
            iterator > 4 && $kids.filter(":nth-child(" + iterator + "n+5)").addClass("ui-block-e");
        });
    };
    !function($, undefined) {
        $.widget("mobile.navbar", {
            ...
            _create: function() {
                ...
                $navbtns.each(function() {
                    ...
                    icon && (classes += " ui-icon-" + icon + " ui-btn-icon-" + iconpos);
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.listview", $.extend({
            ...
            refresh: function(create) {
                var buttonClass, pos, numli, item, itemClass, itemTheme, itemIcon, icon, a, isDivider, startCount, newStartCount, value, last, splittheme, splitThemeClass, altButtonClass, li, o = this.options, $list = this.element, ol = !!$.nodeName($list[0], "ol"), start = $list.attr("start"), itemClassDict = {}, countBubbles = $list.find(".ui-li-count"), countTheme = getAttr($list[0], "counttheme") || this.options.countTheme, countThemeClass = countTheme ? "ui-body-" + countTheme : "ui-body-inherit";
                ...
                for(pos = 0, numli = li.length; pos < numli; pos++){
                    item = li.eq(pos);
                    itemClass = "";
                    if (create || 0 > item[0].className.search(/\bui-li-static\b|\bui-li-divider\b/)) {
                        a = this._getChildrenByTagName(item[0], "a", "A");
                        isDivider = "list-divider" === getAttr(item[0], "role");
                        value = item.attr("value");
                        itemTheme = getAttr(item[0], "theme");
                        if (a.length && 0 > a[0].className.search(/\bui-btn\b/) && !isDivider) {
                            icon = !1 !== (itemIcon = getAttr(item[0], "icon")) && (itemIcon || o.icon);
                            a.removeClass("ui-link");
                            buttonClass = "ui-btn";
                            itemTheme && (buttonClass += " ui-btn-" + itemTheme);
                            if (a.length > 1) {
                                itemClass = "ui-li-has-alt";
                                splitThemeClass = (splittheme = getAttr((last = a.last())[0], "theme") || o.splitTheme || getAttr(item[0], "theme", !0)) ? " ui-btn-" + splittheme : "";
                                altButtonClass = "ui-btn ui-btn-icon-notext ui-icon-" + (getAttr(last[0], "icon") || getAttr(item[0], "icon") || o.splitIcon) + splitThemeClass;
                            ...
                            itemClass = "ui-li-divider ui-bar-" + (getAttr(item[0], "theme") || o.dividerTheme || o.theme || "inherit");
                            item.attr("role", "heading");
                        } else a.length <= 0 && (itemClass = "ui-li-static ui-body-" + (itemTheme || "inherit"));
                        if (ol && value) {
        ...
        $.widget("mobile.listview", $.mobile.listview, {
            ...
            _replaceDividers: function() {
                ...
                for(i = 0; i < lis.length; i++){
                    li = lis[i];
                    if ((dividerText = this.options.autodividersSelector($(li))) && lastDividerText !== dividerText) {
                        (divider = document1.createElement("li")).appendChild(document1.createTextNode(dividerText));
        ...
        $.widget("mobile.listview", $.mobile.listview, {
            ...
            _afterListviewRefresh: function() {
                ...
                if (this.options.hideDividers) {
                    ...
                    for(idx = items.length - 1; idx > -1; idx--)if ((item = items[idx]).className.match(rdivider)) {
                        hideDivider && (item.className = item.className + " ui-screen-hidden");
                        hideDivider = !0;
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.checkboxradio", $.extend({
            ...
            _enhance: function() {
                ...
                if (this.parentLabel.length > 0) this.input.add(this.label).wrapAll(this._wrapper());
                else {
            ...
            _getInputSet: function() {
                ...
                if (name && "radio" === this.inputtype && doc) {
                    ...
                    if (form) {
                        (formId = form.id) && (radios = $(selector + "[form='" + escapeId(formId) + "']", doc));
                        radios = $(form).find(selector).filter(function() {
                            return this.form === form;
                        }).add(radios);
                    } else radios = $(selector, doc).filter(function() {
                        return !this.form;
                    });
                }
                return radios;
            ...
            _setOptions: function(options) {
                ...
                if (undefined !== options.disabled) {
                    this.input.prop("disabled", !!options.disabled);
                    outer.toggleClass("ui-state-disabled", !!options.disabled);
                }
                undefined !== options.mini && outer.toggleClass("ui-mini", !!options.mini);
                undefined !== options.theme && label.removeClass("ui-btn-" + currentOptions.theme).addClass("ui-btn-" + options.theme);
                undefined !== options.wrapperClass && outer.removeClass(currentOptions.wrapperClass).addClass(options.wrapperClass);
                undefined !== options.iconpos && hasIcon ? label.removeClass("ui-btn-icon-" + currentOptions.iconpos).addClass("ui-btn-icon-" + options.iconpos) : hasIcon || label.removeClass("ui-btn-icon-" + currentOptions.iconpos);
                this._super(options);
            }
    ...
    !function($, undefined) {
        $.widget("mobile.button", {
            ...
            _setOptions: function(options) {
                ...
                undefined !== options.theme && outer.removeClass(this.options.theme).addClass("ui-btn-" + options.theme);
                undefined !== options.corners && outer.toggleClass("ui-corner-all", options.corners);
                undefined !== options.shadow && outer.toggleClass("ui-shadow", options.shadow);
                undefined !== options.inline && outer.toggleClass("ui-btn-inline", options.inline);
                undefined !== options.mini && outer.toggleClass("ui-mini", options.mini);
                if (undefined !== options.disabled) {
                    this.element.prop("disabled", options.disabled);
                    outer.toggleClass("ui-state-disabled", options.disabled);
                }
                (undefined !== options.icon || undefined !== options.iconshadow || undefined !== options.iconpos) && outer.removeClass(this._getIconClasses(this.options)).addClass(this._getIconClasses($.extend({}, this.options, options)));
                this._super(options);
            },
            refresh: function(create) {
                ...
                this.options.disabled !== isDisabled && this._setOptions({
                    disabled: isDisabled
                });
            }
        });
    }(jQuery);
    disabledZoom = (initialContent = (meta = ($9 = jQuery)("meta[name=viewport]")).attr("content")) + ",maximum-scale=1, user-scalable=no", enabledZoom = initialContent + ",maximum-scale=10, user-scalable=yes", disabledInitially = /(user-scalable[\s]*=[\s]*no)|(maximum-scale[\s]*=[\s]*1)[$,\s]/.test(initialContent), $9.mobile.zoom = $9.extend({}, {
        enabled: !disabledInitially,
        locked: !1,
        disable: function(lock) {
            if (!disabledInitially && !$9.mobile.zoom.locked) {
                meta.attr("content", disabledZoom);
                $9.mobile.zoom.enabled = !1;
                $9.mobile.zoom.locked = lock || !1;
            }
        },
        enable: function(unlock) {
            if (!disabledInitially && (!$9.mobile.zoom.locked || !0 === unlock)) {
                meta.attr("content", enabledZoom);
                $9.mobile.zoom.enabled = !0;
                $9.mobile.zoom.locked = !1;
            }
        },
        restore: function() {
    ...
    !function($, undefined) {
        $.widget("mobile.textinput", {
            ...
            _enhance: function() {
                ...
                (this.isTextarea || this.isRange) && elementClasses.push("ui-shadow-inset");
                this.inputNeedsWrap ? this.element.wrap(this._wrap()) : elementClasses = elementClasses.concat(this.classes);
            ...
            _autoCorrect: function() {
                if (void 0 !== this.element[0].autocorrect && !$.support.touchOverflow) {
            ...
            _handleBlur: function() {
                this.widget().removeClass($.mobile.focusClass);
                this.options.preventFocusZoom && $.mobile.zoom.enable(!0);
            },
            _handleFocus: function() {
                this.options.preventFocusZoom && $.mobile.zoom.disable(!0);
                this.widget().addClass($.mobile.focusClass);
            },
            _setOptions: function(options) {
                var outer = this.widget();
                this._super(options);
                if (!(undefined === options.disabled && undefined === options.mini && undefined === options.corners && undefined === options.theme && undefined === options.wrapperClass)) {
                    outer.removeClass(this.classes.join(" "));
                    this.classes = this._classesFromOptions();
                    outer.addClass(this.classes.join(" "));
                }
                undefined !== options.disabled && this.element.prop("disabled", !!options.disabled);
            },
            _destroy: function() {
                if (!this.options.enhanced) {
    ...
    !function($, undefined) {
        $.widget("mobile.slider", $.extend({
            ...
            _create: function() {
                ...
                if (isToggleSwitch) {
                    (origTabIndex = control.attr("tabindex")) && handle.attr("tabindex", origTabIndex);
                    control.attr("tabindex", "-1").focus(function() {
                        $(this).blur();
                        handle.focus();
                    });
                    (wrapper = document1.createElement("div")).className = "ui-slider-inneroffset";
                    for(j = 0, length = domSlider.childNodes.length; j < length; j++)wrapper.appendChild(domSlider.childNodes[j]);
                    ...
                    for(i = 0, optionsCount = options.length; i < optionsCount; i++){
                        ...
                        (sliderImg = document1.createElement("span")).className = [
                            "ui-slider-label ui-slider-label-",
                            side,
                            activeClass
                        ].join("");
                        sliderImg.setAttribute("role", "img");
                        sliderImg.appendChild(document1.createTextNode(options[i].innerHTML));
                ...
                slider.bind("vmousedown", $.proxy(this._sliderVMouseDown, this)).bind("vclick", !1);
                this._on(document1, {
                ...
                this._handleFormReset();
                this.refresh(undefined, undefined, !0);
            },
            _setOptions: function(options) {
                undefined !== options.theme && this._setTheme(options.theme);
                undefined !== options.trackTheme && this._setTrackTheme(options.trackTheme);
                undefined !== options.corners && this._setCorners(options.corners);
                undefined !== options.mini && this._setMini(options.mini);
                undefined !== options.highlight && this._setHighlight(options.highlight);
                undefined !== options.disabled && this._setDisabled(options.disabled);
                this._super(options);
            },
            ...
            _sliderVMouseDown: function(event1) {
                return !this.options.disabled && !!(1 === event1.which || 0 === event1.which || undefined === event1.which) && !1 !== this._trigger("beforestart", event1) && (this.dragging = !0, this.userModified = !1, this.mouseMoved = !1, this.isToggleSwitch && (this.beforeStart = this.element[0].selectedIndex), this.refresh(event1), this._trigger("start"), !1);
            },
            ...
            refresh: function(val, isfromControl, preventInputUpdate) {
                ...
                this.options.highlight && !this.isToggleSwitch && 0 === this.slider.find(".ui-slider-bg").length && (this.valuebg = ((bg = document1.createElement("div")).className = "ui-slider-bg " + $.mobile.activeBtnClass, $(bg).prependTo(self.slider)));
                this.handle.addClass("ui-btn" + (theme ? " ui-btn-" + theme : "") + " ui-shadow");
                control = this.element;
                optionElements = (isInput = !this.isToggleSwitch) ? [] : control.find("option");
                ...
                if ("object" == typeof val) {
                    ...
                    pxStep = (width = this.slider.width()) / ((max - min) / step);
                    if (!this.dragging || data.pageX < left - tol || data.pageX > left + width + tol) return;
                    percent = pxStep > 1 ? (data.pageX - left) / width * 100 : Math.round((data.pageX - left) / width * 100);
                } else {
                    null == val && (val = isInput ? parseFloat(control.val() || 0) : control[0].selectedIndex);
                    percent = (parseFloat(val) - min) / (max - min) * 100;
                }
                if (!isNaN(percent)) {
                    valModStep = ((newval = percent / 100 * (max - min) + min) - min) % step;
                    alignValue = newval - valModStep;
                    2 * Math.abs(valModStep) >= step && (alignValue += valModStep > 0 ? step : -step);
                    percentPerStep = 100 / ((max - min) / step);
                    newval = parseFloat(alignValue.toFixed(5));
                    void 0 === pxStep && (pxStep = width / ((max - min) / step));
                    pxStep > 1 && isInput && (percent = (newval - min) * percentPerStep * (1 / step));
                    percent < 0 && (percent = 0);
                    ...
                    if (this._labels) {
                        ...
                        bPercent = 100 === percent ? 0 : Math.min(handlePercent + 100 - aPercent, 100);
                    ...
                    if (!preventInputUpdate) {
                        ...
                        if (!1 === this._trigger("beforechange", val)) return !1;
            ...
            _setCorners: function(value) {
                ...
                this.isToggleSwitch || this.control.toggleClass("ui-corner-all", value);
            },
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.slider", $.mobile.slider, {
            ...
            _setOption: function(key, value) {
                ...
                "showValue" === key ? this.handle.html(value && !this.options.mini ? this._value() : "") : "popupEnabled" === key && value && !this._popup && (this._popup = (popup || (popup = $("<div></div>", {
            ...
            _refresh: function() {
                ...
                if ((newValue = this._value()) !== this._currentValue) {
    ...
    !function($, undefined) {
        $.widget("mobile.flipswitch", $.extend({
            ...
            _keydown: function(e) {
                if (e.which === $.mobile.keyCode.LEFT) this._left();
                else if (e.which === $.mobile.keyCode.RIGHT) this._right();
            ...
            _setOptions: function(options) {
                ...
                undefined !== options.onText && this.on.text(options.onText);
                undefined !== options.offText && this.off.text(options.offText);
                undefined !== options.disabled && this.widget().toggleClass("ui-state-disabled", options.disabled);
                undefined !== options.mini && this.widget().toggleClass("ui-mini", options.mini);
                undefined !== options.corners && this.widget().toggleClass("ui-corner-all", options.corners);
                this._super(options);
            },
            _destroy: function() {
                if (!this.options.enhanced) {
    ...
    !function($, undefined) {
        $.widget("mobile.rangeslider", $.extend({
            ...
            _slidedrag: function(event1) {
                ...
                if ("first" === this._proxy && first || "last" === this._proxy && !first) return $.data(otherSlider.get(0), "mobile-slider").dragging = !0, $.data(otherSlider.get(0), "mobile-slider").refresh(event1), !1;
            },
            ...
            _slidebeforestart: function(event1) {
                this._sliderTarget = !1;
                if ($(event1.originalEvent.target).hasClass("ui-slider-track")) {
                    this._sliderTarget = !0;
                    this._targetVal = $(event1.target).val();
                }
            },
            _setOptions: function(options) {
                undefined !== options.theme && this._setTheme(options.theme);
    ...
    !function($, undefined) {
        $.widget("mobile.textinput", $.mobile.textinput, {
            ...
            _setOptions: function(options) {
                this._super(options);
                undefined === options.clearBtn || this.element.is("textarea, :jqmData(type='range')") || (options.clearBtn ? this._addClearBtn() : this._destroyClear());
                undefined !== options.clearBtnText && undefined !== this._clearBtn && this._clearBtn.text(options.clearBtnText).attr("title", options.clearBtnText);
            },
    ...
    !function($, undefined) {
        $.widget("mobile.textinput", $.mobile.textinput, {
            ...
            _handleShow: function(event1) {
                if ($.contains(event1.target, this.element[0]) && this.element.is(":visible")) {
                    "popupbeforeposition" !== event1.type && this.element.addClass("ui-textinput-autogrow-resize").animationComplete($.proxy(function() {
            ...
            _prepareHeightUpdate: function(delay) {
                ...
                delay === undefined ? this._updateHeight() : this.keyupTimeout = this._delay("_updateHeight", delay);
            },
            _timeout: function() {
            ...
            _updateHeight: function() {
                ...
                height = scrollHeight + (parseFloat(this.element.css("border-top-width")) + parseFloat(this.element.css("border-bottom-width"))) + 15;
                0 === clientHeight && (height += parseFloat(this.element.css("padding-top")) + parseFloat(this.element.css("padding-bottom")));
                this.element.css({
                    height: height,
                    "min-height": "",
                    "max-height": ""
            ...
            _setOptions: function(options) {
                this._super(options);
                undefined !== options.autogrow && this.isTextarea && (options.autogrow ? this._autogrow() : this._unbindAutogrow());
            }
        });
    }(jQuery);
    !function($, undefined) {
        $.widget("mobile.selectmenu", $.extend({
            ...
            _preExtension: function() {
                ...
                ~this.element[0].className.indexOf("ui-btn-left") && (classes = " ui-btn-left");
                ~this.element[0].className.indexOf("ui-btn-right") && (classes = " ui-btn-right");
            ...
            _destroy: function() {
                ...
                if (wrapper.length > 0) {
                    wrapper.is(".ui-btn-left, .ui-btn-right") && this.element.addClass(wrapper.hasClass("ui-btn-left") ? "ui-btn-left" : "ui-btn-right");
            ...
            _create: function() {
                ...
                this.setButtonText();
                options.nativeMenu && window.opera && window.opera.version && button.addClass("ui-select-nativeonly");
                this.isMultiple && (this.buttonCount = $("<span>").addClass("ui-li-count ui-body-inherit").hide().appendTo(button.addClass("ui-li-has-count")));
                (options.disabled || this.element.attr("disabled")) && this.disable();
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.popup", {
            ...
            _create: function() {
                ...
                0 === this._page.length && (this._page = $("body"));
                if (currentOptions.enhanced) this._ui = {
            ...
            _enhance: function(theElement, myId) {
                ...
                return this._page[0].appendChild(fragment), ui.placeholder.insertAfter(theElement), theElement.detach().addClass("ui-popup " + this._themeClassFromOption("ui-body-", currentOptions.theme) + " " + (currentOptions.shadow ? "ui-overlay-shadow " : "") + (currentOptions.corners ? "ui-corner-all " : "")).appendTo(ui.container), ui;
            },
            ...
            _handleWindowOrientationchange: function() {
                if (!this._orientationchangeInProgress && this._isOpen && 0 === this._ignoreResizeTo) {
            ...
            _setOptions: function(newOptions) {
                ...
                undefined !== newOptions.wrapperClass && this._ui.container.removeClass(currentOptions.wrapperClass).addClass(newOptions.wrapperClass);
                undefined !== newOptions.theme && theElement.removeClass(this._themeClassFromOption("ui-body-", currentOptions.theme)).addClass(this._themeClassFromOption("ui-body-", newOptions.theme));
                if (undefined !== newOptions.overlayTheme) {
                    screen1.removeClass(this._themeClassFromOption("ui-overlay-", currentOptions.overlayTheme)).addClass(this._themeClassFromOption("ui-overlay-", newOptions.overlayTheme));
                    this._isOpen && screen1.addClass("in");
                }
                return undefined !== newOptions.shadow && theElement.toggleClass("ui-overlay-shadow", newOptions.shadow), undefined !== newOptions.corners && theElement.toggleClass("ui-corner-all", newOptions.corners), undefined === newOptions.transition || this._currentTransition || this._applyTransition(newOptions.transition), undefined !== newOptions.tolerance && this._setTolerance(newOptions.tolerance), undefined !== newOptions.disabled && newOptions.disabled && this.close(), this._super(newOptions);
            },
            ...
            _animate: function(args) {
                ...
                if (args.transition && "none" !== args.transition) {
            ...
            _desiredCoords: function(openOptions) {
                ...
                if (dst) {
                    x = (offset = dst.offset()).left + dst.outerWidth() / 2;
                    y = offset.top + dst.outerHeight() / 2;
                }
                return ("number" !== $.type(x) || isNaN(x)) && (x = windowCoordinates.cx / 2 + windowCoordinates.x), ("number" !== $.type(y) || isNaN(y)) && (y = windowCoordinates.cy / 2 + windowCoordinates.y), {
                    x: x,
                    y: y
                };
            },
            ...
            _openPrerequisitesComplete: function() {
                ...
                this._ignoreResizeEvents();
                id && this.document.find("[aria-haspopup='true'][aria-owns='" + id + "']").attr("aria-expanded", !0);
            ...
            _open: function(options) {
                ...
                this.options.overlayTheme && androidBlacklist && this.element.closest(".ui-page").addClass("ui-popup-open");
                this._animate({
            ...
            _closePrerequisitesDone: function() {
                ...
                id && this.document.find("[aria-haspopup='true'][aria-owns='" + id + "']").attr("aria-expanded", !1);
            ...
            _closePopup: function(theEvent, data) {
                ...
                if (!(theEvent && theEvent.isDefaultPrevented()) && $.mobile.popup.active === this) {
                    ...
                    if (theEvent && "pagebeforechange" === theEvent.type && data) {
                        parsedDst = "string" == typeof data.toPage ? data.toPage : data.toPage.jqmData("url");
                        toUrl = (parsedDst = $.mobile.path.parseUrl(parsedDst)).pathname + parsedDst.search + parsedDst.hash;
                        this._myUrl !== $.mobile.path.makeUrlAbsolute(toUrl) ? immediate = !0 : theEvent.preventDefault();
                    }
            ...
            close: function() {
                if ($.mobile.popup.active !== this) return this;
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.selectmenu", $.mobile.selectmenu, {
            ...
            _handleKeydown: function(event1) {
                this._super(event1);
                this._handleButtonVclickKeydown(event1);
            },
            _handleButtonVclickKeydown: function(event1) {
                if (!this.options.disabled && !this.isOpen && ("vclick" === event1.type || event1.keyCode && (event1.keyCode === $.mobile.keyCode.ENTER || event1.keyCode === $.mobile.keyCode.SPACE))) {
                    this._decideFormat();
                    "overlay" === this.menuType ? this.button.attr("href", "#" + this.popupId).attr("data-" + ($.mobile.ns || "") + "rel", "popup") : this.button.attr("href", "#" + this.dialogId).attr("data-" + ($.mobile.ns || "") + "rel", "dialog");
                    this.isOpen = !0;
                }
            },
            ...
            build: function() {
                ...
                return o.nativeMenu ? this._super() : (self = this, popupId = (selectId = this.selectId) + "-listbox", dialogId = selectId + "-dialog", label = this.label, thisPage = this.element.closest(".ui-page"), isMultiple = this.element[0].multiple, menuId = selectId + "-menu", themeAttr = o.theme ? " data-" + $.mobile.ns + "theme='" + o.theme + "'" : "", overlayThemeAttr = (overlayTheme = o.overlayTheme || o.theme || null) ? " data-" + $.mobile.ns + "overlay-theme='" + overlayTheme + "'" : "", dividerThemeAttr = o.dividerTheme && isMultiple ? " data-" + $.mobile.ns + "divider-theme='" + o.dividerTheme + "'" : "", menuPage = $("<div data-" + $.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + dialogId + "'" + themeAttr + overlayThemeAttr + "><div data-" + $.mobile.ns + "role='header'><div class='ui-title'>" + label.getEncodedText() + "</div></div><div data-" + $.mobile.ns + "role='content'></div></div>"), listbox = $("<div id='" + popupId + "' class='ui-selectmenu'></div>").insertAfter(this.select).popup({
                    ...
                    self.isMultiple && $(this).find("a").toggleClass("ui-checkbox-on", option.selected).toggleClass("ui-checkbox-off", !option.selected);
                    (self.isMultiple || oldIndex !== newIndex) && self.select.trigger("change");
                    self.isMultiple ? self.list.find("li:not(.ui-li-divider)").eq(newIndex).find("a").first().focus() : self.close();
                    event1.preventDefault();
            ...
            refresh: function(force) {
                ...
                self.setButtonText();
                self.setButtonCount();
                self.list.find("li:not(.ui-li-divider)").find("a").removeClass($.mobile.activeBtnClass).end().attr("aria-selected", !1).each(function(i) {
                    if ($.inArray(i, indices) > -1) {
                        var item = $(this);
                        item.attr("aria-selected", !0);
                        self.isMultiple ? item.find("a").removeClass("ui-checkbox-off").addClass("ui-checkbox-on") : item.hasClass("ui-screen-hidden") ? item.next().find("a").addClass($.mobile.activeBtnClass) : item.find("a").addClass($.mobile.activeBtnClass);
                    }
                });
            },
            close: function() {
            ...
            _focusMenuItem: function() {
                ...
                0 === selector.length && (selector = this.list.find("li:not(" + unfocusableItemSelector + ") a.ui-btn"));
            ...
            _decideFormat: function() {
                ...
                if (menuHeight > screenHeight - 80 || !$.support.scrollTop) {
                    ...
                    0 === scrollTop && btnOffset > screenHeight && self.thisPage.one("pagehide", function() {
            ...
            _buildList: function() {
                ...
                numOptions = ($options = this._selectOptions()).length;
                select = this.select[0];
                for(i = 0; i < numOptions; i++, isPlaceholderItem = !1)if (!($option = $(option = $options[i])).hasClass("ui-screen-hidden")) {
                    parent = option.parentNode;
                    text = $option.text();
                    anchor = document1.createElement("a");
                    classes = [];
                    anchor.setAttribute("href", "#");
                    anchor.appendChild(document1.createTextNode(text));
                    if (parent !== select && "optgroup" === parent.nodeName.toLowerCase() && (optLabel = parent.getAttribute("label")) !== optGroup) {
                        (divider = document1.createElement("li")).setAttribute(dataRoleAttr, "list-divider");
                        divider.setAttribute("role", "option");
                        divider.setAttribute("tabindex", "-1");
                        divider.appendChild(document1.createTextNode(optLabel));
                        fragment.appendChild(divider);
                        optGroup = optLabel;
                    }
                    if (needPlaceholder && (!option.getAttribute("value") || 0 === text.length || $option.jqmData("placeholder"))) {
                        needPlaceholder = !1;
                        isPlaceholderItem = !0;
                        null === option.getAttribute(dataPlaceholderAttr) && (this._removePlaceholderAttr = !0);
                        option.setAttribute(dataPlaceholderAttr, !0);
                        o.hidePlaceholderMenuItems && classes.push("ui-screen-hidden");
                        placeholder !== text && (placeholder = self.placeholder = text);
                    }
                    item = document1.createElement("li");
                    if (option.disabled) {
                        classes.push("ui-state-disabled");
                        item.setAttribute("aria-disabled", !0);
                    }
                    item.setAttribute(dataIndexAttr, i);
                    item.setAttribute(dataIconAttr, "false");
                    isPlaceholderItem && item.setAttribute(dataPlaceholderAttr, !0);
                    item.className = classes.join(" ");
                    item.setAttribute("role", "option");
                    anchor.setAttribute("tabindex", "-1");
                    this.isMultiple && $(anchor).addClass("ui-btn ui-checkbox-off ui-btn-icon-right");
                    item.appendChild(anchor);
                    fragment.appendChild(item);
                }
                self.list[0].appendChild(fragment);
                this.isMultiple || placeholder.length ? this.headerTitle.text(this.placeholder) : this.header.addClass("ui-screen-hidden");
                self.list.listview();
            },
            _button: function() {
            ...
            _destroy: function() {
                if (!this.options.nativeMenu) {
                    this.close();
                    undefined !== this._origTabIndex && (!1 !== this._origTabIndex ? this.select.attr("tabindex", this._origTabIndex) : this.select.removeAttr("tabindex"));
                    this._removePlaceholderAttr && this._selectOptions().removeAttr("data-" + $.mobile.ns + "placeholder");
                    this.listbox.remove();
    ...
    !function($, undefined) {
        ...
        function optionsToClasses(options, existingClasses) {
            ...
            return options.inline && classes.push("ui-btn-inline"), options.shadow && classes.push("ui-shadow"), options.corners && classes.push("ui-corner-all"), options.mini && classes.push("ui-mini"), classes;
        }
        function classNameToOptions(classes) {
            ...
            for(idx = 0; idx < classes.length; idx++){
                unknownClass = !0;
                if (undefined !== (map = reverseBoolOptionMap[classes[idx]])) {
                    unknownClass = !1;
                    o[map] = !0;
                } else if (0 === classes[idx].indexOf("ui-btn-icon-")) {
                    unknownClass = !1;
                    noIcon = !1;
                    o.iconpos = classes[idx].substring(12);
                } else if (0 === classes[idx].indexOf("ui-icon-")) {
                    unknownClass = !1;
                    o.icon = classes[idx].substring(8);
                } else if (0 === classes[idx].indexOf("ui-btn-") && 8 === classes[idx].length) {
                    unknownClass = !1;
                    o.theme = classes[idx].substring(7);
                } else if ("ui-btn" === classes[idx]) {
                    unknownClass = !1;
                    alreadyEnhanced = !0;
                }
        ...
        $.fn.buttonMarkup = function(options, overwriteClasses) {
            ...
            for(idx = 0; idx < this.length; idx++){
                ...
                if (!data.alreadyEnhanced) for(optionKey in defaults)undefined === retrievedOptions[optionKey] && (retrievedOptions[optionKey] = getAttrFixed(el, optionKey.replace(capitalLettersRE, camelCase2Hyphenated)));
                el.className = optionsToClasses($.extend({}, defaults, retrievedOptions), data.unknownClasses).join(" ");
                "button" !== el.tagName.toLowerCase() && el.setAttribute("role", "button");
            }
            return this;
        };
    ...
    !function($, undefined) {
        $.widget("mobile.controlgroup", $.extend({
            ...
            _create: function() {
                var elem = this.element, opts = this.options;
                $.fn.buttonMarkup && this.element.find($.fn.buttonMarkup.initSelector).buttonMarkup();
            ...
            _setOptions: function(options) {
                ...
                if (undefined !== options.type) {
                    elem.removeClass("ui-controlgroup-horizontal ui-controlgroup-vertical").addClass("ui-controlgroup-" + ("horizontal" === options.type ? "horizontal" : "vertical"));
                    callRefresh = !0;
                }
                undefined !== options.theme && elem.removeClass(this._themeClassFromOption(this.options.theme)).addClass(this._themeClassFromOption(options.theme));
                undefined !== options.corners && elem.toggleClass("ui-corner-all", options.corners);
                undefined !== options.mini && elem.toggleClass("ui-mini", options.mini);
                undefined !== options.shadow && this._ui.childWrapper.toggleClass("ui-shadow", options.shadow);
                if (undefined !== options.excludeInvisible) {
                    this.options.excludeInvisible = options.excludeInvisible;
                    callRefresh = !0;
                }
                return returnValue = this._super(options), callRefresh && this.refresh(), returnValue;
            },
            container: function() {
            ...
            refresh: function() {
                ...
                $.mobile.checkboxradio && $el.find(":mobile-checkboxradio").checkboxradio("refresh");
    ...
    !function($, undefined) {
        $.widget("mobile.toolbar", {
            ...
            _create: function() {
                ...
                this.element.attr("role", "header" === role ? "banner" : "contentinfo").addClass("ui-" + role);
                this.refresh();
                this._setOptions(this.options);
            },
            _setOptions: function(o) {
                undefined !== o.addBackBtn && (this.options.addBackBtn && "header" === this.role && $(".ui-page").length > 1 && this.page[0].getAttribute("data-" + $.mobile.ns + "url") !== $.mobile.path.stripHash(location.hash) && !this.leftbtn ? this._addBackButton() : this.element.find(".ui-toolbar-back-btn").remove());
                null != o.backBtnTheme && this.element.find(".ui-toolbar-back-btn").addClass("ui-btn ui-btn-" + o.backBtnTheme);
                undefined !== o.backBtnText && this.element.find(".ui-toolbar-back-btn .ui-btn-text").text(o.backBtnText);
                if (undefined !== o.theme) {
    ...
    !function($, undefined) {
        $.widget("mobile.toolbar", $.mobile.toolbar, {
            ...
            _setOptions: function(o) {
                "fixed" === o.position && "fixed" !== this.options.position && this._makeFixed();
                if ("fixed" === this.options.position && !this.options.supportBlacklist()) {
                    var $page = this.page ? this.page : $(".ui-page-active").length > 0 ? $(".ui-page-active") : $(".ui-page").eq(0);
                    if (undefined !== o.fullscreen) {
                        if (o.fullscreen) {
            ...
            _addTransitionClass: function() {
                ...
                if (tclass && "none" !== tclass) {
                    "slide" === tclass && (tclass = this.element.hasClass("ui-header") ? "slidedown" : "slideup");
            ...
            _handlePageBeforeShow: function() {
                var o = this.options;
                o.disablePageZoom && $.mobile.zoom.disable(!0);
            ...
            _handlePageBeforeHide: function(e, ui) {
                ...
                o.disablePageZoom && $.mobile.zoom.enable(!0);
            ...
            updatePagePadding: function(tbPage) {
                ...
                if (!this.options.fullscreen) {
                    tbPage = tbPage && undefined === tbPage.type && tbPage || this.page || $el.closest(".ui-page");
                    $(tbPage = this.page ? this.page : ".ui-page-active").css("padding-" + (header ? "top" : "bottom"), $el.outerHeight() + pos);
                }
            },
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.popup", $.mobile.popup, {
            ...
            _placementCoords: function(desired) {
                ...
                if (!best) return ar.arEls.hide(), this._super(desired);
            ...
            _setOptions: function(opts) {
                ...
                if (ar = this._ui.arrow) {
                    if (undefined !== opts.theme) {
                        oldTheme = this._themeClassFromOption("ui-body-", oldTheme);
                        newTheme = this._themeClassFromOption("ui-body-", opts.theme);
                        ar.ar.removeClass(oldTheme).addClass(newTheme);
                    }
                    undefined !== opts.shadow && ar.ar.toggleClass("ui-overlay-shadow", opts.shadow);
                }
                return ret;
            },
            _destroy: function() {
    ...
    !function($, undefined) {
        $.widget("mobile.panel", {
            ...
            _create: function() {
                ...
                $.support.cssTransform3d && this.options.animate && this.element.addClass(this.options.classes.animate);
            ...
            _getWrapper: function() {
                ...
                0 === wrapper.length && (wrapper = this._page().children(".ui-header:not(.ui-header-fixed), .ui-content:not(.ui-popup), .ui-footer:not(.ui-footer-fixed)").wrapAll("<div class='" + this.options.classes.pageWrapper + "'></div>").parent());
            ...
            _positionPanel: function(scrollToTop) {
                ...
                if (expand || !this.options.positionFixed) {
                    ...
                    scrollToTop && this.window[0].scrollTo(0, $.mobile.defaultHomeScroll);
                } else this._fixPanel();
            },
            ...
            _handleClick: function(e) {
                ...
                if (e.currentTarget.href.split("#")[1] === panelId && void 0 !== panelId) {
                    e.preventDefault();
                    if ((link = $(e.target)).hasClass("ui-btn")) {
            ...
            open: function(immediate) {
                if (!this._open) {
                    var self = this, o = self.options, _openPanel = function() {
                        ...
                        if ($.support.cssTransform3d && o.animate && "overlay" !== o.display) {
                            self._wrapper.addClass(o.classes.animate);
                            self._fixedToolbars().addClass(o.classes.animate);
                        }
                        !immediate && $.support.cssTransform3d && o.animate ? self.element.animationComplete(complete, "transition") : setTimeout(complete, 0);
                        o.theme && "overlay" !== o.display && self._page().parent().addClass(o.classes.pageContainer + "-themed " + o.classes.pageContainer + "-" + o.theme);
                        self.element.removeClass(o.classes.panelClosed).addClass(o.classes.panelOpen);
                        self._positionPanel(!0);
                        self._pageContentOpenClasses = self._getPosDisplayClasses(o.classes.pageContentPrefix);
                        if ("overlay" !== o.display) {
                    ...
                    "open" === self._page().jqmData("panel") ? self.document.on("panelclose", function() {
                        _openPanel();
                    }) : _openPanel();
                    self._open = !0;
                }
            ...
            close: function(immediate) {
                if (this._open) {
                    var self = this, o = this.options, complete = function() {
                        o.theme && "overlay" !== o.display && self._page().parent().removeClass(o.classes.pageContainer + "-themed " + o.classes.pageContainer + "-" + o.theme);
            ...
            _destroy: function() {
                ...
                if ("overlay" !== o.display) {
                    0 === $("body > :mobile-panel").add($.mobile.activePage.find(":mobile-panel")).not(".ui-panel-display-overlay").not(this.element).length && this._wrapper.children().unwrap();
                    if (this._open) {
                        this._fixedToolbars().removeClass(o.classes.pageContentPrefix + "-open");
                        $.support.cssTransform3d && o.animate && this._fixedToolbars().removeClass(o.classes.animate);
                        this._page().parent().removeClass(o.classes.pageContainer);
                        o.theme && this._page().parent().removeClass(o.classes.pageContainer + "-themed " + o.classes.pageContainer + "-" + o.theme);
                    }
                }
            ...
            _refresh: function() {
                ...
                trs.each(function() {
                    ...
                    $(this).children().each(function() {
                        ...
                        if (span) for(j = 0; j < span - 1; j++)selector += ", :nth-child(" + (++columnCount + 1) + ")";
    ...
    !function($, undefined) {
        $.widget("mobile.table", $.mobile.table, {
            ...
            _create: function() {
                this._super();
                if ("columntoggle" === this.options.mode) {
                    $.extend(this, {
                        _menu: null
                    });
                    if (this.options.enhanced) {
            ...
            _addToggles: function(menu, keep) {
                ...
                this.headers.not("td").each(function() {
                    ...
                    if (priority) {
                        ...
                        (keep ? inputs.eq(checkboxIndex++) : $("<label><input type='checkbox' checked />" + (header.children("abbr").first().attr("title") || header.text()) + "</label>").appendTo(container).children(0).checkboxradio({
            ...
            _refresh: function(create) {
                this._super(create);
                if (!create && "columntoggle" === this.options.mode) {
            ...
            _setToggleState: function() {
                this._menu.find("input").each(function() {
                    var checkbox = $(this);
                    this.checked = "table-cell" === checkbox.jqmData("cells").eq(0).css("display");
    ...
    !function($, undefined) {
        $.widget("mobile.table", $.mobile.table, {
            ...
            _create: function() {
                this._super();
                if ("reflow" === this.options.mode && !this.options.enhanced) {
                ...
                $(table.allHeaders.get().reverse()).each(function() {
                    ...
                    if ("" !== text) {
                        if (hierarchyClass) {
                            ...
                            filter = "";
                            iteration && (filter = "td:nth-child(" + iteration + "n + " + colstart + ")");
    ...
    !function($, undefined) {
        ...
        $.widget("mobile.filterable", {
            ...
            _create: function() {
                ...
                opts.enhanced || this._filterItems((this._search && this._search.val() || "").toLowerCase());
            },
            _onKeyUp: function() {
                var val, lastval, search = this._search;
                if (search) {
                    val = search.val().toLowerCase();
                    if ((lastval = $.mobile.getAttribute(search[0], "lastval") + "") && lastval === val) return;
                    if (this._timer) {
            ...
            _filterItems: function(val) {
                ...
                if (null != val) {
                    ...
                    for(idx = 0; idx < length; idx++)(callback.call(filterItems[idx], idx, val) ? hide : show).push(filterItems[idx]);
                }
                if (0 === hide.length) filterItems[opts.filterReveal ? "addClass" : "removeClass"]("ui-screen-hidden");
                else {
            ...
            _refreshChildWidget: function() {
                ...
                for(idx = recognizedWidgets.length - 1; idx > -1; idx--){
                    ...
                    $.mobile[widget] && (widget = this.element.data("mobile-" + widget)) && $.isFunction(widget.refresh) && widget.refresh();
                }
            },
    ...
    !function($, undefined) {
        var rDividerListItem = /(^|\s)ui-li-divider(\s|$)/, origDefaultFilterCallback = $.mobile.filterable.prototype.options.filterCallback;
        ...
        $.widget("mobile.filterable", $.mobile.filterable, {
            ...
            _trigger: function(type, event1, data) {
                this._widget && "mobile-listview" === this._widget.widgetFullName && "beforefilter" === type && this._widget._trigger("beforefilter", event1, data);
                this._super(type, event1, data);
            },
            _setWidget: function(widget) {
                if (!this._widget && widget) {
                    var self, orig;
                    this._widget = widget;
                    this._widget._setOptions = (self = this, orig = this._widget._setOptions, function(options) {
                ...
                if (this._widget) {
                    ...
                    if ("listview" === this._widget.widgetName) {
            ...
            _setInput: function(selector) {
                ...
                if (!selector) {
                    ...
                    updatePlaceholder = !1;
                    selector = $("<input data-" + $.mobile.ns + "type='search' placeholder='" + opts.filterPlaceholder + "'></input>").jqmData("ui-filterable-" + this.uuid + "-internal", !0);
                    $("<form class='ui-filterable'></form>").append(selector).submit(function(evt) {
                        evt.preventDefault();
                        selector.blur();
                    }).insertBefore(this.element);
                    if ($.mobile.textinput) {
                        null != this.options.filterTheme && (textinputOpts.theme = opts.filterTheme);
                        selector.textinput(textinputOpts);
                    }
                }
                this._super(selector);
                this._isSearchInternal() && updatePlaceholder && this._search.attr("placeholder", this.options.filterPlaceholder);
            },
            _setOptions: function(options) {
    ...
    !function($, undefined) {
        ...
        $.widget("ui.tabs", {
            ...
            _create: function() {
                ...
                this.running = !1;
                this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all").toggleClass("ui-tabs-collapsible", options.collapsible).delegate(".ui-tabs-nav > li", "mousedown" + this.eventNamespace, function(event1) {
            ...
            _initialActive: function() {
                ...
                if (null === active) {
                    ...
                    (null === active || -1 === active) && (active = !!this.tabs.length && 0);
                }
                return !1 !== active && -1 === (active = this.tabs.index(this.tabs.eq(active))) && (active = !collapsible && 0), !collapsible && !1 === active && this.anchors.length && (active = 0), active;
            },
            ...
            _panelKeydown: function(event1) {
                if (!this._handlePageNav(event1) && event1.ctrlKey && event1.keyCode === $.ui.keyCode.UP) {
                    event1.preventDefault();
                    this.active.focus();
                }
            },
            ...
            _processTabs: function() {
                ...
                this.anchors.each(function(i, anchor) {
                    ...
                    if (isLocal(anchor)) {
                        ...
                        selector = "#" + (panelId = that._tabId(tab));
            ...
            _eventHandler: function(event1) {
                ...
                event1.preventDefault();
                if (!(tab.hasClass("ui-state-disabled") || tab.hasClass("ui-tabs-loading")) && !this.running && (!clickedIsActive || options.collapsible) && !1 !== this._trigger("beforeActivate", event1, eventData)) {
                    ...
                    toShow.length && this.load(this.tabs.index(tab), event1);
                    this._toggle(event1, eventData);
                }
            },
            _toggle: function(event1, eventData) {
                ...
                function complete() {
                    that.running = !1;
                    that._trigger("activate", event1, eventData);
                }
                function show() {
            ...
            load: function(index, event1) {
                ...
                if (!isLocal(anchor[0])) {
                    this.xhr = $.ajax(this._ajaxSettings(anchor, event1, eventData));
                    if (this.xhr && "canceled" !== this.xhr.statusText) {
                        ...
                        this.xhr.success(function(response) {
                            setTimeout(function() {
                                panel.html(response);
                                that._trigger("load", event1, eventData);
                            }, 1);
    ...
    !function($, window) {
        ...
        function checkTilt(e) {
            x = Math.abs((aig = e.originalEvent.accelerationIncludingGravity).x);
            y = Math.abs(aig.y);
            z = Math.abs(aig.z);
            !window.orientation && (x > 7 || (z > 6 && y < 8 || z < 8 && y > 6) && x > 5) ? zoom.enabled && zoom.disable() : zoom.enabled || zoom.enable();
        }
        ...
        if ($.mobile.gradeA()) {
            ...
            $.extend($.mobile, {
                initializePage: function() {
                    ...
                    $pages.length || ($pages = $("body").wrapInner("<div data-" + $.mobile.ns + "role='page'></div>").children(0));
                    $pages.each(function() {
                        var $this = $(this);
                    ...
                    if ($.mobile.hashListeningEnabled && $.mobile.path.isHashValid(location.hash) && ($(hashPage).is(":jqmData(role='page')") || $.mobile.path.isPath(hash) || hash === $.mobile.dialogHashKey)) {
                        ...
                        $.mobile.path.isHashValid(location.hash) && ($.mobile.navigate.history.initialDst = hash.replace("#", ""));
                        $.event.special.navigate.isPushStateEnabled() && $.mobile.navigate.navigator.squash(path.parseLocation().href);
            ...
            $(function() {
                $.support.inlineSVG();
                $.mobile.hideUrlBar && window.scrollTo(0, 1);
                $.mobile.defaultHomeScroll = $.support.scrollTop && 1 !== $.mobile.window.scrollTop() ? 1 : 0;
                $.mobile.autoInitializePage && $.mobile.initializePage();
                $.mobile.hideUrlBar && $window.load($.mobile.silentScroll);
                $.support.cssPointerEvents || $.mobile.document.delegate(".ui-state-disabled,.ui-disabled", "vclick", function(e) {
                    e.preventDefault();
