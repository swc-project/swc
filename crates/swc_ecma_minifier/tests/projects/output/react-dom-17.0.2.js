 ...
 */ function(global, factory) {
   ...
   */ function dangerousStyleValue(name, value, isCustomProperty) {
    ...
    var uppercasePattern = /([A-Z])/g, msPattern = /^ms-/, badVendoredStyleNamePattern = /^(?:webkit|moz|o)[A-Z]/, msPattern$1 = /^-ms-/, hyphenPattern = /-(.)/g, badStyleValueWithSemicolonPattern = /;\s*$/, warnedStyleNames = {}, warnedStyleValues = {}, warnedForNaNValue = !1, warnedForInfinityValue = !1, warnHyphenatedStyleName = function(name) {
   ...
   */ function(name, func, context, a, b, c, d, e, f) {
    ...
    function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst, targetContainer) {
        ...
        !function(fn) {
            ...
            return targetInst = ancestorInst, nativeEventTarget = getEventTarget(nativeEvent), void (!function(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
                ...
                function(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
   ...
   */ function(domEventName, nativeEvent) {
    ...
    warnedUnknownTags = {
        ...
        if (!isCustomComponent(type, props)) {
            var invalidProps = [];
            for(var key in props)!function(name) {
   ...
   */ function getNodeFromInstance(inst) {
        ...
        if (null !== firstBaseUpdate) {
            ...
            var newState = queue.baseState, newLanes = 0, newBaseState = null, newFirstBaseUpdate = null, newLastBaseUpdate = null, update = firstBaseUpdate;;){
                ...
                if ((renderLanes & updateLane) === updateLane) {
                    ...
                    if (newState = function(workInProgress, update, prevState, nextProps, instance) {
                        switch(update.tag){
                            case 1:
                        ...
                        return prevState;
                    }(workInProgress, update, newState, props, instance), null !== update.callback) {
    ...
    function deleteHydratableInstance(returnFiber, instance) {
        ...
        var fiber, parentContainer, parentProps, parentInstance, childToDelete = ((fiber = createFiber(5, null, null, 0)).elementType = "DELETED", fiber.type = "DELETED", fiber);
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        if (push(suspenseStackCursor, suspenseContext &= 1, workInProgress), null === current) {
            ...
            var suspenseContext1, current1, workInProgress1, primaryChildren, renderLanes1, primaryChildFragment, nextPrimaryChildren = nextProps.children, nextFallbackChildren = nextProps.fallback;
            if (showFallback) {
        ...
        workInProgress.lanes = 0, workInProgress.tag){
            ...
            case 16:
                ...
                return function(_current, workInProgress, elementType, updateLanes, renderLanes) {
                    ...
                    // Disconnect the alternate pointers.
                    _current.alternate = null, workInProgress.alternate = null, workInProgress.flags |= 2);
                    var props = workInProgress.pendingProps, payload = elementType._payload, Component = (0, elementType._init)(payload);
        ...
        switch(workInProgress.tag){
            ...
            case 5:
                ...
                if (null !== current && null != workInProgress.stateNode) updateHostComponent$1(current, workInProgress, type, newProps, rootContainerInstance), current.ref !== workInProgress.ref && markRef$1(workInProgress);
                    ...
                    // to consolidate.
                    {
                        instance = workInProgress.stateNode, type1 = workInProgress.type, props = workInProgress.memoizedProps, hostContext = currentHostContext, hostInst = workInProgress, instance[internalInstanceKey] = hostInst, node = instance, props1 = props, node[internalPropsKey] = props1, workInProgress.updateQueue = updatePayload = function(domElement, tag, rawProps, parentNamespace) {
   ...
   */ function(node, name, expected, propertyInfo) {
                        ...
                        var instance, type1, props, hostContext, hostInst, node, props1, updatePayload, instance1 = function(type, props, rootContainerInstance, hostContext, internalInstanceHandle) {
                        ...
                        appendAllChildren(instance1, workInProgress, !1, !1), workInProgress.stateNode = instance1, function(domElement, tag, rawProps) {
                        ...
                        (instance1, type, newProps), shouldAutoFocusHostComponent(type, newProps) && markUpdate(workInProgress);
                    }
    ...
    // Noop
        ...
        if (oldProps !== newProps) {
            ...
            // related to `hidden`.
            var updatePayload = function(domElement, type, oldProps, newProps, hostContext) {
                ...
                return function(domElement, tag, lastRawProps, nextRawProps) {
   ...
   */ function(styleUpdates, nextStyles) {
            ...
            }(workInProgress.stateNode, type, oldProps, newProps, getHostContext()); // TODO: Type this specific to this type of component.
    ...
    function commitWork(current, finishedWork) {
        switch(finishedWork.tag){
            ...
            case 15:
            case 22:
                return void function(finishedWork) {
    ...
    function completeUnitOfWork(unitOfWork) {
        ...
        do {
            ...
            if ((2048 & completedWork.flags) == 0) {
                ...
                var _next = function(workInProgress) {
                    switch(workInProgress.tag){
                        case 1:
    ...
    function commitRootImpl(root, renderPriorityLevel) {
        ...
        firstEffect = finishedWork.firstEffect, null !== firstEffect) {
            var containerInfo, focusedElem, input, prevExecutionContext = executionContext;
            executionContext |= /*                */ 32;
   ...
   */ function(node, offsets) {
    ...
    function commitLayoutEffects(root, committedLanes) {
        for(; null !== nextEffect;){
            setCurrentFiber(nextEffect);
            var flags = nextEffect.flags;
            36 & flags && function(finishedRoot, current, finishedWork) {
                switch(finishedWork.tag){
                    case 0:
                    case 11:
                    case 15:
                    case 22:
                        ...
                        }(finishedWork), function(finishedWork) {
                            var updateQueue = finishedWork.updateQueue, lastEffect = null !== updateQueue ? updateQueue.lastEffect : null;
                            if (null !== lastEffect) {
                                var firstEffect = lastEffect.next, effect = firstEffect;
                                do {
