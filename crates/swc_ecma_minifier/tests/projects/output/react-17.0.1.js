...
"production" !== process.env.NODE_ENV && function() {
    ...
    function mapChildren(children, func, context) {
        ...
        return !function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
            ...
            if (invokeCallback) {
                var oldElement, _child = children, mappedChild = callback(_child), childKey = "" === nameSoFar ? "." + getElementKey(_child, 0) : nameSoFar;
                ...
                } else null != mappedChild && (isValidElement(mappedChild) && (oldElement = mappedChild, mappedChild = ReactElement(oldElement.type, escapedPrefix + (mappedChild.key && (!_child || _child.key !== mappedChild.key) ? escapeUserProvidedKey("" + mappedChild.key) + "/" : "") + childKey, oldElement.ref, oldElement._self, oldElement._source, oldElement._owner, oldElement.props)), array.push(mappedChild));
                return 1;
            }
