...
/// Issue #11517: Three if statements with different local variable values.
#[test]
fn issue_11517_three_branches() {
    let src = r#"
...
console.log(getResult(1).value);
console.log(getResult(2).value);
console.log(getResult(3).value);
console.log(getResult(4).value);
"#;
    run_default_exec_test(src);
}
...
/// Issue #11517: Different return statement structures with local variables.
#[test]
fn issue_11517_object_return() {
    let src = r#"
function buildResponse(status) {
  ...
  return { code: 0, text: 'Unknown', success: false };
}

console.log(JSON.stringify(buildResponse('ok')));
console.log(JSON.stringify(buildResponse('error')));
console.log(JSON.stringify(buildResponse('other')));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Array return with local variable.
#[test]
fn issue_11517_array_return() {
    let src = r#"
...
console.log(getItems('A').join(','));
console.log(getItems('B').join(','));
console.log(getItems('C').join(','));
"#;
    run_default_exec_test(src);
}
...
/// Issue #11517: Multiple local variables with same names but different values.
#[test]
fn issue_11517_multiple_vars() {
    let src = r#"
function multi(type) {
  if (type === 'A') {
    const a = 1;
...
/// Issue #11517: Same structure but variable used in computation.
#[test]
fn issue_11517_computation() {
    let src = r#"
function calc(op) {
  if (op === 'add') {
    const base = 100;
...
/// Issue #11517: Nested object with local variable.
#[test]
fn issue_11517_nested_object() {
    let src = r#"
function createNested(type) {
  if (type === 'X') {
    const inner = { value: 'x-value' };
    return { outer: inner };
  }
  if (type === 'Y') {
    const inner = { value: 'y-value' };
    return { outer: inner };
  }
  return null;
}

console.log(createNested('X').outer.value);
console.log(createNested('Y').outer.value);
console.log(createNested('Z'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Template literal with local variable.
#[test]
fn issue_11517_template_literal() {
    let src = r#"
function greet(lang) {
  if (lang === 'en') {
    const word = 'Hello';
...
/// Issue #11517: Function call with local variable.
#[test]
fn issue_11517_function_call() {
    let src = r#"
...
/// Issue #11517: Complex condition tests.
#[test]
fn issue_11517_complex_conditions() {
    let src = r#"
function check(a, b) {
  if (a > 0 && b > 0) {
    const result = 'both positive';
    return result;
  }
  if (a < 0 && b < 0) {
    const result = 'both negative';
    return result;
  }
  return 'mixed';
}
...
/// Issue #11517: With type coercion in condition.
#[test]
fn issue_11517_type_coercion() {
    let src = r#"
function coerce(val) {
  if (val == '1') {
...
console.log(coerce('2'));
console.log(coerce(3));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Numeric string values.
#[test]
fn issue_11517_numeric_strings() {
    let src = r#"
...
console.log(getCode('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Boolean local variables.
#[test]
fn issue_11517_boolean_vars() {
    let src = r#"
...
const r1 = checkState('on');
const r2 = checkState('off');
console.log(r1.active, r1.label);
console.log(r2.active, r2.label);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With spread operator.
#[test]
fn issue_11517_spread() {
    let src = r#"
...
console.log(JSON.stringify(extend('A', { x: 0 })));
console.log(JSON.stringify(extend('B', { x: 0 })));
console.log(JSON.stringify(extend('C', { x: 0 })));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Inside IIFE.
#[test]
fn issue_11517_iife() {
    let src = r#"
...
/// Issue #11517: Arrow function.
#[test]
fn issue_11517_arrow_function() {
    let src = r#"
const handler = (code) => {
  if (code === 100) {
    const msg = 'continue';
...
/// Issue #11517: With destructuring.
#[test]
fn issue_11517_destructuring() {
    let src = r#"
...
console.log(extract('name', { first: 'John', second: 30 }));
console.log(extract('age', { first: 'John', second: 30 }));
console.log(extract('other', { first: 'John', second: 30 }));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Array destructuring.
#[test]
fn issue_11517_array_destructuring() {
    let src = r#"
function getElement(pos, arr) {
  if (pos === 'first') {
    const [item] = arr;
    return item;
  }
...
console.log(getElement('first', ['a', 'b', 'c']));
console.log(getElement('last', ['a', 'b', 'c']));
console.log(getElement('middle', ['a', 'b', 'c']));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With default parameters.
#[test]
fn issue_11517_default_params() {
    let src = r#"
function withDefault(type, prefix = 'default') {
  if (type === 'A') {
    const suffix = '-alpha';
...
console.log(withDefault('B', 'custom'));
console.log(withDefault('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Rest parameters.
#[test]
fn issue_11517_rest_params() {
    let src = r#"
function collect(type, ...items) {
  if (type === 'sum') {
    const op = 'add';
    return op + ':' + items.reduce((a, b) => a + b, 0);
  }
  if (type === 'count') {
    const op = 'len';
    return op + ':' + items.length;
  }
  return 'none';
}

console.log(collect('sum', 1, 2, 3));
console.log(collect('count', 1, 2, 3, 4, 5));
console.log(collect('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Async function (sync test).
#[test]
fn issue_11517_async_sync() {
    let src = r#"
async function asyncHandler(type) {
  if (type === 'fast') {
    const delay = 0;
    return 'fast:' + delay;
  }
...
asyncHandler('fast').then(console.log);
asyncHandler('slow').then(console.log);
asyncHandler('other').then(console.log);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Generator function.
#[test]
fn issue_11517_generator() {
    let src = r#"
function* gen(type) {
  if (type === 'A') {
    const val = 'a-value';
...
console.log([...gen('A')].join(','));
console.log([...gen('B')].join(','));
console.log([...gen('C')].join(','));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Switch-like pattern with if-else-if.
#[test]
fn issue_11517_switch_pattern() {
    let src = r#"
function switcher(n) {
  if (n === 1) {
    const label = 'one';
...
console.log(switcher(1).label);
console.log(switcher(2).label);
console.log(switcher(3).label);
console.log(switcher(4).label);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Nested function calls.
#[test]
fn issue_11517_nested_calls() {
    let src = r#"
function outer(type) {
  function inner(val) {
...
/// Issue #11517: Multiple returns in same block.
#[test]
fn issue_11517_early_return() {
    let src = r#"
function earlyReturn(type, check) {
  if (type === 'A') {
    const val = 'A-value';
    if (check) return val + '-checked';
    return val;
  }
  if (type === 'B') {
    const val = 'B-value';
...
console.log(earlyReturn('A', true));
console.log(earlyReturn('A', false));
console.log(earlyReturn('B', true));
console.log(earlyReturn('B', false));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Variable used multiple times.
#[test]
fn issue_11517_multi_use() {
    let src = r#"
function multiUse(type) {
  if (type === 'X') {
    const val = 'x';
    return val + val + val;
  }
...
console.log(multiUse('X'));
console.log(multiUse('Y'));
console.log(multiUse('Z'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Numeric values.
#[test]
fn issue_11517_numeric() {
    let src = r#"
...
console.log(numeric('large'));
console.log(numeric('medium'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Null and undefined values.
#[test]
fn issue_11517_null_undefined() {
    let src = r#"
function nullish(type) {
  if (type === 'null') {
    const val = null;
    return { value: val };
  }
...
console.log(JSON.stringify(nullish('null')));
console.log(JSON.stringify(nullish('undef')));
console.log(JSON.stringify(nullish('other')));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Symbol values.
#[test]
fn issue_11517_symbols() {
    let src = r#"
function withSymbol(type) {
  if (type === 'A') {
    const sym = Symbol.for('a');
    return Symbol.keyFor(sym);
  }
  if (type === 'B') {
    const sym = Symbol.for('b');
    return Symbol.keyFor(sym);
  }
  return 'none';
}

console.log(withSymbol('A'));
console.log(withSymbol('B'));
console.log(withSymbol('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: RegExp values.
#[test]
fn issue_11517_regexp() {
    let src = r#"
function withRegex(type) {
  if (type === 'digits') {
    const re = /^\d+$/;
    return re.test('123');
  }
...
console.log(withRegex('digits'));
console.log(withRegex('letters'));
console.log(withRegex('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: BigInt values.
#[test]
fn issue_11517_bigint() {
    let src = r#"
function withBigInt(type) {
  if (type === 'small') {
    const big = 100n;
    return (big * 2n).toString();
  }
  if (type === 'large') {
...
console.log(withBigInt('small'));
console.log(withBigInt('large'));
console.log(withBigInt('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With try-catch inside if.
#[test]
fn issue_11517_try_catch() {
    let src = r#"
function withTryCatch(type) {
  if (type === 'safe') {
    const msg = 'safe-operation';
    try {
      return msg;
    } catch (e) {
      return 'error';
...
console.log(withTryCatch('safe'));
console.log(withTryCatch('risky'));
console.log(withTryCatch('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Deeply nested if statements.
#[test]
fn issue_11517_deep_nesting() {
    let src = r#"
function deepNest(a, b) {
  if (a === 1) {
    if (b === 1) {
      const val = 'a1-b1';
      return val;
...
console.log(deepNest(1, 1));
console.log(deepNest(1, 2));
console.log(deepNest(2, 1));
console.log(deepNest(2, 2));
console.log(deepNest(3, 3));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Object method shorthand.
#[test]
fn issue_11517_method_shorthand() {
    let src = r#"
function getObj(type) {
  if (type === 'A') {
    const method = () => 'method-A';
    return { method };
  }
  if (type === 'B') {
    const method = () => 'method-B';
    return { method };
  }
  return { method: () => 'default' };
}

console.log(getObj('A').method());
console.log(getObj('B').method());
console.log(getObj('C').method());
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Computed property names.
#[test]
fn issue_11517_computed_property() {
    let src = r#"
function withComputed(type) {
  const key = 'value';
  if (type === 'X') {
    const data = 'x-data';
    return { [key]: data };
...
console.log(withComputed('X').value);
console.log(withComputed('Y').value);
console.log(withComputed('Z').value);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Tagged template literal.
#[test]
fn issue_11517_tagged_template() {
    let src = r#"
function tag(strings, ...values) {
  return strings.join('') + ':' + values.join(',');
}

function withTagged(type) {
  if (type === 'A') {
    const val = 'alpha';
...
console.log(withTagged('A'));
console.log(withTagged('B'));
console.log(withTagged('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With Map.
#[test]
fn issue_11517_map() {
    let src = r#"
function withMap(type) {
  if (type === 'A') {
    const entry = ['key', 'value-A'];
    return new Map([entry]).get('key');
  }
  if (type === 'B') {
    const entry = ['key', 'value-B'];
    return new Map([entry]).get('key');
  }
  return 'default';
}

console.log(withMap('A'));
console.log(withMap('B'));
console.log(withMap('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With Set.
#[test]
fn issue_11517_set() {
    let src = r#"
function withSet(type) {
  if (type === 'A') {
    const items = [1, 2, 3];
...
console.log(withSet('A'));
console.log(withSet('B'));
console.log(withSet('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Ternary inside if.
#[test]
fn issue_11517_ternary() {
    let src = r#"
function withTernary(type, flag) {
  if (type === 'A') {
    const base = 'A-base';
    return flag ? base + '-flagged' : base;
  }
  if (type === 'B') {
    const base = 'B-base';
    return flag ? base + '-flagged' : base;
...
console.log(withTernary('A', true));
console.log(withTernary('A', false));
console.log(withTernary('B', true));
console.log(withTernary('B', false));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Logical operators with local var.
#[test]
fn issue_11517_logical_ops() {
    let src = r#"
function withLogical(type, extra) {
  if (type === 'A') {
    const val = 'A-value';
    return val || extra;
  }
...
console.log(withLogical('A', 'fallback'));
console.log(withLogical('B', 'fallback'));
console.log(withLogical('C', 'fallback'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Nullish coalescing.
#[test]
fn issue_11517_nullish_coalescing() {
    let src = r#"
function withNullish(type) {
  if (type === 'A') {
    const val = 'A-defined';
    return val ?? 'fallback';
  }
  if (type === 'B') {
    const val = null;
    return val ?? 'B-fallback';
  }
  return 'default';
}

console.log(withNullish('A'));
console.log(withNullish('B'));
console.log(withNullish('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Optional chaining.
#[test]
fn issue_11517_optional_chaining() {
    let src = r#"
function withOptional(type, obj) {
  if (type === 'A') {
    const key = 'a';
    return obj?.[key] ?? 'no-a';
  }
...
console.log(withOptional('A', { a: 'found-a' }));
console.log(withOptional('B', { b: 'found-b' }));
console.log(withOptional('A', null));
console.log(withOptional('C', {}));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Array methods.
#[test]
fn issue_11517_array_methods() {
    let src = r#"
function withArrayMethod(type, arr) {
  if (type === 'map') {
    const fn = x => x * 2;
  ...
  if (type === 'filter') {
    const fn = x => x > 2;
    return arr.filter(fn).join(',');
  }
  return arr.join(',');
}

console.log(withArrayMethod('map', [1, 2, 3]));
console.log(withArrayMethod('filter', [1, 2, 3, 4]));
console.log(withArrayMethod('other', [1, 2, 3]));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Promise-like pattern.
#[test]
fn issue_11517_promise_like() {
    let src = r#"
function createPromiseLike(type) {
  if (type === 'resolve') {
  ...
  if (type === 'reject') {
    ...
    return Promise.reject(value).catch(e => e);
  }
  return Promise.resolve('default');
}

createPromiseLike('resolve').then(console.log);
createPromiseLike('reject').then(console.log);
createPromiseLike('other').then(console.log);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Date operations.
#[test]
fn issue_11517_date() {
    let src = r#"
function withDate(type) {
  if (type === 'year') {
    const part = 'year';
    return part + ':' + new Date(2024, 0, 1).getFullYear();
  }
  if (type === 'month') {
    const part = 'month';
    return part + ':' + new Date(2024, 5, 1).getMonth();
  }
  return 'unknown';
}

console.log(withDate('year'));
console.log(withDate('month'));
console.log(withDate('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: JSON operations.
#[test]
fn issue_11517_json() {
    let src = r#"
function withJSON(type) {
  if (type === 'simple') {
    const data = { key: 'simple-value' };
    return JSON.stringify(data);
  }
  if (type === 'complex') {
    const data = { key: 'complex-value', nested: { a: 1 } };
    return JSON.stringify(data);
  }
  return '{}';
}

console.log(withJSON('simple'));
console.log(withJSON('complex'));
console.log(withJSON('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Error construction.
#[test]
fn issue_11517_error_construction() {
    let src = r#"
function createError(type) {
  if (type === 'type') {
    const msg = 'Type error message';
    return new TypeError(msg).message;
  }
  if (type === 'range') {
    const msg = 'Range error message';
    return new RangeError(msg).message;
  }
  return 'no error';
}

console.log(createError('type'));
console.log(createError('range'));
console.log(createError('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Object.keys/values/entries.
#[test]
fn issue_11517_object_methods() {
    let src = r#"
function withObjectMethod(type) {
  if (type === 'keys') {
    const obj = { a: 1, b: 2 };
...
console.log(withObjectMethod('keys'));
console.log(withObjectMethod('values'));
console.log(withObjectMethod('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: String methods.
#[test]
fn issue_11517_string_methods() {
    let src = r#"
function withStringMethod(type, str) {
  if (type === 'upper') {
...
console.log(withStringMethod('upper', 'Hello'));
console.log(withStringMethod('lower', 'Hello'));
console.log(withStringMethod('other', 'Hello'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Math operations.
#[test]
fn issue_11517_math() {
    let src = r#"
function withMath(type, num) {
  if (type === 'ceil') {
    const fn = Math.ceil;
    return fn(num);
  }
...
console.log(withMath('ceil', 4.3));
console.log(withMath('floor', 4.7));
console.log(withMath('other', 4.5));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Array constructor.
#[test]
fn issue_11517_array_constructor() {
    let src = r#"
function createArray(type) {
  if (type === 'fill-a') {
    const fill = 'A';
    return new Array(3).fill(fill).join(',');
  }
  if (type === 'fill-b') {
    const fill = 'B';
    return new Array(3).fill(fill).join(',');
...
console.log(createArray('fill-a'));
console.log(createArray('fill-b'));
console.log(createArray('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Prototype methods.
#[test]
fn issue_11517_prototype() {
    let src = r#"
function withPrototype(type) {
  if (type === 'array') {
    const proto = Array.prototype;
    return typeof proto.map;
  }
  if (type === 'string') {
    const proto = String.prototype;
    return typeof proto.split;
  }
  return 'unknown';
}

console.log(withPrototype('array'));
console.log(withPrototype('string'));
console.log(withPrototype('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: instanceof checks.
#[test]
fn issue_11517_instanceof() {
    let src = r#"
function checkInstance(type, val) {
  if (type === 'array') {
    const ctor = Array;
...
console.log(checkInstance('array', [1, 2]));
console.log(checkInstance('object', { a: 1 }));
console.log(checkInstance('other', 'string'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: typeof checks.
#[test]
fn issue_11517_typeof() {
    let src = r#"
function checkType(type) {
  if (type === 'number') {
    const expected = 'number';
    return typeof 42 === expected;
  }
  if (type === 'string') {
    const expected = 'string';
    return typeof 'hello' === expected;
  }
  return false;
}
...
console.log(checkType('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: void expressions.
#[test]
fn issue_11517_void() {
    let src = r#"
function withVoid(type) {
  if (type === 'A') {
    const result = void 0;
    return result === undefined ? 'A-undefined' : 'A-other';
  }
  if (type === 'B') {
    const result = void 1;
    return result === undefined ? 'B-undefined' : 'B-other';
  }
  return 'default';
}

console.log(withVoid('A'));
console.log(withVoid('B'));
console.log(withVoid('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: delete operator.
#[test]
fn issue_11517_delete() {
    let src = r#"
function withDelete(type) {
  if (type === 'A') {
    const obj = { a: 1, b: 2 };
    delete obj.a;
    return Object.keys(obj).join(',');
...
console.log(withDelete('A'));
console.log(withDelete('B'));
console.log(withDelete('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: in operator.
#[test]
fn issue_11517_in_operator() {
    let src = r#"
function checkIn(type, obj) {
  if (type === 'hasA') {
    const key = 'a';
    return key in obj;
  }
...
console.log(checkIn('hasA', { a: 1 }));
console.log(checkIn('hasB', { b: 2 }));
console.log(checkIn('hasA', { b: 2 }));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Unary operators.
#[test]
fn issue_11517_unary() {
    let src = r#"
function withUnary(type) {
  if (type === 'neg') {
    const num = 5;
    return -num;
  }
...
console.log(withUnary('neg'));
console.log(withUnary('not'));
console.log(withUnary('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Binary operators.
#[test]
fn issue_11517_binary() {
    let src = r#"
function withBinary(type) {
  if (type === 'add') {
    const operand = 10;
    return 5 + operand;
  }
...
console.log(withBinary('add'));
console.log(withBinary('mul'));
console.log(withBinary('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Bitwise operators.
#[test]
fn issue_11517_bitwise() {
    let src = r#"
function withBitwise(type) {
  if (type === 'and') {
    const mask = 0xFF;
    return (0x12AB & mask).toString(16);
  }
  if (type === 'or') {
    const mask = 0xF0;
    return (0x0A | mask).toString(16);
  }
  return '0';
}

console.log(withBitwise('and'));
console.log(withBitwise('or'));
console.log(withBitwise('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Shift operators.
#[test]
fn issue_11517_shift() {
    let src = r#"
function withShift(type) {
  if (type === 'left') {
    const bits = 2;
    return (1 << bits);
  }
...
console.log(withShift('left'));
console.log(withShift('right'));
console.log(withShift('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Assignment expressions.
#[test]
fn issue_11517_assignment() {
    let src = r#"
function withAssignment(type) {
  let result = 0;
  if (type === 'add') {
    const delta = 5;
    result += delta;
...
console.log(withAssignment('add'));
console.log(withAssignment('mul'));
console.log(withAssignment('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Increment/decrement.
#[test]
fn issue_11517_inc_dec() {
    let src = r#"
function withIncDec(type) {
  if (type === 'inc') {
    let val = 10;
    return ++val;
  }
...
console.log(withIncDec('inc'));
console.log(withIncDec('dec'));
console.log(withIncDec('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Sequence expressions.
#[test]
fn issue_11517_sequence() {
    let src = r#"
function withSequence(type) {
  if (type === 'A') {
    const a = 1, b = 2;
    return (a, b, a + b);
  }
...
console.log(withSequence('A'));
console.log(withSequence('B'));
console.log(withSequence('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Labeled statement.
#[test]
fn issue_11517_labeled() {
    let src = r#"
function withLabeled(type) {
  if (type === 'A') {
    const label = 'A-result';
    outer: {
      break outer;
    }
    return label;
...
console.log(withLabeled('A'));
console.log(withLabeled('B'));
console.log(withLabeled('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: With statement (non-strict).
#[test]
fn issue_11517_with_statement() {
    let src = r#"
function withWith(type) {
  if (type === 'A') {
    const obj = { x: 'A-value' };
    with (obj) {
      return x;
...
console.log(withWith('A'));
console.log(withWith('B'));
console.log(withWith('C'));
"#;
    let config = r#"{
    "defaults": true
}"#;
...
/// Issue #11517: For-of loop.
#[test]
fn issue_11517_for_of() {
    let src = r#"
function withForOf(type) {
  const result = [];
  if (type === 'A') {
    const items = ['a1', 'a2'];
...
console.log(withForOf('A'));
console.log(withForOf('B'));
console.log(withForOf('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: For-in loop.
#[test]
fn issue_11517_for_in() {
    let src = r#"
function withForIn(type) {
  const result = [];
  if (type === 'A') {
    const obj = { a: 1, b: 2 };
...
console.log(withForIn('A'));
console.log(withForIn('B'));
console.log(withForIn('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: While loop.
#[test]
fn issue_11517_while() {
    let src = r#"
function withWhile(type) {
  if (type === 'A') {
    const limit = 3;
    let i = 0;
    let result = '';
...
console.log(withWhile('A'));
console.log(withWhile('B'));
console.log(withWhile('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Do-while loop.
#[test]
fn issue_11517_do_while() {
    let src = r#"
function withDoWhile(type) {
  if (type === 'A') {
    const limit = 3;
    let i = 0;
    let result = '';
...
console.log(withDoWhile('A'));
console.log(withDoWhile('B'));
console.log(withDoWhile('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Switch statement inside if.
#[test]
fn issue_11517_switch_inside() {
    let src = r#"
function withSwitch(type, code) {
  if (type === 'A') {
    const prefix = 'A-';
    switch (code) {
...
console.log(withSwitch('A', 1));
console.log(withSwitch('A', 2));
console.log(withSwitch('B', 1));
console.log(withSwitch('B', 3));
console.log(withSwitch('C', 1));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: New expression.
#[test]
fn issue_11517_new_expr() {
    let src = r#"
function withNew(type) {
  if (type === 'A') {
    const Ctor = Array;
    return new Ctor(3).length;
  }
  if (type === 'B') {
    const Ctor = Object;
...
console.log(withNew('A'));
console.log(withNew('B'));
console.log(withNew('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Call expression.
#[test]
fn issue_11517_call_expr() {
    let src = r#"
function withCall(type) {
  const transform = (fn, val) => fn(val);
  if (type === 'A') {
    const fn = x => x * 2;
    return transform(fn, 5);
  }
  if (type === 'B') {
    const fn = x => x + 10;
    return transform(fn, 5);
...
console.log(withCall('A'));
console.log(withCall('B'));
console.log(withCall('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Member expression.
#[test]
fn issue_11517_member_expr() {
    let src = r#"
function withMember(type) {
...
console.log(withMember('A'));
console.log(withMember('B'));
console.log(withMember('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Array expression.
#[test]
fn issue_11517_array_expr() {
    let src = r#"
function withArrayExpr(type) {
  if (type === 'A') {
    const elem = 'a-elem';
...
console.log(withArrayExpr('A'));
console.log(withArrayExpr('B'));
console.log(withArrayExpr('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Object expression.
#[test]
fn issue_11517_object_expr() {
    let src = r#"
function withObjectExpr(type) {
  if (type === 'A') {
    const val = 'a-value';
...
console.log(withObjectExpr('A'));
console.log(withObjectExpr('B'));
console.log(withObjectExpr('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Parenthesized expression.
#[test]
fn issue_11517_paren_expr() {
    let src = r#"
function withParen(type) {
  if (type === 'A') {
    const x = 2;
    return (x + 3) * 4;
  }
...
console.log(withParen('A'));
console.log(withParen('B'));
console.log(withParen('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Super call in constructor.
#[test]
fn issue_11517_super_call() {
    let src = r#"
class Base {
  constructor(value) {
    this.value = value;
...
console.log(new DerivedA('A').value);
console.log(new DerivedA('X').value);
console.log(new DerivedB('B').value);
console.log(new DerivedB('X').value);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Static class fields.
#[test]
fn issue_11517_static_fields() {
    let src = r#"
function getClass(type) {
  if (type === 'A') {
    const value = 'A-static';
    return class { static field = value; };
  }
  if (type === 'B') {
    const value = 'B-static';
    return class { static field = value; };
  }
  return class { static field = 'default'; };
}

console.log(getClass('A').field);
console.log(getClass('B').field);
console.log(getClass('C').field);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Private class fields.
#[test]
fn issue_11517_private_fields() {
    let src = r#"
function getInstance(type) {
  if (type === 'A') {
    const val = 'A-private';
    return new class { #field = val; get() { return this.#field; } }().get();
  }
  if (type === 'B') {
    const val = 'B-private';
    return new class { #field = val; get() { return this.#field; } }().get();
...
console.log(getInstance('B'));
console.log(getInstance('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Getter and setter.
#[test]
fn issue_11517_getter_setter() {
    let src = r#"
function createObj(type) {
  if (type === 'A') {
    ...
    return {
      _val: 'value',
      get val() { return prefix + this._val; },
...
console.log(createObj('A').val);
console.log(createObj('B').val);
console.log(createObj('C').val);
"#;
    run_default_exec_test(src);
}
...
/// Issue #11517: Proxy.
#[test]
fn issue_11517_proxy() {
    let src = r#"
function createProxy(type) {
  if (type === 'A') {
    const target = { value: 'A-target' };
    return new Proxy(target, {}).value;
  }
  if (type === 'B') {
    const target = { value: 'B-target' };
    return new Proxy(target, {}).value;
  }
  return 'default';
}

console.log(createProxy('A'));
console.log(createProxy('B'));
console.log(createProxy('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Reflect API.
#[test]
fn issue_11517_reflect() {
    let src = r#"
function useReflect(type) {
  if (type === 'A') {
    const prop = 'a';
    const obj = { a: 'A-value' };
...
console.log(useReflect('A'));
console.log(useReflect('B'));
console.log(useReflect('C'));
"#;
    run_default_exec_test(src);
}
...
/// Issue #11517: WeakMap.
#[test]
fn issue_11517_weakmap() {
    let src = r#"
function useWeakMap(type) {
  const key = {};
  if (type === 'A') {
    const value = 'A-value';
...
console.log(useWeakMap('A'));
console.log(useWeakMap('B'));
console.log(useWeakMap('C'));
"#;
    run_default_exec_test(src);
}
...
/// Issue #11517: WeakSet.
#[test]
fn issue_11517_weakset() {
    let src = r#"
function useWeakSet(type) {
  const obj1 = {};
  const obj2 = {};
  if (type === 'A') {
    const items = [obj1];
...
console.log(useWeakSet('A'));
console.log(useWeakSet('B'));
console.log(useWeakSet('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: ArrayBuffer and typed arrays.
#[test]
fn issue_11517_typed_array() {
    let src = r#"
function useTypedArray(type) {
  if (type === 'uint8') {
...
console.log(useTypedArray('uint8'));
console.log(useTypedArray('int32'));
console.log(useTypedArray('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: DataView.
#[test]
fn issue_11517_dataview() {
    let src = r#"
function useDataView(type) {
...
console.log(useDataView('int8'));
console.log(useDataView('int16'));
console.log(useDataView('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Intl API.
#[test]
fn issue_11517_intl() {
    let src = r#"
function useIntl(type) {
  if (type === 'number') {
  ...
  if (type === 'date') {
    ...
    return typeof formatter.format;
  }
  return 'default';
}

console.log(useIntl('number'));
console.log(useIntl('date'));
console.log(useIntl('other'));
"#;
    run_default_exec_test(src);
}
...
function useURL(type) {
  ...
  if (type === 'pathname') {
    const url = new URL('https://example.com/mypath');
    return url.pathname;
  }
  return 'default';
}

console.log(useURL('hostname'));
console.log(useURL('pathname'));
console.log(useURL('other'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Mixed local and outer variable.
#[test]
fn issue_11517_mixed_vars() {
    let src = r#"
...
/// Issue #11517: Hoisted function declaration.
#[test]
fn issue_11517_hoisted_fn() {
    let src = r#"
function withHoisted(type) {
  if (type === 'A') {
    function inner() { return 'A-hoisted'; }
    return inner();
  }
  if (type === 'B') {
    function inner() { return 'B-hoisted'; }
    return inner();
  }
  return 'default';
}

console.log(withHoisted('A'));
console.log(withHoisted('B'));
console.log(withHoisted('C'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Complex real-world pattern.
#[test]
fn issue_11517_real_world_1() {
    let src = r#"
function processEvent(event) {
  if (event.type === 'click') {
    const handler = 'click-handler';
    const result = { handled: true, by: handler };
    return result;
  }
  if (event.type === 'keydown') {
    const handler = 'keydown-handler';
    const result = { handled: true, by: handler };
    return result;
  }
  if (event.type === 'scroll') {
    const handler = 'scroll-handler';
    const result = { handled: true, by: handler };
    return result;
  }
...
console.log(JSON.stringify(processEvent({ type: 'click' })));
console.log(JSON.stringify(processEvent({ type: 'keydown' })));
console.log(JSON.stringify(processEvent({ type: 'scroll' })));
console.log(JSON.stringify(processEvent({ type: 'unknown' })));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: HTTP status pattern.
#[test]
...
/// Issue #11517: Form validation pattern.
#[test]
fn issue_11517_form_validation() {
    let src = r#"
function validateField(field, value) {
  if (field === 'email') {
    const pattern = /@/;
    const isValid = pattern.test(value);
    return { field, isValid, error: isValid ? null : 'Invalid email' };
  }
  if (field === 'phone') {
    const pattern = /^\d{10}$/;
    const isValid = pattern.test(value);
    return { field, isValid, error: isValid ? null : 'Invalid phone' };
  }
  if (field === 'zip') {
    const pattern = /^\d{5}$/;
    const isValid = pattern.test(value);
    return { field, isValid, error: isValid ? null : 'Invalid zip' };
  }
  return { field, isValid: true, error: null };
}

console.log(JSON.stringify(validateField('email', 'test@example.com')));
console.log(JSON.stringify(validateField('email', 'invalid')));
console.log(JSON.stringify(validateField('phone', '1234567890')));
console.log(JSON.stringify(validateField('phone', '123')));
console.log(JSON.stringify(validateField('zip', '12345')));
console.log(JSON.stringify(validateField('other', 'value')));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Redux-like action pattern.
#[test]
fn issue_11517_redux_pattern() {
    let src = r#"
...
console.log(state.count);
state = reducer(state, { type: 'ADD', payload: 10 });
console.log(state.count);
...
console.log(translate('goodbye', 'en'));
console.log(translate('goodbye', 'es'));
console.log(translate('goodbye', 'fr'));
console.log(translate('hello', 'de'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Theme pattern.
#[test]
fn issue_11517_theme() {
    let src = r#"
function getThemeColors(theme) {
  ...
  if (theme === 'dark') {
    const colors = { bg: '#000', fg: '#fff' };
    return colors;
  }
  if (theme === 'sepia') {
    const colors = { bg: '#f4ecd8', fg: '#5c4a37' };
    return colors;
  }
  return { bg: '#fff', fg: '#000' };
}

console.log(JSON.stringify(getThemeColors('light')));
console.log(JSON.stringify(getThemeColors('dark')));
console.log(JSON.stringify(getThemeColors('sepia')));
console.log(JSON.stringify(getThemeColors('unknown')));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Logger pattern.
#[test]
fn issue_11517_logger() {
    let src = r#"
...
console.log(log('warn', 'Memory usage high'));
console.log(log('error', 'Connection failed'));
console.log(log('debug', 'Variable value: 42'));
console.log(log('unknown', 'Raw message'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: API response pattern.
#[test]
fn issue_11517_api_response() {
    let src = r#"
function handleApiResponse(response) {
  if (response.code === 'SUCCESS') {
    const status = 'success';
    const result = { status, data: response.data, error: null };
    return result;
  }
  if (response.code === 'VALIDATION_ERROR') {
    const status = 'validation_error';
    const result = { status, data: null, error: response.message };
    return result;
  }
  if (response.code === 'AUTH_ERROR') {
    const status = 'auth_error';
    const result = { status, data: null, error: response.message };
    return result;
  }
  ...
  return { status: 'unknown', data: null, error: 'Unknown error' };
}

console.log(handleApiResponse({ code: 'SUCCESS', data: { id: 1 } }).status);
console.log(handleApiResponse({ code: 'VALIDATION_ERROR', message: 'Invalid input' }).status);
console.log(handleApiResponse({ code: 'AUTH_ERROR', message: 'Unauthorized' }).status);
console.log(handleApiResponse({ code: 'SERVER_ERROR', message: 'Internal error' }).status);
console.log(handleApiResponse({ code: 'UNKNOWN' }).status);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: File type handler.
#[test]
fn issue_11517_file_handler() {
    let src = r#"
function getHandler(extension) {
  if (extension === '.js') {
    const handler = 'javascript';
    return { handler, canExecute: true };
  }
  if (extension === '.ts') {
  ...
  return { handler: 'binary', canExecute: false };
}

console.log(getHandler('.js').handler);
console.log(getHandler('.ts').handler);
console.log(getHandler('.json').handler);
console.log(getHandler('.md').handler);
console.log(getHandler('.txt').handler);
console.log(getHandler('.exe').handler);
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Command parser.
#[test]
fn issue_11517_command_parser() {
    let src = r#"
...
console.log(JSON.stringify(parseCommand('add item')));
console.log(JSON.stringify(parseCommand('remove item')));
console.log(JSON.stringify(parseCommand('update item')));
console.log(JSON.stringify(parseCommand('list')));
console.log(JSON.stringify(parseCommand('other')));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Currency formatter.
#[test]
fn issue_11517_currency() {
    let src = r#"
...
console.log(formatCurrency(99.99, 'USD'));
console.log(formatCurrency(99.99, 'EUR'));
console.log(formatCurrency(99.99, 'GBP'));
console.log(formatCurrency(9999, 'JPY'));
console.log(formatCurrency(99.99, 'XXX'));
"#;
    run_default_exec_test(src);
}

/// Issue #11517: Permission checker.
#[test]
fn issue_11517_permissions() {
    let src = r#"
function checkPermission(role, resource) {
  if (role === 'admin') {
    const permissions = ['read', 'write', 'delete'];
    return { allowed: permissions.includes(resource), permissions };
  }
  if (role === 'editor') {
...
console.log(checkPermission('admin', 'delete').allowed);
console.log(checkPermission('editor', 'delete').allowed);
console.log(checkPermission('viewer', 'read').allowed);
console.log(checkPermission('guest', 'read').allowed);
console.log(checkPermission('admin', 'read').permissions.join(','));
console.log(checkPermission('editor', 'read').permissions.join(','));
"#;
    run_default_exec_test(src);
}
