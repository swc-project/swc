(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([
    [405],
    {
        ...
        /***/ 562: /***/ function (
            ...
            var BigInt =
                global_window__WEBPACK_IMPORTED_MODULE_0___default().BigInt ||
                Number;
            var BYTE_TABLE = [
                BigInt("0x1"),
                BigInt("0x100"),
            ...
            var numberToBytes = function numberToBytes(number, _temp2) {
                ...
                for (var i = 0; i < byteCount; i++) {
                    ...
                    bytes[byteIndex] = Number(
                        (number / BYTE_TABLE[i]) & BigInt(0xff)
                    );
            ...
            var concatTypedArrays = function concatTypedArrays() {
                ...
                buffers = buffers.filter(function (b) {
                    return (
                        b && (b.byteLength || b.length) && typeof b !== "string"
                    );
                });
            ...
            var sliceBytes = function sliceBytes(src, start, end) {
                ...
                return new Uint8Array(
                    Array.prototype.slice.call(src, start, end)
                );
            };
        ...
        /***/ 2260: /***/ function (
            ...
            var translateLegacyCodec = function translateLegacyCodec(codec) {
                ...
                return codec.replace(
                    ...
                    function (orig, profile, avcLevel) {
                        var profileHex = (
                            "00" + Number(profile).toString(16)
                        ).slice(-2);
                        var avcLevelHex = (
                            "00" + Number(avcLevel).toString(16)
                        ).slice(-2);
            ...
            var codecsFromDefault = function codecsFromDefault(
                master,
                audioGroupId
            ) {
                ...
                for (var name in audioGroup) {
                    ...
                    if (audioType.default && audioType.playlists) {
                        ...
                        return parseCodecs(
                            audioType.playlists[0].attributes.CODECS
                        );
                    }
                }
            ...
            var browserSupportsCodec = function browserSupportsCodec(
                codecString
            ) {
                if (codecString === void 0) {
                    codecString = "";
                ...
                return (
                    (global_window__WEBPACK_IMPORTED_MODULE_0___default()
                        ...
                        global_window__WEBPACK_IMPORTED_MODULE_0___default().MediaSource.isTypeSupported(
                            getMimeForCodec(codecString)
                        )) ||
                    false
                );
            };
        ...
        /***/ 6185: /***/ function (
            ...
            var byte_helpers = __webpack_require__(562); // CONCATENATED MODULE: ./node_modules/@videojs/vhs-utils/es/codec-helpers.js
            ...
            var codec_helpers_getHvcCodec = function getHvcCodec(bytes) {
                ...
                if (profileCompatVal > 255) {
                    profileCompatVal = parseInt(
                        toBinaryString(profileCompat),
                        2
                    );
                }
            ...
            DESCRIPTORS = [
                {
                    ...
                    parser: function parser(bytes) {
                        ...
                        if (desc.flags & 0x80) {
                            desc.dependsOnEsId =
                                (bytes[desc.size] << 8) | bytes[desc.size + 1];
                            desc.size += 2;
                        } // url

                        if (desc.flags & 0x40) {
                            var len = bytes[desc.size];
                            desc.url = (0, byte_helpers /* bytesToString */.d3)(
                                bytes.subarray(
                                    desc.size + 1,
                                    desc.size + 1 + len
                                )
                        ...
                        desc.descriptors =
                            parseDescriptors(bytes.subarray(desc.size)) || [];
                        return desc;
                    },
                },
                {
                ...
                while (i < bytes.length) {
                    ...
                    if ((0, byte_helpers /* bytesMatch */.G3)(type, paths[0])) {
                        if (paths.length === 1) {
                            ...
                            results.push.apply(
                                results,
                                findBox(data, paths.slice(1), complete)
                            );
                        }
                    }
            ...
            var buildFrameTable = function buildFrameTable(stbl, timescale) {
                ...
                var samplesToChunks = parseSamples(
                    ...
                    function (entry) {
                        return {
                            ...
                            samplesPerChunk: bytesToNumber(
                                entry.subarray(4, 8)
                            ),
                            sampleDescriptionIndex: bytesToNumber(
                                entry.subarray(8, 12)
                            ),
                        };
                    }
                ...
                for (
                    ...
                    for (var i = 0; i < samplesToChunks.length; i++) {
                        ...
                        var isThisOne =
                            ...
                            (i + 1 >= samplesToChunks.length ||
                                chunkIndex + 1 <
                                    samplesToChunks[i + 1].firstChunk);
                    ...
                    for (var _i = 0; _i < samplesInChunk; _i++) {
                        ...
                        if (
                            keySamples.length &&
                            keySamples.indexOf(frames.length + 1) !== -1
                        ) {
                            keyframe = true;
                        }
            ...
            var addSampleDescription = function addSampleDescription(
                track,
                bytes
            ) {
      ...
      const nalLen = avcC[offset] << 8 | avcC[offset + 1];
       ...
       offset += nalLen + 2;
                    ...
                    if (decoderConfig) {
                        ...
                        if (decoderConfig.oti === 0x40) {
                            codec +=
                                "." +
                                (
                                    decoderConfig.descriptors[0].bytes[0] >> 3
                                ).toString();
                        } else if (decoderConfig.oti === 0x20) {
                            codec +=
                                "." +
                                decoderConfig.descriptors[0].bytes[4].toString();
            ...
            var parseTracks = function parseTracks(bytes, frameTable) {
                ...
                traks.forEach(function (trak) {
                    ...
                    while (descriptionCount--) {
                        var len = bytesToNumber(
                            stsd.subarray(offset, offset + 4)
                        );
                        var sampleDescriptor = stsd.subarray(
                            offset + 4,
                            offset + 4 + len
                        );
                    ...
                    if (frameTable) {
                        track.frameTable = buildFrameTable(
                            stbl,
                            track.timescale
                        );
            ...
            var getvint = function getvint(
                ...
                if (removeLength) {
                    valueBytes = Array.prototype.slice.call(
                        bytes,
                        offset,
                        offset + length
                    );
                ...
                return {
                    length: length,
                    value: (0, byte_helpers /* bytesToNumber */.tm)(
                        valueBytes,
                        {
                            signed: signed,
                        }
            ...
            var getInfinityDataSize = function getInfinityDataSize(
                id,
                bytes,
                offset
            ) {
            ...
            var findEbml = function findEbml(bytes, paths) {
                ...
                while (i < bytes.length) {
                    ...
                    if (dataHeader.value === 0x7f) {
                        dataHeader.value = getInfinityDataSize(
                            id,
                            bytes,
                            dataStart
                        );
                    ...
                    if (
                        ...
                        if (paths.length === 1) {
                            ...
                            results = results.concat(
                                findEbml(data, paths.slice(1))
                            );
                        }
                    }

                    var totalLength =
                        id.length + dataHeader.length + data.length; // move past this tag entirely, we are not looking for it
            ...
            var decodeBlock = function decodeBlock(
                block,
                type,
                timestampScale,
                clusterTimestamp
                ...
                if (type === "group") {
                    ...
                    if (duration) {
                        ...
                        duration =
                            ((1 / timestampScale) * duration * timestampScale) /
                            1000;
                    }
            ...
            var ebml_helpers_parseTracks = function parseTracks(bytes) {
                ...
                tracks.forEach(function (track) {
                    ...
                    var decodedTrack = {
                        rawCodec: bytesToString(
                            findEbml(track, [EBML_TAGS.CodecID])[0]
                        ),
                        type: trackType,
                        ...
                        number: bytesToNumber(
                            findEbml(track, [EBML_TAGS.TrackNumber])[0]
                        ),
                    ...
                    if (/V_MPEG4\/ISO\/AVC/.test(decodedTrack.rawCodec)) {
                        codec =
                            "avc1." + getAvcCodec(decodedTrack.codecPrivate);
                    } else if (
                        /V_MPEGH\/ISO\/HEVC/.test(decodedTrack.rawCodec)
                    ) {
                        codec =
                            "hev1." + getHvcCodec(decodedTrack.codecPrivate);
                    } else if (
                        /V_MPEG4\/ISO\/ASP/.test(decodedTrack.rawCodec)
                    ) {
                        if (decodedTrack.codecPrivate) {
                            codec =
                                "mp4v.20." +
                                decodedTrack.codecPrivate[4].toString();
                        } else {
                            codec = "mp4v.20.9";
                        }
                        ...
                        if (decodedTrack.codecPrivate) {
                            var _parseVp9Private = parseVp9Private(
                                    decodedTrack.codecPrivate
                                ),
                                profile = _parseVp9Private.profile,
                                level = _parseVp9Private.level,
                                bitDepth = _parseVp9Private.bitDepth,
                                chromaSubsampling =
                                    _parseVp9Private.chromaSubsampling;
                            ...
                            if (
                                ...
                                codec +=
                                    "." + padStart(colourPrimaries[0], 2, "0");
                                codec +=
                                    "." +
                                    padStart(
                                ...
                                codec +=
                                    "." +
                                    padStart(matrixCoefficients[0], 2, "0");
                                codec +=
                                    "." +
                                    padStart(videoFullRangeFlag[0], 2, "0");
                            }
                        } else {
                            codec = "vp9";
                        }
                        ...
                        codec =
                            "av01." + getAv1Codec(decodedTrack.codecPrivate);
                        ...
                        if (decodedTrack.codecPrivate) {
                            codec =
                                "mp4a.40." +
                                (decodedTrack.codecPrivate[0] >>> 3).toString();
                        } else {
                            codec = "mp4a.40.2";
                        }
            ...
            var parseData = function parseData(data, tracks) {
                ...
                clusters.forEach(function (cluster, ci) {
                    ...
                    var timestamp =
                        findEbml(cluster, [EBML_TAGS.Timestamp])[0] || 0;
            ...
            var id3_helpers = __webpack_require__(8925); // CONCATENATED MODULE: ./node_modules/@videojs/vhs-utils/es/nal-helpers.js
            var NAL_TYPE_ONE = (0, byte_helpers /* toUint8 */.Ki)([
                0x00, 0x00, 0x00, 0x01,
            ]);
            var NAL_TYPE_TWO = (0, byte_helpers /* toUint8 */.Ki)([
                0x00, 0x00, 0x01,
            ]);
            var EMULATION_PREVENTION = (0, byte_helpers /* toUint8 */.Ki)([
                0x00, 0x00, 0x03,
            ]);
            /**
            ...
            var findNal = function findNal(bytes, dataType, types, nalLimit) {
                ...
                while (i < bytes.length && (nalsFound < nalLimit || nalStart)) {
                    ...
                    if (nalStart) {
                        return discardEmulationPreventionBytes(
                            bytes.subarray(nalStart, i)
                        );
                    }
            ...
            var _isLikely = {
                aac: function aac(bytes) {
                    ...
                    return (0, byte_helpers /* bytesMatch */.G3)(
                        bytes,
                        [0xff, 0x10],
                        {
                            offset: offset,
            ...
            isLikelyTypes.forEach(function (type) {
                ...
                _isLikely[type] = function (bytes) {
                    return isLikelyFn(
                        (0, byte_helpers /* toUint8 */.Ki)(bytes)
                    );
                };
            ...
            var detectContainerForBytes = function detectContainerForBytes(
                bytes
            ) {
                bytes = (0, byte_helpers /* toUint8 */.Ki)(bytes);
            ...
            var isLikelyFmp4MediaSegment = function isLikelyFmp4MediaSegment(
                bytes
            ) {
        ...
        /***/ 6722: /***/ function (
            ...
            /* provided dependency */ var Buffer =
                __webpack_require__(816)["Buffer"];

            var atob = function atob(s) {
                return global_window__WEBPACK_IMPORTED_MODULE_0___default().atob
                    ? global_window__WEBPACK_IMPORTED_MODULE_0___default().atob(
                          s
                      )
        ...
        /***/ 8925: /***/ function (
            ...
            /* harmony import */ var _byte_helpers_js__WEBPACK_IMPORTED_MODULE_0__ =
                __webpack_require__(562);

            var ID3 = (0,
            _byte_helpers_js__WEBPACK_IMPORTED_MODULE_0__ /* .toUint8 */.Ki)([
                0x49, 0x44, 0x33,
            ]);
            ...
            var getId3Offset = function getId3Offset(bytes, offset) {
                ...
                if (
                    ...
                    !(0,
                    _byte_helpers_js__WEBPACK_IMPORTED_MODULE_0__ /* .bytesMatch */.G3)(
                        bytes,
                        ID3,
                        {
                            offset: offset,
        ...
        /***/ 8485: /***/ function (
            ...
            var MPEGURL_REGEX =
                /^(audio|video|application)\/(x-|vnd\.apple\.)?mpegurl/i;
            ...
            var simpleTypeFromSourceType = function simpleTypeFromSourceType(
                type
            ) {
        ...
        /***/ 779: /***/ function (
            ...
            "use strict";
            /* harmony import */ var url_toolkit__WEBPACK_IMPORTED_MODULE_0__ =
                __webpack_require__(9945);
            /* harmony import */ var url_toolkit__WEBPACK_IMPORTED_MODULE_0___default =
                /*#__PURE__*/ __webpack_require__.n(
                    url_toolkit__WEBPACK_IMPORTED_MODULE_0__
                );
            /* harmony import */ var global_window__WEBPACK_IMPORTED_MODULE_1__ =
                __webpack_require__(8908);
            /* harmony import */ var global_window__WEBPACK_IMPORTED_MODULE_1___default =
                /*#__PURE__*/ __webpack_require__.n(
                    global_window__WEBPACK_IMPORTED_MODULE_1__
                );
            ...
            var resolveUrl = function resolveUrl(baseUrl, relativeUrl) {
                ...
                var nativeURL =
                    typeof global_window__WEBPACK_IMPORTED_MODULE_1___default()
                        .URL === "function";
                ...
                var removeLocation =
                    !global_window__WEBPACK_IMPORTED_MODULE_1___default()
                        .location && !/\/\//i.test(baseUrl); // if the base URL is relative then combine with the current location

                if (nativeURL) {
                    baseUrl =
                        new (global_window__WEBPACK_IMPORTED_MODULE_1___default().URL)(
                            baseUrl,
                            global_window__WEBPACK_IMPORTED_MODULE_1___default()
                    ...
                    baseUrl =
                        url_toolkit__WEBPACK_IMPORTED_MODULE_0___default().buildAbsoluteURL(
                            (global_window__WEBPACK_IMPORTED_MODULE_1___default()
                                .location &&
                                global_window__WEBPACK_IMPORTED_MODULE_1___default()
                                    .location.href) ||
                ...
                return url_toolkit__WEBPACK_IMPORTED_MODULE_0___default().buildAbsoluteURL(
                    baseUrl,
                    relativeUrl
                );
            };
                    ...
                    if (
                        ...
                        if (decodeResponseBody) {
                            if (window.TextDecoder) {
                                ...
                                try {
                                    cause = new TextDecoder(charset).decode(
                                        responseBody
                                    );
                                } catch (e) {}
                            } else {
                                cause = String.fromCharCode.apply(
                                    null,
            ...
            function _createXHR(options) {
                ...
                function errorFunc(evt) {
                    ...
                    if (!(evt instanceof Error)) {
                        evt = new Error(
                            "" + (evt || "Unknown XMLHttpRequest Error")
                        );
                    }
 ...
 */
                            ...
                            _visitNode(base.documentElement, function (node) {
                                if (
                                    ...
                                    if (nodeClassNames) {
                                        ...
                                        if (!matches) {
                                            var nodeClassNamesSet =
                                                toOrderedSet(nodeClassNames);
        ...
        /***/ 9323: /***/ function (
            ...
            var inheritsLoose = __webpack_require__(4578); // CONCATENATED MODULE: ./node_modules/@videojs/vhs-utils/es/stream.js
            /**
             * @file stream.js
             */
            ...
            var decode_b64_to_uint8_array = __webpack_require__(6722); // CONCATENATED MODULE: ./node_modules/m3u8-parser/dist/m3u8-parser.es.js
            ...
            var LineStream = /*#__PURE__*/ (function (_Stream) {
                ...
                _proto.push = function push(data) {
                    ...
                    for (
                        ...
                        this.trigger(
                            "data",
                            this.buffer.substring(0, nextNewline)
                        );
            ...
            var ParseStream = /*#__PURE__*/ (function (_Stream) {
                ...
                _proto.push = function push(line) {
                    ...
                    newLines.forEach(function (newLine) {
                        ...
                        match = /^#EXT-X-TARGETDURATION:?([0-9.]*)?/.exec(
                            newLine
                        );
                        ...
                        match = /^#EXT-X-MEDIA-SEQUENCE:?(\-?[0-9.]*)?/.exec(
                            newLine
                        );
                        ...
                        if (match) {
                            event = (0, esm_extends /* default */.Z)(
                                parseByterange(match[1]),
                                {
                                    type: "tag",
                                    tagType: "byterange",
                                }
                        ...
                        if (match) {
                            ...
                            if (match[1]) {
                                ...
                                if (attributes.BYTERANGE) {
                                    event.byterange = parseByterange(
                        ...
                        if (match) {
                            ...
                            if (match[1]) {
                                ...
                                if (event.attributes.RESOLUTION) {
                                    var split =
                                        event.attributes.RESOLUTION.split("x");
                                    var resolution = {};
                        ...
                        match = /^#EXT-X-PROGRAM-DATE-TIME:?(.*)$/.exec(
                            newLine
                        );
                        ...
                        if (match) {
                            ...
                            if (match[1]) {
                                ...
                                if (event.attributes.IV) {
                                    if (
                                        event.attributes.IV.substring(
                                            0,
                                            2
                                        ).toLowerCase() === "0x"
                                    ) {
                                        event.attributes.IV =
                                            event.attributes.IV.substring(2);
                                    }

                                    event.attributes.IV =
                                        event.attributes.IV.match(/.{8}/g);
                                    event.attributes.IV[0] = parseInt(
                                        event.attributes.IV[0],
                                        16
                                    );
                                    event.attributes.IV[1] = parseInt(
                                        event.attributes.IV[1],
                                        16
                                    );
                                    event.attributes.IV[2] = parseInt(
                                        event.attributes.IV[2],
                                        16
                                    );
                                    event.attributes.IV[3] = parseInt(
                                        event.attributes.IV[3],
                                        16
                                    );
                                    event.attributes.IV = new Uint32Array(
                                        event.attributes.IV
                                    );
                                }
                            }
                        ...
                        if (match) {
                            ...
                            if (match[1]) {
                                ...
                                event.attributes.PRECISE = /YES/.test(
                                    event.attributes.PRECISE
                                );
                            }
                        ...
                        if (match && match[1]) {
                            ...
                            if (
                                event.attributes.hasOwnProperty(
                                    "SKIPPED-SEGMENTS"
                                )
                            ) {
                        ...
                        if (match && match[1]) {
                            ...
                            ["DURATION"].forEach(function (key) {
                                if (event.attributes.hasOwnProperty(key)) {
                                    event.attributes[key] = parseFloat(
                        ...
                        if (match && match[1]) {
                            ...
                            ["BYTERANGE-START", "BYTERANGE-LENGTH"].forEach(
                                function (key) {
                                    if (event.attributes.hasOwnProperty(key)) {
                                        event.attributes[key] = parseInt(
                                            event.attributes[key],
                                            10
                                        );
                                        var subkey =
                                            key === "BYTERANGE-LENGTH"
                                                ? "length"
                                                : "offset";
                                        event.attributes.byterange =
                                            event.attributes.byterange || {};
                                        event.attributes.byterange[subkey] =
                                            event.attributes[key]; // only keep the parsed byterange object.
            ...
            var setHoldBack = function setHoldBack(manifest) {
                ...
                var minPartDuration =
                    partTargetDuration && partTargetDuration * 2;
            ...
            var Parser = /*#__PURE__*/ (function (_Stream) {
                ...
                function Parser() {
                    ...
                    var self = (0, assertThisInitialized /* default */.Z)(
                        _this
                    );
                    ...
                    var widevineUuid =
                        "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed"; // group segments into numbered timelines delineated by discontinuities
                    ...
                    _this.on("end", function () {
                        ...
                        if (
                            currentUri.uri ||
                            (!currentUri.parts && !currentUri.preloadHints)
                        ) {
                            return;
                        }
                        ...
                        ({
                                ...
                                ((
                                    {
                                        ...
                                        inf: function inf() {
                                            if (
                                                ...
                                                this.trigger("info", {
                                                    message:
                                                        "defaulting media sequence to zero",
                                                });
                                            }
                                        ...
                                        key: function key() {
                                            ...
                                            if (
                                                ...
                                                if (
                                                    entry.attributes.URI.substring(
                                                        0,
                                                        23
                                                    ) !==
                                                ...
                                                if (
                                                    !(
                                                        entry.attributes
                                                            .KEYID &&
                                                        entry.attributes.KEYID.substring(
                                                            0,
                                                            2
                                                        ) === "0x"
                                                    )
                                                ...
                                                this.manifest.contentProtection[
                                                    ...
                                                    attributes: {
                                                        ...
                                                        keyId: entry.attributes.KEYID.substring(
                                                            2
                                                        ),
                                                    },
                                                    // decode the base64-encoded PSSH box
                                                    pssh: (0,
                                                    decode_b64_to_uint8_array /* default */.Z)(
                                                        entry.attributes.URI.split(
                                                            ","
                                                        )[1]
                                                    ),
                                                };
                                        ...
                                        "discontinuity-sequence":
                                            function discontinuitySequence() {
                                                if (!isFinite(entry.number)) {
                                                    this.trigger("warn", {
                                                        message:
                                        ...
                                        media: function media() {
                                            ...
                                            if (
                                                entry.attributes["INSTREAM-ID"]
                                            ) {
                                                rendition.instreamId =
                                                    entry.attributes[
                                                        "INSTREAM-ID"
                                                    ];
                                            }
                                            ...
                                            if (
                                                entry.attributes.CHARACTERISTICS
                                            ) {
                                            ...
                                            if (entry.attributes.FORCED) {
                                                rendition.forced = /yes/i.test(
                                                    entry.attributes.FORCED
                                                );
                                            } // insert the new rendition

                                            mediaGroup[entry.attributes.NAME] =
                                                rendition;
                                        },
                                        discontinuity:
                                            ...
                                            function programDateTime() {
                                                if (
                                                    ...
                                                    this.manifest.dateTimeObject =
                                                        entry.dateTimeObject;
                                                }

                                                currentUri.dateTimeString =
                                                    entry.dateTimeString;
                                                currentUri.dateTimeObject =
                                                    entry.dateTimeObject;
                                            },
                                        targetduration:
                                        ...
                                        skip: function skip() {
                                            this.manifest.skip = camelCaseKeys(
                                                entry.attributes
                                            );
                                        ...
                                        part: function part() {
                                            ...
                                            if (part.byterange) {
                                                if (
                                                    !part.byterange.hasOwnProperty(
                                                        "offset"
                                                    )
                                                ) {
                                                    part.byterange.offset =
                                                        lastPartByterangeEnd;
                                                }

                                                lastPartByterangeEnd =
                                                    part.byterange.offset +
                                                    part.byterange.length;
                                            }

                                            var partIndex =
                                                currentUri.parts.length - 1;
                                            this.warnOnMissingAttributes_(
                                                "#EXT-X-PART #" +
                                                    partIndex +
                                                    " for segment #" +
                                        ...
                                        "preload-hint": function preloadHint() {
                                            ...
                                            var segmentIndex =
                                                this.manifest.segments.length;
                                            var hint = camelCaseKeys(
                                                entry.attributes
                                            );
                                            var isPart =
                                                hint.type &&
                                                hint.type === "PART";
                                            currentUri.preloadHints =
                                                currentUri.preloadHints || [];
                                            currentUri.preloadHints.push(hint);

                                            if (hint.byterange) {
                                                if (
                                                    !hint.byterange.hasOwnProperty(
                                                        "offset"
                                                    )
                                                ) {
                                                    // use last part byterange end or zero if not a part.
                                                    hint.byterange.offset =
                                                        isPart
                                                            ? lastPartByterangeEnd
                                                            : 0;
                                            ...
                                            var index =
                                                currentUri.preloadHints.length -
                                                1;
                                            this.warnOnMissingAttributes_(
                                                "#EXT-X-PRELOAD-HINT #" +
                                                    index +
                                        ...
                                        "rendition-report":
                                            function renditionReport() {
                                                var report = camelCaseKeys(
                                                    entry.attributes
                                                );
                                                this.manifest.renditionReports =
                                                    this.manifest
                                                        .renditionReports || [];
                                                this.manifest.renditionReports.push(
                                                    report
                                                );
                                                var index =
                                                    this.manifest
                                        ...
                                        "part-inf": function partInf() {
                                            this.manifest.partInf =
                                                camelCaseKeys(entry.attributes);
                                            this.warnOnMissingAttributes_(
                                                "#EXT-X-PART-INF",
                                                entry.attributes,
                                                ["PART-TARGET"]
                            ...
                            custom: function custom() {
                                ...
                                if (entry.segment) {
                                    ...
                                    currentUri.custom[entry.customType] =
                                        entry.data; // if this is manifest-level data attach to the top level manifest object
                                } else {
                                    this.manifest.custom =
                                        this.manifest.custom || {};
                ...
                _proto.warnOnMissingAttributes_ =
                    function warnOnMissingAttributes_(
                        identifier,
                        attributes,
                        required
                    ) {
        ...
        /***/ 973: /***/ function (
            ...
            /* harmony import */ var _videojs_vhs_utils_es_resolve_url__WEBPACK_IMPORTED_MODULE_0__ =
            ...
            /* harmony import */ var _videojs_vhs_utils_es_decode_b64_to_uint8_array__WEBPACK_IMPORTED_MODULE_2__ =
                __webpack_require__(6722);
            /* harmony import */ var _xmldom_xmldom__WEBPACK_IMPORTED_MODULE_3__ =
            ...
            var urlTypeToSegment = function urlTypeToSegment(_ref) {
                var _ref$baseUrl = _ref.baseUrl,
                    ...
                    indexRange =
                        _ref$indexRange === void 0 ? "" : _ref$indexRange;
                var segment = {
                    uri: source,
                    resolvedUri: (0,
                    _videojs_vhs_utils_es_resolve_url__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(
                        baseUrl || "",
                        source
                    ),
                };
            ...
            var segmentRange = {
                ...
                static: function _static(attributes) {
                    var duration = attributes.duration,
                        ...
                        timescale =
                            _attributes$timescale === void 0
                                ? 1
                                : _attributes$timescale,
                ...
                dynamic: function dynamic(attributes) {
                    var NOW = attributes.NOW,
                        ...
                        timescale =
                            _attributes$timescale2 === void 0
                                ? 1
                                : _attributes$timescale2,
                        duration = attributes.duration,
                        _attributes$start = attributes.start,
                        start =
                            _attributes$start === void 0
                                ? 0
                                : _attributes$start,
                        _attributes$minimumUp = attributes.minimumUpdatePeriod,
                        minimumUpdatePeriod =
                            _attributes$minimumUp === void 0
                                ? 0
                                : _attributes$minimumUp,
                        _attributes$timeShift = attributes.timeShiftBufferDepth,
                        timeShiftBufferDepth =
                            _attributes$timeShift === void 0
                                ? Infinity
                                : _attributes$timeShift;
                    var endNumber = parseEndNumber(attributes.endNumber);
                    var now = (NOW + clientOffset) / 1000;
                    var periodStartWC = availabilityStartTime + start;
                    var periodEndWC = now + minimumUpdatePeriod;
                    var periodDuration = periodEndWC - periodStartWC;
                    var segmentCount = Math.ceil(
                        (periodDuration * timescale) / duration
                    );
                    var availableStart = Math.floor(
                        ((now - periodStartWC - timeShiftBufferDepth) *
                            timescale) /
                            duration
                    );
            ...
            var toSegments = function toSegments(attributes) {
                return function (number, index) {
                    var duration = attributes.duration,
                        ...
                        timescale =
                            _attributes$timescale3 === void 0
                                ? 1
                                : _attributes$timescale3,
                        periodIndex = attributes.periodIndex,
                        _attributes$startNumb = attributes.startNumber,
                        startNumber =
                            _attributes$startNumb === void 0
                                ? 1
                                : _attributes$startNumb;
                    return {
            ...
            var parseByDuration = function parseByDuration(attributes) {
                var type = attributes.type,
                    ...
                    timescale =
                        _attributes$timescale4 === void 0
                            ? 1
                            : _attributes$timescale4,
                    periodDuration = attributes.periodDuration,
                    sourceDuration = attributes.sourceDuration;
                ...
                if (type === "static") {
                    ...
                    var sectionDuration =
                        typeof periodDuration === "number"
                            ? periodDuration
                            : sourceDuration; // final segment may be less than full segment duration

                    segments[index].duration =
                        sectionDuration - (duration / timescale) * index;
                }
            ...
            var segmentsFromBase = function segmentsFromBase(attributes) {
                var baseUrl = attributes.baseUrl,
                    ...
                    indexRange =
                        _attributes$indexRang === void 0
                            ? ""
                            : _attributes$indexRang,
            ...
            var generateSidxKey = function generateSidxKey(sidx) {
                return (
                    sidx && sidx.uri + "-" + byteRangeToString(sidx.byterange)
                );
            };

            var mergeDiscontiguousPlaylists =
                function mergeDiscontiguousPlaylists(playlists) {
                    var mergedPlaylists = values(
                        playlists.reduce(function (acc, playlist) {
                            ...
                            var name =
                                ...
                                (playlist.attributes.lang || ""); // Periods after first
            ...
            var addSidxSegmentsToPlaylist$1 =
                function addSidxSegmentsToPlaylist$1(playlist, sidxMapping) {
            ...
            var addSidxSegmentsToPlaylists =
                function addSidxSegmentsToPlaylists(playlists, sidxMapping) {
                    ...
                    for (var i in playlists) {
                        playlists[i] = addSidxSegmentsToPlaylist$1(
                            playlists[i],
                            sidxMapping
                        );
                    }
            ...
            var formatAudioPlaylist = function formatAudioPlaylist(
                _ref,
                isAudioOnly
            ) {
                var _attributes;
            ...
            var organizeAudioPlaylists = function organizeAudioPlaylists(
                ...
                var mainPlaylist;
                var formattedPlaylists = playlists.reduce(function (
                    a,
                    playlist
                ) {
                    var role =
                        (playlist.attributes.role &&
            ...
            var vttOnly = function vttOnly(_ref6) {
                ...
                return (
                    attributes.mimeType === "text/vtt" ||
                    attributes.contentType === "text"
                );
            };

            var toM3u8 = function toM3u8(
                dashPlaylists,
                locations,
                sidxMapping
            ) {
                ...
                var _dashPlaylists$0$attr = dashPlaylists[0].attributes,
                    ...
                    minimumUpdatePeriod =
                        _dashPlaylists$0$attr.minimumUpdatePeriod;
                ...
                var manifest = {
                    ...
                    uri: "",
                    duration: duration,
                    playlists: addSidxSegmentsToPlaylists(
                        videoPlaylists,
                        sidxMapping
                    ),
                };
                ...
                if (audioPlaylists.length) {
                    manifest.mediaGroups.AUDIO.audio = organizeAudioPlaylists(
                        audioPlaylists,
                        sidxMapping,
                        isAudioOnly
                    );
                ...
                if (vttPlaylists.length) {
                    manifest.mediaGroups.SUBTITLES.subs = organizeVttPlaylists(
                        vttPlaylists,
                        sidxMapping
                    );
                }
             ...
             */
            var getLiveRValue = function getLiveRValue(
                attributes,
                time,
                duration
            ) {
                var NOW = attributes.NOW,
                    ...
                    _attributes$start = attributes.start,
                    start =
                        _attributes$start === void 0 ? 0 : _attributes$start,
                    _attributes$minimumUp = attributes.minimumUpdatePeriod,
                    minimumUpdatePeriod =
                        _attributes$minimumUp === void 0
                            ? 0
                ...
                var periodDuration = periodEndWC - periodStartWC;
                return Math.ceil(
                    (periodDuration * timescale - time) / duration
                );
            };
            /**
            ...
            var parseByTimeline = function parseByTimeline(
                attributes,
                segmentTimeline
            ) {
                var type = attributes.type,
                    ...
                    minimumUpdatePeriod =
                        _attributes$minimumUp2 === void 0
                            ? 0
                            : _attributes$minimumUp2,
                    _attributes$media = attributes.media,
                    media =
                        _attributes$media === void 0 ? "" : _attributes$media,
                    sourceDuration = attributes.sourceDuration,
                    _attributes$timescale2 = attributes.timescale,
                    timescale =
                        _attributes$timescale2 === void 0
                    ...
                    if (repeat < 0) {
                        ...
                        if (nextS === segmentTimeline.length) {
                            ...
                            if (
                                ...
                                count =
                                    (sourceDuration * timescale - time) /
                                    duration;
                            }
                        } else {
                            count =
                                (segmentTimeline[nextS].t - time) / duration;
                        }
                    } else {
                        count = repeat + 1;
                    }
            ...
            var identifierReplacement = function identifierReplacement(values) {
                return function (match, identifier, format, width) {
                    ...
                    return (
                        "" +
                        new Array(width - value.length + 1).join("0") +
                        value
                    );
                };
            };
            ...
            var constructTemplateUrl = function constructTemplateUrl(
                url,
                values
            ) {
                return url.replace(
                    identifierPattern,
                    identifierReplacement(values)
                );
            };
            /**
            ...
            var segmentsFromTemplate = function segmentsFromTemplate(
                ...
                return segments.map(function (segment) {
                    ...
                    var presentationTimeOffset =
                        attributes.presentationTimeOffset || 0;
            ...
            var segmentsFromList = function segmentsFromList(
                ...
                var duration = attributes.duration,
                    ...
                    segmentUrls =
                        _attributes$segmentUr === void 0
                            ? []
                            : _attributes$segmentUr,
                ...
                var segmentUrlMap = segmentUrls.map(function (
                    segmentUrlObject
                ) {
                    return SegmentURLToSegmentObject(
                        attributes,
                        segmentUrlObject
                    );
                });
                ...
                if (segmentTimeline) {
                    segmentTimeInfo = parseByTimeline(
                        attributes,
                        segmentTimeline
                    );
                }
                    ...
                    .map(function (segmentTime, index) {
                        if (segmentUrlMap[index]) {
                            ...
                            segment.presentationTime =
                                periodStart +
                                (segmentTime.time - presentationTimeOffset) /
                                    timescale;
                            return segment;
            ...
            var generateSegments = function generateSegments(_ref) {
                ...
                if (segmentAttributes.duration) {
                    var _segmentAttributes = segmentAttributes,
                        ...
                        timescale =
                            _segmentAttributes$ti === void 0
                                ? 1
                                : _segmentAttributes$ti;
                    segmentAttributes.duration = duration / timescale;
                } else if (segments.length) {
                    // if there is no @duration attribute, use the largest segment duration as
                    // as target duration
                    segmentAttributes.duration = segments.reduce(function (
                        max,
                        segment
                    ) {
            ...
            var parsers = {
                 ...
                 */
                mediaPresentationDuration: function mediaPresentationDuration(
                    value
                ) {
                 ...
                 *         The duration in seconds
                 */
                suggestedPresentationDelay: function suggestedPresentationDelay(
                    value
                ) {
                    return parseDuration(value);
                },
            ...
            var buildBaseUrls = function buildBaseUrls(
                referenceUrls,
                baseUrlElements
            ) {
                ...
                return flatten(
                    referenceUrls.map(function (reference) {
                        return baseUrlElements.map(function (baseUrlElement) {
                            return (0,
                            _videojs_vhs_utils_es_resolve_url__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(reference, getContent(baseUrlElement));
                        });
                    })
                );
            };
            ...
            var getSegmentInformation = function getSegmentInformation(
                adaptationSet
            ) {
                var segmentTemplate = findChildren(
                    adaptationSet,
                    "SegmentTemplate"
                )[0];
                ...
                var segmentInitialization =
                    ...
                    findChildren(
                        segmentInitializationParentNode,
                        "Initialization"
                    )[0]; // SegmentTemplate is handled slightly differently, since it can have both
                ...
                var template =
                    segmentTemplate && parseAttributes(segmentTemplate);

                if (template && segmentInitialization) {
                    template.initialization =
                        segmentInitialization &&
                        parseAttributes(segmentInitialization);
                ...
                var segmentInfo = {
                    ...
                    list:
                        ...
                        merge(parseAttributes(segmentList), {
                            ...
                            initialization: parseAttributes(
                                segmentInitialization
                            ),
                        }),
                    base:
            ...
            var inheritBaseUrls = function inheritBaseUrls(
                ...
                return function (representation) {
                    var repBaseUrlElements = findChildren(
                        representation,
                        "BaseURL"
                    );
                    ...
                    var representationSegmentInfo =
                        getSegmentInformation(representation);
            ...
            var generateKeySystemInformation =
                function generateKeySystemInformation(contentProtectionNodes) {
                        ...
                        if (keySystem) {
                            ...
                            if (psshNode) {
                                ...
                                var psshBuffer =
                                    pssh &&
                                    (0,
                                    _videojs_vhs_utils_es_decode_b64_to_uint8_array__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(
                                        pssh
                                    );
            ...
            var parseCaptionServiceMetadata =
                function parseCaptionServiceMetadata(service) {
                    // 608 captions
                    if (
                        service.schemeIdUri === "urn:scte:dash:cc:cea-608:2015"
                    ) {
                        var values =
                        ...
                        service.schemeIdUri === "urn:scte:dash:cc:cea-708:2015"
                    ) {
                        var _values =
                            typeof service.value !== "string"
                                ? []
            ...
            var toRepresentations = function toRepresentations(
                ...
                return function (adaptationSet) {
                    ...
                    var accessibility = findChildren(
                        adaptationSet,
                        "Accessibility"
                    )[0];
                    ...
                    var representations = findChildren(
                        adaptationSet,
                        "Representation"
                    );
                    var adaptationSetSegmentInfo = merge(
                        periodSegmentInfo,
                        segmentInfo
                    );
                    return flatten(
            ...
            var toAdaptationSets = function toAdaptationSets(
                mpdAttributes,
                mpdBaseUrls
            ) {
                return function (period, index) {
                    ...
                    var periodIndex =
                        global_window__WEBPACK_IMPORTED_MODULE_1___default().isNaN(
                            parsedPeriodId
                        )
                            ? index
                            : parsedPeriodId;
                    ...
                    if (typeof period.attributes.duration === "number") {
                        periodAttributes.periodDuration =
                            period.attributes.duration;
                    }

                    var adaptationSets = findChildren(
                        period.node,
                        "AdaptationSet"
                    );
            ...
            var getPeriodStart = function getPeriodStart(_ref) {
                ...
                if (
                    ...
                    return (
                        priorPeriodAttributes.start +
                        priorPeriodAttributes.duration
                    );
                } // (3)
            ...
            var inheritAttributes = function inheritAttributes(mpd, options) {
                ...
                var _options = options,
                    ...
                    clientOffset =
                        _options$clientOffset === void 0
                            ? 0
                            : _options$clientOffset;
                ...
                mpdAttributes.sourceDuration =
                    mpdAttributes.mediaPresentationDuration || 0;
                ...
                periodNodes.forEach(function (node, index) {
                    ...
                    attributes.start = getPeriodStart({
                        attributes: attributes,
                        priorPeriodAttributes: priorPeriod
                            ? priorPeriod.attributes
                            : null,
                ...
                return {
                    ...
                    representationInfo: flatten(
                        periods.map(
                            toAdaptationSets(mpdAttributes, mpdBaseUrls)
                        )
                    ),
                };
            };
            ...
            var stringToMpdXml = function stringToMpdXml(manifestString) {
                ...
                var parser =
                    new _xmldom_xmldom__WEBPACK_IMPORTED_MODULE_3__.DOMParser();
                var xml;
                var mpd;
                ...
                try {
                    ...
                    mpd =
                        xml && xml.documentElement.tagName === "MPD"
                            ? xml.documentElement
                            : null;
                } catch (e) {
                ...
                if (
                    !mpd ||
                    (mpd && mpd.getElementsByTagName("parsererror").length > 0)
                ) {
            ...
            var parse = function parse(manifestString, options) {
                ...
                var playlists = toPlaylists(
                    parsedManifestInfo.representationInfo
                );
                return toM3u8(
                    playlists,
                    parsedManifestInfo.locations,
                    options.sidxMapping
                );
            };
            /**
        ...
        /***/ 4816: /***/ function (
            ...
            var Home_module_default =
                /*#__PURE__*/ __webpack_require__.n(Home_module);
            ...
            var video_js = __webpack_require__(3512); // CONCATENATED MODULE: ./components/VideoJS.js
                ...
                react.useEffect(
                    function () {
                        ...
                        if (!playerRef.current) {
                            ...
                            var player = (playerRef.current = (0,
                            video_es /* default */.Z)(
                                videoElement,
                                options,
                                function () {
            ...
            /* harmony default export */ var components_VideoJS = VideoJS; // CONCATENATED MODULE: ./pages/index.js
            ...
            (function (root) {
                ...
                var URLToolkit = {
                        ...
                        if (!relativeParts.netLoc) {
                            ...
                            if (relativeParts.path[0] !== "/") {
                                if (!relativeParts.path) {
                                    ...
                                    builtParts.path =
                                        URLToolkit.normalizePath(newPath);
                                }
                            }
                        }
                    ...
                    normalizePath: function (path) {
                        ...
                        while (
                            path.length !==
                            (path = path.replace(SLASH_DOT_DOT_REGEX, ""))
                                .length
                        ) {}
        ...
        /***/ 3706: /***/ function (
            ...
            BoxPosition.prototype.intersectPercentage = function (b2) {
                var x = Math.max(
                        0,
                        Math.min(this.right, b2.right) -
                            Math.max(this.left, b2.left)
                    ),
                    y = Math.max(
                        0,
                        Math.min(this.bottom, b2.bottom) -
                            Math.max(this.top, b2.top)
                    ),
                    intersectArea = x * y;
                ...
                function findBestPosition(b, axis) {
                    ...
                    for (var i = 0; i < axis.length; i++) {
                        while (
                            ...
                            (b.within(containerBox) &&
                                b.overlapsAny(boxPositions))
                        ) {
                            b.move(axis[i]);
                        }
            ...
            WebVTT.processCues = function (window, cues, overlay) {
                ...
                var boxPositions = [],
                    containerBox =
                        BoxPosition.getSimpleBoxPosition(paddedOverlay),
                    fontSize =
                        Math.round(
                            containerBox.height * FONT_SIZE_PERCENT * 100
                        ) / 100;
                var styleOptions = {
                ...
                (function () {
                    ...
                    for (var i = 0; i < cues.length; i++) {
                        ...
                        boxPositions.push(
                            BoxPosition.getSimpleBoxPosition(styleBox)
                        );
                    }
                })();
            };
                ...
                parse: function (data) {
                    ...
                    function parseRegion(input) {
                        ...
                        if (settings.has("id")) {
                            ...
                            region.regionAnchorX = settings.get(
                                "regionanchorX",
                                0
                            );
                            region.regionAnchorY = settings.get(
                                "regionanchorY",
                                100
                            );
                            region.viewportAnchorX = settings.get(
                                "viewportanchorX",
                                0
                            );
                    ...
                    try {
                        ...
                        if (self.state === "INITIAL") {
                            ...
                            if (!m || !m[0]) {
                                throw new ParsingError(
                                    ParsingError.Errors.BadSignature
                                );
                            }
        ...
        /***/ 136: /***/ function (
            ...
            function _inherits(subClass, superClass) {
                ...
                if (superClass)
                    (0,
                    _setPrototypeOf_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(
                        subClass,
                        superClass
                    );
            }
    ...
    /******/ function (__webpack_require__) {
        ...
        /******/ __webpack_require__.O(0, [544, 774, 888, 179], function () {
