    ...
    ],
    {
        ...
        562: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var bytesToNumber = function(bytes, _temp) {
                ...
                "string" != typeof string && string && "function" == typeof string.toString && (string = string.toString());
                if ("string" != typeof string) return new Uint8Array();
        ...
        6185: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            DESCRIPTORS = [
                {
                    ...
                    parser: function(bytes) {
                        ...
                        if (0x40 & desc.flags) {
                            ...
                            desc.url = (0, byte_helpers.d3)(bytes.subarray(desc.size + 1, desc.size + 1 + len));
                            desc.size += len;
                        }
                        if (0x20 & desc.flags) {
                        ...
                        return desc.descriptors = parseDescriptors(bytes.subarray(desc.size)) || [], desc;
                    }
                },
                {
                    id: 0x04,
            ...
            var findBox = function findBox(bytes, paths, complete) {
                ...
                for(var i = 0; i < bytes.length;){
                    ...
                    (0, byte_helpers.G3)(type, paths[0]) && (1 === paths.length ? results.push(data) : results.push.apply(results, findBox(data, paths.slice(1), complete)));
                    i = end;
                }
                return results;
            }, EBML_TAGS = {
                ...
                void 0 === removeLength && (removeLength = !0);
                void 0 === signed && (signed = !1);
                ...
                for(var i = 0; i < bytes.length;){
                    ...
                    if (0x7f === dataHeader.value) {
                        dataHeader.value = getInfinityDataSize(id, bytes, dataStart);
                        dataHeader.value !== bytes.length && (dataHeader.value -= dataStart);
                    }
                    ...
                    i += id.length + dataHeader.length + data.length;
                }
                return results;
                ...
                for(var positions = [], i = 1; i < bytes.length - 2;){
                    if ((0, byte_helpers.G3)(bytes.subarray(i, i + 3), EMULATION_PREVENTION)) {
                        positions.push(i + 2);
                        i++;
                    }
                    i++;
                ...
                void 0 === nalLimit && (nalLimit = 1 / 0);
                bytes = (0, byte_helpers.Ki)(bytes);
                types = [].concat(types);
                for(var nalStart, i = 0, nalsFound = 0; i < bytes.length && (nalsFound < nalLimit || nalStart);){
                    var nalOffset = void 0;
                    (0, byte_helpers.G3)(bytes.subarray(i), NAL_TYPE_ONE) ? nalOffset = 4 : (0, byte_helpers.G3)(bytes.subarray(i), NAL_TYPE_TWO) && (nalOffset = 3);
                    if (!nalOffset) {
                        i++;
                        continue;
                    }
                    ...
                    var nalType = void 0;
                    "h264" === dataType ? nalType = 0x1f & bytes[i + nalOffset] : "h265" === dataType && (nalType = bytes[i + nalOffset] >> 1 & 0x3f);
                    -1 !== types.indexOf(nalType) && (nalStart = i + nalOffset);
                    i += nalOffset + ("h264" === dataType ? 1 : 2);
                }
        ...
        9603: function(module, __unused_webpack_exports, __webpack_require__) {
            ...
            createXHR.XMLHttpRequest = window1.XMLHttpRequest || function() {};
            createXHR.XDomainRequest = "withCredentials" in new createXHR.XMLHttpRequest() ? createXHR.XMLHttpRequest : window1.XDomainRequest;
            ...
            function initParams(uri, options, callback) {
                ...
                if (isFunction(options)) {
                    callback = options;
                    "string" == typeof uri && (params = {
                        uri: uri
                    });
                } else params = _extends({}, options, {
                    uri: uri
                });
                return params.callback = callback, params;
            }
            ...
            function _createXHR(options) {
                ...
                function loadFunc() {
                    if (!aborted) {
                        ...
                        status = options.useXDR && void 0 === xhr.status ? 200 : 1223 === xhr.status ? 204 : xhr.status;
                        var status, response = failureResponse, err = null;
                        if (0 !== status) {
                            response = {
                                body: function() {
                                    var body = void 0;
                                    body = xhr.response ? xhr.response : xhr.responseText || function(xhr) {
                                        try {
                            ...
                            xhr.getAllResponseHeaders && (response.headers = parseHeaders(xhr.getAllResponseHeaders()));
                        } else err = Error("Internal XMLHttpRequest Error");
                ...
                if ("json" in options && !1 !== options.json) {
                    isJson = !0;
                    headers.accept || headers.Accept || (headers.Accept = "application/json");
                    if ("GET" !== method && "HEAD" !== method) {
                        headers["content-type"] || headers["Content-Type"] || (headers["Content-Type"] = "application/json");
                        body = JSON.stringify(!0 === options.json ? body : options.json);
                    }
                }
                ...
                sync || (xhr.withCredentials = !!options.withCredentials);
                !sync && options.timeout > 0 && (timeoutTimer = setTimeout(function() {
                    if (!aborted) {
                        aborted = !0;
                        xhr.abort("timeout");
                ...
                if (xhr.setRequestHeader) for(key in headers)headers.hasOwnProperty(key) && xhr.setRequestHeader(key, headers[key]);
        ...
        6129: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            DOMParser.prototype.parseFromString = function(source, mimeType) {
                ...
                return locator && domBuilder.setDocumentLocator(locator), sax.errorHandler = function(errorImpl, domBuilder, locator) {
                    ...
                    return build("warning"), build("error"), build("fatalError"), errorHandler;
        ...
        1146: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function _addNamedNode(el, list, newAttr, oldAttr) {
                ...
                if (el) {
                    ...
                    if (doc1) {
                        oldAttr && _onRemoveAttribute(doc1, el, oldAttr);
                        doc = doc1, el1 = el, newAttr1 = newAttr, doc && doc._inc++, newAttr1.namespaceURI === NAMESPACE.XMLNS && (el1._nsMap[newAttr1.prefix ? newAttr1.localName : ""] = newAttr1.value);
                    }
                }
            }
            ...
            Node.prototype = {
                ...
                cloneNode: function(deep) {
                    return function cloneNode(doc, node, deep) {
                        ...
                        if (deep) for(var child = node.firstChild; child;){
            ...
            function _onRemoveAttribute(doc, el, newAttr, remove) {
                doc && doc._inc++;
                newAttr.namespaceURI === NAMESPACE.XMLNS && delete el._nsMap[newAttr.prefix ? newAttr.localName : ""];
            }
            function _onUpdateChild(doc, el, newChild) {
                if (doc && doc._inc) {
                    ...
                    if (newChild) cs[cs.length++] = newChild;
                        ...
                        for(var child = el.firstChild, i = 0; child;){
                            cs[i++] = child;
                            child = child.nextSibling;
                        }
                        cs.length = i;
                ...
                switch(node.nodeType){
                    case ELEMENT_NODE:
                        ...
                        if (child || isHTML && !/^(?:meta|link|img|br|hr|input)$/i.test(nodeName)) {
                            buf.push(">");
                            if (isHTML && /^script$/i.test(nodeName)) for(; child;){
        ...
        6925: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            XMLReader.prototype = {
                parse: function(source, defaultNSMap, entityMap) {
                    ...
                    !function(source, defaultNSMapCopy, entityMap, domBuilder, errorHandler) {
                        ...
                        function position(p, m) {
                            for(; p >= lineEnd && (m = linePattern.exec(source));){
                                lineEnd = (lineStart = m.index) + m[0].length;
                                locator.lineNumber++;
                            }
                    ...
                    }(source, defaultNSMap, entityMap, domBuilder, this.errorHandler);
                ...
                for(var attrName, value, p = ++start, s = 0;;){
                    ...
                    switch(c){
                        ...
                        case "":
                            ...
                            0 == s && el.setTagName(source.slice(start, p));
                            return p;
                        case ">":
                            switch(s){
                                case 0:
                                ...
                                case 4:
                                case 1:
                                    if ("/" === (value = source.slice(start, p)).slice(-1)) {
                                        el.closed = !0;
            ...
            function appendElement(el, domBuilder, currentNSMap) {
                ...
                if (!el.closed) return el.currentNSMap = currentNSMap, el.localNSMap = localNSMap, !0;
            ...
            function fixSelfClosed(source, elStartEnd, tagName, closeMap) {
                ...
                if (null == pos) {
                    (pos = source.lastIndexOf("</" + tagName + ">")) < elStartEnd && (pos = source.lastIndexOf("</" + tagName));
        ...
        8908: function(module, __unused_webpack_exports, __webpack_require__) {
            var win;
            win = "undefined" != typeof window ? window : void 0 !== __webpack_require__.g ? __webpack_require__.g : "undefined" != typeof self ? self : {};
            module.exports = win;
        },
        ...
        9323: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var inheritsLoose = __webpack_require__(4578), Stream = function() {
                ...
                (0, inheritsLoose.Z)(LineStream, _Stream);
                function LineStream() {
                    var _this;
                    return (_this = _Stream.call(this) || this).buffer = "", _this;
                }
                return LineStream.prototype.push = function(data) {
                    var nextNewline;
                    this.buffer += data;
                ...
                for(var attr, attrs = attributes.split(RegExp('(?:^|,)((?:[^=]*)=(?:"[^"]*"|[^,]*))')), result = {}, i = attrs.length; i--;)if ("" !== attrs[i]) {
                    (attr = /([^=]*)=(.*)/.exec(attrs[i]).slice(1))[0] = attr[0].replace(/^\s+|\s+$/g, "");
                    ...
                    if (0 !== (line = line.trim()).length) {
                        ...
                        this.tagMappers.reduce(function(acc, mapper) {
                            ...
                            if (match = /^#EXTINF:?([0-9\.]*)?,?(.*)?$/.exec(newLine)) {
                                ...
                                match[1] && (event.duration = parseFloat(match[1]));
                                match[2] && (event.title = match[2]);
                            ...
                            if (match = /^#EXT-X-TARGETDURATION:?([0-9.]*)?/.exec(newLine)) {
                                ...
                                match[1] && (event.duration = parseInt(match[1], 10));
                                _this2.trigger("data", event);
                                return;
                            }
                            if (match = /^#EXT-X-VERSION:?([0-9.]*)?/.exec(newLine)) {
                                ...
                                match[1] && (event.version = parseInt(match[1], 10));
                                _this2.trigger("data", event);
                                return;
                            }
                            if (match = /^#EXT-X-MEDIA-SEQUENCE:?(\-?[0-9.]*)?/.exec(newLine)) {
                                ...
                                match[1] && (event.number = parseInt(match[1], 10));
                                _this2.trigger("data", event);
                                return;
                            }
                            ...
                            if (match = /^#EXT-X-PLAYLIST-TYPE:?(.*)?$/.exec(newLine)) {
                                ...
                                match[1] && (event.playlistType = match[1]);
                                _this2.trigger("data", event);
                                return;
                            }
                            ...
                            if (match = /^#EXT-X-ALLOW-CACHE:?(YES|NO)?/.exec(newLine)) {
                                ...
                                match[1] && (event.allowed = !/NO/.test(match[1]));
                                _this2.trigger("data", event);
                                return;
                            }
                            if (match = /^#EXT-X-MAP:?(.*)$/.exec(newLine)) {
                                ...
                                if (match[1]) {
                                    ...
                                    attributes.URI && (event.uri = attributes.URI);
                                    attributes.BYTERANGE && (event.byterange = parseByterange(attributes.BYTERANGE));
                                }
                                _this2.trigger("data", event);
                                return;
                            }
                            if (match = /^#EXT-X-STREAM-INF:?(.*)$/.exec(newLine)) {
                                ...
                                if (match[1]) {
                                    ...
                                    if (event.attributes.RESOLUTION) {
                                        ...
                                        split[0] && (resolution.width = parseInt(split[0], 10));
                                        split[1] && (resolution.height = parseInt(split[1], 10));
                                        event.attributes.RESOLUTION = resolution;
                                    }
                                    event.attributes.BANDWIDTH && (event.attributes.BANDWIDTH = parseInt(event.attributes.BANDWIDTH, 10));
                                    event.attributes["PROGRAM-ID"] && (event.attributes["PROGRAM-ID"] = parseInt(event.attributes["PROGRAM-ID"], 10));
                                }
                                _this2.trigger("data", event);
                                return;
                            }
                            if (match = /^#EXT-X-MEDIA:?(.*)$/.exec(newLine)) {
                                ...
                                match[1] && (event.attributes = parseAttributes(match[1]));
                                _this2.trigger("data", event);
                                return;
                            }
                            ...
                            if (match = /^#EXT-X-KEY:?(.*)$/.exec(newLine)) {
                                ...
                                if (match[1]) {
                                    ...
                                    if (event.attributes.IV) {
                                        "0x" === event.attributes.IV.substring(0, 2).toLowerCase() && (event.attributes.IV = event.attributes.IV.substring(2));
                            ...
                            if (match = /^#EXT-X-CUE-OUT-CONT:?(.*)?$/.exec(newLine)) {
                                ...
                                match[1] ? event.data = match[1] : event.data = "";
                                _this2.trigger("data", event);
                                return;
                            }
                            ...
                            if ((match = /^#EXT-X-SKIP:(.*)$/.exec(newLine)) && match[1]) {
                                ...
                                event.attributes.hasOwnProperty("SKIPPED-SEGMENTS") && (event.attributes["SKIPPED-SEGMENTS"] = parseInt(event.attributes["SKIPPED-SEGMENTS"], 10));
                                event.attributes.hasOwnProperty("RECENTLY-REMOVED-DATERANGES") && (event.attributes["RECENTLY-REMOVED-DATERANGES"] = event.attributes["RECENTLY-REMOVED-DATERANGES"].split("	"));
                                _this2.trigger("data", event);
                                return;
                            }
                            if ((match = /^#EXT-X-PART:(.*)$/.exec(newLine)) && match[1]) {
                                ...
                                event.attributes.hasOwnProperty("BYTERANGE") && (event.attributes.byterange = parseByterange(event.attributes.BYTERANGE));
                                _this2.trigger("data", event);
                                return;
                            }
                ...
                if (serverControl) {
                    ...
                    if (partTargetDuration && !serverControl.hasOwnProperty(phb)) {
                        serverControl[phb] = 3 * partTargetDuration;
                        this.trigger("info", {
                ...
                function Parser() {
                    (_this = _Stream.call(this) || this).lineStream = new LineStream();
                    ...
                    return _this.on("end", function() {
                        if (!currentUri.uri && (currentUri.parts || currentUri.preloadHints)) {
                            !currentUri.map && currentMap && (currentUri.map = currentMap);
                            !currentUri.key && _key && (currentUri.key = _key);
                            currentUri.timeline || "number" != typeof currentTimeline || (currentUri.timeline = currentTimeline);
                        ...
                        ({
                                ...
                                (({
                                    ...
                                    byterange: function() {
                                        ...
                                        if ("length" in entry) {
                                            ...
                                            "offset" in entry || (entry.offset = lastByterangeEnd);
                                        }
                                        if ("offset" in entry) {
                                            currentUri.byterange = byterange;
                                    ...
                                    inf: function() {
                                        ...
                                        entry.duration > 0 && (currentUri.duration = entry.duration);
                                        if (0 === entry.duration) {
                                    ...
                                    key: function() {
                                        ...
                                        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed" === entry.attributes.KEYFORMAT) {
                                            ...
                                            if ("data:text/plain;base64," !== entry.attributes.URI.substring(0, 23)) {
                                                this.trigger("warn", {
                                    ...
                                    map: function() {
                                        currentMap = {};
                                        entry.uri && (currentMap.uri = entry.uri);
                                        entry.byterange && (currentMap.byterange = entry.byterange);
                                        _key && (currentMap.key = _key);
                                    },
                                    "stream-inf": function() {
                                        ...
                                        currentUri.attributes || (currentUri.attributes = {});
                                        (0, esm_extends.Z)(currentUri.attributes, entry.attributes);
                                    },
                                    media: function() {
                                        this.manifest.mediaGroups = this.manifest.mediaGroups || defaultMediaGroups;
                                        ...
                                        entry.attributes.LANGUAGE && (rendition.language = entry.attributes.LANGUAGE);
                                        entry.attributes.URI && (rendition.uri = entry.attributes.URI);
                                        entry.attributes["INSTREAM-ID"] && (rendition.instreamId = entry.attributes["INSTREAM-ID"]);
                                        entry.attributes.CHARACTERISTICS && (rendition.characteristics = entry.attributes.CHARACTERISTICS);
                                        entry.attributes.FORCED && (rendition.forced = /yes/i.test(entry.attributes.FORCED));
                                        mediaGroup[entry.attributes.NAME] = rendition;
                                    },
                                    discontinuity: function() {
                                        currentTimeline += 1;
                                        currentUri.discontinuity = !0;
                                        this.manifest.discontinuityStarts.push(uris.length);
                                    },
                                    "program-date-time": function() {
                                        if (void 0 === this.manifest.dateTimeString) {
                                    ...
                                    part: function() {
                                        ...
                                        if (part.byterange) {
                                            part.byterange.hasOwnProperty("offset") || (part.byterange.offset = lastPartByterangeEnd);
                                    ...
                                    "server-control": function() {
                                        ...
                                        if (!attrs.hasOwnProperty("canBlockReload")) {
                                            attrs.canBlockReload = !1;
                                            this.trigger("info", {
                                                message: "#EXT-X-SERVER-CONTROL defaulting CAN-BLOCK-RELOAD to false"
                                            });
                                        }
                                        setHoldBack.call(this, this.manifest);
                                        attrs.canSkipDateranges && !attrs.hasOwnProperty("canSkipUntil") && this.trigger("warn", {
                                    ...
                                    "preload-hint": function() {
                                        ...
                                        if (hint.byterange && !hint.byterange.hasOwnProperty("offset")) {
                                            hint.byterange.offset = isPart ? lastPartByterangeEnd : 0;
                                            isPart && (lastPartByterangeEnd = hint.byterange.offset + hint.byterange.length);
                                        }
                                        ...
                                        if (hint.type) for(var i = 0; i < currentUri.preloadHints.length - 1; i++){
                                    ...
                                    "rendition-report": function() {
                                        ...
                                        hasParts && required.push("LAST-PART");
                            ...
                            uri: function() {
                                ...
                                _key && (currentUri.key = _key);
                                currentUri.timeline = currentTimeline;
                                currentMap && (currentUri.map = currentMap);
        ...
        973: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var _videojs_vhs_utils_es_resolve_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(779), global_window__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8908), global_window__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(global_window__WEBPACK_IMPORTED_MODULE_1__), _videojs_vhs_utils_es_decode_b64_to_uint8_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6722), _xmldom_xmldom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3969), isObject = function(obj) {
                ...
                for(var initSegment = playlist.sidx.map ? playlist.sidx.map : null, sourceDuration = playlist.sidx.duration, timeline = playlist.timeline || 0, sidxByteRange = playlist.sidx.byterange, sidxEnd = sidxByteRange.offset + sidxByteRange.length, timescale = sidx.timescale, mediaReferences = sidx.references.filter(function(r) {
                    ...
                    initSegment && (segment.map = initSegment);
                ...
                return Object.keys(o = playlists.reduce(function(acc, playlist) {
                    ...
                    if (acc[name]) {
                        playlist.segments[0] && (playlist.segments[0].discontinuity = !0);
                        (_acc$name$segments = acc[name].segments).push.apply(_acc$name$segments, playlist.segments);
                        playlist.attributes.contentProtection && (acc[name].attributes.contentProtection = playlist.attributes.contentProtection);
                    } else acc[name] = playlist;
                    return acc;
                }, {})).map(function(k) {
                    return o[k];
                ...
                void 0 === sidxMapping && (sidxMapping = {});
                ...
                attributes.contentProtection && (playlist.contentProtection = attributes.contentProtection);
                sidx && (playlist.sidx = sidx);
                if (isAudioOnly) {
                ...
                void 0 === sidxMapping && (sidxMapping = {});
                void 0 === isAudioOnly && (isAudioOnly = !1);
                var mainPlaylist, formattedPlaylists = playlists.reduce(function(a, playlist) {
                    ...
                    language && !playlist.attributes.label && (label = "" + playlist.attributes.lang + (role ? " (" + role + ")" : ""));
                    a[label] || (a[label] = {
                        language: language,
                        autoselect: !0,
                        default: "main" === role,
                ...
                minimumUpdatePeriod >= 0 && (manifest.minimumUpdatePeriod = 1000 * minimumUpdatePeriod);
                locations && (manifest.locations = locations);
                "dynamic" === type && (manifest.suggestedPresentationDelay = suggestedPresentationDelay);
                ...
                return audioPlaylists.length && (manifest.mediaGroups.AUDIO.audio = organizeAudioPlaylists(audioPlaylists, sidxMapping, isAudioOnly)), vttPlaylists.length && (manifest.mediaGroups.SUBTITLES.subs = (void 0 === (sidxMapping1 = sidxMapping) && (sidxMapping1 = {}), vttPlaylists.reduce(function(a, playlist) {
                    ...
                    return svc && svc.forEach(function(service) {
                        ...
                        service.hasOwnProperty("aspectRatio") && (svcObj[language].aspectRatio = service.aspectRatio);
                        service.hasOwnProperty("easyReader") && (svcObj[language].easyReader = service.easyReader);
                        service.hasOwnProperty("3D") && (svcObj[language]["3D"] = service["3D"]);
                    }), svcObj;
                }, {})), manifest;
                ...
                for(var type = attributes.type, _attributes$minimumUp2 = attributes.minimumUpdatePeriod, minimumUpdatePeriod = void 0 === _attributes$minimumUp2 ? 0 : _attributes$minimumUp2, _attributes$media = attributes.media, media = void 0 === _attributes$media ? "" : _attributes$media, sourceDuration = attributes.sourceDuration, _attributes$timescale2 = attributes.timescale, timescale = void 0 === _attributes$timescale2 ? 1 : _attributes$timescale2, _attributes$startNumb = attributes.startNumber, startNumber = void 0 === _attributes$startNumb ? 1 : _attributes$startNumb, timeline = attributes.periodIndex, segments = [], time = -1, sIndex = 0; sIndex < segmentTimeline.length; sIndex++){
                    ...
                    time < 0 && (time = segmentTime);
                    segmentTime && segmentTime > time && (time = segmentTime);
                    var count = void 0;
                    if (repeat < 0) {
                        var nextS = sIndex + 1;
                    ...
                    for(var end = startNumber + segments.length + count, number = startNumber + segments.length; number < end;){
                        segments.push({
                            number: number,
                ...
                mpdAttributes.clientOffset = void 0 === _options$clientOffset ? 0 : _options$clientOffset;
                locations.length && (mpdAttributes.locations = locations.map(getContent));
                var periods = [];
                        ...
                        return flatten(adaptationSets.map(function(adaptationSet) {
                            var service, adaptationSetAttributes = parseAttributes(adaptationSet), adaptationSetBaseUrls = buildBaseUrls(periodBaseUrls, findChildren(adaptationSet, "BaseURL")), role = findChildren(adaptationSet, "Role")[0], roleAttributes = {
                                ...
                                if (/=/.test(value)) {
                                    ...
                                    (void 0 === _value$split2$ ? "" : _value$split2$).split(",").forEach(function(opt) {
        ...
        4221: function(module) {
            var parseSidx = function(data) {
                ...
                if (0 === result.version) {
                    ...
                    result.earliestPresentationTime = 4294967296 * view.getUint32(i) + view.getUint32(i + 4);
                    result.firstOffset = 4294967296 * view.getUint32(i + 8) + view.getUint32(i + 12);
                    i += 16;
                }
                i += 2;
        ...
        9945: function(module) {
            ...
            URL_REGEX = /^((?:[a-zA-Z0-9+\-.]+:)?)(\/\/[^\/?#]*)?((?:[^\/?#]*\/)*[^;?#]*)?(;[^?#]*)?(\?[^#]*)?(#[^]*)?$/, FIRST_SEGMENT_REGEX = /^([^\/?#]*)([^]*)$/, SLASH_DOT_REGEX = /(?:\/|^)\.(?=\/)/g, SLASH_DOT_DOT_REGEX = /(?:\/|^)\.\.\/(?!\.\.\/)[^\/]*(?=\/)/g, URLToolkit = {
                ...
                normalizePath: function(path) {
                    ...
                    for(; path.length !== (path = path.replace(SLASH_DOT_DOT_REGEX, "")).length;);
        ...
        3407: function(module, __unused_webpack_exports, __webpack_require__) {
            ...
            window1.vttjs = vttjs;
            window1.WebVTT = vttjs.WebVTT;
            var cueShim = vttjs.VTTCue, regionShim = vttjs.VTTRegion, nativeVTTCue = window1.VTTCue, nativeVTTRegion = window1.VTTRegion;
            vttjs.shim = function() {
                window1.VTTCue = cueShim;
                window1.VTTRegion = regionShim;
            };
            vttjs.restore = function() {
                window1.VTTCue = nativeVTTCue;
                window1.VTTRegion = nativeVTTRegion;
            };
        ...
        3706: function(module, __unused_webpack_exports, __webpack_require__) {
            ...
            function parseCue(input, cue, regionList) {
                ...
                !function(input, cue) {
                    ...
                    parseOptions(input, function(k, v) {
                        switch(k){
                            ...
                            case "line":
                                ...
                                settings.percent(k, vals0) && settings.set("snapToLines", !1);
                            ...
                            case "position":
                                ...
                                2 === vals.length && settings.alt("positionAlign", vals[1], [
                                    "start",
                                    "center",
                                    "end"
                                ]);
                    ...
                    cue.snapToLines = settings.get("snapToLines", !0);
            ...
            function parseContent(window1, input) {
                ...
                for(var t, rootDiv = window1.document.createElement("div"), current = rootDiv, tagStack = []; null !== (t = nextToken());){
                    if ("<" === t[0]) {
                        ...
                        if (ts) {
                            node = window1.document.createProcessingInstruction("timestamp", ts);
            ...
            StyleBox.prototype.applyStyles = function(styles, div) {
                div = div || this.div;
                for(var prop in styles)styles.hasOwnProperty(prop) && (div.style[prop] = styles[prop]);
            };
            ...
            function CueStyleBox(window1, cue, styleOptions) {
                ...
                this.div = window1.document.createElement("div");
                styles = {
                    direction: function(cueDiv) {
                        ...
                        for(; text = nextTextNode(nodeStack);)for(var i = 0; i < text.length; i++)if (isStrongRTLChar(text.charCodeAt(i))) return "rtl";
                        return "ltr";
                    }(this.cueDiv),
                    writingMode: "" === cue.vertical ? "horizontal-tb" : "lr" === cue.vertical ? "vertical-lr" : "vertical-rl",
                    unicodeBidi: "plaintext",
            ...
            function BoxPosition(obj) {
                ...
                this.lineHeight = void 0 !== lh ? lh : obj.lineHeight;
            }
            BoxPosition.prototype.move = function(axis, toMove) {
                toMove = void 0 !== toMove ? toMove : this.lineHeight;
                switch(axis){
                    case "+x":
                        this.left += toMove;
                        this.right += toMove;
            ...
            WebVTT1.processCues = function(window1, cues, overlay) {
                ...
                paddedOverlay.style.margin = "1.5%";
                ...
                !function() {
                    for(var styleBox, cue, i = 0; i < cues.length; i++){
                        cue = cues[i];
                        styleBox = new CueStyleBox(window1, cue, styleOptions);
                        paddedOverlay.appendChild(styleBox.div);
                        moveBoxToLinePosition(window1, styleBox, containerBox, boxPositions);
            ...
            WebVTT1.Parser.prototype = {
                ...
                parse: function(data) {
                        ...
                        input.match(/X-TIMESTAMP-MAP/) ? parseOptions(input, function(k, v) {
                            ...
                            "Region" === k && function(input) {
                                ...
                                if (settings.has("id")) {
                                    ...
                                    self1.onregion && self1.onregion(region);
                    ...
                    try {
                        ...
                        for(var alreadyCollectedLine = !1; self1.buffer && /\r\n|\n/.test(self1.buffer);){
                            alreadyCollectedLine ? alreadyCollectedLine = !1 : line = collectNextLine();
                            switch(self1.state){
                                case "HEADER":
                                ...
                                case "CUETEXT":
                                    ...
                                    if (!line || hasSubstring && (alreadyCollectedLine = !0)) {
                                        self1.oncue && self1.oncue(self1.cue);
                                        self1.cue = null;
                                        self1.state = "ID";
                                        continue;
                                    }
                        ...
                        self1.reportOrThrowError(e2);
                        "CUETEXT" === self1.state && self1.cue && self1.oncue && self1.oncue(self1.cue);
                        self1.cue = null;
                ...
                flush: function() {
                    var self1 = this;
                    try {
                        self1.buffer += self1.decoder.decode();
                        if (self1.cue || "HEADER" === self1.state) {
                            self1.buffer += "\n\n";
                            self1.parse();
                        }
                        if ("INITIAL" === self1.state) throw new ParsingError(ParsingError.Errors.BadSignature);
                    } catch (e) {
                    ...
                    lineAlign: {
                        ...
                        set: function(value) {
                            ...
                            if (setting) {
                                _lineAlign = setting;
                                this.hasBeenReset = !0;
                            } else console.warn("lineAlign: an invalid or illegal string was specified.");
                        }
                    },
                    position: {
                        enumerable: !0,
                    ...
                    positionAlign: {
                        ...
                        set: function(value) {
                            ...
                            if (setting) {
                                ...
                                this.hasBeenReset = !0;
                            } else console.warn("positionAlign: an invalid or illegal string was specified.");
                        }
                    },
                    size: {
                        enumerable: !0,
        ...
        816: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function from(value, encodingOrOffset, length) {
                if ("string" == typeof value) return function(string, encoding) {
                    ...
                    if (!Buffer.isEncoding(encoding)) throw TypeError("Unknown encoding: " + encoding);
            ...
            Buffer.compare = function(a, b) {
                ...
                if (!Buffer.isBuffer(a) || !Buffer.isBuffer(b)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                if (a === b) return 0;
            ...
            Buffer.prototype.compare = function(target, start, end, thisStart, thisEnd) {
                ...
                if (!Buffer.isBuffer(target)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof target);
            ...
            function bidirectionalIndexOf(buffer, val, byteOffset, encoding, dir) {
                ...
                if ("string" == typeof byteOffset) {
                    encoding = byteOffset;
                    byteOffset = 0;
                } else byteOffset > 0x7fffffff ? byteOffset = 0x7fffffff : byteOffset < -2147483648 && (byteOffset = -2147483648);
                ...
                for(var res = [], i = start; i < end;){
                    ...
                    if (i + bytesPerSequence <= end) switch(bytesPerSequence){
                        ...
                        case 3:
                            secondByte = buf[i + 1];
                            thirdByte = buf[i + 2];
                            (0xc0 & secondByte) == 0x80 && (0xc0 & thirdByte) == 0x80 && (tempCodePoint = (0xf & firstByte) << 0xc | (0x3f & secondByte) << 0x6 | 0x3f & thirdByte) > 0x7ff && (tempCodePoint < 0xd800 || tempCodePoint > 0xdfff) && (codePoint = tempCodePoint);
                            break;
                        case 4:
                            secondByte = buf[i + 1];
                            thirdByte = buf[i + 2];
                            fourthByte = buf[i + 3];
                            (0xc0 & secondByte) == 0x80 && (0xc0 & thirdByte) == 0x80 && (0xc0 & fourthByte) == 0x80 && (tempCodePoint = (0xf & firstByte) << 0x12 | (0x3f & secondByte) << 0xc | (0x3f & thirdByte) << 0x6 | 0x3f & fourthByte) > 0xffff && tempCodePoint < 0x110000 && (codePoint = tempCodePoint);
                    }
                    if (null === codePoint) {
                        codePoint = 0xfffd;
                        bytesPerSequence = 1;
            ...
            Buffer.prototype.writeUIntLE = function(value, offset, byteLength, noAssert) {
                ...
                for(; ++i < byteLength && (mul *= 0x100);)this[offset + i] = value / mul & 0xff;
            ...
            Buffer.prototype.writeUIntBE = function(value, offset, byteLength, noAssert) {
                ...
                for(; --i >= 0 && (mul *= 0x100);)this[offset + i] = value / mul & 0xff;
                return offset + byteLength;
            };
            ...
            Buffer.prototype.copy = function(target, targetStart, start, end) {
                ...
                if (end === start || 0 === target.length || 0 === this.length) return 0;
        ...
        8898: function(__unused_webpack_module, exports) {
            ...
            exports.write = function(buffer, value, offset, isLE, mLen, nBytes) {
                ...
                if (isNaN(value = Math.abs(value)) || value === 1 / 0) {
                    m = isNaN(value) ? 1 : 0;
                    e = eMax;
                } else {
