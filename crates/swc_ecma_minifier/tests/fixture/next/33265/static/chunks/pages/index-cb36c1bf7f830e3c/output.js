    ...
    ],
    {
        ...
        1146: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function _addNamedNode(el, list, newAttr, oldAttr) {
                if (oldAttr ? list[_findNodeIndex(list, oldAttr)] = newAttr : list[list.length++] = newAttr, el) {
                    ...
                    var newAttr1, doc = el.ownerDocument;
                    doc && (oldAttr && _onRemoveAttribute(doc, el, oldAttr), newAttr1 = newAttr, doc && doc._inc++, newAttr1.namespaceURI === NAMESPACE.XMLNS && (el._nsMap[newAttr1.prefix ? newAttr1.localName : ""] = newAttr1.value));
                }
            }
        ...
        4782: function(__unused_webpack_module, exports) {
            ...
            exports.byteLength = function(b64) {
                ...
                var placeHoldersLen, tmp, i, lens = getLens(b64), validLen = lens[0], placeHoldersLen1 = lens[1], arr = new Arr((validLen + (placeHoldersLen = placeHoldersLen1)) * 3 / 4 - placeHoldersLen), curByte = 0, len = placeHoldersLen1 > 0 ? validLen - 4 : validLen;
        ...
        816: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            exports.Buffer = Buffer, exports.SlowBuffer = function(length) {
                ...
                var string1, offset1, length1, string2, offset2, length2, string3, offset3, length3, string4, offset4, length4, remaining = this.length - offset;
                ...
                for(var loweredCase = !1;;)switch(encoding){
                    ...
                    case "utf8":
                    case "utf-8":
                        return string1 = string, offset1 = offset, length1 = length, blitBuffer(utf8ToBytes(string1, this.length - offset1), this, offset1, length1);
                    case "ascii":
                        return string2 = string, offset2 = offset, length2 = length, blitBuffer(asciiToBytes(string2), this, offset2, length2);
                    case "latin1":
                    case "binary":
                        return function(buf, string, offset, length) {
                            var buf1, string1, offset1, length1;
                            return buf1 = buf, string1 = string, offset1 = offset, length1 = length, blitBuffer(asciiToBytes(string1), buf1, offset1, length1);
                        }(this, string, offset, length);
                    case "base64":
                        return string3 = string, offset3 = offset, length3 = length, blitBuffer(base64ToBytes(string3), this, offset3, length3);
                    case "ucs2":
                    case "ucs-2":
                    case "utf16le":
                    case "utf-16le":
                        return string4 = string, offset4 = offset, length4 = length, blitBuffer(function(str, units) {
                            for(var c, hi, byteArray = [], i = 0; i < str.length && !((units -= 2) < 0); ++i)hi = (c = str.charCodeAt(i)) >> 8, byteArray.push(c % 256), byteArray.push(hi);
                            return byteArray;
                        }(string4, this.length - offset4), this, offset4, length4);
                    default:
                        if (loweredCase) throw TypeError("Unknown encoding: " + encoding);
                        encoding = ("" + encoding).toLowerCase(), loweredCase = !0;
                }
