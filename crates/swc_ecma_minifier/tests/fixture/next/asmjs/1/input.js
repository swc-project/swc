export function foo(global, env, buffer) {
    ...
    function uc(b) {
        ...
        d = T(g[(b + 48) >> 2]);
        if (Sb(d) | 0)
            d = a[((c[(b + 976) >> 2] | 0) + 2) >> 0] | 0 ? T(1.0) : T(0.0);
        return T(d);
    }
    function vc(a, b) {
        a = a | 0;
    ...
    function Td(b, d, e, f, i, j, k, m, n, o, p) {
        ...
        c[2279] = z;
        E = (b + 984) | 0;
        if ((a[E >> 0] | 0) != 0 ? (c[(b + 512) >> 2] | 0) != (c[2278] | 0) : 0)
            w = 4;
                ...
                a: do
                    if ((D | 0) == 1) {
                        ...
                        while (1) {
                            q = ac(b, r) | 0;
                            if (!h) {
                                if (T(Ee(q)) > T(0.0) ? T(Fe(q)) > T(0.0) : 0)
                                    h = q;
                                else h = 0;
                            } else if (De(q) | 0) {
                                t = 0;
    ...
    function se(a, b) {
        ...
        var d = ib;
        if (
            !((oe(b) | 0 ? (c[(a + 312) >> 2] | 0) != 0 : 0)
                ? ((d = T(g[(a + 308) >> 2])), d >= T(0.0))
                : 0)
        )
            d = T(
                cC(
    ...
    function te(a, b) {
        ...
        var d = ib;
        if (
            !((oe(b) | 0 ? (c[(a + 320) >> 2] | 0) != 0 : 0)
                ? ((d = T(g[(a + 316) >> 2])), d >= T(0.0))
                : 0)
        )
            d = T(
                cC(
    ...
    function ue(a, b, d) {
        ...
        var e = ib;
        if (
            !((oe(b) | 0 ? (c[(a + 240) >> 2] | 0) != 0 : 0)
                ? ((e = T(be((a + 236) | 0, d))), e >= T(0.0))
                : 0)
        )
            e = T(
                cC(
    ...
    function ve(a, b, d) {
        ...
        var e = ib;
        if (
            !((oe(b) | 0 ? (c[(a + 248) >> 2] | 0) != 0 : 0)
                ? ((e = T(be((a + 244) | 0, d))), e >= T(0.0))
                : 0)
        )
            e = T(
                cC(
    ...
    function Ne(a, b) {
        ...
        if (oe(b) | 0 ? (c[((Tb(a, 4, 948) | 0) + 4) >> 2] | 0) != 0 : 0) a = 1;
            ...
            a =
                (c[((Tb(a, c[(1040 + (b << 2)) >> 2] | 0, 948) | 0) + 4) >> 2] |
                    0) !=
                0;
        return a | 0;
    }
    ...
    function Xe(b) {
        ...
        switch (c[(b + 56) >> 2] | 0) {
            ...
            case 3: {
                d = T(g[(b + 40) >> 2]);
                if ((d > T(0.0)) & ((Sb(d) | 0) ^ 1))
                    b = a[((c[(b + 976) >> 2] | 0) + 2) >> 0] | 0 ? 1056 : 992;
                else b = 1056;
                break;
            }
            default:
    ...
    function Ze(a, b) {
        ...
        if (oe(b) | 0 ? (c[((Tb(a, 5, 948) | 0) + 4) >> 2] | 0) != 0 : 0) a = 1;
            ...
            a =
                (c[((Tb(a, c[(1e3 + (b << 2)) >> 2] | 0, 948) | 0) + 4) >> 2] |
                    0) !=
                0;
        return a | 0;
    }
        ...
        a: do
            if (
                (f | 0) != 0
                    ? !(
                          ((d | 0) == 255) |
                          (((hC(b) | 0) & 2147483647) >>> 0 > 2139095040)
                      )
                    : 0
            ) {
                e = h << 1;
    ...
    function pC(a) {
        ...
        var b = 0;
        b = (a + 8) | 0;
        if (!((c[b >> 2] | 0) != 0 ? (nC(b) | 0) != -1 : 0))
            nb[c[((c[a >> 2] | 0) + 16) >> 2] & 127](a);
        return;
    }
    function qC(a) {
        a = a | 0;
