    ...
    ],
    {
        8780: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            if ("undefined" != typeof navigator && "undefined" != typeof document) {
                ...
                result.gecko_version = result.gecko && +(/Firefox\/(\d+)/.exec(navigator.userAgent) || [
                    0,
                    0
                ])[1];
                ...
                result.webkit_version = result.webkit && +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [
                    0,
                    0
                ])[1];
            }
            ...
            function scrollRectIntoView(view, rect, startDOM) {
                for(var scrollThreshold = view.someProp("scrollThreshold") || 0, scrollMargin = view.someProp("scrollMargin") || 5, doc = view.dom.ownerDocument, parent = startDOM || view.dom; parent; parent = parentNode(parent))if (1 == parent.nodeType) {
                    ...
                    rect.top < bounding.top + getSide(scrollThreshold, "top") ? moveY = -(bounding.top - rect.top + getSide(scrollMargin, "top")) : rect.bottom > bounding.bottom - getSide(scrollThreshold, "bottom") && (moveY = rect.bottom - bounding.bottom + getSide(scrollMargin, "bottom"));
            ...
            function scrollStack(dom) {
                for(var stack = [], doc = dom.ownerDocument; dom; dom = parentNode(dom)){
                    stack.push({
                        dom: dom,
                        top: dom.scrollTop,
                        left: dom.scrollLeft
            ...
            function restoreScrollStack(stack, dTop) {
                for(var i = 0; i < stack.length; i++){
                    ...
                    dom.scrollTop != top + dTop && (dom.scrollTop = top + dTop);
                    dom.scrollLeft != left && (dom.scrollLeft = left);
                }
            }
            ...
            function withFlushedState(view, state, f) {
                ...
                viewState != state && view.updateState(state);
                active != view.dom && view.focus();
                try {
                    return f();
                } finally{
                    viewState != state && view.updateState(viewState);
                    active != view.dom && active && active.focus();
                }
            }
            ...
            ViewDesc.prototype.setSelection = function(anchor, head, root, force) {
                ...
                if (!(!(force || brKludge && result.safari) && isEquivalentPosition(anchorDOM.node, anchorDOM.offset, domSel.anchorNode, domSel.anchorOffset) && isEquivalentPosition(headDOM.node, headDOM.offset, domSel.focusNode, domSel.focusOffset))) {
                    ...
                    if ((domSel.extend || anchor == head) && !brKludge) {
                        ...
                        try {
                            anchor != head && domSel.extend(headDOM.node, headDOM.offset);
                            domSelExtended = !0;
                        } catch (err) {
                ...
                for(var offset = 0, i = 0; i < this.children.length; i++){
                    ...
                    if (offset == end ? from <= end && to >= offset : from < end && to > offset) {
                        ...
                        if (from >= startInside && to <= endInside) {
                            this.dirty = from == offset || to == end ? 2 : 1;
                            from == startInside && to == endInside && (child.contentLost || child.dom.parentNode != this.contentDOM) ? child.dirty = 3 : child.markDirty(from - startInside, to - startInside);
                            return;
                        }
            ...
            var nothing = [], WidgetViewDesc = function(ViewDesc) {
                function WidgetViewDesc(parent, widget, view, pos) {
                    ...
                    "function" == typeof dom && (dom = dom(view, function() {
                ...
                ViewDesc && (WidgetViewDesc.__proto__ = ViewDesc);
                ...
                ViewDesc && (CompositionViewDesc.__proto__ = ViewDesc);
                ...
                return ViewDesc && (MarkViewDesc.__proto__ = ViewDesc), MarkViewDesc.prototype = Object.create(ViewDesc && ViewDesc.prototype), MarkViewDesc.prototype.constructor = MarkViewDesc, MarkViewDesc.create = function(parent, mark, inline, view) {
                    ...
                    if (0 != this.dirty) {
                        ...
                        parent.dirty < this.dirty && (parent.dirty = this.dirty);
                        this.dirty = 0;
                    }
                    ...
                    to < size && (nodes = replaceNodes(nodes, to, size, view));
                    from > 0 && (nodes = replaceNodes(nodes, 0, from, view));
                ...
                function NodeViewDesc(parent, node, outerDeco, innerDeco, dom, contentDOM, nodeDOM, view, pos) {
                    ...
                    contentDOM && this.updateChildren(view, pos);
                }
                ViewDesc && (NodeViewDesc.__proto__ = ViewDesc);
                ...
                return NodeViewDesc.create = function(parent, node, outerDeco, innerDeco, view, pos) {
                    ...
                    if (!contentDOM && !node.isText && "BR" != dom.nodeName) {
                        dom.hasAttribute("contenteditable") || (dom.contentEditable = !1);
                    ...
                    (function(parent, deco, onWidget, onNode) {
                        ...
                        widget.spec.marks ? updater.syncToMarks(widget.spec.marks, inline, view) : widget.type.side >= 0 && !insideNode && updater.syncToMarks(i == this$1.node.childCount ? prosemirror_model__WEBPACK_IMPORTED_MODULE_1__.Mark.none : this$1.node.child(i).marks, inline, view);
                        updater.placeWidget(widget, view, off);
                    }, function(child, outerDeco, innerDeco, i) {
                        var compIndex;
                        updater.syncToMarks(child.marks, inline, view);
                        updater.findNodeMatch(child, outerDeco, innerDeco, i) || compositionInChild && view.state.selection.from > off && view.state.selection.to < off + child.nodeSize && (compIndex = updater.findIndexWithChild(composition.node)) > -1 && updater.updateNodeAt(child, outerDeco, innerDeco, compIndex, view) || updater.updateNextNode(child, outerDeco, innerDeco, view, i) || updater.addNode(child, outerDeco, innerDeco, view, off);
                        off += child.nodeSize;
                    });
                    updater.syncToMarks(nothing, inline, view);
                    this.node.isTextblock && updater.addTextblockHacks();
                    updater.destroyRest();
                    if (updater.changed || 2 == this.dirty) {
                        localComposition && this.protectLocalComposition(view, localComposition);
                        ...
                        })(this.contentDOM, this.children, view);
                        result.ios && function(dom) {
                            ...
                            var text = textNode.nodeValue, textPos = function(frag, text, from, to) {
                                for(var i = 0, pos = 0; i < frag.childCount && pos <= to;){
                                    ...
                                    if (child.isText) {
                                        ...
                                        if (pos >= from) {
                                            var found = str.lastIndexOf(text, to - pos);
                                            if (found >= 0 && found + text.length + pos >= from) return pos + found;
                                        }
                                    }
                                }
                                return -1;
                    ...
                    this.node = node;
                    this.innerDeco = innerDeco;
                    this.contentDOM && this.updateChildren(view, this.posAtStart);
                    this.dirty = 0;
            ...
            var TextViewDesc = function(NodeViewDesc) {
                ...
                NodeViewDesc && (TextViewDesc.__proto__ = NodeViewDesc);
                ...
                return TextViewDesc.prototype.parseRule = function() {
                    ...
                    if (3 == this.dirty || 0 != this.dirty && !this.inParent() || !node.sameMarkup(this.node)) return !1;
                    this.updateOuterDeco(outerDeco);
                    if ((0 != this.dirty || node.text != this.node.text) && node.text != this.nodeDOM.nodeValue) {
                        this.nodeDOM.nodeValue = node.text;
                        view.trackWrites == this.nodeDOM && (view.trackWrites = null);
                    }
                    return this.node = node, this.dirty = 0, !0;
                    ...
                    this.dom != this.nodeDOM && (0 == from || to == this.nodeDOM.nodeValue.length) && (this.dirty = 3);
                ...
                ViewDesc && (TrailingHackViewDesc.__proto__ = ViewDesc);
            ...
            function computeOuterDeco(outerDeco, node, needsWrap) {
                ...
                for(var top = needsWrap ? noDeco[0] : new OuterDecoLevel(), result = [
                    ...
                    if (attrs) {
                        attrs.nodeName && result.push(top = new OuterDecoLevel(attrs.nodeName));
                        for(var name in attrs){
                            var val = attrs[name];
                            if (null != val) {
                                needsWrap && 1 == result.length && result.push(top = new OuterDecoLevel(node.isInline ? "span" : "div"));
                                "class" == name ? top.class = (top.class ? top.class + " " : "") + val : "style" == name ? top.style = (top.style ? top.style + ";" : "") + val : "nodeName" != name && (top[name] = val);
                            }
                        }
                    }
                }
            ...
            function patchOuterDeco(outerDOM, nodeDOM, prevComputed, curComputed) {
                ...
                for(var curDOM = nodeDOM, i = 0; i < curComputed.length; i++){
                    ...
                    if (i) {
                        var parent = void 0;
                        if (prev && prev.nodeName == deco.nodeName && curDOM != outerDOM && (parent = curDOM.parentNode) && parent.tagName.toLowerCase() == deco.nodeName) curDOM = parent;
                        else {
                            (parent = document.createElement(deco.nodeName)).pmIsDeco = !0;
            ...
            var ViewTreeUpdater = function(top, lockedNode) {
                ...
                this.stack = [];
                this.changed = !1;
                this.preMatch = function(frag, descs) {
            ...
            ViewTreeUpdater.prototype.updateNextNode = function(node, outerDeco, innerDeco, view, index) {
                for(var i = this.index; i < this.top.children.length; i++){
                    ...
                    if (next instanceof NodeViewDesc) {
                        ...
                        if (!(this.lock && (nextDOM == this.lock || 1 == nextDOM.nodeType && nextDOM.contains(this.lock.parentNode)) && !(node.isText && next.node && next.node.isText && next.nodeDOM.nodeValue == node.text && 3 != next.dirty && sameOuterDeco(outerDeco, next.outerDeco))) && next.update(node, outerDeco, innerDeco, view)) {
                            this.destroyBetween(this.index, i);
                            next.dom != nextDOM && (this.changed = !0);
                            this.index++;
                            return !0;
                        }
                        break;
            ...
            ViewTreeUpdater.prototype.addTextblockHacks = function() {
                ...
                if (!lastChild || !(lastChild instanceof TextViewDesc) || /\n$/.test(lastChild.node.text)) {
                    (result.safari || result.chrome) && lastChild && "false" == lastChild.dom.contentEditable && this.addHackNode("IMG");
                    this.addHackNode("BR");
                }
            };
            ViewTreeUpdater.prototype.addHackNode = function(nodeName) {
                if (this.index < this.top.children.length && this.top.children[this.index].matchesHack(nodeName)) this.index++;
                    ...
                    "IMG" == nodeName && (dom.className = "ProseMirror-separator");
                    "BR" == nodeName && (dom.className = "ProseMirror-trailingBreak");
            ...
            function replaceNodes(nodes, from, to, view, replacement) {
                for(var result = [], i = 0, off = 0; i < nodes.length; i++){
                    var child = nodes[i], end = off += child.size;
                    if (off >= to || end <= from) result.push(child);
                    else {
                        off < from && result.push(child.slice(0, from - off, view));
                        if (replacement) {
                            result.push(replacement);
                            replacement = null;
                        }
                        end > to && result.push(child.slice(to - off, child.size, view));
                    }
                }
                return result;
            }
            function selectionFromDOM(view, origin) {
                ...
                if (selectionCollapsed(domSel)) {
                    $anchor = $head;
                    for(; nearestDesc && !nearestDesc.node;)nearestDesc = nearestDesc.parent;
            ...
            function selectionToDOM(view, force) {
                ...
                if (editorOwnsSelection(view)) {
                    if (!force && view.mouseDown && view.mouseDown.allowDefault) {
                        view.mouseDown.delayedSelectionSync = !0;
                        view.domObserver.setCurSelection();
                        return;
                    }
                    view.domObserver.disconnectSelection();
                    if (view.cursorWrapper) !function(view) {
                        ...
                        var view1, doc, domSel, node, offset, resetEditableFrom, resetEditableTo, anchor = sel.anchor, head = sel.head;
                        if (brokenSelectBetweenUneditable && !(sel instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection)) {
                            sel.$from.parent.inlineContent || (resetEditableFrom = temporarilyEditableNear(view, sel.from));
                            sel.empty || sel.$from.parent.inlineContent || (resetEditableTo = temporarilyEditableNear(view, sel.to));
                        }
                        view.docView.setSelection(anchor, head, view.root, force);
                        if (brokenSelectBetweenUneditable) {
                            resetEditableFrom && resetEditable(resetEditableFrom);
                            resetEditableTo && resetEditable(resetEditableTo);
                        }
                        if (sel.visible) view.dom.classList.remove("ProseMirror-hideselection");
                        else {
                            view.dom.classList.add("ProseMirror-hideselection");
                            "onselectionchange" in document && ((doc = (view1 = view).dom.ownerDocument).removeEventListener("selectionchange", view1.hideSelectionGuard), node = (domSel = view1.root.getSelection()).anchorNode, offset = domSel.anchorOffset, doc.addEventListener("selectionchange", view1.hideSelectionGuard = function() {
                                if (domSel.anchorNode != node || domSel.anchorOffset != offset) {
                                    doc.removeEventListener("selectionchange", view1.hideSelectionGuard);
                                    setTimeout(function() {
            ...
            function clearNodeSelection(view) {
                if (view.lastSelectedViewDesc) {
                    view.lastSelectedViewDesc.parent && view.lastSelectedViewDesc.deselectNode();
            ...
            function skipIgnoredNodesLeft(view) {
                ...
                if (node) {
                    ...
                    result.gecko && 1 == node.nodeType && offset < nodeLen(node) && isIgnorable(node.childNodes[offset]) && (force = !0);
                    for(;;)if (offset > 0) {
                        ...
                        for(var prev = node.previousSibling; prev && isIgnorable(prev);){
            ...
            function skipIgnoredNodesRight(view) {
                ...
                if (node) {
                    for(var len = nodeLen(node);;)if (offset < len) {
                        if (1 != node.nodeType) break;
                        if (isIgnorable(node.childNodes[offset])) {
                            moveNode = node;
                            moveOffset = ++offset;
                        } else break;
                    } else if (isBlockNode(node)) break;
                    else {
                        for(var next = node.nextSibling; next && isIgnorable(next);){
            ...
            function skipClosingAndOpening($pos, fromEnd, mayOpen) {
                for(var depth = $pos.depth, end = fromEnd ? $pos.end() : $pos.pos; depth > 0 && (fromEnd || $pos.indexAfter(depth) == $pos.node(depth).childCount);){
                    depth--;
                    end++;
                    fromEnd = !1;
                }
                if (mayOpen) for(var next = $pos.node(depth).maybeChild($pos.indexAfter(depth)); next && !next.isLeaf;){
            ...
            function parseFromClipboard(view, text, html, plainText, $context) {
                ...
                slice || (slice = (view.someProp("clipboardParser") || view.someProp("domParser") || prosemirror_model__WEBPACK_IMPORTED_MODULE_1__.DOMParser.fromSchema(view.state.schema)).parseSlice(dom, {
            ...
            var DOMObserver = function(view, handleDOMChange) {
                ...
                useCharData && (this.onCharData = function(e) {
                    this$1.queue.push({
                        target: e.target,
                        type: "characterData",
            ...
            DOMObserver.prototype.start = function() {
                this.observer && this.observer.observe(this.view.dom, observeOptions);
                useCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData);
                    ...
                    if (from > -1 || newSel) {
                        if (from > -1) {
                            ...
                            !function(view) {
                                if (!cssChecked) {
                                    cssChecked = !0;
                                    "normal" == getComputedStyle(view.dom).whiteSpace && console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package.");
                                }
                            }(this.view);
                        }
                        this.handleDOMChange(from, to, typeOver, added);
                        this.view.docView.dirty ? this.view.updateState(this.view.state) : this.currentSelection.eq(sel) || selectionToDOM(this.view);
            ...
            DOMObserver.prototype.registerMutation = function(mut, added) {
                ...
                if ("childList" == mut.type) {
                    ...
                    if (result.ie && result.ie_version <= 11 && mut.addedNodes.length) for(var i$1 = 0; i$1 < mut.addedNodes.length; i$1++){
                        ...
                        (!previousSibling || 0 > Array.prototype.indexOf.call(mut.addedNodes, previousSibling)) && (prev = previousSibling);
                        (!nextSibling || 0 > Array.prototype.indexOf.call(mut.addedNodes, nextSibling)) && (next = nextSibling);
                    }
            ...
            editHandlers.keydown = function(view, event) {
                view.shiftKey = 16 == event.keyCode || event.shiftKey;
                if (!inOrNearComposition(view, event)) {
                    229 != event.keyCode && view.domObserver.forceFlush();
                    view.lastKeyCode = event.keyCode;
                    view.lastKeyCodeTime = Date.now();
                    if (!result.ios || 13 != event.keyCode || event.ctrlKey || event.altKey || event.metaKey) {
                        var result1, code;
            ...
            function updateSelection(view, selection, origin) {
                ...
                "pointer" == origin && tr.setMeta("pointer", !0);
                view.dispatch(tr);
            }
            ...
            handlers.mousedown = function(view, event) {
                ...
                now - view.lastClick.time < 500 && (dx = (click = view.lastClick).x - event.clientX) * dx + (dy = click.y - event.clientY) * dy < 100 && !event[selectNodeModifier] && ("singleClick" == view.lastClick.type ? type = "doubleClick" : "doubleClick" == view.lastClick.type && (type = "tripleClick"));
                view.lastClick = {
                    time: now,
                    x: event.clientX,
                    y: event.clientY,
                ...
                if (pos) {
                    if ("singleClick" == type) {
                        view.mouseDown && view.mouseDown.done();
                        view.mouseDown = new MouseDown(view, pos, event, flushed);
                    } else ("doubleClick" == type ? handleDoubleClick : handleTripleClick)(view, pos.pos, pos.inside, event) ? event.preventDefault() : setSelectionOrigin(view, "pointer");
                }
            };
            ...
            MouseDown.prototype.up = function(event) {
                this.done();
                if (this.view.dom.contains(3 == event.target.nodeType ? event.target.parentNode : event.target)) {
                    var view, pos, inside, selectNode, pos1 = this.pos;
                    this.view.state.doc != this.startDoc && (pos1 = this.view.posAtCoords(eventCoords(event)));
                    if (this.allowDefault || !pos1) setSelectionOrigin(this.view, "pointer");
                    else if (view = this.view, pos = pos1.pos, inside = pos1.inside, selectNode = this.selectNode, runHandlerOnContext(view, "handleClickOn", pos, inside, event) || view.someProp("handleClick", function(f) {
                        return f(view, pos, event);
                    ...
                    }(view, inside))) event.preventDefault();
                    else if (0 == event.button && (this.flushed || result.safari && this.mightDrag && !this.mightDrag.node.isAtom || result.chrome && !(this.view.state.selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection) && 2 >= Math.min(Math.abs(pos1.pos - this.view.state.selection.from), Math.abs(pos1.pos - this.view.state.selection.to)))) {
                        updateSelection(this.view, prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.Selection.near(this.view.state.doc.resolve(pos1.pos)), "pointer");
                        event.preventDefault();
            ...
            editHandlers.compositionstart = editHandlers.compositionupdate = function(view) {
                if (!view.composing) {
                    ...
                    if (state.selection.empty && (state.storedMarks || !$pos.textOffset && $pos.parentOffset && $pos.nodeBefore.marks.some(function(m) {
                        ...
                        endComposition(view, !0);
                        view.markCursor = null;
                    } else {
                        endComposition(view);
                        if (result.gecko && state.selection.empty && $pos.parentOffset && !$pos.textOffset && $pos.nodeBefore.marks.length) for(var sel = view.root.getSelection(), node = sel.focusNode, offset = sel.focusOffset; node && 1 == node.nodeType && 0 != offset;){
            ...
            function scheduleComposeEnd(view, delay) {
                ...
                delay > -1 && (view.composingTimeout = setTimeout(function() {
                    return endComposition(view);
                }, delay));
            }
            function clearComposition(view) {
                if (view.composing) {
                    var event;
                    view.composing = !1;
                    view.compositionEndedAt = ((event = document.createEvent("Event")).initEvent("event", !0, !0), event.timeStamp);
                }
                for(; view.compositionNodes.length > 0;)view.compositionNodes.pop().markParentsDirty();
            }
            ...
            editHandlers.paste = function(view, e) {
                ...
                data && doPaste(view, data.getData("text/plain"), data.getData("text/html"), e) ? e.preventDefault() : function(view, e) {
                    if (view.dom.parentNode) {
                        ...
                        plainText || (target.contentEditable = "true");
                        target.style.cssText = "position: fixed; left: -10000px; top: 10px";
                        target.focus();
                        setTimeout(function() {
                            view.focus();
                            target.parentNode && target.parentNode.removeChild(target);
                            plainText ? doPaste(view, target.value, null, e) : doPaste(view, target.textContent, target.innerHTML, e);
                        }, 50);
                    }
                }(view, e);
            };
            ...
            handlers.dragstart = function(view, e) {
                ...
                if (e.dataTransfer) {
                    ...
                    brokenClipboardAPI || e.dataTransfer.setData("text/plain", text);
                    ...
                    if (eventPos) {
                        ...
                        if ($mouse) {
                            ...
                            if (slice) {
                                ...
                                isNode ? tr.replaceRangeWith(pos, pos, slice.content.firstChild) : tr.replaceRange(pos, pos, slice);
            ...
            handlers.blur = function(view, e) {
                if (view.focused) {
                    ...
                    view.domObserver.start();
                    e.relatedTarget && view.dom.contains(e.relatedTarget) && view.domObserver.currentSelection.set({});
                    view.focused = !1;
                }
            };
                ...
                return this.children.length ? function(oldChildren, newLocal, mapping, node, offset, oldOffset, options) {
                    for(var children = oldChildren.slice(), shift = function(oldStart, oldEnd, newStart, newEnd) {
                        for(var i = 0; i < children.length; i += 3){
                            ...
                            if (-1 != end && !(oldStart > end + oldOffset)) {
                                if (oldEnd >= children[i] + oldOffset) children[i + 1] = -1;
            ...
            DecorationSet.prototype.addInner = function(doc, decorations, offset) {
                ...
                doc.forEach(function(childNode, childOffset) {
                    ...
                    if (found = takeSpansForNode(decorations, childNode, baseOffset)) {
                        children || (children = this$1.children.slice());
                        for(; childIndex < children.length && children[childIndex] < childOffset;)childIndex += 3;
            ...
            DecorationSet.prototype.removeInner = function(decorations, offset) {
                for(var children = this.children, local = this.local, i = 0; i < children.length; i += 3){
                    for(var found = void 0, from = children[i] + offset, to = children[i + 1] + offset, j = 0, span = void 0; j < decorations.length; j++)if ((span = decorations[j]) && span.from > from && span.to < to) {
                        decorations[j] = null;
                ...
                if (local.length) {
                    for(var i$1 = 0, span$1 = void 0; i$1 < decorations.length; i$1++)if (span$1 = decorations[i$1]) {
            ...
            function takeSpansForNode(spans, node, offset) {
                ...
                for(var end = offset + node.nodeSize, found = null, i = 0, span = void 0; i < spans.length; i++)if ((span = spans[i]) && span.from > offset && span.to < end) {
                    (found || (found = [])).push(span);
                    spans[i] = null;
                }
                return found;
            ...
            function buildTree(spans, node, offset, options) {
                ...
                for(var locals = moveSpans(hasNulls ? withoutNulls(spans) : spans, -offset).sort(byPos), i = 0; i < locals.length; i++)if (!locals[i].type.valid(node, locals[i])) {
                    options.onRemove && options.onRemove(locals[i].spec);
                    locals.splice(i--, 1);
                }
                ...
                for(var working = spans, i = 0; i < working.length - 1; i++){
                    ...
                    if (span.from != span.to) for(var j = i + 1; j < working.length; j++){
                        ...
                        if (next.from == span.from) {
                            if (next.to != span.to) {
                                working == spans && (working = spans.slice());
            ...
            var EditorView = function(place, props) {
                ...
                !function(view) {
                    ...
                    view.compositionEndedAt = -200000000;
                    view.domObserver = new DOMObserver(view, function(from, to, typeOver, added) {
                        return function(view, from, to, typeOver, addedNodes) {
                            ...
                            var sel = view.state.selection, parse = function(view, from_, to_) {
                                ...
                                if (anchor && view.dom.contains(1 == anchor.nodeType ? anchor : anchor.parentNode)) {
                                    find = [
                                        {
                                            node: anchor,
                                ...
                                if (result.chrome && 8 === view.lastKeyCode) for(var off = toOffset; off > fromOffset; off--){
                            ...
                            if (8 === view.lastKeyCode && Date.now() - 100 < view.lastKeyCodeTime) {
                            ...
                            if (view.state.selection.from < view.state.selection.to && change.start == change.endB && view.state.selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection) {
                                if (change.start > view.state.selection.from && change.start <= view.state.selection.from + 2) change.start = view.state.selection.from;
                            ...
                            result.chrome && result.android && change.toB == change.from && (view.lastAndroidDelete = Date.now());
                            if (result.android && !inlineChange && $from.start() != $to.start() && 0 == $to.parentOffset && $from.depth == $to.depth && parse.sel && parse.sel.anchor == parse.sel.head && parse.sel.head == change.endA) {
                                change.endB -= 2;
                            ...
                            if (inlineChange) {
                                if ($from.pos == $to.pos) {
                                    if (result.ie && result.ie_version <= 11 && 0 == $from.parentOffset) {
                                    ...
                                    if (1 == added.length && 0 == removed.length) {
                                        mark = added[0];
                                        type = "add";
                                ...
                                }($from.parent.content.cut($from.parentOffset, $to.parentOffset), $from1.parent.content.cut($from1.parentOffset, change.endA - $from1.start())))) {
                                    tr = view.state.tr;
                                    "add" == markChange.type ? tr.addMark(chFrom, chTo, markChange.mark) : tr.removeMark(chFrom, chTo, markChange.mark);
                            ...
                            tr || (tr = view.state.tr.replace(chFrom, chTo, parse.doc.slice(change.start - parse.from, change.endB - parse.from)));
                            if (parse.sel) {
                    ...
                    for(var event in handlers)!function(event) {
            ...
            EditorView.prototype.update = function(props) {
                props.handleDOMEvents != this._props.handleDOMEvents && ensureListeners(this);
                this._props = props;
                if (props.plugins) {
            ...
            EditorView.prototype.updateStateInner = function(state, reconfigured) {
                ...
                if (updateSel) {
                    ...
                    if (forceSelUpdate || !(this.mouseDown && this.domObserver.currentSelection.eq(this.root.getSelection()) && (anchorDOM = this.docView.domFromPos(this.state.selection.anchor, 0), domSel = this.root.getSelection(), isEquivalentPosition(anchorDOM.node, anchorDOM.offset, domSel.anchorNode, domSel.anchorOffset)))) selectionToDOM(this, forceSelUpdate);
                    else {
                ...
                if ("reset" == scroll) this.dom.scrollTop = 0;
            ...
            prototypeAccessors$2.root.get = function() {
                ...
                if (null == cached) {
                    for(var search = this.dom.parentNode; search; search = search.parentNode)if (9 == search.nodeType || 11 == search.nodeType && search.host) {
                        search.getSelection || (Object.getPrototypeOf(search).getSelection = function() {
            ...
            EditorView.prototype.posAtCoords = function(coords) {
                return function(view, coords) {
                    ...
                    dom = elt, coords1 = coords, elt = (parent = dom.parentNode) && /^li$/i.test(parent.nodeName) && coords1.left < dom.getBoundingClientRect().left ? parent : dom;
                    if (node) {
                                ...
                                for(var i = 0; i < rects.length; i++){
                                    ...
                                    if (rect.top <= rowBot && rect.bottom >= rowTop) {
                                        ...
                                        if (dx < dxClosest) {
                                            closest = child;
                                            dxClosest = dx;
                                            coordsClosest = dx && 3 == closest.nodeType ? {
                                                left: rect.right < coords.left ? rect.right : rect.left,
                                                top: coords.top
                                            } : coords;
                                            1 == child.nodeType && dx && (offset = childIndex + (coords.left >= (rect.left + rect.right) / 2 ? 1 : 0));
                                            continue;
                                        }
                                    }
            ...
            EditorView.prototype.destroy = function() {
                if (this.docView) {
                    !function(view) {
                        view.domObserver.stop();
                        for(var type in view.eventHandlers)view.dom.removeEventListener(type, view.eventHandlers[type]);
                        clearTimeout(view.composingTimeout);
            ...
            function computeDocDeco(view) {
                ...
                return attrs.class = "ProseMirror", attrs.contenteditable = String(view.editable), attrs.translate = "no", view.someProp("attributes", function(value) {
                    "function" == typeof value && (value = value(view.state));
                    if (value) for(var attr in value){
                        "class" == attr && (attrs.class += " " + value[attr]);
                        "style" == attr ? attrs.style = (attrs.style ? attrs.style + ";" : "") + value[attr] : attrs[attr] || "contenteditable" == attr || "nodeName" == attr || (attrs[attr] = String(value[attr]));
                    }
                }), [
