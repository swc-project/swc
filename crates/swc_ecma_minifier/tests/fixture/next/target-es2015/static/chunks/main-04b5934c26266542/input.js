...
const version = "12.3.2-canary.13";
...
function renderError(renderErrorProps) {
    ...
    return pageLoader.loadPage("/_error").then((param)=>{
        ...
        return (lastAppProps == null ? void 0 : lastAppProps.Component) === ErrorComponent ? Promise.resolve().then(()=>/*#__PURE__*/ _interopRequireWildcard(__webpack_require__(9185))).then((errorModule)=>{
            return Promise.resolve().then(()=>/*#__PURE__*/ _interopRequireWildcard(__webpack_require__(6029))).then((appModule)=>{
