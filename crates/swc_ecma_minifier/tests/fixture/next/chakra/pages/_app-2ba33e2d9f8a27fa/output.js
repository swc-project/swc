    ...
    ],
    {
        949: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var key, classNames = {
                ...
                dark: "chakra-ui-dark"
            }, localStorageManager = (key = "chakra-ui-color-mode", {
                ssr: !1,
                type: "localStorage",
                get: function(init) {
                    var value;
                ...
                var useSystemColorMode = _props$options.useSystemColorMode, initialColorMode = _props$options.initialColorMode, disableTransitionOnChange = _props$options.disableTransitionOnChange, _props$colorModeManag = props.colorModeManager, colorModeManager = void 0 === _props$colorModeManag ? localStorageManager : _props$colorModeManag, defaultColorMode = "dark" === initialColorMode ? "dark" : "light", _React$useState = react__WEBPACK_IMPORTED_MODULE_0__.useState(function() {
                    ...
                    return preventTransition = void 0 === (_options$preventTrans = disableTransitionOnChange) || _options$preventTrans, utils = {
                        ...
                        getSystemTheme: function(fallback) {
                            ...
                            return (null != (_utils$query$matches = utils.query().matches) ? _utils$query$matches : "dark" === fallback) ? "dark" : "light";
                        },
        ...
        4244: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var _spaceXTemplate, _spaceYTemplate, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5031), _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8554), _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(_chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1__);
            function _extends() {
                return (_extends = Object.assign ? Object.assign.bind() : function(target) {
                    for(var i = 1; i < arguments.length; i++){
                        var source = arguments[i];
            ...
            var directionMap = {
                ...
                px: function(value) {
                    return null == value ? value : analyzeCSSValue(value).unitless || (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.hj)(value) ? value + "px" : value;
                },
                ...
                gradient: function(value, theme) {
                    return function(value, theme) {
                        ...
                        var _regex$exec$groups, _regex$exec, _ref = null != (_regex$exec$groups = null == (_regex$exec = _wrapRegExp(/(^[a-z-A-Z]+)\(((.*))\)/g, {
                            type: 1,
                            values: 2
                        }).exec(value)) ? void 0 : _regex$exec.groups) ? _regex$exec$groups : {}, type = _ref.type, values = _ref.values;
                ...
                bgImage: function(value) {
                    return null == value ? value : isCSSFunction(value) || globalSet.has(value) ? value : "url(" + value + ")";
                },
            ...
            var list = {
                ...
                for(var prop in obj)prop in styles && null != styles[prop] || (result[prop] = obj[prop]);
                return result;
            }, position = {
                position: !0,
                pos: t.prop("position"),
            ...
            function toCSSVar(rawTheme) {
                var rawTheme1, _theme$config, theme, _ref, _flatten, _flatten2, tokens1, semanticTokens, tokenEntries, semanticTokenEntries, theme1 = ((rawTheme1 = rawTheme).__cssMap, rawTheme1.__cssVars, rawTheme1.__breakpoints, function(source, excluded) {
                    if (null == source) return {};
                    var key, i, target = {}, sourceKeys = Object.keys(source);
                    for(i = 0; i < sourceKeys.length; i++)key = sourceKeys[i], excluded.indexOf(key) >= 0 || (target[key] = source[key]);
                    return target;
                }(rawTheme1, _excluded)), tokens2 = (theme = theme1, (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.ei)(theme, tokens)), semanticTokens1 = theme1.semanticTokens, flatTokens = (tokens1 = (_ref = {
                    tokens: tokens2,
                    semanticTokens: semanticTokens1
                }).tokens, semanticTokens = _ref.semanticTokens, tokenEntries = Object.entries(null != (_flatten = (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.xH)(tokens1)) ? _flatten : {}).map(function(_ref2) {
                ...
                }), semanticTokenEntries = Object.entries(null != (_flatten2 = (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.xH)(semanticTokens, 1)) ? _flatten2 : {}).map(function(_ref3) {
                ...
                }), (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.sq)([].concat(tokenEntries, semanticTokenEntries))), cssVarPrefix = null == (_theme$config = theme1.config) ? void 0 : _theme$config.cssVarPrefix, _createThemeVars = function(flatTokens, options) {
                    for(var cssVars = {}, cssMap = {}, _loop = function() {
                        ...
                        var lookupToken = function(maybeToken) {
                            ...
                            return flatTokens[withScale] ? tokenToCssVar(withScale, null == options ? void 0 : options.cssVarPrefix).reference : maybeToken;
                        ...
                        cssVars = _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1___default()(cssVars, Object.entries(normalizedValue).reduce(function(acc, _ref) {
                            var _conditionAlias, _acc$conditionSelecto, conditionAlias = _ref[0], maybeReference = lookupToken(_ref[1]);
                            return "default" === conditionAlias ? (acc[variable] = maybeReference, acc) : (acc[null != (_conditionAlias = null == pseudoSelectors ? void 0 : pseudoSelectors[conditionAlias]) ? _conditionAlias : conditionAlias] = ((_acc$conditionSelecto = {})[variable] = maybeReference, _acc$conditionSelecto), acc);
                        }, {})), cssMap[token] = {
                            value: reference,
                            var: variable,
                            varRef: reference
                        };
                    }, _i = 0, _Object$entries = Object.entries(flatTokens); _i < _Object$entries.length; _i++)if ("continue" === _loop()) continue;
                    return {
                        cssVars: cssVars,
                        cssMap: cssMap
                    };
                ...
                return Object.assign(theme1, {
                    ...
                    __cssMap: cssMap,
                    __breakpoints: (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.yn)(theme1.breakpoints)
                }), theme1;
            }
            ...
            var propNames = [].concat((0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.Yd)(systemProps), pseudoPropNames), styleProps = _extends({}, systemProps, pseudoSelectors), isStyleProp = function(prop) {
                ...
                var _ref, _getVar2, getVar = function(val) {
                ...
                return function(theme) {
                    var options, _options$configs, configs, _options$pseudos, pseudos, theme1;
                    return (configs = void 0 === (_options$configs = (options = {
                        theme: theme,
                        ...
                        var styles, _styles = (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.Pu)(stylesOrFn, theme1), styles1 = (styles = _styles, function(theme) {
                        ...
                        for(var key in styles1){
                            var key1, value, valueOrFn = styles1[key], value1 = (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.Pu)(valueOrFn, theme1);
                            key in pseudos && (key = pseudos[key]), key1 = key, value = value1, key1.startsWith("--") && (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.HD)(value) && !(0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.FS)(value) && (value1 = resolveTokenValue(theme1, value1));
                            var config = configs[key];
                            if (!0 === config && (config = {
                                property: key
                            }), (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.Kn)(value1)) {
                                computedStyles[key] = null != (_computedStyles$key = computedStyles[key]) ? _computedStyles$key : {}, computedStyles[key] = _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1___default()({}, computedStyles[key], css(value1, !0));
                                continue;
                            }
                            var rawValue = null != (_config$transform = null == (_config = config) ? void 0 : null == _config.transform ? void 0 : _config.transform(value1, theme1, _styles)) ? _config$transform : value1;
                            ...
                            if (configProperty && Array.isArray(configProperty)) {
                                for(var _config$transform, _config, _config2, _config3, _config4, _computedStyles$key, _step, _iterator = _createForOfIteratorHelperLoose(configProperty); !(_step = _iterator()).done;)computedStyles[_step.value] = rawValue;
                                continue;
                            }
                            if (configProperty) {
            ...
            function resolveStyleConfig(config) {
                return function(props) {
                    var _config$baseStyle, breakpointUtil, variant = props.variant, size = props.size, theme = props.theme, recipe = (breakpointUtil = theme.__breakpoints, function(config, prop, value, props) {
                        if (breakpointUtil) {
                            var value1, toArray, result = {}, normalized = (value1 = value, toArray = breakpointUtil.toArrayValue, (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.kJ)(value1) ? value1 : (0, _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_0__.Kn)(value1) ? toArray(value1) : null != value1 ? [
                                value1
                            ] : void 0);
                            if (!normalized) return result;
                            for(var len = normalized.length, isSingle = 1 === len, isMultipart = !!config.parts, _loop = function(i) {
                                var _config$prop, _config$parts, key = breakpointUtil.details[i], nextKey = breakpointUtil.details[function(values, i) {
                                ...
                                return styles ? isMultipart ? (null == (_config$parts = config.parts) || _config$parts.forEach(function(part) {
                                    var _ref, _mergeWith;
                                ...
                                }), "continue") : isMultipart ? void (result[query] = styles) : (isSingle ? _chakra_ui_utils__WEBPACK_IMPORTED_MODULE_1___default()(result, styles) : result[query] = styles, "continue") : "continue";
                            }, i = 0; i < len; i++)if ("continue" === _loop(i)) continue;
                            return result;
                        }
                    });
        ...
        2846: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var createStylesContext = function(componentName) {
                ...
                var colorMode = (0, chakra_ui_color_mode_esm.If)().colorMode;
                return react.createElement(emotion_react_browser_esm.xB, {
                    styles: function(theme) {
                        ...
                        if (globalStyles) return (0, chakra_ui_styled_system_esm.iv)(globalStyles)(theme);
                    }
                });
            };
            ...
            function useStyleConfigImpl(themeKey, props) {
                void 0 === props && (props = {});
                var _styleConfig$defaultP, _props = props, styleConfigProp = _props.styleConfig, rest = _objectWithoutPropertiesLoose(_props, _excluded), _useChakra = _extends({}, (0, chakra_ui_color_mode_esm.If)(), {
                    theme: function() {
                ...
                if (styleConfig) {
                    var styles = (0, chakra_ui_styled_system_esm.Ud)(styleConfig)(mergedProps);
                    react_fast_compare_default()(stylesRef.current, styles) || (stylesRef.current = styles);
                }
        ...
        5031: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            function objectFilter(object, fn) {
                ...
                return Object.keys(object).forEach(function(key) {
                    ...
                    fn(value, key, object) && (result[key] = value);
                }), result;
            }
            ...
            function px(value) {
                var value1, num, unit;
                return null == value ? value : (num = parseFloat((value1 = value).toString()), unit = value1.toString().replace(String(num), ""), {
                    unitless: !unit,
                    value: num,
                    unit: unit
                }).unitless || isNumber(value) ? value + "px" : value;
            }
            ...
            function subtract(value) {
                ...
                var _px, factor = (value = null != (_px = px(value)) ? _px : value).endsWith("px") ? -1 : -0.0635;
            ...
            function analyzeBreakpoints(breakpoints) {
                ...
                var _breakpoints$base, value, normalized = normalize(breakpoints), queries = Object.entries(breakpoints).sort(sortByBreakpointValue).map(function(_ref, index, entry) {
                ...
                }), _keys = (value = Object.keys(sortBps(breakpoints)), new Set(value)), _keysArr = Array.from(_keys.values());
                return {
                    keys: _keys,
            ...
            function isHTMLElement(el) {
                ...
                var _el$ownerDocument$def, win = null != (_el$ownerDocument$def = el.ownerDocument.defaultView) ? _el$ownerDocument$def : window;
            ...
            function isActiveElement(element) {
                return (isHTMLElement(element) ? getOwnerDocument(element) : document).activeElement === element;
            }
            function _arrayLikeToArray(arr, len) {
                (null == len || len > arr.length) && (len = arr.length);
                for(var i = 0, arr2 = Array(len); i < len; i++)arr2[i] = arr[i];
            ...
            function chakra_ui_utils_esm_focus(element, options) {
                ...
                function triggerFocus() {
                    ...
                    if (supportsPreventScroll()) element.focus({
                        ...
                        var element1, scrollableElements = getScrollableElements(element);
            ...
            function restoreScrollPosition(scrollableElements) {
                for(var _step, _iterator = function(o, allowArrayLike) {
                    ...
                    throw TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
                }(scrollableElements); !(_step = _iterator()).done;){
        ...
        3663: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            }, ThemeContext = (0, react.createContext)({}), createCacheWithTheme = weak_memoize_browser_esm(function(outerTheme) {
                return weak_memoize_browser_esm(function(theme) {
                    var outerTheme1, theme1;
                    return outerTheme1 = outerTheme, "function" == typeof (theme1 = theme) ? theme1(outerTheme1) : (0, esm_extends.Z)({}, outerTheme1, theme1);
                });
        ...
        917: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var react__WEBPACK_IMPORTED_MODULE_0___namespace_cache, react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7294);
        ...
        3772: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            var cursor, hash_browser_esm = function(str) {
        ...
        640: function(module, __unused_webpack_exports, __webpack_require__) {
            ...
            module.exports = function(text, options) {
                ...
                try {
                    ...
                    }), document.body.appendChild(mark), range.selectNodeContents(mark), selection.addRange(range), !document.execCommand("copy")) throw Error("copy command was unsuccessful");
                    success = !0;
                } catch (err) {
                    ...
                    try {
                        ...
                        debug && console.error("unable to copy using clipboardData: ", err1), debug && console.error("falling back to prompt"), message1 = (message = "message" in options ? options.message : "Copy to clipboard: #{key}, Enter", copyKey = (/mac os x/i.test(navigator.userAgent) ? "⌘" : "Ctrl") + "+C", message.replace(/#{\s*key\s*}/g, copyKey)), window.prompt(message1, text);
                    }
                } finally{
        ...
        8554: function(module, exports, __webpack_require__) {
            ...
            var uid, func, transform, freeGlobal = "object" == typeof __webpack_require__.g && __webpack_require__.g && __webpack_require__.g.Object === Object && __webpack_require__.g, freeSelf = "object" == typeof self && self && self.Object === Object && self, root = freeGlobal || freeSelf || Function("return this")(), freeExports = exports && !exports.nodeType && exports, freeModule = freeExports && module && !module.nodeType && module, moduleExports = freeModule && freeModule.exports === freeExports, freeProcess = moduleExports && freeGlobal.process, nodeUtil = function() {
                try {
                    var types = freeModule && freeModule.require && freeModule.require("util").types;
                    if (types) return types;
                    return freeProcess && freeProcess.binding && freeProcess.binding("util");
                } catch (e) {}
            }(), nodeIsTypedArray = nodeUtil && nodeUtil.isTypedArray, arrayProto = Array.prototype, funcProto = Function.prototype, objectProto = Object.prototype, coreJsData = root["__core-js_shared__"], funcToString = funcProto.toString, hasOwnProperty = objectProto.hasOwnProperty, maskSrcKey = (uid = /[^.]+$/.exec(coreJsData && coreJsData.keys && coreJsData.keys.IE_PROTO || "")) ? "Symbol(src)_1." + uid : "", nativeObjectToString = objectProto.toString, objectCtorString = funcToString.call(Object), reIsNative = RegExp("^" + funcToString.call(hasOwnProperty).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Buffer = moduleExports ? root.Buffer : void 0, Symbol1 = root.Symbol, Uint8Array = root.Uint8Array, allocUnsafe = Buffer ? Buffer.allocUnsafe : void 0, getPrototype = (func = Object.getPrototypeOf, transform = Object, function(arg) {
            ...
            function getNative(object, key) {
                var object1, key1, value, value1 = (object1 = object, key1 = key, null == object1 ? void 0 : object1[key1]);
                return !(!isObject(value = value1) || isMasked(value)) && (isFunction1(value) ? reIsNative : reIsHostCtor).test(toSource(value)) ? value1 : void 0;
            }
        ...
        1190: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
                ...
                var children = _a.children, initial = _a.initial, isPresent = _a.isPresent, onExitComplete = _a.onExitComplete, custom = _a.custom, presenceAffectsLayout = _a.presenceAffectsLayout, presenceChildren = (0, use_constant.h)(newChildrenMap), id = (0, use_id.M)(), context = (0, react.useMemo)(function() {
                    return {
                        ...
                        onExitComplete: function(childId) {
                            ...
                            try {
                                for(var _b = (0, tslib_es6.XA)(presenceChildren.values()), _c = _b.next(); !_c.done; _c = _b.next())if (!_c.value) return;
                            } catch (e_1_1) {
                                e_1 = {
                                    error: e_1_1
                                };
            ...
            var LayoutGroupContext = __webpack_require__(5364), use_unmount_effect = __webpack_require__(5411), getChildKey = function(child) {
                ...
                var isMounted, _a1, forcedRenderCount, setForcedRenderCount, forceRender, children = _a.children, custom = _a.custom, _b = _a.initial, initial = void 0 === _b || _b, onExitComplete = _a.onExitComplete, exitBeforeEnter = _a.exitBeforeEnter, _c = _a.presenceAffectsLayout, presenceAffectsLayout = void 0 === _c || _c, _d = (0, tslib_es6.CR)((isMounted = useIsMounted(), forcedRenderCount = (_a1 = (0, tslib_es6.CR)((0, react.useState)(0), 2))[0], setForcedRenderCount = _a1[1], forceRender = (0, react.useCallback)(function() {
                ...
                var children1, filtered, isMounted1 = useIsMounted(), filteredChildren = (children1 = children, filtered = [], react.Children.forEach(children1, function(child) {
        ...
        5364: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutGroupContext = (0, __webpack_require__(7294).createContext)({});
        },
        240: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
            ...
            var PresenceContext = (0, __webpack_require__(7294).createContext)(null);
        },
        8970: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
            ...
            var AnimationType, BoundingBoxDimension, tslib_es6 = __webpack_require__(1439), react = __webpack_require__(7294), process = __webpack_require__(9304), createDefinition = function(propNames) {
                return {
            ...
            function resolveVariant(visualElement, definition, custom) {
                var current, velocity, props = visualElement.getProps();
            ...
            var SubscriptionManager = function() {
                ...
                function MotionValue(init) {
                    ...
                    this.version = "6.3.16", this.timeDelta = 0, this.lastUpdated = 0, this.updateSubscribers = new SubscriptionManager(), this.velocityUpdateSubscribers = new SubscriptionManager(), this.renderSubscribers = new SubscriptionManager(), this.canTrackVelocity = !1, this.updateAndNotify = function(v, render) {
                        ...
                        _a.timestamp !== _this.lastUpdated && (_this.prev = _this.current, _this.velocityUpdateSubscribers.notify(_this.getVelocity()));
            ...
            function keyframes({ from =0 , to =1 , ease , offset , duration =300 ,  }) {
                ...
                const state = {
                    ...
                    from,
                    to
                ], times = (offset1 = offset && offset.length === values.length ? offset : function(values) {
            ...
            function startAnimation(key, value, target, transition) {
                return void 0 === transition && (transition = {}), instantAnimationState.current && (transition = {
                    ...
                    var key1, value1, target1, transition1, onComplete1, _a, valueTransition, origin, isTargetAnimatable, isOriginAnimatable, delayTimer, controls, transition2, _a1, _b, animation = (key1 = key, value1 = value, target1 = target, transition1 = transition, onComplete1 = onComplete, origin = null !== (_a = (valueTransition = getValueTransition(transition1, key1)).from) && void 0 !== _a ? _a : value1.get(), isTargetAnimatable = isAnimatable(key1, target1), "none" === origin && isTargetAnimatable && "string" == typeof target1 ? origin = animatable_none_getAnimatableNone(key1, target1) : isZero(origin) && "string" == typeof target1 ? origin = getZeroUnit(target1) : !Array.isArray(target1) && isZero(target1) && "string" == typeof origin && (target1 = getZeroUnit(origin)), isOriginAnimatable = isAnimatable(key1, origin), warning(isOriginAnimatable === isTargetAnimatable, "You are trying to animate ".concat(key1, ' from "').concat(origin, '" to "').concat(target1, '". ').concat(origin, " is not an animatable value - to enable this animation set ").concat(origin, " to a value animatable to ").concat(target1, " via the `style` property.")), isOriginAnimatable && isTargetAnimatable && !1 !== valueTransition.type ? function() {
                        ...
                        return "inertia" === valueTransition.type || "decay" === valueTransition.type ? function({ from =0 , velocity =0 , min , max , power =0.8 , timeConstant =750 , bounceStiffness =500 , bounceDamping =10 , restDelta =1 , modifyTarget , driver , onUpdate , onComplete , onStop ,  }) {
                        ...
                        }((0, tslib_es6.pi)((0, tslib_es6.pi)({}, options3), valueTransition)) : animate((0, tslib_es6.pi)((0, tslib_es6.pi)({}, (transition = valueTransition, options = options3, key = key1, Array.isArray(options.to) && (null !== (_a = transition.duration) && void 0 !== _a || (transition.duration = 0.8)), Array.isArray((options1 = options).to) && null === options1.to[0] && (options1.to = (0, tslib_es6.ev)([], (0, tslib_es6.CR)(options1.to), !1), options1.to[0] = options1.from), (_a1 = transition).when, _a1.delay, _a1.delayChildren, _a1.staggerChildren, _a1.staggerDirection, _a1.repeat, _a1.repeatType, _a1.repeatDelay, _a1.from, Object.keys((0, tslib_es6._T)(_a1, [
                            "when",
                            "delay",
                            "delayChildren",
                            "staggerChildren",
                            ...
                            "repeatDelay",
                            "from", 
                        ])).length || (transition = (0, tslib_es6.pi)((0, tslib_es6.pi)({}, transition), getDefaultTransition(key, options.to))), (0, tslib_es6.pi)((0, tslib_es6.pi)({}, options), (ease1 = (_a2 = transition).ease, times = _a2.times, yoyo = _a2.yoyo, flip = _a2.flip, loop = _a2.loop, transition1 = (0, tslib_es6._T)(_a2, [
                            "ease",
                            "times",
                            "yoyo",
                            "flip",
                            "loop", 
                        ]), options2 = (0, tslib_es6.pi)({}, transition1), times && (options2.offset = times), transition1.duration && (options2.duration = secondsToMilliseconds(transition1.duration)), transition1.repeatDelay && (options2.repeatDelay = secondsToMilliseconds(transition1.repeatDelay)), ease1 && (ease = ease1, options2.ease = Array.isArray(ease) && "number" != typeof ease[0] ? ease1.map(easingDefinitionToFunction) : easingDefinitionToFunction(ease1)), "tween" === transition1.type && (options2.type = "keyframes"), (yoyo || loop || flip) && (warning(!legacyRepeatWarning, "yoyo, loop and flip have been removed from the API. Replace with repeat and repeatType options."), legacyRepeatWarning = !0, yoyo ? options2.repeatType = "reverse" : loop ? options2.repeatType = "loop" : flip && (options2.repeatType = "mirror"), options2.repeat = loop || yoyo || flip || transition1.repeat), "spring" !== transition1.type && (options2.type = "keyframes"), options2)))), {
                            onUpdate: function(v) {
                                var _a;
                                options3.onUpdate(v), null === (_a = valueTransition.onUpdate) || void 0 === _a || _a.call(valueTransition, v);
                            },
                            onComplete: function() {
                                var _a;
                                options3.onComplete(), null === (_a = valueTransition.onComplete) || void 0 === _a || _a.call(valueTransition);
                            }
                        }));
                    } : function() {
                    ...
                    }), delay = null !== (_b = null !== (_a1 = (getValueTransition(transition2 = transition, key) || {}).delay) && void 0 !== _a1 ? _a1 : transition2.delay) && void 0 !== _b ? _b : 0, start = function() {
            ...
            function applyPointDelta(point, translate, scale, originPoint, boxScale) {
                var point1, scale1, originPoint1, point2, scale2, originPoint2;
                return void 0 !== boxScale && (point = (point1 = point, scale1 = boxScale, (originPoint1 = originPoint) + scale1 * (point1 - originPoint1))), point2 = point, scale2 = scale, (originPoint2 = originPoint) + scale2 * (point2 - originPoint2) + translate;
            }
            ...
            function removePointDelta(point, translate, scale, originPoint, boxScale) {
                var point1, scale1, originPoint1, point2, scale2, originPoint2;
                return point -= translate, point = (point1 = point, scale1 = 1 / scale, (originPoint1 = originPoint) + scale1 * (point1 - originPoint1)), void 0 !== boxScale && (point = (point2 = point, scale2 = 1 / boxScale, (originPoint2 = originPoint) + scale2 * (point2 - originPoint2))), point;
            }
            function removeAxisTransforms(axis, transforms, _a, origin, sourceAxis) {
                ...
                !function(axis, translate, scale, origin, boxScale, originAxis, sourceAxis) {
                    if (void 0 === translate && (translate = 0), void 0 === scale && (scale = 1), void 0 === origin && (origin = 0.5), void 0 === originAxis && (originAxis = axis), void 0 === sourceAxis && (sourceAxis = axis), percent.test(translate) && (translate = parseFloat(translate), translate = mix(sourceAxis.min, sourceAxis.max, translate / 100) - sourceAxis.min), "number" == typeof translate) {
            ...
            var NodeStack = function() {
                ...
                return NodeStack.prototype.add = function(node) {
                    ...
                    var prevLead, indexOfNode = this.members.findIndex(function(member) {
                        return node === member;
                    });
                    ...
                    node !== prevLead && (this.prevLead = prevLead, this.lead = node, node.show(), prevLead) && (prevLead.instance && prevLead.scheduleRender(), node.scheduleRender(), node.resumeFrom = prevLead, preserveFollowOpacity && (node.resumeFrom.preserveOpacity = !0), prevLead.snapshot && (node.snapshot = prevLead.snapshot, node.snapshot.latestValues = prevLead.animationValues || prevLead.latestValues, node.snapshot.isShared = !0), (null === (_a = node.root) || void 0 === _a ? void 0 : _a.isUpdating) && (node.isLayoutDirty = !0), !1 === node.options.crossfade && prevLead.hide());
            ...
            function resolveMotionValue(value) {
                var v, unwrappedValue = isMotionValue(value) ? value.get() : value;
                    ...
                    return ProjectionNode.prototype.addEventListener = function(name, handler) {
                        ...
                        if (void 0 === isLayoutDirty && (isLayoutDirty = !1), !this.instance) {
                            ...
                            if (visualElement && !visualElement.getInstance() && visualElement.mount(instance), this.root.nodes.add(this), null === (_a = this.parent) || void 0 === _a || _a.children.add(this), this.id && this.root.potentialNodes.delete(this.id), isLayoutDirty && (layout || layoutId) && (this.isLayoutDirty = !0), attachResizeListener) {
                                var _a, unblockTimeout_1, resizeUnblockUpdate_1 = function() {
                        ...
                        if (this.root.isUpdating || this.root.startUpdate(), !this.isLayoutDirty) {
                            ...
                            for(var _a, _b, _c, i = 0; i < this.path.length; i++){
                        ...
                        if (this.instance && (this.updateScroll(), this.options.alwaysMeasureLayout && this.isLead() || this.isLayoutDirty)) {
                            if (this.resumeFrom && !this.resumeFrom.instance) for(var _a, i = 0; i < this.path.length; i++)this.path[i].updateScroll();
                        ...
                        for(var i = 0; i < this.path.length; i++){
                            ...
                            if (node.instance && hasTransform(node.latestValues)) {
                                ...
                                copyBoxInto(sourceBox, node.measure()), removeBoxTransforms(boxWithoutTransform, node.latestValues, null === (_a = node.snapshot) || void 0 === _a ? void 0 : _a.layout, sourceBox);
                            }
                        }
                        ...
                        var target, relative, parent, _a, _b = this.options, layout = _b.layout, layoutId = _b.layoutId;
                        ...
                        if (this.isTreeAnimating = Boolean((null === (_a = this.parent) || void 0 === _a ? void 0 : _a.isTreeAnimating) || this.currentAnimation || this.pendingAnimation), this.isTreeAnimating || (this.targetDelta = this.relativeTarget = void 0), this.layout && (layout || layoutId)) {
                            ...
                            copyBoxInto(this.layoutCorrected, this.layout.actual), function(box, treeScale, treePath, isSharedTransition) {
                                ...
                                var _a, _b, node, delta, treeLength = treePath.length;
                                if (treeLength) {
                        ...
                        this.animationProgress = 0, this.mixTargetDelta = function(latest) {
                            ...
                            mixAxisDelta(targetDelta.x, delta.x, progress), mixAxisDelta(targetDelta.y, delta.y, progress), _this.setTargetDelta(targetDelta), _this.relativeTarget && _this.relativeTargetOrigin && _this.layout && (null === (_a = _this.relativeParent) || void 0 === _a ? void 0 : _a.layout) && (calcRelativePosition(relativeLayout, _this.layout.actual, _this.relativeParent.layout.actual), mixBox(_this.relativeTarget, _this.relativeTargetOrigin, relativeLayout, progress)), isSharedLayoutAnimation && (_this.animationValues = mixedValues, function(target, follow, lead, progress, shouldCrossfadeOpacity, isOnlyMember) {
                                ...
                                for(var i = 0; i < numBorders; i++){
                                    ...
                                    (void 0 !== followRadius || void 0 !== leadRadius) && (followRadius || (followRadius = 0), leadRadius || (leadRadius = 0), 0 === followRadius || 0 === leadRadius || isPx(followRadius) === isPx(leadRadius) ? (target[borderLabel] = Math.max(mix(asNumber(followRadius), asNumber(leadRadius), progress), 0), (percent.test(leadRadius) || percent.test(followRadius)) && (target[borderLabel] += "%")) : target[borderLabel] = leadRadius);
                                }
                        ...
                        var _a, _b, _c;
                        this.sharedNodes.has(layoutId) || this.sharedNodes.set(layoutId, new NodeStack()), this.sharedNodes.get(layoutId).add(node), node.promote({
                        ...
                        var _a;
                        return this.options.layoutId && (null === (_a = this.getStack()) || void 0 === _a ? void 0 : _a.lead) || this;
                    }, ProjectionNode.prototype.getPrevLead = function() {
                        var _a;
                        return this.options.layoutId ? null === (_a = this.getStack()) || void 0 === _a ? void 0 : _a.prevLead : void 0;
            ...
            function mountNodeEarly(node, id) {
                ...
                var element = (searchNode && searchNode !== node.root ? searchNode.instance : document).querySelector('[data-projection-id="'.concat(id, '"]'));
            ...
            function buildHTMLStyles(state, latestValues, options, transformTemplate) {
                var _a, _b, _c, _d, _a1, style = state.style, vars = state.vars, transform = state.transform, transformKeys = state.transformKeys, transformOrigin = state.transformOrigin;
                ...
                for(var key in latestValues){
                    ...
                    var value1, type, valueType = numberValueTypes[key], valueAsType = (value1 = value, (type = valueType) && "number" == typeof value1 ? type.transform(value1) : value1);
                    if (isTransformProp(key)) {
                        if (hasTransform = !0, transform[key] = valueAsType, transformKeys.push(key), !transformIsNone) continue;
                        value !== (null !== (_a1 = valueType.default) && void 0 !== _a1 ? _a1 : 0) && (transformIsNone = !1);
                    } else isTransformOriginProp(key) ? (transformOrigin[key] = valueAsType, hasTransformOrigin = !0) : style[key] = valueAsType;
                }
                hasTransform ? style.transform = function(_a, _b, transformIsDefault, transformTemplate) {
                ...
                }(state, options, transformIsNone, transformTemplate) : transformTemplate ? style.transform = transformTemplate({}, "") : !latestValues.transform && style.transform && (style.transform = "none"), hasTransformOrigin && (style.transformOrigin = (_b = (_a = transformOrigin).originX, _c = _a.originY, _d = _a.originZ, "".concat(void 0 === _b ? "50%" : _b, " ").concat(void 0 === _c ? "50%" : _c, " ").concat(void 0 === _d ? 0 : _d)));
            }
            ...
            function buildSVGAttrs(state, _a, options, transformTemplate) {
                var dimensions, originX, originY, pxOriginX, pxOriginY, attrs, length, spacing, offset, useDashCase, keys, pathLength, pathSpacing, attrX = _a.attrX, attrY = _a.attrY, originX1 = _a.originX, originY1 = _a.originY, pathLength1 = _a.pathLength, _b = _a.pathSpacing, _c = _a.pathOffset, latest = (0, tslib_es6._T)(_a, [
                    "attrX",
                    "attrY",
                    "originX",
                    "originY",
                ...
                var attrs1 = state.attrs, style = state.style, dimensions1 = state.dimensions;
                attrs1.transform && (dimensions1 && (style.transform = attrs1.transform), delete attrs1.transform), dimensions1 && (void 0 !== originX1 || void 0 !== originY1 || style.transform) && (style.transformOrigin = (dimensions = dimensions1, originX = void 0 !== originX1 ? originX1 : 0.5, originY = void 0 !== originY1 ? originY1 : 0.5, pxOriginX = calcOrigin(originX, dimensions.x, dimensions.width), pxOriginY = calcOrigin(originY, dimensions.y, dimensions.height), "".concat(pxOriginX, " ").concat(pxOriginY))), void 0 !== attrX && (attrs1.x = attrX), void 0 !== attrY && (attrs1.y = attrY), void 0 !== pathLength1 && (attrs = attrs1, length = pathLength1, spacing = void 0 === _b ? 1 : _b, offset = void 0 === _c ? 0 : _c, void 0 === spacing && (spacing = 1), void 0 === offset && (offset = 0), useDashCase = !1, attrs.pathLength = 1, attrs[(keys = useDashCase ? dashKeys : camelKeys).offset] = px.transform(-offset), pathLength = px.transform(length), pathSpacing = px.transform(spacing), attrs[keys.array] = "".concat(pathLength, " ").concat(pathSpacing));
            }
            ...
            function scrape_motion_values_scrapeMotionValuesFromProps(props) {
                ...
                for(var key in props)isMotionValue(props[key]) && (newValues["x" === key || "y" === key ? "attr" + key.toUpperCase() : key] = props[key]);
                return newValues;
            }
            ...
            function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
                ...
                return variantToSet && "boolean" != typeof variantToSet && !isAnimationControls(variantToSet) && (Array.isArray(variantToSet) ? variantToSet : [
                    variantToSet
            ...
            var isValidProp, AnimationType1, svgMotionConfig = {
            ...
            var wrapHandler = function(handler, shouldFilterPrimaryPointer) {
                ...
                var eventHandler, listener = function(event) {
                    return handler(event, extractEventInfo(event));
                };
                return shouldFilterPrimaryPointer ? (eventHandler = listener, function(event) {
                    var isMouseEvent = event instanceof MouseEvent;
                    (!isMouseEvent || isMouseEvent && 0 === event.button) && eventHandler(event);
                }) : listener;
            }, mouseEventNames = {
            ...
            function useIntersectionObserver(shouldObserve, state, visualElement, _a) {
                ...
                (0, react.useEffect)(function() {
                    if (shouldObserve) {
                        var element, options, callback, _a, root1, options1, lookupRoot, rootObservers, key, rootInteresectionObserver, options2 = {
                        ...
                        return element = visualElement.getInstance(), options = options2, callback = intersectionCallback, rootInteresectionObserver = (root1 = (_a = options).root, options1 = (0, tslib_es6._T)(_a, [
                            "root"
                        ]), lookupRoot = root1 || document, observers.has(lookupRoot) || observers.set(lookupRoot, {}), (rootObservers = observers.get(lookupRoot))[key = JSON.stringify(options1)] || (rootObservers[key] = new IntersectionObserver(fireAllObserverCallbacks, (0, tslib_es6.pi)({
                            root: root1
                        }, options1))), rootObservers[key]), observerCallbacks.set(element, callback), rootInteresectionObserver.observe(element), function() {
                ...
                (0, react.useEffect)(function() {
                    if (shouldObserve && fallback) {
                        ...
                        requestAnimationFrame(function() {
                            ...
                            var _a, onViewportEnter = visualElement.getProps().onViewportEnter;
            ...
            function getOriginFromTransition(key, transition) {
                if (transition) return (transition[key] || transition.default || transition).from;
            }
            function animateVariant(visualElement, variant, options) {
                void 0 === options && (options = {});
                var _a, resolved = resolveVariant(visualElement, variant, options.custom), _b = (resolved || {}).transition, transition = void 0 === _b ? visualElement.getDefaultTransition() || {} : _b;
            ...
            var animations = {
                    ...
                    visualElement.animationState || (visualElement.animationState = function(visualElement) {
                            ...
                            return Promise.all(animations.map(function(_a) {
                                ...
                                return function(visualElement, definition, options) {
                                    if (void 0 === options && (options = {}), visualElement.notifyAnimationStart(definition), Array.isArray(definition)) {
                                        var animation;
                                        animation = Promise.all(definition.map(function(variant) {
                        ...
                        return {
                            ...
                            setActive: function(type, isActive, options) {
                                ...
                                var _a, animations = animateChanges(options, type);
                ...
                exit: makeRenderlessComponent(function(props) {
                    ...
                    (0, react.useEffect)(function() {
                        ...
                        var _a, _b, animation = null === (_a = visualElement.animationState) || void 0 === _a ? void 0 : _a.setActive(AnimationType.Exit, !isPresent, {
            ...
            var elementDragControls = new WeakMap(), VisualElementDragControls = function() {
                ...
                return VisualElementDragControls.prototype.start = function(originEvent, _a) {
                    ...
                    var _a, _b;
                    this.isDragging = !1, this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !1), null === (_a = this.panSession) || void 0 === _a || _a.end(), this.panSession = void 0, !this.getProps().dragPropagation && this.openGlobalLock && (this.openGlobalLock(), this.openGlobalLock = null), null === (_b = this.visualElement.animationState) || void 0 === _b || _b.setActive(AnimationType.Drag, !1);
                }, VisualElementDragControls.prototype.updateAxis = function(axis, _point, offset) {
                    var drag = this.getProps().drag;
                    if (offset && shouldDrag(axis, drag, this.currentDirection)) {
                        var point, _a, elastic, min, max, axisValue = this.getAxisMotionValue(axis), next = this.originPoint[axis] + offset[axis];
                        this.constraints && this.constraints[axis] && (next = (point = next, _a = this.constraints[axis], elastic = this.elastic[axis], min = _a.min, max = _a.max, void 0 !== min && point < min ? point = elastic ? mix(min, point, elastic.min) : Math.max(point, min) : void 0 !== max && point > max && (point = elastic ? mix(max, point, elastic.max) : Math.min(point, max)), point)), axisValue.set(next);
                    }
                }, VisualElementDragControls.prototype.resolveConstraints = function() {
                    var layoutBox, _a, top, left, bottom, right, dragElastic, _this = this, _a1 = this.getProps(), dragConstraints = _a1.dragConstraints, dragElastic1 = _a1.dragElastic, layout = (this.visualElement.projection || {}).layout, prevConstraints = this.constraints;
                    dragConstraints && isRefObject(dragConstraints) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : dragConstraints && layout ? this.constraints = (layoutBox = layout.actual, top = (_a = dragConstraints).top, left = _a.left, bottom = _a.bottom, right = _a.right, {
                        x: calcRelativeAxisConstraints(layoutBox.x, left, right),
                        y: calcRelativeAxisConstraints(layoutBox.y, top, bottom)
                    }) : this.constraints = !1, this.elastic = (void 0 === (dragElastic = dragElastic1) && (dragElastic = 0.35), !1 === dragElastic ? dragElastic = 0 : !0 === dragElastic && (dragElastic = 0.35), {
                    ...
                    var element, rootProjectionNode, viewportBox, scroll, layoutBox, constraintsBox, constraintsBox1 = (element = constraintsElement, rootProjectionNode = projection.root, viewportBox = measureViewportBox(element, this.visualElement.getTransformPagePoint()), (scroll = rootProjectionNode.scroll) && (translateAxis(viewportBox.x, scroll.x), translateAxis(viewportBox.y, scroll.y)), viewportBox), measuredConstraints = (layoutBox = projection.layout.actual, constraintsBox = constraintsBox1, {
                    ...
                    var _this = this, _a = this.getProps(), drag = _a.drag, dragMomentum = _a.dragMomentum, dragElastic = _a.dragElastic, dragTransition = _a.dragTransition, dragSnapToOrigin = _a.dragSnapToOrigin, onDragTransitionEnd = _a.onDragTransitionEnd, constraints = this.constraints || {};
                    return Promise.all(eachAxis(function(axis) {
                        if (shouldDrag(axis, drag, _this.currentDirection)) {
                            var _a, transition = null !== (_a = null == constraints ? void 0 : constraints[axis]) && void 0 !== _a ? _a : {};
                    ...
                    var _a, _b, dragKey = "_drag" + axis.toUpperCase();
                    return this.visualElement.getProps()[dragKey] || this.visualElement.getValue(axis, null !== (_b = null === (_a = this.visualElement.getProps().initial) || void 0 === _a ? void 0 : _a[axis]) && void 0 !== _b ? _b : 0);
                }, VisualElementDragControls.prototype.snapToCursor = function(point) {
                    var _this = this;
                    eachAxis(function(axis) {
                        if (shouldDrag(axis, _this.getProps().drag, _this.currentDirection)) {
                    ...
                    var _a, _this = this, _b = this.getProps(), drag = _b.drag, dragConstraints = _b.dragConstraints, projection = this.visualElement.projection;
                    if (isRefObject(dragConstraints) && projection && this.constraints) {
                        ...
                        eachAxis(function(axis) {
                            ...
                            if (axisValue) {
                                var source, target, origin, sourceLength, targetLength, latest = axisValue.get();
                    ...
                    var stopPointerListener = addPointerEvent(this.visualElement.getInstance(), "pointerdown", function(event) {
                        var _a = _this.getProps(), drag = _a.drag, _b = _a.dragListener;
                        drag && (void 0 === _b || _b) && _this.start(event);
                    }), measureDragConstraints = function() {
                        isRefObject(_this.getProps().dragConstraints) && (_this.constraints = _this.resolveRefConstraints());
            ...
            var drag = {
                ...
                return function(_a, options) {
                    var instance, removeFromVariantTree, parent = _a.parent, props = _a.props, presenceId = _a.presenceId, blockInitialAnimation = _a.blockInitialAnimation, visualState = _a.visualState, shouldReduceMotion = _a.shouldReduceMotion;
                    void 0 === options && (options = {});
                    var managers, propSubscriptions, lifecycles, isMounted = !1, latestValues = visualState.latestValues, renderState = visualState.renderState, lifecycles1 = (managers = names.map(function() {
                    ...
                    }), lifecycles), values = new Map(), valueSubscriptions = new Map(), prevMotionValues = {}, baseTarget = (0, tslib_es6.pi)({}, latestValues);
                    function render() {
            ...
            var BoundingBoxDimension1, positionalKeys = new Set([
                "width",
                "height",
                "top",
                "left",
            ...
            var getPosFromMatrix = function(matrix, pos) {
                ...
                top: function(_bbox, _a) {
                    return parseFloat(_a.top);
                },
                left: function(_bbox, _a) {
                    return parseFloat(_a.left);
                },
                bottom: function(_a, _b) {
                    var y = _a.y;
                    return parseFloat(_b.top) + (y.max - y.min);
                },
                right: function(_a, _b) {
                    var x = _a.x;
                    return parseFloat(_b.left) + (x.max - x.min);
                },
                x: getTranslateFromMatrix(4, 13),
                y: getTranslateFromMatrix(5, 14)
            }, convertChangedValueTypes = function(target, visualElement, changedKeys) {
                var originBbox = visualElement.measureViewportBox(), elementComputedStyle = getComputedStyle(visualElement.getInstance()), display = elementComputedStyle.display, origin = {};
                ...
                if (targetPositionalKeys.forEach(function(key) {
                    var toType, value = visualElement.getValue(key);
                    if (visualElement.hasValue(key)) {
                        var from = origin[key], fromType = findDimensionValueType(from), to = target[key];
                        ...
                        if (fromType !== toType) {
                            if (isNumOrPxType(fromType) && isNumOrPxType(toType)) {
                                var visualElement1, removedTransforms, current = value.get();
                            ...
                            } else (null == fromType ? void 0 : fromType.transform) && (null == toType ? void 0 : toType.transform) && (0 === from || 0 === to) ? 0 === from ? value.set(toType.transform(from)) : target[key] = fromType.transform(to) : (hasAttemptedToRemoveTransformValues || (removedTransformValues = (visualElement1 = visualElement, removedTransforms = [], nonTranslationalTransformKeys.forEach(function(key) {
                                var value = visualElement1.getValue(key);
                                void 0 !== value && (removedTransforms.push([
                                    key,
                                    value.get()
                                ]), value.set(key.startsWith("scale") ? 1 : 0));
                            }), removedTransforms.length && visualElement1.syncRender(), removedTransforms), hasAttemptedToRemoveTransformValues = !0), changedValueTypeKeys.push(key), transitionEnd[key] = void 0 !== transitionEnd[key] ? transitionEnd[key] : target[key], setAndResetVelocity(value, to));
                        }
                    }
                ...
                var visualElement1, target1, origin1, transitionEnd1, resolved = function(visualElement, _a, transitionEnd) {
                ...
                measureViewportBox: function(element, _a) {
                    return measureViewportBox(element, _a.transformPagePoint);
                },
                    ...
                    if (transformValues && (transitionEnd && (transitionEnd = transformValues(transitionEnd)), target && (target = transformValues(target)), origin && (origin = transformValues(origin))), isMounted) {
                        !function(visualElement, target, origin) {
                            ...
                            if (numNewValues) for(var i = 0; i < numNewValues; i++){
                                var v, v1, v2, key = newValueKeys[i], targetValue = target[key], value = null;
                                Array.isArray(targetValue) && (value = targetValue[0]), null === value && (value = null !== (_b = null !== (_a = origin[key]) && void 0 !== _a ? _a : visualElement.readValue(key)) && void 0 !== _b ? _b : target[key]), null != value && ("string" == typeof value && (v = value, /^\-?\d*\.?\d+$/.test(v) || (v1 = value, /^0[^.\s]+$/.test(v1))) ? value = parseFloat(value) : (v2 = value, !valueTypes.find(testValueType(v2)) && complex.test(targetValue) && (value = animatable_none_getAnimatableNone(key, targetValue))), visualElement.addValue(key, motionValue(value)), null !== (_c = (_d = origin)[key]) && void 0 !== _c || (_d[key] = value), visualElement.setBaseTarget(key, value));
                            }
            ...
            var correctBorderRadius = {
                ...
                function custom(Component, customMotionComponentConfig) {
                    ...
                    return void 0 === customMotionComponentConfig && (customMotionComponentConfig = {}), preloadedFeatures = (_a = createConfig(Component, customMotionComponentConfig)).preloadedFeatures, createVisualElement = _a.createVisualElement, projectionNodeConstructor = _a.projectionNodeConstructor, useRender = _a.useRender, useVisualState = _a.useVisualState, Component1 = _a.Component, preloadedFeatures && function(features) {
                        ...
                        var projectionId, _a, visualElement, ProjectionNodeConstructor, _b, layoutId, layout, drag, dragConstraints, layoutScroll, initialPromotionConfig, _b1, layoutId1, layoutGroupId, Component, visualState, props1, createVisualElement1, lazyContext, parent, presenceContext, reducedMotionPreference, reducedMotion, shouldReduceMotion, visualElementRef, visualElement1, visualState1, visualElement2, externalRef1, layoutId2 = (layoutId1 = props.layoutId, (layoutGroupId = null === (_b1 = (0, react.useContext)(LayoutGroupContext.p)) || void 0 === _b1 ? void 0 : _b1.id) && void 0 !== layoutId1 ? layoutGroupId + "-" + layoutId1 : layoutId1);
                        props = (0, tslib_es6.pi)((0, tslib_es6.pi)({}, props), {
                            layoutId: layoutId2
                        });
                        var _a1, initial, animate, config = (0, react.useContext)(MotionConfigContext), features = null, context = (initial = (_a1 = function(props, context) {
                        ...
                        }(props, (0, react.useContext)(MotionContext))).initial, animate = _a1.animate, (0, react.useMemo)(function() {
                            return {
                                initial: initial,
                                animate: animate
                            };
                        ...
                        ])), projectionId1 = config.isStatic ? void 0 : (0, use_constant.h)(function() {
                            if (globalProjectionState.hasEverUpdated) return id++;
                        }), visualState2 = useVisualState(props, config.isStatic);
                        return !config.isStatic && is_browser.j && (context.visualElement = (Component = Component1, visualState = visualState2, props1 = (0, tslib_es6.pi)((0, tslib_es6.pi)({}, config), props), createVisualElement1 = createVisualElement, lazyContext = (0, react.useContext)(LazyContext), parent = (0, react.useContext)(MotionContext).visualElement, presenceContext = (0, react.useContext)(PresenceContext.O), shouldReduceMotion = (reducedMotionPreference = (hasDetected || function() {
                            ...
                            shouldReduceMotion: shouldReduceMotion
                        })), visualElement1 = visualElementRef.current, (0, use_isomorphic_effect.L)(function() {
                            null == visualElement1 || visualElement1.syncRender();
                        }), (0, react.useEffect)(function() {
                            var _a;
                            null === (_a = null == visualElement1 ? void 0 : visualElement1.animationState) || void 0 === _a || _a.animateChanges();
                        }), (0, use_isomorphic_effect.L)(function() {
                            return function() {
                                return null == visualElement1 ? void 0 : visualElement1.notifyUnmount();
                            };
                        }, []), visualElement1), projectionId = projectionId1, _a = props, visualElement = context.visualElement, ProjectionNodeConstructor = projectionNodeConstructor || featureDefinitions.projectionNodeConstructor, layoutId = _a.layoutId, layout = _a.layout, drag = _a.drag, dragConstraints = _a.dragConstraints, layoutScroll = _a.layoutScroll, initialPromotionConfig = (0, react.useContext)(SwitchLayoutGroupContext), !ProjectionNodeConstructor || !visualElement || (null == visualElement ? void 0 : visualElement.projection) || (visualElement.projection = new ProjectionNodeConstructor(projectionId, visualElement.getLatestValues(), null === (_b = visualElement.parent) || void 0 === _b ? void 0 : _b.projection), visualElement.projection.setOptions({
                            layoutId: layoutId,
                            layout: layout,
                            ...
                            return features;
                        }(props, context.visualElement, preloadedFeatures)), react.createElement(VisualElementHandler, {
                            visualElement: context.visualElement,
                            props: (0, tslib_es6.pi)((0, tslib_es6.pi)({}, config), props)
                        }, features, react.createElement(MotionContext.Provider, {
                            value: context
                        }, useRender(Component1, props, projectionId1, (visualState1 = visualState2, visualElement2 = context.visualElement, externalRef1 = externalRef, (0, react.useCallback)(function(instance) {
                            var _a;
                            instance && (null === (_a = visualState1.mount) || void 0 === _a || _a.call(visualState1, instance)), visualElement2 && (instance ? visualElement2.mount(instance) : visualElement2.unmount()), externalRef1 && ("function" == typeof externalRef1 ? externalRef1(instance) : isRefObject(externalRef1) && (externalRef1.current = instance));
                        }, [
                            visualElement2
                        ])), visualState2, config.isStatic, context.visualElement)));
                    });
                }
                ...
                return Component1 = Component, _a = config, preloadedFeatures = featureBundle, createVisualElement = function(Component, options) {
                    ...
                    useRender: (void 0 === (forwardMotionProps = void 0 !== _b && _b) && (forwardMotionProps = !1), function(Component, props, projectionId, ref, _a, isStatic) {
                        var latestValues = _a.latestValues, visualProps = (isSVGComponent(Component) ? useSVGProps : useHTMLProps)(props, latestValues, isStatic), filteredProps = function(props, isDom, forwardMotionProps) {
                            var filteredProps = {};
        ...
        8868: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
            ...
            var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7294), useIsomorphicLayoutEffect = __webpack_require__(1741).j ? react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_0__.useEffect;
        },
