...
var module_compiled = __webpack_require__(93);
...
const createHmacString = (privateKey, message)=>{
    const key = external_crypto_js_namespaceObject.enc.Utf8.parse(privateKey);
    const timestamp = external_crypto_js_namespaceObject.enc.Utf8.parse(message);
    const hmac = external_crypto_js_namespaceObject.enc.Hex.stringify((0,external_crypto_js_namespaceObject.HmacSHA256)(timestamp, key));
    return hmac;
};
...
var __webpack_exports__ = __webpack_require__.X(0, [209], () => (__webpack_exec__(989)));
