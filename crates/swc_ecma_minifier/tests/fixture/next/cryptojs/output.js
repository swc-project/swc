export default function(r, t, e) {
    ...
    r.exports = (n = e(8249), o = Math, a = (s = n.lib).WordArray, i = s.Hasher, h = n.algo, c = [], l = [], function() {
        function r(r) {
        ...
        _doProcessBlock: function(r, t) {
            for(var e = this._hash.words, n = e[0], o = e[1], s = e[2], a = e[3], i = e[4], h = e[5], c = e[6], u = e[7], _ = 0; _ < 64; _++){
                ...
                var w = i & h ^ ~i & c, A = n & o ^ n & s ^ o & s, g = (n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22), y = u + ((i << 26 | i >>> 6) ^ (i << 21 | i >>> 11) ^ (i << 7 | i >>> 25)) + w + l[_] + f[_], B = g + A;
                u = c, c = h, h = i, i = a + y | 0, a = s, s = o, o = n, n = y + B | 0;
            }
        ...
        _doFinalize: function() {
            ...
            return t[n >>> 5] |= 0x80 << 24 - n % 32, t[(n + 64 >>> 9 << 4) + 14] = o.floor(e / 0x100000000), t[(n + 64 >>> 9 << 4) + 15] = e, r.sigBytes = 4 * t.length, this._process(), this._hash;
        },
        clone: function() {
            var r = i.clone.call(this);
            return r._hash = this._hash.clone(), r;
        }
    }), n.SHA256 = i._createHelper(u), n.HmacSHA256 = i._createHmacHelper(u), n.SHA256);
}
