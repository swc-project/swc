...
exports.modules = {
    /***/ 4622: /***/ function(e, t, n) {
        ...
        function h(e, t) {
            var n = function(e) {
                ...
                if (t && -1 !== t.lastIndexOf(".") && !e.type) {
                    var n = t.split(".").pop().toLowerCase(), i = T.get(n);
        ...
        var M = "file-invalid-type", L = "file-too-large", q = "file-too-small", et = "too-many-files", _ = function(e) {
        ...
        var er = [
            ...
            var n = e.children, b = de(l(e, er)), R = b.open, T = l(b, eo);
            return i.useImperativeHandle(t, function() {
                ...
                R
            ]), w.default.createElement(i.Fragment, null, n(c(c({}, T), {}, {
                open: R
            })));
        });
        ec.displayName = "Dropzone";
        var eu = {
            disabled: !1,
        ...
        ec.defaultProps = eu, ec.propTypes = {
            children: R.default.func,
            accept: R.default.objectOf(R.default.arrayOf(R.default.string)),
            multiple: R.default.bool,
            preventDropOnDocument: R.default.bool,
            noClick: R.default.bool,
            noKeyboard: R.default.bool,
            noDrag: R.default.bool,
            noDragEventsBubbling: R.default.bool,
            minSize: R.default.number,
            maxSize: R.default.number,
            maxFiles: R.default.number,
            disabled: R.default.bool,
            getFilesFromEvent: R.default.func,
            onFileDialogCancel: R.default.func,
            onFileDialogOpen: R.default.func,
            useFsAccessApi: R.default.bool,
            autoFocus: R.default.bool,
            onDragEnter: R.default.func,
            onDragLeave: R.default.func,
            onDragOver: R.default.func,
            onDrop: R.default.func,
            onDropAccepted: R.default.func,
            onDropRejected: R.default.func,
            onError: R.default.func,
            validator: R.default.func
        };
        var el = {
            isFocused: !1,
        ...
        function de() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = c(c({}, eu), e), n = t.accept, b = t.disabled, w = t.getFilesFromEvent, R = t.maxSize, T = t.minSize, I = t.multiple, M = t.maxFiles, L = t.onDragEnter, q = t.onDragLeave, et = t.onDragOver, er = t.onDrop, eo = t.onDropAccepted, ec = t.onDropRejected, es = t.onFileDialogCancel, ef = t.onFileDialogOpen, ep = t.useFsAccessApi, ed = t.autoFocus, ev = t.preventDropOnDocument, em = t.noClick, eg = t.noKeyboard, ey = t.noDrag, eb = t.noDragEventsBubbling, eh = t.onError, eD = t.validator, ew = i.useMemo(function() {
                return te(n);
            }, [
                n
                ...
                n
            ]), eA = i.useMemo(function() {
                return "function" == typeof ef ? ef : me;
            }, [
                ef
            ]), eO = i.useMemo(function() {
                return "function" == typeof es ? es : me;
            }, [
                es
            ]), eF = i.useRef(null), ej = i.useRef(null), ek = s(i.useReducer(ve, el), 2), eE = ek[0], eP = ek[1], eC = eE.isFocused, eS = eE.isFileDialogActive, ez = i.useRef("undefined" != typeof window && window.isSecureContext && ep && Z()), ie = function() {
            ...
            var eT = i.useCallback(function(e) {
                ...
                e.forEach(function(e) {
                    ...
                    fileRejections: i,
                    type: "setFiles"
                }), er && er(n, i, t), i.length > 0 && ec && ec(i, t), n.length > 0 && eo && eo(n, t);
            }, [
                eP,
                I,
                ew,
                ...
                return function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.refKey, n = e.role, i = e.onKeyDown, w = e.onFocus, R = e.onBlur, T = e.onClick, I = e.onDragEnter, M = e.onDragOver, L = e.onDragLeave, q = e.onDrop, et = l(e, ei);
                    return c(c(u({
                        onKeyDown: Oe(X(i, e$)),
                        onFocus: Oe(X(w, eX)),
                        onBlur: Oe(X(R, eH)),
                ...
                ey,
                b
            ]), eW = i.useCallback(function(e) {
                e.stopPropagation();
            }, []), eG = i.useMemo(function() {
                return function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.refKey, n = e.onChange, i = e.onClick, b = l(e, ea);
                    return c(c({}, u({
                        accept: ew,
                        multiple: I,
                        type: "file",
        ...
        t.ErrorCode = {
            ...
            FileTooSmall: q,
            TooManyFiles: et
        }, t.default = ec, t.useDropzone = de, Object.defineProperty(t, "__esModule", {
            value: !0
        });
    /***/ }
};
