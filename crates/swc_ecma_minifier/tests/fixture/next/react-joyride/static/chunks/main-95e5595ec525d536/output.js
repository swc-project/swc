            ...
            function fetchNextData(param) {
                ...
                const getData = (params)=>{
                    return fetchRetry(dataHref, isServerRender ? 3 : 1, {
                        ...
                        if (!unstable_skipClientCache) delete inflightCache[cacheKey];
                        if ("Failed to fetch" === err.message) _routeLoader.markAssetError(err);
                        throw err;
                    });
                };
            ...
            class Router {
                ...
                change(method, url, as, options, forcedScroll) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        const parsedAsPathname = as.startsWith("/") && _parseRelativeUrl.parseRelativeUrl(as).pathname;
                        const isMiddlewareRewrite = !!(parsedAsPathname && route !== parsedAsPathname && (!_isDynamic.isDynamicRoute(route) || !_routeMatcher.getRouteMatcher(_routeRegex.getRouteRegex(route))(parsedAsPathname)));
                ...
                getRouteInfo(param) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        try {
                            ...
                            if (isQueryUpdating) data.json = self.__NEXT_DATA__.props;
                            handleCancelled();
                            ...
                            if ((null == data ? void 0 : null == (ref5 = data.effect) ? void 0 : ref5.type) === "rewrite") {
                                const resolvedRoute = _removeTrailingSlash.removeTrailingSlash(data.effect.resolvedHref);
                            ...
                            if (false) ;
                            const wasBailedPrefetch = null == data ? void 0 : null == (ref6 = data.response) ? void 0 : ref6.headers.get("x-middleware-skip");
                            const shouldFetchData = routeInfo.__N_SSG || routeInfo.__N_SSP;
                            if (wasBailedPrefetch) delete _this.sdc[null == data ? void 0 : data.dataHref];
                ...
                prefetch(url) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        if ((null == data ? void 0 : data.effect.type) === "redirect-external") {
                            return;
                        }
