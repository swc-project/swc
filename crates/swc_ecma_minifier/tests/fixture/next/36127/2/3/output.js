export class Text {
    ...
    eq(t) {
        ...
        for(let l = e, r = e;;){
            ...
            h.next(l);
            l = 0;
            if (i.lineBreak != h.lineBreak || i.done != h.done || i.value != h.value) return !1;
            r += i.value.length;
            if (i.done || r >= n) return !0;
        }
    }
    iter(t = 1) {
        return new s(this, t);
...
class t extends Text {
    ...
    sliceString(t, e = this.length, n = "\n") {
        ...
        for(let s = 0, h = 0; s <= e && h < this.text.length; h++){
            ...
            s > t && h && (i += n);
            t < r && e > s && (i += l.slice(Math.max(0, t - s), e - s));
            s = r + 1;
        }
        return i;
    }
...
class e extends Text {
        ...
        if (i.lines < this.lines) for(let s = 0, h = 0; s < this.children.length; s++){
            ...
            if (t >= h && n <= r) {
                ...
                if (o.lines < f >> 4 && o.lines > f >> 6) {
                    ...
                    u[s] = o;
                    return new e(u, this.length - (n - t) + i.length);
                }
    ...
    sliceString(t, e = this.length, n = "\n") {
        ...
        for(let s = 0, h = 0; s < this.children.length && h <= e; s++){
            let l = this.children[s], r = h + l.length;
            h > t && s && (i += n);
            t < r && e > h && (i += l.sliceString(t - h, e - h, n));
            h = r + 1;
        }
        return i;
    }
    ...
    static from(n, i = n.reduce((t, e)=>t + e.length + 1, -1)) {
        ...
        function d(n) {
            ...
            if (n.lines > f && n instanceof e) for (let s of n.children)d(s);
                ...
                x();
                c.push(n);
            } else if (n instanceof t && a && (i = p[p.length - 1]) instanceof t && n.lines + i.lines <= 32) {
                a += n.lines;
                g += n.length + 1;
                p[p.length - 1] = new t(i.text.concat(n.text), i.length + 1 + n.length);
            } else {
                a + n.lines > o && x();
                a += n.lines;
                g += n.length + 1;
        ...
        function x() {
            if (0 != a) {
                c.push(1 == p.length ? p[0] : e.from(p, g));
                g = -1;
                a = p.length = 0;
            }
        }
    ...
    nextInner(e, n) {
        ...
        for(;;){
            ...
            if (l == (n > 0 ? r : 0)) {
                ...
                this.offsets[i] += n;
                if (o.length > Math.max(0, e)) {
                    this.value = 0 == e ? o : n > 0 ? o.slice(e) : o.slice(0, o.length - e);
                    return this;
                }
                e -= o.length;
            } else {
                ...
                if (e > f.length) {
                    ...
                    n < 0 && this.offsets[i]--;
                    this.nodes.push(f);
                    this.offsets.push(n > 0 ? 1 : (f instanceof t ? f.text.length : f.children.length) << 1);
                }
            }
        }
    }
