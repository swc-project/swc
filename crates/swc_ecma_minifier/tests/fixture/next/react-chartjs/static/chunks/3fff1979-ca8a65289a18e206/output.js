...
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([
    ...
    ],
    {
        6775: function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
            ...
            var _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2454);
            class Animator {
                constructor(){
                    this._request = null;
            ...
            function applyStack(stack, value, dsIndex, options = {}) {
                ...
                for(i = 0, ilen = keys.length; i < ilen; ++i){
                    ...
                    if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(otherValue) && (singleMode || 0 === value || (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(value) === (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(otherValue))) value += otherValue;
                }
                return value;
            }
            ...
            function clearStacks(meta, items) {
                ...
                for (const parsed of items){
                    ...
                    if (!stacks || void 0 === stacks[axis] || void 0 === stacks[axis][datasetIndex]) {
                        return;
                    }
            ...
            class DatasetController {
                ...
                _destroy() {
                    const meta = this._cachedMeta;
                    if (this._data) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.u)(this._data, this);
                ...
                _dataCheck() {
                    ...
                    if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(data)) this._data = convertObjectDataToArray(data);
                    else if (_data !== data) {
                        if (_data) {
                        ...
                        if (data && Object.isExtensible(data)) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.l)(data, this);
                        this._syncList = [];
                        this._data = data;
                    }
                }
                ...
                parse(start, count) {
                    ...
                    const iAxis = iScale.axis;
                    let sorted = 0 === start && count === data.length || meta._sorted;
                ...
                getAllParsedValues(scale) {
                    ...
                    for(i = 0, ilen = parsed.length; i < ilen; ++i){
                        ...
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(value)) values.push(value);
                    }
                    return values;
                }
                getMaxOverflow() {
            ...
            function computeMinSampleSize(meta) {
                ...
                const updateMinAndPrev = ()=>{
                    if (32767 === curr || -32768 === curr) {
                        return;
                    }
                    if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.j)(prev)) min = Math.min(min, Math.abs(curr - prev) || min);
                    prev = curr;
                };
            ...
            function parseValue(entry, item, vScale, i) {
                if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(entry)) parseFloatBar(entry, item, vScale, i);
            ...
            class BarController extends DatasetController {
                ...
                _getStacks(last, dataIndex) {
                    ...
                    for (const meta of metasets){
                        if (void 0 !== dataIndex && skipNull(meta)) {
                            continue;
                        }
                ...
                _calculateBarValuePixels(index) {
                    ...
                    if (floating) {
                        ...
                        if (0 !== value && (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(value) !== (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(custom.barEnd)) start = 0;
                        start += value;
                    }
                    const startValue = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(baseValue) || floating ? start : baseValue;
                    let base = vScale.getPixelForValue(startValue);
                    head = this.chart.getDataVisibility(index) ? vScale.getPixelForValue(start + length) : base;
                    size = head - base;
                ...
                _calculateBarIndexPixels(index, ruler) {
                    ...
                    const maxBarThickness = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.v)(options.maxBarThickness, 1 / 0);
                    if (ruler.grouped) {
            ...
            class DoughnutController extends DatasetController {
                ...
                parse(start, count) {
                    ...
                    const meta = this._cachedMeta;
                    if (false === this._parsing) meta._parsed = data;
                    else {
                ...
                update(mode) {
                    ...
                    const outerRadius = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.n)(this.options.radius, Math.max(Math.min(maxWidth, maxHeight) / 2, 0));
                ...
                _circumference(i, reset) {
                    ...
                    if (reset && opts.animation.animateRotate || !this.chart.getDataVisibility(i) || null === meta._parsed[i] || meta.data[i].hidden) {
                        return 0;
                    }
            ...
            function getEvenSpacing(arr) {
                ...
                for(diff = arr[0], i = 1; i < len; ++i)if (arr[i] - arr[i - 1] !== diff) {
                    return false;
                }
                return diff;
            }
            ...
            function getPixelForGridLine(scale, index, offsetGridLines) {
                ...
                if (offsetGridLines) {
                    offset = 1 === length ? Math.max(lineValue - start, end - lineValue) : 0 === index ? (scale.getPixelForTick(1) - lineValue) / 2 : (lineValue - scale.getPixelForTick(validIndex - 1)) / 2;
            ...
            function titleArgs(scale, offset, position, align) {
                ...
                if (scale.isHorizontal()) {
                    ...
                    rotation = 'left' === position ? -_chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.H : _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.H;
                }
                return {
                    titleX,
                    titleY,
            ...
            class Scale extends Element {
                ...
                _calculatePadding(first, last, sin, cos) {
                    ...
                    if (this.isHorizontal()) {
                        ...
                        else if ('start' === align) paddingRight = last.width;
                        else if ('end' === align) paddingLeft = first.width;
                        else if ('inner' !== align) {
                ...
                _convertTicksToLabels(ticks) {
                    ...
                    for(i = 0, ilen = ticks.length; i < ilen; i++)if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(ticks[i].label)) {
                        ticks.splice(i, 1);
                        ilen--;
                        i--;
                    }
                ...
                _computeLabelSizes(ticks, length) {
                    ...
                    for(i = 0; i < length; ++i){
                        ...
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(label) || (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(label)) {
                            if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(label)) {
                ...
                _computeLabelItems(chartArea) {
                    ...
                    if ('y' === axis) {
                        if ('start' === align) textBaseline = 'top';
                        else if ('end' === align) textBaseline = 'bottom';
                    }
                    const labelSizes = this._getLabelSizes();
                    for(i = 0, ilen = ticks.length; i < ilen; ++i){
                        let backdrop;
                        ...
                        if (isHorizontal) {
                            x = pixel;
                            if ('inner' === textAlign) tickTextAlign = i === ilen - 1 ? this.options.reverse ? 'left' : 'right' : 0 === i ? this.options.reverse ? 'right' : 'left' : 'center';
                            textOffset = 'top' === position ? 'near' === crossAlign || 0 !== rotation ? -lineCount * lineHeight + lineHeight / 2 : 'center' === crossAlign ? -labelSizes.highest.height / 2 - halfCount * lineHeight + lineHeight : -labelSizes.highest.height + lineHeight / 2 : 'near' === crossAlign || 0 !== rotation ? lineHeight / 2 : 'center' === crossAlign ? labelSizes.highest.height / 2 - halfCount * lineHeight : labelSizes.highest.height - lineCount * lineHeight;
                ...
                _getXAxisLabelAlignment() {
                    ...
                    let align = 'center';
                    if ('start' === ticks.align) align = 'left';
                    else if ('end' === ticks.align) align = 'right';
                    else if ('inner' === ticks.align) align = 'inner';
                    return align;
                }
                _getYAxisLabelAlignment(tl) {
                    ...
                    if ('left' === position) if (mirror) {
                        ...
                        if ('near' === crossAlign) textAlign = 'left';
                        else if ('center' === crossAlign) {
                            textAlign = 'center';
                            x += widest / 2;
                        } else {
                            textAlign = 'right';
                        ...
                        if ('near' === crossAlign) textAlign = 'right';
                        else if ('center' === crossAlign) {
                            textAlign = 'center';
                            x -= widest / 2;
                        } else {
                ...
                drawLabels(chartArea) {
                    ...
                    if (area) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.L)(ctx, area);
                    ...
                    if (area) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.N)(ctx);
                }
                drawTitle() {
                    ...
                    if ('bottom' === position || 'center' === position || (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(position)) {
                        offset += padding.bottom;
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(title.text)) offset += font.lineHeight * (title.text.length - 1);
                    } else {
                        offset += padding.top;
                    }
            ...
            class TypedRegistry {
                ...
                register(item) {
                    ...
                    if (this.override) _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.d.override(item.id, item.overrides);
                    return scope;
                }
                get(id) {
                ...
                unregister(item) {
                    ...
                    if (scope && id in _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.d[scope]) {
                        ...
                        if (this.override) delete _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.U[id];
                    }
                }
            }
            function registerDefaults(item, scope, parentScope) {
                ...
                if (item.descriptors) _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.d.describe(scope, item.descriptors);
            }
            ...
            class Registry {
                ...
                _each(method, args, typedRegistry) {
                    [
                        ...
                        else (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Q)(arg, (item)=>{
            ...
            function getNearestRadialItems(chart, position, axis, useFinalPosition) {
                ...
                function evaluationFunc(element, datasetIndex, index) {
                    ...
                    if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.p)(angle, startAngle, endAngle)) items.push({
                        element,
                        datasetIndex,
                        index
                    });
            ...
            function getNearestItems(chart, position, axis, intersect, useFinalPosition, includeInvisible) {
                ...
                return 'r' !== axis || intersect ? getNearestCartesianItems(chart, position, axis, intersect, useFinalPosition, includeInvisible) : getNearestRadialItems(chart, position, axis, useFinalPosition);
            }
            ...
            function getMargins(horizontal, chartArea) {
                ...
                return marginForPositions(horizontal ? [
                    'left',
                    'right'
                ] : [
                    'top',
            ...
            function placeBoxes(boxes, chartArea, params, stacks) {
                ...
                for (const layout of boxes){
                    ...
                    if (layout.horizontal) {
                        ...
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.j)(stack.start)) y = stack.start;
                        box.fullSize ? setBoxDims(box, userPadding.left, y, params.outerWidth - userPadding.right - userPadding.left, height) : setBoxDims(box, chartArea.left + stack.placed, y, width, height);
                        stack.start = y;
                        stack.placed += width;
                        y = box.bottom;
                    } else {
                        ...
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.j)(stack.start)) x = stack.start;
                        box.fullSize ? setBoxDims(box, x, userPadding.top, width1, params.outerHeight - userPadding.bottom - userPadding.top) : setBoxDims(box, x, chartArea.top + stack.placed, width1, height1);
                        stack.start = x;
            ...
            function nodeListContains(nodeList, canvas) {
                for (const node of nodeList)if (node === canvas || node.contains(canvas)) {
                    return true;
                }
            }
            ...
            class DomPlatform extends BasePlatform {
                ...
                releaseContext(context) {
                    ...
                    [
                        ...
                        if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(value)) canvas.removeAttribute(prop);
            ...
            function _detectPlatform(canvas) {
                if (!(0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.a6)() || 'undefined' != typeof OffscreenCanvas && canvas instanceof OffscreenCanvas) {
            ...
            class PluginService {
                ...
                _notify(descriptors, chart, hook, args) {
                    ...
                    for (const descriptor of descriptors){
                        ...
                        if (false === (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.C)(method, params, plugin) && args.cancelable) {
                            return false;
                        }
                    }
                    return true;
            ...
            function getAxisFromDefaultScaleID(id, indexAxis) {
                let axis = id;
                if ('_index_' === id) axis = indexAxis;
                else if ('_value_' === id) axis = 'x' === indexAxis ? 'y' : 'x';
                return axis;
            }
            ...
            function getCanvas(item) {
                if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.a6)() && 'string' == typeof item) item = document.getElementById(item);
            ...
            function determineLastEvent(e, lastEvent, inChartArea, isClick) {
                if (!inChartArea || 'mouseout' === e.type) {
                    return null;
                }
                if (isClick) {
                    return lastEvent;
            ...
            class Chart {
                constructor(item, userConfig){
                    ...
                    if (existingChart) {
                        throw Error('Canvas is already in use. Chart with ID \'' + existingChart.id + "' must be destroyed before the canvas with ID '" + existingChart.canvas.id + '\' can be reused.');
                    }
                ...
                _initialize() {
                    ...
                    else (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.af)(this, this.options.devicePixelRatio);
                    this.bindEvents();
                ...
                resize(width, height) {
                    if (animator.running(this)) this._resizeBeforeDraw = {
                        width,
                        height
                    };
                    else this._resize(width, height);
                }
                ...
                update(mode) {
                    ...
                    if (!animsDisabled) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Q)(newControllers, (controller)=>{
                        controller.reset();
                    });
                ...
                _getUniformDataChanges() {
                    ...
                    for(let i = 1; i < datasetCount; i++)if (!(0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.ah)(changeSet, makeSet(i))) {
                        return;
                    }
                ...
                _updateLayout(minPadding) {
                    ...
                    (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Q)(this.boxes, (box)=>{
                        if (noArea && 'chartArea' === box.position) {
                            return;
                        }
                ...
                _updateDataset(index, mode) {
                    ...
                    if (false === this.notifyPlugins('beforeDatasetUpdate', args)) {
                        return;
                    }
                ...
                _drawDataset(meta) {
                    ...
                    if (false === this.notifyPlugins('beforeDatasetDraw', args)) {
                        return;
                    }
                    if (useClip) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.L)(ctx, {
                    ...
                    if (useClip) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.N)(ctx);
                    args.cancelable = false;
                ...
                _eventHandler(e, replay) {
                    ...
                    if (false === this.notifyPlugins('beforeEvent', args, eventFilter)) {
                        return;
                    }
                ...
                _handleEvent(e, replay, inChartArea) {
                    ...
                    const active = this._getActiveElements(e, lastActive, inChartArea, replay);
                    ...
                    if (inChartArea) {
                        ...
                        if (isClick) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.C)(options.onClick, [
                            e,
                            active,
                            this
                        ], this);
            ...
            function parseBorderRadius$1(arc, innerRadius, outerRadius, angleDelta) {
                ...
                const computeOuterLimit = (val)=>{
                    return (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.E)(val, 0, Math.min(halfThickness, (outerRadius - Math.min(halfThickness, val)) * angleDelta / 2));
                };
                return {
            ...
            function pathArc(ctx, element, offset, spacing, end, circular) {
                ...
                if (circular) {
                    ...
                    ctx.moveTo(x, y);
                    ctx.lineTo(Math.cos(outerStartAdjustedAngle) * outerRadius + x, Math.sin(outerStartAdjustedAngle) * outerRadius + y);
                    ctx.lineTo(Math.cos(outerEndAdjustedAngle) * outerRadius + x, Math.sin(outerEndAdjustedAngle) * outerRadius + y);
                }
                ctx.closePath();
            }
            function drawArc(ctx, element, offset, spacing, circular) {
                ...
                if (fullCircles) {
                    ...
                    if (!isNaN(circumference)) {
                        ...
                        if (circumference % _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.T === 0) endAngle += _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.T;
                    }
                }
            ...
            function drawFullCircleBorders(ctx, element, inner) {
                ...
                if (inner) clipArc(ctx, element, startAngle + _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.T);
                ctx.beginPath();
            ...
            class ArcElement extends Element {
                ...
                draw(ctx) {
                    ...
                    this.pixelMargin = 'inner' === options.borderAlign ? 0.33 : 0;
                    ...
                    if (0 === circumference || this.innerRadius < 0 || this.outerRadius < 0) {
                        return;
                    }
                    ctx.save();
                    let radiusOffset = 0;
                    if (offset) {
                        ...
                        if (this.circumference >= _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.P) radiusOffset = offset;
                    }
            ...
            function getLineMethod(options) {
                ...
                if (options.tension || 'monotone' === options.cubicInterpolationMode) {
            ...
            function lttbDecimation(data, start, count, availableWidth, options) {
                ...
                decimated[sampledIndex++] = data[start + count - 1];
                return decimated;
            }
            function minMaxDecimation(data, start, count, availableWidth) {
                let i, point, x, y, prevX, minIndex, maxIndex, startIndex, minY, maxY, avgX = 0;
                let countX = 0;
                const decimated = [];
                const xMin = data[start].x;
                const xMax = data[start + count - 1].x;
                const dx = xMax - xMin;
                for(i = start; i < start + count; ++i){
                    point = data[i];
            ...
            function getStartAndCountOfVisiblePointsSimplified(meta, points) {
                ...
                if (minDefined) start = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.E)((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Z)(points, iScale.axis, min).lo, 0, pointCount - 1);
                count = maxDefined ? (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.E)((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Z)(points, iScale.axis, max).hi + 1, start, pointCount) - start : pointCount - start;
                return {
                    start,
                    count
                };
            ...
            function _shouldApplyFill(source) {
                return source && false !== source.fill;
            }
            ...
            function _getTargetPixel(fill, scale) {
                let pixel = null;
                if ('start' === fill) pixel = scale.bottom;
                else if ('end' === fill) pixel = scale.top;
                else if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(fill)) pixel = scale.getPixelForValue(fill.value);
                else if (scale.getBasePixel) pixel = scale.getBasePixel();
                return pixel;
            }
            function _getTargetValue(fill, scale, startValue) {
                let value;
                value = 'start' === fill ? startValue : 'end' === fill ? scale.options.reverse ? scale.min : scale.max : (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(fill) ? fill.value : scale.getBaseValue();
                return value;
            }
            ...
            class Legend extends Element {
                ...
                _draw() {
                    ...
                    const drawLegendBox = function(x, y, legendItem) {
                        ...
                        if (labelOpts.usePointStyle) {
                            ...
                            ctx.beginPath();
                            if (Object.values(borderRadius).some((v)=>0 !== v)) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.av)(ctx, {
                                x: xBoxLeft,
                                y: yBoxTop,
                                w: boxWidth,
                                h: boxHeight,
                ...
                handleEvent(e) {
                    ...
                    if ('mousemove' === e.type || 'mouseout' === e.type) {
                        ...
                        if (previous && !sameItem) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.C)(opts.onLeave, [
                            e,
                            previous,
                            this
                        ], this);
                        this._hoveredItem = hoveredItem;
                        if (hoveredItem && !sameItem) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.C)(opts.onHover, [
                            e,
                            hoveredItem,
                            this
                        ], this);
                    } else if (hoveredItem) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.C)(opts.onClick, [
                        e,
                        hoveredItem,
                        this
                    ], this);
            ...
            function isListened(type, opts) {
                if (('mousemove' === type || 'mouseout' === type) && (opts.onHover || opts.onLeave)) {
                    return true;
                }
                ...
                _drawArgs(offset) {
                    ...
                    if (this.isHorizontal()) {
                        ...
                        if ('left' === options.position) {
                            titleX = left + offset;
                            titleY = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.S)(align, bottom, top);
                            rotation = -0.5 * _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.P;
                        } else {
                            titleX = right - offset;
            ...
            function pushOrConcat(base, toPush) {
                if (toPush) if ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(toPush)) Array.prototype.push.apply(base, toPush);
            ...
            function doesNotFitWithAlign(xAlign, chart, options, size) {
                ...
                if ('left' === xAlign && x + width + caret > chart.width) {
                    return true;
                }
                if ('right' === xAlign && x - width - caret < 0) {
                    return true;
                }
            }
            function determineXAlign(chart, options, size, yAlign) {
                ...
                let xAlign = 'center';
                if ('center' === yAlign) xAlign = x <= (left + right) / 2 ? 'left' : 'right';
            ...
            function alignX(size, xAlign) {
                let { x , width  } = size;
                if ('right' === xAlign) x -= width;
                else if ('center' === xAlign) x -= width / 2;
                return x;
            }
            function alignY(size, yAlign, paddingAndSize) {
                let { y , height  } = size;
                if ('top' === yAlign) y += paddingAndSize;
                else if ('bottom' === yAlign) y -= height + paddingAndSize;
                else y -= height / 2;
                return y;
            }
            function getBackgroundPoint(options, size, alignment, chart) {
                ...
                if ('center' === yAlign) {
                    if ('left' === xAlign) x += paddingAndSize;
                    else if ('right' === xAlign) x -= paddingAndSize;
                } else if ('left' === xAlign) x -= Math.max(topLeft, bottomLeft) + caretSize;
                else if ('right' === xAlign) x += Math.max(topRight, bottomRight) + caretSize;
                return {
            ...
            class Tooltip extends Element {
                ...
                getCaretPosition(tooltipPoint, size, options) {
                    ...
                    if ('center' === yAlign) {
                        ...
                        x2 = 'left' === xAlign ? ptX + Math.max(topLeft, bottomLeft) + caretSize : 'right' === xAlign ? ptX + width - Math.max(topRight, bottomRight) - caretSize : this.caretX;
                        if ('top' === yAlign) {
                            y1 = ptY;
                            y2 = y1 - caretSize;
                            x1 = x2 - caretSize;
            ...
            var plugin_tooltip = {
                ...
                afterDraw (chart) {
                    ...
                    if (tooltip && tooltip._willRender()) {
                        ...
                        if (false === chart.notifyPlugins('beforeTooltipDraw', args)) {
                            return;
                        }
                ...
                defaults: {
                    ...
                    callbacks: {
                        ...
                        label (tooltipItem) {
                            ...
                            if (label) label += ': ';
                            const value = tooltipItem.formattedValue;
                            if (!(0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(value)) label += value;
                            return label;
                        },
            ...
            var plugins = Object.freeze({
                ...
                Decimation: {
                    ...
                    beforeElementsUpdate: (chart, args, options)=>{
                        ...
                        chart.data.datasets.forEach((dataset, datasetIndex)=>{
                            ...
                            if ('linear' !== xAxis.type && 'time' !== xAxis.type) {
                                return;
                            }
                ...
                Filler: {
                    ...
                    beforeDatasetsDraw (chart, _args, options) {
                        if ('beforeDatasetsDraw' !== options.drawTime) {
                            return;
                        }
                        const metasets = chart.getSortedVisibleDatasetMetas();
                        for(let i = metasets.length - 1; i >= 0; --i){
                    ...
                    beforeDatasetDraw (chart, args, options) {
                        ...
                        if (!_shouldApplyFill(source) || 'beforeDatasetDraw' !== options.drawTime) {
                            return;
                        }
            ...
            const validIndex = (index, max)=>null === index ? null : (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.E)(Math.round(index), 0, max);
            ...
            class LinearScaleBase extends Scale {
                ...
                parse(raw, index) {
                    ...
                    if (('number' == typeof raw || raw instanceof Number) && !isFinite(+raw)) {
                        return null;
                    }
                    return +raw;
                }
                handleTickRangeOptions() {
                    ...
                    if (min === max) {
                        let offset = 1;
                        if (max >= Number.MAX_SAFE_INTEGER || min <= Number.MIN_SAFE_INTEGER) offset = Math.abs(0.05 * max);
                        setMax(max + offset);
                ...
                buildTicks() {
                    ...
                    if ('ticks' === opts.bounds) (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.aH)(ticks, this, 'value');
                    if (opts.reverse) {
                        ticks.reverse();
                        this.start = this.max;
                        this.end = this.min;
            ...
            function leftForTextAlign(x, w, align) {
                if ('right' === align) x -= w;
                else if ('center' === align) x -= w / 2;
                return x;
            }
            function yForAngle(y, h, angle) {
                if (90 === angle || 270 === angle) y -= h / 2;
            ...
            function parse(scale, input) {
                ...
                if (!(0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(value)) value = 'string' == typeof parser ? adapter.parse(value, parser) : adapter.parse(value);
                if (null === value) {
                    return null;
                }
                if (round) value = 'week' === round && ((0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.x)(isoWeekday) || true === isoWeekday) ? adapter.startOf(value, 'isoWeek', isoWeekday) : adapter.startOf(value, round);
                return +value;
            }
            ...
            function determineMajorUnit(unit) {
                for(let i = UNITS.indexOf(unit) + 1, ilen = UNITS.length; i < ilen; ++i)if (INTERVALS[UNITS[i]].common) {
                    return UNITS[i];
                }
            }
            ...
            function ticksFromTimestamps(scale, values, majorUnit) {
                ...
                return 0 !== ilen && majorUnit ? setMajorTicks(scale, ticks, map, majorUnit) : ticks;
            }
            class TimeScale extends Scale {
                ...
                buildTicks() {
                    ...
                    this._majorUnit = tickOpts.major.enabled && 'year' !== this._unit ? determineMajorUnit(this._unit) : void 0;
                ...
                initOffsets(timestamps) {
                    ...
                    if (this.options.offset && timestamps.length) {
                        ...
                        start = 1 === timestamps.length ? 1 - first : (this.getDecimalForValue(timestamps[1]) - first) / 2;
                        last = this.getDecimalForValue(timestamps[timestamps.length - 1]);
                        end = 1 === timestamps.length ? last : (last - this.getDecimalForValue(timestamps[timestamps.length - 2])) / 2;
                    }
                ...
                _generate() {
                    ...
                    const weekday = 'week' === minor && timeOpts.isoWeekday;
                    const hasWeekday = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.x)(weekday) || true === weekday;
                    const ticks = {};
                    let first = min;
            ...
            function interpolate(table, val, reverse) {
                ...
                if (reverse) {
                    if (val >= table[lo].pos && val <= table[hi].pos) ({ lo , hi  } = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Z)(table, 'pos', val));
                    ({ pos: prevSource , time: prevTarget  } = table[lo]);
                    ({ pos: nextSource , time: nextTarget  } = table[hi]);
                } else {
                    if (val >= table[lo].time && val <= table[hi].time) ({ lo , hi  } = (0, _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__.Z)(table, 'time', val));
            ...
            class TimeSeriesScale extends TimeScale {
                ...
                _getTimestampsForTable() {
                    ...
                    timestamps = data.length && label.length ? this.normalize(data.concat(label)) : data.length ? data : label;
