export default function(module, __unused_webpack_exports, __webpack_require__) {
    var commonjsGlobal, parser, version, version$2, require$$2, require$$3, DLList, Events, Queues, BottleneckError, Job, LocalDatastore, States, Sync, Group, Scripts$1, Batcher, RedisDatastore$1, require$$8, splice, Bottleneck_1;
        ...
        class Bottleneck {
            ...
            _drainOne(capacity) {
                return this._registerLock.schedule(()=>{
                    ...
                    return 0 === this.queued() ? this.Promise.resolve(null) : ({ options, args } = next = (queue = this._queues.getFirst()).first(), null != capacity && options.weight > capacity) ? this.Promise.resolve(null) : (this.Events.trigger("debug", `Draining ${options.id}`, {
                        args,
                        options
            ...
            submit(...args) {
                var cb, fn, job, options;
                return "function" == typeof args[0] ? ([fn, ...args] = args, [cb] = splice.call(args, -1), options = parser.load({}, this.jobDefaults)) : ([options, fn, ...args] = args, [cb] = splice.call(args, -1), options = parser.load(options, this.jobDefaults)), (job = new Job((...args)=>new this.Promise(function(resolve, reject) {
