    ...
    ],
    {
        1321: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            (function(e, t) {
                "use strict";
                var e1;
                var n = t && "object" == typeof t && "default" in t ? t : {
                    default: t
                }, o = ("undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0 !== __webpack_require__.g ? __webpack_require__.g : "undefined" != typeof self && self, {
                    exports: {}
                });
                var e2;
                (function(e) {
                    ...
                    class g {
                        ...
                        static fromHex(e) {
                            ...
                            var e1;
                            const c = $(a * a), u = $(n + t * c), h = $(n - t * c), f = $(u * u), d = $(h * h), p = $(t * o * f - d), { isValid: w , value: y  } = _(n, e1 = $(p * d)), b = $(y * h), m = $(y * b * p);
                            let v = $((a + a) * b);
                            I(v) && (v = $(-v));
                            const x = $(u * m), E = $(v * x);
                        ...
                        toRawBytes() {
                            let { x: e , y: t , z: r , t: n1  } = this.ep;
                            var e1;
                            const o = $($(r + t) * $(r - t)), i = $(e * t), s = $(i * i), { value: a  } = _(n, e1 = $(o * s)), u = $(a * o), f = $(a * i), d = $(u * f * n1);
                            let l;
                            if (I(n1 * d)) {
                                let r1 = $(t * c), n2 = $(e * c);
                                e = r1, t = n2, l = $(u * h);
                    ...
                    const br = {
                        ...
                        Object (e, t, r, n) {
                            ...
                            var e1, t2;
                            return (r.mapSorter && a.sort(r.mapSorter)), r.addBreakTokens ? [
                                new ht(ut.map, s),
                                a,
                                new ht(ut.break)
                            ] : [
                    ...
                    function vr(e, t = {}, r) {
                        const n = function(e) {
                            ...
                            var e1;
                            if (e && e.constructor && e.constructor.isBuffer && e.constructor.isBuffer.call(null, e)) return "Buffer";
                            const r = function(e) {
                    ...
                    const Un = (e)=>{
                        ...
                        var e1;
                        var e2, t1;
                        return `${Sn(t)}.${Bn(t)}.${An(t.signature)}` === e ? mn(t) : (t1 = Nr(e), new bn(t, t1));
                    ...
                    Wn.prototype.reset = function() {
                        ...
                        return t;
                    }, ((e12 = Vn).operation = function(r) {
                        var n = e12.timeouts(r);
                        return new Wn(n, {
                            forever: r && (r.forever || r.retries === 1 / 0),
                            unref: r && r.unref,
                            maxRetryTime: r && r.maxRetryTime
                        });
                    }, e12.timeouts = function(e) {
                    ...
                    }, e12.createTimeout = function(e, t) {
                    ...
                    }, e12.wrap = function(t, r, n) {
                        if (r instanceof Array && (n = r, r = null), !n) for(var o in n = [], t)"function" == typeof t[o] && n.push(o);
                        for(var i = 0; i < n.length; i++){
                            var s = n[i], a = t[s];
                            t[s] = (function(n) {
                                var o = e12.operation(r), i = Array.prototype.slice.call(arguments, 1), s = i.pop();
                                i.push(function(e) {
                    ...
                    var e13;
                    var Hn = (e13 = Mn.exports) && e13.__esModule && Object.prototype.hasOwnProperty.call(e13, "default") ? e13.default : e13;
                    const qn = new Set([
                        "Failed to fetch",
                    ...
                    async function ls(e) {
                        var e1, t, r;
                        const t1 = e.url || cs, r1 = await Zn((e1 = e.issuer.did(), t = t1.toString(), r = e.signal, async ()=>{
                            const n = await Pn(`${t}validate?did=${e1}`, {
                                signal: r
                            });
            ...
            })(exports, __webpack_require__(7294)), true;
        }
    }
]);
