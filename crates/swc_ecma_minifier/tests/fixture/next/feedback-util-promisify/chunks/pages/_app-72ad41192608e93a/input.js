    ...
    [888], {
        ...
        8484:
            ...
            (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                ...
                /* harmony import */
                var _Users_kdy1_projects_lab_swc_minify_issue_node_modules_next_dist_compiled_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4051);
                /* harmony import */
                ...
                /* harmony import */
                var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7294);
                /* harmony import */
                var util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9720);
                /* harmony import */
                var util__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(util__WEBPACK_IMPORTED_MODULE_3__);
                /* harmony import */
                var _styles_globals_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6774);
                /* harmony import */
                var _styles_globals_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/ __webpack_require__.n(_styles_globals_css__WEBPACK_IMPORTED_MODULE_4__);
                ...
                var initBranch = function () {
                    var _ref = _asyncToGenerator(_Users_kdy1_projects_lab_swc_minify_issue_node_modules_next_dist_compiled_regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
                ...
                function MyApp(param) {
                    ...
                    return ( /*#__PURE__*/ (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Component, _objectSpread({}, pageProps)));
                }
                ...
                (function () {
                    var r = {
                        ...
                        112: function (r, t, e) {
                            ...
                            var p = n("%Object.getOwnPropertyDescriptor%", true);
                        ...
                        91: function (r, t, e) {
                            ...
                            r.exports = function GetIntrinsic(r, t) {
                                ...
                                for (var l = 1, d = true; l < e.length; l += 1) {
                                    var A = e[l];
                                    var v = h(A, 0, 1);
                                    var P = h(A, -1);
                                    if ((v === '"' || v === "'" || v === "`" || (P === '"' || P === "'" || P === "`")) && v !== P) {
                            ...
                            r.exports = function bind(r) {
                                ...
                                var binder = function () {
                                    if (this instanceof y) {
                                        ...
                                        return i.apply(r, a.concat(e.call(arguments)))
                                    }
                                };
                        ...
                        879: function (r, t, e) {
                            ...
                            r.exports = function GetIntrinsic(r, t) {
                                ...
                                for (var d = 1, g = true; d < e.length; d += 1) {
                                    var A = e[d];
                                    var m = P(A, 0, 1);
                                    var h = P(A, -1);
                                    if ((m === '"' || m === "'" || m === "`" || (h === '"' || h === "'" || h === "`")) && m !== h) {
                                    ...
                                    if (v(l, f)) {
                                        ...
                                        if (y && d + 1 >= e.length) {
                                            var O = y(u, A);
                                            g = !!O;
                                            if (g && "get" in O && !("originalValue" in O.get)) {
                                                u = O.get
                                            } else {
                                                u = u[A]
                                            }
                        ...
                        234: function (r, t, e) {
                            ...
                            var f = n();
                            var u = i("Array.prototype.indexOf", true) || function indexOf(r, t) {
                        ...
                        650: function (r, t, e) {
                            var o = Object.getOwnPropertyDescriptors || function getOwnPropertyDescriptors(r) {
                                ...
                                for (var o = 0; o < t.length; o++) {
                                    e[t[o]] = Object.getOwnPropertyDescriptor(r, t[o])
                                }
                                return e
                            };
                            var n = /%[sdj%]/g;
                            ...
                            function formatValue(r, e, o) {
                                ...
                                if (isDate(e)) {
                                    f = " " + Date.prototype.toUTCString.call(e)
                                }
                                if (isError(e)) {
                                    f = " " + formatError(e)
                                }
                            ...
                            function formatArray(r, t, e, o, n) {
                                ...
                                for (var a = 0, y = t.length; a < y; ++a) {
                                    if (hasOwnProperty(t, String(a))) {
                                        i.push(formatProperty(r, t, e, o, String(a), true))
                                    } else {
                                        i.push("")
                                    }
                                }
                                n.forEach((function (n) {
                                    if (!n.match(/^\d+$/)) {
                                        i.push(formatProperty(r, t, e, o, n, true))
                                    }
                                }));
                                return i
                            }
                            ...
                            function timestamp() {
                                var r = new Date;
                                var t = [pad(r.getHours()), pad(r.getMinutes()), pad(r.getSeconds())].join(":");
                        ...
                        227: function (r, t, e) {
                            ...
                            r.exports = function GetIntrinsic(r, t) {
                                ...
                                for (var s = 1, c = true; s < e.length; s += 1) {
                                    var l = e[s];
                                    if (l === "constructor" || !c) {
                                        f = true
                                    }
                                    ...
                                    if (b(g, i)) {
                                        ...
                                        if (y && s + 1 >= e.length) {
                                            ...
                                            if (c && "get" in d && !("originalValue" in d.get)) {
                                                p = d.get
                                            } else {
                                                p = p[l]
                                            }
