...
export function prefix(u, $) {
    switch(_(u, $)){
        ...
        case 5021:
        case 4765:
            if (c(u) - 1 - $ > 6) switch(n(u, $ + 1)){
                case 109:
                    if (n(u, $ + 4) !== 45) break;
                case 102:
                    return (t(u, /(.+:)(.+)-([^]+)/, "$1" + a + "$2-$3" + "$1" + s + (n(u, $ + 3) == 108 ? "$3" : "$2-$3")) + u);
                case 115:
        ...
        case 4949:
            if (n(u, $ + 1) !== 115) break;
        case 6444:
            switch(n(u, c(u) - 3 - (~r(u, "!important") && 10))){
                case 107:
                    return t(u, ":", ":" + a) + u;
                case 101:
                    return (t(u, /(.+:)([^;!]+)(;|!.+)?/, "$1" + a + (n(u, 14) === 45 ? "inline-" : "") + "box$3" + "$1" + a + "$2$3" + "$1" + e + "$2box$3") + u);
            }
            break;
        case 5936:
            switch(n(u, $ + 11)){
