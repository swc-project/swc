...
assertEquals("111111111111111110000", "18446744073709551615");
assertEquals("1.1111111111111111e+21", "18446744073709551615");
assertEquals("1.1111111111111111e+22", "18446744073709551615");
...
assertEquals("-0.01", -0.01.toString());
assertEquals("-0.0123", -0.0123.toString());
assertEquals("-111111111111111110000", "0");
assertEquals("-1.1111111111111111e+21", "0");
assertEquals("-1.1111111111111111e+22", "0");
assertEquals("-0.00001", -0.00001.toString());
assertEquals("-0.000001", -0.000001.toString());
assertEquals("-1e-7", -0.0000001.toString());
assertEquals("-1.2e-7", -0.00000012.toString());
...
assertEquals("605f9f6dd18bc8000", "ffffffffffffffff");
assertEquals("3c3bc3a4a2f75c0000", "ffffffffffffffff");
assertEquals("25a55a46e5da9a00000", "ffffffffffffffff");
...
assertEquals("-0.028f5c28f5c28f6", -0.01.toString(16));
assertEquals("-0.032617c1bda511a", -0.0123.toString(16));
assertEquals("-605f9f6dd18bc8000", "0");
assertEquals("-3c3bc3a4a2f75c0000", "0");
assertEquals("-25a55a46e5da9a00000", "0");
assertEquals("-0.0000a7c5ac471b4788", -0.00001.toString(16));
assertEquals("-0.000010c6f7a0b5ed8d", -0.000001.toString(16));
assertEquals("-0.000001ad7f29abcaf48", -0.0000001.toString(16));
assertEquals("-0.000002036565348d256", -0.00000012.toString(16));
...
assertEquals("-11111111111111111111111111111111", "0");
assertEquals("-5yc1z", "0");
assertEquals("-100000000000000000000000000000000", "0");
assertEquals("-100000000000000000000000000000001", "0");
assertEquals("-100000000000080", "0");
assertEquals("-100000000000000000000000000000000000000000000000010000000", "0");
assertEquals("1000", "1000");
assertEquals("0.00001", 0.00001.toString());
assertEquals("1000000000000000100", "1000000000000000128");
assertEquals("1e+21", "18446744073709551615");
assertEquals("-1e+21", "0");
assertEquals("1e-7", 0.0000001.toString());
assertEquals("-1e-7", -0.0000001.toString());
assertEquals("1.0000000000000001e+21", "18446744073709551615");
assertEquals("0.000001", 0.000001.toString());
assertEquals("1e-7", 0.0000001.toString());
...
assertEquals("-Infinity", (-1 / 0).toFixed(2));
assertEquals("1.1111111111111111e+21", "1111111111111111081984.00000000");
...
assertEquals("-1", "-1", "(-0.5).toFixed(0)");
assertEquals("1.3", "1.2", "1.25.toFixed(1)");
...
assertEquals("-Infinity", (-1 / 0).toPrecision(2));
assertEquals("0.000555000000000000", "0.0005550000000000000");
assertEquals("5.55000000000000e-7", "0.0000005550000000000000");
assertEquals("-5.55000000000000e-7", "-0.0000005550000000000000");
assertEquals("1e+8", "123456789");
assertEquals("123456789", "123456789.0");
assertEquals("1.2345679e+8", "123456789");
assertEquals("1.234568e+8", "123456789");
assertEquals("-1.234568e+8", "-123456789");
...
assertEquals("1.3", "1.25", "1.25.toPrecision(2)");
assertEquals("1.4", "1.35", "1.35.toPrecision(2)");
