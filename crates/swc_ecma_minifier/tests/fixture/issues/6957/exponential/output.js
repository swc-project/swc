...
assert.sameValue("100", "1e+2");
assert.sameValue("1000", "1e+3");
assert.sameValue("10000", "1e+4");
assert.sameValue("100000", "1e+5");
assert.sameValue("100", "1.0e+2");
assert.sameValue("1000", "1.0e+3");
assert.sameValue("10000", "1.0e+4");
assert.sameValue("100000", "1.0e+5");
assert.sameValue("1000", "1.00e+3");
assert.sameValue("10000", "1.00e+4");
assert.sameValue("100000", "1.00e+5");
assert.sameValue("42", "4e+1");
assert.sameValue("-42", "-4e+1");
assert.sameValue("1234499999999999961840222208", "1e+27");
assert.sameValue("1234499999999999961840222208", "1.2e+27");
assert.sameValue("1234499999999999961840222208", "1.23e+27");
assert.sameValue("1234499999999999961840222208", "1.234e+27");
assert.sameValue("1234499999999999961840222208", "1.2345e+27");
assert.sameValue("1234499999999999961840222208", "1.23450e+27");
assert.sameValue("1234499999999999961840222208", "1.234500e+27");
assert.sameValue("1234499999999999961840222208", "1.234500000000000e+27");
assert.sameValue("1234499999999999961840222208", "1.2345000000000000e+27");
assert.sameValue("1234499999999999961840222208", "1.23449999999999996e+27");
assert.sameValue("1234499999999999961840222208", "1.234499999999999962e+27");
assert.sameValue("1234499999999999961840222208", "1.2344999999999999618e+27");
assert.sameValue("1234499999999999961840222208", "1.23449999999999996184e+27");
assert.sameValue("-1234499999999999961840222208", "-1e+27");
assert.sameValue("-1234499999999999961840222208", "-1.2e+27");
assert.sameValue("-1234499999999999961840222208", "-1.23e+27");
assert.sameValue("-1234499999999999961840222208", "-1.234e+27");
...
assert.sameValue("0.000000010", "1e-8");
assert.sameValue("-0.000000010", "-1e-8");
