...
var ItemsList = function(Component) {
    ...
    function ItemsList() {
        ...
        }(this, ItemsList), _this = (call = _getPrototypeOf(ItemsList).apply(this, arguments), call && ("object" == ((obj = call) && "undefined" != typeof Symbol && obj.constructor === Symbol ? "symbol" : typeof obj) || "function" == typeof call) ? call : function(self) {
