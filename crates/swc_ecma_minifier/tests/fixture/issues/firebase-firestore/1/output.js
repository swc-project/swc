        ...
        /***/ 19: /***/ function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
            ...
            /* eslint-disable no-restricted-globals */ /**
                ...
                /**
                     ...
                     */ store(t) {
                    return new Js(this.transaction.objectStore(t));
                }
            }
            /**
                ...
                /**
                     ...
                     */ static Pt() {
                    var t;
                    return void 0 !== process && "YES" === (null == (t = process.env) ? void 0 : t.Vt);
                }
                /** Helper to get a typed SimpleDbStore from a transaction. */ static St(t, e) {
                    return t.store(e);
                }
                // visible for testing
                /** Parse User Agent to determine iOS version. Returns -1 if not found. */ static Rt(t) {
                    const e = t.match(/i(?:phone|pad|pod) os ([\d_]+)/i);
                    return Number(e ? e[1].split("_").slice(0, 2).join(".") : "-1");
                }
                // visible for testing
                /** Parse User Agent to determine Android version. Returns -1 if not found. */ static vt(t) {
                    const e = t.match(/Android ([\d.]+)/i);
                    return Number(e ? e[1].split(".").slice(0, 2).join(".") : "-1");
                }
                /**
                ...
                async runTransaction(t, e, n, s) {
                    ...
                    for(;;){
                        ...
                        try {
                            ...
                            const e = Qs.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t)=>// Abort the transaction if there was an error.
            ...
            /** An error that wraps exceptions that thrown during IndexedDB execution. */ class zs extends /* unused pure expression or super */ null {
                constructor(t, e){
            ...
            /**
                ...
                /**
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    return Ys(this.store.get(t)).next((e)=>// Normalize nonexistence to null.
            ...
            let Xs = /* unused pure expression or super */ null;
            function Zs(t) {
                const e = Ws.Rt(getUA());
                if (e >= 12.2 && e < 13) {
