    ...
    ],
    {
        19: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                        ...
                        query: function(t) {
                            const e = function(t) {
                                ...
                                if (s > 0) {
                                    1 === s || L();
                                    const t2 = n.from[0];
                                    t2.allDescendants ? i = t2.collectionId : e1 = e1.child(t2.collectionId);
                                }
                                let r = [];
                            ...
                            return "LAST" === t.limitType ? new fe(e.path, e.collectionGroup, e.explicitOrderBy.slice(), e.filters.slice(), e.limit, "L", e.startAt, e.endAt) : e;
                        }(e.bundledQuery),
            ...
            class Cr {
                constructor(t, e){
                    var e1;
                    this.bs = {}, this.Le = new X(0), this.Be = !1, this.Be = !0, this.referenceDelegate = t(this), this.ze = new Dr(this), this.Ht = new pi(), this.He = (e1 = (t)=>this.referenceDelegate.Ps(t), new Vr(this.Ht, e1)), this.N = new ri(e), this.Je = new Rr(this.N);
                }
                start() {
            ...
            function Co(t) {
                var t1, n;
                return t.Yr || (t.Yr = (t1 = t.datastore, n = {
                    Si: mo.bind(null, t),
                    Ci: go.bind(null, t),
                    Rr: yo.bind(null, t)
                }, t1.$r(), new to(t.asyncQueue, t1.sr, t1.credentials, t1.N, n)), t.Gr.push(async (e)=>{
            ...
            function Ma(t) {
                var e, e1;
                const n = t._freezeSettings(), s = (e1 = (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", new ua(t._databaseId, e1, t._persistenceKey, n.host, n.ssl, n.experimentalForceLongPolling, n.experimentalAutoDetectLongPolling, n.useFetchStreams));
