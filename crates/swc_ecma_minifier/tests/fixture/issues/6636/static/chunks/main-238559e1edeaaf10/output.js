(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    ],
    {
        ...
        4534: function(module, exports, __webpack_require__) {
            ...
            exports.version = "13.0.7-canary.5";
            let router;
            exports.router = router;
            const emitter = _mitt.default();
            exports.emitter = emitter;
            const looseToArray = (input)=>[].slice.call(input);
            let initialData, defaultLocale, asPath, pageLoader, appElement, headManager, initialMatchesMiddleware = !1, lastAppProps, lastRenderReject, CachedApp, onPerfEntry, CachedComponent;
            ...
            function _initialize() {
                return _initialize = _async_to_generator(function*() {
                    ...
                    _hasBasePath.hasBasePath(asPath) && (asPath = _removeBasePath.removeBasePath(asPath));
            ...
            function markHydrateComplete() {
                if (_utils.ST) {
                    ...
                    onPerfEntry && performance.getEntriesByName("Next.js-hydration").forEach(onPerfEntry);
                    clearMarks();
                }
            }
            ...
            function doRender(input) {
                let { App , Component , props , err  } = input, styleSheets = "initial" in input ? void 0 : input.styleSheets;
                ...
                !function() {
                    ...
                    styleSheets.forEach((param)=>{
                        ...
                        if (!currentHrefs.has(href)) {
                            ...
                            nonce && styleTag.setAttribute("nonce", nonce);
            ...
            function _hydrate() {
                return _hydrate = _async_to_generator(function*(opts) {
                    ...
                    try {
                        ...
                        CachedApp = app;
                        mod && mod.reportWebVitals && (onPerfEntry = (param)=>{
                            ...
                            attribution && (webVitals.attribution = attribution);
                    ...
                    window.__NEXT_PRELOADREADY && (yield window.__NEXT_PRELOADREADY(initialData.dynamicIds));
                    ...
                    (null == opts ? void 0 : opts.beforeRender) && (yield opts.beforeRender());
                    render(renderCtx);
                }), _hydrate.apply(this, arguments);
            }
            if (("function" == typeof exports.default || "object" == typeof exports.default && null !== exports.default) && void 0 === exports.default.__esModule) {
                Object.defineProperty(exports.default, "__esModule", {
                    value: !0
        ...
        659: function(module, exports, __webpack_require__) {
            ...
            location.href;
            let isRegistered = !1, userReportHandler;
            ...
            var _default = (onPerfEntry)=>{
                ...
                if (!isRegistered) {
                    ...
                    for (const webVital of WEB_VITALS)try {
                        let mod;
                        mod || (mod = __webpack_require__(8018));
                ...
                function maybeExecuteScript(src) {
                    {
                        ...
                        var script;
                        return loadedScripts.set(src.toString(), prom = new Promise((resolve, reject)=>{
                    ...
                    onEntrypoint (route, execute) {
                        (execute ? Promise.resolve().then(()=>execute()).then((exports1)=>({
                            ...
                            if (old && "resolve" in old) {
                                ...
                                input ? entrypoints.set(route, input) : entrypoints.delete(route);
                                routes.delete(route);
                            }
                        });
                    },
            ...
            function Script(props) {
                ...
                _react.useEffect(()=>{
                    if (!hasLoadScriptEffectCalled.current) {
                        "afterInteractive" === strategy ? loadScript(props) : "lazyOnload" === strategy && ("complete" === document.readyState ? _requestIdleCallback.requestIdleCallback(()=>loadScript(props)) : window.addEventListener("load", ()=>{
                            _requestIdleCallback.requestIdleCallback(()=>loadScript(props));
                        }));
                ...
                if ("beforeInteractive" === strategy || "worker" === strategy) {
                    ...
                    } else getIsSsr && getIsSsr() ? LoadCache.add(id || src) : getIsSsr && !getIsSsr() && loadScript(props);
                }
                if (appDir) {
                    if ("beforeInteractive" === strategy) {
                        ...
                        return _reactDom.default.preload(src, restProps.integrity ? {
                            as: "script",
        ...
        4297: function(module, exports, __webpack_require__) {
            ...
            exports.default = void 0;
            var _async_to_generator = __webpack_require__(932).Z, _interop_require_default = __webpack_require__(2648).Z, _react = _interop_require_default(__webpack_require__(7294)), _utils = __webpack_require__(670);
            ...
            function _appGetInitialProps() {
                ...
                }), _appGetInitialProps.apply(this, arguments);
            }
            var _Component;
        ...
        67: function(module, exports, __webpack_require__) {
            ...
            exports.default = void 0;
            var _interop_require_default = __webpack_require__(2648).Z, _react = _interop_require_default(__webpack_require__(7294)), _head = _interop_require_default(__webpack_require__(3121));
            const statusCodes = {
                400: "Bad Request",
        ...
        8245: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            var _interop_require_default = __webpack_require__(2648).Z, _react = _interop_require_default(__webpack_require__(7294)), CacheStates;
            exports.CacheStates = CacheStates;
            var CacheStates1;
            (CacheStates1 = CacheStates || (exports.CacheStates = CacheStates = {})).LAZY_INITIALIZED = "LAZYINITIALIZED", CacheStates1.DATA_FETCH = "DATAFETCH", CacheStates1.READY = "READY";
                                ...
                                for(let i = 0, len = METATYPES.length; i < len; i++){
                                    ...
                                    if (h.props.hasOwnProperty(metatype)) {
                                        if ("charSet" === metatype) metaTypes.has(metatype) ? isUnique = !1 : metaTypes.add(metatype);
                                            ...
                                            if (("name" !== metatype || !hasKey) && categories.has(category)) isUnique = !1;
                                            else {
        ...
        2983: function(__unused_webpack_module, exports) {
            ...
            exports.NEXT_DYNAMIC_NO_SSR_CODE = "DYNAMIC_SERVER_USAGE";
        },
        ...
        401: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            exports.PathnameContextProviderAdapter = function(_param) {
                ...
                const ref = _react.useRef(props.isAutoExport), value = _react.useMemo(()=>{
                    ...
                    isAutoExport && (ref.current = !1);
                    if (_utils.isDynamicRoute(router.pathname) && (router.isFallback || isAutoExport && !router.isReady)) return null;
                    let url;
                    try {
        ...
        1003: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function _matchesMiddleware() {
                ...
                }), _matchesMiddleware.apply(this, arguments);
            }
            ...
            function _withMiddlewareEffects() {
                return _withMiddlewareEffects = _async_to_generator(function*(options) {
                    ...
                    try {
                        const data = yield options.fetchData(), effect = yield function(source, response, options) {
                            ...
                            !matchedPath || rewriteTarget || matchedPath.includes("__next_data_catchall") || matchedPath.includes("/_error") || matchedPath.includes("/404") || (rewriteTarget = matchedPath);
                            if (rewriteTarget) {
                ...
                }), _withMiddlewareEffects.apply(this, arguments);
            }
            ...
            function fetchNextData(param) {
                ...
                var ref1;
                const getData = (params)=>(function fetchRetry(url, attempts, options) {
                        return fetch(url, {
                        ...
                        "Failed to fetch" === err.message && _routeLoader.markAssetError(err);
                        throw err;
                    });
            ...
            class Router {
                ...
                change(method, url, as, options, forcedScroll) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        if (isQueryUpdating && _this.clc) return !1;
                        ...
                        if (_this._inFlightRoute && _this.clc) {
                            isSsr || Router.events.emit("routeChangeError", buildCancellationError(), _this._inFlightRoute, routeProps);
                            _this.clc();
                            _this.clc = null;
                        }
                        ...
                        if (!isQueryUpdating && _this.onlyAHashChange(cleanedAs) && !localeChange) {
                            ...
                            try {
                                ...
                                _isError.default(err) && err.cancelled && Router.events.emit("routeChangeError", err, cleanedAs, routeProps);
                                throw err;
                            }
                            return Router.events.emit("hashChangeComplete", as, routeProps), !0;
                        }
                        let parsed = _parseRelativeUrl.parseRelativeUrl(url), { pathname , query  } = parsed, pages, rewrites;
                        try {
                        ...
                        options.shallow && isMiddlewareMatch && (pathname = _this.pathname);
                        ...
                        if (shouldResolveHref && "/_error" !== pathname) {
                            ...
                            if (parsed.pathname !== pathname) {
                                ...
                                isMiddlewareMatch || (url = _formatUrl.formatWithValidation(parsed));
                            }
                        }
                        if (!isLocalURL(as)) return handleHardNavigation({
                            url: as,
                            router: _this
                        }), !1;
                        ...
                        try {
                            ...
                            if ("route" in routeInfo && isMiddlewareMatch) {
                                ...
                                route = pathname;
                                routeProps.shallow || (query = Object.assign({}, routeInfo.query || {}, query));
                                ...
                                routeMatch && pathname !== cleanedParsedPathname && Object.keys(routeMatch).forEach((key)=>{
                            ...
                            if ((routeInfo.__N_SSG || routeInfo.__N_SSP) && routeInfo.props) {
                                ...
                                if (routeInfo.props.notFound === SSG_DATA_NOT_FOUND) {
                                    ...
                                    if ("type" in routeInfo) throw Error("Unexpected middleware effect on /404");
                                }
                            }
                            ...
                            var _scroll;
                            const shouldScroll = null != (_scroll = options.scroll) ? _scroll : !isQueryUpdating && !isValidShallowRoute, upcomingScrollState = null != forcedScroll ? forcedScroll : shouldScroll ? {
                                x: 0,
                                y: 0
                            ...
                            if (isQueryUpdating && ("/404" === _this.pathname || "/_error" === _this.pathname)) {
                                ...
                                if ("type" in routeInfo) throw Error("Unexpected middleware effect on ".concat(_this.pathname));
                                ...
                                try {
                                    ...
                                    _isError.default(err2) && err2.cancelled && Router.events.emit("routeChangeError", err2, cleanedAs, routeProps);
                                    throw err2;
                                }
                                return !0;
                            }
                            ...
                            if (!canSkipUpdating) {
                                ...
                                if (routeInfo.error) {
                                    isQueryUpdating || Router.events.emit("routeChangeError", routeInfo.error, cleanedAs, routeProps);
                ...
                getRouteInfo(param) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        try {
                            ...
                            handleCancelled();
                            if ((null == data ? void 0 : null == (ref = data.effect) ? void 0 : ref.type) === "redirect-internal" || (null == data ? void 0 : null == (ref8 = data.effect) ? void 0 : ref8.type) === "redirect-external") return data.effect;
                            if ((null == data ? void 0 : null == (ref9 = data.effect) ? void 0 : ref9.type) === "rewrite") {
                                ...
                                if (!isQueryUpdating || pages.includes(resolvedRoute)) {
                                    ...
                                    if (routeProps.shallow && existingInfo && _this.route === route && !hasMiddleware) return _extends({}, existingInfo, {
                                        route
                                    });
                                }
                            }
                            ...
                            routeInfo.__N_SSP && fetchNextDataParams.dataHref && cacheKey && delete _this.sdc[cacheKey];
                            _this.isPreview || !routeInfo.__N_SSG || isQueryUpdating || fetchNextData(Object.assign({}, fetchNextDataParams, {
                                isBackground: !0,
                                persistCache: !1,
                ...
                prefetch(url) {
                    ...
                    return _async_to_generator(function*() {
                        ...
                        if ((null == data ? void 0 : data.effect.type) === "rewrite") {
                        ...
                        if ((null == data ? void 0 : data.effect.type) === "redirect-external") return;
                ...
                constructor(pathname1, query1, as1, { initialProps , pageLoader , App , wrapApp , Component , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview  }){
                    ...
                    this.components = {};
                    "/_error" !== pathname1 && (this.components[route] = {
                        Component,
                        initial: !0,
                        props: initialProps,
                        err,
        ...
        7795: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function formatUrl(urlObj) {
                ...
                query && "object" == typeof query && (query = String(querystring.urlQueryToSearchParams(query)));
                let search = urlObj.search || query && "?".concat(query) || "";
                protocol && !protocol.endsWith(":") && (protocol += ":");
                if (urlObj.slashes || (!protocol || slashedProtocols.test(protocol)) && !1 !== host) {
                    host = "//" + (host || "");
                    pathname && "/" !== pathname[0] && (pathname = "/" + pathname);
                } else host || (host = "");
                return hash && "#" !== hash[0] && (hash = "#" + hash), search && "?" !== search[0] && (search = "?" + search), pathname = pathname.replace(/[?#]/g, encodeURIComponent), search = search.replace("#", "%23"), "".concat(protocol).concat(host).concat(pathname).concat(search).concat(hash);
            }
        ...
        8756: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            exports.getNextPathnameInfo = function(pathname, options) {
                ...
                if (!0 === options.parseData && info.pathname.startsWith("/_next/data/") && info.pathname.endsWith(".json")) {
        ...
        4903: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function getNamedParametrizedRoute(route) {
                ...
                const getSafeRouteKey = (routeKeyCharCode = 97, routeKeyCharLength = 1, ()=>{
                    let routeKey = "";
        ...
        566: function(__unused_webpack_module, exports) {
            ...
            class UrlNode {
                ...
                _smoosh() {
                    ...
                    null !== this.slugName && routes.push(...this.children.get("[]")._smoosh("".concat(prefix, "[").concat(this.slugName, "]/")));
                    if (!this.placeholder) {
                ...
                _insert(urlPaths, slugNames, isCatchAll) {
                    ...
                    if (nextSegment.startsWith("[") && nextSegment.endsWith("]")) {
                        ...
                        if (segmentName.startsWith("[") || segmentName.endsWith("]")) throw Error("Segment names may not start or end with extra brackets ('".concat(segmentName, "')."));
                    ...
                    this.children.has(nextSegment) || this.children.set(nextSegment, new UrlNode());
        ...
        1436: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            exports.default = function(props) {
                ...
                if (isServer) {
                    var ref;
                    null == headManager || null == (ref = headManager.mountedInstances) || ref.add(props.children);
                    emitChange();
                }
        ...
        670: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            function _loadGetInitialProps() {
                return _loadGetInitialProps = _async_to_generator(function*(App, ctx) {
                    ...
                    return props;
                }), _loadGetInitialProps.apply(this, arguments);
            }
            ...
            exports.ST = ST;
            exports.DecodeError = class extends Error {
            };
