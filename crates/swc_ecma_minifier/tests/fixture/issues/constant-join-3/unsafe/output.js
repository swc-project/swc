...
function unresolved_global_join_lookup_order() {
    ...
    try {
        ...
        Array.prototype.join = join;
        if (xDescriptor) Object.defineProperty(globalThis, "x", xDescriptor);
        else delete globalThis.x;
        if (yDescriptor) Object.defineProperty(globalThis, "y", yDescriptor);
        else delete globalThis.y;
    }
}
