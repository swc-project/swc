                ...
                function newParse(specifier, Z) {
                    return function(string) {
                        ...
                        if (!Z || "Z" in d || (d.Z = 0), "p" in d && (d.H = d.H % 12 + 12 * d.p), void 0 === d.m && (d.m = "q" in d ? d.q : 0), "V" in d) {
                            ...
                            "w" in d || (d.w = 1), "Z" in d ? (day1 = (week = utcDate(newDate(d.y, 0, 1))).getUTCDay(), week = day1 > 4 || 0 === day1 ? utcMonday.ceil(week) : utcMonday(week), week = utcDay.offset(week, (d.V - 1) * 7), d.y = week.getUTCFullYear(), d.m = week.getUTCMonth(), d.d = week.getUTCDate() + (d.w + 6) % 7) : (day1 = (week = localDate(newDate(d.y, 0, 1))).getDay(), week = day1 > 4 || 0 === day1 ? monday.ceil(week) : monday(week), week = day.offset(week, (d.V - 1) * 7), d.y = week.getFullYear(), d.m = week.getMonth(), d.d = week.getDate() + (d.w + 6) % 7);
