...
var load3 = __swcpack_require__.bind(void 0, function(module, exports) {
    'use strict';
    if (process.env.NODE_ENV === 'production') module.exports = load1();
    else module.exports = load2();
});
...
var load6 = __swcpack_require__.bind(void 0, function(module, exports) {
    'use strict';
    if (process.env.NODE_ENV === 'production') module.exports = load4();
    else module.exports = load5();
});
var { jsx: _jsx } = load6();
var Divider = _jsx("div", {});
