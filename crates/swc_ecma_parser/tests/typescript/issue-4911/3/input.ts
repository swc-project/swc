import __process$ from "/v45/node_process.js";
...
var T = (f, e, r) => {
    if (e && typeof e == "object" || typeof e == "function")
        for (let i of S(e)) !L.call(f, i) && i !== "default" && m(f, i, {
            get: () => e[i],
            enumerable: !(r = w(e, i)) || r.enumerable
        });
    return f
},
    R = f => T(z(m(f != null ? y(P(f)) : {}, "default", f && f.__esModule && "default" in f ? {
        get: () => f.default,
        enumerable: !0
    } : {
        value: f,
...
var h = D((q, C) => {
    ...
    function b(f, e) {
        for (var r = "", i = 0, l = -1, s = 0, n, t = 0; t <= f.length; ++t) {
            ...
            if (n === 47) {
                if (!(l === t - 1 || s === 1))
                    if (l !== t - 1 && s === 2) {
                        if (r.length < 2 || i !== 2 || r.charCodeAt(r.length - 1) !== 46 || r.charCodeAt(r.length - 2) !== 46) {
                            if (r.length > 2) {
                                var a = r.lastIndexOf("/");
                                if (a !== r.length - 1) {
                                    a === -1 ? (r = "", i = 0) : (r = r.slice(0, a), i = r.length - 1 - r.lastIndexOf("/")), l = t, s = 0;
                                    continue
                                }
                    ...
                    } else r.length > 0 ? r += "/" + f.slice(l + 1, t) : r = f.slice(l + 1, t), i = t - l - 1;
                l = t, s = 0
            } else n === 46 && s !== -1 ? ++s : s = -1
        }
        return r
