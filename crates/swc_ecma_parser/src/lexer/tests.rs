...
fn str_escape_hex() {
    assert_eq!(
        ...
        vec![Token::Str { value: "a".into() }.span(0..6).lb(),]
    );
}
...
fn str_escape_unicode_long() {
    assert_eq!(
        ...
        vec![Token::Str { value: "4".into() }.span(0..17).lb(),]
    );
}
...
fn issue_401() {
    assert_eq!(
        ...
        vec![Token::Str { value: "17".into() }, tok!("as"), tok!("const")],
    );
}
