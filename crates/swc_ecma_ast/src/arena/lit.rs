...
//     ($bridge: ty, $src:ty) => {
//         // bridge_expr_from!(crate::Lit<'a>, $src);
//         bridge_from!(Box<'a, $bridge>, $bridge, $src);
//         bridge_from!(Lit<'a>, Box<'a, $bridge>, $src);
//     };
// }

// bridge_expr_from!(Lit<'a>, Str);
// bridge_expr_from!(Lit<'a>, Bool);
// bridge_expr_from!(Lit<'a>, Number);
// bridge_expr_from!(Lit<'a>, BigInt<'a>);
// bridge_expr_from!(Lit<'a>, Regex);
// bridge_expr_from!(Lit<'a>, Null);
// bridge_expr_from!(Lit<'a>, JSXText);
...
// bridge_lit_from!(BigInt<'a>, BigIntValue);
...
impl EqIgnoreSpan for BigInt<'_> {
...
#[derive(Debug, Clone, Copy, CloneIn)]
#[cfg_attr(feature = "rkyv-impl", derive(bytecheck::CheckBytes))]
#[cfg_attr(feature = "rkyv-impl", repr(C))]
pub struct EncodeBigInt;

#[cfg(feature = "rkyv-impl")]
impl rkyv::with::ArchiveWith<Box<'_, BigIntValue>> for EncodeBigInt {
...
#[cfg(feature = "rkyv-impl")]
impl<S> rkyv::with::SerializeWith<Box<'_, BigIntValue>, S> for EncodeBigInt
where
...
// #[cfg(feature = "rkyv-impl")]
// impl<D> rkyv::with::DeserializeWith<rkyv::Archived<String>, Box<BigIntValue>,
// D> for EncodeBigInt where
...
// impl<'a> FromWith<'a, BigIntValue> for BigInt<'a> {
//     fn from_with(value: BigIntValue, allocator: &'a swc_allocator::Allocator)
// -> Self {         BigInt {
//             span: DUMMY_SP,
//             value: Box::new_in(value, allocator),
//             raw: None,
//         }
//     }
// }
