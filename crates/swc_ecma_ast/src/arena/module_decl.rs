...
#[derive(Debug, Copy, Clone, CloneIn, PartialEq, Eq, Hash, Default, EqIgnoreSpan)]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[cfg_attr(
...
pub enum DefaultDecl<'a> {
    ...
    TsInterfaceDecl(Box<'a, TsInterfaceDecl<'a>>),
}
...
pub enum ImportSpecifier<'a> {
    ...
    Default(Box<'a, ImportDefaultSpecifier>),
    // #[tag("ImportNamespaceSpecifier")]
    Namespace(Box<'a, ImportStarAsSpecifier>),
}
...
pub enum ExportSpecifier<'a> {
    ...
    Default(Box<'a, ExportDefaultSpecifier>),
...
// bridge_from!(Box<'a, Ident>, Ident, BindingIdent<'a>);
// bridge_from!(ModuleExportName<'a>, Box<'a, Ident>, BindingIdent<'a>);
// bridge_from!(Box<'a, Ident>, Ident, IdentName);
// bridge_from!(ModuleExportName<'a>, Box<'a, Ident>, IdentName);
