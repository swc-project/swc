...
use swc_ecma_ast::{
    ...
    FnDecl, ForInStmt, ForOfStmt, ForStmt, GetterProp, IfStmt, ImportDecl, ImportSpecifier,
    NamedExport, Param, Pat, PrivateMethod, PrivateProp, Program, SetterProp, Stmt, TsAsExpr,
    ...
    TsTypeParamInstantiation, WhileStmt,
};
use swc_ecma_parser::{
    lexer::Lexer,
