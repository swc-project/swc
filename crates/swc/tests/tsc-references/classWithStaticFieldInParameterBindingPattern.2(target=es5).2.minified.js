...
var _class, _class1, _this1 = this, __ = new WeakMap(), __1 = new WeakMap(), C = function C() {
...
(void 0)[(_class = /*#__PURE__*/ function(C) {
    ...
    param[(_class1 = /*#__PURE__*/ function(C) {
        ...
        writable: !0,
        value: _this1.x = 1
    }), _class1).x], arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
}();
