...
f10(42);
f10();
f10.apply(void 0, _to_consumable_array(t3));
f10.apply(void 0, [
    42
].concat(_to_consumable_array(t2)));
f10.apply(void 0, [
...
f10.apply(void 0, _to_consumable_array(ns).concat([
    !0
]));
f11(42, "hello", !0);
f11(42, "hello");
f11(42);
f11();
f11.apply(void 0, _to_consumable_array(t3));
f11.apply(void 0, [
    42
].concat(_to_consumable_array(t2)));
f11.apply(void 0, [
...
f11.apply(void 0, _to_consumable_array(ns).concat([
    !0
]));
function call(f) {
