...
function f(definiteBoolean, definiteString, optionalString, optionalNumber, undefinedString, undefinedNumber) {
    ...
    // undefined
    let undefinedUnionStops = _objectSpread({}, definiteBoolean, definiteString, undefinedNumber);
    let undefinedUnionDuplicates = _objectSpread({}, definiteBoolean, definiteString, undefinedString, undefinedNumber);
    let allUndefined = _objectSpread({}, undefinedString, undefinedNumber);
    let undefinedWithOptionalContinues = _objectSpread({}, definiteBoolean, undefinedString, optionalNumber);
}
const m = {
    title: "The Matrix",
    yearReleased: 1999
