...
function _testPromise2() {
    _testPromise2 = /** @type {FunctionReturningPromise} */
...
/** @type {FunctionReturningPromise} */
var testPromise4 = function testPromise4() {
    console.log("test");
};
/**
...
function _testNever2() {
    _testNever2 = /** @type {FunctionReturningNever} */
    _async_to_generator(function() {
        return _ts_generator(this, function(_state) {
            return [
                2,
...
/** @type {FunctionReturningNever} */
var testNever4 = function testNever4() {
    console.log("test");
};
