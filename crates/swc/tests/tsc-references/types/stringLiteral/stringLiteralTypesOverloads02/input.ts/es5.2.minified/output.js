...
Consts1 = Consts1 || (Consts1 = {
}), getFalsyPrimitive("string"), getFalsyPrimitive("number"), getFalsyPrimitive("boolean");
var Consts1, Consts1, Consts2, Consts2, string = "string", number = "number", boolean = "boolean", stringOrBoolean = string || boolean;
Consts2 = Consts2 || (Consts2 = {
