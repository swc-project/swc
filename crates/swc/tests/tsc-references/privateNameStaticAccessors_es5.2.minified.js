...
var A1 = function(name) {
    ...
    }(this, A1), _classStaticPrivateFieldSpecSet(A1, A1, _prop, ""), _classStaticPrivateFieldSpecSet(A1, A1, _roProp, ""), console.log(_classStaticPrivateFieldSpecGet(A1, A1, _prop)), console.log(_classStaticPrivateFieldSpecGet(A1, A1, _roProp));
}, _prop = {
    get: function() {
        return "";
    },
