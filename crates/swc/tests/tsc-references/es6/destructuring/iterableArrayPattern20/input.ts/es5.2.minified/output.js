...
var arr, _typeof = function(obj) {
    ...
    return Constructor = FooArrayIterator, protoProps = [
        {
            key: "next",
            value: function() {
                return {
    ...
    ], _defineProperties(Constructor.prototype, protoProps), staticProps && _defineProperties(Constructor, staticProps), FooArrayIterator;
}();
(function() {
