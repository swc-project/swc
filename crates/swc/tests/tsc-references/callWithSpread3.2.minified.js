...
fs2.apply(void 0, _to_consumable_array(s3));
fs2_.apply(void 0, _to_consumable_array(s_));
fs2_.apply(void 0, _to_consumable_array(s2n_));
fs2_.apply(void 0, _to_consumable_array(s_).concat(_to_consumable_array(s_)));
fs2_.apply(void 0, _to_consumable_array(s_).concat(_to_consumable_array(s_), _to_consumable_array(s_)));
fs2n_.apply(void 0, _to_consumable_array(s2_));
