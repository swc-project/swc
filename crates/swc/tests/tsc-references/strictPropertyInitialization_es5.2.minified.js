...
var _f = new WeakMap(), _g = new WeakMap(), _h = new WeakMap(), _i = new WeakMap(), C1 = function() {
    ...
    this.a = this.b, receiver = this, descriptor = _classExtractFieldDescriptor(receiver, privateMap = _d1, "get"), this.b = descriptor.get ? descriptor.get.call(receiver) : descriptor.value, this.b = x, _classPrivateFieldSet(this, _d1, x), this.c;
