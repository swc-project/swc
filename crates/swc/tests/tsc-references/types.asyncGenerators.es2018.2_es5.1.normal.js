        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(_tmp), _await_async_generator))
                    ];
                case 1:
                    _state.sent();
                    return [
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(inferReturnType2()), _await_async_generator))
                    ];
                case 1:
                    _state.sent();
                    return [
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(Promise.resolve([
                            1,
                            2
