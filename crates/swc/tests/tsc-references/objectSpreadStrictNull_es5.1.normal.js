...
function f(definiteBoolean, definiteString, optionalString, optionalNumber, undefinedString, undefinedNumber) {
    ...
    // undefined
    var undefinedUnionStops = _objectSpread({}, definiteBoolean, definiteString, undefinedNumber);
    var undefinedUnionDuplicates = _objectSpread({}, definiteBoolean, definiteString, undefinedString, undefinedNumber);
    var allUndefined = _objectSpread({}, undefinedString, undefinedNumber);
    var undefinedWithOptionalContinues = _objectSpread({}, definiteBoolean, undefinedString, optionalNumber);
}
var m = {
    title: "The Matrix",
    yearReleased: 1999
