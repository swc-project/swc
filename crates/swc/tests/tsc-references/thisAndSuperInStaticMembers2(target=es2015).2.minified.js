...
C.y1 = C.x;
C.y2 = C.x();
C.y3 = null == C ? void 0 : C.x();
C.y4 = C.x();
C.y5 = null == C ? void 0 : C.x();
...
C.z5 = _set(_get_prototype_of(C), "a", 0, C, !0);
C.z6 = _update(_get_prototype_of(C), "a", C, !0)._ += 1;
C.z7 = void _set(_get_prototype_of(C), "a", 0, C, !0);
C.z8 = [_update(_get_prototype_of(C), "a", C, !0)._] = [
    0
];
...
C.z13 = (_tmp = {
    x: 0
}, _update(_get_prototype_of(C), "a", C, !0)._ = _extends({}, _tmp), _tmp);
C.z14 = ++_update(_get_prototype_of(C), "a", C, !0)._;
C.z15 = --_update(_get_prototype_of(C), "a", C, !0)._;
C.z16 = ++_update(_get_prototype_of(C), "a", C, !0)._;
C.z17 = _update(_get_prototype_of(C), "a", C, !0)._++;
