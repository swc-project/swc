...
var TypeScript, globalAstWalkerFactory, ChildrenWalkers, TypeScript1 = TypeScript || (TypeScript = {}), AstWalkOptions = /*#__PURE__*/ function() {
...
var ChildrenWalkers1 = ChildrenWalkers || (ChildrenWalkers = {});
...
ChildrenWalkers1.walkNone = function(preAst, parent, walker) {}, ChildrenWalkers1.walkListChildren = function(preAst, parent, walker) {
...
}, ChildrenWalkers1.walkRecordChildren = walkRecordChildren, ChildrenWalkers1.walkNamedTypeChildren = function(preAst, parent, walker) {
    walkRecordChildren(preAst, parent, walker);
}, ChildrenWalkers1.walkClassDeclChildren = function(preAst, parent, walker) {
    ...
    preAst.expr && (preAst.expr = walker.walk(preAst.expr, preAst)), preAst.body && walker.options.goNextSibling && (preAst.body = walker.walk(preAst.body, preAst));
}, ChildrenWalkers1.walkLabelChildren = function(preAst, parent, walker) {}, ChildrenWalkers1.walkLabeledStatementChildren = function(preAst, parent, walker) {
