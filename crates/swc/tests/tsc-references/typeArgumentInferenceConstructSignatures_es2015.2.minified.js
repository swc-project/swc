...
new noParams(), new noParams(), new noParams(), new noGenericParams(""), new noGenericParams(""), new noGenericParams(""), new someGenerics1(3, 4), new someGenerics1(3, 4), new someGenerics1(3, 4), new someGenerics2a((n)=>n
...
), new someGenerics3(()=>void 0
), new someGenerics3(()=>3
), new someGenerics4(4, ()=>null
), new someGenerics4("", ()=>3
), new someGenerics4("", (x)=>""
), new someGenerics4(null, null), new someGenerics5(4, ()=>null
), new someGenerics5("", ()=>3
), new someGenerics5("", (x)=>""
), new someGenerics5(null, null), new someGenerics6((n)=>n
, (n)=>n
, (n)=>n
), new someGenerics6((n)=>n
, (n)=>n
, (n)=>n
), new someGenerics6((n)=>n
, (n)=>n
