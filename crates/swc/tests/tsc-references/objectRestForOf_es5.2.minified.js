...
try {
    for(var __ref, _step1, _iterator1 = array[Symbol.iterator](); !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = !0)__ref = _step1.value, swcHelpers.objectWithoutProperties(__ref, [
        "x"
    ]), __ref.x;
} catch (err) {
