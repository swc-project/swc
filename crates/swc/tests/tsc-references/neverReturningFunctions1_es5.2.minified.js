...
var MyThrowable = function() {
    ...
    return _createClass(MyThrowable, [
        {
            key: "throw",
            value: function() {
                throw new Error();
    ...
    }(SuperThrowable, MyThrowable);
    var Derived, hasNativeReflectConstruct, _super = (Derived = SuperThrowable, hasNativeReflectConstruct = function() {
    ...
    function SuperThrowable() {
        return _classCallCheck(this, SuperThrowable), _super.apply(this, arguments);
    }
    return _createClass(SuperThrowable, [
        {
            key: "err",
            value: function(msg) {
