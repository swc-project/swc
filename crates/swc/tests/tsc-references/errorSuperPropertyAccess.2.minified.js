...
var SomeDerived1 = function(SomeBase) {
    ...
    return SomeDerived3.fn = function() {
        _set(_get_prototype_of(SomeDerived3), "publicStaticMember", 3, this, !0), _set(_get_prototype_of(SomeDerived3), "privateStaticMember", 3, this, !0), _get(_get_prototype_of(SomeDerived3), "privateStaticFunc", this).call(this);
    }, _create_class(SomeDerived3, null, [
        {
            key: "a",
            get: function() {
                return _set(_get_prototype_of(SomeDerived3), "publicStaticMember", 3, this, !0), _set(_get_prototype_of(SomeDerived3), "privateStaticMember", 3, this, !0), _get(_get_prototype_of(SomeDerived3), "privateStaticFunc", this).call(this), "";
            },
            set: function(n) {
                _set(_get_prototype_of(SomeDerived3), "publicStaticMember", 3, this, !0), _set(_get_prototype_of(SomeDerived3), "privateStaticMember", 3, this, !0), _get(_get_prototype_of(SomeDerived3), "privateStaticFunc", this).call(this);
            }
