    ...
    return _proto.simple = function() {
        ...
        return _async_to_generator(regeneratorRuntime.mark(function _callee() {
            ...
            return regeneratorRuntime.wrap(function(_ctx) {
                for(;;)switch(_ctx.prev = _ctx.next){
                    case 0:
                        _super = null, _superIndex = null, f = function() {}, _superprop_get_x().call(_this1), _superprop_get("x").call(_this1), a = _superprop_get_x(), b = _superprop_get("x"), _set(_get_prototype_of(B.prototype), "x", f, _this, !0), _set(_get_prototype_of(B.prototype), "x", f, _this, !0), ref = {
                            f: f
