...
(Compass = Compass1 || (Compass1 = {}))[Compass.North = 0] = "North", Compass[Compass.South = 1] = "South", Compass[Compass.East = 2] = "East", Compass[Compass.West = 3] = "West";
var Compass1, bothIndex, stringOrNumber, someObject, Compass, numIndex = {
    3: "three",
    three: "three"
}, strIndex = {
    N: 0,
