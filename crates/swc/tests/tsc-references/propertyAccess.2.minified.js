...
obj.hasOwnProperty;
obj.qqq;
obj["literal property"];
obj["wa wa wa wa wa"];
obj["10"];
obj["1"];
numIndex[3.0];
numIndex[Compass.South];
numIndex[anyVar];
numIndex.what;
numIndex[someObject];
strIndex.N;
strIndex.zzz;
strIndex[10];
strIndex[Compass.East];
strIndex[null];
noIndex[123];
noIndex[Compass.South];
noIndex[null];
noIndex[someObject];
noIndex[32];
bothIndex[Compass.East];
bothIndex[null];
bothIndex.foo;
bothIndex["1.0"];
bothIndex[someObject];
numIndex[stringOrNumber];
strIndex[stringOrNumber];
bothIndex[stringOrNumber];
