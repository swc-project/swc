...
let o2 = _objectSpread({}, publicX, privateOptionalX);
...
let duplicatedSpread = _objectSpread({}, o, o);
...
let combinedMid = _objectSpread({}, o3, {
    b: 'ok'
}, o4);
...
let computedMiddle = _objectSpread({}, o3, {
    ['in the middle']: 13,
    b: 'maybe?'
}, o4);
// primitives are not allowed, except for falsy ones
let spreadNum = _objectSpread({}, 12);
let spreadSum = _objectSpread({}, 1 + 1);
let spreadZero = _objectSpread({}, 0);
spreadZero.toFixed(); // error, no methods even from a falsy number
let spreadBool = _objectSpread({}, true);
spreadBool.valueOf();
let spreadStr = _objectSpread({}, 'foo');
...
let spreadObj = _objectSpread({}, obj);
