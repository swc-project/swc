...
global = this, factory = function(exports1, _async_to_generator, _interop_require_default, _a) {
    ...
    "./a"
], factory) : (global = "undefined" != typeof globalThis ? globalThis : global || self) && factory(global.bTs = {}, global.asyncToGenerator, global.interopRequireDefault, global.a) : factory(exports, require("@swc/helpers/_/_async_to_generator"), require("@swc/helpers/_/_interop_require_default"), require("./a"));
