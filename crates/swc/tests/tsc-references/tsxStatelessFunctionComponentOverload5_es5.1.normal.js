...
var b1 = /*#__PURE__*/ React.createElement(MainButton, swcHelpers.extends({
    onClick: function(e) {}
}, obj0), "Hello world"); // extra property;
var b2 = /*#__PURE__*/ React.createElement(MainButton, swcHelpers.extends({}, {
    to: "10000"
}, obj2)); // extra property
...
var b4 = /*#__PURE__*/ React.createElement(MainButton, swcHelpers.extends({}, obj3, {
    to: true
})); // Should error because Incorrect type; but attributes are any so everything is allowed
var b5 = /*#__PURE__*/ React.createElement(MainButton, swcHelpers.extends({}, {
    onClick: function onClick(e) {}
}, obj0)); // Spread retain method declaration (see GitHub #13365), so now there is an extra attributes
var b6 = /*#__PURE__*/ React.createElement(MainButton, swcHelpers.extends({}, {
    onClick: function onClick(e) {}
}, {
    children: 10
