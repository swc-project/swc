...
(function(TypeScript) {
    ...
    class AstWalkerFactory {
        walk(ast1, pre, post, options, state) {
            return this.getWalker(pre, post, options, state).walk(ast1, null);
        }
        getWalker(pre1, post1, options1, state1) {
            return this.getSlowWalker(pre1, post1, options1, state1);
        }
        getSlowWalker(pre2, post2, options2, state2) {
            if (!options2) {
                options2 = new AstWalkOptions();
            }
            return new AstWalker(this.childrenWalkers, pre2, post2, options2, state2);
        }
        initChildrenWalkers() {
    ...
    (function(ChildrenWalkers1) {
        function walkNone(preAst, parent, walker) {
        // Nothing to do
        }
        ChildrenWalkers1.walkNone = walkNone;
        ...
        ChildrenWalkers1.walkListChildren = walkListChildren;
        ...
        ChildrenWalkers1.walkUnaryExpressionChildren = walkUnaryExpressionChildren;
        ...
        ChildrenWalkers1.walkBinaryExpressionChildren = walkBinaryExpressionChildren;
        function walkTypeReferenceChildren(preAst, parent, walker) {
            if (preAst.term) {
                preAst.term = walker.walk(preAst.term, preAst);
            }
        }
        ChildrenWalkers1.walkTypeReferenceChildren = walkTypeReferenceChildren;
        ...
        ChildrenWalkers1.walkCallExpressionChildren = walkCallExpressionChildren;
        ...
        ChildrenWalkers1.walkTrinaryExpressionChildren = walkTrinaryExpressionChildren;
        ...
        ChildrenWalkers1.walkFuncDeclChildren = walkFuncDeclChildren;
        ...
        ChildrenWalkers1.walkBoundDeclChildren = walkBoundDeclChildren;
        function walkReturnStatementChildren(preAst, parent, walker) {
            if (preAst.returnExpression) {
                preAst.returnExpression = walker.walk(preAst.returnExpression, preAst);
            }
        }
        ChildrenWalkers1.walkReturnStatementChildren = walkReturnStatementChildren;
        ...
        ChildrenWalkers1.walkForStatementChildren = walkForStatementChildren;
        ...
        ChildrenWalkers1.walkForInStatementChildren = walkForInStatementChildren;
        ...
        ChildrenWalkers1.walkIfStatementChildren = walkIfStatementChildren;
        ...
        ChildrenWalkers1.walkWhileStatementChildren = walkWhileStatementChildren;
        ...
        ChildrenWalkers1.walkDoWhileStatementChildren = walkDoWhileStatementChildren;
        function walkBlockChildren(preAst, parent, walker) {
            if (preAst.statements) {
                preAst.statements = walker.walk(preAst.statements, preAst);
            }
        }
        ChildrenWalkers1.walkBlockChildren = walkBlockChildren;
        ...
        ChildrenWalkers1.walkCaseStatementChildren = walkCaseStatementChildren;
        ...
        ChildrenWalkers1.walkSwitchStatementChildren = walkSwitchStatementChildren;
        function walkTryChildren(preAst, parent, walker) {
            if (preAst.body) {
                preAst.body = walker.walk(preAst.body, preAst);
            }
        }
        ChildrenWalkers1.walkTryChildren = walkTryChildren;
        ...
        ChildrenWalkers1.walkTryCatchChildren = walkTryCatchChildren;
        ...
        ChildrenWalkers1.walkTryFinallyChildren = walkTryFinallyChildren;
        function walkFinallyChildren(preAst, parent, walker) {
            if (preAst.body) {
                preAst.body = walker.walk(preAst.body, preAst);
            }
        }
        ChildrenWalkers1.walkFinallyChildren = walkFinallyChildren;
        ...
        ChildrenWalkers1.walkCatchChildren = walkCatchChildren;
        ...
        ChildrenWalkers1.walkRecordChildren = walkRecordChildren;
        function walkNamedTypeChildren(preAst, parent, walker) {
            walkRecordChildren(preAst, parent, walker);
        }
        ChildrenWalkers1.walkNamedTypeChildren = walkNamedTypeChildren;
        ...
        ChildrenWalkers1.walkClassDeclChildren = walkClassDeclChildren;
        function walkScriptChildren(preAst, parent, walker) {
            if (preAst.bod) {
                preAst.bod = walker.walk(preAst.bod, preAst);
            }
        }
        ChildrenWalkers1.walkScriptChildren = walkScriptChildren;
        ...
        ChildrenWalkers1.walkTypeDeclChildren = walkTypeDeclChildren;
        function walkModuleDeclChildren(preAst, parent, walker) {
            walkRecordChildren(preAst, parent, walker);
        }
        ChildrenWalkers1.walkModuleDeclChildren = walkModuleDeclChildren;
        ...
        ChildrenWalkers1.walkImportDeclChildren = walkImportDeclChildren;
        ...
        ChildrenWalkers1.walkWithStatementChildren = walkWithStatementChildren;
        function walkLabelChildren(preAst, parent, walker) {
        //TODO: Walk "id"?
        }
        ChildrenWalkers1.walkLabelChildren = walkLabelChildren;
        ...
        ChildrenWalkers1.walkLabeledStatementChildren = walkLabeledStatementChildren;
