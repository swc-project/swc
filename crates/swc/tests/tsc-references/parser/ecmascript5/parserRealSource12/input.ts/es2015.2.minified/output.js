...
!function(TypeScript) {
    ...
    class AstWalker {
        walk(ast, parent1) {
            ...
            if (void 0 === preAst && (preAst = ast), this.options.goChildren) {
                ...
                this.options.goNextSibling = !0, this.childrenWalkers[ast.nodeType](ast, parent1, this), this.options.goNextSibling = svGoSib;
    ...
    class AstWalkerFactory {
        ...
        getSlowWalker(pre2, post2, options2, state2) {
            return options2 || (options2 = new AstWalkOptions()), new AstWalker(this.childrenWalkers, pre2, post2, options2, state2);
        }
        initChildrenWalkers() {
