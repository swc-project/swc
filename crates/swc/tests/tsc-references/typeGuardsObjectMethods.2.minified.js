...
var strOrNum, var1, obj1 = {
    ...
    get prop () {
        ...
        "string" == typeof var2 && var2.length;
        return strOrNum;
    },
    set prop (param){
        var var21;
        "string" == typeof var1 && var1.length;
        "string" == typeof var21 && var21.length;
        "string" == typeof param && param.length;
    }
};
strOrNum = "string" == typeof obj1.method(strOrNum) && obj1.method(strOrNum);
