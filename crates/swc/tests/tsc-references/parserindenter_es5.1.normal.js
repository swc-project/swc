...
(function(Formatting1) {
    var Indenter = /*#__PURE__*/ function() {
        ...
        _proto.GetIndentationEdits = function GetIndentationEdits(token, nextToken, node, sameLineIndent) {
        ...
        _proto.GetIndentationEditsWorker = function GetIndentationEditsWorker(token, nextToken, node, sameLineIndent) {
        ...
        _proto.GetCommentIndentationEdits = function GetCommentIndentationEdits(token) {
            var result = new List_TextEditInfo();
        ...
        _proto.GetSpecialCaseIndentation = function GetSpecialCaseIndentation(token, node) {
            var indentationInfo = null;
            switch(token.Token){
        ...
        _proto.GetSpecialCaseIndentationForLCurly = function GetSpecialCaseIndentationForLCurly(node) {
            var indentationInfo = null;
        ...
        _proto.GetSpecialCaseIndentationForSemicolon = function GetSpecialCaseIndentationForSemicolon(token, node) {
            var indentationInfo = null;
            if (this.smartIndent) {
                indentationInfo = node.GetEffectiveChildrenIndentation(this);
                return indentationInfo;
        ...
        _proto.GetSpecialCaseIndentationForComment = function GetSpecialCaseIndentationForComment(token, node) {
            var indentationInfo = null;
        ...
        _proto.CanIndentComment = function CanIndentComment(token, node) {
        ...
        _proto.ApplyScriptBlockIndentation = function ApplyScriptBlockIndentation(languageHostIndentation, tree) {
        ...
        _proto.GetIndentEdit = function GetIndentEdit(indentInfo, tokenStartPosition, sameLineIndent) {
        ...
        _proto.ApplyIndentationLevel = function ApplyIndentationLevel(existingIndentation, level) {
        ...
        _proto.ApplyIndentationDeltaFromParent = function ApplyIndentationDeltaFromParent(token, node) {
            var indentationInfo = null;
        ...
        _proto.ApplyIndentationDelta1 = function ApplyIndentationDelta1(tokenStartPosition, delta) {
        ...
        _proto.ApplyIndentationDelta2 = function ApplyIndentationDelta2(currentIndent, delta) {
        ...
        _proto.FillInheritedIndentation = function FillInheritedIndentation(tree) {
            var offset = -1;
            var indentNode = null;
        ...
        _proto.GetLineIndentationForOffset = function GetLineIndentationForOffset(offset) {
            var indentationEdit;
        ...
        _proto.RegisterIndentation = function RegisterIndentation(indent, sameLineIndent) {
            var indentationInfo = null;
            if (sameLineIndent) {
        ...
        _proto.RegisterIndentation2 = function RegisterIndentation2(position, indent) {
            this.RegisterIndentation(new TextEditInfo(position, 0, indent), false);
        };
        _proto.AdjustStartOffsetIfNeeded = function AdjustStartOffsetIfNeeded(token, node) {
        ...
        _proto.IsMultiLineString = function IsMultiLineString(token) {
