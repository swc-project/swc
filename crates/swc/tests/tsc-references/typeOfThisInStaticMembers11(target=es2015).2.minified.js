...
_define_property(C, "a", 1), _define_property(C, "b", C.a + 1), C = _ts_decorate([
    foo
], C);
class D extends C {
    static foo() {
...
_define_property(D, "c", 2), _define_property(D, "d", D.c + 1), _define_property(D, "e", _get(_get_prototype_of(D), "a", D) + D.c + 1), _define_property(D, "f", ()=>D.c + 1), _define_property(D, "ff", function() {
    this.c;
}), D = _ts_decorate([
    foo
], D);
