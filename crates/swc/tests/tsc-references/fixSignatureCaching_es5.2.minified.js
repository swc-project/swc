    ...
    define(function() {
        ...
        return impl.FALLBACK_PHONE = "UnknownPhone", impl.FALLBACK_TABLET = "UnknownTablet", impl.FALLBACK_MOBILE = "UnknownMobile", isArray = "isArray" in Array ? Array.isArray : function(value) {
            ...
            if (undefined === cache.mobile) {
                ...
                if (phone = impl.findMatch(impl.mobileDetectRules.phones, userAgent)) {
            ...
            match: function(pattern) {
                var left, right;
                return left = pattern, (null != (right = RegExp) && "undefined" != typeof Symbol && right[Symbol.hasInstance] ? right[Symbol.hasInstance](left) : left instanceof right) || (pattern = new RegExp(pattern, "i")), pattern.test(this.ua);
            },
