...
class A {
    static test() {
        ...
        new (_class_static_private_field_spec_get(this, A, _fieldFunc2))(0, ...arr, 3);
        _class_static_private_field_spec_get(this, A, _fieldFunc2).bind(A)`head${1}middle${2}tail`;
