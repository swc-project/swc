...
t2.z.toString(); // Should error
{
    ...
    var x1 = numMapPoint.x, q = swcHelpers.objectWithoutProperties(numMapPoint, [
        "x"
    ]);
...
// Assignment forms
ref = swcHelpers.slicedToArray(strArray, 1), target_string = ref[0], ref; // Should error
var ref1;
ref1 = swcHelpers.slicedToArray(strArray, 1), target_string_undef = ref1[0], ref1; // Should OK
var ref2;
ref2 = swcHelpers.toArray(strArray), target_string_arr = ref2.slice(3), ref2; // Should OK
{
    var x2, y1, z1;
    var ref3;
