...
var _C, _D, C = (_define_property(_C = function C() {
...
}, "a", 1), _define_property(_C, "b", _C.a + 1), _C), D = (_define_property(_D = function(C) {
    "use strict";
    _inherits(D, C);
    ...
    foo
], C)), "c", 2), _define_property(_D, "d", _D.c + 1), _define_property(_D, "e", _get(_get_prototype_of(_D), "a", _D) + _D.c + 1), _define_property(_D, "f", function() {
    return _D.c + 1;
