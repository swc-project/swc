...
var React = require("react"), Poisoned = function(_Component) {
    ...
    function Poisoned() {
        ...
        }(this, Poisoned), self = this, call = _getPrototypeOf(Poisoned).apply(this, arguments), call && ("object" == ((obj = call) && "undefined" != typeof Symbol && obj.constructor === Symbol ? "symbol" : typeof obj) || "function" == typeof call) ? call : (function(self) {
    ...
    }(Poisoned, _Component), Constructor = Poisoned, protoProps = [
        {
            key: "render",
            value: function() {
