...
_define_property(C, "z5", _set(_get_prototype_of(C), "a", 0, C, !0));
_define_property(C, "z6", _update(_get_prototype_of(C), "a", C, !0)._ += 1);
_define_property(C, "z7", void _set(_get_prototype_of(C), "a", 0, C, !0));
_define_property(C, "z8", [_update(_get_prototype_of(C), "a", C, !0)._] = [
    0
]);
...
_define_property(C, "z14", ++_update(_get_prototype_of(C), "a", C, !0)._);
_define_property(C, "z15", --_update(_get_prototype_of(C), "a", C, !0)._);
_define_property(C, "z16", ++_update(_get_prototype_of(C), "a", C, !0)._);
_define_property(C, "z17", _update(_get_prototype_of(C), "a", C, !0)._++);
