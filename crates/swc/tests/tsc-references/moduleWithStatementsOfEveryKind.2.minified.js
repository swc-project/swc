...
A || (A = {}), Module || (Module = {}), Color1 = Color || (Color = {}), Color1[Color1.Blue = 0] = "Blue", Color1[Color1.Red = 1] = "Red", Y1 = Y || (Y = {}), A1 = function A() {
    ...
    return BB;
}(A1), Y1.BB = BB, Y1.Module || (Y1.Module = {}), Color2 = Y1.Color || (Y1.Color = {}), Color2[Color2.Blue = 0] = "Blue", Color2[Color2.Red = 1] = "Red", Y1.x = 12, Y1.F = function(s) {
    return 2;
