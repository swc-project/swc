...
f2 = f1 = f2, f1(42, "hello", !0), f1(t3[0], t3[1], t3[2]), f1(...t3), f1(42, ...t2), f1(42, "hello", ...t1), f1(42, "hello", !0, ...t0), f1(ns[0], ns[1], !0), f1(...ns, !0), f2(42, "hello", !0), f2(t3[0], t3[1], t3[2]), f2(...t3), f2(42, ...t2), f2(42, "hello", ...t1), f2(42, "hello", !0, ...t0), f2(ns[0], ns[1], !0), f2(...ns, !0), f10(42, "hello", !0), f10(42, "hello"), f10(42), f10(), f10(...t3), f10(42, ...t2), f10(42, "hello", ...t1), f10(42, "hello", !0, ...t0), f10(...ns, !0), f11(42, "hello", !0), f11(42, "hello"), f11(42), f11(), f11(...t3), f11(42, ...t2), f11(42, "hello", ...t1), f11(42, "hello", !0, ...t0), f11(...ns, !0), call((x, y)=>x + y
, 10, 20), call((x, y)=>x + y
, 10, "hello"), call(f15, "hello", 42), call(f16, "hello", 42), call(f16, "hello", 42), callr(sn, (x, y)=>x + y
