...
TestWithErrors.dd = _class_private_field_get(_ref = new TestWithErrors(), _prop), TestWithErrors["X_ z_ zz"] = (_foo = new WeakMap(), (_Inner = class Inner {
    m() {
...
class TestNoErrors {
    constructor(){
        _class_private_field_init(this, _prop1, {
            writable: !0,
            value: 0
        }), this.dd = _class_private_field_get(_ref1 = new TestNoErrors(), _prop1), this["X_ z_ zz"] = (_foo1 = new WeakMap(), class Inner {
            m() {
