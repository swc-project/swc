...
class B extends A {
    ...
    property_access_only_read_only() {
        ...
        return _async_to_generator(function*() {
            _superprop_get_x().call(_this), _superprop_get_x();
        })();
    }
    property_access_only_write_only() {
        ...
        return _async_to_generator(function*() {
            let f = ()=>{};
            _superprop_set_x(f), { f: _superprop_update_x._  } = {
                f
            };
        })();
    }
    element_access_only_read_only() {
        ...
        return _async_to_generator(function*() {
            _superprop_get("x").call(_this), _superprop_get("x");
        })();
    }
    element_access_only_write_only() {
        ...
        return _async_to_generator(function*() {
            let f = ()=>{};
            _superprop_set("x", f), { f: _superprop_update("x")._  } = {
                f
            };
        })();
    }
