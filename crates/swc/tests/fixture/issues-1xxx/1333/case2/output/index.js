...
class Shard extends _utils.Emitter {
     ...
     */ _open() {
        ...
        this._debug(`Connected. ${(_class_private_field_get1 = _class_private_field_get(this, _ws1)) === null || _class_private_field_get1 === void 0 ? void 0 : _class_private_field_get1.url} in ${Date.now() - this.connectedAt}`);
