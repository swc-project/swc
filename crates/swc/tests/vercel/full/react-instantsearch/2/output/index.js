...
export default function S(u) {
    var o = u.indexName, l = u.initialState, S = u.searchClient, v = u.resultsState, x = u.stalledSearchDelay, y = function() {
        ...
        var s = n.indexId;
        return function(n) {
            var c = G.getState(), i = !W.derivedHelpers.length, u = c.results ? c.results : {};
            u = !i && u.getFacetByName ? {} : u, u = i ? n.results : r(t({}, u), e({}, s, n.results));
            var o = G.getState(), l = o.isSearchStalled;
            W.hasPendingRequests() || (clearTimeout(U), U = null, l = !1), o.resultsFacetValues;
            var d = a(o, [
                "resultsFacetValues"
            ]);
            G.setState(r(t({}, d), {
        ...
        W.hasPendingRequests() || (clearTimeout(U), c = !1), s.resultsFacetValues;
        var i = a(s, [
            "resultsFacetValues"
        ]);
        G.setState(r(t({}, i), {
    ...
    var M, J, E, T, k = !1, U = null, D = W.state, z = c(C);
    !function(e, a) {
    ...
    var G = (J = {
        widgets: void 0 === l ? {} : l,
        metadata: (T = v, T ? T.metadata.map(function(e) {
            return r(t({
                value: function() {
                    return {};
                }
