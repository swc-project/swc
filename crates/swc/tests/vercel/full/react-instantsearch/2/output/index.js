...
export default function S(c) {
    var o, l, S = c.indexName, v = c.initialState, x = c.searchClient, _ = c.resultsState, y = c.stalledSearchDelay, w = s(x, S, t({}, u));
    ...
    (function(a, s) {
        if (s) {
            if (a.transporter && !a._cacheHydrated || a._useCache && "function" == typeof a.addAlgoliaAgent) {
                ...
                if (Array.isArray(s.results)) return function(a, n) {
    ...
    function N(n) {
        var s = n.indexId;
        return function(n) {
            var i = A.getState(), u = !w.derivedHelpers.length, c = i.results ? i.results : {};
            c = !u && c.getFacetByName ? {} : c, c = u ? n.results : r(t({}, c), e({}, s, n.results));
    ...
    return {
        ...
        onSearchForFacetValues: function(a) {
            var n = a.facetName, s = a.query, i = a.maxFacetHits, u = Math.max(1, Math.min(void 0 === i ? 10 : i, 100));
            A.setState(r(t({}, A.getState()), {
                searchingForFacetValues: !0
            })), w.searchForFacetValues(n, s, u).then(function(a) {
                var i;
                A.setState(r(t({}, A.getState()), {
                    error: null,
                    searchingForFacetValues: !1,
