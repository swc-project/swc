...
var k = -.5210501878999999 - .1347134789;
export default function l(b, c, d, g) {
    return 1 === arguments.length ? (function(b) {
        ...
        var c = b.r / 255, d = b.g / 255, g = b.b / 255, h = (k * g + -1.7884503806 * c - 3.5172982438 * d) / (k + -1.7884503806 - 3.5172982438), i = g - h, l = -((1.97294 * (d - h) - -.29227 * i) / .90649), m = Math.sqrt(l * l + i * i) / (1.97294 * h * (1 - h)), n = m ? Math.atan2(l, i) * j - 120 : NaN;
...
b(Cubehelix, l, c(d, {
    ...
    rgb: function() {
        ...
        return new f(255 * (b + c * (-.14861 * d + 1.78277 * e)), 255 * (b + c * (-.29227 * d + -.90649 * e)), 255 * (b + c * (1.97294 * d)), this.opacity);
    }
}));
