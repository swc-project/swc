...
use react_compiler_hir::{
    ...
    environment::{is_hook_name, Environment},
        ...
        for &instr_id in &block.instructions {
            ...
            match &instr.value {
                ...
                InstructionValue::Destructure { lvalue, value, .. } => {
                    ...
                    // Process instr.lvalue and all pattern operands (matching TS
                ...
                _ => {
                    ...
                    value_kinds.insert(lvalue_id, kind);
                    // Also set kind for value-level lvalues (e.g. DeclareLocal, PrefixUpdate,
                    // PostfixUpdate)
