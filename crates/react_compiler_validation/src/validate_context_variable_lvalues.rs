...
use react_compiler_hir::{
    ...
    visitors::{each_instruction_value_lvalue, each_pattern_operand},
    ...
    if let Some((prev_place, prev_kind)) = identifiers.get(&place.identifier) {
        ...
        if was_context != is_context {
            ...
            return Err(CompilerDiagnostic::new(
                ...
                "Expected all references to a variable to be consistently local or context \
                 references",
                Some(format!(
                    "Identifier {} is referenced as a {} variable, but was previously referenced \
                     as a {} variable",
