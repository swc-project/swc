...
// =============================================================================
// DebugPrinter struct — thin wrapper around PrintFormatter for HIR-specific
// logic
// =============================================================================
...
/// This bridges the two debug printers so inner functions in
/// FunctionExpression/ObjectMethod can be printed within the reactive function
/// output.
