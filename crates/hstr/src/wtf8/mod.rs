    ...
    fn into_iter(self) -> Self::IntoIter {
        ...
        CharIter(match char::from_u32(self.value) {
            ...
            None => {
                ...
                let high = self.value & 0xffff0000 >> 16;

                let low = self.value & 0x0000ffff;
...
impl Wtf8Buf {
    ...
    #[inline]
    pub fn froming(string: String) -> Wtf8Buf {
        Wtf8Buf {
...
impl<'a> Iterator for Wtf8CodePoints<'a> {
    ...
    fn next(&mut self) -> Option<CodePoint> {
        not_quite_std::next_code_point(&mut self.bytes)
            .map(|value| unsafe { CodePoint::from_u32_unchecked(value) })
    }
...
impl PartialEq<&'_ Wtf8> for Wtf8Buf {
    fn eq(&self, other: &&Wtf8) -> bool {
        **self == **other
    }
}

impl PartialEq<Wtf8Buf> for &'_ Wtf8 {
...
mod tests {
    ...
    #[test]
    fn wtf8buf_from() {
        assert_eq!(Wtf8Buf::from("").bytes, b"");
        assert_eq!(Wtf8Buf::from("aé 💩").bytes, b"a\xC3\xA9 \xF0\x9F\x92\xA9");
    }

    #[test]
    fn wtf8buf_froming() {
        assert_eq!(Wtf8Buf::froming(String::from("")).bytes, b"");
        assert_eq!(
            Wtf8Buf::froming(String::from("aé 💩")).bytes,
    ...
    fn wtf8buf_push_char() {
        let mut string = Wtf8Buf::from("aé ");
    ...
    #[test]
    fn wtf8buf_as_slice() {
        assert_eq!(Wtf8Buf::from("aé"), Wtf8::from("aé"));
    }
    ...
    #[test]
    fn wtf8_from() {
        assert_eq!(&Wtf8::from("").bytes, b"");
        assert_eq!(&Wtf8::from("aé 💩").bytes, b"a\xC3\xA9 \xF0\x9F\x92\xA9");
    }

    #[test]
    fn wtf8_len() {
        assert_eq!(Wtf8::from("").len(), 0);
        assert_eq!(Wtf8::from("aé 💩").len(), 8);
    }

    #[test]
    fn wtf8_slice() {
        assert_eq!(&Wtf8::from("aé 💩").slice(1, 4).bytes, b"\xC3\xA9 ");
    }

    #[test]
    #[should_panic]
    fn wtf8_slice_not_code_point_boundary() {
        Wtf8::from("aé 💩").slice(2, 4);
    }

    #[test]
    fn wtf8_slice_from() {
        assert_eq!(
            &Wtf8::from("aé 💩").slice_from(1).bytes,
    ...
    fn wtf8_slice_from_not_code_point_boundary() {
        Wtf8::from("aé 💩").slice_from(2);
    }

    #[test]
    fn wtf8_slice_to() {
        assert_eq!(&Wtf8::from("aé 💩").slice_to(4).bytes, b"a\xC3\xA9 ");
    }

    #[test]
    #[should_panic]
    fn wtf8_slice_to_not_code_point_boundary() {
        Wtf8::from("aé 💩").slice_from(5);
    }

    #[test]
    fn wtf8_ascii_byte_at() {
        let slice = Wtf8::from("aé 💩");
    ...
    #[test]
    fn wtf8_as_str() {
        assert_eq!(Wtf8::from("").as_str(), Some(""));
        assert_eq!(Wtf8::from("aé 💩").as_str(), Some("aé 💩"));
        let mut string = Wtf8Buf::new();
        string.push(CodePoint::from_u32(0xd800).unwrap());
    ...
    fn wtf8_to_string_lossy() {
        assert_eq!(Wtf8::from("").to_string_lossy(), Cow::Borrowed(""));
        assert_eq!(
            Wtf8::from("aé 💩").to_string_lossy(),
            Cow::Borrowed("aé 💩")
        );
        let mut string = Wtf8Buf::from("aé 💩");
        string.push(CodePoint::from_u32(0xd800).unwrap());
