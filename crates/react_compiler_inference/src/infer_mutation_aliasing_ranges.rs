...
//! - The externally-visible effects of the function (mutations of
//!   params/context vars, aliasing between params/context-vars/return-value)
...
use react_compiler_hir::{
    ...
    InstructionValue, MutationReason, Place, SourceLocation,
};
                ...
                match effect {
                    ...
                    AliasingEffect::Apply { .. } => {
                        return Err(CompilerDiagnostic::new(
                            ...
                            "[AnalyzeFunctions] Expected Apply effects to be replaced with more \
                             precise effects",
                            None,
                        ));
                    }
