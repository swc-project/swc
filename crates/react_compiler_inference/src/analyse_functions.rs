...
use react_compiler_hir::{
    environment::Environment, AliasingEffect, BlockId, Effect, EvaluationOrder, FunctionId,
    HirFunction, IdentifierId, InstructionValue, MutableRange, Place, ReactFunctionType, HIR,
};
        ...
        match effect {
            ...
            AliasingEffect::Apply { .. } => {
                return Err(CompilerDiagnostic::new(
                    ...
                    "[AnalyzeFunctions] Expected Apply effects to be replaced with more precise \
                     effects",
                    None,
                ));
            }
