...
use react_compiler_hir::{
    ...
    BasicBlock, BlockId, EvaluationOrder, GotoVariant, HirFunction, IdentifierId, ScopeId,
    Terminal,
};
...
/// Collect all unique scopes from places in the function that have non-empty
/// ranges. Corresponds to TS `getScopes(fn)`.
