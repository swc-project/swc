...
use react_compiler_hir::{
    environment::Environment, EvaluationOrder, HirFunction, IdentifierId, InstructionValue, ScopeId,
};
...
pub fn align_method_call_scopes(func: &mut HirFunction, env: &mut Environment) {
    // Maps an identifier to the scope it should be assigned to (or None to remove
    // scope)
