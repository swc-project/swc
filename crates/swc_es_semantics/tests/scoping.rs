...
use common::{analyze_fixture, assert_snapshot};
...
#[testing::fixture("tests/fixtures/scoping/**/input.js")]
fn scoping_fixture(input: PathBuf) {
    ...
    let references = semantics
        ...
        .map(|(index, reference)| ReferenceSnapshot {
            ...
            expr: reference.expr.map(|id| id.as_raw()),
