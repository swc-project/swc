    ...
    _create_class(A, [
        {
            ...
            value: function foo() {
                ...
                let a = (_this = this, _this1 = _class_private_field_get(_this, _a), _class_private_field_set(_this, _a, _this1 + (typeof _this1 === "bigint" ? 1n : 1)), _this1);
                a = (_this2 = this, _this3 = (_this4 = _class_private_field_get(_this2, _a)) + (typeof _this4 === "bigint" ? 1n : 1), _class_private_field_set(_this2, _a, _this3), _this3);
...
function set_d(v) {
    _class_private_field_set(this, _b, v);
}
_d.set(A, {
    get: get_d,
    set: set_d
