...
// use crate::{control_flow_graph::ControlFlowGraph, data_flow::FlowAnalyzer,
// node::Node};
...
//     pub fn new(cfg: &'a ControlFlowGraph<Node>, all_vars_declared_in_fn:
// Vec<Var>) -> Self {         Self {
//             cfg,
...
//     /// There is only a version of this function with index since var.index
// will     /// return the wrong one. Use an instantiation of
...
//     pub fn iter_next_set_bit<'a>(&'a self, from_index: usize) ->
// NextSetBitIter<'a> {         NextSetBitIter {
//             lattice: self,
//             cur: Some(from_index),
//         }
//     }
