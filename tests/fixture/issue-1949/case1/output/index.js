...
var _interopRequireDefault1 = require("@babel/runtime/helpers/interopRequireDefault");
var _createForOfIteratorHelper2 = _interopRequireDefault1(require("@babel/runtime/helpers/createForOfIteratorHelper"));
var _defineProperty2 = _interopRequireDefault1(require("@babel/runtime/helpers/defineProperty"));
...
var _require = require('./RelayStoreUtils'), ROOT_ID = _require.ROOT_ID, ROOT_TYPE = _require.ROOT_TYPE;
 ...
 */ var RelayModernStore = /*#__PURE__*/ function() {
    var RelayModernStore1 = function RelayModernStore1(source, options) {
        var _this = this;
    ...
    var _proto = RelayModernStore1.prototype;
    ...
    _proto.publish = function publish(source, idsMarkedForInvalidation) {
        ...
        updateTargetFromSource(target, source, // in notify(). Here, we pass what will be the incremented value of
    ...
    _proto._collect = _regeneratorRuntime.default.mark(function _collect() {
        var startEpoch, references, _iterator2, _step2, operation, selector, log, storeIDs, ii, dataID;
        return _regeneratorRuntime.default.wrap(function _collect$(_ctx) {
