...
(function(TypeScript) {
    ...
    var getAstPathToPosition = function getAstPathToPosition(script, pos, param) {
        var options = param === void 0 ? GetAstPathOptions.Default : param;
        ...
        var pre = function pre(cur, parent, walker) {
            if (isValidAstNode(cur)) {
                ...
                var inclusive = hasFlag(options, GetAstPathOptions.EdgeInclusive) || cur.nodeType === TypeScript1.NodeType.Name || pos === script.limChar; // Special "EOF" case
