...
var x, StringTreeCollectionBase1 = function() {
    ...
    function StringTreeCollection() {
        var self, call, obj;
        return _classCallCheck(this, StringTreeCollection), self = this, call = _getPrototypeOf(StringTreeCollection).apply(this, arguments), call && ("object" == ((obj = call) && "undefined" != typeof Symbol && obj.constructor === Symbol ? "symbol" : typeof obj) || "function" == typeof call) ? call : (function(self) {
