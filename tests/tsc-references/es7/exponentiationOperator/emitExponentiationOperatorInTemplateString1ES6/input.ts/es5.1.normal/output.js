...
"".concat(_typeof(Math.pow(t1, Math.pow(t2, t1))));
"".concat(1 + _typeof(Math.pow(t1, Math.pow(t2, t1))));
...
"".concat(_typeof(Math.pow(t1, Math.pow(t2, t1)))).concat(_typeof(Math.pow(t1, Math.pow(t2, t1))));
