...
function _asyncfn() {
    _asyncfn = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, _iteratorAbruptCompletion1, _didIteratorError3, _iteratorError3, _iterator4, _step3, _value1, _iteratorAbruptCompletion2, _didIteratorError4, _iteratorError4, _iterator5, _step4, _value2, _iteratorAbruptCompletion3, _didIteratorError5, _iteratorError5, _iterator6, _step5, _value3;
        return regeneratorRuntime.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 26:
                    _iteratorAbruptCompletion1 = false, _didIteratorError3 = false;
                    _ctx.prev = 27;
                    _iterator4 = _asyncIterator(g2);
                case 29:
                    _ctx.next = 31;
                    return _iterator4.next();
                case 31:
                    if (!(_iteratorAbruptCompletion1 = !(_step3 = _ctx.sent).done)) {
                        _ctx.next = 36;
                        break;
                    }
                    {
                        _value1 = _step3.value;
                        _ = _value1;
                        ; // ok
                    }
                case 33:
                ...
                case 38:
                    ...
                    _iteratorError3 = _ctx.t1;
                case 42:
                    _ctx.prev = 42;
                    _ctx.prev = 43;
                    if (!(_iteratorAbruptCompletion1 && _iterator4.return != null)) {
                        _ctx.next = 47;
                        break;
                    }
                    _ctx.next = 47;
                ...
                case 52:
                    _iteratorAbruptCompletion2 = false, _didIteratorError4 = false;
                    _ctx.prev = 53;
                    _iterator5 = _asyncIterator(g4);
                case 55:
                    _ctx.next = 57;
                    return _iterator5.next();
                case 57:
                    if (!(_iteratorAbruptCompletion2 = !(_step4 = _ctx.sent).done)) {
                        _ctx.next = 62;
                        break;
                    }
                    {
                ...
                case 64:
                    ...
                    _iteratorError4 = _ctx.t2;
                case 68:
                    _ctx.prev = 68;
                    _ctx.prev = 69;
                    if (!(_iteratorAbruptCompletion2 && _iterator5.return != null)) {
                        _ctx.next = 73;
                        break;
                    }
                    _ctx.next = 73;
                ...
                case 78:
                    _iteratorAbruptCompletion3 = false, _didIteratorError5 = false;
                    _ctx.prev = 79;
                    _iterator6 = _asyncIterator(g5);
                case 81:
                    _ctx.next = 83;
                    return _iterator6.next();
                case 83:
                    if (!(_iteratorAbruptCompletion3 = !(_step5 = _ctx.sent).done)) {
                        _ctx.next = 88;
                        break;
                    }
                    {
                        _value3 = _step5.value;
                        _ = _value3;
                        ; // ok
                    }
                case 85:
                ...
                case 90:
                    ...
                    _iteratorError5 = _ctx.t3;
                case 94:
                    _ctx.prev = 94;
                    _ctx.prev = 95;
                    if (!(_iteratorAbruptCompletion3 && _iterator6.return != null)) {
                        _ctx.next = 99;
                        break;
                    }
                    _ctx.next = 99;
