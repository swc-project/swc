// Usage: npx tsc scripts/copy-ts-error-tests.ts && node scripts/copy-ts-error-tests.js  ~/projects/TypeScript
...
const targetDir = path.resolve(__dirname, '..', 'tests', 'typescript-errors', 'tsc')
