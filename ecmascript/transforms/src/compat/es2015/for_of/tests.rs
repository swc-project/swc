...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_ignore_cases, r#"for (var i of foo) {
  switch (i) {
    case 1:
      break;
  }
...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_let, r#"for (let i of arr) {
...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_member_expr, r#"for (obj.prop of arr) {
...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_multiple, r#"for (var i of arr) {
...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_nested_label_for_of, r#"b: for (let c of d()) {
  for (let e of f()) {
    continue b;
  }
}"#, r#"var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
...
test!(::swc_ecma_parser::Syntax::Es2019,ForOf, spec_var, r#"for (var i of arr) {
