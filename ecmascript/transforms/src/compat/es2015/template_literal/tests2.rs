/Users/kdy1/projects/swc/ecmascript/transforms/src/compat/es2015/template_literal/fixtures

// default_order_exec
test_exec!(syntax(), |_| tr(Default::default()), default_order_exec, r#"
const calls = [];
...
// default_only
test!(syntax(),|_| tr(Default::default()), default_only, r#"
var foo = `${test}`;
...
// default_single
test!(syntax(),|_| tr(Default::default()), default_single, r#"
var foo = `test ${foo}`;
...
// default_statement
test!(syntax(),|_| tr(Default::default()), default_statement, r#"
...
test!(syntax(),|_| tr(Default::default()), default_expression_first, r#"
var foo = 5;
var bar = 10;
var baz = 15;
...
// default_literals
test!(syntax(),|_| tr(Default::default()), default_literals, r#"
...
// default_multiline
test!(syntax(),|_| tr(Default::default()), default_multiline, r#"
var o = `wow
this is
actually multiline!`;
...
test!(syntax(),|_| tr(Default::default()), default_template_revision, r#"
...
// default_order2_exec
test_exec!(syntax(), |_| tr(Default::default()), default_order2_exec, r#"
const calls = [];
...
test_exec!(syntax(), |_| tr(Default::default()), default_cache_revision_exec, r#"
var tag = v => v;
...
// default_functions
test!(syntax(),|_| tr(Default::default()), default_functions, r#"
...
// default_none
test!(syntax(),|_| tr(Default::default()), default_none, r#"
var foo = `test`;
...
// default_symbol_exec
test_exec!(syntax(), |_| tr(Default::default()), default_symbol_exec, r#"
const fn = () => `${Symbol()}`;
...
test!(syntax(),|_| tr(Default::default()), default_cache_revision, r#"
var tag = v => v;
...
// default_tag
test!(syntax(),|_| tr(Default::default()), default_tag, r#"
var foo = bar`wow\na${ 42 }b ${_.foobar()}`;
var bar = bar`wow\nab${ 42 } ${_.foobar()}`;
var bar = bar`wow\naB${ 42 } ${_.baz()}`;
...
// default_simple_tag
test!(syntax(),|_| tr(Default::default()), default_simple_tag, r#"
var foo = tag`wow`;
