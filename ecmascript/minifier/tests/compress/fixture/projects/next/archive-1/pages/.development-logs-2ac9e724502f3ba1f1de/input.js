    ...
    [
        ...
        /***/ 3824: /***/ function (
                ...
                function prefetch(
                    ...
                    if (!(0, _router).isLocalURL(
                        href
                    )) return; // Prefetch the JSON page if asked (only in the client)
                ...
                function Link(
                    ...
                    var setRef = _react["default"].useCallback(
                        function (
                            ...
                            if (childRef) {
                                if (typeof childRef === "function") childRef(
                                    el
                                );
                    ...
                    _react["default"].useEffect(
                        function (
                            ...
                            var shouldPrefetch =
                            isVisible && p && (0, _router).isLocalURL(
                                href
                            );
                            var curLocale =
