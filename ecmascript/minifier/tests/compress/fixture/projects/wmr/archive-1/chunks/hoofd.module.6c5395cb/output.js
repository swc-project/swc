...
var isServerSide = "undefined" == typeof document,
    META = "M",
    TITLE = "T",
    LINK = "L",
    TEMPLATE = "P",
    SCRIPT = "S",
    applyTitleTemplate = function (
        title, template
    ) {
        return template
            ? template.replace(
    ...
    changeOrCreateMetaTag = function (
        meta
    ) {
        ...
        return {
            ...
            _removeFromQueue: function (
                ...
                if (type === TITLE || type === TEMPLATE) {
                    var queue =
                            type === TEMPLATE ? titleTemplateQueue : titleQueue,
                        index = queue.indexOf(
                            payload
                        );
                    queue.splice(
