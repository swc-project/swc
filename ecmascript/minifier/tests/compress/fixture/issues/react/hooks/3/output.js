...
export function EnvironmentsSelector(param) {
    param.selectedGitBranch, param.checkedProduction, param.checkedPreview, param.checkedDevelopment, param.setCheckedProduction, param.setCheckedPreview, param.setCheckedDevelopment, param.setSelectedGitBranch;
