        ...
        __webpack_require__
            ...
            function newInterval(floori, offseti, count, field) {
                function interval(date) {
                    return (
                        floori(
                            (date = arguments.length === 0 ? new Date() : new Date(+date))
                        ),
                        date
                    )
                }
        ...
        /* harmony default export */ var src_utcYear = utcYear
            ...
            function ticker(year, month, week, day, hour, minute) {
                ...
                function tickInterval(start, stop, count) {
                    ...
                    const i = (0, bisector /* default */.Z)(([, , step]) => step).right(
                        tickIntervals,
                        target
                    )
                    ...
                    if (i === 0)
                        return src_millisecond.every(
                            Math.max((0, src_ticks /* tickStep */.ly)(start, stop, count), 1)
                        )
                    const [t, step] =
                        tickIntervals[
            ...
            function formatWeekNumberISO(d, p) {
                d = dISO(d)
                return pad(
                    thursday.count(src_year(d), d) + (src_year(d).getDay() === 4),
                    p,
                    2
                )
            }
