    ...
    function (jQuery, window, document, undefined) {
        ...
        (function ($, window1, undefined) {
            ...
            (jQuery.jqmRemoveData = function (elem, prop) {
                return jQuery.removeData(elem,
                    jQuery.mobile.nsNormalize(prop));
            }),
            ...
            jQuery.extend(jQuery.expr[":"],
                {
                    ...
                    focusable: function (element) {
                        return focusable(element,
                            !isNaN(jQuery.attr(element,
                                "tabindex")));
                    },
                    tabbable: function (element) {
                        var tabIndex = jQuery.attr(element,
                                "tabindex"),
          ...
          (jQuery.fn.removeData = (function (removeData) {
              return function (key) {
                  return arguments.length
                      ? jQuery.fn.removeData.call(this,
          ...
          "onselectstart" in document.createElement("div")),
            jQuery.fn.extend({
                ...
                zIndex: function (zIndex) {
                    if (void 0 !== zIndex) return this.css("zIndex",
                        zIndex);
                    if (this.length)
                        for (
        ...
        (function ($, window1, undefined) {
            ...
            jQuery.mobile.activeClickedLink.removeClass(
                ...
                (ltr = m[2]))
                    ...
                    enhanceable: function (elements) {
                        return this.haveParents(elements,
                            "enhance");
                    },
                ...
                (toolbarsAffectingHeight = toolbarsAffectingHeight.concat(
                    externalFooters.toArray(),
                                ...
                                jQuery.each(toolbarsAffectingHeight,
              ...
              jQuery(jQuery.mobile.loader.prototype.defaultHtml).loader(),
                            returnValue = loader.loader.apply(loader,
                                arguments);
            ...
            (jQuery.addDependents = function (elem, newDependents) {
                ...
                $elem.jqmData("dependents",
                    jQuery(dependents).add(newDependents));
            }),
            jQuery.fn.extend({
                ...
                this.find(":jqmData(role='fieldcontain')")
                    ...
                    .jqmEnhanceable()
                    .fieldcontain(),
                    jQuery.each(jQuery.mobile.widgets,
                ...
                return (
                    ...
                    (constructor = jQuery[namespace][name] = function (
                        ...
                        if (!this._createWidget) return new constructor(options,
                            element);
                        arguments.length && this._createWidget(options,
                            element);
                    }),
                    jQuery.extend(constructor,
                        existingConstructor,
                        {
        ...
        (function ($) {
          ...
          "<div class='ui-loader'><span class='ui-icon-loading'></span><h1></h1></div>",
            ...
            this.window
                ...
                .bind("scroll",
                    jQuery.proxy(this.fakeFixLoader,
                        this)));
                    },
                    resetHtml: function () {
              ...
              msgText || (loadSettings.text === !1 ? "" : loadSettings.text)),
                ...
                (loadSettings.textonly || textonly
                    ...
                    : ""),
                        ...
                        this.window.bind(
                            "scroll",
                            jQuery.proxy(this.checkLoaderPosition,
                                this),
                        );
                    },
                    hide: function () {
                        ...
                        jQuery.mobile.window.unbind("scroll",
                            this.fakeFixLoader),
                        jQuery.mobile.window.unbind("scroll",
                            this.checkLoaderPosition);
                    },
      ...
      (function (doc, undefined) {
              ...
              this.isHashChangeEnabled()
                ...
                popstate: function (event) {
                    ...
                    if (
                        ...
                        return;
                    event.historyState && jQuery.extend(state,
                        event.historyState),
                ...
                setup: function () {
                    ...
                    self.isPushStateEnabled()
                        ...
                        $win.bind("popstate.navigate",
                            self.popstate))
                        : self.isHashChangeEnabled() &&
                  ((self.originalEventName = "hashchange"),
                  $win.bind("hashchange.navigate",
                      self.hashchange));
                },
            });
        })(jQuery),
        (function ($, undefined) {
            ...
            (u.hash || "")
                        ...
                        : path.isSameDomain(u,
                            ...
                            ? u.hrefNoHash
                                .replace(this.documentBase.domain,
                                    "")
                                .split("&ui-state=dialog")[0]
                            : window.decodeURIComponent(absUrl);
                },
              ...
              (cleanedUrl = cleanedUrl.slice(0,
                  stateIndex))),
                        (href = path.makeUrlAbsolute(cleanedUrl,
                            resolutionUrl)),
              ...
              hash.replace(/([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g,
                ...
                isFirstPageUrl: function (url) {
                    var u = path.parseUrl(path.makeUrlAbsolute(url,
                            this.documentBase)),
                        samePath =
              u.hrefNoHash === this.documentUrl.hrefNoHash ||
              (this.documentBaseDiffers &&
            ...
            (path.documentBase = $base.length
                ? path.parseUrl(
                    path.makeUrlAbsolute($base.attr("href"),
                        path.documentUrl.href),
                )
                : path.documentUrl),
        ...
        jQuery.extend(jQuery.mobile.History.prototype,
          ...
          ((this.activeIndex = newActiveIndex), (this.previousIndex = a)),
                    a > newActiveIndex
                        ? (opts.present || opts.back || jQuery.noop)(
                            this.getActive(),
                            "back",
                        )
                        : newActiveIndex > a
        ...
        (function ($, undefined) {
            ...
            (jQuery.mobile.Navigator = function (history) {
                ...
                jQuery.mobile.window.bind({
                    "popstate.history": jQuery.proxy(this.popstate,
                        this),
                    "hashchange.history": jQuery.proxy(this.hashchange,
                        this),
                });
            }),
        ...
        (function ($, undefined) {
            (jQuery.mobile.navigate = function (url, data, noEvents) {
                jQuery.mobile.navigate.navigator.go(url,
                    data,
                    noEvents);
            }),
            ...
            (jQuery.support.cssAnimations && "animation" === animationType)
                ...
                (0 === duration || void 0 === duration || isNaN(duration)) &&
                  (duration = jQuery.fn.animationComplete.defaultDuration)),
                    ...
                    duration)),
                    jQuery(this).one(props[animationType].event,
                        function () {
                            clearTimeout(timer), callback.call(this,
                                arguments);
                        }))
                    : (setTimeout(jQuery.proxy(callback,
                        this),
                    0), jQuery(this));
            }),
        ...
        (function ($, window1, document1, undefined) {
            ...
            (!flags &&
              getClosestElementWithVirtualBinding(event.target,
                  eventType))) &&
            ((ve = createVirtualEvent(event,
                eventType)),
            ...
            function mouseEventCallback(event) {
                var touchID = jQuery.data(event.target,
                        "virtualTouchID"),
                    ve;
                !blockMouseTriggers &&
          (!lastTouchID || lastTouchID !== touchID) &&
          ((ve = triggerVirtualEvent("v" + event.type,
              event)),
          ve &&
          ...
          flags.hasVirtualBinding &&
            ...
            triggerVirtualEvent("vmouseover",
                event,
                flags),
            triggerVirtualEvent("vmousedown",
                event,
                flags)));
            }
          ...
          Math.abs(t.pageY - startY) > moveThreshold),
                didScroll &&
            !didCancel &&
            triggerVirtualEvent("vmousecancel",
                event,
                flags),
                triggerVirtualEvent("vmousemove",
                    event,
                    flags),
                startResetTimer();
            }
            ...
            function getSpecialEventObject(eventType) {
              ...
              jQuery.data(this,
                ...
                $document.bind(realType,
                    mouseEventCallback),
                        jQuery(this).bind(realType,
                            dummyMouseHandler),
            ...
            function triggerCustomEvent(obj, eventType, event, bubble) {
                ...
                bubble
                    ? jQuery.event.trigger(event,
                        void 0,
                        obj)
                    : jQuery.event.dispatch.call(obj,
                        event),
              ...
              Math.abs(start.coords[1] - stop.coords[1]) <
                ...
                0 === events.length &&
                  jQuery.removeData(this,
                    ...
                    events.swipe &&
                (events.swipe.start &&
                  jQuery(this).off(touchStartEvent,
                      events.swipe.start),
                events.swipe.move &&
                  $document.off(touchMoveEvent,
                      events.swipe.move),
                events.swipe.stop &&
                  $document.off(touchStopEvent,
                      events.swipe.stop));
                },
            }),
            jQuery.each(
        ...
        (function ($) {
            jQuery.event.special.throttledresize = {
                setup: function () {
                    jQuery(this).bind("resize",
                        handler);
                },
                teardown: function () {
                    jQuery(this).unbind("resize",
                        handler);
                },
            };
        ...
        ((initial_orientation_is_landscape && initial_orientation_is_default) ||
          ...
          ((last_orientation = orientation), win.trigger("orientationchange"));
            ...
            (jQuery.event.special.orientationchange.orientation = get_orientation = function () {
                ...
                return (
                    (isPortrait = jQuery.support.orientation
        ...
        (function ($, undefined) {
            ...
            (jQuery.widget = (function (orig) {
                return function () {
                    var constructor = jQuery.widget.apply(this,
                            arguments),
            ...
            jQuery.extend(jQuery.widget,
                originalWidget),
            jQuery.mobile.document.on("create",
                function (event) {
            ...
            jQuery.widget("mobile.page",
                {
                    ...
                    _createWidget: function () {
                        jQuery.Widget.prototype._createWidget.apply(this,
                            arguments),
                        this._trigger("init");
                    },
                    _create: function () {
        ...
        (function ($, undefined) {
            ...
            e.originalEvent.type.indexOf("hashchange") > -1
                    ...
                    go: function (steps) {
                        if (jQuery.mobile.hashListeningEnabled) window.history.go(steps);
                            ...
                            var activeIndex = jQuery.mobile.navigate.history.activeIndex,
                                index = activeIndex + parseInt(steps,
                                    10),
              ...
              to ===
                ...
                (to = this._getInitialContent())),
                    ...
                    _handleDialog: function (changePageOptions, data) {
                        ...
                        return activeContent && !activeContent.hasClass("ui-dialog")
                            ? ("back" === data.direction ? this.back() : this.forward(), !1)
              ...
              history.initialDst !== to)
                            ...
                            if (((to = this._handleDialog(changePageOptions,
                                data)), !1 === to))
                                return;
                        }
                        this._changeContent(this._handleDestination(to),
                            changePageOptions);
                    },
                    _changeContent: function (to, opts) {
                        jQuery.mobile.changePage(to,
                            opts);
                    },
                    _getBase: function () {
              ...
              (page = jQuery(
                  ...
                  "</div>",
                            ...
                            page
                                ...
                                .attr("data-" + this._getNs() + "external-page",
                                    !0),
                            page
                        );
                    },
            ...
            page.jqmData("title",
                newPageTitle));
                    ...
                    _triggerWithDeprecated: function (name, data, page) {
                        ...
                        return (
                            (page || this.element).trigger(deprecatedEvent,
                                data),
                            this.element.trigger(newEvent,
                                data),
                            {
                ...
                (fileUrl = jQuery.mobile.path.getFilePath(
                    jQuery("<div>" + RegExp.$1 + "</div>").text(),
                                ...
                                (content = this._parse(html,
                                    fileUrl)),
                                this._setLoadedTitle(content,
                                    html),
                                (triggerData.xhr = xhr),
              ...
              !jQuery.mobile.path.isFirstPageUrl(fileUrl))
                        ...
                        if (
                            ...
                            (pblEvent = this._triggerWithDeprecated("beforeload",
                                triggerData)),
              ...
              jQuery.mobile.path.isSameDomain(
                  ...
                  absUrl,
                        ...
                        jQuery.ajax({
                            ...
                            dataType: "html",
                            success: this._loadSuccess(absUrl,
                                triggerData,
                                settings,
                                deferred),
                            error: this._loadError(absUrl,
                                triggerData,
                                settings,
                                deferred),
                        });
            ...
            this._triggerWithDeprecated(
                ...
                from,
                    ...
                    _cssTransition: function (to, from, options) {
                        var transition = options.transition,
                            ...
                            TransitionHandler,
                            promise;
                        this._triggerCssTransitionEvents(to,
                            from,
                            "before"),
                        this._hideLoading(),
              ...
              jQuery.mobile.changePage.apply(null,
                    ...
                    _loadUrl: function (to, triggerData, settings) {
                        ...
                        settings.deferred.fail(
                            jQuery.proxy(function () {
                                ...
                                this._triggerWithDeprecated("changefailed",
                                    triggerData);
                            },
                            this),
                        );
                        ...
                        !this._triggerPageBeforeChange(
                            ...
                            "string" === jQuery.type(triggerData.toPage)
                                ...
                                this._loadUrl(triggerData.toPage,
                                    triggerData,
                                    settings))
                                : this.transition(triggerData.toPage,
                                    triggerData,
                                    settings));
                    },
            ...
            "body" !== document.activeElement.nodeName.toLowerCase()
              ...
              (pageTitle = newPageTitle),
                        toPage.jqmData("title") || toPage.jqmData("title",
                            pageTitle),
                        (settings.transition =
              settings.transition ||
              ...
              settings.changeHash !== !1 && jQuery.mobile.hashListeningEnabled
                  ? jQuery.mobile.navigate(url,
                      ...
                      !0)
                  : toPage[0] !== jQuery.mobile.firstPage[0] &&
                  jQuery.mobile.navigate.history.add(url,
                      params)),
        ...
        (function ($, undefined) {
          ...
          nav.app.backHistory
                    ? nav.app.backHistory()
                    : jQuery.mobile.pageContainer.pagecontainer("back");
            }),
          ...
          function (transition) {
            ...
            (jQuery.mobile._registerInternalEvents = function () {
              ...
              $form.attr("target")
                ...
                jQuery.mobile.document.delegate("form",
                    "submit",
                    function (event) {
                        var formData;
                        event.isDefaultPrevented() ||
              ...
              formData &&
                (jQuery.mobile.changePage(formData.url,
                    formData.options),
                event.preventDefault()));
                    }),
                jQuery.mobile.document.bind("vclick",
                    function (event) {
                        var $btn,
                            btnEls,
                            target = event.target,
                        ...
                        if (
                            ...
                            if (!getAjaxFormData(jQuery(target).closest("form"),
                                !0))
                                return;
                    ...
                    !(
                        ...
                        !!~target.className.indexOf("ui-link-inherit")
                            ? target.parentNode &&
                  (btnEls = jQuery.data(target.parentNode,
                      "buttonElements"))
                            : (btnEls = jQuery.data(target,
                                "buttonElements")),
                ...
                jQuery.mobile.document.bind("click",
                    function (event) {
                        if (
                  ...
                  !jQuery.mobile.path.isEmbeddedPage(href))
                        ...
                        if (-1 !== href.search("#")) {
                            if (((href = href.replace(/[^#]*#/,
                                ...
                                jQuery.mobile.path.isPath(href)
                                    ? (href = jQuery.mobile.path.makeUrlAbsolute(href,
                                        baseUrl))
                                    : (href = jQuery.mobile.path.makeUrlAbsolute(
                                        "#" + href,
                ...
                jQuery.mobile.document.bind("pageshow",
                    function () {
                        loadDeferred
            ...
            jQuery
                .when(domreadyDeferred,
                    jQuery.mobile.navreadyDeferred)
                .done(function () {
            ...
            jQuery.extend(jQuery.mobile.Transition.prototype,
                ...
                window1.scrollTo(0,
                    ...
                    startOut: function (screenHeight, reverseClass, none) {
                        this.beforeStartOut(screenHeight,
                            reverseClass,
                            none),
                        this.$from
                ...
                Math.max(jQuery.mobile.window.scrollTop(),
                  ...
                  jQuery.mobile.getMaxScrollForTransition()),
                            this.toggleViewportClass(),
                            this.$from && !none
                                ? this.startOut(screenHeight,
                                    reverseClass,
                                    none)
                                : this.doneOut(screenHeight,
                                    reverseClass,
                                    none,
                                    !0),
      ...
      jQuery.mobile.degradeInputs),
        (jQuery.mobile.degradeInputsWithin = function (target) {
            ...
            target
              ...
              (repstr =
                ...
                '"' +
                (hasType ? "" : ">")),
              element.replaceWith(html.replace(findstr,
                  repstr)));
                });
        }),
        jQuery.widget("mobile.page",
          ...
          this._inner.toggleClass("ui-corner-all",
              !!options.corners),
            ...
            (closeButtonLocation = options.closeBtn),
                    closeButtonLocation &&
            this._setCloseBtn(closeButtonLocation,
          ...
          "left" === location
              ...
              : "right" === location
                  ...
                  location,
                                ...
                                .attr("data-" + jQuery.mobile.ns + "rel",
                                    "back")
        ...
        (function ($, undefined) {
            ...
            jQuery.widget("mobile.collapsible",
              ...
              ui.originalHeading.remove()),
                  ...
                  this._themeClassFromOption("ui-btn-",
                      opts.theme) +
                  " " +
                  (opts.mini ? "ui-mini " : ""),
                                )),
            ...
            this._handleExpandCollapse(options.collapsed),
              ...
              (newTheme = this._themeClassFromOption("ui-btn-",
                  opts.theme)),
              ...
              ui.content.removeClass(oldTheme).addClass(newTheme)),
                        opts.inset !== void 0 &&
              (elem.toggleClass("ui-collapsible-inset",
                  opts.inset),
              (hasCorners = !(
              ...
              (hasCorners = !(
                  !opts.corners || !(opts.inset || currentOpts.inset)
                        ...
                        void 0 !== hasCorners &&
              elem.toggleClass("ui-corner-all",
                  hasCorners),
                        opts.mini !== void 0 && anchor.toggleClass("ui-mini",
                            opts.mini);
                    },
                    _setOptions: function (options) {
                    ...
                    _handleExpandCollapse: function (isCollapse) {
                        ...
                        ui.heading
                            .toggleClass("ui-collapsible-heading-collapsed",
                                isCollapse)
                            .find("a")
                            .first()
                            .toggleClass("ui-icon-" + opts.expandedIcon,
                                !isCollapse)
                            .toggleClass(
                                "ui-icon-" + opts.collapsedIcon,
                        ...
                        this.element.toggleClass("ui-collapsible-collapsed",
                            isCollapse),
                        ui.content
                            .toggleClass("ui-collapsible-content-collapsed",
                                isCollapse)
                            .attr("aria-hidden",
                                isCollapse)
                      ...
                      this._themeClassFromOption(
                        ...
                        _refresh: function (create) {
                            ...
                            this._addFirstLastClasses(
                                collapsiblesInSet,
                                this._getVisibles(collapsiblesInSet,
                                    create),
                                create,
                            );
                        },
        ...
        jQuery.widget("mobile.navbar",
            {
                ...
                _create: function () {
                    ...
                    $navbtns.each(function () {
                        var icon = jQuery.mobile.getAttribute(this,
                                "icon"),
                            theme = jQuery.mobile.getAttribute(this,
                                "theme"),
                            classes = "ui-btn";
                    ...
                    jQuery(
                        ...
                        refresh: function (create) {
                            var buttonClass,
                                ...
                                countTheme =
                  getAttr($list[0],
                      "counttheme") || this.options.countTheme,
                            ...
                            for (
                                ...
                                ol &&
                    (start || 0 === start) &&
                    ((startCount = parseInt(start,
                        10) - 1),
                    $list.css("counter-reset",
                        "listnumbering " + startCount)),
                                this._beforeListviewRefresh(),
                                li = this._getChildrenByTagName($list[0],
                                    "li",
                                    "LI"),
                                pos = 0,
                                li.length;
                    ...
                    !isDivider
                        ...
                        a.length > 1
                            ...
                            last
                                .attr("title",
                                    jQuery.trim(last.getEncodedText()))
        ...
        (function ($, undefined) {
            ...
            (this._replaceDividers(), this._superApply(arguments));
                ...
                li.parentNode.insertBefore(divider,
                    li)),
                ...
                jQuery.mobile.listview,
                {
                    ...
                    _afterListviewRefresh: function () {
                        ...
                        if ((this._superApply(arguments), this.options.hideDividers))
                            for (
                                items = this._getChildrenByTagName(this.element[0],
                                    "li",
                                    "LI"),
                                idx = items.length - 1;
                                idx > -1;
                                ...
                                (item = items[idx]),
                                item.className.match(rdivider)
                                    ? (hideDivider &&
                      (item.className = item.className + " ui-screen-hidden"),
                                    (hideDivider = !0))
                                    : !item.className.match(rhidden) && (hideDivider = !1);
                    },
                });
        })(jQuery),
        (jQuery.mobile.nojs = function (target) {
            jQuery(":jqmData(role='nojs')",
                target).addClass("ui-nojs");
        }),
              ...
              "input:not( :jqmData(role='flipswitch' ) )[type='checkbox'],input[type='radio']:not( :jqmData(role='flipswitch' ))",
                  ...
                  "' ></div>",
                        ...
                        _handleInputVClick: function () {
                            ...
                            this._getInputSet().not(this.element).prop("checked",
                                !1),
                            this._updateAll();
                        },
                ...
                event.stopPropagation();
                        ...
                        _handleLabelVClick: function (event) {
                            ...
                            return (
                                ...
                                this._getInputSet().not(input).prop("checked",
                                    !1),
                                this._updateAll(),
                                !1
                            );
                ...
                (this.input.prop("disabled",
                    !!options.disabled),
                outer.toggleClass("ui-state-disabled",
                    !!options.disabled)),
                            options.mini !== void 0 &&
                  outer.toggleClass("ui-mini",
                      !!options.mini),
                            options.theme !== void 0 &&
                  label
        ...
        "input[type='button'], input[type='submit'], input[type='reset']",
          ...
          outer
              ...
              .addClass("ui-btn-" + options.theme),
                    options.corners !== void 0 &&
            outer.toggleClass("ui-corner-all",
                options.corners),
                    options.shadow !== void 0 &&
            outer.toggleClass("ui-shadow",
                options.shadow),
                    options.inline !== void 0 &&
            outer.toggleClass("ui-btn-inline",
                options.inline),
                    options.mini !== void 0 && outer.toggleClass("ui-mini",
                        options.mini),
                    options.disabled !== void 0 &&
        ...
        "input[type='text'],input[type='search'],:jqmData(type='search'),input[type='number'],:jqmData(type='number'),input[type='password'],input[type='email'],input[type='url'],input[type='tel'],textarea,input[type='time'],input[type='date'],input[type='month'],input[type='week'],input[type='datetime'],input[type='datetime-local'],input[type='color'],input:not([type]),input[type='file']",
          ...
          (this.element[0].setAttribute("autocorrect",
              "off"),
          this.element[0].setAttribute("autocomplete",
              "off"));
                },
        ...
        jQuery.widget(
            ...
            "input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",
                ...
                jQuery.mobile.getAttribute(control[0],
                    "theme"),
                            cornerClass =
                    ...
                    : !1,
                        ...
                        if (
                            ...
                            for (
                                ...
                                origTabIndex && handle.attr("tabindex",
                                    origTabIndex),
                                control.attr("tabindex",
                                    "-1").focus(function () {
                        ...
                        slider
                            .bind("vmousedown",
                                jQuery.proxy(this._sliderVMouseDown,
                                    this))
                            .bind("vclick",
                                !1),
                        this._on(document,
                ...
                this._setDisabled(options.disabled),
                    ...
                    _controlChange: function (event) {
                        if (this._trigger("controlchange",
                            event) === !1) return !1;
                        this.mouseMoved || this.refresh(this._value(),
                            !0);
                    },
              ...
              !(
                ...
                (percent = (newval - min) * percentPerStep * (1 / step)),
                            ...
                            this.valuebg && this.valuebg.css("width",
                                percent + "%"),
                            this._labels &&
                ((handlePercent =
                ...
                (bPercent =
                  100 === percent
                      ? 0
                      : Math.min(handlePercent + 100 - aPercent,
                          100)),
                this._labels.each(function () {
                    ...
                    _setMini: function (value) {
                        ...
                        this.isToggleSwitch ||
                this.isRangeslider ||
                (this.slider.parent().toggleClass("ui-mini",
                    value),
                this.element.toggleClass("ui-mini",
                    ...
                    _setCorners: function (value) {
                        this.slider.toggleClass("ui-corner-all",
                            value),
                        this.isToggleSwitch ||
                this.control.toggleClass("ui-corner-all",
                    value);
                    },
                ...
                (this._popup = getPopup()
                    ...
                    _refresh: function () {
                        ...
                        o.popupEnabled && this._popup
                            ...
                            : o.showValue && !this.options.mini && this.handle.html(newValue);
                    },
                    _showPopup: function () {
                        this.options.popupEnabled &&
            !this._popupVisible &&
            ...
            jQuery.extend(
              ...
              "SELECT" === this.type
                  ...
                  : this.element.prop("checked")
                    ...
                    _keydown: function (e) {
                        e.which === jQuery.mobile.keyCode.LEFT
                            ? this._left()
                            : e.which === jQuery.mobile.keyCode.RIGHT
                                ? this._right()
                ...
                this.widget().toggleClass(
                    ...
                    options.disabled,
                        ...
                        options.mini !== void 0 &&
                this.widget().toggleClass("ui-mini",
                    options.mini),
                        options.corners !== void 0 &&
                this.widget().toggleClass("ui-corner-all",
                    options.corners),
                        this._super(options);
                    },
                    _destroy: function () {
            ...
            jQuery.extend(
                {
                    ...
                    _create: function () {
                        var $el = this.element,
                            ...
                            _sliderWidgetFirst =
                jQuery.data(_inputFirst.get(0),
                    "mobile-slider") ||
                jQuery.data(_inputFirst.slider().get(0),
                    "mobile-slider"),
                            _sliderWidgetLast =
                jQuery.data(_inputLast.get(0),
                    "mobile-slider") ||
                jQuery.data(_inputLast.slider().get(0),
                    "mobile-slider"),
                ...
                ("last" === this._proxy && !first))
                            ...
                            return (
                                ...
                                jQuery.data(otherSlider.get(0),
                                    "mobile-slider").refresh(event),
                                !1
                            );
                    },
              ...
              (this.options.disabled = !0),
                    ...
                    _change: function (event) {
                        ...
                        var self = this,
                            min = parseFloat(this._inputFirst.val(),
                                10),
                            max = parseFloat(this._inputLast.val(),
                                10),
              ...
              !jQuery(event.target).hasClass("ui-slider-handle")
                  ...
                  setTimeout(function () {
                      ...
                      jQuery
                          .data(otherSlider.get(0),
                              "mobile-slider")
                          .handle.focus(),
                      self._sliderFirst.css("z-index",
                          first ? "" : 1),
        ...
        jQuery.widget("mobile.textinput",
            ...
            (options.clearBtn ? this._addClearBtn() : this._destroyClear()),
        ...
        jQuery.widget("mobile.textinput",
          ...
          this._timeout());
                ...
                _prepareHeightUpdate: function (delay) {
                    ...
                    void 0 === delay
                        ? this._updateHeight()
                        : (this.keyupTimeout = this._delay("_updateHeight",
                            delay));
                },
                _timeout: function () {
            ...
            this.isTextarea &&
            (options.autogrow ? this._autogrow() : this._unbindAutogrow());
                },
            }),
        jQuery.widget(
            "mobile.selectmenu",
                    ...
                    _setDisabled: function (value) {
                        return (
                            this.element.attr("disabled",
                                value),
                            this.button.attr("aria-disabled",
                                value),
              ...
              wrapper.remove());
                ...
                this.disable(),
                    ...
                    build: function () {
                        ...
                        self.button.bind("vmousedown",
                            function () {
                                self.options.preventFocusZoom && jQuery.mobile.zoom.disable(!0);
                            }),
                        self.label.bind("click focus",
                            function () {
                                self.options.preventFocusZoom && jQuery.mobile.zoom.disable(!0);
                            }),
                        self.select.bind("focus",
                            function () {
                                self.options.preventFocusZoom && jQuery.mobile.zoom.disable(!0);
                            }),
                        self.button.bind("mouseup",
                            function () {
        ...
        (jQuery.mobile.links = function (target) {
            ...
            (element.setAttribute("aria-haspopup",
                !0),
            element.setAttribute("aria-owns",
                idref),
        ...
        (function ($, undefined) {
            ...
            jQuery.mobile.hashListeningEnabled),
                        ...
                        currentOptions.enhanced
                            ...
                            : ((this._ui = this._enhance(theElement,
                                myId)),
                        ...
                        this._on(this.window,
                            {
                                ...
                                resize: jQuery.proxy(this,
                                    "_handleWindowResize"),
                                keyup: jQuery.proxy(this,
                                    "_handleWindowKeyUp"),
                            }),
                  ...
                  (currentOptions.corners ? "ui-corner-all " : ""),
                    ...
                    _resizeScreen: function () {
                        ...
                        documentHeight > screenHeight
                            ...
                            : popupHeight > screenHeight && screen.height(popupHeight);
                    },
            ...
            (this._orientationchangeInProgress = !0));
              ...
              theElement.toggleClass("ui-overlay-shadow",
                  newOptions.shadow),
                            newOptions.corners !== void 0 &&
              theElement.toggleClass("ui-corner-all",
                  newOptions.corners),
              ...
              this.close(),
                    ...
                    _clampPopupWidth: function (infoOnly) {
                        ...
                        return (
                            infoOnly || this._ui.container.css("max-width",
                                rectangle.cx),
                            (menuSize = {
                    ...
                    _placementCoords: function (desired) {
                        return this._calculateFinalLocation(desired,
                        ...
                        if (
                            ...
                            if (
                                ...
                                this._ui.container
                                    ...
                                    .removeClass(args.classToRemove)
                                    .animationComplete(
                                        jQuery.proxy(args.prerequisites.container,
                                            "resolve"),
                                    );
                                return;
                            }
              ...
              (y = windowCoordinates.cy / 2 + windowCoordinates.y),
                    ...
                    _openPrerequisitesComplete: function () {
                        ...
                        (this._isOpen = !0),
                        this._resizeScreen(),
                        this._ui.container.attr("tabindex",
                            "0").focus(),
                        this._ignoreResizeEvents(),
                        id &&
              this.document
              ...
              this.element.closest(".ui-page").addClass("ui-popup-open"),
                    ...
                    _closePrerequisitesDone: function () {
                        ...
                        jQuery(":focus",
                            container[0]).add(container[0]).blur(),
                        id &&
              this.document
                  .find("[aria-haspopup='true'][aria-owns='" + id + "']")
                  .attr("aria-expanded",
            ...
            jQuery.mobile.popup.active !== this
              ...
              currentIsDialog
                ...
                url === jQuery.mobile.navigate.history.initialDst &&
                (url += jQuery.mobile.dialogHashKey),
                                    this.window.one("beforenavigate",
                                        function (theEvent) {
                                            theEvent.preventDefault(),
                                            self._open(options),
                                            self._bindContainerClose();
        ...
        (function ($, undefined) {
            var goToAdjacentItem = function (item, target, direction) {
                var adjacent = item[direction + "All"]()
                    ...
                    .first();
                adjacent.length &&
          (target.blur().attr("tabindex",
              "-1"),
          adjacent.find("a").first().focus());
            };
            jQuery.widget("mobile.selectmenu",
            ...
            "focusin" === e.type
                ...
                (this._origTabIndex =
                  null === this.select[0].getAttribute("tabindex")
                            ...
                            this.list.delegate(
                                ...
                                function (event) {
                                    var oldIndex = self.select[0].selectedIndex,
                                        newIndex = jQuery.mobile.getAttribute(this,
                                            "option-index"),
                      ...
                      jQuery(this)
                          .find("a")
                          .toggleClass("ui-checkbox-on",
                              option.selected)
                          .toggleClass("ui-checkbox-off",
                              !option.selected),
                            ...
                            .each(function (i) {
                                if (jQuery.inArray(i,
                                    ...
                                    self.isMultiple
                                        ...
                                        : item.hasClass("ui-screen-hidden")
                                            ? item
                                                .next()
                                                .find("a")
                                                .addClass(jQuery.mobile.activeBtnClass)
                                            : item.find("a").addClass(jQuery.mobile.activeBtnClass);
                                }
                            });
                    },
                    close: function () {
            ...
            (selector = this.list.find(
                "li:not(.ui-disabled,.ui-state-disabled,.ui-li-divider,.ui-screen-hidden,:jqmData(role='placeholder')) a.ui-btn",
                    ...
                    _decideFormat: function () {
                        ...
                        menuHeight > screenHeight - 80 || !jQuery.support.scrollTop
                ...
                self.thisPage.one("pagehide",
                    function () {
                        jQuery(this).jqmData("lastScroll",
                            btnOffset);
                    }),
                            self.menuPage.one({
                                pageshow: jQuery.proxy(this,
                                    "_focusMenuItem"),
                                pagehide: jQuery.proxy(this,
                                    "close"),
                            }),
                            (self.menuType = "page"),
                            ...
                            self.listbox.one({
                                popupafteropen: jQuery.proxy(this,
                                    "_focusMenuItem"),
                            }));
                    },
                    _buildList: function () {
                ...
                optGroup !== optLabel &&
                  ((divider = document.createElement("li")),
                  divider.setAttribute(dataPrefix + "role",
                      "list-divider"),
                  divider.setAttribute("role",
                      "option"),
                  divider.setAttribute("tabindex",
                      "-1"),
                ...
                option.setAttribute(dataPlaceholderAttr,
                    !0),
                ...
                item.setAttribute("aria-disabled",
                    !0)),
                            item.setAttribute(dataPrefix + "option-index",
                                i),
                            item.setAttribute(dataPrefix + "icon",
                                "false"),
                            isPlaceholderItem && item.setAttribute(dataPlaceholderAttr,
                                !0),
        ...
        (function ($, undefined) {
            ...
            (jQuery.fn.buttonMarkup = function (options, overwriteClasses) {
                ...
                (retrievedOptions[optionKey] = (function () {
                    var ret = jQuery.mobile.getAttribute.apply(this,
                        arguments);
                    return null == ret ? void 0 : ret;
                })(
                    el,
                    optionKey.replace(capitalLettersRE,
            ...
            jQuery.extend(
              ...
              this.element
                ...
                elem.toggleClass("ui-corner-all",
                    options.corners),
                            options.mini !== void 0 &&
                elem.toggleClass("ui-mini",
                    options.mini),
                            options.shadow !== void 0 &&
                this._ui.childWrapper.toggleClass("ui-shadow",
                    options.shadow),
            ...
            "footer" === this.role && this.element.appendTo("body")),
                ...
                _btnMarkup: function () {
                    this.element
                        ...
                        .attr("data-" + jQuery.mobile.ns + "role",
                            "button"),
          ...
          this.updatePagePadding(!!this.page ? this.page : ".ui-page-active");
            ...
            this._on(this.window,
                ...
                _handlePageBeforeHide: function (e, ui) {
                    ...
                    o.updatePagePadding && this._off(this.window,
                        "throttledresize"),
                    o.trackPersistentToolbars &&
            ((thisFooter = jQuery(".ui-footer-fixed:jqmData(id)",
                this.page)),
            (thisHeader = jQuery(".ui-header-fixed:jqmData(id)",
                this.page)),
            (nextFooter =
              (thisFooter.length &&
                ui.nextPage &&
          ...
          ((this.options.transition &&
            ...
            this.options.fullscreen)
                ...
                show: function (notransition) {
                    var $el = this.element;
                    this._useTransition(notransition)
                        ? $el
                        ...
                        : $el.removeClass("ui-fixed-hidden"),
                    (this._visible = !0);
                },
            ...
            jQuery.widget("mobile.popup",
                jQuery.mobile.popup,
                {
                    ...
                    _addArrow: function () {
                        var theme,
                            ...
                            ar = getArrow();
                        return (
                            (theme = this._themeClassFromOption("ui-body-",
                                opts.theme)),
                ...
                (s.clampInfo.menuSize[p.oDimKey] - s.contentBox[p.oDimKey]) *
                  p.arrowOffsetFactor),
                            ...
                            (result =
                s.result ||
                this._calculateFinalLocation(desiredForArrow,
                    s.clampInfo)),
                            (r = {
                                x: result.left,
                                y: result.top,
                ...
                (best = {
                    ...
                    _placementCoords: function (desired) {
                        ...
                        return !ar
                            ...
                            !best)
                                ? (ar.arEls.hide(), this._super(desired))
                                : (ar.ct
                                    .removeClass(
        ...
        jQuery.widget("mobile.panel",
          ...
          (self.options.position === "left"
              ? area.on("swipeleft.panel",
                  function () {
                      self.close();
                  })
              : area.on("swiperight.panel",
                  function () {
                      self.close();
                  }));
                },
                ...
                open: function (immediate) {
                  ...
                  self._fixedToolbars().addClass(o.classes.animate)),
                                !immediate && jQuery.support.cssTransform3d && !!o.animate
                                    ? self.element.animationComplete(complete,
                                        "transition")
                                    : setTimeout(complete,
                                        0),
                                o.theme &&
                ...
                _refresh: function () {
                    ...
                    trs.each(function () {
                        ...
                        jQuery(this)
                            .children()
                            .each(function () {
                                var span = parseInt(this.getAttribute("colspan"),
                                        10),
        ...
        jQuery.widget("mobile.table",
            jQuery.mobile.table,
            {
                ...
                _addToggles: function (menu, keep) {
                    ...
                    keep ? (inputs = menu.find("input")) : container.empty(),
                    this.headers.not("td").each(function () {
                        var header = jQuery(this),
                            priority = jQuery.mobile.getAttribute(this,
                                "priority"),
              ...
              (keep
                ...
                _menuInputChange: function (evt) {
                    ...
                    input
                        .jqmData("cells")
                        .toggleClass("ui-table-cell-hidden",
                            !checked)
                        .toggleClass("ui-table-cell-visible",
                            checked),
        ...
        jQuery.widget("mobile.table",
          ...
          this._updateReflow());
                ...
                _updateReflow: function () {
                    ...
                    jQuery(table.allHeaders.get().reverse()).each(function () {
                        var cells = jQuery(this).jqmData("cells"),
                            colstart = jQuery.mobile.getAttribute(this,
                                "colstart"),
                            hierarchyClass =
              ...
              " ui-table-cell-label-top",
                        ...
                        "" !== text &&
            (hierarchyClass
                ? ((iteration = parseInt(this.getAttribute("colspan"),
                    10)),
                (filter = ""),
                iteration &&
                  (filter =
                    ...
                    _onKeyUp: function () {
                        ...
                        if (search) {
                            if (
                                ...
                                (lastval = jQuery.mobile.getAttribute(search[0],
                                    "lastval") + ""),
                                lastval && lastval === val)
                            )
                                return;
                    ...
                    _filterItems: function (val) {
                        ...
                        if (null != val)
                            for (
                                ...
                                (dst = callback.call(filterItems[idx],
                                    idx,
                                    val)
                                    ? hide
                                    : show),
                ...
                widget &&
                  ...
                  widget.refresh());
                    ...
                    _setInput: function (selector) {
                        ...
                        search &&
              (this._off(search,
                  "keyup change input"), (search = null)),
                        selector &&
            ...
            options.children !== void 0;
              ...
              (this._setInput(options.input), (refilter = !0)),
                    ...
                    _destroy: function () {
                        ...
                        opts.enhanced
                            ? items.toggleClass("ui-screen-hidden",
                                opts.filterReveal)
            ...
            jQuery.widget("mobile.filterable",
                jQuery.mobile.filterable,
                {
                    ...
                    _create: function () {
                        ...
                        this._widget || this._on(elem,
                            createHandlers);
                    },
                    _handleCreate: function (evt) {
                        this._setWidget(
                            this.element.data(
                                "mobile-" + evt.type.substring(0,
                                    evt.type.length - 6),
                            ),
                        );
                    },
              ...
              "beforefilter" === type &&
              this._widget._trigger("beforefilter",
                  event,
                  data),
                        this._super(type,
                            event,
              ...
              this._search.jqmData("ui-filterable-" + this.uuid + "-internal")
                    ...
                    "'></input>",
                            ).jqmData("ui-filterable-" + this.uuid + "-internal",
                                !0)),
                ...
                this._isSearchInternal() &&
                this._search.attr("placeholder",
                    options.filterPlaceholder),
                            options.filterTheme !== void 0 &&
                this._search &&
                jQuery.mobile.textinput &&
                this._search.textinput("option",
                    "theme",
                    options.filterTheme),
                            ret
                        );
          ...
          decodeURIComponent(anchor.href.replace(rhash,
              ...
              value || this.options.active !== !1 || this._activate(0)),
                    ...
                    refresh: function () {
                        ...
                        options.active !== !1 && this.anchors.length
                            ...
                            : this.active.length &&
                !jQuery.contains(this.tablist[0],
                    this.active[0])
                                ? this.tabs.length === options.disabled.length
                                    ? ((options.active = !1), (this.active = jQuery()))
                                    : this._activate(
                                        this._findNextTab(Math.max(0,
                                            options.active - 1),
                                        !1),
                                    )
            ...
            jQuery.each(event.split(" "),
              ...
              jQuery.error("jQuery UI Tabs: Mismatching fragment identifier."),
                        toShow.length && this.load(this.tabs.index(tab),
                            event),
                        this._toggle(event,
                            eventData);
                    },
                    _toggle: function (event, eventData) {
                        ...
                        this.running = !0;
                        function complete() {
                            (that.running = !1), that._trigger("activate",
                                event,
                                eventData);
                        }
                        function show() {
                  ...
                  "");
                    ...
                    enable: function (index) {
                        ...
                        void 0 === index
                            ...
                            jQuery.isArray(disabled)
                                ? (disabled = jQuery.map(disabled,
                                    function (num) {
                                        return index !== num ? num : null;
                                    }))
                                : (disabled = jQuery.map(this.tabs,
                                    function (li, num) {
                                        return index !== num ? num : null;
                                    }))),
              ...
              this.xhr
                  ...
                  .complete(function (jqXHR, status) {
                      setTimeout(function () {
                          "abort" === status && that.panels.stop(!1,
                              !0),
        ...
        !(ua.indexOf("AppleWebKit") > -1)
          ...
          !(x > 7 || (((z > 6 && 8 > y) || (8 > z && y > 6)) && x > 5))
            ...
            jQuery.mobile.document.on("mobileinit",
                function () {
                    jQuery.mobile.iosorientationfixEnabled &&
          jQuery.mobile.window
              .bind("orientationchange.iosorientationfix",
                  zoom.enable)
              .bind("devicemotion.iosorientationfix",
                  checkTilt);
                });
        })(jQuery,
            this),
