    ...
    return (
        ...
        (function ($, window1, undefined) {
            ...
            jQuery.extend(jQuery.mobile, {
              ...
              (data = element.getAttribute("data-" + jQuery.mobile.ns + key));
                    try {
                        data =
              "true" === data
                  ? !0
            ...
            (nsNormalizeDict[prop] = jQuery.camelCase(jQuery.mobile.ns + prop))
                    );
                },
            ...
            (jQuery.jqmData = function (elem, prop, value) {
              ...
              (result = jQuery.data(
                  elem,
                  prop ? jQuery.mobile.nsNormalize(prop) : prop,
                  value,
              )),
                    result
                );
            ...
            (jQuery.find = function (selector, context, ret, extra) {
                return (
                    selector.indexOf(":jqmData") > -1 &&
              (selector = selector.replace(
                  jqmDataRE,
                  "[data-" + (jQuery.mobile.ns || "") + "$1]",
              )),
                    oldFind.call(this, selector, context, ret, extra)
                );
            }),
        ...
        (function ($, undefined) {
                            ...
                            .filter(function () {
                                return (
                                    /(relative|absolute|fixed)/.test(
                                        jQuery.css(this, "position"),
                                    ) &&
                    /(auto|scroll)/.test(
                        jQuery.css(this, "overflow") +
                        jQuery.css(this, "overflow-y") +
                        jQuery.css(this, "overflow-x"),
                    )
                                );
                            })
                            .eq(0);
            ...
            function focusable(element, isTabIndexNotNaN) {
              ...
              element.parentNode.nodeName.toLowerCase() !== "map")
                        ...
                        return !1;
                    return (
                        (img = jQuery("img[usemap=#" + element.parentNode.name + "]")[0]),
                        !!img && visible(img)
                    );
                }
                return (
              ...
              function reduce(elem, size, border, margin) {
                  return (
                      jQuery.each(
                          ...
                          function () {
                              (size -=
                      parseFloat(jQuery.css(elem, "padding" + this)) || 0),
                              border &&
                        (size -=
                          parseFloat(
                              jQuery.css(elem, "border" + this + "Width"),
                          ) || 0),
                              margin &&
                        (size -=
                          parseFloat(jQuery.css(elem, "margin" + this)) || 0);
                          },
                      ),
                      size
                  );
          ...
          (jQuery.fn.addBack = function (selector) {
            ...
            jQuery("<a>").data("a-b", "a").removeData("a-b").data("a-b") &&
          (jQuery.fn.removeData = (function (removeData) {
              return function (key) {
                  if (arguments.length)
                      return jQuery.fn.removeData.call(this, jQuery.camelCase(key));
                  return jQuery.fn.removeData.call(this);
              };
          })(jQuery.fn.removeData)),
            (jQuery.ui.ie = !!/msie [\w.]+/.exec(
                navigator.userAgent.toLowerCase(),
            )),
            (jQuery.support.selectstart =
          "onselectstart" in document.createElement("div")),
            jQuery.fn.extend({
                disableSelection: function () {
                    return this.bind(
                        (jQuery.support.selectstart ? "selectstart" : "mousedown") +
                ".ui-disableSelection",
                        function (event) {
        ...
        (function ($, window1, undefined) {
            ...
            (ypos = jQuery.mobile.defaultHomeScroll),
                    ...
                    setTimeout(function () {
                        window1.scrollTo(0, ypos),
                        jQuery.mobile.document.trigger("silentscroll", {
                            x: 0,
                            y: ypos,
                        });
                    }, 20),
              ...
              (url = base),
                        jQuery.mobile.path.makeUrlAbsolute(url, base)
                    );
                },
                removeActiveLinkClass: function (forceRemoval) {
                    !!jQuery.mobile.activeClickedLink &&
            (!jQuery.mobile.activeClickedLink.closest(
                "." + jQuery.mobile.activePageClass,
            ).length ||
              forceRemoval) &&
            jQuery.mobile.activeClickedLink.removeClass(
                jQuery.mobile.activeBtnClass,
            ),
                    (jQuery.mobile.activeClickedLink = null);
                },
                getInheritedTheme: function (el, defaultTheme) {
                    for (var e = el[0], ltr = "", c, m; e; ) {
                        if (
                            ((c = e.className || ""),
                            c &&
                (m = /ui-(bar|body|overlay)-([a-z])\b/.exec(c)) &&
                (ltr = m[2]))
                        )
                            break;
                        e = e.parentNode;
                ...
                haveParents: function (elements, attr) {
                    ...
                    for (i = 0; count > i; i++) {
                        for (
                            $element = elements.eq(i), excluded = !1, e = elements[i];
                            e;

                        ) {
                            if (
                                ((c = e.getAttribute
                                    ? e.getAttribute("data-" + jQuery.mobile.ns + attr)
                                    : ""),
                                "false" === c)
                            ) {
                                excluded = !0;
                ...
                resetActivePageHeight: function (height) {
                    var page = jQuery("." + jQuery.mobile.activePageClass),
                ...
                (toolbarsAffectingHeight = toolbarsAffectingHeight.concat(
                    externalFooters.toArray(),
                            ...
                            jQuery.each(toolbarsAffectingHeight, function (index, value) {
              ...
              jQuery(jQuery.mobile.loader.prototype.defaultHtml).loader(),
            ...
            (jQuery.addDependents = function (elem, newDependents) {
                var $elem = jQuery(elem),
                    dependents = $elem.jqmData("dependents") || jQuery();
            ...
            jQuery.fn.extend({
                ...
                jQuery.mobile.degradeInputsWithin(this),
                    jQuery.fn.buttonMarkup &&
                this.find(jQuery.fn.buttonMarkup.initSelector)
                    .not(keepNative)
                    .jqmEnhanceable()
                    .buttonMarkup(),
                ...
                this.find(":jqmData(role='fieldcontain')")
                    ...
                    jQuery.each(jQuery.mobile.widgets, function (name, constructor) {
                        if (constructor.initSelector) {
                            ...
                            elements.length > 0 && (elements = elements.not(keepNative)),
                            elements.length > 0 &&
                      (widgetElements[
            ...
            (jQuery.removeWithDependents = function (nativeElement) {
                ...
                (element.jqmData("dependents") || jQuery()).remove(),
                element.remove();
            }),
            (jQuery.addDependents = function (nativeElement, newDependents) {
                var element = jQuery(nativeElement),
                    dependents = element.jqmData("dependents") || jQuery();
        ...
        (function ($, undefined) {
            ...
            (jQuery.widget = function (name, base, prototype) {
                ...
                if (
                    ...
                    (constructor.prototype = jQuery.widget.extend(
                        basePrototype,
                        {
                ...
                for (
                    ...
                    for (key in input[inputIndex])
                        if (
                            ...
                            input[inputIndex].hasOwnProperty(key) && void 0 !== value)
                        ) {
                  ...
                  options.charAt(0) === "_"
                      ...
                      " widget instance",
                            ...
                            if (
                                ...
                                instance !== methodValue && void 0 !== methodValue)
                            )
                                return (
                                    (returnValue =
            ...
            jQuery.each(
                ...
                function (method, defaultEffect) {
                    jQuery.Widget.prototype["_" + method] = function (
                        element,
                        options,
                        callback,
                    ) {
                ...
                (options = {
                  ...
                  (options = {
                      duration: options,
                            ...
                            hasOptions &&
                  jQuery.effects &&
                  jQuery.effects.effect[effectName])
                        )
            ...
            jQuery.extend(jQuery.Widget.prototype, {
                _getCreateOptions: function () {
                    var option,
                        ...
                        elem = this.element[0],
                        options = {};
                    if (!jQuery.mobile.getAttribute(elem, "defaults"))
                        for (option in this.options)
                            (value = jQuery.mobile.getAttribute(
                                elem,
                                option.replace(rcapitals, function (c) {
        ...
        (function ($) {
          ...
          "<div class='ui-loader'><span class='ui-icon-loading'></span><h1></h1></div>",
            ...
            this.window
                ...
                .bind("scroll", jQuery.proxy(this.fakeFixLoader, this)));
                },
                resetHtml: function () {
                ...
                show: function (theme, msgText, textonly) {
                    ...
                    if ((this.resetHtml(), jQuery.type(theme) === "object"))
                        (loadSettings = jQuery.extend({}, this.options, theme)),
              ...
              msgText || (loadSettings.text === !1 ? "" : loadSettings.text)),
                ...
                (loadSettings.textonly || textonly
                    ...
                    this.element.appendTo(jQuery.mobile.pageContainer),
                    this.checkLoaderPosition(),
                    this.window.bind(
                        "scroll",
                        jQuery.proxy(this.checkLoaderPosition, this),
                    );
                },
                hide: function () {
                    $html.removeClass("ui-loading"),
                    this.options.text && this.element.removeClass("ui-loader-fakefix"),
                    jQuery.mobile.window.unbind("scroll", this.fakeFixLoader),
                    jQuery.mobile.window.unbind("scroll", this.checkLoaderPosition);
                },
            });
        })(jQuery, this),
        (function ($, window1, undefined) {
          ...
          "onhashchange" in window1 && (void 0 === doc_mode || doc_mode > 7);
            ...
            (special.hashchange = jQuery.extend(special.hashchange, {
                setup: function () {
            ...
            (fake_onhashchange = (function () {
                ...
                function poll() {
                    ...
                    if (hash !== last_hash)
                        ...
                        jQuery(window1).trigger("hashchange");
                    else
      ...
      (function (doc, undefined) {
        ...
        (function ($, undefined) {
          ...
          {}.toString.call(window.operamini) === "[object OperaMini]",
            ...
            !operamini,
                ...
                location.pathname +
                "ui-dir/",
                            base = jQuery("head base"),
                            fauxEle = null,
                            href = "",
                            link;
                        if (!base.length)
                            base = fauxEle = jQuery("<base>", {
                                href: fauxBase,
                            }).appendTo("head");
                        else href = base.attr("href");
                        return (
                            (link = jQuery("<a href='testurl' />").prependTo(fakeBody)),
                            link[0].href,
                ...
                getComputedStyle(element, "").pointerEvents === "auto"),
                    ...
                    boundingRect:
            "undefined" !==
            typeof document.createElement("div").getBoundingClientRect,
                    inlineSVG: function () {
                        var w = window,
                            svg =
            ...
            ua.match(/(BrowserNG|NokiaBrowser)\/7\.[0-3]/)
                ...
                (jQuery.mobile.gradeA = function () {
                    return (
                        ((jQuery.support.mediaquery && jQuery.support.cssPseudoElement) ||
              ...
              this.isHashChangeEnabled()
                ...
                popstate: function (event) {
                    ...
                    if (
                        ...
                        return;
                    event.historyState && jQuery.extend(state, event.historyState),
                ...
                setup: function () {
                    ...
                    if (((self.bound = !0), self.isPushStateEnabled()))
        ...
        (function ($, undefined) {
            ...
            (jQuery.mobile.path = path = {
                ...
                getDocumentUrl: function (asParsedObject) {
                    return asParsedObject
                        ? jQuery.extend({}, path.documentUrl)
                ...
                isSameDomain: function (absUrl1, absUrl2) {
                    return (
                        path.parseUrl(absUrl1).domain === path.parseUrl(absUrl2).domain
                    );
                },
                ...
                makeUrlAbsolute: function (relUrl, absUrl) {
                    ...
                    var relObj = path.parseUrl(relUrl),
                        absObj = path.parseUrl(this.documentBase),
                ...
                addSearchParams: function (url, params) {
                    var u = path.parseUrl(url),
                        p = "object" == typeof params ? jQuery.param(params) : params,
                        s = u.search || "?";
                    return (
                        u.hrefNoSearch +
            s +
            ...
            (u.hash || "")
                ...
                convertUrlToDataUrl: function (absUrl) {
                    ...
                    if (path.isEmbeddedPage(u))
                        return u.hash
                            .split("&ui-state=dialog")[0]
                            .replace(/^#/, "")
                            .replace(/\?.*$/, "");
                    if (path.isSameDomain(u, this.documentBase))
                        return u.hrefNoHash
                ...
                get: function (newPath) {
                    return (
                        path.parseLocation().hash === void 0 && path.parseLocation().hash,
                        path
                            .stripHash(path.parseLocation().hash)
                            .replace(/[^\/]*\.[^\/*]+$/, "")
                    );
                },
                set: function (path1) {
                ...
                cleanHash: function (hash) {
                    return path.stripHash(
                        hash.replace(/\?.*$/, "").replace("&ui-state=dialog", ""),
                    );
                },
          ...
          path.documentUrl.hrefNoHash !== path.documentBase.hrefNoHash),
            (path.getDocumentBase = function (asParsedObject) {
                return asParsedObject
                    ? jQuery.extend({}, path.documentBase)
        ...
        jQuery.extend(jQuery.mobile.History.prototype, {
            ...
            closest: function (url) {
                ...
                return (
                    ...
                    void 0 === closest &&
            ((closest = this.find(url, this.stack.slice(a), !0)),
            ...
            direct: function (opts) {
                var newActiveIndex = this.closest(opts.url),
                    a = this.activeIndex;
                if (
                    (void 0 !== newActiveIndex &&
            ((this.activeIndex = newActiveIndex), (this.previousIndex = a)),
                    a > newActiveIndex)
                )
                    (opts.present || opts.back || jQuery.noop)(this.getActive(), "back");
                else if (newActiveIndex > a)
                    (opts.present || opts.forward || jQuery.noop)(
                        this.getActive(),
                        "forward",
                    );
                else
            ...
            jQuery.extend(jQuery.mobile.Navigator.prototype, {
                ...
                hash: function (url, href) {
                    ...
                    if (
                        ...
                        loc.pathname + loc.search === parsed.pathname + parsed.search)
                    )
                        hash = parsed.hash
                            ? parsed.hash
                ...
                go: function (url, data, noEvents) {
                    var state,
                        ...
                        hash,
                        popstateEvent,
                        isPopStateEvent = jQuery.event.special.navigate.isPushStateEnabled();
                    (href = path.squash(url)),
                ...
                (this.preventNextHashChange = noEvents),
                    ...
                    isPopStateEvent &&
                ((popstateEvent = new jQuery.Event("popstate")),
                ...
                !noEvents &&
                  ...
                  jQuery.mobile.window.trigger(popstateEvent))),
              ...
              this.ignoreInitialHashChange
                ...
                path.parseLocation().hash,
                        present: function (historyEntry, direction) {
                            (event.historyState = jQuery.extend({}, historyEntry)),
                ...
                hashchange: function (event) {
                    var history, hash;
                    if (
                        !jQuery.event.special.navigate.isHashChangeEnabled() ||
              jQuery.event.special.navigate.isPushStateEnabled()
                    ...
                    this.history.direct({
                        url: hash,
                        present: function (historyEntry, direction) {
                            (event.hashchangeState = jQuery.extend({}, historyEntry)),
        ...
        (function ($, undefined) {
            ...
            (jQuery.mobile.navigate.history = new jQuery.mobile.History()),
            (jQuery.mobile.navigate.navigator = new jQuery.mobile.Navigator(
        ...
        (function ($, undefined) {
            ...
            jQuery.each(["animation", "transition"], function (i, test) {
                jQuery.each(["", "webkit-", "moz-", "o-"], function (j, prefix) {
                    if (
                        testElement.style[
                            jQuery.camelCase(prefix + (0 === i ? test + "-name" : test))
                        ] !== void 0
                    )
                        return (props[test].prefix = prefix), !1;
                }),
                (props[test].duration = jQuery.camelCase(
            ...
            (jQuery.fn.animationComplete = function (callback, type, fallbackTime) {
              ...
              !type || "animation" === type ? "animation" : "transition";
                if (
                    (jQuery.support.cssTransitions && "transition" === animationType) ||
                ...
                (0 === duration || void 0 === duration || isNaN(duration)) &&
                  (duration = jQuery.fn.animationComplete.defaultDuration)),
                        (timer = setTimeout(function () {
                            jQuery(that).off(props[animationType].event),
                            callback.apply(that);
                        }, duration)),
                        jQuery(this).one(props[animationType].event, function () {
        ...
        (function ($, window1, document1, undefined) {
            var virtualEventNames = "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(
                ...
                mouseHookProps = jQuery.event.mouseHooks
            ...
            function mouseEventCallback(event) {
                var touchID = jQuery.data(event.target, "virtualTouchID"),
                    ve;
                !blockMouseTriggers &&
          ...
          flags.hasVirtualBinding &&
            ...
            jQuery.data(event.target, "virtualTouchID", lastTouchID),
            clearResetTimer(),
          ...
          triggerVirtualEvent(
            ...
            function handleTouchMove(event) {
                ...
                var t = getNativeEvent(event).touches[0],
                    didCancel = didScroll,
                    moveThreshold = jQuery.vmouse.moveDistanceThreshold,
                    flags = getVirtualBindingFlags(event.target);
                (didScroll ||=
          ...
          Math.abs(t.pageY - startY) > moveThreshold),
            ...
            function hasVirtualBindings(ele) {
                var bindings = jQuery.data(ele, "virtualMouseBindings"),
                    k;
                  ...
                  $document
                      ...
                      .unbind("scroll", handleScroll));
                        var $this = jQuery(this),
                            bindings = jQuery.data(this, "virtualMouseBindings");
                        bindings && (bindings[eventType] = !1),
                        $this.unbind(realType, dummyMouseHandler),
                        hasVirtualBindings(this) ||
                $this.removeData("virtualMouseBindings");
                    },
                };
            }
                    ...
                    for (
                        ...
                        for (i = 0; cnt > i; i++)
                            if (
                                ((o = clickBlockList[i]),
                                (ele === target &&
                      Math.abs(o.x - e.clientX) <
                        jQuery.vmouse.clickDistanceThreshold &&
                      Math.abs(o.y - e.clientY) <
                        jQuery.vmouse.clickDistanceThreshold) ||
                      jQuery.data(ele, "virtualTouchID") === o.touchID)
                            )
        ...
        (function ($, window1, undefined) {
            ...
            function triggerCustomEvent(obj, eventType, event, bubble) {
                ...
                if (((event.type = eventType), bubble))
                    jQuery.event.trigger(event, void 0, obj);
            ...
            (jQuery.event.special.tap = {
                ...
                setup: function () {
                    ...
                    $this.bind("vmousedown", function (event) {
                        ...
                        (timer = setTimeout(function () {
                            jQuery.event.special.tap.emitTapOnTaphold || (isTaphold = !0),
                            triggerCustomEvent(
                                thisObject,
                                "taphold",
            ...
            (jQuery.event.special.swipe = {
              ...
              (0 === event.pageX && Math.floor(x) > Math.floor(event.pageX))
                ...
                jQuery.event.special.swipe.durationThreshold &&
              Math.abs(start.coords[0] - stop.coords[0]) >
                jQuery.event.special.swipe.horizontalDistanceThreshold &&
              Math.abs(start.coords[1] - stop.coords[1]) <
                jQuery.event.special.swipe.verticalDistanceThreshold
                    ) {
                        var direction =
                ...
                setup: function () {
                    var events,
                        ...
                        $this = jQuery(thisObject),
                        context = {};
                    (events = jQuery.data(this, "mobile-events")),
                    events ||
                ((events = {
                    length: 0,
                }),
                jQuery.data(this, "mobile-events", events)),
                    events.length++,
                    ...
                    (context.start = function (event) {
                        ...
                        var stop,
                            start = jQuery.event.special.swipe.start(event),
                            origTarget = event.target,
                            emitted = !1;
                        (context.move = function (event) {
                            if (!start) return;
                            (stop = jQuery.event.special.swipe.stop(event)),
                            emitted ||
                      ((emitted = jQuery.event.special.swipe.handleSwipe(
                          start,
                          stop,
                          thisObject,
                          origTarget,
                      ...
                      emitted &&
                        (jQuery.event.special.swipe.eventInProgress = !1)),
                            Math.abs(start.coords[0] - stop.coords[0]) >
                      jQuery.event.special.swipe.scrollSupressionThreshold &&
                      event.preventDefault();
                        }),
                ...
                0 === events.length &&
                  jQuery.removeData(this, "mobile-events")),
                    events.swipe &&
                (events.swipe.start &&
                  jQuery(this).off(touchStartEvent, events.swipe.start),
                events.swipe.move &&
                  $document.off(touchMoveEvent, events.swipe.move),
                events.swipe.stop &&
                  $document.off(touchStopEvent, events.swipe.stop));
                },
            }),
            jQuery.each(
                {
        ...
        (function ($) {
            ...
            var handler = function () {
                    if (
                        ...
                        (lastCall = curr), jQuery(this).trigger("throttledresize");
                    else
                        heldCall && clearTimeout(heldCall),
          ...
          ((last_orientation = orientation), win.trigger("orientationchange"));
            ...
            (jQuery.event.special.orientationchange.orientation = get_orientation = function () {
                ...
                if (jQuery.support.orientation)
                    isPortrait = portrait_map[window1.orientation];
        ...
        (function ($, undefined) {
            var baseElement = jQuery("head").children("base"),
                base = {
            ...
            "[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]",
                    set: function (href) {
                        ...
                        jQuery.support.dynamicBaseTag &&
              base.element.attr(
                  "href",
                  jQuery.mobile.path.makeUrlAbsolute(
                      href,
                      jQuery.mobile.path.documentBase,
                  ),
              );
                    },
                    rewrite: function (href, page) {
                        ...
                        page.find(base.linkSelector).each(function (i, link) {
                            var thisAttr = jQuery(link).is("[href]")
                                    ? "href"
                                    : jQuery(link).is("[src]")
                                        ? "src"
                                        : "action",
                                thisUrl = jQuery(link).attr(thisAttr);
                            (thisUrl = thisUrl.replace(
                                location.protocol + "//" + location.host + location.pathname,
                                "",
                            )),
                            /^(\w+:|#|\/)/.test(thisUrl) ||
                  jQuery(link).attr(thisAttr, newPath + thisUrl);
                        });
                    },
                    reset: function () {
                        base.element.attr(
                            "href",
                            jQuery.mobile.path.documentBase.hrefNoSearch,
                        );
                    },
                };
        ...
        (function ($, undefined) {
            ...
            (jQuery.widget = (function (orig) {
                return function () {
                    var constructor = jQuery.widget.apply(this, arguments),
            ...
            jQuery.extend(jQuery.widget, originalWidget),
            jQuery.mobile.document.on("create", function (event) {
            ...
            jQuery.widget("mobile.page", {
                ...
                _createWidget: function () {
                    jQuery.Widget.prototype._createWidget.apply(this, arguments),
                    this._trigger("init");
                },
                _create: function () {
                    ...
                    jQuery.mobile.getAttribute(this.element[0], "role") ===
                "dialog" &&
                jQuery.mobile.dialog &&
                this.element.dialog();
                },
                _enhance: function () {
                    var attrPrefix = "data-" + jQuery.mobile.ns,
                        self = this;
                    this.options.role &&
              this.element.attr(
                  ...
                  this.options.role,
                    ...
                    this.element
                        ...
                        .each(function () {
                            var $this = jQuery(this),
                                theme = this.getAttribute(attrPrefix + "theme") || void 0;
              ...
              page.bind(
                  ...
                  function (e, data) {
                      if (!data.samePage) {
                          var $this = jQuery(this),
                              prEvent = new jQuery.Event("pageremove");
              ...
              this.element
                ...
                this.element
                    .find("[data-" + jQuery.mobile.ns + "='content']")
                ...
                keepNativeSelector: function () {
                    var options = this.options,
                        keepNative = jQuery.trim(options.keepNative || ""),
                        globalValue = jQuery.trim(jQuery.mobile.keepNative),
                        optionValue = jQuery.trim(options.keepNativeDefault),
                        newDefault =
        ...
        (function ($, undefined) {
            ...
            e.originalEvent.type.indexOf("hashchange") > -1
              ...
              (url = location.href),
                ...
                go: function (steps) {
                    if (jQuery.mobile.hashListeningEnabled) window.history.go(steps);
                        ...
                        var activeIndex = jQuery.mobile.navigate.history.activeIndex,
                            index = activeIndex + parseInt(steps, 10),
                            url = jQuery.mobile.navigate.history.stack[index].url,
                            direction = steps >= 1 ? "forward" : "back";
                        (jQuery.mobile.navigate.history.activeIndex = index),
                        (jQuery.mobile.navigate.history.previousIndex = activeIndex),
                        this.change(url, {
                            direction: direction,
                            changeHash: !1,
                            fromHashChange: !0,
              ...
              (to = !jQuery.mobile.path.isPath(to)
                  ? jQuery.mobile.path.makeUrlAbsolute(
                      "#" + to,
              ...
              to ===
                ...
                history.stack[0].url !==
                  history.initialDst.replace(jQuery.mobile.dialogHashKey, "") &&
                ...
                _handleNavigate: function (url, data) {
                    var to = jQuery.mobile.path.stripHash(url),
                        history = this._getHistory(),
              ...
              history.initialDst !== to)
                        ...
                        if (((to = this._handleDialog(changePageOptions, data)), !1 === to))
                            return;
                    }
              ...
              (page = jQuery(
                  ...
                  "</div>",
                        ...
                        page
                            .attr(
                                ...
                                jQuery.mobile.path.convertUrlToDataUrl(fileUrl),
                            )
                ...
                _setLoadedTitle: function (page, html) {
                    ...
                    newPageTitle &&
            !page.jqmData("title") &&
            ((newPageTitle = jQuery("<div>" + newPageTitle + "</div>").text()),
            page.jqmData("title", newPageTitle));
                },
                _isRewritableBaseTag: function () {
                    return (
                        jQuery.mobile.dynamicBaseEnabled && !jQuery.support.dynamicBaseTag
                    );
                },
                ...
                _triggerWithDeprecated: function (name, data, page) {
                    var deprecatedEvent = jQuery.Event("page" + name),
                        newEvent = jQuery.Event(this.widgetName + name);
                    return (
                ...
                RegExp.$1 &&
                (fileUrl = jQuery.mobile.path.getFilePath(
                    jQuery("<div>" + RegExp.$1 + "</div>").text(),
                )),
                            settings.prefetch === void 0 && this._getBase().set(fileUrl),
                            ...
                            !this._trigger("load", void 0, triggerData))
                        )
                            return;
              ...
              this._getBase().rewrite(fileUrl, content),
                        ...
                        absUrl.indexOf("&" + jQuery.mobile.subPageUrlKey) > -1 &&
                ...
                load: function (url, options) {
                    var deferred = (options && options.deferred) || jQuery.Deferred(),
                        settings = jQuery.extend({}, this._loadDefaults, options),
                        content = null,
              ...
              pblEvent.event.isDefaultPrevented())
                        ...
                        return;
                    if (
                        (settings.showLoadMsg && this._showLoading(settings.loadMsgDelay),
                        settings.prefetch === void 0 && this._getBase().reset(),
                        !(
                            jQuery.mobile.allowCrossDomainPages ||
              jQuery.mobile.path.isSameDomain(
                  jQuery.mobile.path.documentUrl,
                  absUrl,
              )
                        ))
                    ) {
                ...
                _loadError: function (absUrl, triggerData, settings, deferred) {
                    return jQuery.proxy(function (xhr, textStatus, errorThrown) {
                        this._getBase().set(jQuery.mobile.path.get()),
                        (triggerData.xhr = xhr),
                        (triggerData.textStatus = textStatus),
              ...
              plfEvent.event.isDefaultPrevented()
                ...
                _getTransitionHandler: function (transition) {
                    return (
                        (transition = jQuery.mobile._maybeDegradeTransition(transition)),
                        jQuery.mobile.transitionHandlers[transition] ||
            ...
            this._triggerWithDeprecated(
              ...
              jQuery.mobile.changePage.apply(null, pageTransitionQueue.pop());
                },
                ...
                _loadUrl: function (to, triggerData, settings) {
                    ...
                    settings.deferred.done(
                        jQuery.proxy(function (url, options, content) {
                            (isPageTransitioning = !1),
                ...
                change: function (to, options) {
                    ...
                    if (
                        ...
                        return;
                    if (
                        (triggerData.toPage, jQuery.type(triggerData.toPage) === "string")
                    )
                        (isPageTransitioning = !0),
                        this._loadUrl(triggerData.toPage, triggerData, settings);
              ...
              (settings.dataUrl = jQuery.mobile.path.documentUrl.hrefNoHash),
                        (url =
              (settings.dataUrl &&
                jQuery.mobile.path.convertUrlToDataUrl(settings.dataUrl)) ||
              toPage.jqmData("url")),
                        (pageUrl = url),
                        jQuery.mobile.path.getFilePath(url),
              ...
              document.activeElement.nodeName.toLowerCase() !== "body"
                    ...
                    if (((alreadyThere = !1), isDialog && active)) {
                        if (
                            (active.url &&
                active.url.indexOf(jQuery.mobile.dialogHashKey) > -1 &&
                this.activePage &&
              ...
              (isDialog
                  ...
                  : jQuery.mobile.defaultPageTransition)),
                        !historyDir &&
              alreadyThere &&
              (jQuery.mobile.navigate.history.getActive().pageUrl = pageUrl),
                        url && !settings.fromHashChange)
                    ) {
                        if (
                            (!jQuery.mobile.path.isPath(url) &&
                url.indexOf("#") < 0 &&
                (url = "#" + url),
                            ...
                            jQuery.mobile.navigate(url, params, !0);
                        else
                            toPage[0] !== jQuery.mobile.firstPage[0] &&
                jQuery.mobile.navigate.history.add(url, params);
                    }
                    ...
                    this._cssTransition(toPage, settings.fromPage, {
                        transition: settings.transition,
                    ...
                    settings.duplicateCachedPage.remove(),
                            alreadyFocused || jQuery.mobile.focusPage(toPage),
                            this._releaseTransitionLock(),
                            this.element.trigger("pagechange", triggerData),
                            this._triggerWithDeprecated("transition", triggerData);
                        },
                ...
                _findBaseWithDefault: function () {
                    var closestBase =
            this.activePage && jQuery.mobile.getClosestBaseUrl(this.activePage);
        ...
        (function ($, undefined) {
            var domreadyDeferred = jQuery.Deferred(),
                loadDeferred = jQuery.Deferred(),
                documentUrl = jQuery.mobile.path.documentUrl,
                $lastVClicked = null;
            ...
            (jQuery.mobile._maybeDegradeTransition =
          jQuery.mobile._maybeDegradeTransition ||
          function (transition) {
              return transition;
          }),
            ...
            (jQuery.mobile._registerInternalEvents = function () {
                ...
                url === jQuery.mobile.path.documentBase.hrefNoHash &&
                  (url = documentUrl.hrefNoSearch)),
                        (url = jQuery.mobile.path.makeUrlAbsolute(
                            url,
                            jQuery.mobile.getClosestBaseUrl($form),
                        )),
                        jQuery.mobile.path.isExternal(url) &&
              ...
              formData &&
                ...
                jQuery.mobile.document.bind("vclick", function (event) {
                    ...
                    if (
                        (($lastVClicked = jQuery(target)),
                        jQuery.data(target, "mobile-button"))
                    ) {
                        if (!getAjaxFormData(jQuery(target).closest("form"), !0))
                            return;
                    ...
                    if (!!~target.className.indexOf("ui-link-inherit"))
                        target.parentNode &&
                  (btnEls = jQuery.data(target.parentNode, "buttonElements"));
                    else btnEls = jQuery.data(target, "buttonElements");
                    if (btnEls) target = btnEls.outer;
                    else needClosest = !0;
                    ($btn = jQuery(target)),
                    needClosest && ($btn = $btn.closest(".ui-btn")),
                    $btn.length > 0 &&
                  !$btn.hasClass("ui-state-disabled") &&
                  (jQuery.mobile.removeActiveLinkClass(!0),
                  (jQuery.mobile.activeClickedLink = $btn),
                  jQuery.mobile.activeClickedLink.addClass(
                      jQuery.mobile.activeBtnClass,
                  ));
                }),
                ...
                event.isDefaultPrevented()
                  ...
                  httpCleanup(),
                        !link || event.which > 1 || !$link.jqmHijackable().length)
                    )
                        return;
                    if ($link.is(":jqmData(rel='back')"))
                        return jQuery.mobile.back(), !1;
                    if (
                        ((baseUrl = jQuery.mobile.getClosestBaseUrl($link)),
                        (href = jQuery.mobile.path.makeUrlAbsolute(
                            $link.attr("href") || "#",
                            baseUrl,
                        )),
                        !jQuery.mobile.ajaxEnabled &&
                  !jQuery.mobile.path.isEmbeddedPage(href))
                    ) {
                        httpCleanup();
                        return;
                    }
                    if (href.search("#") !== -1) {
                        if (((href = href.replace(/[^#]*#/, "")), !href)) {
                            event.preventDefault();
                            return;
                        } else if (jQuery.mobile.path.isPath(href))
                            href = jQuery.mobile.path.makeUrlAbsolute(href, baseUrl);
                        else
                            href = jQuery.mobile.path.makeUrlAbsolute(
                                "#" + href,
                  ...
                  $link.is("[target]")),
                        useDefaultUrlHandling ||
                  (jQuery.mobile.path.isExternal(href) &&
                    !jQuery.mobile.path.isPermittedCrossDomainRequest(
                        documentUrl,
                        href,
                    )))
                ...
                jQuery.mobile.document.bind("pageshow", function () {
                    if (loadDeferred)
                        loadDeferred.done(jQuery.mobile.resetActivePageHeight);
            ...
            jQuery
                .when(domreadyDeferred, jQuery.mobile.navreadyDeferred)
                .done(function () {
        ...
        (function ($, window1, undefined) {
            ...
            jQuery.extend(jQuery.mobile.Transition.prototype, {
                ...
                cleanFrom: function () {
                    this.$from
                        .removeClass(
                            jQuery.mobile.activePageClass + " out in reverse " + this.name,
                        )
                        .height("");
                },
                ...
                this.scrollPage(),
                    this.sequential ||
                this.$to.addClass(jQuery.mobile.activePageClass),
                ...
                window1.scrollTo(0, this.toScroll),
                    setTimeout(function () {
                        jQuery.event.special.scrollstart.enabled = !0;
                    }, 150);
                },
                startIn: function (screenHeight, reverseClass, none, preventFocus) {
                    if (
                        (this.hideIn(function () {
                            this.$to.addClass(
                                jQuery.mobile.activePageClass + this.toPreClass,
                            ),
                            preventFocus || jQuery.mobile.focusPage(this.$to),
                ...
                startOut: function (screenHeight, reverseClass, none) {
                    ...
                    this.$from
                        .height(screenHeight + jQuery.mobile.window.scrollTop())
                        .addClass(this.name + " out" + reverseClass);
                },
                toggleViewportClass: function () {
                    jQuery.mobile.pageContainer.toggleClass(
        ...
        (function ($) {
            ...
            jQuery.extend(
                jQuery.mobile.SerialTransition.prototype,
                jQuery.mobile.Transition.prototype,
                {
                    sequential: !0,
                    beforeDoneOut: function () {
        ...
        (function ($) {
            ...
            jQuery.extend(
                jQuery.mobile.ConcurrentTransition.prototype,
                jQuery.mobile.Transition.prototype,
                {
                    sequential: !1,
                    beforeDoneIn: function () {
      ...
      jQuery.mobile.transitionHandlers.sequential),
        ...
        (jQuery.mobile._maybeDegradeTransition = function (transition) {
          ...
          jQuery.mobile.transitionFallbacks[transition] &&
          (transition = jQuery.mobile.transitionFallbacks[transition]),
                transition
            );
        }),
        (jQuery.mobile.getMaxScrollForTransition =
      ...
      function () {
        ...
        (jQuery.mobile.transitionHandlers.slide =
      jQuery.mobile.transitionHandlers.simultaneous),
        (jQuery.mobile.transitionFallbacks.slide = "fade"),
        (jQuery.mobile.transitionFallbacks.slidedown = "fade"),
        (jQuery.mobile.transitionFallbacks.slidefade = "fade"),
        ...
        (jQuery.mobile.page.prototype.options.degradeInputs =
      jQuery.mobile.degradeInputs),
        (jQuery.mobile.degradeInputsWithin = function (target) {
            (target = jQuery(target)),
            target
                .find("input")
                .not(jQuery.mobile.page.prototype.keepNativeSelector())
                .each(function () {
              ...
              ((html = jQuery("<div>").html(element.clone()).html()),
        ...
        jQuery.widget("mobile.page", jQuery.mobile.page, {
          ...
          this._inner.toggleClass("ui-corner-all", !!options.corners),
            ...
            (closeButtonLocation = options.closeBtn),
                closeButtonLocation &&
            this._setCloseBtn(closeButtonLocation, options.closeBtnText),
                this._super(options);
            },
            _handlePageBeforeShow: function () {
            ...
            "left" === location
                ...
                location,
                        ...
                        .attr("data-" + jQuery.mobile.ns + "rel", "back")
        ...
        (function ($, undefined) {
            ...
            jQuery.widget("mobile.collapsible", {
                ...
                _create: function () {
                    ...
                    if (
                        ...
                        (ui.heading = jQuery(".ui-collapsible-heading", this.element[0])),
                        (ui.content = ui.heading.next()),
                        (ui.anchor = jQuery("a", ui.heading[0]).first()),
                    ...
                    this._on(ui.heading, {
                        tap: function () {
                            ui.heading
                                .find("a")
                                .first()
                                .addClass(jQuery.mobile.activeBtnClass);
                        },
              ...
              options[key] != null
                  ...
                  : accordionWidget
                      ...
                      : accordion.length
                          ? jQuery.mobile.getAttribute(
                              accordion[0],
                              key.replace(rInitialLetter, "-$1").toLowerCase(),
                          )
                          : null),
                        null == options[key] &&
                (options[key] = jQuery.mobile.collapsible.defaults[key]);
                    return options;
                },
                ...
                (contentThemeClass ? "ui-collapsible-themed-content " : ""),
                  ...
                  "'></div>",
                        ...
                        ui.heading.is("legend") &&
              ((ui.heading = jQuery(
                  "<div role='heading'>" + ui.heading.html() + "</div>",
              )),
              (ui.placeholder = jQuery(
              ...
              this._handleExpandCollapse(options.collapsed),
                        ...
                        opts.expandCueText !== void 0 && status.text(opts.expandCueText);
                    else
            ...
            opts.collapsedIcon !== void 0
              ...
              elem.toggleClass("ui-corner-all", hasCorners),
                    opts.mini !== void 0 && anchor.toggleClass("ui-mini", opts.mini);
                },
                _setOptions: function (options) {
                ...
                _handleExpandCollapse: function (isCollapse) {
                    ...
                    ui.heading
                        ...
                        .removeClass(jQuery.mobile.activeBtnClass),
        ...
        (jQuery.mobile.behaviors.addFirstLastClasses = {
            ...
            _addFirstLastClasses: function ($els, $visibles, create) {
                ...
                create || this.element.trigger("updatelayout");
            },
        ...
        ":mobile-collapsible, " + jQuery.mobile.collapsible.initSelector;
            jQuery.widget(
                "mobile.collapsibleset",
                jQuery.extend(
                    {
              ...
              ":jqmData(role='collapsible-set'),:jqmData(role='collapsibleset')",
                        ...
                        _handleCollapsibleExpand: function (event) {
                            var closestCollapsible = jQuery(event.target).closest(
                                ".ui-collapsible",
                            );
                            closestCollapsible
                                .parent()
                ...
                closestCollapsible
                  ...
                  this.element
                      .find(jQuery.mobile.collapsible.initSelector)
                      .collapsible()),
                            this._on(elem, {
        ...
        jQuery.widget("mobile.navbar", {
            ...
            _create: function () {
                ...
                $navbtns.each(function () {
                    var icon = jQuery.mobile.getAttribute(this, "icon"),
                        theme = jQuery.mobile.getAttribute(this, "theme"),
                        classes = "ui-btn";
                ...
                jQuery.extend(
                    ...
                    jQuery(
                        ...
                        _getChildrenByTagName: function (ele, lcName, ucName) {
                            ...
                            for (
                                ...
                                dict[ele.nodeName] && results.push(ele),
                                (ele = ele.nextSibling);
                  ...
                  getAttr($list[0], "counttheme") || this.options.countTheme,
                                countThemeClass = countTheme
                                    ...
                                    : "ui-body-inherit";
                            for (
                                o.theme && $list.addClass("ui-group-theme-" + o.theme),
                                ol &&
                    (start || 0 === start) &&
                    ...
                    item.css(
                        ...
                        "listnumbering " + newStartCount,
                            ...
                            for (itemClass in itemClassDict)
                                jQuery(itemClassDict[itemClass]).addClass(itemClass);
                            countBubbles.each(function () {
                                jQuery(this).closest("li").addClass("ui-li-has-count");
                            }),
                            countThemeClass && countBubbles.addClass(countThemeClass),
            ...
            (this._replaceDividers(), this._superApply(arguments));
                ...
                _replaceDividers: function () {
                    ...
                    for (
                        ...
                        (li = lis[i]),
                        (dividerText = this.options.autodividersSelector(jQuery(li))),
                        dividerText &&
                dividerText !== lastDividerText &&
                ...
                _afterListviewRefresh: function () {
                    ...
                    if ((this._superApply(arguments), this.options.hideDividers))
                        for (
                            ...
                            if (((item = items[idx]), item.className.match(rdivider)))
                                hideDivider &&
        ...
        (jQuery.mobile.nojs = function (target) {
        ...
        (function ($, undefined) {
            ...
            jQuery.widget(
              ...
              "input:not( :jqmData(role='flipswitch' ) )[type='checkbox'],input[type='radio']:not( :jqmData(role='flipswitch' ))",
                  ...
                  label.attr("data-" + jQuery.mobile.ns + "iconpos") ||
                  o.iconpos),
                ...
                event.stopPropagation();
                        ...
                        _cacheVals: function () {
                            this._getInputSet().each(function () {
                                jQuery(this).attr(
                                    "data-" + jQuery.mobile.ns + "cacheVal",
                                    this.checked,
                                );
                            });
                        },
                    ...
                    "input[type='radio'][name='" + escapeId(name) + "']"),
                                    ...
                                    form.id &&
                      (radios = jQuery(
                          selector + "[form='" + escapeId(form.id) + "']",
                          doc,
                      )),
                                    (radios = jQuery(form)
                                        .find(selector)
                                    ...
                                    radios = jQuery(selector, doc).filter(function () {
                                        return !this.form;
                                    });
                            }
                            return radios;
                      ...
                      controlgroupConstructor.prototype.initSelector,
                        ...
                        refresh: function () {
                            var hasIcon = this._hasIcon(),
                                ...
                                active = jQuery.mobile.activeBtnClass,
                                iconposClass = "ui-btn-icon-" + this.options.iconpos,
                                addClasses = [],
                                removeClasses = [];
                            if (hasIcon)
                                removeClasses.push(active), addClasses.push(iconposClass);
                            else
        ...
        "input[type='button'], input[type='submit'], input[type='reset']",
          ...
          outer
            ...
            outer.toggleClass("ui-btn-inline", options.inline),
                options.mini !== void 0 && outer.toggleClass("ui-mini", options.mini),
                options.disabled !== void 0 &&
            ...
            outer
                ...
                .addClass(
                    this._getIconClasses(jQuery.extend({}, this.options, options)),
                ),
                this._super(options);
            },
            refresh: function (create) {
        ...
        jQuery.widget("mobile.textinput", {
            initSelector:
        "input[type='text'],input[type='search'],:jqmData(type='search'),input[type='number'],:jqmData(type='number'),input[type='password'],input[type='email'],input[type='url'],input[type='tel'],textarea,input[type='time'],input[type='date'],input[type='month'],input[type='week'],input[type='datetime'],input[type='datetime-local'],input[type='color'],input:not([type]),input[type='file']",
          ...
          navigator.userAgent.indexOf("AppleWebKit") > -1,
            ...
            (this.element.is("input") ||
              this.element.is(
                  "[data-" + (jQuery.mobile.ns || "") + "type='search']",
              )) &&
            !isRange;
            ...
            _enhance: function () {
                var elementClasses = [];
                if (
                    (this.isTextarea && elementClasses.push("ui-input-text"),
            ...
            _classesFromOptions: function () {
                ...
                return (
                    ...
                    options.disabled && classes.push("ui-state-disabled"),
                    options.wrapperClass && classes.push(options.wrapperClass),
                    classes
                );
            },
            _wrap: function () {
          ...
          this.element[0].setAttribute("autocomplete", "off"));
            ...
            _handleBlur: function () {
                this.widget().removeClass(jQuery.mobile.focusClass),
                this.options.preventFocusZoom && jQuery.mobile.zoom.enable(!0);
            },
            _handleFocus: function () {
                this.options.preventFocusZoom && jQuery.mobile.zoom.disable(!0),
                this.widget().addClass(jQuery.mobile.focusClass);
            },
            _setOptions: function (options) {
                var outer = this.widget();
        ...
        jQuery.widget(
            ...
            "input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",
                ...
                jQuery.mobile.getAttribute(control[0], "theme"),
                            cornerClass =
                ...
                this.options.mini || control.jqmData("mini") ? " ui-mini" : "",
                            ...
                            handle = jQuery(domHandle),
                            domSlider = document.createElement("div"),
                            slider = jQuery(domSlider),
                            valuebg =
                    ...
                    : !1,
                        ...
                        if (
                            ...
                            for (
                                ...
                                origTabIndex && handle.attr("tabindex", origTabIndex),
                        ...
                        slider
                            .bind("vmousedown", jQuery.proxy(this._sliderVMouseDown, this))
                            .bind("vclick", !1),
                        this._on(document, {
                ...
                control.add(slider).wrapAll(wrapper)),
                        ...
                        this._handleFormReset(),
                        this.refresh(void 0, void 0, !0);
                    },
                    _setOptions: function (options) {
                        options.theme !== void 0 && this._setTheme(options.theme),
                        options.trackTheme !== void 0 &&
                this._setTrackTheme(options.trackTheme),
                        options.corners !== void 0 && this._setCorners(options.corners),
                        options.mini !== void 0 && this._setMini(options.mini),
              ...
              !(
                ...
                (this.valuebg = (function () {
                    ...
                    return (
                        (bg.className =
                      "ui-slider-bg " + jQuery.mobile.activeBtnClass),
                        jQuery(bg).prependTo(self.slider)
                    );
                })()),
                            ...
                            (optionElements = isInput ? [] : this.element.find("option")),
                            (min = isInput ? parseFloat(this.element.attr("min")) : 0),
                            (max = isInput
                                ? parseFloat(this.element.attr("max"))
                                : optionElements.length - 1),
                            (step =
                isInput && parseFloat(this.element.attr("step")) > 0
                    ? parseFloat(this.element.attr("step"))
                    : 1),
                            "object" == typeof val)
                        ) {
                            if (
                                ...
                                !this.dragging ||
                  data.pageX < this.slider.offset().left - 8 ||
                  data.pageX > this.slider.offset().left + width + 8)
                            )
                                return;
                            if (pxStep > 1)
                                percent =
                  ((data.pageX - this.slider.offset().left) / width) * 100;
                            else
                                percent = Math.round(
                                    ((data.pageX - this.slider.offset().left) / width) * 100,
                                );
                ...
                this._labels.each(function () {
                    ...
                    jQuery(this).width((ab ? aPercent : bPercent) + "%");
                            ...
                            if (((valueChanged = !1), isInput))
                                (valueChanged = this.element.val() !== newval),
                    ...
                    _setTheme: function (value) {
                        ...
                        this.control
                            ...
                            .addClass("ui-body-" + (value ? value : "inherit"));
                    },
        ...
        (function ($, undefined) {
            ...
            jQuery.widget("mobile.slider", jQuery.mobile.slider, {
              ...
              dstOffset.left + (this.handle.width() - this._popup.width()) / 2,
                ...
                _setOption: function (key, value) {
                    if ((this._super(key, value), "showValue" === key))
              ...
              (this._popup = getPopup()
                ...
                _refresh: function () {
                    var o = this.options,
                        newValue;
                    if (
                        (o.popupEnabled && this.handle.removeAttr("title"),
                        (newValue = this._value()),
                        newValue === this._currentValue)
                    )
                        return;
                    if (((this._currentValue = newValue), o.popupEnabled && this._popup))
                        this._positionPopup(), this._popup.html(newValue);
            ...
            (this._popupVisible = !0));
                ...
                _hidePopup: function () {
                    ...
                    o.popupEnabled &&
            this._popupVisible &&
            (o.showValue && !o.mini && this.handle.html(this._value()),
            this._popup.hide(),
        ...
        jQuery.widget(
            ...
            jQuery.extend(
                ...
                this.element.get(0).selectedIndex > 0 ? "_right" : "_left";
                    ...
                    _toggle: function () {
                        this[
                            this.flipswitch.hasClass("ui-flipswitch-active")
                                ? "_left"
                                : "_right"
                        ]();
                    },
                    _keydown: function (e) {
                        if (e.which === jQuery.mobile.keyCode.LEFT) this._left();
                            ...
                            e.which === jQuery.mobile.keyCode.SPACE &&
                (this._toggle(), e.preventDefault());
                    ...
                    _setOptions: function (options) {
                        ...
                        options.onText !== void 0 && this.on.text(options.onText),
                        options.offText !== void 0 && this.off.text(options.offText),
                        options.disabled !== void 0 &&
                this.widget().toggleClass(
                    "ui-state-disabled",
                    options.disabled,
            ...
            jQuery.extend(
                {
                    ...
                    _create: function () {
                        var $el = this.element,
                            ...
                            _sliderWidgetFirst =
                jQuery.data(_inputFirst.get(0), "mobile-slider") ||
                jQuery.data(_inputFirst.slider().get(0), "mobile-slider"),
                            _sliderWidgetLast =
                jQuery.data(_inputLast.get(0), "mobile-slider") ||
                jQuery.data(_inputLast.slider().get(0), "mobile-slider"),
                ...
                ("last" === this._proxy && !first))
                            ...
                            return (
                                ...
                                jQuery.data(otherSlider.get(0), "mobile-slider").refresh(event),
                                !1
                            );
                    },
                    ...
                    _slidebeforestart: function (event) {
                        (this._sliderTarget = !1),
                        jQuery(event.originalEvent.target).hasClass("ui-slider-track") &&
                ((this._sliderTarget = !0),
                (this._targetVal = jQuery(event.target).val()));
                    },
                    _setOptions: function (options) {
                        options.theme !== void 0 && this._setTheme(options.theme),
                        options.trackTheme !== void 0 &&
              ...
              (this.options.disabled = !0),
                    ...
                    _change: function (event) {
                        ...
                        var self = this,
                            ...
                            first = jQuery(event.target).hasClass("ui-rangeslider-first"),
        ...
        jQuery.widget("mobile.textinput", jQuery.mobile.textinput, {
          ...
          this._timeout());
            ...
            _setOptions: function (options) {
                if (
                    (this._super(options), options.autogrow !== void 0 && this.isTextarea)
                ) {
            ...
            "select:not( :jqmData(role='slider')):not( :jqmData(role='flipswitch') )",
              ...
              (classes = " ui-btn-left"),
                ...
                (classes = " ui-btn-right"),
                        ...
                        (this.label = jQuery("label[for='" + this.selectId + "']")),
                        (this.isMultiple = this.select[0].multiple);
                    },
                    _destroy: function () {
                        var wrapper = this.element.parents(".ui-select");
                        wrapper.length > 0 &&
              (wrapper.is(".ui-btn-left, .ui-btn-right") &&
              ...
              wrapper.remove());
                ...
                button.addClass("ui-select-nativeonly"),
                        this.isMultiple &&
                (this.buttonCount = jQuery("<span>")
                    .addClass("ui-li-count ui-body-inherit")
                    .hide()
                    .appendTo(button.addClass("ui-li-has-count"))),
                        (options.disabled || this.element.attr("disabled")) &&
                this.disable(),
        ...
        (jQuery.mobile.links = function (target) {
            jQuery(target)
                .find("a")
                .jqmEnhanceable()
                ...
                .each(function () {
                    ...
                    idref &&
            (element.setAttribute("aria-haspopup", !0),
        ...
        (function ($, undefined) {
            ...
            jQuery.widget("mobile.popup", {
              ...
              jQuery.mobile.hashListeningEnabled),
                        ...
                        this._page.length === 0 && (this._page = jQuery("body")),
                    ...
                    this._on(this.window, {
                        orientationchange: jQuery.proxy(
                            this,
              ...
              ui.placeholder
                ...
                _resizeScreen: function () {
                    var screen = this._ui.screen,
                        popupHeight = this._ui.container.outerHeight(!0),
                ...
                _handleWindowKeyUp: function (theEvent) {
                    if (this._isOpen && theEvent.keyCode === jQuery.mobile.keyCode.ESCAPE)
              ...
              (this._orientationchangeInProgress = !1));
                        ...
                        (this._resizeData = null), (this._orientationchangeInProgress = !1);
                },
            ...
            (this._orientationchangeInProgress = !0));
                ...
                _handleDocumentFocusIn: function (theEvent) {
                    ...
                    if (targetElement !== ui.container[0]) {
                        if (
                            ...
                            return (
                                jQuery(this.document[0].activeElement).one(
                                    "focus",
                                    function () {
                                        target.blur();
                                    },
              ...
              this._isOpen && screen.addClass("in")),
                ...
                _setTolerance: function (value) {
                    ...
                    if (void 0 !== value)
                        ...
                        case 2:
                            ...
                            isNaN(ar[1]) || (tol.l = tol.r = ar[1]);
                            break;
                        case 4:
                            isNaN(ar[0]) || (tol.t = ar[0]),
                            isNaN(ar[1]) || (tol.r = ar[1]),
                            isNaN(ar[2]) || (tol.b = ar[2]),
                            isNaN(ar[3]) || (tol.l = ar[3]);
                            break;
                        default:
                            break;
                        }
                    ...
                    if (
                        ...
                        if (
                            ...
                            this._ui.container
                                ...
                                .removeClass(args.classToRemove)
                                .animationComplete(
                                    jQuery.proxy(args.prerequisites.container, "resolve"),
                                );
                            return;
                        }
                    }
              ...
              (y = windowCoordinates.cy / 2 + windowCoordinates.y),
                ...
                _reposition: function (openOptions) {
                    ...
                    this._trigger("beforeposition", void 0, openOptions),
              ...
              this.document
                ...
                _open: function (options) {
                    var openOptions = jQuery.extend({}, this.options, options),
                ...
                !chromematch
                    ...
                    this._createPrerequisites(
                        jQuery.noop,
                        jQuery.noop,
                        jQuery.proxy(this, "_openPrerequisitesComplete"),
                    ),
              ...
              this.element.closest(".ui-page").addClass("ui-popup-open"),
                ...
                _closePrerequisitesDone: function () {
                    ...
                    (jQuery.mobile.popup.active = void 0),
                    jQuery(":focus", container[0]).add(container[0]).blur(),
                    id &&
              this.document
                  .find("[aria-haspopup='true'][aria-owns='" + id + "']")
                ...
                _close: function (immediate) {
                    ...
                    (this._isOpen = !1),
                    this._createPrerequisites(
                        jQuery.proxy(this, "_closePrerequisiteScreen"),
                        jQuery.proxy(this, "_closePrerequisiteContainer"),
                        jQuery.proxy(this, "_closePrerequisitesDone"),
                    ),
                    this._animate({
                ...
                _destroy: function () {
                    if (jQuery.mobile.popup.active === this)
                        this.element.one(
                            "popupafterclose",
                            jQuery.proxy(this, "_unenhance"),
                        ),
                        this.close();
            ...
            jQuery.mobile.popup.active !== this
                    ...
                    if (
                        ...
                        if (
                            ((parsedDst = jQuery.mobile.path.parseUrl(parsedDst)),
                            (toUrl = parsedDst.pathname + parsedDst.search + parsedDst.hash),
                            this._myUrl !== jQuery.mobile.path.makeUrlAbsolute(toUrl))
                        )
                            immediate = !0;
                ...
                open: function (options) {
                    var url,
                        ...
                        self = this,
                        currentOptions = this.options;
                    if (jQuery.mobile.popup.active || currentOptions.disabled)
                        return this;
                    if (
                        ((jQuery.mobile.popup.active = this),
                    ...
                    if (
                        ...
                        (currentIsDialog = jQuery.mobile.activePage
                            ? jQuery.mobile.activePage.hasClass("ui-dialog")
                            : !1),
              ...
              jQuery.mobile.navigate.history.activeIndex > 0)
                        ...
                        return self._open(options), self._bindContainerClose(), this;
                    if (
                        url.indexOf(jQuery.mobile.dialogHashKey) === -1 &&
            !currentIsDialog
                    )
              ...
              url.indexOf("#") > -1
                  ...
                  : "#" + jQuery.mobile.dialogHashKey;
                        ...
                        url =
              jQuery.mobile.path.parseLocation().hash +
              jQuery.mobile.dialogHashKey;
                    return (
                        jQuery.mobile.navigate.history.activeIndex === 0 &&
              url === jQuery.mobile.navigate.history.initialDst &&
              (url += jQuery.mobile.dialogHashKey),
                ...
                close: function () {
                    ...
                    if (
                        ...
                        jQuery.mobile.back(), (this.urlAltered = !1);
            ...
            jQuery.mobile.document.on(
                "pagebeforechange",
                function (theEvent, data) {
                    data.options.role === "popup" &&
              (jQuery.mobile.popup.handleLink(data.options.link),
              theEvent.preventDefault());
                },
            );
        })(jQuery),
          ...
          adjacent.find("a").first().focus());
                ...
                event.keyCode === jQuery.mobile.keyCode.SPACE))
                        ...
                        if ((this._decideFormat(), "overlay" === this.menuType))
                            ...
                            this.button
                                ...
                                .attr("data-" + (jQuery.mobile.ns || "") + "rel", "dialog");
                        this.isOpen = !0;
                    }
                },
            ...
            "focusin" === e.type
              ...
              o.dividerTheme && this.element[0].multiple
                ...
                "'></div>",
                        ...
                        (headerTitle = jQuery("<h1 class='ui-title'></h1>").appendTo(
                            header,
                        )),
                        this.isMultiple &&
              (headerClose = jQuery("<a>", {
                  role: "button",
                  text: o.closeText,
                  href: "#",
                  class:
                ...
                this.select[0].getAttribute("tabindex") === null
                        ...
                        this.list.delegate(
                            ...
                            function (event) {
                                var oldIndex = self.select[0].selectedIndex,
                                    newIndex = jQuery.mobile.getAttribute(this, "option-index"),
                    ...
                    jQuery(this)
                        ...
                        .toggleClass("ui-checkbox-off", !option.selected),
                                    (self.isMultiple || newIndex !== oldIndex) &&
              ...
              this._on(this.headerClose, {
                ...
                _isRebuildRequired: function () {
                    return (
                        this._selectOptions().not(".ui-screen-hidden").text() !==
            list.text()
                    );
                },
                selected: function () {
                    ...
                    self.list
                        ...
                        .each(function (i) {
                            if (jQuery.inArray(i, indices) > -1) {
                                ...
                                if ((item.attr("aria-selected", !0), self.isMultiple))
                                    item
                                        .find("a")
                                        .removeClass("ui-checkbox-off")
                                        .addClass("ui-checkbox-on");
                                else if (item.hasClass("ui-screen-hidden"))
                                    item
                                        .next()
                                        .find("a")
                                        .addClass(jQuery.mobile.activeBtnClass);
            ...
            (selector = this.list.find(
                ...
                _decideFormat: function () {
                    ...
                    if (menuHeight > screenHeight - 80 || !jQuery.support.scrollTop)
                        self.menuPage.appendTo(jQuery.mobile.pageContainer).page(),
                ...
                _buildList: function () {
                    ...
                    for (
                        ...
                        if (
                            ...
                            $option.hasClass("ui-screen-hidden"))
                        )
                            continue;
                        option.parentNode,
                        (text = $option.text()),
                ...
                optGroup !== optLabel &&
                  ((divider = document.createElement("li")),
                  divider.setAttribute(dataPrefix + "role", "list-divider"),
                ...
                option.setAttribute(dataPlaceholderAttr, !0),
                ...
                item.setAttribute("aria-disabled", !0)),
                        ...
                        item.setAttribute(dataPrefix + "icon", "false"),
                        isPlaceholderItem && item.setAttribute(dataPlaceholderAttr, !0),
        ...
        (function ($, undefined) {
            ...
            function optionsToClasses(options, existingClasses) {
                ...
                return (
                    classes.push("ui-btn"),
                    options.theme && classes.push("ui-btn-" + options.theme),
                    options.icon &&
            ((classes = classes.concat([
                "ui-icon-" + options.icon,
                "ui-btn-icon-" + options.iconpos,
            ])),
            options.iconshadow && classes.push("ui-shadow-icon")),
                    options.inline && classes.push("ui-btn-inline"),
                    options.shadow && classes.push("ui-shadow"),
                    options.corners && classes.push("ui-corner-all"),
                    options.mini && classes.push("ui-mini"),
                    classes
                );
            ...
            (jQuery.fn.buttonMarkup = function (options, overwriteClasses) {
                ...
                (retrievedOptions[optionKey] = (function () {
                    ...
                    (el.className = optionsToClasses(
                        jQuery.extend({}, defaults, retrievedOptions),
                        data.unknownClasses,
                    ).join(" ")),
            ...
            jQuery.extend(
                {
                    ...
                    _create: function () {
                        ...
                        if (
                            (jQuery.fn.buttonMarkup &&
                this.element
                    .find(jQuery.fn.buttonMarkup.initSelector)
                    .buttonMarkup(),
                            jQuery.each(
                                this._childWidgets,
                                jQuery.proxy(function (number, widgetName) {
                                    jQuery.mobile[widgetName] &&
                    this.element
                        .find(jQuery.mobile[widgetName].initSelector)
                        .not(jQuery.mobile.page.prototype.keepNativeSelector())
                        [widgetName]();
                                }, this),
                            ),
              ...
              $el.find(":mobile-checkboxradio").checkboxradio("refresh"),
                    ...
                    this._themeClassFromOption(opts.theme),
                        ...
                        this._ui.childWrapper.children().unwrap();
                    },
                },
                jQuery.mobile.behaviors.addFirstLastClasses,
            ),
        ),
        jQuery.widget("mobile.toolbar", {
          ...
          this._on(this.document, {
              pageshow: "refresh",
                ...
                this.element
                    .attr("role", "header" === role ? "banner" : "contentinfo")
                    .addClass("ui-" + role),
                this.refresh(),
            ...
            _btnMarkup: function () {
                this.element
                    .children("a")
                    .filter(":not([data-" + jQuery.mobile.ns + "role='none'])")
                    .attr("data-" + jQuery.mobile.ns + "role", "button"),
            ...
            _addHeaderButtonClasses: function () {
                ...
                (this.leftbtn =
            this.leftbtn ||
            $headeranchors.eq(0).not(".ui-btn-right").addClass("ui-btn-left")
                .length),
                (this.rightbtn =
            this.rightbtn ||
        ...
        jQuery.widget("mobile.toolbar", jQuery.mobile.toolbar, {
          ...
          "a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed, .ui-flipswitch, .ui-popup, .ui-panel, .ui-panel-dismiss-open",
            ...
            this._makeFixed(),
                    ...
                    var $page = !!this.page
                        ? this.page
                        : jQuery(".ui-page-active").length > 0
          ...
          this.element.addClass(tclass));
            ...
            _handlePageBeforeShow: function () {
                var o = this.options;
                o.disablePageZoom && jQuery.mobile.zoom.disable(!0),
                o.visibleOnPageShow || this.hide(!0);
            },
          ...
          this.updatePagePadding(!!this.page ? this.page : ".ui-page-active");
            ...
            _handlePageBeforeHide: function (e, ui) {
                var o = this.options,
                    ...
                    nextFooter,
                    nextHeader;
                o.disablePageZoom && jQuery.mobile.zoom.enable(!0),
                o.updatePagePadding && this._off(this.window, "throttledresize"),
                o.trackPersistentToolbars &&
            ((thisFooter = jQuery(".ui-footer-fixed:jqmData(id)", this.page)),
            (thisHeader = jQuery(".ui-header-fixed:jqmData(id)", this.page)),
            (nextFooter =
              (thisFooter.length &&
                ui.nextPage &&
                jQuery(
            ...
            (nextFooter.length || nextHeader.length) &&
              (nextFooter.add(nextHeader).appendTo(jQuery.mobile.pageContainer),
            ...
            _useTransition: function (notransition) {
                var $win = this.window,
                    ...
                    pHeight = !!this.page
                        ...
                        : jQuery(".ui-page-active").height(),
                    viewportHeight = jQuery.mobile.getScreenHeight();
                return (
                    !notransition &&
          ((this.options.transition &&
            ...
            _bindToggleHandlers: function () {
                (!!this.page ? this.page : jQuery(".ui-page"))
                    .bind("vclick", function (e) {
                        o.tapToggle &&
              !jQuery(e.target).closest(o.tapToggleBlacklist).length &&
              self.toggle();
                    })
        ...
        jQuery.widget("mobile.toolbar", jQuery.mobile.toolbar, {
          ...
          platform.indexOf("iPod") > -1
                ...
                if ("ios" === os) self._bindScrollWorkaround();
                    ...
                    self._bindScrollWorkaround(), self._bindListThumbWorkaround();
                else return;
            },
            ...
            _triggerRedraw: function () {
                var paddingBottom = parseFloat(
                    jQuery(".ui-page-active").css("padding-bottom"),
                );
                jQuery(".ui-page-active").css(
                    "padding-bottom",
                    paddingBottom + 1 + "px",
                ),
                setTimeout(function () {
        ...
        jQuery.mobile.browser.oldIE && jQuery.mobile.browser.oldIE <= 8;
            ...
            jQuery.widget("mobile.popup", jQuery.mobile.popup, {
              ...
              (best = {
                ...
                _placementCoords: function (desired) {
                    ...
                    if (
                        ...
                        return ar.arEls.hide(), this._super(desired);
                    return (
                        ar.ct
                            .removeClass(
                ...
                _setOptions: function (opts) {
                    ...
                    if ((this._ui.arrow, opts.arrow !== void 0)) {
                        if (!this._ui.arrow && opts.arrow) {
                            ...
                            this._ui.arrow &&
                !opts.arrow &&
                (this._ui.arrow.arEls.remove(), (this._ui.arrow = null));
                    }
                    return (
                        this._ui.arrow,
                        this._ui.arrow &&
              (opts.theme !== void 0 &&
                ...
                this._ui.arrow.ar.removeClass(oldTheme).addClass(newTheme)),
              opts.shadow !== void 0 &&
        ...
        jQuery.widget("mobile.panel", {
          ...
          this._openedPage ||
          this._parentPage ||
          jQuery("." + jQuery.mobile.activePageClass);
                return page;
            },
          ...
          (wrapper = this._page()
            ...
            _getFixedToolbars: function () {
                var extFixedToolbars = jQuery("body").children(
          ...
          (this.options.theme ? this.options.theme : "inherit");
            ...
            _positionPanel: function (scrollToTop) {
                var self = this,
                    ...
                    expand = panelInnerHeight > jQuery.mobile.getScreenHeight();
                if (expand || !self.options.positionFixed)
                    expand &&
            (self._unfixPanel(),
            jQuery.mobile.resetActivePageHeight(panelInnerHeight)),
                    scrollToTop &&
              this.window[0].scrollTo(0, jQuery.mobile.defaultHomeScroll);
                else self._fixPanel();
            },
          ...
          void 0 !== panelId
                    ...
                    return (
                        ...
                        link.hasClass("ui-btn") &&
              (link.addClass(jQuery.mobile.activeBtnClass),
          ...
          otherPanels.not(".ui-panel-display-overlay").not(this.element)
              .length === 0 && this._wrapper.children().unwrap(),
          this._open &&
            ...
            o.theme &&
              this._page()
                ...
                multiplePanels || this.document.off("panelopen panelclose"),
          ...
          this.element.addClass(this.options.classes.table),
            ...
            _setHeaders: function () {
                ...
                (this.allHeaders = this.headers.add(
                    this.element.find("thead tr").children(),
                ));
            },
            refresh: function () {
                this._refresh();
        ...
        jQuery.widget("mobile.table", jQuery.mobile.table, {
            ...
            _addToggles: function (menu, keep) {
                ...
                this.headers.not("td").each(function () {
                    var header = jQuery(this),
                        priority = jQuery.mobile.getAttribute(this, "priority"),
            ...
            _menuInputChange: function (evt) {
                ...
                if (
                    ...
                    input[0].getAttribute("locked"))
                )
                    input.removeAttr("locked"), this._unlockCells(input.jqmData("cells"));
            ...
            _enhanceColToggle: function () {
              ...
              "</a>",
                    ...
                    (menu = jQuery("<fieldset></fieldset>").controlgroup()),
                    this._addToggles(menu, !1),
                    menu.appendTo(popup),
            ...
            rebuild: function () {
                this._super(),
                this.options.mode === "columntoggle" && this._refresh(!1);
            },
            _refresh: function (create) {
                this._super(create),
                create ||
          ...
          this._updateReflow());
            ...
            _updateReflow: function () {
                ...
                jQuery(table.allHeaders.get().reverse()).each(function () {
                    var cells = jQuery(this).jqmData("cells"),
                        colstart = jQuery.mobile.getAttribute(this, "colstart"),
                        hierarchyClass =
        ...
        (function ($, undefined) {
            var defaultFilterCallback = function (index, searchValue) {
                return (
                    (
                        "" +
            (jQuery.mobile.getAttribute(this, "filtertext") ||
              jQuery(this).text())
                    )
                        .toLowerCase()
                ...
                _onKeyUp: function () {
                    ...
                    if (search) {
                        if (
                            ...
                            (lastval = jQuery.mobile.getAttribute(search[0], "lastval") + ""),
                            lastval && lastval === val)
                        )
                            return;
                        this._timer &&
              (window.clearTimeout(this._timer), (this._timer = 0)),
                ...
                _filterItems: function (val) {
                    ...
                    if (0 === hide.length)
                        ...
                        jQuery(hide).addClass("ui-screen-hidden"),
                        jQuery(show).removeClass("ui-screen-hidden");
                ...
                widget &&
                  jQuery.isFunction(widget.refresh) &&
                  widget.refresh());
                },
                _setInput: function (selector) {
                    var search = this._search;
                    this._timer && (window.clearTimeout(this._timer), (this._timer = 0)),
                    search &&
              (this._off(search, "keyup change input"), (search = null)),
                    selector &&
            ...
            options.children !== void 0;
              ...
              (this._setInput(options.input), (refilter = !0)),
          ...
          jQuery.mobile.filterable.prototype.options.filterCallback.call(
            ...
            jQuery.widget("mobile.filterable", jQuery.mobile.filterable, {
              ...
              this._widget._trigger("beforefilter", event, data),
                ...
                widget &&
                ((this._widget = widget),
                (this._widget._setOptions = (function (self, orig) {
              ...
              this._search.jqmData("ui-filterable-" + this.uuid + "-internal")
                ...
                _setInput: function (selector) {
                    ...
                    "'></input>",
                        ).jqmData("ui-filterable-" + this.uuid + "-internal", !0)),
                        jQuery("<form class='ui-filterable'></form>")
                            .append(selector)
                            .submit(function (evt) {
                ...
                _syncTextInputOptions: function (options) {
                    ...
                    if (this._isSearchInternal() && jQuery.mobile.textinput) {
                        for (idx in jQuery.mobile.textinput.prototype.options)
                            if (options[idx] !== void 0) {
                                if ("theme" === idx && this.options.filterTheme != null)
        ...
        (function ($, undefined) {
          ...
          decodeURIComponent(anchor.href.replace(rhash, "")) ===
                    ...
                    if (
                        ...
                        this.element
                            ...
                            .delegate(
                                ...
                                function (event) {
                                    jQuery(this).is(".ui-state-disabled") &&
                    event.preventDefault();
                                },
                            )
                            .delegate(
                                ...
                                function () {
                                    jQuery(this).closest("li").is(".ui-state-disabled") &&
                    this.blur();
                                },
                            ),
                        this._processTabs(),
                        (options.active = this._initialActive()),
                        jQuery.isArray(options.disabled) &&
              (options.disabled = jQuery
                  .unique(
            ...
            (event.preventDefault(), this.active.focus());
                },
                ...
                _findNextTab: function (index, goingForward) {
                    ...
                    for (; jQuery.inArray(constrain(), this.options.disabled) !== -1; )
            ...
            !jQuery.contains(this.tablist[0], this.active[0])
                        ...
                        if (this.tabs.length === options.disabled.length)
                            ...
                            this._activate(
                                this._findNextTab(Math.max(0, options.active - 1), !1),
                            );
                ...
                _setupDisabled: function (disabled) {
                    ...
                    for (var i = 0, li; (li = this.tabs[i]); i++)
                        if (!0 === disabled || jQuery.inArray(i, disabled) !== -1)
                            jQuery(li)
            ...
            jQuery.each(event.split(" "), function (index, eventName) {
              ...
              this._trigger("beforeActivate", event, eventData) === !1)
                    )
                        return;
              ...
              this.tabs
                ...
                _activate: function (index) {
                    var anchor;
                    if ((this._findActive(index), this.active[0] == this.active[0]))
                        return;
                    this.active.length || this.active,
                    (anchor = this.active.find(".ui-tabs-anchor")[0]),
                    this._eventHandler({
                        target: anchor,
              ...
              this.panels.css("height", "");
                ...
                enable: function (index) {
                    ...
                    else if (((index = this._getIndex(index)), jQuery.isArray(disabled)))
                ...
                disable: function (index) {
                    ...
                    if (void 0 === index) disabled = !0;
                        ...
                        if (
                            ...
                            jQuery.inArray(index, disabled) !== -1)
                        )
                            return;
                        if (jQuery.isArray(disabled))
                ...
                load: function (index, event) {
                    ...
                    (this.xhr = jQuery.ajax(
                        this._ajaxSettings(anchor, event, eventData),
                    )),
                    this.xhr &&
        ...
        !(function ($, window1, undefined) {
            var $html = jQuery("html"),
                $window = jQuery.mobile.window;
            function hideRenderingClass() {
                $html.removeClass("ui-mobile-rendering");
            }
            if (
                (jQuery(window1.document).trigger("mobileinit"),
            ...
            jQuery.extend(jQuery.mobile, {
                initializePage: function () {
                    var path = jQuery.mobile.path,
                        $pages = jQuery(":jqmData(role='page'), :jqmData(role='dialog')"),
                        hash = path.stripHash(
                ...
                ($pages = jQuery("body")
                  ...
                  $this.attr(
                      ...
                      $this.attr("id") || location.pathname + location.search,
                        ...
                        (jQuery.mobile.firstPage = $pages.first()),
                        (jQuery.mobile.pageContainer = jQuery.mobile.firstPage
                            .parent()
                            .addClass("ui-mobile-viewport")
                            .pagecontainer()),
                        jQuery.mobile.navreadyDeferred.resolve(),
                ...
                !(
                  ...
                  hash === jQuery.mobile.dialogHashKey
                ))
                    )
                        jQuery.mobile.path.isHashValid(location.hash) &&
                (jQuery.mobile.navigate.history.initialDst = hash.replace(
                    "#",
                    "",
                )),
                        jQuery.event.special.navigate.isPushStateEnabled() &&
                  jQuery.mobile.navigate.navigator.squash(
                      path.parseLocation().href,
                  ),
                        jQuery.mobile.changePage(jQuery.mobile.firstPage, {
                            transition: "none",
                            reverse: !0,
                            changeHash: !1,
                            fromHashChange: !0,
                        });
                    else if (!jQuery.event.special.navigate.isPushStateEnabled())
                        $window.trigger("hashchange", [!0]);
                    else
            ...
            jQuery(function () {
              ...
              jQuery.mobile.window.scrollTop() === 1
                ...
                jQuery.mobile.hideUrlBar &&
              $window.load(jQuery.mobile.silentScroll),
                jQuery.support.cssPointerEvents ||
              jQuery.mobile.document.delegate(
