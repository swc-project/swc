(function () {
        ...
        _.each(
            ...
            function (method) {
                Model.prototype[method] = function () {
                    ...
                    return (
                        args.unshift(this.attributes), _[method].apply(_, args)
                    );
                };
            }
        );
    ...
    _.extend(Collection.prototype, Events, {
        ...
        remove: function (models, options) {
            ...
            for (i = 0; i < models.length; i++) {
                if (((model = models[i] = this.get(models[i])), !model))
                    continue;
            ...
            for (i = 0, l = models.length; l > i; i++) {
                ...
                if ((existing = this.get(id)))
                    remove && (modelMap[existing.cid] = !0),
                        merge &&
                            ((attrs =
                                attrs === model ? model.attributes : attrs),
                            options.parse &&
    ...
    var History1 = (Backbone.History = function () {
        ...
        pathStripper = /[?#].*$/;
    (History1.started = !1),
        _.extend(History1.prototype, Events, {
            interval: 50,
            ...
            navigate: function (fragment, options) {
                ...
                var url =
                    this.root + (fragment = this.getFragment(fragment || ""));
                if (
