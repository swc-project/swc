    ...
    (proto = {
        ...
        _setup: function (
            ...
            for (i = 0; i < extras.length; i++)
                YUI.Env.mods[extras[i]] && core.push(
                    extras[i]
                );
            Y._attach(
                ["yui-base",]
        ...
        _attach: function (
            ...
            for (i = 0, len = (r = c).length; i < len; i++)
                if (!done[r[i]]) {
                    if (
                        ((mod = mods[(name = r[i])]), (aliases && aliases[name]) || mod)
                    ) {
                        Y._attach(
                            aliases[name]
                        );
        ...
        _use: function (
            ...
            return (
                ((mods.loader || mods["loader-base"] || Y.Loader) &&
          Y._attach(
    ...
    function (
            ...
            abort: function (
                ...
                if (!transaction.abort) {
                    if (
                        ...
                        (transaction = null),
                        pending && pending.transaction.id === id)
                    )
        ...
        (Transaction.prototype = {
            ...
            _finish: function (
                ...
                if ("done" !== this._state) {
                    for (
                        i = 0, this._state = "done", len = this._callbacks.length;
                        i < len;
                        ++i
                    )
            ...
            _getInsertBefore: function (
                ...
                return el
                    ? "string" == typeof el
                        ...
                        : el
                    : (Get._insertCache,
                    (el = Get._insertCache[(docStamp = Y.stamp(
                        doc
                    ))]))
                        ? el
                        : (el = doc.getElementsByTagName(
                            ...
                            : (el = doc.head || doc.getElementsByTagName(
                                ...
                                (Get._insertCache[docStamp] = el.lastChild))
                                : (Get._insertCache[docStamp] = doc.getElementsByTagName(
                                    "script",
                                )[0]);
            },
            _insert: function (
            ...
            _poll: function (
              ...
              !self._pollTimer)
                    ...
                    for (i = 0, self._pollTimer = null; i < pendingCSS.length; ++i)
    ...
    function (
        ...
        (INSTANCE.log = function (
            ...
            bail ||
              ...
              (publisher || silent) &&
                ((publisher === Y || publisher.getEvent(
                    LOGEVENT
                )) &&
                  publisher.publish(
                      LOGEVENT,
    ...
    function (
        ...
        (Y.Loader.prototype = {
            ...
            _requires: function (
                ...
                if (!m && other) return !1;
                if (
                    (m.expanded_map, (after_map = m.after_map) && mod2 in after_map)
                )
                    return !0;
                ...
                return (
                    (!!m.expanded_map && mod2 in m.expanded_map) ||
            ...
            _config: function (
                ...
                ((self.filterName = f = f.toUpperCase(
                )),
            ...
            addModule: function (
              ...
              (g = this.groups[o.group]).requires
                ...
                if (o.submodules) {
                    for (i in ((sup = o.supersedes || []), (l = 0), o.submodules))
                        if (o.submodules.hasOwnProperty(
                            i
                        )) {
                            if (
                                (((s = o.submodules[i]).path =
                      s.path || _path(
                          name,
                          i,
                          o.type
                ...
                if (o.plugins)
                    for (i in o.plugins)
                        o.plugins.hasOwnProperty(
                            i
                        ) &&
                  (((plug = o.plugins[i]).pkg = name),
            ...
            getRequires: function (
                ...
                if (o && this.loadOptional)
                  ...
                  (d.push(
                      o[i]
                  ), (hash[o[i]] = !0), (m = this.moduleInfo[o[i]]))
                        )
                            for (
                                j = 0,
                                add = this.getRequires(
            ...
            _explode: function (
                ...
                var m,
                    ...
                    self = this;
                for (name in (this.required,
                (self.dirty = !1),
                self._explodeRollups(
                ),
                self.required,
                self.required))
                    self.required.hasOwnProperty(
                        name
                    ) &&
                (done[name] ||
                  ((done[name] = !0),
                  (m = self.getModule(
                    ...
                    ((expound = m.expound) &&
                      ((self.required[expound] = self.getModule(
                          expound
                      )),
                      (reqs = self.getRequires(
                          self.required[expound]
                      )),
                      Y.mix(
                          self.required,
                          yArray.hash(
            ...
            getModule: function (
                ...
                return (
                    m
                        ? ((found && m && found.configFn) || m.configFn) &&
