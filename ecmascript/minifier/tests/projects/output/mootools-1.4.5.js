!(function (
    ...
    (Function1.prototype.overloadSetter = function (
        usePlural
    ) {
        var self = this;
        return function (
    ...
    (Function1.prototype.overloadGetter = function (
        usePlural
    ) {
        var self = this;
        return function (
    ...
    (Function1.prototype.extend = function (
        key, value
    ) {
        this[key] = value;
    }.overloadSetter(
    )),
    (Function1.prototype.implement = function (
        key, value
    ) {
...
function (
    ...
    (local.setDocument = function (
        ...
        var id = "slick_uniqueid",
            ...
            testRoot =
            document.body || document.getElementsByTagName(
                "body"
            )[0] || root;
                ...
                (this.idGetsName &&
                  ...
                  item.getAttributeNode(
                    ...
                    if (!item) {
                        ...
                        break getById;
                    } else if (this.document !== node && !this.contains(
                        node,
                        item
                    ))
                        return;
...
(function (
    ...
    [Element1, Window, Document,].invoke(
        "implement",
        {
    ...
    "s" != null.firstChild.value &&
        (Element1.Properties.value = {
            set: function (
                ...
                if ("select" != tag) return this.setProperty(
                    "value",
                    value
                );
                for (
    ...
    Element1.implement(
        {
            getComputedStyle: function (
                ...
                var defaultView = Element1.getDocument(
                        this
                    ).defaultView,
            ...
            custom.base &&
              ...
              delete attached[events]);
                ...
                cloneEvents: function (
                    ...
                    if (!type)
                        for (var eventType in events) this.cloneEvents(
                            from,
                            eventType
                        );
                    else
...
[Window, Document, Element1,].invoke(
    "implement",
    {
        getHeight: function (
        ) {
...
(function (
    ...
    (Element1.Events.load = {
        ...
        condition: function (
            ...
            return (
                this == window && (domready(
                ), delete Element1.Events.load), !0
            );
        },
    }),
    window.addEvent(
