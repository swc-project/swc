    ...
    function (
      ...
      error(
        ...
        function describeNativeComponentFrame(
            ...
            try {
                ...
                (reentry = !1),
                (ReactCurrentDispatcher$1.current = ReactCurrentDispatcher$1.current),
                reenableLogs(
                ),
      ...
      "object" == typeof performance && "function" == typeof performance.now;
        ...
        function pop(
            ...
            return last !== first && ((heap[0] = last), siftDown(
                heap,
                last,
                0
            )), first;
        ...
        ((isHostTimeoutScheduled = !1), cancelHostTimeout(
            ...
            (isPerformingWork = !0);
            try {
                if (!enableProfiling) return workLoop(
                    hasTimeRemaining,
                    initialTime
                );
                try {
        ...
        function workLoop(
            ...
            for (
                ...
                null !== currentTask && !enableSchedulerDebugging;
        ...
        for (var fnName in ((ReactDebugCurrentFrame.setExtraStackFrame = function (
            stack,
        ) {
            currentExtraStackFrame = stack;
        }),
