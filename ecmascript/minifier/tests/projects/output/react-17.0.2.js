!function(global, factory) {
    ...
    function describeNativeComponentFrame(fn, construct) {
        ...
        Error.prepareStackTrace = void 0, ReactCurrentDispatcher$1.current, ReactCurrentDispatcher$1.current = null, disableLogs();
        try {
            if (construct) {
                var Fake = function() {
                    throw Error();
            ...
            reentry = !1, ReactCurrentDispatcher$1.current = ReactCurrentDispatcher$1.current, reenableLogs(), Error.prepareStackTrace = previousPrepareStackTrace;
        }
    ...
    function siftDown(heap, node, i) {
        for(var index = i, length = heap.length; index < length;){
            ...
            if (void 0 !== left && 0 > compare(left, node)) void 0 !== right && 0 > compare(right, left) ? (heap[index] = right, heap[rightIndex] = node, index = rightIndex) : (heap[index] = left, heap[leftIndex] = node, index = leftIndex);
            else {
                if (!(void 0 !== right && 0 > compare(right, node))) return;
