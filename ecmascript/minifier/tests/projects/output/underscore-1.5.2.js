(function() {
    var root = this, previousUnderscore = root._, breaker = {
        }, ArrayProto = Array.prototype, ObjProto = Object.prototype, FuncProto = Function.prototype, push = ArrayProto.push, slice = ArrayProto.slice, concat = ArrayProto.concat, toString = ObjProto.toString, nativeForEach = ArrayProto.forEach, nativeMap = ArrayProto.map, nativeReduce = ArrayProto.reduce, nativeReduceRight = ArrayProto.reduceRight, nativeFilter = ArrayProto.filter, nativeEvery = ArrayProto.every, nativeSome = ArrayProto.some, nativeIndexOf = ArrayProto.indexOf, nativeLastIndexOf = ArrayProto.lastIndexOf, nativeIsArray = Array.isArray, nativeKeys = Object.keys, nativeBind = FuncProto.bind, _ = function(obj) {
            if (obj instanceof _) return obj;
            if (!(this instanceof _)) return new _(obj);
            this._wrapped = obj;
        };
    if ('undefined' !== typeof exports) 'undefined' !== typeof module && module.exports && (exports = module.exports = _), exports._ = _;
    else root._ = _;
    _.VERSION = '1.5.2';
    var each = _.each = _.forEach = function(obj, iterator, context) {
        if (null == obj) return;
        if (nativeForEach && obj.forEach === nativeForEach) obj.forEach(iterator, context);
        else if (obj.length === +obj.length) for(var i = 0, length = obj.length; length > i; i++)if (iterator.call(context, obj[i], i, obj) === breaker) return;
    ...
    _.map = _.collect = function(obj, iterator, context) {
        ...
        if (each(obj, function(value, index, list) {
            if (index = keys ? keys[--length] : --length, !initial) memo = obj[index], initial = !0;
    ...
    _.sortBy = function(obj, value, context) {
        return _.pluck(_.map(obj, function(value1, index, list) {
            return {
                value: value1,
                index: index,
    ...
    var group = function(behavior) {
        return function(obj, value, context) {
            ...
            return each(obj, function(value1, index) {
                var key = (null == value ? _.identity : lookupIterator(value)).call(context, value1, index, obj);
    ...
    var flatten = function(input, shallow, output) {
        ...
        return each(input, function(value) {
            if (_.isArray(value) || _.isArguments(value)) shallow ? push.apply(output, value) : flatten(value, shallow, output);
    ...
    _.flatten = function(array, shallow) {
        ...
        for(var result = {
            }, i = 0, length = list.length; length > i; i++)if (values) result[list[i]] = values[i];
    ...
    _.bind = function(func, context) {
        ...
        return function() {
            return func.apply(this, slice.call(arguments, 1).concat(slice.call(arguments)));
        };
        ...
        return options || (options = {
            ...
            if (context = this, args = arguments, 0 >= remaining) clearTimeout(timeout), timeout = null, previous = now, result = func.apply(context, args);
            else timeout || options.trailing === !1 || (timeout = setTimeout(function() {
        ...
        return function() {
            ...
            var later = function() {
                    ...
                    else timeout = null, !immediate && (result = func.apply(context, args));
        ...
        return function() {
            if (ran) return memo;
            return ran = !0, memo = func.apply(this, arguments), func = null, memo;
        };
        ...
        for(var result = {
            }, keys = _.keys(obj), i = 0, length = keys.length; length > i; i++)result[obj[keys[i]]] = keys[i];
        return result;
    ...
    var eq = function(a, b, aStack, bStack) {
        ...
        if ('[object Array]' == className) {
            if (size = a.length, result = size == b.length) for(; size--;)if (!(result = eq(a[size], b[size], aStack, bStack))) break;
        } else {
            for(var key in a)if (_.has(a, key)) {
                if (size++, !(result = _.has(b, key) && eq(a[key], b[key], aStack, bStack))) break;
            }
            if (result) {
    ...
    _.isEqual = function(a, b) {
        ...
        return !0 === obj || !1 === obj || toString.call(obj) == '[object Boolean]';
        ...
        return null == max && (max = min, min = 0), 0 + Math.floor(Math.random() * (max - 0 + 1));
    };
    var entityMap = {
        escape: {
            '&': '&amp;',
    ...
    entityMap.unescape = _.invert(entityMap.escape), _.each(['escape', 'unescape'], function(method) {
        ...
        each(_.functions(obj), function(name) {
            _.prototype[name] = function() {
                ...
                return push.apply(args, arguments), result.call(this, (_[name] = obj[name]).apply(_, args));
            };
        });
    };
    var idCounter = 0;
    ...
    _.mixin(_), each(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function(name) {
        _.prototype[name] = function() {
            ...
            return ArrayProto[name].apply(obj, arguments), ('shift' == name || 'splice' == name) && obj.length === 0 && delete obj[0], result.call(this, obj);
        };
    }), each(['concat', 'join', 'slice'], function(name) {
        _.prototype[name] = function() {
            return result.call(this, ArrayProto[name].apply(this._wrapped, arguments));
        };
