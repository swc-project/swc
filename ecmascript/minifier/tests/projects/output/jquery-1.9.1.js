!(function (window, undefined) {
        ...
        init: function (selector, context, rootjQuery1) {
          ...
          selector.length >= 3
                ...
                if (match && (match[1] || !context)) {
                    ...
                    return (context || rootjQuery1).find(selector);
    ...
    jQuery.extend({
        ...
        ready: function (wait) {
            ...
            if (((jQuery.isReady = !0), !0 !== wait && --jQuery.readyWait > 0))
                return;
        ...
        each: function (obj, callback, args) {
            ...
            if (args) {
                if (isArray)
                    for (; length > i; i++)
                        if (((value = callback.apply(obj[i], args)), !1 === value)) break;
                        else
                            for (i in obj)
                                if (((value = callback.apply(obj[i], args)), !1 === value))
                                    break;
            } else if (isArray)
                for (; length > i; i++)
        ...
        inArray: function (elem, arr, i) {
            if (arr) {
                ...
                for (
                    i = i ? (0 > i ? Math.max(0, arr.length + i) : i) : 0;
                    i < arr.length;
                    i++
                )
    ...
    (jQuery.ready.promise = function (obj) {
        if (!readyList) {
            if (
                ((readyList = jQuery.Deferred()), document.readyState === "complete")
            )
    ...
    jQuery.fn.extend({
        queue: function (type, data) {
            ...
            return void 0 === data
                ...
                : this.each(function () {
                    ...
                    "fx" === type &&
                  jQuery.queue(this, type, data)[0] !== "inprogress" &&
        ...
        delay: function (time, type) {
            return (
                ...
                this.queue("fx", function (next, hooks) {
    ...
    jQuery.fn.extend({
        ...
        removeClass: function (value) {
            var classes,
                ...
                i = 0,
                len = this.length,
                proceed = arguments.length === 0 || ("string" == typeof value && value);
            if (jQuery.isFunction(value))
                return this.each(function (j) {
            ...
            return this.each(function () {
                if ("string" === type)
                    for (
                        ...
                        (className = (value.match(core_rnotwhite) || [])[i++]);

                    )
                        (state =
              "boolean" == typeof stateVal ? state : !self.hasClass(className)),
                ...
                get: function (elem) {
                    for (
                        var value,
                            ...
                            one = elem.type === "select-one" || 0 > index,
                            values = one ? null : [],
        ...
        removeAttr: function (elem, value) {
            ...
            if (attrNames && elem.nodeType === 1)
                for (; (name = attrNames[i++]); ) {
                    if (
                        ((propName = jQuery.propFix[name] || name), rboolean.test(name))
                    ) {
    ...
    (jQuery.event = {
                    ...
                    (handleObj = jQuery.extend(
                        {
                            ...
                            needsContext:
                handleObjIn.selector &&
                jQuery.expr.match.needsContext.test(handleObjIn.selector),
                    ...
                    if (
                        ...
                        !special.setup ||
              special.setup.call(null, data, namespaces, eventHandle) === !1)
                    ) {
                        if (null.addEventListener)
                            null.addEventListener(type, eventHandle, !1);
                        else null.attachEvent && null.attachEvent("on" + type, eventHandle);
                    }
                }
                if (
                    (special.add &&
            (special.add.call(null, handleObj),
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
          ...
          delete elemData.events[type]);
            ...
            jQuery.isEmptyObject(elemData.events) &&
        ...
        trigger: function (event, data, elem, onlyHandlers) {
          ...
          eventPath.push(tmp.defaultView || tmp.parentWindow || window);
            ...
            handle.apply &&
            handle.apply(cur, data) === !1 &&
            event.preventDefault();
            if (((event.type = type), !onlyHandlers && !event.isDefaultPrevented())) {
                if (
                    (!special._default ||
            special._default.apply(elem.ownerDocument, data) === !1) &&
    ...
    (function (window, undefined) {
            ...
            if (!documentIsXML && !seed) {
                if ((match = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/.exec(selector))) {
                    if ((m = match[1])) {
                        if (context.nodeType === 9) {
                            if (
                                ((elem = context.getElementById(m)), elem && elem.parentNode)
                            ) {
              ...
              context.getElementsByClassName
                ...
                context.nodeName.toLowerCase() !== "object")
                        ...
                        for (nid = "[id='" + nid + "'] ", i = groups.length; i--; )
            ...
            if (
                ...
                (support.getByClassName = assert(function (div) {
                  ...
                  !div.getElementsByClassName("e").length)
                    ...
                    return (
                        ...
                        div.getElementsByClassName("e").length === 2
                    );
                })),
                ...
                (Expr.filter.ID = function (id) {
                    return function (elem) {
                        return (
                            elem.getAttribute("id") === id.replace(runescape, funescape)
                        );
                    };
                });
            else
                ...
                (Expr.filter.ID = function (id) {
                    ...
                    elem.getAttributeNode("id");
                        return (
                            node && node.value === id.replace(runescape, funescape)
                        );
                    };
                });
            return (
        ...
        function createPositionalPseudo(fn) {
            return markFunction(function (argument) {
                return (
                    (argument = +argument),
                    markFunction(function (seed, matches1) {
                        for (
                            var j,
        ...
        (Expr = Sizzle.selectors = {
            ...
            pseudos: {
                not: markFunction(function (selector) {
                    var input = [],
                        results = [],
                        matcher = compile(selector.replace(rtrim1, "$1"));
                    return matcher[expando]
                        ? markFunction(function (seed, matches1, context, xml) {
                            for (
                                var elem,
        ...
        function condense(unmatched, map, filter, context, xml) {
            ...
            (newUnmatched.push(elem), null != map && map.push(i));
            return newUnmatched;
        }
        function setMatcher(
            preFilter,
                ...
                if ((matcher = Expr.relative[tokens[i].type]))
                    ...
                    if (
                        ...
                        return setMatcher(
                            ...
                            i > 1 &&
                  toSelector(tokens.slice(0, i - 1)).replace(rtrim1, "$1"),
                            matcher,
    ...
    jQuery.fn.extend({
        ...
        closest: function (selectors, context) {
            ...
            rneedsContext.test(selectors) || "string" !== typeof selectors
                ...
                for (
                    cur = this[i];
                    cur && cur.ownerDocument && context !== cur && cur.nodeType !== 11;
    ...
    jQuery.each(
        ...
        function (name, fn) {
            ...
            !{
                ...
                : ret),
                    this.length > 1 &&
            /^(?:parents|prev(?:Until|All))/.test(name) &&
            (ret = ret.reverse()),
                    this.pushStack(ret)
                );
            };
    ...
    jQuery.extend({
        ...
        dir: function (elem, dir, until) {
            for (
                ...
                cur &&
          cur.nodeType !== 9 &&
          (void 0 === until || cur.nodeType !== 1 || !jQuery(cur).is(until));
        ...
        sibling: function (n, elem) {
            for (var r = []; n; n = n.nextSibling)
                n.nodeType === 1 && elem !== n && r.push(n);
            return r;
        },
    });
    function winnow(elements, qualifier, keep) {
        if (((qualifier ||= 0), jQuery.isFunction(qualifier)))
    ...
    jQuery.fn.extend({
        ...
        remove: function (selector, keepData) {
            ...
            (keepData || elem.nodeType !== 1 || jQuery.cleanData(getAll(elem)),
            elem.parentNode &&
              (keepData &&
        ...
        html: function (value) {
            return jQuery.access(
                ...
                function (value) {
                    ...
                    if (
                        "string" == typeof value &&
              !/<(?:script|style|link)/i.test(value) &&
        ...
        domManip: function (args, table, callback) {
          ...
          !(
            ...
            !/checked\s*(?:[^=]|=\s*.checked.)/i.test(value)
          )
            )
                return this.each(function (index) {
                    var self = this.eq(index);
                    isFunction &&
              (args[0] = value.call(this, index, table ? self.html() : void 0)),
        ...
        !jQuery.isXMLDoc(elem)
            ...
            if (dataAndEvents) {
                if (deepDataAndEvents)
                    for (
                        srcElements ||= getAll(elem), destElements ||= getAll(clone), i = 0;
                        (node = srcElements[i]) != null;
                        i++
                    )
            ...
            for (
                ...
                if (((elem = elems[i]), elem || 0 === elem)) {
                    if (jQuery.type(elem) === "object")
                        ...
                        for (
                            tmp ||= safe.appendChild(context.createElement("div")),
                    ...
                    if (((id = elem[internalKey]), (data = id && cache[id]))) {
                        if (data.events)
                            for (type in data.events)
                                if (jQuery.event.special[type]) jQuery.event.remove(elem, type);
                                else jQuery.removeEvent(elem, type, data.handle);
                        if (cache[id]) {
                            if ((delete cache[id], deleteExpando)) delete elem[internalKey];
                            else if ("undefined" !== typeof elem.removeAttribute)
        ...
        for (
          ...
          ((elem.style.display && elem.style.display !== "none") || !hidden) &&
            jQuery._data(
                elem,
                "olddisplay",
                hidden ? elem.style.display : jQuery.css(elem, "display"),
            ));
        }
    ...
    if (
        (jQuery.fn.extend({
                ...
                return jQuery.access(
                    ...
                    function (elem, name, value) {
                        var styles,
                            ...
                            i = 0;
                        if (jQuery.isArray(name)) {
                            for (styles = getStyles(elem); i < name.length; i++)
            ...
            toggle: function (state) {
                return this.each(function () {
                    if ("boolean" == typeof state ? state : isHidden(this))
                        jQuery(this).show();
        ...
        jQuery.extend({
            ...
            (jQuery.cssProps[origName] = vendorPropName(style, origName))),
                    ...
                    if (
                        ((type = typeof value),
                        "string" === type &&
              (ret = new RegExp("^([+-])=(" + core_pnum + ")", "i").exec(
                  value,
              )) &&
              ((value =
                (ret[1] + 1) * ret[2] + parseFloat(jQuery.css(elem, name))),
              (type = "number")),
                        null == value || ("number" === type && isNaN(value)))
                    )
                        return;
                    if (
              ...
              (value = hooks.set(elem, value, extra)) !== void 0)
                    ...
                    if (
                        hooks &&
            "get" in hooks &&
            (ret = hooks.get(elem, !1, extra)) !== void 0
                    )
                        return ret;
                    return style[name];
                }
      ...
      (curCSS = function (elem, name, _computed) {
          ...
          return (
              ...
              rnumnonpx.test(ret) &&
            !/^(top|right|bottom|left)$/.test(name) &&
            (style.left,
    ...
    function addToPrefiltersOrTransports(structure) {
        return function (dataTypeExpression, func) {
            ...
            if (jQuery.isFunction("*"))
                for (; (dataType = ("*".match(core_rnotwhite) || [])[i++]); )
                    if (dataType[0] === "+")
            ...
            if ("*" !== current) {
              ...
              converters[prev + " " + current] || converters["* " + current]),
                        ...
                        for (conv2 in converters)
                            if (((tmp = conv2.split(" ")), tmp[1] === current)) {
                                if (
                                    (conv =
    ...
    function defaultPrefilter(elem, props, opts) {
      ...
      !jQuery.support.shrinkWrapBlocks &&
        ...
        for (index in props)
            if (((value = props[index]), /^(?:toggle|show|hide)$/.exec(value))) {
                if (
                    (delete props[index],
                    (toggle ||= "toggle" === value),
    ...
    jQuery.each(["toggle", "show", "hide"], function (i, name) {
        jQuery.fn[name] = function (speed, easing, callback) {
            return null == speed || "boolean" == typeof speed
                ? jQuery.fn[name].apply(this, arguments)
    ...
    (jQuery.fn.offset = function (options) {
        ...
        if (!doc) return;
        if ((doc.documentElement, !jQuery.contains(doc.documentElement, elem)))
            return box;
        return (
                ...
                (!0 === margin || !0 === value ? "margin" : "border");
                        return jQuery.access(
                            ...
                            function (elem, type1, value) {
                                ...
                                return void 0 === value
                                    ? jQuery.css(elem, type1, extra)
                                    : jQuery.style(elem, type1, value, extra);
                            },
                            type,
