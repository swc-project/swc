!(function (window, undefined) {
    ...
    jQuery.extend({
            ...
            return (!0 === wait ? --jQuery.readyWait : jQuery.isReady)
                ...
                : !document.body
                    ...
                    : ((jQuery.isReady = !0), !0 !== wait && --jQuery.readyWait > 0)
                        ? void 0
                        : void (readyList.resolveWith(document,
                            [jQuery]),
                        jQuery.fn.trigger &&
        ...
        isPlainObject: function (obj) {
          ...
          jQuery.isWindow(obj)
            ...
            var key;
            for (key in obj);
            return void 0 === key || core_hasOwn.call(obj,
                key);
        },
        ...
        access: function (elems, fn, key, value, chainable, emptyGet, raw) {
            ...
            if ("object" === jQuery.type(key)) {
                chainable = !0;
                for (i in key) jQuery.access(elems,
                    fn,
                    i,
                    key[i],
                    !0,
      ...
      "string" == typeof options
        ...
        var firing,
            ...
            self = {
              ...
              firing
                  ? (firingLength = list.length)
                  : memory && ((firingStart = list.length), fire(memory))),
                        this
                    );
                },
                remove: function () {
        ...
        attr: function (elem, name, value) {
            ...
            (hooks =
              ...
              (rboolean.test(name) ? boolHook : nodeHook))),
                ...
                if (null === value) jQuery.removeAttr(elem,
                    name);
                else if (
                    hooks &&
            notxml &&
            ...
            (ret = hooks.set(elem,
                ...
                name)) !== void 0
                    ...
                    return ret;
                else return elem.setAttribute(name,
                    value + ""), value;
            } else if (
                hooks &&
          notxml &&
      ...
      (jQuery.attrHooks.value = {
          ...
          set: function (elem, value, name) {
              if (jQuery.nodeName(elem,
                  "input")) elem.defaultValue = value;
              else return nodeHook && nodeHook.set(elem,
                  value,
                  name);
          },
      }),
    ...
    (jQuery.event = {
        ...
        add: function (elem, types, handler, data, selector) {
          ...
          handleObjIn.selector),
            ...
            (!special.setup ||
              special.setup.call(null,
                  data,
                  namespaces,
                  eventHandle) === !1) &&
              (null.addEventListener
                  ? null.addEventListener(type,
                      eventHandle,
                      !1)
                  : null.attachEvent &&
                  null.attachEvent("on" + type,
                      eventHandle))),
                special.add &&
            (special.add.call(null,
                handleObj),
        ...
        trigger: function (event, data, elem, onlyHandlers) {
          ...
          eventPath.push(tmp.defaultView || tmp.parentWindow || window);
            ...
            if (((event.type = type), !onlyHandlers && !event.isDefaultPrevented())) {
                if (
                    (!special._default ||
            special._default.apply(elem.ownerDocument,
                data) === !1) &&
        ...
        dispatch: function (event) {
            ...
            if (
                ...
                special.preDispatch && special.preDispatch.call(this,
                    event) === !1)
            )
                return;
            for (
      ...
      jQuery.each(
          ...
          function (orig, fix) {
              ...
              jQuery.event.special[fix] = {
                  setup: function () {
                      attaches++ == 0 && document.addEventListener(orig,
                          handler,
                          !0);
                  },
                  teardown: function () {
    ...
    jQuery.fn.extend({
        on: function (types, selector, data, fn, one) {
            ...
            ((data ||= selector), (selector = void 0));
                for (type in types) this.on(type,
                    selector,
                    data,
                    types[type],
                    one);
    ...
    (function (window, undefined) {
        ...
        function Sizzle(selector, context, results, seed) {
            ...
            return select(selector.replace(rtrim1,
                "$1"),
            context,
            results,
            seed);
                ...
                support.getIdNotName
                    ...
                    (Expr.filter.ID = function (id) {
                        ...
                        elem.getAttributeNode("id");
                            return (
                                node && node.value === id.replace(runescape,
                                    funescape)
                            );
                        };
                    })),
        ...
        (Expr = Sizzle.selectors = {
            ...
            pseudos: {
                not: markFunction(function (selector) {
                    var input = [],
                        results = [],
                        matcher = compile(selector.replace(rtrim1,
                            "$1"));
            ...
            for (
                ...
                if ((matcher = Expr.relative[tokens[i].type]))
                  ...
                  toSelector(tokens.slice(0,
                      ...
                      "$1"),
                            matcher,
                            j > i && matcherFromTokens(tokens.slice(i,
                                j)),
    ...
    jQuery.fn.extend({
        find: function (selector) {
            ...
            for (ret = [], i = 0; len > i; i++) jQuery.find(selector,
                this[i],
                ret);
            return (
    ...
    function winnow(elements, qualifier, keep) {
        if (((qualifier ||= 0), jQuery.isFunction(qualifier)))
            return jQuery.grep(elements,
                function (elem, i) {
                    var retVal = !!qualifier.call(elem,
                        i,
                        elem);
                    return keep === retVal;
                });
    ...
    function fixCloneNodeIssues(src, dest) {
        ...
        if (
            ...
            for (e in data.events) jQuery.removeEvent(dest,
                e,
                data.handle);
            ...
            for (
                ...
                tag && !jQuery.nodeName(elem,
                    ...
                    : jQuery.merge(found,
                        getAll(elem,
                            tag));
        return void 0 === tag || (tag && jQuery.nodeName(context,
            tag))
    ...
    jQuery.extend({
        ...
        buildFragment: function (elems, context, scripts, selection) {
            ...
            fixDefaultChecked),
                ...
                if (selection && -1 !== jQuery.inArray(elem,
                    selection)) continue;
                if (
    ...
    jQuery.fn.extend({
        ...
        toggle: function (state) {
            return this.each(function () {
                ("boolean" == typeof state ? state : isHidden(this))
                    ? jQuery(this).show()
                    : jQuery(this).hide();
            });
        },
    ...
    jQuery.extend({
        ...
        css: function (elem, name, extra, styles) {
          ...
          (jQuery.cssProps[origName] = vendorPropName(elem.style,
              origName))),
            (hooks = jQuery.cssHooks[name] || jQuery.cssHooks[origName]),
            hooks && "get" in hooks && (val = hooks.get(elem,
                !0,
                extra)),
            void 0 === val && (val = curCSS(elem,
                name,
                styles)),
            "normal" === val &&
    ...
    function setPositiveNumber(elem, value, subtract) {
        var matches = new RegExp("^(" + core_pnum + ")(.*)$",
            "i").exec(value);
        return matches
            ? Math.max(0,
    ...
    function actualDisplay(name, doc) {
        return elem.remove(), jQuery.css(elem[0],
            "display");
    }
    jQuery.each(["height", "width"],
        function (i, name) {
            ...
            /^(none|table(?!-c[ea]).+)/.test(jQuery.css(elem,
                "display"))
                            ? jQuery.swap(
                                elem,
                                {
    ...
    jQuery.extend({
        ...
        ajax: function (url, options) {
            ...
            for (i in s.headers) jqXHR.setRequestHeader(i,
                s.headers[i]);
            if (
                s.beforeSend &&
          (s.beforeSend.call(callbackContext,
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                (jqXHR.readyState = 0),
                responses && ajaxHandleResponses(s,
                    jqXHR,
                    responses),
                (jqXHR.status = 0),
    ...
    var xhrCallbacks,
      ...
      function () {
          var key;
          for (key in xhrCallbacks) xhrCallbacks[key](void 0,
              !0);
      };
          ...
          jQuery._data(elem,
              ...
              {}),
                ...
                anim.done(function () {
                    ...
                    jQuery._removeData(elem,
                        "fxshow");
                    for (prop in orig) jQuery.style(elem,
                        prop,
                        orig[prop]);
                }),
                index = 0;
    ...
    (jQuery.fx.tick = function () {
        ...
        for (fxNow = jQuery.now(); i < timers.length; i++)
            (timer = timers[i]),
            timer() || timers[i] !== timer || timers.splice(i--,
                1);
    ...
    jQuery.fn.extend({
        position: function () {
            ...
            return (
                ...
                {
                    top:
              offset.top - parentOffset.top - jQuery.css(elem,
                  "marginTop",
                  !0),
                    left:
              offset.left -
