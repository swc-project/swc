...
!(function (window, document, undefined) {
                    ...
                    (message =
                        ...
                        template.replace(/\{\d+\}/g, function (match) {
                            ...
                            return index + 2 < templateArgs.length
                                ? "function" ==
                                  typeof (arg = templateArgs[index + 2])
    ...
    function nextUid() {
        for (var digit, index = uid.length; index; ) {
            ...
            if (90 != digit)
                return (
                    (uid[index] = String.fromCharCode(digit + 1)), uid.join("")
                );
            uid[index] = "0";
        }
    ...
    function jqLiteInheritedData(element, name, value) {
        ...
        for (var names = isArray(name) ? name : [name]; element.length; ) {
            for (var i = 0, ii = names.length; i < ii; i++)
                if (undefined !== (value = element.data(names[i])))
                    return value;
        ...
        forEach(
            {
                ...
                text: (function () {
                    ...
                    function getText(element, value) {
                        var textProp =
                            NODE_TYPE_TEXT_PROPERTY[element.nodeType];
        ...
        (self.cookies = function (name, value) {
            ...
            if (!name) {
                if (rawDocument.cookie !== lastCookieString)
                    for (
                        cookieArray = (lastCookieString =
                            rawDocument.cookie).split("; "),
                            lastCookies = {},
                            i = 0;
            ...
            (this.$get = [
                ...
                function (
                    ...
                    Attributes.prototype = {
                        ...
                        $updateClass: function (newClasses, oldClasses) {
                            this.$removeClass(
                                ...
                                this.$addClass(
                                    tokenDifference(newClasses, oldClasses)
                                );
                        },
                    ...
                    function compileNodes(
                        ...
                        for (
                            ...
                            (attrs = new Attributes()),
                                ...
                                (linkFnFound =
                                    linkFnFound || nodeLinkFn || childLinkFn),
                    ...
                    function collectDirectives(
                        ...
                        switch (nodeType) {
                            case 1:
                                ...
                                if (
                                    isString((className = node.className)) &&
                                    "" !== className
                                )
                                    for (
                                        ;
                            ...
                            for (
                                newIsolateScopeDirective &&
                                    (newIsolateScopeDirective.template ||
                                        null ===
                                            newIsolateScopeDirective.templateUrl) &&
                                    ...
                                    return {
                                        pre: function (scope, element, attr) {
                                            var $$observers =
                                                ...
                                                (attr.$$observers = {});
                                            if (
                                                EVENT_HANDLER_ATTR_REGEXP.test(
                                                    name
                                                )
                                            )
                                                throw $compileMinErr(
                    ...
                    function replaceWith(
                        ...
                        for (
                            var k = 1, kk = elementsToRemove.length;
                            k < kk;
                            k++
                        ) {
                                ...
                                return (
                                    ...
                                    (function (config, reqData, reqHeaders) {
                                        ...
                                        function removePendingReq() {
                                            ...
                                            -1 !== idx &&
                                                $http.pendingRequests.splice(
                                                    idx,
                                                    1
                                                );
                                        }
                                    })(config, reqData, headers).then(
                                        transformResponse,
                                        transformResponse
                                    )
                                );
                ...
                return (function (
                    ...
                    return function (
                        ...
                        if (
                            ...
                            var callbackId =
                                "_" + (callbacks.counter++).toString(36);
    ...
    function parseAbsoluteUrl(absoluteUrl, locationObj, appBase) {
        ...
        (locationObj.$$protocol = parsedUrl.protocol),
            ...
            (locationObj.$$port =
                int(parsedUrl.port) ||
                DEFAULT_PORTS[parsedUrl.protocol] ||
                null);
    }
    ...
    function LocationHtml5Url(appBase, basePrefix) {
        ...
        parseAbsoluteUrl(appBase, this, appBase),
            ...
            (this.$$rewrite = function (url) {
                ...
                return undefined !== (appUrl = beginsWith(appBase, url))
                    ? ((prevAppUrl = appUrl),
                      undefined !== (appUrl = beginsWith(basePrefix, appUrl))
                          ? appBaseNoFile + (beginsWith("/", appUrl) || appUrl)
                          : appBase + prevAppUrl)
                    : undefined !== (appUrl = beginsWith(appBaseNoFile, url))
                ...
                function ($rootScope, $browser, $sniffer, $rootElement) {
                    ...
                    html5Mode
                        ...
                        ($location = new LocationMode(
                            appBase,
                            "#" + hashPrefix
                        )).$$parse($location.$$rewrite(initialUrl)),
                        ...
                        return (
                            arg instanceof Error &&
                                (arg.stack
                                    ? (arg =
                                          arg.message &&
                                          -1 === arg.stack.indexOf(arg.message)
                                              ? "Error: " +
                                                arg.message +
                                                "\n" +
                                                arg.stack
    ...
    function setter(obj, path, setValue, fullExp, options) {
        options = options || {};
        for (
            var key, element = path.split("."), i = 0;
            element.length > 1;
            i++
        ) {
            var propertyObj =
                obj[(key = ensureSafeMemberName(element.shift(), fullExp))];
        ...
        (Parser.prototype = {
            ...
            primary: function () {
                ...
                if (this.expect("("))
                    ...
                    (primary = token.fn) ||
                        ...
                        token.json &&
                            ((primary.constant = !0), (primary.literal = !0));
                }
            ...
            ternary: function () {
                ...
                return (token = this.expect("?"))
                    ? ((middle = this.ternary()),
                      (token = this.expect(":"))
                          ? this.ternaryFn(left, middle, this.ternary())
                          : void this.throwError("expected :", token))
                    : left;
            },
            logicalOR: function () {
                ...
                function ($injector, $exceptionHandler, $parse, $browser) {
                    ...
                    Scope.prototype = {
                        ...
                        $watch: function (watchExp, listener, objectEquality) {
                            ...
                            if (
                                ((lastDirtyWatch = null), !isFunction(listener))
                            ) {
                    ...
                    return (
                        ...
                        )),
                        {
                            ...
                            getTrusted: function (type, maybeTrusted) {
                                ...
                                if (
                                    constructor &&
                                    maybeTrusted instanceof constructor
                                )
                            ...
                            valueOf: function (maybeTrusted) {
                                return maybeTrusted instanceof
                                    trustedValueHolderBase
                    ...
                    return (
                        forEach(SCE_CONTEXTS, function (enumValue, name) {
                            ...
                            (sce[camelCase("parse_as_" + lName)] = function (
                                ...
                                (sce[
                                    camelCase("get_trusted_" + lName)
                                ] = function (value) {
                                    return getTrusted(enumValue, value);
                                }),
                                (sce[
                                    camelCase("trust_as_" + lName)
                                ] = function (value) {
        ...
        this.$get = [
            ...
            function ($window, $document) {
                ...
                if (bodyStyle) {
                    ...
                    vendorPrefix ||
                        (vendorPrefix =
                            "WebkitOpacity" in bodyStyle && "webkit"),
                        (transitions = !(
        ...
        return function (date, format) {
                        ...
                        : (function (string) {
                              ...
                              if ((match = string.match(R_ISO8601_STR))) {
                                  ...
                                  var h = int(match[4] || 0) - tzHour,
                                      ...
                                      ms = Math.round(
                                          1e3 *
                                              parseFloat("0." + (match[7] || 0))
                                      );
                                  return (
                                      timeSetter.call(date, h, m, s, ms), date
                                  );
                              }
                              return string;
                          })(date)),
            ...
            for (; format; )
                (match = DATE_FORMATS_SPLIT.exec(format))
                    ? (format = (parts = concat(parts, match, 1)).pop())
    ...
    function orderByFilter($parse) {
        return function (array, sortPredicate, reverseOrder) {
            ...
            (sortPredicate = isArray(sortPredicate)
                ...
                (results = []),
                forEach(sortPredicate, function (value, index, list) {
                        ...
                        return empty || NUMBER_REGEXP.test(value)
                            ? (ctrl.$setValidity("number", !0),
                              "" === value
                                  ...
                                  ? value
                                  : parseFloat(value))
                            : void ctrl.$setValidity("number", !1);
                    }),
        ...
        var patternValidator,
            ...
            validate = function (regexp, value) {
                return ctrl.$isEmpty(value) || regexp.test(value)
                    ...
                    : void ctrl.$setValidity("pattern", !1);
            };
        if (
            (pattern &&
            ...
            var minlength = int(attr.ngMinlength),
                minLengthValidator = function (value) {
                    return !ctrl.$isEmpty(value) && value.length < minlength
                        ? void ctrl.$setValidity("minlength", !1)
            ...
            var maxlength = int(attr.ngMaxlength),
                maxLengthValidator = function (value) {
                    return !ctrl.$isEmpty(value) && value.length > maxlength
                        ? void ctrl.$setValidity("maxlength", !1)
                    ...
                    if (ctrl) {
                        ...
                        var validator = function (value) {
                            return attr.required && ctrl.$isEmpty(value)
                                ? void ctrl.$setValidity("required", !1)
                                : (ctrl.$setValidity("required", !0), value);
                        };
    ...
    (jQuery = window.jQuery)
        ...
        (function (angular) {
            ...
            try {
                ...
                angularModule("ngLocale", []).provider(
                    "$locale",
                    $LocaleProvider
                );
            }
