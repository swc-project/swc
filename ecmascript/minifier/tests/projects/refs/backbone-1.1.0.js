(function () {
    ...
    var Events = (Backbone.Events = {
            ...
            off: function (name, callback, context) {
                ...
                for (
                    i = 0,
                        l = (names = name ? [name] : _.keys(this._events))
                            .length;
                    i < l;
                    i++
                )
            ...
            stopListening: function (obj, name, callback) {
                ...
                listeningTo))
                    (obj = listeningTo[id]).off(name, callback, this),
    ...
    _.extend(Collection.prototype, Events, {
        ...
        add: function (models, options) {
            return this.set(
                models,
                _.extend({ merge: !1 }, options, addOptions)
            );
        },
        ...
        set: function (models, options) {
            (options = _.defaults({}, options, setOptions)).parse &&
