    ...
    (proto = {
        ...
        _init: function () {
            ...
            (Y.constructor = YUI),
                ...
                (Y.config.base =
                    YUI.config.base || Y.Env.getBase(Y.Env._BASE_RE)),
                    ...
                    if (mod) {
                        ...
                        if (
                            ...
                            loader.moduleInfo[name].expanded_map))
                                loader.moduleInfo[
                                    name
                                ].expanded_map.hasOwnProperty(j) && req.push(j);
                            Y._attach(req);
                        }
                        if (
            ...
            return (
                "load" ===
                    (until = Y.Lang.isObject(until) ? until : { event: until })
                        .event && mod.push("event-synthetic"),
                function () {
                    var args = arguments;
                    Y._use(mod, function () {
                        Y.on(
        ...
        use: function () {
            ...
            if (
                ...
                if (provisioned)
                    return (
                        args.length, Y._notify(callback, ALREADY_DONE, args), Y
                    );
            }
            return (
                Y._loading
        ...
        _use: function (args, callback) {
            ...
            if ("*" === firstArg) {
                for (i in ((args = []), mods))
                    mods.hasOwnProperty(i) && args.push(i);
    ...
    YUI.add(
        ...
        function (Y, NAME) {
            ...
            (L._isNative = function (fn) {
                ...
                (L.trimRight =
                    L._isNative(STRING_PROTO.trimRight) &&
            ...
            (O.hasKey = owns),
                    ...
                    Lang._isNative(Object.keys) && !hasProtoEnumBug
                        ...
                        : function (obj) {
                              ...
                              if (hasProtoEnumBug && "function" == typeof obj)
                                  ...
                                  for (key in obj)
                                      owns(obj, key) && keys.push(key);
                              if (hasEnumBug)
                                  for (
                                      i = 0, len = forceEnum.length;
                                      i < len;
                                      ++i
                                  )
                                      owns(obj, (key = forceEnum[i])) &&
                                          keys.push(key);
                              return keys;
                          }),
                ...
                (O.setValue = function (o, path, val) {
                    var i,
                        ...
                        ref = o;
                    if (leafIdx >= 0) {
                        for (i = 0; undefined !== ref && i < leafIdx; i++)
                            ref = ref[p[i]];
                ...
                (YUI.Env.parseUA = function (subUA) {
                    var m,
                        ...
                        o = {
                            ...
                            nodejs: 0,
                            winjs: !(
                                "undefined" == typeof Windows || !Windows.System
                            ),
                            touchEnabled: !1,
                        },
                    ...
                    return (
                        (o.userAgent = ua),
                        (o.secure =
                            href && 0 === href.toLowerCase().indexOf("https")),
                        ua &&
        ...
        function (Y, NAME) {
            ...
            (Y.Get = Get = {
                    ...
                    if (!transaction.abort)
                        if (
                            ...
                            for (i = 0, len = this._queue.length; i < len; ++i)
                                if (
                                    (item = this._queue[i].transaction).id ===
                                    id
                                ) {
                                    (transaction = item),
                ...
                _getEnv: function () {
                    ...
                    return (this._env = {
                        async:
                            (doc && !0 === doc.createElement("script").async) ||
                            ua.ie >= 10,
                        cssFail:
                            ua.gecko >= 9 ||
                ...
                (Transaction.prototype = {
                    ...
                    _createNode: function (name, attrs, doc) {
                        ...
                        for (attr in (CUSTOM_ATTRS ||
                            ((testEl = doc.createElement("div")).setAttribute(
                                "class",
                                "a"
                            ),
                            (CUSTOM_ATTRS =
                    ...
                    _poll: function (newReq) {
                        ...
                        if (
                            ...
                            for (
                                self._pollTimer = null, i = 0;
                                i < pendingCSS.length;
                                ++i
                            )
                                if (((req = pendingCSS[i]), isWebKit)) {
                                    for (
                                        j = (sheets = req.doc.styleSheets)
                                            .length,
                    ...
                    test: function (Y) {
                        ...
                        return (
                            addFeature("style", "computedStyle", {
                                test: function () {
                                    return (
                                        WINDOW && "getComputedStyle" in WINDOW
                                    );
                                },
                            }),
                    ...
                    test: function (Y) {
                        var _JSON = Y.config.global.JSON,
                            Native =
                                ...
                                _JSON,
                            nativeSupport =
                                !1 !== Y.config.useNativeJSONStringify &&
                                !!Native;
                        if (nativeSupport)
                            try {
                ...
                return (
                    c.debug &&
                        (void 0 !== (src = src || "") &&
                            ...
                            (minlevel =
                                LEVELS[Y.config.logLevel.toLowerCase()]),
                            cat in LEVELS &&
                                LEVELS[cat] < minlevel &&
                                (bail = 1)),
                        bail ||
                ...
                var VERSION = Y.version,
                    ...
                    yui2Update = function (tnt, yui2, config) {
                        var root =
                                ...
                                "/build/",
                            base =
                                config && config.base ? config.base : CDN_BASE,
                            combo =
                    ...
                    galleryUpdate = function (tag, config) {
                        var root =
                                (tag || "gallery-2013.08.22-21-03") + "/build/",
                            base =
                                config && config.base ? config.base : CDN_BASE,
                            combo =
                                config && config.comboBase
            ...
            YUI.Env._cssLoaded || (YUI.Env._cssLoaded = {}),
                ...
                (Y.Loader = function (o) {
                    (o = o || {}),
                        ...
                        (this.combine =
                            o.base &&
                            o.base.indexOf(this.comboBase.substr(0, 20)) > -1),
                        (this.comboSep = "&"),
                ...
                (Y.Loader.prototype = {
                            ...
                            if (this.moduleInfo.hasOwnProperty(i)) {
                                if (
                                    ...
                                    (details = YUI.Env.mods[name]
                                        ...
                                        (this.moduleInfo[name].requires =
                                            details.requires || []),
                                        (this.moduleInfo[name].optional =
                                            details.optional || []),
                    ...
                    _requires: function (mod1, mod2) {
                        ...
                        if (
                            ...
                            return !0;
                        if ((after_map = other.after_map) && mod1 in after_map)
                            return !1;
                        ...
                        if (
                            ...
                            (self.filters = self.filters || {}),
                                Y.Array.each(mods, function (mod) {
                                    self.filters[mod] =
                                        self.FILTER_DEFS.COVERAGE;
                                }),
                                (self.filterName = "RAW"),
                                (self.filter =
                                    self.FILTER_DEFS[self.filterName]);
                        }
                    },
                    ...
                    addModule: function (o, name) {
                        ...
                        if (
                            ...
                            o.requires.length &&
                                (o.requires =
                                    this.filterRequires(o.requires) || []),
                            !o.langPack && o.lang)
                        )
                            for (
                                langs = yArray(o.lang), j = 0;
                                j < langs.length;
                                j++
                            )
                                (lang = langs[j]),
                    ...
                    require: function (what) {
                        var a =
                            "string" == typeof what ? yArray(arguments) : what;
                        (this.dirty = !0),
                        ...
                        if (!this.allowRollup) {
                            for (i in r)
                                if (
                                    ...
                                    for (
                                        len = m.use.length, a = 0;
                                        a < len;
                                        a++
                                    )
                                        if (
                                            (m2 = this.getModule(m.use[a])) &&
                                            m2.use
                                        )
                                            for (
                                                len2 = m2.use.length, v = 0;
                                                v < len2;
                                                v++
                                            )
                                                r[m2.use[v]] = !0;
                    ...
                    getRequires: function (mod) {
                        ...
                        if (
                            (mod.temp &&
                                adddef &&
                                ((old_mod = mod),
                                ((mod = this.addModule(adddef, name)).group =
                                    old_mod.group),
                                (mod.pkg = old_mod.pkg),
                                delete mod.expanded),
                            (reparse = !(
                            ...
                            if (((mod._parsed = !1), testresults && ftests))
                                ...
                                for (i in cond)
                                    if (
                                        ...
                                        for (
                                            add = this.getRequires(m), j = 0;
                                            j < add.length;
                                            j++
                                        )
                                            d.push(add[j]);
                        if (mod.skinnable) {
                            for (i in ((skindef = this.skin.overrides),
                            YUI.Env.aliases))
                                YUI.Env.aliases.hasOwnProperty(i) &&
                                    Y.Array.indexOf(YUI.Env.aliases[i], name) >
                                        -1 &&
                                    (skinpar = i);
                            if (
                                skindef &&
                                ...
                                for (
                                    ...
                                    (skinmod = this._addSkin(
                                        ...
                                        this.isCSSLoaded(skinmod, this._boot) ||
                                            d.push(skinmod);
                            else
                                (skinmod = this._addSkin(
                                    this.skin.defaultSkin,
                    ...
                    _onSuccess: function () {
                        ...
                        for (i in skipped)
                            skipped.hasOwnProperty(i) &&
                                delete this.inserted[i];
                        for (i in ((this.skipped = {}), this.inserted))
                        ...
                        if (
                            ...
                            (complete = function (d) {
                                ...
                                if (actions === comp) {
                                    if (
                                        ((self._loading = null),
                                        self._refetch.length)
                                    ) {
                                        for (
                                            i = 0;
                                            i < self._refetch.length;
                                            i++
                                        )
                                            for (
                                                ...
                                                self.inserted[deps[o]] ||
                                                    (mods[deps[o]] = deps[o]);
                                        if (
                                            (mods = Y.Object.keys(mods)).length
                                        ) {
                                            if (
                                                (self.require(mods),
                                                (resMods = self.resolve(!0))
                                                    .cssMods.length)
                                            ) {
                                                for (
                                                    i = 0;
                            ...
                            return (
                                (actions = -1),
                                void complete({ fn: self._onSuccess })
                            );
                        modules.css.length &&
                                ...
                                for (i = 0; i < len; i++)
                                    inserted[mods[i]] ||
                                        (!(m = mods[i]) || (!m.combine && m.ext)
                                            ...
                                            : ((resCombos[j].comboSep =
                                                  m.comboSep),
                                              (resCombos[j].group = m.group),
                                              (resCombos[j].maxURLLength =
                                                  m.maxURLLength),
                                              (frag =
                                                  (L.isValue(m.root)
                                                      ? m.root
                        ...
                        for (j in resCombos)
                            if (resCombos.hasOwnProperty(j))
                                for (type in ((comboSep =
                                    resCombos[(base = j)].comboSep ||
                                    self.comboSep),
                                (maxURLLength =
                                    resCombos[base].maxURLLength ||
                                    self.maxURLLength),
                                resCombos[base]))
                                    if (type === JS || type === CSS) {
                                        if (
                                            ...
                                            (mods =
                                                resCombos[base][type + "Mods"]),
                                            (len = urls.length),
                                            (baseLen = (tmpBase =
                                                base + urls.join(comboSep))
                                                .length),
                                            maxURLLength <= base.length &&
                                                (maxURLLength = 1024),
                                            len)
                                        )
                ...
                Y.mix(YUI.Env[Y.version].modules, {
                    ...
                    "event-base-ie": {
                        ...
                        condition: {
                            ...
                            test: function (Y) {
                                var imp =
                                    Y.config.doc && Y.config.doc.implementation;
                                return imp && !imp.hasFeature("Events", "2.0");
                            },
                            trigger: "node-base",
                        },
                        ...
                        condition: {
                            ...
                            test: function (Y) {
                                var _JSON = Y.config.global.JSON,
                                    ...
                                    nativeSupport =
                                        !1 !==
                                            Y.config.useNativeJSONStringify &&
                                        !!Native;
                                if (nativeSupport)
                                    try {
                                        nativeSupport =
