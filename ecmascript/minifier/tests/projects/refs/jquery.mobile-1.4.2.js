...
!(function (root, doc, factory) {
              ...
              function reduce(elem, size, border, margin) {
                  return (
                      $.each(side, function () {
                          ...
                          border &&
                      (size -=
                        parseFloat($.css(elem, "border" + this + "Width")) ||
                        0),
                          margin &&
    ...
    (function ($, window, undefined) {
        $.extend($.mobile, {
            ...
            getClosestBaseUrl: function (ele) {
              ...
              (url = base),
                    $.mobile.path.makeUrlAbsolute(url, base)
                );
            },
        ...
        $.widget("mobile.loader", {
          ...
          "<div class='ui-loader'><span class='ui-icon-loading'></span><h1></h1></div>",
            ...
            show: function (theme, msgText, textonly) {
                ...
                this.resetHtml(),
                "object" === $.type(theme)
                    ? (theme = (loadSettings = $.extend({}, this.options, theme))
                        .theme)
    ...
    (function ($, undefined) {
        ...
        ($.event.special.navigate = self = {
            ...
            popstate: function (event) {
                ...
                (event.historyState && $.extend(state, event.historyState),
    ...
    (function ($, undefined) {
        ...
        ($.fn.animationComplete = function (callback, type, fallbackTime) {
            ...
            ($.support.cssAnimations && "animation" === animationType)
                ...
                $(this).one(props[animationType].event, function () {
    ...
    (function ($, window, document, undefined) {
        ...
        function mouseEventCallback(event) {
            var ve,
                touchID = $.data(event.target, "virtualTouchID");
            blockMouseTriggers ||
        ...
        function hasVirtualBindings(ele) {
            var k,
                bindings = $.data(ele, dataPropertyName);
            ...
            function (e) {
                ...
                if (cnt)
                    for (
                      ...
                      $.data(ele, "virtualTouchID") === o.touchID)
                            )
    ...
    (function ($, window, undefined) {
        ...
        ($.event.special.swipe = {
            ...
            setup: function () {
              ...
              ((events = { length: 0 }), $.data(this, "mobile-events", events)),
                events.length++,
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.page", {
            ...
            _create: function () {
                ...
                "dialog" === $.mobile.getAttribute(this.element[0], "role") &&
                $.mobile.dialog &&
                this.element.dialog();
            },
            _enhance: function () {
    ...
    (function ($, undefined) {
        $.widget("mobile.pagecontainer", {
            ...
            _handleNavigate: function (url, data) {
              ...
              !1 === (to = this._handleDialog(changePageOptions, data))) ||
              this._changeContent(
            ...
            _loadSuccess: function (absUrl, triggerData, settings, deferred) {
              ...
              (fileUrl = $.mobile.path.getFilePath(
                  $("<div>" + RegExp.$1 + "</div>").text(),
                    ...
                    this._trigger("load", undefined, triggerData) &&
            ...
            load: function (url, options) {
              ...
              $.mobile.path.isFirstPageUrl(fileUrl))
                ...
                } else deferred.reject(absUrl, settings);
            },
            ...
            change: function (to, options) {
                if (isPageTransitioning) pageTransitionQueue.unshift(arguments);
                    ...
                    this._triggerPageBeforeChange(to, triggerData, settings) &&
            ...
            transition: function (toPage, triggerData, settings) {
                ...
                if (isPageTransitioning)
                    ...
                    this._triggerPageBeforeChange(toPage, triggerData, settings) &&
                        ...
                        if (
                            ...
                            if (-1 !== href.search("#")) {
                                ...
                                href = $.mobile.path.isPath(href)
                                    ? $.mobile.path.makeUrlAbsolute(href, baseUrl)
                                    : $.mobile.path.makeUrlAbsolute(
                                        "#" + href,
            ...
            $.extend(
                {
                    initSelector:
              ":jqmData(role='collapsible-set'),:jqmData(role='collapsibleset')",
                    options: $.extend({ enhanced: !1 }, $.mobile.collapsible.defaults),
            ...
            $.extend(
                {
                  ...
                  getAttr($list[0], "counttheme") || this.options.countTheme,
                    ...
                    !isDivider
                        ? ((icon =
                          !1 !== (itemIcon = getAttr(item[0], "icon")) &&
                          (itemIcon || o.icon)),
            ...
            $.extend(
              ...
              "input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",
                ...
                this.handle.removeClass("ui-state-active"));
                  ...
                  !1 === this._trigger("beforestart", event) ||
                  ((this.dragging = !0),
                  (this.userModified = !1),
                  (this.mouseMoved = !1),
                  this.isToggleSwitch &&
                ...
                !preventInputUpdate)
                            ...
                            if (
                                ...
                                !1 === this._trigger("beforechange", val))
                            )
                                return !1;
            ...
            $.extend(
                {
                  ...
                  ("last" === this._proxy && !first))
                            ...
                            return (
                                ($.data(otherSlider.get(0), "mobile-slider").dragging = !0),
                ...
                !$(event.target).hasClass("ui-slider-handle")
                    ...
                    _updateHighlight: function () {
                        var min = parseInt(
                            ...
                            width =
                  parseInt(
                      $.data(this._inputLast.get(0), "mobile-slider").handle.get(
                          0,
                      ).style.left,
                      10,
                  ) - min;
        ...
        $.widget("mobile.popup", {
            ...
            _calculateFinalLocation: function (desired, clampInfo) {
                ...
                return (
                    ...
                    }).top = Math.max(0, returnValue.top)),
            ...
            _open: function (options) {
                var ua,
                    ...
                    andversion,
                    chromematch,
                    openOptions = $.extend({}, this.options, options),
                    androidBlacklist =
              ((ua = navigator.userAgent),
              (wkmatch = ua.match(/AppleWebKit\/([0-9\.]+)/)),
              (wkversion = !!wkmatch && wkmatch[1]),
        ...
        ($.fn.buttonMarkup = function (options, overwriteClasses) {
            ...
            for (idx = 0; idx < this.length; idx++) {
                ...
                (el.className = optionsToClasses(
                    $.extend({}, defaults, retrievedOptions),
                    data.unknownClasses,
                ).join(" ")),
    ...
    (function ($, undefined) {
        $.widget("mobile.toolbar", {
            ...
            _create: function () {
                ...
                0 === page.length &&
            ((page = !1), this._on(this.document, { pageshow: "refresh" })),
                $.extend(this, {
                    role: role,
                    page: page,
                    leftbtn: undefined,
            ...
            _filterItems: function (val) {
                ...
                if (null != val)
                    for (
                        ...
                        (callback.call(filterItems[idx], idx, val) ? hide : show).push(
                            filterItems[idx],
                        );
                0 === hide.length
