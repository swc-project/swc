...
!(function (root, doc, factory) {
    ...
    function (jQuery, window, document, undefined) {
        ...
        (function ($, window, undefined) {
            ...
            ($.jqmRemoveData = function (elem, prop) {
                return $.removeData(elem,
                    $.mobile.nsNormalize(prop));
            }),
          ...
          "onselectstart" in document.createElement("div")),
            $.fn.extend({
                ...
                zIndex: function (zIndex) {
                    if (undefined !== zIndex) return this.css("zIndex",
                        zIndex);
                    if (this.length)
                        for (
            ...
            $.extend($.mobile,
                {
                    ...
                    getClosestBaseUrl: function (ele) {
                        ...
                        return (
                            ($.mobile.dynamicBaseEnabled && url && $.mobile.path.isPath(url)) ||
              (url = base),
                            $.mobile.path.makeUrlAbsolute(url,
                                base)
                        );
                    },
            ...
            $.mobile.activeClickedLink.removeClass($.mobile.activeBtnClass),
                    ...
                    getInheritedTheme: function (el, defaultTheme) {
                        for (
                            ...
                            e && !((c = e.className || "") && (m = re.exec(c)) && (ltr = m[2]));
                ...
                (e.getAttribute
                    ...
                    resetActivePageHeight: function (height) {
                        ...
                        (height = (function (page, desiredHeight) {
                ...
                (toolbarsAffectingHeight = toolbarsAffectingHeight.concat(
                    externalFooters.toArray(),
                            ...
                            page,
                            "number" == typeof height ? height : $.mobile.getScreenHeight(),
                        )),
                        page.css("min-height",
            ...
            $.fn.extend({
                ...
                enhanceWithin: function () {
                    var index,
                        ...
                        that = this;
                    for (index in ($.mobile.nojs && $.mobile.nojs(this),
                ...
                option: function (key, value) {
                    ...
                    if ("string" == typeof key)
                        if (
                            ...
                            if (((key = parts.pop()), undefined === value))
     ...
     */
        ...
        ((div = doc.createElement("div")).id = "mq-test-1"),
          ...
          "[object OperaMini]" === {}.toString.call(window.operamini),
            ...
            -1 === window.navigator.userAgent.search(/CriOS/),
                  ...
                  ")",
                        ...
                        if (ret) return !!ret;
                        for (t in ((el = document.createElement("div")),
                        (transforms = {
            ...
            base.length
                ? (href = base.attr("href"))
                : (base = fauxEle = $("<base>",
                    { href: fauxBase }).appendTo(
                    "head",
                )),
            (rebase = $("<a href='testurl' />").prependTo(fakeBody)[0].href),
            (base[0].href = href || location.pathname),
            fauxEle && fauxEle.remove(),
            0 === rebase.indexOf(fauxBase)),
                    cssPointerEvents:
            ...
            "pointerEvents" in element.style &&
              ...
              (supports =
                getComputedStyle &&
                "auto" === getComputedStyle(element,
                    "").pointerEvents),
              documentElement.removeChild(element),
              !!supports)),
                    boundingRect:
            void 0 !== document.createElement("div").getBoundingClientRect,
                    inlineSVG: function () {
                        var w = window,
                            svg = !(
            ...
            ($.support.boundingRect ||
              null !== $.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/))
                );
            }),
        ...
        (function ($, undefined) {
            ...
            ($.event.special.navigate = self = {
              ...
              this.isHashChangeEnabled()
                ...
                (event.historyState && $.extend(state,
                    event.historyState),
        ...
        (function ($, undefined) {
            ...
            relObj.hash
                ...
                addSearchParams: function (url, params) {
                    var u = path.parseUrl(url),
                        p = "object" == typeof params ? $.param(params) : params,
                        s = u.search || "?";
                    return (
                        u.hrefNoSearch +
            s +
            ...
            (u.hash || "")
                ...
                get: function (newPath) {
                    return (
                        undefined === newPath && (newPath = path.parseLocation().hash),
                        path.stripHash(newPath).replace(/[^\/]*\.[^\/*]+$/,
                            "")
                    );
                },
                set: function (path) {
              ...
              (path.isPath(url) ? path.getLocation() : path.getDocumentUrl())),
                        ...
                        (stateIndex = (cleanedUrl = path.isPath(uri.hash)
                            ? path.stripHash(uri.hash)
                            : cleanedUrl).indexOf(this.uiStateKey)) > -1 &&
              ...
              (cleanedUrl = cleanedUrl.slice(0,
                  ...
                  (preservedHash = "#" + preservedHash),
                            (href =
                  (href = path.parseUrl(href)).protocol +
                  "//" +
                  href.host +
                  href.pathname +
                  search +
            ...
            $.extend($.mobile.Navigator.prototype,
                {
                    ...
                    hash: function (url, href) {
                        ...
                        return (
                            ...
                            (loc = path.parseLocation()).pathname + loc.search ===
              parsed.pathname + parsed.search
                                ? parsed.hash
                                    ? parsed.hash
                                    : parsed.pathname + parsed.search
                                : path.isPath(url)
                                    ? (resolved = path.parseUrl(href)).pathname +
                  resolved.search +
        ...
        (function ($, undefined) {
            ($.mobile.navigate = function (url, data, noEvents) {
                $.mobile.navigate.navigator.go(url,
                    data,
                    noEvents);
            }),
        ...
        (function ($, undefined) {
            ...
            $.each(["animation", "transition"],
                function (i, test) {
                    ...
                    $.each(vendorPrefixes,
                        function (j, prefix) {
                            if (undefined !== testElement.style[$.camelCase(prefix + testName)])
            ...
            ($.support.cssAnimations && "animation" === animationType)
                ...
                ($(this).context !== document &&
                  (duration =
                    3e3 *
                    parseFloat($(this).css(props[animationType].duration))),
                (0 === duration || undefined === duration || isNaN(duration)) &&
                  (duration = $.fn.animationComplete.defaultDuration)),
                    (timer = setTimeout(function () {
                        $(that).off(props[animationType].event), callback.apply(that);
                    },
                    duration)),
                    $(this).one(props[animationType].event,
                        function () {
                            clearTimeout(timer), callback.call(this,
                                arguments);
                        }))
                    : (setTimeout($.proxy(callback,
                        this),
                    0), $(this));
            }),
        ...
        (function ($, window, document, undefined) {
          ...
          ((ve = triggerVirtualEvent("v" + event.type,
            ...
            function handleTouchStart(event) {
                var target,
                    flags,
                    t,
                    touches = getNativeEvent(event).touches;
                touches &&
          1 === touches.length &&
          ...
          startResetTimer());
            ...
            function getSpecialEventObject(eventType) {
                ...
                return {
                    setup: function () {
                        hasVirtualBindings(this) || $.data(this,
                            dataPropertyName,
                            {}),
                        ($.data(this,
                            dataPropertyName)[eventType] = !0),
        ...
        (function ($, window, undefined) {
            ...
            ($.event.special.scrollstart = {
                ...
                setup: function () {
                    ...
                    $(thisObject).bind("touchmove scroll",
                        function (event) {
            ...
            ($.event.special.swipe = {
              ...
              delete events.swipe,
              events.length--,
              0 === events.length && $.removeData(this,
                  "mobile-events")),
                    context &&
                (context.start && $(this).off(touchStartEvent,
                    context.start),
                context.move && $document.off(touchMoveEvent,
                    context.move),
                context.stop && $document.off(touchStopEvent,
                    context.stop));
                },
            }),
            $.each(
        ...
        (initial_orientation_is_landscape =
          (ww = window.innerWidth || win.width()) >
            (wh = window.innerHeight || win.height()) && ww - wh > 50),
        ...
        ((orig = $.widget),
        function () {
            var constructor = orig.apply(this,
                    arguments),
            ...
            $.widget("mobile.page",
                {
                    ...
                    _createWidget: function () {
                        $.Widget.prototype._createWidget.apply(this,
                            arguments),
                        this._trigger("init");
                    },
                    _create: function () {
                        ...
                        "dialog" === $.mobile.getAttribute(this.element[0],
                            "role") &&
                $.mobile.dialog &&
                this.element.dialog();
                    },
                  ...
                  this.options.role,
                        ...
                        this.element
                            ...
                            .each(function () {
                                var $this = $(this),
                                    theme =
                      this.getAttribute(attrPrefix + "theme") || undefined;
        ...
        (function ($, undefined) {
            ...
            (url &&
              "#" !== url &&
              0 !== url.indexOf("#" + $.mobile.path.uiStateKey)) ||
              (url = location.href),
            this._handleNavigate(url,
              ...
              (to = $.mobile.path.isPath(to)
                ...
                history.stack[0].url !==
                  history.initialDst.replace($.mobile.dialogHashKey,
                      "") &&
              ...
              !1 === (to = this._handleDialog(changePageOptions,
                  data))) ||
              this._changeContent(
            ...
            page.jqmData("title",
              ...
              (fileUrl = $.mobile.path.getFilePath(
                ...
                this._include(content,
                    settings),
                absUrl.indexOf("&" + $.mobile.subPageUrlKey) > -1 &&
                ...
                deferred.resolve(absUrl,
                    ...
                    load: function (url, options) {
                        ...
                        if (
                            ...
                            settings.data &&
              "get" === settings.type &&
              ((absUrl = $.mobile.path.addSearchParams(absUrl,
                  settings.data)),
              (settings.data = undefined)),
                            settings.data && "post" === settings.type && (settings.reload = !0),
                            (fileUrl = this._createFileUrl(absUrl)),
                            (dataUrl = this._createDataUrl(absUrl)),
                            0 !== (content = this._find(absUrl)).length ||
              ...
              $.mobile.path.isFirstPageUrl(fileUrl))
                            ...
                            if ((this._getBase().reset(), content.length && !settings.reload))
                                return (
                                    ...
                                    deferred.resolve(absUrl,
                                        settings,
                                        content),
                                    void (settings.prefetch || this._getBase().set(url))
                                );
                            (triggerData = {
                                url: url,
                                absUrl: absUrl,
                ...
                $.mobile.allowCrossDomainPages ||
                $.mobile.path.isSameDomain($.mobile.path.documentUrl,
                    absUrl)
                    ? $.ajax({
                        url: fileUrl,
                        type: settings.type,
                  ...
                  from,
                    ...
                    _cssTransition: function (to, from, options) {
                        ...
                        this._triggerCssTransitionEvents(to,
                            ...
                            "before"),
                        this._hideLoading(),
                        (promise = new (this._getTransitionHandler(transition))(
                            transition,
                            reverse,
                            to,
                            from,
              ...
              $.mobile.changePage.apply(null,
                  pageTransitionQueue.pop());
                    ...
                    change: function (to, options) {
                        if (isPageTransitioning) pageTransitionQueue.unshift(arguments);
                        else {
                            var settings = $.extend({},
                            ...
                            this._triggerPageBeforeChange(to,
                                triggerData,
                                settings) &&
              ...
              "body" !== document.activeElement.nodeName.toLowerCase()
                ...
                !1 !== settings.changeHash && $.mobile.hashListeningEnabled
                    ? $.mobile.navigate(url,
                        ...
                        !0)
                    : toPage[0] !== $.mobile.firstPage[0] &&
                    $.mobile.navigate.history.add(url,
                        params)),
        ...
        (function ($, undefined) {
          ...
          ("string" != typeof ele.nodeName ||
            ...
            ($.mobile.loadPage = function (url, opts) {
                ...
                return (
                    (container =
            (opts = opts || {}).pageContainer || $.mobile.pageContainer),
          ...
          function (transition) {
            ...
            ($.mobile._registerInternalEvents = function () {
              ...
              !(
                ...
                !$.mobile.path.isPermittedCrossDomainRequest(documentUrl,
                    url)
              ) &&
                (calculateOnly ||
                ...
                $.mobile.document.delegate("form",
                    "submit",
                    function (event) {
                        var formData;
                        event.isDefaultPrevented() ||
              ((formData = getAjaxFormData($(this))) &&
                ($.mobile.changePage(formData.url,
                    formData.options),
                event.preventDefault()));
                    }),
                $.mobile.document.bind("vclick",
                    function (event) {
                        ...
                        if (!(event.which > 1) && $.mobile.linkBindingEnabled) {
                            if (
                                (($lastVClicked = $(target)), $.data(target,
                                    "mobile-button"))
                            ) {
                                if (!getAjaxFormData($(target).closest("form"),
                                    !0)) return;
                ...
                $.mobile.document.bind("click",
                    ...
                    httpCleanup(),
                                ...
                                if (
                                    ...
                                    $.mobile.ajaxEnabled || $.mobile.path.isEmbeddedPage(href))
                                ) {
                                    if (-1 !== href.search("#")) {
                                        if (!(href = href.replace(/[^#]*#/,
                                            "")))
                                            return void event.preventDefault();
                                        href = $.mobile.path.isPath(href)
                                            ? $.mobile.path.makeUrlAbsolute(href,
                                                baseUrl)
                                            : $.mobile.path.makeUrlAbsolute(
                                                "#" + href,
        ...
        (function ($, window, undefined) {
            ...
            $.extend($.mobile.Transition.prototype,
                ...
                !this.name ||
                "none" === this.name ||
                Math.max($.mobile.window.scrollTop(),
                    this.toScroll) >
        ...
        (function ($, undefined) {
          ...
          $.mobile.degradeInputs),
            ($.mobile.degradeInputsWithin = function (target) {
                ...
                ((findstr = (hasType =
                  (html = $("<div>").html(element.clone()).html()).indexOf(
                      " type=",
                  ) > -1)
                    ? /\s+type=["']?\w+['"]?/
                    : /\/?>/),
        ...
        (function ($, undefined) {
            ...
            $.widget("mobile.collapsible",
                {
                    ...
                    ($.mobile.collapsibleset ? ", :mobile-collapsibleset" : ""),
                        ...
                        this.options.enhanced
                            ? ((ui.heading = $(".ui-collapsible-heading",
                                this.element[0])),
            ...
            this._handleExpandCollapse(options.collapsed),
              ...
              elem.toggleClass("ui-corner-all",
                  hasCorners),
                        undefined !== opts.mini && anchor.toggleClass("ui-mini",
                            opts.mini);
                    },
                    _setOptions: function (options) {
        ...
        (function ($, undefined) {
            $.mobile.behaviors.addFirstLastClasses = {
                _getVisibles: function ($els, create) {
                    var visibles;
                    return (
                        (create || 0 === (visibles = $els.filter(":visible")).length) &&
                    ...
                    _create: function () {
                        ...
                        $navbtns.each(function () {
                            var icon = $.mobile.getAttribute(this,
                                    "icon"),
                                theme = $.mobile.getAttribute(this,
                                    "theme"),
                                classes = "ui-btn";
        ...
        (function ($, undefined) {
            ...
            (this._replaceDividers(), this._superApply(arguments));
                ...
                ((divider = document.createElement("li")).appendChild(
            ...
            $.widget("mobile.listview",
                ...
                (items = this._getChildrenByTagName(
                    ...
                    "LI",
                                ...
                                (item = items[idx]).className.match(rdivider)
                                    ? (hideDivider &&
                ...
                event.stopPropagation();
                        ...
                        _cacheVals: function () {
                            this._getInputSet().each(function () {
                                $(this).attr("data-" + $.mobile.ns + "cacheVal",
                                    this.checked);
                            });
                        },
        ...
        (function ($, undefined) {
            $.widget(
              ...
              "input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",
                  ...
                  (((bg = document.createElement("div")).className =
                  ...
                  $(bg).prependTo(slider));
                    ...
                    handle.attr("tabindex",
                        origTabIndex),
                                    control.attr("tabindex",
                                        "-1").focus(function () {
                                        $(this).blur(), handle.focus();
                                    }),
                                    (wrapper = document.createElement("div")).className =
                      "ui-slider-inneroffset",
                                ...
                                for (
                                    ...
                                    i = 0,
                                    optionsCount = (options = control.find("option")).length;
                                    i < optionsCount;
                                    i++
                                )
                                    (side = i ? "a" : "b"),
                                    (activeClass = i ? " " + $.mobile.activeBtnClass : ""),
                                    ((sliderImg = document.createElement("span")).className = [
                  ...
                  this._setDisabled(options.disabled),
                        ...
                        _controlChange: function (event) {
                            if (!1 === this._trigger("controlchange",
                                event)) return !1;
                ...
                (this.dragging && !this.options.disabled
                    ...
                    : void 0)
                        ...
                        refresh: function (val, isfromControl, preventInputUpdate) {
                            var left,
                                ...
                                bg,
                                self = this,
                                parentTheme = $.mobile.getAttribute(this.element[0],
                                    "theme"),
                  ...
                  isInput && parseFloat(control.attr("step")) > 0
                      ...
                      : 1),
                                ...
                                if (
                                    ...
                                    (pxStep =
                    (width = this.slider.width()) / ((max - min) / step)),
                                    !this.dragging ||
                    data.pageX < left - 8 ||
                  ...
                  pxStep > 1
                      ...
                      : Math.round(((data.pageX - left) / width) * 100);
                            } else
                                null == val &&
                  (val = isInput
              ...
              dstOffset.left + (this.handle.width() - this._popup.width()) / 2,
                ...
                popup.clone())
                    ...
                    _refresh: function () {
                        ...
                        (newValue = this._value()) !== this._currentValue &&
                ...
                $.extend(
                    {
                        ...
                        _create: function () {
                            var $el = this.element,
                                ...
                                _sliderWidgetFirst =
                  $.data(_inputFirst.get(0),
                      "mobile-slider") ||
                  $.data(_inputFirst.slider().get(0),
                      "mobile-slider"),
                                _sliderWidgetLast =
                  $.data(_inputLast.get(0),
                      "mobile-slider") ||
                  $.data(_inputLast.slider().get(0),
                      "mobile-slider"),
                  ...
                  ("last" === this._proxy && !first))
                        ...
                        _slidebeforestart: function (event) {
                            (this._sliderTarget = !1),
                            $(event.originalEvent.target).hasClass("ui-slider-track") &&
        ...
        (function ($, undefined) {
            ...
            this._timeout());
              ...
              (parseFloat(this.element.css("border-top-width")) +
                parseFloat(this.element.css("border-bottom-width"))) +
              15),
                        0 === clientHeight &&
              (height +=
                parseFloat(this.element.css("padding-top")) +
        ...
        (function ($, undefined) {
            ...
            $.mobile.hashListeningEnabled),
              ...
              ui.placeholder
                  .attr("id",
                      myId + "-placeholder")
                  .html("\x3c!-- placeholder for " + myId + " --\x3e")),
                    ...
                    _handleDocumentFocusIn: function (theEvent) {
                        ...
                        if (this._isOpen) {
                            if (targetElement !== ui.container[0]) {
                                if (
                                    0 ===
                (target = $(targetElement)).parents().filter(ui.container[0])
                    .length
                                )
                                    return (
                                        $(this.document[0].activeElement).one("focus",
                                            function () {
                                                target.blur();
                                            }),
            ...
            this._fallbackTransition)
                            ? this._ui.container
                                ...
                                .removeClass(args.classToRemove)
                                .animationComplete(
                                    $.proxy(args.prerequisites.container,
                                        "resolve"),
                                )
            ...
            theEvent &&
              ...
              (toUrl =
                (parsedDst = $.mobile.path.parseUrl(parsedDst)).pathname +
                parsedDst.search +
                parsedDst.hash),
            ...
            this._close(immediate));
                  ...
                  urlHistory.activeIndex > 0
                                    ...
                                    : (-1 !== url.indexOf(hashkey) || currentIsDialog
                                        ? (url = $.mobile.path.parseLocation().hash + hashkey)
                                        : (url +=
                            url.indexOf("#") > -1 ? hashkey : "#" + hashkey),
            ...
            $.mobile.document.on("pagebeforechange",
          ...
          ".ui-disabled,.ui-state-disabled,.ui-li-divider,.ui-screen-hidden,:jqmData(role='placeholder')",
                            ...
                            this.list.delegate(
                                ...
                                function (event) {
                                    var oldIndex = self.select[0].selectedIndex,
                                        newIndex = $.mobile.getAttribute(this,
                                            "option-index"),
            ...
            (selector = this.list.find(
                "li:not(" + unfocusableItemSelector + ") a.ui-btn",
                    ...
                    _decideFormat: function () {
                        var $window = this.window,
                            menuHeight = this.list.parent().outerHeight(),
                ...
                this.thisPage.one("pagehide",
                    function () {
                        $(this).jqmData("lastScroll",
                            ...
                            this.menuPage.find("div .ui-title").text(this.label.text()))
                            : ((this.menuType = "overlay"),
                            this.listbox.one({
                                popupafteropen: $.proxy(this,
                                    "_focusMenuItem"),
                            }));
                    },
                    _buildList: function () {
                        ...
                        for (
                            ...
                            (option = $options[i]),
                            ($option = $(option)).hasClass("ui-screen-hidden") ||
                ((parent = option.parentNode),
                (text = $option.text()),
                (classes = []),
                (anchor = document.createElement("a")).setAttribute(
                    "href",
                    "#",
                ),
                ...
                parent !== select &&
                  ...
                  (optLabel = parent.getAttribute("label")) !== optGroup &&
                  ((divider = document.createElement("li")).setAttribute(
                      dataRoleAttr,
                      "list-divider",
                  ),
                ...
                option.disabled &&
                  ...
                  item.setAttribute("aria-disabled",
                      !0)),
                item.setAttribute(dataIndexAttr,
                    i),
                item.setAttribute(dataIconAttr,
                    "false"),
            ...
            $.widget("mobile.toolbar",
                {
                    ...
                    _create: function () {
                        var role = this.element.is(":jqmData(role='header')")
                                ? "header"
                                : "footer",
        ...
        (function ($, undefined) {
            ...
            this.updatePagePadding(this.page ? this.page : ".ui-page-active");
              ...
              ((thisFooter = $(".ui-footer-fixed:jqmData(id)",
                  this.page)),
              (thisHeader = $(".ui-header-fixed:jqmData(id)",
                  this.page)),
              (nextFooter =
                (thisFooter.length &&
                  ui.nextPage &&
            ...
            ((this.options.transition &&
              ...
              "out" + ("slide" === this.options.transition ? " reverse" : "");
                ...
                !$(e.target).closest(".ui-header-fixed, .ui-footer-fixed")
                    .length &&
        ...
        (function ($, undefined) {
            ...
            $.widget("mobile.popup",
              ...
              undefined !== opts.shadow &&
                ar.ar.toggleClass("ui-overlay-shadow",
                    opts.shadow)),
                            ret
                        );
                    },
        ...
        (function ($, undefined) {
            ...
            (0 ===
              $("body > :mobile-panel")
                  ...
                  .not(this.element).length && this._wrapper.children().unwrap(),
            this._open &&
                    ...
                    _refresh: function () {
                        ...
                        trs.each(function () {
                            ...
                            $(this)
                                ...
                                .each(function () {
                                    var j,
                                        span = parseInt(this.getAttribute("colspan"),
                                            10),
              ...
              this._setToggleState());
                    ...
                    _addToggles: function (menu, keep) {
                        ...
                        this.headers.not("td").each(function () {
                            var header = $(this),
                                priority = $.mobile.getAttribute(this,
                                    "priority"),
                ...
                (keep
                    ...
                    : $(
                        ...
                        .appendTo(container)
                        .children(0)
                        .checkboxradio({ theme: opts.columnPopupTheme })
                ).jqmData("cells",
                    cells));
                        }),
                ...
                this._updateReflow()));
                    ...
                    _updateReflow: function () {
                        ...
                        $(table.allHeaders.get().reverse()).each(function () {
                            var iteration,
                                filter,
                                cells = $(this).jqmData("cells"),
                                colstart = $.mobile.getAttribute(this,
                                    "colstart"),
                                hierarchyClass =
                    ...
                    _onKeyUp: function () {
                        ...
                        if (search) {
                            if (
                                ...
                                (lastval = $.mobile.getAttribute(search[0],
                                    "lastval") + "") &&
                lastval === val)
                            )
                                return;
     ...
     */
            ...
            $.widget("ui.tabs",
              ...
              (null !== active && -1 !== active) ||
                (active = !!this.tabs.length && 0)),
                            !1 !== active &&
              -1 === (active = this.tabs.index(this.tabs.eq(active))) &&
                    ...
                    _processTabs: function () {
                        ...
                        this.anchors.each(function (i, anchor) {
                            ...
                            isLocal(anchor)
                                ...
                                (panel = that.element.find(selector)).length ||
                    (panel = that._createPanel(panelId)).insertAfter(
      ...
      ua.indexOf("AppleWebKit") > -1
        ...
        (function ($, window, undefined) {
          ...
          $.extend($.mobile,
              {
                ...
                ($pages = $("body")
                    ...
                    .children(0)),
                      $pages.each(function () {
                          var $this = $(this);
                          $this[0].getAttribute("data-" + $.mobile.ns + "url") ||
                    $this.attr(
                        "data-" + $.mobile.ns + "url",
          ...
          $(function () {
              $.support.inlineSVG(),
              $.mobile.hideUrlBar && window.scrollTo(0,
                  1),
              ($.mobile.defaultHomeScroll =
