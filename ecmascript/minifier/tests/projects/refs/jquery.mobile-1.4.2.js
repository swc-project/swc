    ...
    (jQuery.mobile = {}),
                        ...
                        if ("string" == typeof key)
                            if (
                                ...
                                if (((key = parts.pop()), undefined === value))
                                    return undefined === curOption[key]
                                        ? null
                                        : curOption[key];
                                curOption[key] = value;
                            } else {
                        ...
                        "boolean" != typeof suppressDisabledCheck &&
                            ...
                            $.each(handlers, function (event, handler) {
                                ...
                                var match = event.match(/^(\w+)\s*(.*)$/),
                                    eventName =
                                        match[1] + instance.eventNamespace,
                                    selector = match[2];
                                selector
            ...
            $.extend($.mobile, { browser: {} }),
                ...
                $.extend($.support, {
                    ...
                    fixedPosition:
                        ...
                        (omversion =
                            !!operammobilematch && operammobilematch[1]),
                        !(
                    ...
                    dynamicBaseTag:
                        ...
                        (rebase = $("<a href='testurl' />").prependTo(
                            fakeBody
                        )[0].href),
        ...
        (function ($, undefined) {
            ...
            ($.mobile.path = path = {
                ...
                isExternal: function (url) {
                    var u = path.parseUrl(url);
                    return !(
                        !u.protocol || u.domain === this.documentUrl.domain
                    );
                },
                    ...
                    return (
                        ...
                        isPath
                            ? ((path.isPath(preservedHash) ||
                              ...
                              uiState &&
                                  -1 ===
                                      preservedHash.indexOf(this.uiStateKey) &&
                ...
                getFilePath: function (path) {
                    ...
                    return (
                        path &&
                        path.split(splitkey)[0].split("&ui-state=dialog")[0]
                    );
                },
                ...
                isPermittedCrossDomainRequest: function (docUrl, reqUrl) {
                    return (
                        ...
                        ("file:" === docUrl.protocol ||
                            "content:" === docUrl.protocol) &&
                ...
                (path.documentBaseDiffers =
                    path.documentUrl.hrefNoHash !==
                    path.documentBase.hrefNoHash),
                ...
                $.extend($.mobile.Navigator.prototype, {
                    ...
                    hash: function (url, href) {
                        ...
                        return (
                            ...
                            (loc = path.parseLocation()).pathname +
                                loc.search ===
                    ...
                    go: function (url, data, noEvents) {
                        ...
                        (href = path.squash(url)),
                            ...
                            noEvents &&
                                hash !==
                                    path.stripHash(path.parseLocation().hash) &&
        ...
        (function ($, undefined) {
            ...
            $.each(["animation", "transition"], function (i, test) {
                ...
                ($.support.cssTransitions =
                    undefined !== props.transition.prefix),
                ($.support.cssAnimations =
                    undefined !== props.animation.prefix),
                $(testElement).remove(),
        ...
        (function ($, window, document, undefined) {
            var threshold,
                ...
                mouseHookProps = $.event.mouseHooks
            ...
            function clearResetTimer() {
                resetTimerID &&
                    (clearTimeout(resetTimerID), (resetTimerID = 0));
            }
                    ...
                    ((flags && flags[eventType]) ||
                        ...
                        ((ve = (function (event, eventType) {
                            ...
                            if (
                                ...
                                for (
                                    j = 0, len = touchEventProps.length;
                                    j < len;
                                    j++
                                )
                                    event[(prop = touchEventProps[j])] =
                                        touch[prop];
                            return event;
                        })(event, eventType)),
            ...
            $.widget("mobile.pagecontainer", {
                ...
                _filterNavigateEvents: function (e, data) {
                    ...
                    (e.originalEvent && e.originalEvent.isDefaultPrevented()) ||
                        ...
                        (url &&
                            "#" !== url &&
                            0 !==
                                url.indexOf("#" + $.mobile.path.uiStateKey)) ||
                            (url = location.href),
                ...
                _handleNavigate: function (url, data) {
                    var to = $.mobile.path.stripHash(url),
                        history = this._getHistory(),
                        transition =
                            0 === history.stack.length ? "none" : undefined,
                        changePageOptions = {
                            changeHash: !1,
                            fromHashChange: !0,
                            reverse: "back" === data.direction,
                ...
                _isRewritableBaseTag: function () {
                    return (
                        $.mobile.dynamicBaseEnabled && !$.support.dynamicBaseTag
                    );
                },
                    ...
                    return $.proxy(function (html, textStatus, xhr) {
                        ...
                        pageElemRegex.test(html) &&
                            ...
                            this._trigger("load", undefined, triggerData) &&
                                ...
                                absUrl.indexOf("&" + $.mobile.subPageUrlKey) >
                                    -1 &&
                ...
                load: function (url, options) {
                    var content,
                        ...
                        triggerData,
                        deferred =
                            (options && options.deferred) || $.Deferred(),
                ...
                change: function (to, options) {
                    if (isPageTransitioning)
                        ...
                        var settings = $.extend(
                            ...
                            triggerData = {};
                        (settings.fromPage =
                            settings.fromPage || this.activePage),
                    ...
                    if (isPageTransitioning)
                        ...
                        if (
                            ...
                            toPage[0] !== $.mobile.firstPage[0] ||
                                settings.dataUrl ||
                                (settings.dataUrl =
                                    $.mobile.path.documentUrl.hrefNoHash),
                        ...
                        (alreadyThere = !1),
                            isDialog &&
                                active &&
                                (active.url &&
                                    active.url.indexOf($.mobile.dialogHashKey) >
                                        -1 &&
                                    this.activePage &&
                    ...
                    (target = $(target))
                        ...
                        .each(function () {
                            var html,
                                ...
                                optType =
                                    $.mobile.degradeInputs[type] || "text";
                    ...
                    $target.length &&
                        ...
                        (((attrs = {})["data-" + $.mobile.ns + "transition"] =
                            ($.mobile.navigate.history.getActive() || {})
                                .transition ||
                            $.mobile.defaultDialogTransition),
                        (attrs["data-" + $.mobile.ns + "direction"] =
                            "reverse"),
                        $target.attr(attrs));
                },
                _create: function () {
        ...
        (function ($, undefined) {
            var rInitialLetter = /([A-Z])/g,
                iconposClass = function (iconpos) {
                    return (
                        "ui-btn-icon-" + (null === iconpos ? "left" : iconpos)
                    );
                };
                ...
                _getOptions: function (options) {
                    ...
                    options))
                        (options[key] =
                            ...
                            null == options[key] &&
                                (options[key] =
                                    $.mobile.collapsible.defaults[key]);
                    return options;
                },
                    ...
                    ui.status.text(
                        ...
                        ui.heading
                            ...
                            .toggleClass(
                                "ui-icon-" + opts.collapsedIcon,
                                isCollapse ||
                                    opts.expandedIcon === opts.collapsedIcon
                            )
            ...
            $.mobile.behaviors.addFirstLastClasses = {
                _getVisibles: function ($els, create) {
                    ...
                    return (
                        (create ||
                            0 ===
                                (visibles = $els.filter(":visible")).length) &&
                            ...
                            for (
                                ...
                                (item = li.eq(pos)),
                                    ...
                                    (create ||
                                        ...
                                        a.length &&
                                        a[0].className.search(/\bui-btn\b/) <
                                            0 &&
                                        !isDivider
                                            ? ((icon =
                                                  !1 !==
        ...
        (function ($, undefined) {
            $.widget("mobile.listview", $.mobile.listview, {
                ...
                _replaceDividers: function () {
                    ...
                    for (
                        list
                            .children("li:jqmData(role='list-divider')")
                            .remove(),
                ...
                $.extend(
                    {
                                ...
                                for (
                                    (origTabIndex = control.attr("tabindex")) &&
                                        ...
                                        (wrapper = document.createElement(
                                            "div"
                                        )).className = "ui-slider-inneroffset",
                                        j = 0,
                        ...
                        _controlChange: function (event) {
                            if (!1 === this._trigger("controlchange", event))
                                return !1;
                        ...
                        refresh: function (
                            ...
                            var left,
                                ...
                                trackTheme =
                                    this.options.trackTheme || parentTheme,
                                trackThemeClass = trackTheme
                                    ? " ui-bar-" + trackTheme
                                    : " ui-bar-inherit",
                            ...
                            if (
                                ...
                                (step =
                                    isInput &&
                                    parseFloat(control.attr("step")) > 0
                        ...
                        "showValue" === key
                            ...
                            : "popupEnabled" === key &&
                              ...
                              (this._popup = (popup ||
                                  (popup = $("<div></div>", {
                                      class:
                                          "ui-slider-popup ui-shadow ui-corner-all",
                                  })),
                              popup.clone())
                                  .addClass(
                ...
                $.extend(
                    {
                        ...
                        _setOptions: function (options) {
                            ...
                            undefined !== options.onText &&
                                this.on.text(options.onText),
                                undefined !== options.offText &&
        ...
        (function ($, undefined) {
            $.widget("mobile.textinput", $.mobile.textinput, {
                ...
                _create: function () {
                    this._super(),
                        (this.options.clearBtn || this.isSearch) &&
                            this._addClearBtn();
                },
            ...
            $.widget("mobile.popup", {
                ...
                _desiredCoords: function (openOptions) {
                    ...
                    if (pTo && "origin" !== pTo)
                        if ("window" === pTo)
                            (x =
                                windowCoordinates.cx / 2 + windowCoordinates.x),
                                (y =
                                    windowCoordinates.cy / 2 +
                                    windowCoordinates.y);
                        else {
                            try {
                                dst = $(pTo);
                    ...
                    return (
                        ...
                        ("number" !== $.type(y) || isNaN(y)) &&
                            (y =
                                windowCoordinates.cy / 2 + windowCoordinates.y),
                        { x: x, y: y }
                    );
                },
                    ...
                    (openOptions = {
                        ...
                        this._ui.container.offset(
                            this._placementCoords(
                                this._desiredCoords(openOptions)
                            )
                        );
                },
                              ...
                              ? ((urlHistory = $.mobile.navigate.history),
                                ...
                                urlHistory.activeIndex > 0
                                    ? (self._open(options),
                                      ...
                                      this)
                                    : (-1 !== url.indexOf(hashkey) ||
                                      currentIsDialog
                                          ? (url =
                                                $.mobile.path.parseLocation()
                                                    .hash + hashkey)
                                          : (url +=
                                                url.indexOf("#") > -1
                                                    ? hashkey
                ...
                ($.mobile.popup.handleLink = function ($link) {
                    var offset,
                        ...
                        popup = $(
                            path.hashToSelector(
                                path.parseUrl($link.attr("href")).hash
                            )
                        ).first();
                    popup.length > 0 &&
                              ...
                              function (event) {
                                  var oldIndex = self.select[0].selectedIndex,
                                      ...
                                      option = self
                                          ...
                                          .eq(newIndex)[0];
                                  (option.selected =
                                      !self.isMultiple || !option.selected),
                                      self.isMultiple &&
                                          $(this)
                                              .find("a")
                                              .toggleClass(
                    ...
                    for (
                        ...
                        (option = $options[i]),
                            ($option = $(option)).hasClass(
                                ...
                                isPlaceholderItem &&
                                    item.setAttribute(dataPlaceholderAttr, !0),
            ...
            $.widget("mobile.toolbar", {
                ...
                _addHeaderButtonClasses: function () {
                    ...
                    (this.leftbtn = $headeranchors.hasClass("ui-btn-left")),
                        ...
                        (this.rightbtn =
                            this.rightbtn ||
                            $headeranchors.eq(1).addClass("ui-btn-right")
                                .length);
                },
                ...
                hide: function (notransition) {
                    ...
                    this._useTransition(notransition)
                        ? $el
                              ...
                              .removeClass("in")
                              .animationComplete(function () {
                                  $el.addClass("ui-fixed-hidden").removeClass(
                                      outclass
                                  );
                              })
                ...
                _bindToggleHandlers: function () {
                    ...
                    (this.page ? this.page : $(".ui-page"))
                        .bind("vclick", function (e) {
                            o.tapToggle &&
                                !$(e.target).closest(o.tapToggleBlacklist)
                                    .length &&
                                self.toggle();
                        })
            ...
            $.widget("mobile.toolbar", $.mobile.toolbar, {
                ...
                _workarounds: function () {
                    ...
                    if ("ios" === os) this._bindScrollWorkaround();
                        ...
                        if (!("android" === os && wkversion && wkversion < 534))
                            return;
            ...
            $.widget("mobile.popup", $.mobile.popup, {
                ...
                _tryAnArrow: function (p, dir, desired, s, best) {
                    ...
                    return (
                        s.arFull[p.dimKey] > s.guideDims[p.dimKey] ||
                            ...
                            (tip[p.fst] =
                                r[p.fst] + s.contentBox[p.fst] + p.tipOffset),
                            (tip[p.snd] = Math.max(
                                result[p.prop] +
                            ...
                            (diff =
                                Math.abs(desired.x - tip.x) +
                                Math.abs(desired.y - tip.y)),
                            (!best || diff < best.diff) &&
                                ((tip[p.snd] -=
                                    s.arHalf[p.dimKey] +
                                    result[p.prop] +
                        ...
                        ? (ar.arEls.show(),
                          ...
                          (params = {
                              ...
                              r: {
                                  ...
                                  offsetFactor: -1,
                                  tipOffset:
                                      state.arHalf.cx + state.contentBox.cx,
                                  arrowOffsetFactor: 1,
                              },
                              b: {
                                  fst: "y",
                                  ...
                                  offsetFactor: -1,
                                  tipOffset:
                                      state.arHalf.cy + state.contentBox.cy,
                                  arrowOffsetFactor: 1,
                              },
                              t: {
                                  fst: "y",
                              ...
                              ? (ar.ct
                                ...
                                ieHack ||
                                    ...
                                    (bgRef[params[best.dir].snd] = {
                                        left:
                                            elOffset.left + state.contentBox.x,
                ...
                _setOptions: function (opts) {
                    ...
                    if (undefined !== opts.arrow) {
                        ...
                        ar &&
                            !opts.arrow &&
                            (ar.arEls.remove(), (this._ui.arrow = null));
                    }
                    return (
                        (ar = this._ui.arrow) &&
                            (undefined !== opts.theme &&
            ...
            $.widget("mobile.filterable", {
                ...
                _getFilterableItems: function () {
                    var elem = this.element,
                        ...
                        items = children
                            ...
                            : { length: 0 };
                    return (
                        0 === items.length && (items = elem.children()), items
                    );
                },
                _filterItems: function (val) {
                    ...
                    if (null != val)
                        for (
                            callback =
                                opts.filterCallback || defaultFilterCallback,
                                length = filterItems.length,
                                idx = 0;
                            idx < length;
                            idx++
                        )
                            (callback.call(filterItems[idx], idx, val)
                                ? hide
                                : show
                            ).push(filterItems[idx]);
                    0 === hide.length
                        ? filterItems[
                              opts.filterReveal ? "addClass" : "removeClass"
                          ]("ui-screen-hidden")
                ...
                $.widget("mobile.filterable", $.mobile.filterable, {
                    ...
                    _handleCreate: function (evt) {
                        this._setWidget(
                            this.element.data(
                                "mobile-" +
                                    evt.type.substring(0, evt.type.length - 6)
                            )
                        );
                    },
                    _trigger: function (type, event, data) {
                ...
                _eventHandler: function (event) {
                    ...
                    event.preventDefault(),
                        tab.hasClass("ui-state-disabled") ||
                            ...
                            ((options.active =
                                !collapsing && this.tabs.index(tab)),
