(function () {
        ...
        return null == obj
            ...
            : nativeEvery && obj.every === nativeEvery
                ...
                : (each(obj,
                    function (value, index, list) {
                        if (
                            !(result = result && iterator.call(context,
                                value,
                                index,
                                list))
                        )
    ...
    (_.invoke = function (obj, method) {
        ...
        return _.map(obj,
            function (value) {
                return (isFunc ? method : value[method]).apply(value,
                    args);
            });
    }),
            ...
            _.map(obj,
                function (value, index, list) {
                    return {
                        value: value,
                        index: index,
                        criteria: iterator.call(context,
                            value,
                            index,
                            list),
                    };
    ...
    (_.sortedIndex = function (array, obj, iterator, context) {
        for (
            var value = (iterator =
            null == iterator ? _.identity : lookupIterator(iterator)).call(
                    context,
                    obj,
                ),
                low = 0,
    ...
    (_.indexOf = function (array, item, isSorted) {
        ...
        if (isSorted) {
            if ("number" != typeof isSorted)
                return array[(i = _.sortedIndex(array,
                    item))] === item
                    ? i
                    : -1;
            i = isSorted < 0
    ...
    _.each(["escape", "unescape",],
        function (method) {
            _[method] = function (string) {
                return null == string
                    ? ""
                    : ("" + string).replace(entityRegexes[method],
                        function (match) {
