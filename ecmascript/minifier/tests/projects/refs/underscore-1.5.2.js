(function () {
        ...
        (_.sortedIndex = function (array, obj, iterator, context) {
            for (
                var value = (iterator =
                        null == iterator
                            ? _.identity
                            : lookupIterator(iterator)).call(context, obj),
                    low = 0,
                    high = array.length;
                low < high;
        ...
        (_.indexOf = function (array, item, isSorted) {
            ...
            if (isSorted) {
                if ("number" != typeof isSorted)
                    return array[(i = _.sortedIndex(array, item))] === item
                        ? i
                        : -1;
    ...
    var eq = function (a, b, aStack, bStack) {
        ...
        if ("[object Array]" == className) {
            if ((result = (size = a.length) == b.length))
                for (
                    ;
                    size-- && (result = eq(a[size], b[size], aStack, bStack));
    ...
    (_.isEqual = function (a, b) {
        ...
        (_.times = function (n, iterator, context) {
            for (var accum = Array(Math.max(0, n)), i = 0; i < n; i++)
