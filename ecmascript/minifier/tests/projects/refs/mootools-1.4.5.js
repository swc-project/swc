                ...
                if (usePlural || "string" != typeof a) {
                    ...
                    if (enumerables)
                        for (var i = enumerables.length; i--; )
                            (k = enumerables[i]),
                                a.hasOwnProperty(k) && self.call(this, k, a[k]);
    ...
    var force = function (name, object, methods) {
        ...
        for (var i = 0, l = methods.length; i < l; i++) {
            ...
            generic && generic.protect(),
                isType && proto && object.implement(key, proto.protect());
        }
        if (isType) {
    ...
    Array.implement({
        every: function (fn, bind) {
            for (var i = 0, l = this.length >>> 0; i < l; i++)
                if (i in this && !fn.call(bind, this[i], i, this)) return !1;
            return !0;
        },
        filter: function (fn, bind) {
            for (
                var value, results = [], i = 0, l = this.length >>> 0;
                i < l;
                i++
            )
                i in this &&
                    ((value = this[i]),
                    fn.call(bind, value, i, this) && results.push(value));
            return results;
        },
        ...
        map: function (fn, bind) {
            for (
                ...
                i in this && (results[i] = fn.call(bind, this[i], i, this));
            return results;
        },
        ...
        rgbToHex: function (array) {
            ...
            if (4 == this.length && 0 == this[3] && !array)
                return "transparent";
            ...
            return (
                ...
                function (event) {
                    ...
                    return options.delay
                        ? setTimeout(returns, options.delay)
                        : options.periodical
                        ? setInterval(returns, options.periodical)
                        : options.attempt
        ...
        toQueryString: function (object, base) {
            ...
            return (
                Object.each(object, function (value, key) {
                    var result;
                    switch (
                        (base && (key = base + "[" + key + "]"), typeOf(value))
                    ) {
                        case "object":
    ...
    (function () {
        var XMLHTTP,
            ...
            Browser = (this.Browser = {
                ...
                version:
                    mode ||
                    parseFloat("opera" == UA[1] && UA[4] ? UA[4] : UA[2]),
                Platform: {
        ...
        (Browser[Browser.name] = !0),
            (Browser[Browser.name + parseInt(Browser.version, 10)] = !0),
            ...
            String.implement("stripScripts", function (exec) {
                ...
                return (
                    !0 === exec
                        ...
                        : "function" == typeOf(exec) && exec(scripts, text),
                    text
                );
            }),
            Browser.extend({
        ...
        Browser.Platform.ios && (Browser.Platform.ipod = !0),
            (Browser.Engine = {});
        ...
        var _keys = {},
            DOMEvent = (this.DOMEvent = new Type(
                ...
                function (event, win) {
                    if (
                        (win || (win = window),
                        (event = event || win.event).$extended)
                    )
                        return event;
                    (this.event = event),
                        (this.$extended = !0),
                    ...
                    if (
                        ...
                        (this.key =
                            _keys[code] || Object.keyOf(Event.Keys, code)),
                            "keydown" == type &&
                                (code > 111 && code < 124
                                    ? (this.key = "f" + (code - 111))
                                    : code > 95 &&
                        ...
                        0 == type.indexOf("touch") ||
                        0 == type.indexOf("gesture")
                    ) {
...
(Event.Keys = {}),
        ...
        var Class = (this.Class = new Type("Class", function (params) {
            ...
            implement = function (key, value, retain) {
                if (
                    ...
                    null == (value = Class.Mutators[key].call(this, value))
                )
                    return this;
                ...
                Implements: function (items) {
                    Array.from(items).each(function (item) {
                        ...
                        for (var key in instance)
                            implement.call(this, key, instance[key], !0);
                    }, this);
                },
            });
    })(),
    (function () {
        ...
        (this.Events = new Class({
            ...
            removeEvents: function (events) {
                ...
                for (type in (events && (events = removeOn(events)),
                this.$events))
                    if (!events || events == type)
                        for (
                            var fns = this.$events[type], i = fns.length;
                            i--;

                        )
                            i in fns && this.removeEvent(type, fns[i]);
                return this;
            },
        })),
    ...
    function () {
        var parsed,
            ...
            parse = function (expression, isReversed) {
                ...
                var currentCache = (reversed = !!isReversed)
                    ? reverseCache
                    : cache;
                ...
                for (
                    parsed = {
                        ...
                        separatorIndex = -1;
                    expression !=
                    (expression = expression.replace(regexp, parser));
        ...
        function parser(
            ...
            var currentParsed =
                parsed.expressions[separatorIndex][combinatorIndex];
    ...
    function () {
                    ...
                    if (features)
                        ...
                        if (features.isHTMLDocument) {
                            (testNode.style.display = "none"),
                                ...
                                (starSelectsComments =
                                    testNode.getElementsByTagName("*").length >
                                    1);
                            try {
                            ...
                            if (testNode.getElementsByClassName) {
                                try {
                                    (testNode.innerHTML =
                                        '<a class="f"></a><a class="b"></a>'),
                                        testNode.getElementsByClassName("b")
                                            .length,
                                ...
                                try {
                                    (testNode.innerHTML =
                                        ...
                                        (brokenSecondClassNameGEBCN =
                                            2 !=
                                            testNode.getElementsByClassName("a")
                                                .length);
                                } catch (e) {}
                            ...
                            try {
                                (testNode.innerHTML =
                                    ...
                                    (brokenFormAttributeGetter =
                                        "s" !=
                                        testNode.firstChild.getAttribute(
                                            "action"
                                        ));
                            } catch (e) {}
                            if (
                        ...
                        testRoot.removeChild(testNode),
                            ...
                            (features.getAttribute =
                                ...
                                brokenFormAttributeGetter
                                    ? function (node, name) {
                                          var method = this.attributeGetters[
                                              name
                                          ];
        ...
        (local.search = function (context, expression, append, first) {
            ...
            if ("string" == typeof expression) {
                ...
                simpleSelectors: if (simpleSelector) {
                    ...
                    if (symbol) {
                        if ("#" == symbol) {
                            ...
                            if (!(node = context.getElementById(name)))
                                return found;
                            if (
                                this.idGetsName &&
                ...
                querySelector: if (context.querySelectorAll) {
                    ...
                    if (!contextIsDocument) {
                        ...
                        _context.setAttribute("id", "slickid__"),
                ...
                if (!(parsed = this.Slick.parse(expression)).length)
                    return found;
            } else {
            ...
            return (
                (hasOthers || parsed.expressions.length > 1) &&
                    this.sort(found),
            ...
            (local.matchNode = function (node, selector) {
                ...
                var item,
                    nodes = this.search(this.document, parsed);
            ...
            (local.matchSelector = function (
                ...
                if (pseudos)
                    for (i = pseudos.length; i--; )
                        if (
                            ((part = pseudos[i]),
                            !this.matchPseudo(node, part.key, part.value))
                        )
                            return !1;
                return !0;
            });
        ...
        var pseudos = {
            ...
            contains: function (node, text) {
                return (
                    (node.innerText || node.textContent || "").indexOf(text) >
                    -1
                );
            },
            ...
            focus: function (node) {
                return (
                    ...
                    (node.href ||
                        node.type ||
                        this.hasAttribute(node, "tabindex"))
                );
            },
            root: function (node) {
...
(Elements.prototype = { length: 0 }),
    ...
    new Type("Elements", Elements).implement({
        ...
        push: function () {
            for (
                var length = this.length, i = 0, l = arguments.length;
                i < l;
                i++
            ) {
    ...
    (function () {
                    ...
                    ((types = {
                        ...
                        object: function (obj, nocash, doc) {
                            return obj.toElement
                                ? types.element(obj.toElement(doc), nocash)
                                : null;
                        },
                    }),
        ...
        document.contains || Document.implement(contains),
            ...
            (function (search, find, match) {
                ...
                (Slick.search = function (context, expression, append) {
                    return (
                        addSlickPseudos(),
                        search.call(this, context, expression, append)
                    );
                }),
                    (Slick.find = function (context, expression) {
                        return (
                            addSlickPseudos(),
                            find.call(this, context, expression)
                        );
                    }),
                    (Slick.match = function (node, selector) {
                        return (
                            addSlickPseudos(), match.call(this, node, selector)
                        );
                    });
        ...
        (inserters.inside = inserters.bottom),
            Object.each(inserters, function (inserter, where) {
                var methods = {};
                (methods["inject" + (where = where.capitalize())] = function (
                    el
                ) {
        ...
        var pollutesGetAttribute = (function (div) {
            return (
                ...
                "attribute" == div.getAttribute("random")
            );
        ...
        Element.implement({
            ...
            grab: function (el, where) {
                return (
                    inserters[where || "bottom"](document.id(el, !0), this),
                    this
                );
            },
            inject: function (el, where) {
                return (
                    inserters[where || "bottom"](this, document.id(el, !0)),
                    this
                );
            },
            replaces: function (el) {
                return (
                    (el = document.id(el, !0)).parentNode.replaceChild(
                        this,
                        el
                    ),
                    this
            ...
            wraps: function (el, where) {
                return (
                    (el = document.id(el, !0)),
                    this.replaces(el).grab(el, where)
                );
            },
            ...
            toQueryString: function () {
                var queryString = [];
                return (
                    this.getElements("input, select, textarea").each(function (
                        el
                    ) {
                        var type = el.type;
                        if (
    ...
    (function () {
            ...
            getOpacity = hasOpacity
                ...
                : function (element) {
                      ...
                      return (
                          null == opacity &&
                              (opacity =
                                  "hidden" == element.style.visibility ? 0 : 1),
                          opacity
                      );
                  },
        ...
        Element.implement({
            ...
            getStyle: function (property) {
                ...
                if (result) {
                    var color = (result = String(result)).match(
                        /rgba?\([\d\s,]+\)/
                    );
                    color &&
            ...
            ["Top", "Right", "Bottom", "Left"].each(function (direction) {
                ...
                var bdw = bd + "Width",
                    ...
                    bdc = bd + "Color";
                (Short[bd] = {}),
                    (Short.borderWidth[bdw] = Short[bd][bdw] = All[bdw] =
                        "@px"),
                    (Short.borderStyle[bds] = Short[bd][bds] = All[bds] = "@"),
                    (Short.borderColor[bdc] = Short[bd][bdc] = All[bdc] =
                        "rgb(@, @, @)");
            });
    })(),
    (function () {
            ...
            [Element, Window, Document].invoke("implement", {
                addEvent: function (type, fn) {
                    ...
                    var realType = type,
                        ...
                        self = this;
                    custom &&
                        (custom.onAdd && custom.onAdd.call(this, fn, type),
                        custom.condition &&
                            (condition = function (event) {
                                return (
                                    !custom.condition.call(this, event, type) ||
                                    fn.call(this, event)
                                );
                            }),
                        custom.base &&
            ...
            relay = function (old, method) {
                return function (type, fn, useCapture) {
                    ...
                    return (
                        ...
                        method.call(this, newType, parsed.pseudos[0].value, fn)
                    );
                };
            },
            delegation = {
                ...
                removeEvent: function (type, match, fn, _uid) {
                    ...
                    if (_uid) {
                        ...
                        return (
                            (type = _map.base || _type),
                            _map.remove && _map.remove(this, _uid),
                            delete stored[_uid],
                            (storage[_type] = stored),
                            removeEvent.call(this, type, delegator)
                        );
                    }
                    if (fn) {
                        for (__uid in stored)
        ...
        Element.implement({
            ...
            getOffsetParent: brokenOffsetParent
                ? function () {
                      ...
                      if (
                          isBody(element) ||
                          "fixed" == styleString(element, "position")
                      )
                          return null;
                      for (
                          var isOffsetCheck =
                              "static" == styleString(element, "position")
                                  ? isOffsetStatic
                                  : isOffset;
                          (element = element.parentNode);
                ...
                : function () {
                      if (
                          isBody(this) ||
                          "fixed" == styleString(this, "position")
                      )
                          return null;
                      try {
            ...
            getOffsets: function () {
                if (this.getBoundingClientRect && !Browser.Platform.ios) {
                    var bound = this.getBoundingClientRect(),
                        ...
                        isFixed = "fixed" == styleString(this, "position");
                    return {
                        x:
                            bound.left.toInt() +
                            elemScrolls.x +
                ...
                for (; element && !isBody(element); ) {
                    if (
                        ...
                        var parent = element.parentNode;
                        parent &&
                            "visible" != styleString(parent, "overflow") &&
        ...
        var Fx = (this.Fx = new Class({
            ...
            step: function (now) {
                if (this.options.frameSkip) {
                    var frames =
                        (null != this.time ? now - this.time : 0) /
                        this.frameInterval;
            ...
            check: function () {
                ...
                switch (this.options.link) {
                    ...
                    case "chain":
                        return (
                            this.chain(this.caller.pass(arguments, this)), !1
                        );
                }
                return !1;
            },
            start: function (from, to) {
                ...
                return (
                    (this.duration =
                        Fx.Durations[duration] || duration.toInt()),
            ...
            return (
                value.each(function (bit) {
                    returned = returned.concat(
                        bit.parser.serve(bit.value, unit)
                    );
                }),
                returned
            );
    ...
    (Fx.Morph = new Class({
        ...
        set: function (now) {
            for (var p in ("string" == typeof now && (now = this.search(now)),
            now))
    ...
    Fx.implement({
        getTransition: function () {
            var trans =
                this.options.transition || Fx.Transitions.Sine.easeInOut;
            if ("string" == typeof trans) {
                var data = trans.split(":");
                (trans =
                    (trans = Fx.Transitions)[data[0]] ||
        ...
        var empty = function () {},
            ...
            Request = (this.Request = new Class({
                ...
                send: function (options) {
                    ...
                    (this.options.isSuccess =
                        this.options.isSuccess || this.isSuccess),
                        (this.running = !0);
        ...
        ["get", "post", "put", "delete", "GET", "POST", "PUT", "DELETE"].each(
            function (method) {
                methods[method] = function (data) {
                    ...
                    return (
                        null != data && (object.data = data), this.send(object)
                    );
                };
            }
        ),
    ...
    (Request.JSON = new Class({
        ...
        success: function (text) {
            ...
            try {
                ...
                return void this.fireEvent("error", [text, error]);
            }
...
var Cookie = new Class({
    ...
    write: function (value) {
        if (
            ...
            var date = new Date();
            date.setTime(
                date.getTime() + 24 * this.options.duration * 60 * 60 * 1e3
            ),
        ...
        testElement.doScroll &&
            ...
            (Element.Events.load = {
                ...
                condition: function () {
                    return (
                        this == window &&
                            (domready(), delete Element.Events.load),
                        !0
                    );
                },
            }),
            ...
            replaces: function (element) {
                return (
                    (element = document.id(
                        element,
                        !0
                    )).parentNode.replaceChild(this.toElement(), element),
                    this
                );
            },
            inject: function (element) {
                return (
                    document.id(element, !0).appendChild(this.toElement()), this
                );
            },
            remote: function () {
