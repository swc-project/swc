!(function () {
    ...
    (Function.prototype.overloadSetter = function (usePlural) {
        ...
        return function (a, b) {
            ...
            if (usePlural || "string" != typeof a) {
                for (var k in a) self.call(this,
                    k,
                    a[k]);
                if (enumerables)
                    for (var i = enumerables.length; i--; )
                        (k = enumerables[i]),
                        a.hasOwnProperty(k) && self.call(this,
                            k,
                            a[k]);
            } else self.call(this,
                a,
    ...
    Type.isEnumerable = function (item) {
      ...
      "[object Function]" != toString.call(item)
        );
    };
    var hooks = {},
    ...
    var force = function (name, object, methods) {
        ...
        for (var i = 0, l = methods.length; i < l; i++) {
            ...
            isType && proto && object.implement(key,
                proto.protect());
        }
        if (isType) {
                ...
                if (!methodsEnumerable)
                    for (var i = 0, l = methods.length; i < l; i++)
                        fn.call(prototype,
                            prototype[methods[i]],
                            methods[i]);
                for (var key in prototype) fn.call(prototype,
                    prototype[key],
                    key);
            };
        }
    ...
    Array.implement({
        forEach: function (fn, bind) {
            for (var i = 0, l = this.length; i < l; i++)
                i in this && fn.call(bind,
                    this[i],
                    i,
                    this);
        },
        each: function (fn, bind) {
            return Array.forEach(this,
                fn,
                bind), this;
        },
    });
    ...
    Array.implement("clone",
        function () {
            for (var i = this.length, clone = new Array(i); i--; )
    ...
    Object.extend({
        merge: function (source, k, v) {
            ...
            for (var i = 1, l = arguments.length; i < l; i++) {
                ...
                for (var key in object) mergeOne(source,
                    key,
                    object[key]);
            }
            return source;
    ...
    var Hash = (this.Hash = new Type("Hash",
        function (object) {
            for (var key in ("hash" == typeOf(object) &&
    ...
    var Native = (this.Native = function (properties) {
        return new Type(properties.name,
...
Array.implement({
    ...
    map: function (fn, bind) {
        for (
            var length = this.length >>> 0, results = Array(length), i = 0;
            i < length;
            i++
        )
            i in this && (results[i] = fn.call(bind,
                this[i],
                i,
                this));
        return results;
    ...
    invoke: function (methodName) {
        ...
        return this.map(function (item) {
            return item[methodName].apply(item,
                args);
        });
    },
    ...
    erase: function (item) {
        for (var i = this.length; i--; ) this[i] === item && this.splice(i,
            1);
        return this;
    },
    empty: function () {
...
Number.implement({
    ...
    times: function (fn, bind) {
        for (var i = 0; i < this; i++) fn.call(bind,
            i,
            this);
    },
    toFloat: function () {
...
Function.implement({
    ...
    pass: function (args, bind) {
        var self = this;
        return (
            null != args && (args = Array.from(args)),
            function () {
    ...
    delay: function (delay, bind, args) {
        return setTimeout(this.pass(null == args ? [] : args,
            bind),
        delay);
    },
    periodical: function (periodical, bind, args) {
        return setInterval(this.pass(null == args ? [] : args,
            bind),
        periodical);
    },
}),
            ...
            return (
                Object.each(object,
                    function (value, key) {
                        ...
                        case "object":
                            result = Object.toQueryString(value,
                                key);
                            break;
                        case "array":
                            var qs = {};
                            ...
                            (result = Object.toQueryString(qs,
                                key));
                            break;
                        default:
...
Hash.implement({
    ...
    set: function (key, value) {
        return (
            (this[key] && !this.hasOwnProperty(key)) || (this[key] = value), this
        );
    },
    empty: function () {
        return (
    ...
    map: function (fn, bind) {
        return new Hash(Object.map(this,
            fn,
            bind));
    },
    filter: function (fn, bind) {
        return new Hash(Object.filter(this,
            fn,
            bind));
    },
    every: function (fn, bind) {
        return Object.every(this,
            fn,
            bind);
    },
    some: function (fn, bind) {
        return Object.some(this,
            fn,
            bind);
    },
    getKeys: function () {
    ...
    try {
        ...
        [
            ...
            Array[name] = function (item) {
                return method.apply(Array.from(item),
                    slice.call(arguments,
                        1));
            };
        });
...
(function () {
        ...
        DOMEvent = (this.DOMEvent = new Type("DOMEvent",
            function (event, win) {
                ...
                if (((this.target = document.id(target)), 0 == type.indexOf("key"))) {
                    ...
                    (this.key = _keys[code] || Object.keyOf(Event.Keys,
                        code)),
                    "keydown" == type &&
              (code > 111 && code < 124
                  ? (this.key = "f" + (code - 111))
    ...
    (DOMEvent.defineKeys = DOMEvent.defineKey.overloadSetter(!0)),
    DOMEvent.defineKeys({
        38: "up",
        40: "down",
        37: "left",
...
(function () {
    var Class = (this.Class = new Type("Class",
        ...
        implement = function (key, value, retain) {
            if (
                Class.Mutators.hasOwnProperty(key) &&
          null == (value = Class.Mutators[key].call(this,
              value))
            )
                return this;
            if ("function" == typeOf(value)) {
                ...
                this.prototype[key] = retain
                    ...
                    : (function (self, key, method) {
                        ...
                        key,
                        value);
            } else Object.merge(this.prototype,
                key,
                value);
            return this;
        };
...
(function () {
    this.Chain = new Class({
        ...
        callChain: function () {
            return (
                !!this.$chain.length && this.$chain.shift().apply(this,
                    arguments)
            );
        },
        clearChain: function () {
    ...
    (this.Events = new Class({
        ...
        addEvents: function (events) {
            for (var type in events) this.addEvent(type,
                events[type]);
            return this;
        },
        ...
        removeEvents: function (events) {
            ...
            for (type in (events && (events = removeOn(events)), this.$events))
                if (!events || events == type)
                    for (var fns = this.$events[type], i = fns.length; i--; )
                        i in fns && this.removeEvent(type,
                            fns[i]);
            return this;
        },
    })),
...
function () {
    var parsed,
        ...
        parse = function (expression, isReversed) {
            ...
            for (
                ...
                separatorIndex = -1;
                expression != (expression = expression.replace(regexp,
                    parser));

            );
            return (
                (parsed.length = parsed.expressions.length),
                (currentCache[parsed.raw] = reversed ? reverse(parsed) : parsed)
            );
        },
    ...
    function parser(
        ...
        if (combinator || combinatorChildren || -1 === combinatorIndex) {
          ...
          (currentSeparator[
              combinatorIndex
          ].reverseCombinator = reverseCombinator(combinator)),
            (currentSeparator[++combinatorIndex] = {
                combinator: combinator,
                tag: "*",
            });
...
function () {
    ...
    (local.isXML = function (document) {
        return (
            !!document.xmlVersion ||
          !!document.xml ||
          "[object XMLDocument]" == toString.call(document) ||
          (9 == document.nodeType &&
    ...
    (local.setDocument = function (document) {
        ...
        if (this.document !== document) {
            ...
            if (features)
                ...
                ((features = featuresCache[rootUid] = {}).root = root),
                ...
                if (features.isHTMLDocument) {
                    ...
                    (starSelectsComments =
                  testNode.getElementsByTagName("*").length > 1);
                    try {
                ...
                starSelectsComments || starSelectsClosed;
                  ...
                  '<a name="' + id + '"></a><b id="' + id + '"></b>'),
                    ...
                    if (testNode.getElementsByClassName) {
                        try {
                            ...
                            (cachedGetElementsByClassName =
                      2 != testNode.getElementsByClassName("b").length);
                        } catch (e) {}
                        try {
                            (testNode.innerHTML =
                    '<a class="a"></a><a class="f b a"></a>'),
                            (brokenSecondClassNameGEBCN =
                      2 != testNode.getElementsByClassName("a").length);
                        } catch (e) {}
                  ...
                  cachedGetElementsByClassName || brokenSecondClassNameGEBCN;
                    ...
                    '<select><option selected="selected">a</option></select>'),
                      ...
                      0 == testNode.querySelectorAll(":checked").length);
                        } catch (e) {}
                        try {
                            (testNode.innerHTML = '<a class=""></a>'),
                            (features.brokenEmptyAttributeQSA =
                      0 != testNode.querySelectorAll('[class*=""]').length);
                        } catch (e) {}
                    }
                    try {
                        (testNode.innerHTML =
                  ...
                  root.webkitMatchesSelector),
                        ...
                        try {
                            features.nativeMatchesSelector.call(root,
                                ":slick"),
                        ...
                        : document.createRange
                            ? function (a, b) {
                                ...
                                return (
                                    ...
                                    bRange.setEnd(b,
                                        0),
                                    aRange.compareBoundaryPoints(Range.START_TO_END,
                                        bRange)
                                );
                            }
                            : null),
    ...
    (local.search = function (context, expression, append, first) {
        ...
        if (
          ...
          this.setDocument(context),
            ...
            for (i = found.length; i--; ) uniques[this.getUID(found[i])] = !0;
        if ("string" == typeof expression) {
                ...
                ((!context.getElementsByClassName || this.brokenGEBCN) &&
                  context.querySelectorAll)
                        ...
                        if (context.getElementsByClassName && !this.brokenGEBCN) {
                            if (((nodes = context.getElementsByClassName(name)), first))
                                return nodes[0] || null;
                            ...
                            for (
                                nodes = context.getElementsByTagName("*"), i = 0;
                                (node = nodes[i++]);

                            )
                                if (
                                    ((className = node.className),
                                    className && matchClass.test(className))
                                ) {
                    ...
                    if (((nodes = context.getElementsByTagName(name)), first))
                        return nodes[0] || null;
                    for (i = 0; (node = nodes[i++]); )
                        (hasOthers && uniques[this.getUID(node)]) || found.push(node);
                }
            ...
            if (!expression.Slick)
                return this.contains(context.documentElement || context,
                    expression)
        ...
        return (
            (hasOthers || parsed.expressions.length > 1) && this.sort(found),
    ...
    (local.getUIDXML = function (node) {
        ...
        return (
            uid || ((uid = this.uidx++), node.setAttribute(this.uidk,
                uid)), uid
        );
    }),
    ...
    (local.pushUID = function (node, tag, id, classes, attributes, pseudos) {
        ...
        !this.uniques[uid] &&
          this.matchSelector(node,
              ...
              attributes,
              pseudos) &&
          ((this.uniques[uid] = !0), this.found.push(node));
    }),
    (local.matchNode = function (node, selector) {
        ...
        var item,
            nodes = this.search(this.document,
                parsed);
    ...
    (local.matchPseudo = function (node, name, argument) {
        ...
        if (this[pseudoName]) return this[pseudoName](node,
            argument);
        var attribute = this.getAttribute(node,
            name);
    ...
    (local.matchSelector = function (
        ...
        if (classes)
            for (i = classes.length; i--; )
                if (
                    !(cls = this.getAttribute(node,
                        "class")) ||
              !classes[i].regexp.test(cls)
                )
                    return !1;
        if (attributes)
            for (i = attributes.length; i--; )
                if (
                    (part = attributes[i]).operator
                        ? !part.test(this.getAttribute(node,
                            part.key))
                        : !this.hasAttribute(node,
                            part.key)
                )
                    return !1;
        if (pseudos)
    ...
    var combinators = {
        " ": function (node, tag, id, classes, attributes, pseudos, classList) {
            ...
            if (this.isHTMLDocument) {
                getById: if (id) {
                    if (
                        (!(item = this.document.getElementById(id)) && node.all) ||
              (this.idGetsName &&
                item &&
                item.getAttributeNode("id").nodeValue != id)
                    ...
                    if (this.document !== node && !this.contains(node,
                        item)) return;
            ...
            if ((children = node.getElementsByTagName(tag)) && children.length)
                for (
    ...
    var pseudos = {
        ...
        "nth-child": local.createNTHPseudo("firstChild",
            "nextSibling",
            "posNTH"),
    ...
    (Slick.contains = function (container, node) {
        return local.setDocument(container), local.contains(container,
            node);
    }),
    (Slick.getAttribute = function (node, name) {
        return local.setDocument(node), local.getAttribute(node,
            name);
    }),
    (Slick.hasAttribute = function (node, name) {
        return local.setDocument(node), local.hasAttribute(node,
            name);
    }),
    (Slick.match = function (node, selector) {
        return (
          ...
          (!selector ||
            selector === node ||
            (local.setDocument(node), local.matchNode(node,
                selector)))
        );
    }),
    ...
    (Slick.lookupPseudo = function (name) {
        ...
        return pseudo
            ? function (argument) {
                return pseudo.call(this,
                    argument);
            }
            : null;
    }),
    (Slick.override = function (regexp, fn) {
        return local.override(regexp,
            fn), this;
    }),
...
var Element = function (tag, props) {
    ...
    return document.newElement(tag,
        props);
};
Browser.Element &&
...
var IFrame = new Type("IFrame",
        function () {
            ...
            (iframe = new Element(iframe || "iframe",
                props));
            var onLoad = function () {
    ...
    Elements = (this.Elements = function (nodes) {
        if (nodes && nodes.length)
            for (var node, uniques = {}, i = 0; (node = nodes[i++]); ) {
...
new Type("Elements",
    ...
    unshift: function () {
        ...
        return Array.prototype.unshift.apply(this,
            items);
    }.protect(),
    concat: function () {
        for (
            var newElements = new Elements(this), i = 0, l = arguments.length;
            i < l;
            i++
        ) {
...
(function () {
    ...
    1 == object[1] &&
        Elements.implement(
            ...
            function () {
                for (
                    var length = this.length, result = splice.apply(this,
                        arguments);
                    length >= this.length;
    ...
    Array.forEachMethod(function (method, name) {
        Elements.implement(name,
            method);
    }),
    Array.mirror(Elements);
    try {
        createElementAcceptsHTML =
        "x" == document.createElement("<input name=x>").name;
    } catch (e) {}
    ...
    Document.implement({
        newElement: function (tag, props) {
            ...
            props &&
            ((tag = "<" + tag),
            props.name && (tag += ' name="' + escapeQuotes(props.name) + '"'),
            props.type && (tag += ' type="' + escapeQuotes(props.type) + '"'),
            (tag += ">"),
            delete props.name,
            delete props.type),
                this.id(this.createElement(tag)).set(props)
            );
        },
    });
})(),
(function () {
          ...
          ((types = {
              ...
              object: function (obj, nocash, doc) {
                  return obj.toElement
                      ? types.element(obj.toElement(doc),
                          nocash)
                      : null;
              },
          }),
    ...
    (function (search, find, match) {
        ...
        var pseudos = (this.Selectors.Pseudo = new Hash()),
            addSlickPseudos = function () {
                for (var name in pseudos)
                    pseudos.hasOwnProperty(name) &&
                (Slick.definePseudo(name,
                    pseudos[name]), delete pseudos[name]);
            };
        (Slick.search = function (context, expression, append) {
            return (
                addSlickPseudos(), search.call(this,
                    context,
                    expression,
                    append)
            );
        ...
        (Slick.find = function (context, expression) {
            return addSlickPseudos(), find.call(this,
                context,
                expression);
        }),
        (Slick.match = function (node, selector) {
            return addSlickPseudos(), match.call(this,
                node,
                selector);
        });
    })(Slick.search,
    ...
    var injectCombinator = function (expression, combinator) {
        ...
        for (
            var expressions = (expression = Object.clone(Slick.parse(expression)))
                    .expressions,
                i = expressions.length;
            i--;
    ...
    Object.forEach(
        ...
        function (combinator, method) {
            Element.implement(method,
                function (expression) {
                    return this.getElement(injectCombinator(expression,
                        combinator));
                });
        },
    ),
    Object.forEach(
        ...
        function (combinator, method) {
            Element.implement(method,
                function (expression) {
                    return this.getElements(injectCombinator(expression,
                        combinator));
                });
        },
    ),
    Element.implement({
        ...
        match: function (expression) {
            return !expression || Slick.match(this,
                expression);
        },
    }),
    null == window.$$ &&
    ...
    var inserters = {
        before: function (context, element) {
            ...
            parent && parent.insertBefore(context,
                element);
        },
    ...
    Object.each(inserters,
        function (inserter, where) {
            ...
            (methods["grab" + where] = function (el) {
                return inserter(document.id(el,
                    !0),
                this), this;
            }),
    ...
    Element.implement({
        ...
        getProperty: function (name) {
            ...
            var result = Slick.getAttribute(this,
                name);
            return result || Slick.hasAttribute(this,
                name)
                ? result
                : null;
        },
        getProperties: function () {
            ...
            return args.map(this.getProperty,
                this).associate(args);
        },
        ...
        toggleClass: function (className, force) {
            return (
                null == force && (force = !this.hasClass(className)),
        ...
        grab: function (el, where) {
            return inserters[where || "bottom"](document.id(el,
                !0),
            this), this;
        },
        inject: function (el, where) {
            return inserters[where || "bottom"](this,
                document.id(el,
                    !0)), this;
        },
        replaces: function (el) {
            return (
                (el = document.id(el,
                    !0)).parentNode.replaceChild(this,
                    el), this
            );
        },
        wraps: function (el, where) {
            return (el = document.id(el,
                !0)), this.replaces(el).grab(el,
                where);
        },
        ...
        clone: function (contents, keepid) {
            ...
            te.append(Array.from(this.getElementsByTagName("*")))),
                ...
                var node = ce[i],
                    element = te[i];
                if (
                    (keepid || node.removeAttribute("id"),
    ...
    var supportsTableInnerHTML = Function.attempt(function () {
            return (
                (document.createElement("table").innerHTML = "<tr><td></td></tr>"), !0
            );
        }),
    ...
    "s" != testForm.firstChild.value &&
        (Element.Properties.value = {
            set: function (value) {
                if ("select" != this.get("tag"))
                    return this.setProperty("value",
                        value);
                for (
                    var options = this.getElements("option"), i = 0;
                    i < options.length;
                    i++
                ) {
            ...
            get: function () {
                ...
                if ("select" == tag && !(option = option.getSelected()[0]))
                    return "";
...
(function () {
            ...
            : hasFilter
              ...
              (style.zoom = 1),
                ...
                null == opacity || 1 == opacity
                    ...
                    ")");
                    var filter =
              style.filter || element.getComputedStyle("filter") || "";
                    (style.filter = reAlpha.test(filter)
                        ? filter.replace(reAlpha,
                            opacity)
                        : filter + opacity),
        ...
        getOpacity = hasOpacity
            ...
            : hasFilter
                ...
                element.style.filter || element.getComputedStyle("filter");
                    return (
                        filter && (opacity = filter.match(reAlpha)),
    ...
    Element.implement({
        ...
        setStyle: function (property, value) {
            if ("opacity" == property)
                return (
                    null != value && (value = parseFloat(value)),
                    setOpacity(this,
                        value),
                    this
                );
        ...
        getStyle: function (property) {
            ...
            if (result) {
                ...
                color && (result = result.replace(color[0],
                    color[0].rgbToHex()));
            }
            if (Browser.opera || Browser.ie) {
                if (/^(height|width)$/.test(property) && !/px$/.test(result)) {
                  ...
                  this.getStyle("padding-" + value).toInt();
                        ...
                        this),
                        this["offset" + property.capitalize()] - size + "px"
                    );
                }
                if (
                    Browser.ie &&
        ...
        [Element, Window, Document].invoke("implement",
            {
                addEvent: function (type, fn) {
                    ...
                    var realType = type,
                        ...
                        self = this;
                    custom &&
            (custom.onAdd && custom.onAdd.call(this,
                fn,
                type),
            custom.condition &&
              (condition = function (event) {
                  return (
                      !custom.condition.call(this,
                          event,
                          type) ||
                  fn.call(this,
                      event)
            ...
            custom.base &&
              (realType = Function.from(custom.base).call(this,
                  type)));
                    var defn = function () {
                            return fn.call(self);
                        },
              ...
              (2 == nativeEvent &&
                (defn = function (event) {
                    (event = new DOMEvent(event,
                        self.getWindow())),
                    !1 === condition.call(self,
                        event) && event.stop();
                }),
              this.addListener(realType,
                  defn,
                  arguments[2])),
                ...
                removeEvent: function (type, fn) {
                    ...
                    return (
                        custom &&
              (custom.onRemove && custom.onRemove.call(this,
                  fn,
                  type),
              custom.base &&
                (type = Function.from(custom.base).call(this,
                    type))),
                ...
                addEvents: function (events) {
                    for (var event in events) this.addEvent(event,
                        events[event]);
                    return this;
                },
                removeEvents: function (events) {
              ...
              this);
                    else for (var eventType in events) this.cloneEvents(from,
                        eventType);
                    return this;
                },
            }),
                  ...
                  : event.target.getParent("form");
                    if (form) {
                        ...
                        if (-1 == forms.indexOf(form)) {
                            ...
                            self.store(_key + type + "listeners",
                                listeners);
                        }
                    }
                },
    ...
    var proto = Element.prototype,
        ...
        delegation = {
            ...
            removeEvent: function (type, match, fn, _uid) {
                var __uid,
                    s,
                    storage = this.retrieve("$delegates",
                        {}),
                    stored = storage[type];
                ...
                delegation.removeEvent.call(this,
                    type,
                    match,
                    s.fn,
                    __uid);
...
(function () {
    ...
    Element.implement({
        ...
        getOffsetParent: brokenOffsetParent
            ...
            : function () {
                if (isBody(this) || "fixed" == styleString(this,
                    "position"))
                    return null;
                try {
        ...
        getOffsets: function () {
            ...
            return (
                Browser.firefox &&
            !borderBox(this) &&
            ((position.x -= leftBorder(this)), (position.y -= topBorder(this))),
                position
            );
        },
        ...
        computePosition: function (obj) {
            return {
                left: obj.x - styleNumber(this,
                    "margin-left"),
                top: obj.y - styleNumber(this,
                    "margin-top"),
            };
        },
    ...
    [Document, Window].invoke("implement",
        {
            ...
            getScrollSize: function () {
                ...
                return {
                    x: Math.max(doc.scrollWidth,
                        body.scrollWidth,
                        min.x),
                    y: Math.max(doc.scrollHeight,
                        body.scrollHeight,
                        min.y),
                };
            },
...
(function () {
    var Fx = (this.Fx = new Class({
        ...
        check: function () {
            ...
            case "chain":
                return this.chain(this.caller.pass(arguments,
                    this)), !1;
            }
            return !1;
        },
        ...
        stop: function () {
            return (
                this.isRunning() &&
            ((this.time = null),
            pullInstance.call(this,
                this.options.fps),
            this.frames == this.frame
                ? (this.fireEvent("complete",
                    this.subject),
                this.callChain() ||
                  this.fireEvent("chainComplete",
                      this.subject))
                : this.fireEvent("stop",
                    this.subject)),
                this
        ...
        pause: function () {
            return (
                this.isRunning() &&
            ((this.time = null), pullInstance.call(this,
                this.options.fps)),
                this
            );
        },
    ...
    var instances = {},
        ...
        pushInstance = function (fps) {
            ...
            list.push(this),
            timers[fps] ||
            (timers[fps] = loop.periodical(Math.round(1e3 / fps),
                list));
        },
...
(Fx.CSS = new Class({
    ...
    prepare: function (element, property, values) {
        var from = (values = Array.from(values))[0],
            to = values[1];
        if (null == to) {
    ...
    parse: function (value) {
        return (value =
        "string" == typeof (value = Function.from(value)())
            ? value.split(" ")
            : Array.from(value)).map(function (val) {
            val = String(val);
            var found = !1;
            return (
    ...
    compute: function (from, to, delta) {
        var computed = [];
        return (
            Math.min(from.length,
                to.length).times(function (i) {
                computed.push({
    ...
    serve: function (value, unit) {
        ...
        return (
            value.each(function (bit) {
                returned = returned.concat(bit.parser.serve(bit.value,
                    unit));
            }),
            returned
        );
                            ...
                            function (rule, i) {
                                if (rule.style) {
                                    var selectorText = rule.selectorText
                                        ? rule.selectorText.replace(/^\w+/,
                                            function (m) {
                                                return m.toLowerCase();
                                            })
                                        : null;
                                    selectorText &&
                  selectorTest.test(selectorText) &&
                  Object.each(Element.Styles,
                      function (value, style) {
                          rule.style[style] &&
                      !Element.ShortStyles[style] &&
                      ((value = String(rule.style[style])),
                      (to[style] = /^rgb/.test(value)
                          ? value.rgbToHex()
                          : value));
                      });
                                }
    ...
    Color: {
        ...
        compute: function (from, to, delta) {
            return from.map(function (value, i) {
                return Math.round(Fx.compute(from[i],
                    to[i],
                    delta));
            });
        },
...
Element.implement({
    tween: function (property, from, to) {
        return this.get("tween").start(property,
            from,
            to), this;
    },
    fade: function (how) {
        ...
        toggle || this.eliminate("fade:flag"), fade[method].apply(fade,
            args);
...
(Fx.Morph = new Class({
    ...
    set: function (now) {
        for (var p in ("string" == typeof now && (now = this.search(now)), now))
            this.render(this.element,
                p,
                now[p],
                this.options.unit);
...
Fx.Transitions.extend({
    ...
    Back: function (p, x) {
        return (x = (x && x[0]) || 1.618), Math.pow(p,
            2) * ((x + 1) * p - x);
    },
    Bounce: function (p) {
        for (var value, a = 0, b = 1; ; a += b, b /= 2)
            if (p >= (7 - 4 * a) / 11) {
                value = b * b - Math.pow((11 - 6 * a - 11 * p) / 4,
                    2);
                break;
            }
        return value;
...
(function () {
    var empty = function () {},
        ...
        Request = (this.Request = new Class({
            ...
            this.options.isSuccess.call(this,
                this.status)
            ...
            /(ecma|java)script/.test(this.getHeader("Content-type"))
                    ? Browser.exec(text)
                    : text.stripScripts(this.options.evalScripts);
            },
            success: function (text, xml) {
                this.onSuccess(this.processScripts(text),
                    xml);
            },
            onSuccess: function () {
                this.fireEvent("complete",
            ...
            (url = url.substr(0,
              ...
              (url += (url.contains("?") ? "&" : "?") + String.uniqueID()),
                data &&
              "get" == method &&
              ((url += (url.contains("?") ? "&" : "?") + data), (data = null));
                var xhr = this.xhr;
                return (
                    progressSupport &&
...
(Request.HTML = new Class({
    ...
    success: function (text) {
        ...
        options.evalScripts && Browser.exec(response.javascript),
        this.onSuccess(
            response.tree,
            response.elements,
            response.html,
...
var Cookie = new Class({
    ...
    write: function (value) {
        if (
            (this.options.encode && (value = encodeURIComponent(value)),
            this.options.domain && (value += "; domain=" + this.options.domain),
            this.options.path && (value += "; path=" + this.options.path),
            this.options.duration)
        ) {
            var date = new Date();
            date.setTime(date.getTime() + 24 * this.options.duration * 60 * 60 * 1e3),
...
(function (window, document) {
    var ready,
        ...
        domready = function () {
            ...
            document
                .removeListener("DOMContentLoaded",
                    domready)
                .removeListener("readystatechange",
                    check),
        ...
        check = function () {
            for (var i = checks.length; i--; )
                if (checks[i]()) return domready(), !0;
            return !1;
        },
        poll = function () {
            clearTimeout(timer), check() || (timer = setTimeout(poll,
                10));
        };
    ...
    testElement.doScroll &&
      !doScrollWorks() &&
      (checks.push(doScrollWorks), (shouldPoll = !0)),
    document.readyState &&
...
(function () {
    var Swiff = (this.Swiff = new Class({
        ...
        initialize: function (path, options) {
            ...
            for (var callBack in callBacks)
                (Swiff.CallBacks[this.instance][callBack] = (function (option) {
                    return function () {
                        return option.apply(self.object,
                            arguments);
                    };
                })(callBacks[callBack])),
                (vars[callBack] =
        ...
        inject: function (element) {
            return document.id(element,
                !0).appendChild(this.toElement()), this;
        },
        remote: function () {
    ...
    (Swiff.remote = function (obj, fn) {
        var rs = obj.CallFunction(
            ...
            __flash__argumentsToXML(arguments,
                2) +
            "</invoke>",
        );
        return eval(rs);
