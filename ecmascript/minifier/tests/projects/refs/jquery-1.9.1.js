...
!(function (window, undefined) {
            ...
            each: function (obj, callback, args) {
                ...
                if (args) {
                    if (isArray)
                        for (
                            ;
                            i < length && !1 !== callback.apply(obj[i], args);
                            i++
                        );
                    else
                        for (i in obj)
            ...
            Deferred: function (func) {
                var tuples = [
                    ...
                    promise = {
                        ...
                        always: function () {
                            return (
                                deferred.done(arguments).fail(arguments), this
                            );
                        },
                        then: function () {
                            var fns = arguments;
                ...
                var progressValues,
                    ...
                    remaining =
                        ...
                        (subordinate && jQuery.isFunction(subordinate.promise))
                            ...
                            : 0,
                    deferred =
                        1 === remaining ? subordinate : jQuery.Deferred(),
        ...
        (jQuery.support = (function () {
            ...
            { submit: !0, change: !0, focusin: !0 }))
                div.setAttribute((eventName = "on" + i), "t"),
                    (support[i + "Bubbles"] =
                        eventName in window ||
                        !1 === div.attributes[eventName].expando);
            return (
                    ...
                    for (
                        i = 0,
                            l = (name = jQuery.isArray(name)
                                ? name.concat(
                                      jQuery.map(name, jQuery.camelCase)
                                  )
                                : (name in thisCache) ||
    ...
    jQuery.extend({
        ...
        acceptData: function (elem) {
            ...
            return (
                !noData ||
                (!0 !== noData && elem.getAttribute("classid") === noData)
            );
        },
    }),
        jQuery.fn.extend({
                  ...
                  this.each(function (i) {
                      ...
                      1 === this.nodeType &&
                          ...
                          ((hooks =
                              ...
                              "set" in hooks &&
                              undefined !== hooks.set(this, val, "value")) ||
                              (this.value = val));
                  }))
                : elem
                ? (hooks =
                  ...
                  "get" in hooks &&
                  undefined !== (ret = hooks.get(elem, "value"))
                    ? ret
        ...
        jQuery.support.checkOn ||
            jQuery.each(["radio", "checkbox"], function () {
                jQuery.valHooks[this] = {
                    get: function (elem) {
                        return null === elem.getAttribute("value")
                            ? "on"
                            : elem.value;
                    },
                };
    ...
    (jQuery.event = {
            ...
            if (elemData) {
                for (
                    handler.handler &&
                        ...
                        t = (types = (types || "").match(core_rnotwhite) || [
                            "",
                        ]).length;
                    t--;
            ...
            if (
                ...
                if (
                    ...
                    for (
                        bubbleType = special.delegateType || type,
                            rfocusMorph.test(bubbleType + type) ||
                                (cur = cur.parentNode);
                        cur;
                        cur = cur.parentNode
                    )
                ...
                if (
                    ...
                    !onlyHandlers &&
                        ...
                        ("click" !== type || !jQuery.nodeName(elem, "a")) &&
        ...
        dispatch: function (event) {
            ...
            if (
                ...
                !special.preDispatch ||
                    !1 !== special.preDispatch.call(this, event))
            ) {
                for (
        ...
        (function (window, undefined) {
            ...
            try {
                slice.call(preferredDoc.documentElement.childNodes, 0)[0]
                    .nodeType;
            } catch (e) {
                slice = function (i) {
                    for (var elem, results = []; (elem = this[i++]); )
                        results.push(elem);
                    return results;
                };
            }
            ...
            function Sizzle(selector, context, results, seed) {
                ...
                if (
                    ((context
                        ? context.ownerDocument || context
                        : preferredDoc) !== document && setDocument(context),
                    (results = results || []),
                ...
                return (function (selector, context, results, seed) {
                    ...
                    if (!seed && 1 === match.length) {
                        if (
                            (tokens = match[0] = match[0].slice(0)).length >
                                2 &&
                ...
                for (
                    ...
                    if ((matcher = Expr.relative[tokens[i].type]))
                        ...
                        if (
                            ...
                            for (
                                j = ++i;
                                j < len && !Expr.relative[tokens[j].type];
                                j++
                            );
                            return setMatcher(
    ...
    function getAll(context, tag) {
        ...
        return undefined === tag || (tag && jQuery.nodeName(context, tag))
        ...
        jQuery.fn.extend({
            ...
            remove: function (selector, keepData) {
                for (var elem, i = 0; null != (elem = this[i]); i++)
                    (!selector || jQuery.filter(selector, [elem]).length > 0) &&
                        (keepData ||
                            1 !== elem.nodeType ||
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        if (val <= 0 || null == val) {
            if (
                (((val = curCSS(elem, name, styles)) < 0 || null == val) &&
                    (val = elem.style[name]),
                rnumnonpx.test(val))
            )
                return val;
    ...
    function css_defaultDisplay(nodeName) {
        ...
        return (
            display ||
                (("none" !== (display = actualDisplay(nodeName, doc)) &&
                    display) ||
                    ((doc = (
                        (iframe = (
                            iframe ||
        ...
        jQuery.extend({
            ...
            style: function (elem, name, value, extra) {
                if (
                    ...
                    if (
                        ...
                        return hooks &&
                            "get" in hooks &&
                            undefined !== (ret = hooks.get(elem, !1, extra))
                            ? ret
                            : style[name];
                    if (
            ...
            css: function (elem, name, extra, styles) {
                ...
                return (
                    ...
                    undefined === val && (val = curCSS(elem, name, styles)),
                    "normal" === val &&
                        name in cssNormalTransform &&
                        (val = cssNormalTransform[name]),
                    "" === extra || extra
                        ? ((num = parseFloat(val)),
                          !0 === extra || jQuery.isNumeric(num)
                              ? num || 0
                              : val)
                        : val
                );
    ...
    (ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || []),
        ...
        jQuery.extend({
            ...
            ajax: function (url, options) {
                ...
                if (
                    s.beforeSend &&
                    (!1 === s.beforeSend.call(callbackContext, jqXHR, s) ||
                        2 === state)
                )
                    return jqXHR.abort();
    ...
    var fxNow,
        ...
        animationPrefilters = [
            function (elem, props, opts) {
                ...
                opts.queue ||
                    (null ==
                        (hooks = jQuery._queueHooks(elem, "fx")).unqueued &&
                        ((hooks.unqueued = 0),
                ...
                1 === elem.nodeType &&
                    ...
                    "inline" === jQuery.css(elem, "display") &&
                ...
                if ((length = handled.length)) {
                    "hidden" in
                        ...
                        anim.done(function () {
                            var prop;
                            for (prop in (jQuery._removeData(elem, "fxshow"),
                            orig))
                ...
                function (prop, value) {
                    ...
                    if (parts) {
                        if (
                            ...
                            start =
                                jQuery.css(tween.elem, prop, !0) || end || 1;
                            do {
                                (start /= scale = scale || ".5"),
                                    jQuery.style(
                                        tween.elem,
        ...
        for (
            !(function (props, specialEasing) {
                ...
                for (index in props)
                    if (
                        ((easing =
                            specialEasing[(name = jQuery.camelCase(index))]),
                        (value = props[index]),
            ...
            _default: {
                get: function (tween) {
                    ...
                    return null == tween.elem[tween.prop] ||
                        (tween.elem.style &&
                            null != tween.elem.style[tween.prop])
                ...
                var empty = jQuery.isEmptyObject(prop),
                    ...
                    doAnimation = function () {
                        ...
                        (doAnimation.finish = function () {
                            ...
                            (empty || jQuery._data(this, "finish")) &&
                                anim.stop(!0);
                    };
                return (
