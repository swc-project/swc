...
//static PROMISE_DEPENDENCIES: &[&str] = &["es6.object.to-string",
// "es6.promise"];

pub static BUILTIN_TYPES: &[(&str, &[&str])] = &[
...
pub static INSTANCE_PROPERTIES: &[(&str, &[&str])] = &[
    ...
    (
        "finally",
        &["es7.promise.finally", "es6.object.to-string", "es6.promise"],
    ),
    ("find", &["es6.array.find"]),
...
pub static STATIC_PROPERTIES: &[(&str, &[(&str, &[&str])])] = &[
    (
        "Array",
        &[
    ...
    (
        "Promise",
        &[("all", COMMON_ITERATORS), ("race", COMMON_ITERATORS)],
    ),
    (
        "Reflect",
        &[
