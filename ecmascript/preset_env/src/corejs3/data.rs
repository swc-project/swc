...
//
//pub static PROMISE_DEPENDENCIES: &[&str] = &["es.promise",
// "es.object.to-string"];
//
...
//];
//
static URLSearchParamsDependencies: &[&str] = &["web.url", CommonIteratorsWithTag];
...
//finally: ["es.promise.finally", PROMISE_DEPENDENCIES],
//find: ["es.array.find"],
...
// "es.date.to-string"], trim: ["es.string.trim"],
