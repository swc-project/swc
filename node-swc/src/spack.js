...
function compileBundleOptions(config) {
    return __awaiter(this, void 0, void 0, function () {
        var f, file, configFromFile;
        return __generator(this, function (_a) {
            f = config === undefined ? '.' : config;
            try {
                file = typeof f === 'string' ? f : path.resolve('spack.config.js');
                configFromFile = require(file);
                if (configFromFile.default) {
                    configFromFile = configFromFile.default;
                }
                if (Array.isArray(configFromFile)) {
                    if (Array.isArray(f)) {
                        return [2 /*return*/, __spreadArrays(configFromFile, f)];
                    }
                    if (typeof f !== 'string') {
                        configFromFile.push(f);
                    }
                    return [2 /*return*/, configFromFile];
                }
                return [2 /*return*/, Object.assign({}, configFromFile, config)];
            }
            catch (e) {
                if (typeof f === 'string') {
